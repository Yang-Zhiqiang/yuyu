CREATE TABLE IT_AnsyuCreditCard (
...
ALTER TABLE IT_AnsyuCreditCard ADD CONSTRAINT PK_AnsyuCreditCard PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_AnsyuCreditCard ON IT_AnsyuCreditCard (
     syono                                                      /* 証券番号 */
) ;
