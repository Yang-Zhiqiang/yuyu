CREATE TABLE ZT_DrtenMinyuuKykInfoTy (
...
ALTER TABLE ZT_DrtenMinyuuKykInfoTy ADD CONSTRAINT PK_ZT_DrtenMinyuuKykInfoTy PRIMARY KEY (
     ztysyono                                                   /* （中継用）証券番号 */
) ;
