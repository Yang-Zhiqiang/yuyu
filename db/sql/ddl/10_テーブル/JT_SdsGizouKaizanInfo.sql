CREATE TABLE JT_SdsGizouKaizanInfo (
     ...
     sindansyogizokaizanriyuu                           VARCHAR     (50)                                                                ,  /* 診断書偽造改竄理由                                     */
...
ALTER TABLE JT_SdsGizouKaizanInfo ADD CONSTRAINT PK_SdsGizouKaizanInfo PRIMARY KEY (
     skno                                                     , /* 請求番号                                           */
     syono                                                    , /* 証券番号                                           */
