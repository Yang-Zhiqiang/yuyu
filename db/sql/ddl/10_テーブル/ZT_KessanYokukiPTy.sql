CREATE TABLE ZT_KessanYokukiPTy (
     ...
     ztyzennyknmonth                                    NUMBER      (2)                                                                 ,  /* （中継用）前回入金月数 */
     ...
     ztytkkzkp                                          NUMBER      (11)                                                                ,  /* （中継用）特約継続Ｐ */
     ztykeizokuphurikaekngk                             NUMBER      (11)                                                                ,  /* （中継用）継続Ｐ振替金額 */
     ...
     ztyitijibrzugktkp                                  NUMBER      (11)                                                                ,  /* （中継用）一時払増額特約Ｐ */
     ztypazukarikingk                                   NUMBER      (11)                                                                ,  /* （中継用）Ｐ預り金額 */
     ...
     ztyiktyknndp                                       NUMBER      (15)                                                                ,  /* （中継用）一括払翌年度保険料 */
     ztykigetumaenyknyknndp                             NUMBER      (15)                                                                ,  /* （中継用）期月前入金翌年度保険料 */
     ztyyknndpkei                                       NUMBER      (15)                                                                ,  /* （中継用）翌年度保険料合計 */
     ztyyobi03xn15                                      NUMBER      (15)                                                                ,  /* （中継用）予備０３＿Ｎ１５ */
...
ALTER TABLE ZT_KessanYokukiPTy ADD CONSTRAINT PK_KessanYokukiPTy PRIMARY KEY (
