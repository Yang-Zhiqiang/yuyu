CREATE TABLE ZT_SmbcGetujiKykMeisaiRn (
     ...
     zrnkyknmkjsmbcgetuji                               VARCHAR     (35)                                                      NOT NULL  ,  /* （連携用）契約者名（漢字）（ＳＭＢＣ月次契約Ｆ） */
     zrnhhknnmkjsmbcgetuji                              VARCHAR     (35)                                                      NOT NULL  ,  /* （連携用）被保険者名（漢字）（ＳＭＢＣ月次契約Ｆ） */
     zrnitijibrp                                        NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）一時払保険料 */
     zrngoukeip2                                        NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）合計保険料２ */
     zrnzenkizennoup                                    NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）全期前納保険料 */
     ...
     zrngetumatuymdidouw                                NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）月末日異動解約返戻金 */
     zrngetumatuymdsibous                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）月末日死亡保険金 */
     zrnyobiv53                                         CHAR        (53)                                                      NOT NULL     /* （連携用）予備項目Ｖ５３ */
)
;

ALTER TABLE ZT_SmbcGetujiKykMeisaiRn ADD CONSTRAINT PK_SmbcGetujiKykMeisaiRn PRIMARY KEY (
