CREATE TABLE BM_KinyuuKikanHuhoyofuriInfo (
     ...
     kinyuutesuuryou                                    NUMBER      (5)                                                                 ,  /* 金融機関手数料 */
...
ALTER TABLE BM_KinyuuKikanHuhoyofuriInfo ADD CONSTRAINT PK_KinyuuKikanHuhoyofuriInfo PRIMARY KEY (
     bankcd                                                     /* 銀行コード */
) ;
