...
ALTER TABLE MT_SousaRireki ADD CONSTRAINT PK_SousaRireki PRIMARY KEY (
     ttdksikibetuid                                             /* 手続識別ＩＤ */
) ;

CREATE INDEX IX1_SousaRireki ON MT_SousaRireki (
     syono                                                    , /* 証券番号 */
     ttdkstartymd                                               /* 手続開始日付 */
) ;

CREATE INDEX IX2_SousaRireki ON MT_SousaRireki (
     ttdkstartymd                                               /* 手続開始日付 */
) ;
