CREATE TABLE IT_KykKihon (
     ...
     tratkityuiuny                                      VARCHAR     (40)                                                                ,  /* 取扱注意内容 */
...
ALTER TABLE IT_KykKihon ADD CONSTRAINT PK_KykKihon PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_KykKihon ON IT_KykKihon (
     syono                                                      /* 証券番号 */
) ;
