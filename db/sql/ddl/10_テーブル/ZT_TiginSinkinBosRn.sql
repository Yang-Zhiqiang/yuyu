CREATE TABLE ZT_TiginSinkinBosRn (
     ...
     zrnseihowebsekno                                   NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ設計書番号 */
     zrnseihowebcalckijyunymd                           NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ計算基準年月日 */
     zrnseihowebhhknknnm                                CHAR        (18)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者カナ氏名 */
     zrnseihowebhhknkjnm                                VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者漢字氏名 */
     zrnseihowebhhknseiymd                              NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者生年月日 */
     zrnseihowebhhknseikbn                              CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者性別区分 */
     zrnseihowebmrhkihontikucd                          CHAR        (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂマル被基本地区コード */
     zrnseihowebhhknadr                                 VARCHAR     (124)                                                     NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者住所 */
     zrnseihowebkykknnm                                 CHAR        (18)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者カナ氏名 */
     zrnseihowebkykkjnm                                 VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者漢字氏名 */
     zrnseihowebkyksyaseiymd                            NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者生年月日 */
     zrnseihowebkyksyaseikbn                            CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者性別区分 */
     zrnseihowebkykkihontikucd                          CHAR        (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者基本地区コード */
     zrnseihowebkykadr                                  VARCHAR     (124)                                                     NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者住所 */
     zrnseihowebhknsyuruino                             NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ保険種類番号 */
     zrnseihowebhjkktkbn                                CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ報状告知区分 */
     zrnseihowebhknkkn                                  NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ保険期間 */
     zrnseihowebphrkkikn                                NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保ＷｅｂＰ払込期間 */
     ...
     zrnseihowebkihons                                  NUMBER      (9)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ基本Ｓ */
     ...
     zrnseihowebmosno                                   NUMBER      (9)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ申込番号 */
     zrnseihowebsekykkigenymd                           NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ設計書有効期限年月日 */
     ...
     zrnseihowebsbuktkjnm                               VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ死亡受取人漢字氏名 */
     zrnseihowebsbuktseiymd                             NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ死亡受取人生年月日 */
     zrnseihowebmosprtzmhyj                             CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ申込書印刷済表示 */
     zrnseihowebfstmossksymd                            NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ初回申込書作成年月日 */
     ...
     zrnseihowebteiwkkn                                 NUMBER      (9)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ低Ｗ期間 */
     ...
     zrnseihowebkjhjnnm                                 VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ漢字法人名 */
     zrnseihowebkndaihyounm                             CHAR        (30)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂカナ代表者名 */
     zrnseihowebkjdaihyounm                             VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ漢字代表者名 */
     zrnseihowebdaihyouktgkkbn                          CHAR        (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ代表者肩書区分 */
     zrnseihowebsykihrkp1                               NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ初回払込Ｐ１ */
     zrnseihowebmosp1                                   NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ申込Ｐ１ */
     ...
     zrnseihowebtargettkmkht                            NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂターゲット特約目標値 */
     zrnseihowebnykntuukanykngk                         NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ入金通貨入金額 */
     zrnseihowebnykntukfsthrkp                          NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ入金通貨初回払込Ｐ */
     zrnseihowebnykntuknexthrkp                         NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ入金通貨次回払込Ｐ */
     zrnseihowebsaimankihyj                             CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ才満期表示 */
     zrnseihowebrayhyj                                  CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保ＷｅｂＲＡＹ表示 */
     zrnseihowebgnykntuknykngk                          NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨入金通貨入金額 */
     zrnseihowebgnykntukfsthrkp                         NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨入金通貨初回Ｐ */
     zrnseihowebgnykntuknxthrkp                         NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨入金通貨次回Ｐ */
     zrnseihowebgaikakihonp                             NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨基本Ｐ */
     ...
     zrnseihowebgaikakihons                             NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨基本Ｓ */
     zrnseihowebdai1hknkkn                              NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ第１保険期間 */
     zrnseihowebkyksykgycd                              CHAR        (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者職業コード */
     zrnseihowebkknmskhjnkitikbn                        CHAR        (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ契勤務先法人形態区分 */
     zrnseihowebkykottmsk                               VARCHAR     (60)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ契約者お勤め先 */
     zrnseihowebhhknsykgycd                             CHAR        (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者職業コード */
     zrnseihowebhknmskhjnkitikbn                        CHAR        (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ被勤務先法人形態区分 */
     zrnseihowebhhknottmsk                              VARCHAR     (60)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者お勤め先 */
     zrnseihowebhhknnensyuukbn                          CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ被保険者年収区分 */
     zrnseihowebplhhknkjnm                              VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ被保険者漢字氏名 */
     zrnseihowebplkykkjnm                               VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ契約者漢字氏名 */
     ...
     zrnseihowebplsbuktkjnm                             VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ死亡受漢字氏名 */
     zrnseihowebplsbuktseiymd                           NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ死亡受生年月日 */
     ...
     zrnseihowebpltsinadrkai                            VARCHAR     (62)                                                      NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ通信先住所下位 */
     zrnseihowebplhiikihontikucd                        CHAR        (8)                                                       NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ被基本地区コード */
     zrnseihowebplhhknadr                               VARCHAR     (124)                                                     NOT NULL  ,  /* （連携用）生保ＷｅｂＰＬ被保険者住所 */
     zrnseihowebhnyppltzmhyj                            CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ汎用ＰＰＬ対応済表示 */
     zrnseihowebssrndhbnwr                              NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ指数連動部分配分割合 */
     zrnseihowebtrtrndhbnwr                             NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ定率積立部分配分割合 */
     zrnseihowebsueokikkn                               NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ据置期間 */
     ...
     zrnseihowebmnkuktkjnm                              VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ満期受取人漢字氏名 */
     zrnseihowebmnkuktseiymd                            NUMBER      (8)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ満期受取人生年月日 */
     zrnseihowebankenkanrino                            CHAR        (15)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ案件管理番号 */
     zrnseihowebikkatup                                 NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ一括払Ｐ */
     zrnseihowebikkatubaraikbn                          CHAR        (1)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ一括払区分 */
     zrnseihowebiktbrikaisuu                            NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ一括払回数 */
     zrnseihowebzennoup                                 NUMBER      (10)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ前納Ｐ */
     zrnseihowebgaikazennoup                            NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ外貨前納Ｐ */
     zrnseihowebzennoukkn                               NUMBER      (2)                                                       NOT NULL  ,  /* （連携用）生保Ｗｅｂ前納期間 */
     ...
     zrnseihowebhhkndrkjnm                              VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）生保Ｗｅｂ被代理漢字氏名 */
     zrnseihowebhhkndrseiymd                            NUMBER      (8)                                                       NOT NULL     /* （連携用）生保Ｗｅｂ被代理生年月日 */
)
;

ALTER TABLE ZT_TiginSinkinBosRn ADD CONSTRAINT PK_TiginSinkinBosRn PRIMARY KEY (
