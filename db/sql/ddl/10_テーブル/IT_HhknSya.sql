...
ALTER TABLE IT_HhknSya ADD CONSTRAINT PK_HhknSya PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_HhknSya ON IT_HhknSya (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX2_HhknSya ON IT_HhknSya (
     hhknseiymd                                                 /* 被保険者生年月日 */
) ;
