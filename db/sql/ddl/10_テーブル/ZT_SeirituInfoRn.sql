CREATE TABLE ZT_SeirituInfoRn (
     ...
     zrnkihons9                                         NUMBER      (9)                                                       NOT NULL  ,  /* （連携用）基本Ｓ（９桁） */
     zrnhsys                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）保障Ｓ */
     zrntkbriknsnhrkp                                   NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）月払換算払込Ｐ */
     ...
     zrnsiteituukakihons                                NUMBER      (13,2)                                                    NOT NULL  ,  /* （連携用）指定通貨建基本Ｓ */
     zrnhrktuukakbn                                     CHAR        (1)                                                       NOT NULL  ,  /* （連携用）払込通貨区分 */
     zrnsiteituukakbn                                   CHAR        (1)                                                       NOT NULL  ,  /* （連携用）指定通貨区分 */
     zrnhrktuukatukiknznhrkp                            NUMBER      (13,2)                                                    NOT NULL  ,  /* （連携用）払込通貨建月換算払込Ｐ */
     zrnsiteituukatukiknznhrkp                          NUMBER      (13,2)                                                    NOT NULL  ,  /* （連携用）指定通貨建月換算払込Ｐ */
     zrnyennyknrate                                     NUMBER      (7,4)                                                     NOT NULL  ,  /* （連携用）円入金レート */
     zrngaikanyknrate                                   NUMBER      (7,4)                                                     NOT NULL  ,  /* （連携用）外貨入金レート */
     zrnjyudkaigomehrtkarihyj                           CHAR        (1)                                                       NOT NULL  ,  /* （連携用）重度介護前払特約有表示 */
     zrnsyksbyensitihsyutkykrate                        NUMBER      (7,4)                                                     NOT NULL  ,  /* （連携用）初期死亡時円換算最低保証特約用為替レート */
     zrnsjkkktyouseiriritu                              NUMBER      (5,4)                                                     NOT NULL  ,  /* （連携用）市場価格調整用利率 */
     zrntargettkmkht                                    NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）ターゲット特約目標値 */
     ...
     zrnpwaribikihanteigk                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）Ｐ割引判定金額 */
...
ALTER TABLE ZT_SeirituInfoRn ADD CONSTRAINT PK_SeirituInfoRn PRIMARY KEY (
