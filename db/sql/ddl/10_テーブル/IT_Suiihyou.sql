...
ALTER TABLE IT_Suiihyou ADD CONSTRAINT PK_Suiihyou PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                              , /* 帳票作成日 */
     keikanensuu                                                /* 経過年数 */
...
CREATE INDEX IX1_Suiihyou ON IT_Suiihyou (
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                              , /* 帳票作成日 */
     keikanensuu                                                /* 経過年数 */
) ;

CREATE INDEX IX2_Suiihyou ON IT_Suiihyou (
     tyouhyouymd                                                /* 帳票作成日 */
) ;
