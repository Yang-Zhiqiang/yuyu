CREATE TABLE ZT_SbRituToukeiSeibiRenRn (
     ...
     zrnkisnkihons                                      NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算基本Ｓ */
     zrnkeisansibous                                    NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算死亡Ｓ */
     zrnshrs                                            NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）支払Ｓ */
     ...
     zrngoukeiteigenbubuns                              NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）合計逓減部分Ｓ */
     ...
     zrnsyuunyuumrtinknengkn7                           NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）収入マル定年金年額Ｎ７ */
     ...
     zrnkeisansykykbbnkhns                              NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算主契約部分基本Ｓ */
     ...
     zrnkeisansyukeiyakup                               NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算主契約Ｐ */
     ...
     zrnkeisangoukeitenkans                             NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算合計転換Ｓ */
     zrnkeisangoukeitenkankakaku                        NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算合計転換価格 */
     zrnkisnwnsgukitnknkakaku                           NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計算Ｗなし合計転換価格 */
     ...
     zrnkeisanyoteiriritu                               NUMBER      (9,6)                                                     NOT NULL  ,  /* （連携用）計算予定利率 */
...
ALTER TABLE ZT_SbRituToukeiSeibiRenRn ADD CONSTRAINT PK_SbRituToukeiSeibiRenRn PRIMARY KEY (
