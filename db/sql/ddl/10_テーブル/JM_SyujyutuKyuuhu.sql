CREATE TABLE JM_SyujyutuKyuuhu (
     ...
     syujyutukyhbairitu                                 NUMBER      (3)                                                                 ,  /* 手術給付倍率                                        */
     kyuuhugendokikan                                   NUMBER      (3)                                                                 ,  /* 給付限度期間                                        */
     syujyutusyurui                                     VARCHAR     (50)                                                                ,  /* 手術種類                                          */
...
ALTER TABLE JM_SyujyutuKyuuhu ADD CONSTRAINT PK_SyujyutuKyuuhu PRIMARY KEY (
