CREATE TABLE ZT_SyainMeiboTy (
     ...
     ztysyainmeibos                                     NUMBER      (13)                                                                ,  /* （中継用）社員名簿用Ｓ                                   */
     ztysyainmeibop                                     NUMBER      (11)                                                                ,  /* （中継用）社員名簿用Ｐ                                   */
     ztysyainmeibosyouyop                               NUMBER      (11)                                                                ,  /* （中継用）社員名簿用賞与払Ｐ                                */
...
ALTER TABLE ZT_SyainMeiboTy ADD CONSTRAINT PK_SyainMeiboTy PRIMARY KEY (
     ztysyono                                                   /* （中継用）証券番号                                      */
) ;
