CREATE TABLE ZT_TmttHaitoukinMeisaiRn (
     ...
     zrnzennendokurikosid                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）前年度繰越Ｄ */
     zrntounendod                                       NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）当年度Ｄ */
     zrntounendomatutumitated                           NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）当年度末積立Ｄ */
     zrntumitaterisoku                                  NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）積立利息 */
...
ALTER TABLE ZT_TmttHaitoukinMeisaiRn ADD CONSTRAINT PK_TmttHaitoukinMeisaiRn PRIMARY KEY (
