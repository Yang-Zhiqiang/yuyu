CREATE TABLE IT_KhTumitateDKanri (
     ...
     tumitated                                          NUMBER      (13)                                                      NOT NULL  ,  /* 積立Ｄ */
...
ALTER TABLE IT_KhTumitateDKanri ADD CONSTRAINT PK_TumitateDKanri PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_TumitateDKanri ON IT_KhTumitateDKanri (
     syono                                                      /* 証券番号 */
) ;
