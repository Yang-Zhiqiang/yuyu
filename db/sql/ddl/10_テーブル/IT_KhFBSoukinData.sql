CREATE TABLE IT_KhFBSoukinData (
...
ALTER TABLE IT_KhFBSoukinData ADD CONSTRAINT PK_KhFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_KhFBSoukinData ON IT_KhFBSoukinData (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX2_KhFBSoukinData ON IT_KhFBSoukinData (
     syoriYmd                                                   /* 処理年月日 */
) ;
