CREATE TABLE IT_KhSisuurendoTmttkn (
...
ALTER TABLE IT_KhSisuurendoTmttkn ADD CONSTRAINT PK_KhSisuurendoTmttkn PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_KhSisuurendoTmttkn ON IT_KhSisuurendoTmttkn (
     syono                                                    , /* 証券番号 */
     tmttkntaisyouym                                            /* 積立金対象年月 */
) ;
