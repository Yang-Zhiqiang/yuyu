CREATE TABLE IT_KoujyoSymNaiyou (
...
ALTER TABLE IT_KoujyoSymNaiyou ADD CONSTRAINT PK_KoujyoSymNaiyou PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syouhncd                                                 , /* 商品コード */
     renno3keta                                                 /* 連番（３桁） */
...
CREATE INDEX IX1_KoujyoSymNaiyou ON IT_KoujyoSymNaiyou (
     syono                                                    , /* 証券番号 */
     syouhncd                                                 , /* 商品コード */
     renno3keta                                                 /* 連番（３桁） */
) ;
