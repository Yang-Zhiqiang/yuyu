CREATE TABLE IT_SyuunouHenknRireki (
...
ALTER TABLE IT_SyuunouHenknRireki ADD CONSTRAINT PK_SyuunouHenknRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
...
CREATE INDEX IX1_SyuunouHenknRireki ON IT_SyuunouHenknRireki (
     syono                                                    , /* 証券番号 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;
