CREATE TABLE ZT_SyainMeiboRn (
     ...
     zrnsyainmeibos                                     NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）社員名簿用Ｓ */
     zrnsyainmeibop                                     NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）社員名簿用Ｐ */
     zrnsyainmeibosyouyop                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）社員名簿用賞与払Ｐ */
...
ALTER TABLE ZT_SyainMeiboRn ADD CONSTRAINT PK_SyainMeiboRn PRIMARY KEY (
     zrnsyono                                                   /* （連携用）証券番号 */
) ;
