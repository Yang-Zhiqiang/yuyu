CREATE TABLE IT_KhUriageKekkaData (
     ...
     zeisoukin                                          NUMBER      (13)                                                                ,  /* 税・送金                                          */
     zeisoukin$                                         VARCHAR     (10)                                                                ,  /* 税・送金(通貨型)                                     */
     uriagegoukei                                       NUMBER      (13)                                                                ,  /* 売上合計                                          */
...
ALTER TABLE IT_KhUriageKekkaData ADD CONSTRAINT PK_KhUriageKekkaData PRIMARY KEY (
     ansyuusyskbn                                             , /* 案内収納用システム区分                                    */
     uriagekekkadatarenno                                       /* 売上結果データ連番                                      */
) ;

CREATE INDEX IX1_KhUriageKekkaData ON IT_KhUriageKekkaData (
     syoriYmd                                                   /* 処理年月日                                          */
) ;
