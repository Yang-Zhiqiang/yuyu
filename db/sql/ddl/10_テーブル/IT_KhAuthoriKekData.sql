CREATE TABLE IT_KhAuthoriKekData (
...
ALTER TABLE IT_KhAuthoriKekData ADD CONSTRAINT PK_KhAuthoriKekData PRIMARY KEY (
     ansyuusyskbn                                             , /* 案内収納用システム区分                                    */
     authorikkdatarenno                                         /* オーソリ結果データ連番                                    */
) ;

CREATE INDEX IX1_KhAuthoriKekData ON IT_KhAuthoriKekData (
     syoriYmd                                                   /* 処理年月日                                          */
) ;
