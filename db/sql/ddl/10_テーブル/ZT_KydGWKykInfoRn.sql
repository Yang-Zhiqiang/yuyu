CREATE TABLE ZT_KydGWKykInfoRn (
     ...
     zrnbnkyk1kaip                                      NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）分割払契約１回分保険料 */
     ...
     zrnsyus                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）主契約保険金額 */
     zrnsyunm                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）主契約名称 */
     ...
     zrnidoukaiyakup                                    NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）異動解約保険料 */
     ...
     zrnbsyudiritnatkiwari1                             NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）募集代理店扱割合１ */
     zrnbsyudiritnatkiwari2                             NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）募集代理店扱割合２ */
     ...
     zrntknm1                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称１ */
     zrntks1                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額１ */
     ...
     zrntknm2                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称２ */
     zrntks2                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額２ */
     ...
     zrntknm3                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称３ */
     zrntks3                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額３ */
     ...
     zrntknm4                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称４ */
     zrntks4                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額４ */
     ...
     zrntknm5                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称５ */
     zrntks5                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額５ */
     ...
     zrntknm6                                           VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）特約名称６ */
     zrntks6                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）特約保険金額６ */
     ...
     zrnkyknmkjkydgw                                    VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）契約者名（漢字）（共同ＧＷ） */
     ...
     zrnkykhrkmgk                                       NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）契約者振込金額 */
...
ALTER TABLE ZT_KydGWKykInfoRn ADD CONSTRAINT PK_KydGWKykInfoRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
