CREATE TABLE JT_Toriatukaifuryouinfo (
     ...
     tratkihuryoucomment                                VARCHAR     (50)                                                                ,  /* 取扱不良コメント                                      */
...
ALTER TABLE JT_Toriatukaifuryouinfo ADD CONSTRAINT PK_Toriatukaifuryouinfo PRIMARY KEY (
     skno                                                     , /* 請求番号                                           */
     syono                                                    , /* 証券番号                                           */
