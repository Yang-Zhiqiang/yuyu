CREATE TABLE MW_DsNeugokiHanteiKekkaWk (
...
ALTER TABLE MW_DsNeugokiHanteiKekkaWk ADD CONSTRAINT PK_DsNeugokiHanteiKekkaWk PRIMARY KEY (
     dsdatasakuseiymd                                         , /* ＤＳデータ作成日 */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_DsNeugokiHanteiKekkaWk ON MW_DsNeugokiHanteiKekkaWk (
     syono                                                      /* 証券番号 */
) ;
