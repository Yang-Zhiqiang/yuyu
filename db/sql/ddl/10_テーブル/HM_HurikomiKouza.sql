...
ALTER TABLE HM_HurikomiKouza ADD CONSTRAINT PK_HurikomiKouza PRIMARY KEY (
     bankcd                                                   , /* 銀行コード */
     sitencd                                                  , /* 支店コード */
     kouzano                                                  , /* 口座番号 */
     tuukasyu                                                 , /* 通貨種類 */
...
CREATE INDEX IX1_HurikomiKouza ON HM_HurikomiKouza (
     oyadrtencd                                                 /* 親代理店コード */
) ;
