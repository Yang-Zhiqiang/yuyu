CREATE TABLE HT_YuukoukknKykListAtukaiSya (
     ...
     tratkiagnm                                         VARCHAR     (30)                                                                ,  /* 取扱代理店名                                        */
     oyadrtencd                                         VARCHAR     (7)                                                                 ,  /* 親代理店コード                                       */
     oyadrtennm                                         VARCHAR     (30)                                                                ,  /* 親代理店名                                         */
...
ALTER TABLE HT_YuukoukknKykListAtukaiSya ADD CONSTRAINT PK_YuukoukknKykListAtukaiSya PRIMARY KEY (
     mosno                                                    , /* 申込番号                                           */
     tyouhyouymd                                              , /* 帳票作成日                                          */
     keikakbn                                                 , /* 経過区分                                           */
     renno                                                      /* 連番                                             */
