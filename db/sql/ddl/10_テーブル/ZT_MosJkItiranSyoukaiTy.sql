CREATE TABLE ZT_MosJkItiranSyoukaiTy (
     ...
     ztykjhjnnm                                         VARCHAR     (30)                                                                ,  /* （中継用）漢字法人名                                    */
...
ALTER TABLE ZT_MosJkItiranSyoukaiTy ADD CONSTRAINT PK_MosJkItiranSyoukaiTy PRIMARY KEY (
     ztymosym                                                 , /* （中継用）申込月度                                      */
     ztymosno                                                 , /* （中継用）申込番号                                      */
