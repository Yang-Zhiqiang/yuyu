...
ALTER TABLE HT_SkUriageData ADD CONSTRAINT PK_SkUriageData PRIMARY KEY (
...
CREATE INDEX IX1_SkUriageData ON HT_SkUriageData (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_SkUriageData ON HT_SkUriageData (
     creditkessaiyouno                                          /* クレジットカード決済用番号 */
) ;

CREATE INDEX IX3_SkUriageData ON HT_SkUriageData (
