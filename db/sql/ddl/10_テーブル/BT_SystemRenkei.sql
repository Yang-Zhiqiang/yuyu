CREATE TABLE BT_SystemRenkei (
     ...
     henkanmaelayoutname                                VARCHAR     (200)                                                               ,  /* 変換前レイアウト名 */
     henkangolayoutid                                   VARCHAR     (50)                                                                ,  /* 変換後レイアウトＩＤ */
     henkangolayoutname                                 VARCHAR     (200)                                                               ,  /* 変換後レイアウト名 */
...
ALTER TABLE BT_SystemRenkei ADD CONSTRAINT PK_SystemRenkei PRIMARY KEY (
