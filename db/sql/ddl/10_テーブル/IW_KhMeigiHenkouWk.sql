CREATE TABLE IW_KhMeigiHenkouWk (
     ...
     sbuktbnwari1                                       NUMBER      (3)                                                                 ,  /* 死亡受取人分割割合１ */
     ...
     sbuktbnwari2                                       NUMBER      (3)                                                                 ,  /* 死亡受取人分割割合２ */
     ...
     sbuktbnwari3                                       NUMBER      (3)                                                                 ,  /* 死亡受取人分割割合３ */
     ...
     sbuktbnwari4                                       NUMBER      (3)                                                                 ,  /* 死亡受取人分割割合４ */
...
ALTER TABLE IW_KhMeigiHenkouWk ADD CONSTRAINT PK_KhMeigiHenkouWk PRIMARY KEY (
