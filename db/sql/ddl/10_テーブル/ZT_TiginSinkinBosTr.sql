CREATE TABLE ZT_TiginSinkinBosTr (
...
ALTER TABLE ZT_TiginSinkinBosTr ADD CONSTRAINT PK_TiginSinkinBosTr PRIMARY KEY (
...
CREATE INDEX IX1_TiginSinkinBosTr ON ZT_TiginSinkinBosTr (
