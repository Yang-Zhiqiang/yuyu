CREATE TABLE JT_SateiMeigihenkouInfo (
     ...
     meihenuktnm                                        VARCHAR     (15)                                                                ,  /* 名義変更受取人名                                      */
...
ALTER TABLE JT_SateiMeigihenkouInfo ADD CONSTRAINT PK_SateiMeigihenkouInfo PRIMARY KEY (
     skno                                                     , /* 請求番号                                           */
     syono                                                    , /* 証券番号                                           */
