CREATE TABLE HT_BosKihon (
     ...
     syutkpkei                                          NUMBER      (13)                                                                ,  /* 主契約・特約Ｐ合計金額 */
     syutkpkei$                                         VARCHAR     (10)                                                                ,  /* 主契約・特約Ｐ合計金額(通貨型) */
     fsthrkpkei                                         NUMBER      (13)                                                                ,  /* 初回払込Ｐ合計金額 */
...
ALTER TABLE HT_BosKihon ADD CONSTRAINT PK_BosKihon PRIMARY KEY (
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX1_BosKihon ON HT_BosKihon (
