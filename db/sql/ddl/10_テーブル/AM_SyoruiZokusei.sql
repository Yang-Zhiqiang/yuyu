CREATE TABLE AM_SyoruiZokusei (
     syoruiCd                                           VARCHAR     (5)                                                       NOT NULL  ,  /* 書類コード */
     syoruinm                                           VARCHAR     (30)                                                                ,  /* 書類名 */
     syoruinmryaku                                      VARCHAR     (10)                                                                ,  /* 書類名（略称） */
...
ALTER TABLE AM_SyoruiZokusei ADD CONSTRAINT AM_SyoruiZokuseiPk PRIMARY KEY (
     syoruiCd                                                   /* 書類コード */
) ;
