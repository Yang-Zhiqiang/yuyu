...
ALTER TABLE AM_IdCard ADD CONSTRAINT AM_IdCardPk PRIMARY KEY (
     idkbn                                                    , /* ＩＤ区分 */
     idcd                                                       /* ＩＤコード */
) ;

CREATE INDEX AM_IdCardIdx1 ON AM_IdCard (
