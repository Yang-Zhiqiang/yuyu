...
ALTER TABLE HT_SyoriCTL ADD CONSTRAINT PK_SyoriCTL PRIMARY KEY (
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX1_SyoriCTL ON HT_SyoriCTL (
     srsyoriymd                                               , /* 成立処理日 */
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX2_SyoriCTL ON HT_SyoriCTL (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX3_SyoriCTL ON HT_SyoriCTL (
     skeijimukbn                                                /* 新契約事務区分 */
) ;
