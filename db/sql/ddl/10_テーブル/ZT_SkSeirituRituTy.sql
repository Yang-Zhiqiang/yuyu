CREATE TABLE ZT_SkSeirituRituTy (
     ztyeigyouhonbusisyacd                              VARCHAR     (7)                                                       NOT NULL  ,  /* （中継用）営業本部支社コード */
     ztysisyanm                                         VARCHAR     (20)                                                                ,  /* （中継用）支社名 */
     ztysosikicd                                        VARCHAR     (7)                                                       NOT NULL  ,  /* （中継用）組織コード */
     ztykanjisosikinm20                                 VARCHAR     (20)                                                                ,  /* （中継用）漢字組織名（２０文字） */
...
ALTER TABLE ZT_SkSeirituRituTy ADD CONSTRAINT PK_SkSeirituRituTy PRIMARY KEY (
