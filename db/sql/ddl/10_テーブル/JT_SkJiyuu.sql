...
ALTER TABLE JT_SkJiyuu ADD CONSTRAINT PK_SkJiyuu PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
