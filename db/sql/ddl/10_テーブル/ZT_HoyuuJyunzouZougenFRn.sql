CREATE TABLE ZT_HoyuuJyunzouZougenFRn (
     ...
     zrngoukeisisttkyktkknsnp                           NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）合計災疾特約月換算Ｐ */
     zrnhsys                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）保障Ｓ */
     zrnkensuun3                                        NUMBER      (3,1)                                                     NOT NULL  ,  /* （連携用）件数Ｎ３ */
     zrnhenkougohosyous                                 NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更後保障Ｓ */
     zrnhtns                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）被転換Ｓ */
     zrnharaikomip                                      NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）払込Ｐ */
     zrnkaiyakusiharaikngk                              NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）解約支払金額 */
     ...
     zrnsyukeiyakutkknsnp                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）主契約月換算Ｐ */
...
ALTER TABLE ZT_HoyuuJyunzouZougenFRn ADD CONSTRAINT PK_HoyuuJyunzouZougenFRn PRIMARY KEY (
