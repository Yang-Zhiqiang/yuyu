CREATE TABLE ZT_BikinKeiyakuSeisandRn (
     ...
     zrnseisand                                         NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）精算Ｄ */
     ...
     zrnkariwariatedganrikin                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）仮割当Ｄ元利金 */
...
ALTER TABLE ZT_BikinKeiyakuSeisandRn ADD CONSTRAINT PK_BikinKeiyakuSeisandRn PRIMARY KEY (
