CREATE TABLE MT_DsKokyakuKeiyaku (
...
ALTER TABLE MT_DsKokyakuKeiyaku ADD CONSTRAINT PK_DsKokyakuKeiyaku PRIMARY KEY (
     dskokno                                                  , /* ＤＳ顧客番号 */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_DsKokyakuKeiyaku ON MT_DsKokyakuKeiyaku (
     syono                                                    , /* 証券番号 */
     dskykmukouhyj                                              /* ＤＳ契約無効表示 */
) ;

CREATE INDEX IX2_DsKokyakuKeiyaku ON MT_DsKokyakuKeiyaku (
