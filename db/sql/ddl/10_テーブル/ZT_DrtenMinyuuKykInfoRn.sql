CREATE TABLE ZT_DrtenMinyuuKykInfoRn (
     ...
     zrnmisyuup                                         NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）未収Ｐ */
...
ALTER TABLE ZT_DrtenMinyuuKykInfoRn ADD CONSTRAINT PK_ZT_DrtenMinyuuKykInfoRn PRIMARY KEY (
     zrnsyono                                                   /* （連携用）証券番号 */
) ;
