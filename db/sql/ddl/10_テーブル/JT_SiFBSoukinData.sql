CREATE TABLE JT_SiFBSoukinData (
...
ALTER TABLE JT_SiFBSoukinData ADD CONSTRAINT PK_SiFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SiFBSoukinData ON JT_SiFBSoukinData (
     syoriYmd                                                   /* 処理年月日 */
) ;
