...
ALTER TABLE HM_KetteiSya ADD CONSTRAINT PK_KetteiSya PRIMARY KEY (
     ketsyacd                                                   /* 決定者コード */
) ;
