...
ALTER TABLE IT_KykSyouhn ADD CONSTRAINT PK_KykSyouhn PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
...
CREATE INDEX IX1_KykSyouhn ON IT_KykSyouhn (
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
     syouhnsdno                                               , /* 商品世代番号 */
...
CREATE INDEX IX2_KykSyouhn ON IT_KykSyouhn (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;

CREATE INDEX IX3_KykSyouhn ON IT_KykSyouhn (
     syutkkbn                                                 , /* 主契約特約区分 */
     kykymd                                                   , /* 契約日 */
...
CREATE INDEX IX4_KykSyouhn ON IT_KykSyouhn (
     syutkkbn                                                 , /* 主契約特約区分 */
     syoumetujiyuu                                            , /* 消滅事由 */
     syoumetuymd                                                /* 消滅日 */
) ;

CREATE INDEX IX5_KykSyouhn ON IT_KykSyouhn (
     syutkkbn                                                 , /* 主契約特約区分 */
     yuukousyoumetukbn                                          /* 有効消滅区分 */
) ;
