CREATE TABLE ZT_YakansyoriLincSousinRn (
     ...
     zrnknjhhknmei30                                    VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）漢字被保険者名（３０桁） */
     zrnkjkyknm30                                       VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）漢字契約者名（３０桁） */
...
ALTER TABLE ZT_YakansyoriLincSousinRn ADD CONSTRAINT PK_YakansyoriLincSousinRn PRIMARY KEY (
