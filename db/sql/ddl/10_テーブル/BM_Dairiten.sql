CREATE TABLE BM_Dairiten (
     drtencd                                            VARCHAR     (7)                                                       NOT NULL  ,  /* 代理店コード */
     drtennm                                            VARCHAR     (30)                                                                ,  /* 代理店名 */
     ...
     tsrybntnwarix1                                     NUMBER      (3,2)                                                               ,  /* 手数料分担割合＿１ */
     tsrybntnaitedrtencdx2                              VARCHAR     (7)                                                                 ,  /* 手数料分担相手代理店コード＿２ */
     tsrybntnwarix2                                     NUMBER      (3,2)                                                               ,  /* 手数料分担割合＿２ */
     tsrybntnaitedrtencdx3                              VARCHAR     (7)                                                                 ,  /* 手数料分担相手代理店コード＿３ */
     tsrybntnwarix3                                     NUMBER      (3,2)                                                               ,  /* 手数料分担割合＿３ */
     tsrybntnaitedrtencdx4                              VARCHAR     (7)                                                                 ,  /* 手数料分担相手代理店コード＿４ */
     tsrybntnwarix4                                     NUMBER      (3,2)                                                               ,  /* 手数料分担割合＿４ */
     hnsituhykranktougetu                               NUMBER      (3)                                                                 ,  /* 品質評価ランク（当月） */
     hnsituhykrankyokugetu                              NUMBER      (3)                                                                 ,  /* 品質評価ランク（翌月） */
...
ALTER TABLE BM_Dairiten ADD CONSTRAINT PK_Dairiten PRIMARY KEY (
     drtencd                                                    /* 代理店コード */
) ;

CREATE INDEX IX1_Dairiten ON BM_Dairiten (
     kinyuucd                                                 , /* 金融機関コード */
     drtenjimcd                                                 /* 代理店事務所コード */
) ;

CREATE INDEX IX2_Dairiten ON BM_Dairiten (
     drtencd                                                  , /* 代理店コード */
     kinyuucd                                                 , /* 金融機関コード */
...
CREATE INDEX IX3_Dairiten ON BM_Dairiten (
     oyadrtencd                                               , /* 親代理店コード */
     drtenjimcd                                                 /* 代理店事務所コード */
) ;
