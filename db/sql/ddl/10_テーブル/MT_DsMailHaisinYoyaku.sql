CREATE TABLE MT_DsMailHaisinYoyaku (
...
ALTER TABLE MT_DsMailHaisinYoyaku ADD CONSTRAINT PK_DsMailHaisinYoyaku PRIMARY KEY (
     dsmailhaisinyoyakuskbtkey                                  /* ＤＳメール配信予約識別キー */
) ;

CREATE INDEX IX1_DsMailHaisinYoyaku ON MT_DsMailHaisinYoyaku (
     dsmailhaisinyoteiymd                                       /* ＤＳメール配信（予定）日 */
) ;

CREATE INDEX IX2_DsMailHaisinYoyaku ON MT_DsMailHaisinYoyaku (
     dssousinmailsyubetukbn                                     /* ＤＳ送信メール種別区分 */
) ;

CREATE INDEX IX3_DsMailHaisinYoyaku ON MT_DsMailHaisinYoyaku (
