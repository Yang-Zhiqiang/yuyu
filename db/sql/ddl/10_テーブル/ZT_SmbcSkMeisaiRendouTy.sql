CREATE TABLE ZT_SmbcSkMeisaiRendouTy (
     ...
     ztysmbckyknmkn                                     VARCHAR     (80)                                                                ,  /* （中継用）ＳＭＢＣ＿契約者名（カナ）                            */
...
ALTER TABLE ZT_SmbcSkMeisaiRendouTy ADD CONSTRAINT PK_SmbcSkMeisaiRendouTy PRIMARY KEY (
