...
ALTER TABLE IT_SyouhnTokujou ADD CONSTRAINT PK_SyouhnTokujou PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
...
CREATE INDEX IX1_SyouhnTokujou ON IT_SyouhnTokujou (
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
     syouhnsdno                                               , /* 商品世代番号 */
