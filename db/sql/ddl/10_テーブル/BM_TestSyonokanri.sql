CREATE TABLE BM_TestSyonokanri (
...
ALTER TABLE BM_TestSyonokanri ADD CONSTRAINT PK_TestSyonokanri PRIMARY KEY (
     seirekinen2keta                                          , /* 西暦年（２桁） */
     bosyuusosikicd                                           , /* 募集組織コード */
     syonorenno                                                 /* 証券番号連番 */
) ;

CREATE INDEX IX1_TestSyonokanri ON BM_TestSyonokanri (
     syono                                                      /* 証券番号 */
) ;
