CREATE TABLE ZT_KaiykHrSoutougakuRn (
     ...
     zrnryumsbbnkaiyakuhr                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）料増部分解約返戻金 */
...
ALTER TABLE ZT_KaiykHrSoutougakuRn ADD CONSTRAINT PK_KaiykHrSoutougakuRn PRIMARY KEY (
