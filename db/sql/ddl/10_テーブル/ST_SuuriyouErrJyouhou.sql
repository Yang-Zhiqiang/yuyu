CREATE TABLE ST_SuuriyouErrJyouhou (
     ...
     suuritoukeiyouerrnaiyou                            VARCHAR     (70)                                                      NOT NULL  ,  /* 数理統計用エラー内容 */
...
ALTER TABLE ST_SuuriyouErrJyouhou ADD CONSTRAINT PK_SuuriyouErrJyouhou PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
