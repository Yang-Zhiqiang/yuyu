CREATE TABLE ZT_FstpUriageSeikyuuKekkaTr (
     ...
     ztrseikyuukngk                                     NUMBER      (13)                                                      NOT NULL  ,  /* （取込用）請求金額 */
...
ALTER TABLE ZT_FstpUriageSeikyuuKekkaTr ADD CONSTRAINT PK_FstpUriageSeikyuuKekkaTr PRIMARY KEY (
