CREATE TABLE BT_Nyknmeisai (
     ...
     hrkmsimukebanknmkn                                 VARCHAR     (15)                                                                ,  /* （振込用）仕向銀行名 */
     hrkmsimuketennmkn                                  VARCHAR     (15)                                                                ,  /* （振込用）仕向店名 */
     hrkmtekiyounaiyou                                  VARCHAR     (20)                                                                ,  /* （振込用）摘要内容 */
...
ALTER TABLE BT_Nyknmeisai ADD CONSTRAINT PK_Nyknmeisai PRIMARY KEY (
