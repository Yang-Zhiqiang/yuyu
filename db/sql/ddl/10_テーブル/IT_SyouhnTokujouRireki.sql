CREATE TABLE IT_SyouhnTokujouRireki (
...
ALTER TABLE IT_SyouhnTokujouRireki ADD CONSTRAINT PK_SyouhnTokujouRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
...
CREATE INDEX IX1_SyouhnTokujouRireki ON IT_SyouhnTokujouRireki (
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
     syouhnsdno                                               , /* 商品世代番号 */
