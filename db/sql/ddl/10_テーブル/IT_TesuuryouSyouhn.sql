CREATE TABLE IT_TesuuryouSyouhn (
...
ALTER TABLE IT_TesuuryouSyouhn ADD CONSTRAINT PK_TesuuryouSyouhn PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_TesuuryouSyouhn ON IT_TesuuryouSyouhn (
     syono                                                    , /* 証券番号 */
     tsrysyorikbn                                             , /* 手数料処理区分 */
     renno                                                    , /* 連番 */
     syutkkbn                                                 , /* 主契約特約区分 */
