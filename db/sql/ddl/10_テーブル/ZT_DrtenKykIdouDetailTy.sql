CREATE TABLE ZT_DrtenKykIdouDetailTy (
     ...
     ztykykmfksnctrlkh                                  NUMBER      (7)                                                                 ,  /* （中継用）契約ＭＦ更新ＣＴＲ（保全） */
     ...
     ztykjsyagaihknnm                                   VARCHAR     (40)                                                                ,  /* （中継用）漢字社外向け保険名 */
     ztytelno                                           VARCHAR     (14)                                                                ,  /* （中継用）電話番号 */
     ztyhensyuubosyuudrtennm                            VARCHAR     (27)                                                                ,  /* （中継用）編集後漢字募集代理店名 */
     ztykyknmkjdirtnkykido                              VARCHAR     (20)                                                                ,  /* （中継用）契約者名（漢字）（代理店契約異動明細） */
     ...
     ztybosyuudrtennmkj                                 VARCHAR     (20)                                                                ,  /* （中継用）募集代理店名（漢字） */
     ztydoujitusyoricount                               VARCHAR     (3)                                                                 ,  /* （中継用）同日処理回数 */
     ztyhjnkykhyj                                       VARCHAR     (1)                                                                 ,  /* （中継用）法人契約表示 */
     ztyhjnnmkj                                         VARCHAR     (35)                                                                ,  /* （中継用）法人名（漢字） */
...
ALTER TABLE ZT_DrtenKykIdouDetailTy ADD CONSTRAINT PK_DrtenKykIdouDetailTy PRIMARY KEY (
