CREATE TABLE ZT_KouzaHnknTuutiTy (
     ...
     ztytuutisakuseiymdV11                              VARCHAR     (11)                                                                ,  /* （中継用）通知作成年月日Ｖ１１ */
     ztyhrkymdmdkj                                      VARCHAR     (6)                                                                 ,  /* （中継用）払込日（月日漢字） */
     ztysyono2                                          VARCHAR     (11)                                                                ,  /* （中継用）証券番号２ */
     ztynyknaiyoumidasi                                 VARCHAR     (2)                                                                 ,  /* （中継用）入金内容見出し */
     ztyymdmidasi                                       VARCHAR     (10)                                                                ,  /* （中継用）日付見出し */
     ztykingakumidasi                                   VARCHAR     (10)                                                                ,  /* （中継用）金額見出し */
     ztynyknymdseirekikj                                VARCHAR     (11)                                                                ,  /* （中継用）入金日（西暦漢字） */
     ztynyuukinngaku                                    VARCHAR     (13)                                                                ,  /* （中継用）入金額 */
     ztypjyuutouym                                      VARCHAR     (18)                                                                ,  /* （中継用）保険料充当年月 */
     ztyyobiv32                                         VARCHAR     (32)                                                                ,  /* （中継用）予備項目Ｖ３２ */
     ztyansyuyouyobin10x4                               VARCHAR     (10)                                                                ,  /* （中継用）案内収納用予備項目Ｎ１０＿４ */
     ztyhrkmymdseireki                                  VARCHAR     (11)                                                                ,  /* （中継用）振込日（西暦） */
     ztyshrgk                                           VARCHAR     (13)                                                                ,  /* （中継用）支払金額 */
     ztyshririyuu1                                      VARCHAR     (32)                                                                ,  /* （中継用）支払理由１ */
     ztyshririyuu2                                      VARCHAR     (32)                                                                ,  /* （中継用）支払理由２ */
     ztyshririyuu3                                      VARCHAR     (32)                                                                ,  /* （中継用）支払理由３ */
     ztysiteikouza1                                     VARCHAR     (32)                                                                ,  /* （中継用）指定口座１ */
     ztysiteikouza2                                     VARCHAR     (32)                                                                ,  /* （中継用）指定口座２ */
     ztysiteikouza3                                     VARCHAR     (32)                                                                ,  /* （中継用）指定口座３ */
     ztysiteikouza4                                     VARCHAR     (32)                                                                ,  /* （中継用）指定口座４ */
     ztysiteikouza5                                     VARCHAR     (32)                                                                ,  /* （中継用）指定口座５ */
     ztytyusyaku                                        VARCHAR     (32)                                                                ,  /* （中継用）注釈 */
     ztyyobiv160                                        VARCHAR     (160)                                                               ,  /* （中継用）予備項目Ｖ１６０ */
...
ALTER TABLE ZT_KouzaHnknTuutiTy ADD CONSTRAINT PK_KouzaHnknTuutiTy PRIMARY KEY (
     ztysyono                                                 , /* （中継用）証券番号 */
