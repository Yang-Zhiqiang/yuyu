CREATE TABLE AM_Sosiki (
     sosikicd                                           VARCHAR     (7)                                                       NOT NULL  ,  /* 組織コード                                         */
     sosikinmkbn                                        VARCHAR     (2)                                                                 ,  /* 組織名区分                                         */
     sosikinm20                                         VARCHAR     (20)                                                                ,  /* 組織名（２０文字）                                     */
     kanjisosikinm20                                    VARCHAR     (20)                                                                ,  /* 漢字組織名（２０文字）                                   */
     ...
     sosikikanjikaijyuusyo30                            VARCHAR     (30)                                                                ,  /* 組織漢字下位住所（３０文字）                                */
     kanjibirunm15                                      VARCHAR     (15)                                                                ,  /* 漢字ビル名称（１５文字）                                  */
     ...
     henkanjisosikikaijyuusyo30                         VARCHAR     (30)                                                                ,  /* (変更後)漢字組織下位住所（３０文字）                           */
     henkanjibirunm15                                   VARCHAR     (15)                                                                ,  /* (変更後)漢字ビル名称（１５文字）                             */
...
ALTER TABLE AM_Sosiki ADD CONSTRAINT AM_SosikiPk PRIMARY KEY (
     sosikicd                                                   /* 組織コード                                          */
) ;
