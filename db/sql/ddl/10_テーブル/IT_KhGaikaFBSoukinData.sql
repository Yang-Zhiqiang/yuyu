CREATE TABLE IT_KhGaikaFBSoukinData (
...
ALTER TABLE IT_KhGaikaFBSoukinData ADD CONSTRAINT PK_KhGaikaFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_KhGaikaFBSoukinData ON IT_KhGaikaFBSoukinData (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_KhGaikaFBSoukinData ON IT_KhGaikaFBSoukinData (
     syono                                                      /* 証券番号 */
) ;
