CREATE TABLE IT_KhLincSousinInfo (
...
ALTER TABLE IT_KhLincSousinInfo ADD CONSTRAINT PK_KhLincSousinInfo PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
...
CREATE INDEX IX1_KhLincSousinInfo ON IT_KhLincSousinInfo (
     lincsoujyusinsyskbn                                      , /* ＬＩＮＣ送受信用システム区分 */
     syono                                                    , /* 証券番号 */
     renno                                                      /* 連番 */
) ;
