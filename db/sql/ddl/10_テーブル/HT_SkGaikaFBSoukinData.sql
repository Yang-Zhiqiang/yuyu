CREATE TABLE HT_SkGaikaFBSoukinData (
...
ALTER TABLE HT_SkGaikaFBSoukinData ADD CONSTRAINT PK_SkGaikaFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SkGaikaFBSoukinData ON HT_SkGaikaFBSoukinData (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_SkGaikaFBSoukinData ON HT_SkGaikaFBSoukinData (
     mosno                                                      /* 申込番号 */
) ;
