CREATE TABLE ZT_BikinKeiyakuSeisandTy (
     ...
     ztykariwariatedganrikin                            NUMBER      (11)                                                                ,  /* （中継用）仮割当Ｄ元利金 */
...
ALTER TABLE ZT_BikinKeiyakuSeisandTy ADD CONSTRAINT PK_BikinKeiyakuSeisandTy PRIMARY KEY (
