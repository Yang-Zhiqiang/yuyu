CREATE TABLE IW_KhKzktrkKykDrHnkWk (
     ...
     trkkzknmkn1                                        VARCHAR     (18)                                                                ,  /* 登録家族名（カナ）１ */
     trkkzknmkj1                                        VARCHAR     (15)                                                                ,  /* 登録家族名（漢字）１ */
     ...
     trkkzkadr1kj1                                      VARCHAR     (30)                                                                ,  /* 登録家族住所１（漢字）１ */
     trkkzkadr2kj1                                      VARCHAR     (30)                                                                ,  /* 登録家族住所２（漢字）１ */
     trkkzkadr3kj1                                      VARCHAR     (30)                                                                ,  /* 登録家族住所３（漢字）１ */
     trkkzktelno1                                       VARCHAR     (14)                                                                ,  /* 登録家族電話番号１ */
     trkkzktdk1                                         VARCHAR     (2)                                                                 ,  /* 登録家族続柄１ */
     trkkzkttdkkbn2                                     VARCHAR     (1)                                                                 ,  /* 登録家族手続区分２ */
     trkkzknmkn2                                        VARCHAR     (18)                                                                ,  /* 登録家族名（カナ）２ */
     trkkzknmkj2                                        VARCHAR     (15)                                                                ,  /* 登録家族名（漢字）２ */
     ...
     trkkzkadr1kj2                                      VARCHAR     (30)                                                                ,  /* 登録家族住所１（漢字）２ */
     trkkzkadr2kj2                                      VARCHAR     (30)                                                                ,  /* 登録家族住所２（漢字）２ */
     trkkzkadr3kj2                                      VARCHAR     (30)                                                                ,  /* 登録家族住所３（漢字）２ */
     ...
     kykdradr1kj                                        VARCHAR     (30)                                                                ,  /* 契約者代理人住所１（漢字） */
     kykdradr2kj                                        VARCHAR     (30)                                                                ,  /* 契約者代理人住所２（漢字） */
     kykdradr3kj                                        VARCHAR     (30)                                                                ,  /* 契約者代理人住所３（漢字） */
...
ALTER TABLE IW_KhKzktrkKykDrHnkWk ADD CONSTRAINT PK_KhKzktrkKykDrHnkWk PRIMARY KEY (
