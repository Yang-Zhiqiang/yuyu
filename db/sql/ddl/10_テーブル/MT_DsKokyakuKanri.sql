CREATE TABLE MT_DsKokyakuKanri (
...
ALTER TABLE MT_DsKokyakuKanri ADD CONSTRAINT PK_DsKokyakuKanri PRIMARY KEY (
     dskokno                                                    /* ＤＳ顧客番号 */
) ;

CREATE INDEX IX1_DsKokyakuKanri ON MT_DsKokyakuKanri (
