CREATE TABLE ZT_KhDrtenMinyuuKykMeisaiTy (
     ...
     ztydrtnbsyunnmisyou                                VARCHAR     (10)                                                                ,  /* （中継用）代理店募集人名称（漢字） */
     ...
     ztyknyukknmei                                      VARCHAR     (26)                                                                ,  /* （中継用）金融機関名 */
     ztyknyykknstnmei                                   VARCHAR     (24)                                                                ,  /* （中継用）金融機関支店名 */
     ztydantaicd                                        VARCHAR     (8)                                                                 ,  /* （中継用）団体コード */
     ztykjdntnm                                         VARCHAR     (35)                                                                ,  /* （中継用）漢字団体名 */
     zty30ketahknsyuruimei                              VARCHAR     (30)                                                                ,  /* （中継用）３０桁保険種類名 */
...
ALTER TABLE ZT_KhDrtenMinyuuKykMeisaiTy ADD CONSTRAINT PK_KhDrtenMinyuuKykMeisaiTy PRIMARY KEY (
