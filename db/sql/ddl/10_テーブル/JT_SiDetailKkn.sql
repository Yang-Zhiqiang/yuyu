CREATE TABLE JT_SiDetailKkn (
     ...
     renno2keta2                                        NUMBER      (2)                                                       NOT NULL  ,  /* 連番（２桁）２                                       */
     ...
     sensingijuturyou                                   NUMBER      (11)                                                                ,  /* 先進医療技術料                                       */
     ...
     hutanpoflg                                         NUMBER      (1)                                                                 ,  /* 不担保フラグ                                        */
     itinyuuingendotyoukaflg                            NUMBER      (1)                                                                 ,  /* 1入院限度超過フラグ                                    */
     tuusangendotyoukaflg                               NUMBER      (1)                                                                 ,  /* 通算限度超過フラグ                                     */
     gannyuuinflg                                       NUMBER      (1)                                                                 ,  /* がん入院フラグ                                       */
...
ALTER TABLE JT_SiDetailKkn ADD CONSTRAINT PK_SiDetailKkn PRIMARY KEY (
     skno                                                     , /* 請求番号                                           */
     syono                                                    , /* 証券番号                                           */
