...
ALTER TABLE IT_KykSya ADD CONSTRAINT PK_KykSya PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_KykSya ON IT_KykSya (
     kyknmkn                                                    /* 契約者名（カナ） */
) ;

CREATE INDEX IX2_KykSya ON IT_KykSya (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX3_KykSya ON IT_KykSya (
     kykseiymd                                                  /* 契約者生年月日 */
) ;

CREATE INDEX IX4_KykSya ON IT_KykSya (
     tsinyno                                                    /* 通信先郵便番号 */
) ;

CREATE INDEX IX5_KykSya ON IT_KykSya (
     tsintelno                                                  /* 通信先電話番号 */
) ;
