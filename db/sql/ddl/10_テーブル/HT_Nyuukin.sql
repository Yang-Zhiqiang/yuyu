...
ALTER TABLE HT_Nyuukin ADD CONSTRAINT PK_Nyuukin PRIMARY KEY (
     mosno                                                    , /* 申込番号 */
     renno                                                      /* 連番 */
) ;

CREATE INDEX IX1_Nyuukin ON HT_Nyuukin (
     nyksyoriymd                                              , /* 入金処理日 */
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX2_Nyuukin ON HT_Nyuukin (
     nyksyoriymd                                              , /* 入金処理日 */
     rstuukasyu                                               , /* 領収通貨種類 */
