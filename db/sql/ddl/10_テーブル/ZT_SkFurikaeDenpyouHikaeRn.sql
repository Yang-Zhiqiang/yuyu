CREATE TABLE ZT_SkFurikaeDenpyouHikaeRn (
     ...
     zrnkjhikaeinjikm                                   VARCHAR     (3)                                                       NOT NULL  ,  /* （連携用）漢字控印字項目 */
     ...
     zrnkanjyoukbnnm                                    VARCHAR     (6)                                                       NOT NULL  ,  /* （連携用）勘定区分名 */
     zrnkjtantoukanm                                    VARCHAR     (8)                                                       NOT NULL  ,  /* （連携用）漢字担当課名 */
     zrnkjtantoucd                                      VARCHAR     (1)                                                       NOT NULL  ,  /* （連携用）漢字担当コード */
     zrnkjsystemnm                                      VARCHAR     (10)                                                      NOT NULL  ,  /* （連携用）漢字システム名 */
     zrnkarikurikosikingaku                             CHAR        (12)                                                      NOT NULL  ,  /* （連携用）借方繰越金額 */
     zrnkasikurikosikingaku                             CHAR        (12)                                                      NOT NULL  ,  /* （連携用）貸方繰越金額 */
     zrndenpyoukbnnm                                    VARCHAR     (4)                                                       NOT NULL  ,  /* （連携用）伝票区分名 */
     zrnkjkarikurikosigkhyjkm                           VARCHAR     (2)                                                       NOT NULL  ,  /* （連携用）漢字借方繰越合計表示項目 */
     zrnkarikurikosigkkingaku                           CHAR        (13)                                                      NOT NULL  ,  /* （連携用）借方繰越合計金額 */
     zrnkjkasikurikosigkhyjkm                           VARCHAR     (2)                                                       NOT NULL  ,  /* （連携用）漢字貸方繰越合計表示項目 */
     zrnkasikurikosigkkingaku                           CHAR        (13)                                                      NOT NULL  ,  /* （連携用）貸方繰越合計金額 */
     zrnkjtekiyou1                                      VARCHAR     (70)                                                      NOT NULL  ,  /* （連携用）漢字摘要１ */
     zrnkjtekiyou2                                      VARCHAR     (70)                                                      NOT NULL  ,  /* （連携用）漢字摘要２ */
     zrnkjtekiyou3                                      VARCHAR     (70)                                                      NOT NULL  ,  /* （連携用）漢字摘要３ */
     zrnkjkarikanjyoukamokunm1                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字借方勘定科目名１ */
     zrnkjkasikanjyoukamokunm1                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字貸方勘定科目名１ */
     ...
     zrnkjkaritekiyoukm1                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字借方摘要項目１ */
     zrnkjkasitekiyoukm1                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字貸方摘要項目１ */
     zrnkjkarikanjyoukamokunm2                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字借方勘定科目名２ */
     zrnkjkasikanjyoukamokunm2                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字貸方勘定科目名２ */
     ...
     zrnkjkaritekiyoukm2                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字借方摘要項目２ */
     zrnkjkasitekiyoukm2                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字貸方摘要項目２ */
     zrnkjkarikanjyoukamokunm3                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字借方勘定科目名３ */
     zrnkjkasikanjyoukamokunm3                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字貸方勘定科目名３ */
     ...
     zrnkjkaritekiyoukm3                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字借方摘要項目３ */
     zrnkjkasitekiyoukm3                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字貸方摘要項目３ */
     zrnkjkarikanjyoukamokunm4                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字借方勘定科目名４ */
     zrnkjkasikanjyoukamokunm4                          VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）漢字貸方勘定科目名４ */
     ...
     zrnkjkaritekiyoukm4                                VARCHAR     (26)                                                      NOT NULL  ,  /* （連携用）漢字借方摘要項目４ */
     zrnkjkasitekiyoukm4                                VARCHAR     (26)                                                      NOT NULL     /* （連携用）漢字貸方摘要項目４ */
)
;

ALTER TABLE ZT_SkFurikaeDenpyouHikaeRn ADD CONSTRAINT PK_SkFurikaeDenpyouHikaeRn PRIMARY KEY (
