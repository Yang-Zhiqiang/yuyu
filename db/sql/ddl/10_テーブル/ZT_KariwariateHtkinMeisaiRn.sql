CREATE TABLE ZT_KariwariateHtkinMeisaiRn (
     ...
     zrnznnndkrkskrwratdruigk                           NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）前年度繰越仮割当Ｄ累計額 */
     zrntounendokariwariated                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）当年度仮割当Ｄ */
     zrntndmatukrkskrwratdruigk                         NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）当年度末仮割当Ｄ累計額 */
     zrnkariwariatedrisoku                              NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）仮割当Ｄ利息 */
...
ALTER TABLE ZT_KariwariateHtkinMeisaiRn ADD CONSTRAINT PK_KariwariateHtkinMeisaiRn PRIMARY KEY (
