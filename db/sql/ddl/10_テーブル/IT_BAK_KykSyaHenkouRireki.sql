CREATE TABLE IT_BAK_KykSyaHenkouRireki (
     ...
     oldkyknmkn                                         VARCHAR     (18)                                                                ,  /* （旧）契約者名（カナ） */
...
ALTER TABLE IT_BAK_KykSyaHenkouRireki ADD CONSTRAINT PK_BAK_KykSyaHenkouRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
