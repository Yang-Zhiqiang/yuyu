...
ALTER TABLE IT_KykDairiten ADD CONSTRAINT PK_KykDairiten PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     drtenrenno                                                 /* 代理店連番 */
) ;

CREATE INDEX IX1_KykDairiten ON IT_KykDairiten (
     syono                                                    , /* 証券番号 */
     drtenrenno                                                 /* 代理店連番 */
) ;

CREATE INDEX IX2_KykDairiten ON IT_KykDairiten (
     drtencd                                                    /* 代理店コード */
) ;
