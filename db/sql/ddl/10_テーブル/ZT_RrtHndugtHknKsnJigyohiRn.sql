CREATE TABLE ZT_RrtHndugtHknKsnJigyohiRn (
     ...
     zrnpjuutoujikawaserate                             NUMBER      (9,6)                                                     NOT NULL  ,  /* （連携用）保険料充当時為替レート */
     ...
     zrnyobin13                                         NUMBER      (13)                                                      NOT NULL  ,  /* （連携用）予備項目Ｎ１３ */
     zrnphireilwrbkritu                                 NUMBER      (13,11)                                                   NOT NULL  ,  /* （連携用）Ｐ比例Ｌ割引率 */
     zrngetumatutumitatekin                             NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）月末積立金 */
...
ALTER TABLE ZT_RrtHndugtHknKsnJigyohiRn ADD CONSTRAINT PK_RrtHndugtHknKsnJigyohiRn PRIMARY KEY (
