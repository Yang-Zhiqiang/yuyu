CREATE TABLE ZT_KoujyoSyoumeiRn (
     ...
     zrnuktnmkn                                         VARCHAR     (18)                                                      NOT NULL  ,  /* （連携用）受取人名（カナ） */
     ...
     zrnsyoumeinndseireki                               VARCHAR     (5)                                                       NOT NULL  ,  /* （連携用）証明年度（西暦） */
     zrnuktnmknmeikj                                    VARCHAR     (17)                                                      NOT NULL  ,  /* （連携用）受取人名（漢字） */
     zrnnenkinuktseiymdseireki                          VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）年金受取人生年月日（西暦） */
     zrnsyono3                                          CHAR        (11)                                                      NOT NULL  ,  /* （連携用）証券番号３ */
     zrnhknsyurui                                       VARCHAR     (15)                                                      NOT NULL  ,  /* （連携用）保険種類 */
     ...
     zrnnkshrstartymdseireki                            VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）年金支払開始日（西暦） */
     ...
     zrnuktmidasi                                       VARCHAR     (3)                                                       NOT NULL  ,  /* （連携用）受取人見出し */
     zrnmidasisub                                       VARCHAR     (5)                                                       NOT NULL  ,  /* （連携用）見出し副題 */
     zrnkoujyosyoumeifreearea                           VARCHAR     (10)                                                      NOT NULL  ,  /* （連携用）控除証明書フリーエリア */
     ...
     zrnphrkkknjyoutai                                  VARCHAR     (4)                                                       NOT NULL  ,  /* （連携用）保険料払込状態 */
     zrnsyoumeiymdseireki                               VARCHAR     (11)                                                      NOT NULL  ,  /* （連携用）証明日（西暦） */
...
ALTER TABLE ZT_KoujyoSyoumeiRn ADD CONSTRAINT PK_KoujyoSyoumeiRn PRIMARY KEY (
