CREATE TABLE ZT_IdCardKihonRn (
     ...
     zrnkanjiidnyuuryokusyanm                           VARCHAR     (10)                                                      NOT NULL  ,  /* （連携用）漢字ＩＤ入力者名 */
...
ALTER TABLE ZT_IdCardKihonRn ADD CONSTRAINT PK_IdCardKihonRn PRIMARY KEY (
     zrnidkbn                                                 , /* （連携用）ＩＤ区分 */
     zrnidcd                                                    /* （連携用）ＩＤコード */
) ;
