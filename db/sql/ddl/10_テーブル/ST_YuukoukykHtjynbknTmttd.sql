CREATE TABLE ST_YuukoukykHtjynbknTmttd (
...
ALTER TABLE ST_YuukoukykHtjynbknTmttd ADD CONSTRAINT PK_YuukoukykHtjynbknTmttd PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
