CREATE TABLE BT_HijynNykSikinIdouListSks (
...
ALTER TABLE BT_HijynNykSikinIdouListSks ADD CONSTRAINT PK_HijynNykSikinIdouListSks PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     sikinidoupjytym                                            /* 資金移動用保険料充当年月 */
) ;

CREATE INDEX IX1_HijynNykSikinIdouListSks ON BT_HijynNykSikinIdouListSks (
