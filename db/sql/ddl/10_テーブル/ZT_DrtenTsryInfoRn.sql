CREATE TABLE ZT_DrtenTsryInfoRn (
     ...
     zrnatkiwari                                        NUMBER      (3,2)                                                     NOT NULL  ,  /* （連携用）扱割合 */
     zrndairitenatkinin                                 NUMBER      (1)                                                       NOT NULL  ,  /* （連携用）代理店扱人数 */
     zrntsrkeisansyukykhsyos                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）手数料計算用主契約保障Ｓ */
     zrnhtns                                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）被転換Ｓ */
     zrnkijymods                                        NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）計上修正Ｓ */
     zrnksnbubunmods                                    NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）加算部分修正Ｓ */
     zrnbfrkijymods                                     NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）変更前計上修正Ｓ */
     zrnbfrksnbubunmods                                 NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）変更前加算部分修正Ｓ */
     ...
     zrnbfritijibrzugkp                                 NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前一時払増額Ｐ */
     ...
     zrndai2ksnbubunmods                                NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）第２加算部分修正Ｓ */
     zrndai2bfrksnbubunmods                             NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）第２変更前加算部分修正Ｓ */
     zrnphrkkikn                                        CHAR        (2)                                                       NOT NULL  ,  /* （連携用）Ｐ払込期間 */
     zrnjissyuup                                        NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）実収Ｐ */
     zrngntikktgtiryoutkp                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）限定告知型医療特約Ｐ */
     zrnbfrgntikktgtiryoutkp                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前限定告知型医療特約Ｐ */
     ...
     zrnsisttkp                                         NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）災疾特約Ｐ */
     zrnreguardtkp                                      NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）リガード特約Ｐ */
     zrnvguardtkp                                       NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）Ｖガード特約Ｐ */
     zrnbfrsisttkp                                      NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前災疾特約Ｐ */
     zrnbfrreguardtkp                                   NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前リガード特約Ｐ */
     zrnbfrvguardtkp                                    NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前Ｖガード特約Ｐ */
     zrngtmtv                                           NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）月末Ｖ */
     zrnsyukeiyakup                                     NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）主契約Ｐ */
     zrnbfrsyup                                         NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前主契約Ｐ */
     zrndairitentsratkiwari                             NUMBER      (3,2)                                                     NOT NULL  ,  /* （連携用）代理店手数料扱割合 */
     ...
     zrnitijibrzugkp                                    NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）一時払増額Ｐ */
     zrntuuintokuyakup                                  NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）通院特約Ｐ */
     zrnbfrtuuintkp                                     NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前通院特約Ｐ */
     zrnsougousonsyoutokuyakup                          NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）総合損傷特約Ｐ */
     zrnbfrsugusnsyutkp                                 NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前総合損傷特約Ｐ */
     zrnyoteiriritun5                                   NUMBER      (5,4)                                                     NOT NULL  ,  /* （連携用）予定利率Ｎ５ */
     zrnyouikunenkintokuyakup                           NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）養育年金特約Ｐ */
     zrnbfryoiknktkp                                    NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前養育年金特約Ｐ */
     zrngntikktgtiryoutkntgk                            NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）限定告知型医療特約日額 */
     ...
     zrnsyouhizeiritu                                   NUMBER      (5,3)                                                     NOT NULL  ,  /* （連携用）消費税率 */
     ...
     zrnkigmrsytkp                                      NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）介護マル終特約Ｐ */
     zrnbfrkigmrsytkp                                   NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前介護マル終特約Ｐ */
     zrnkigmrsytkphrkkkn                                CHAR        (2)                                                       NOT NULL  ,  /* （連携用）介護マル終特約Ｐ払込期間 */
     zrnyobiv5                                          CHAR        (5)                                                       NOT NULL  ,  /* （連携用）予備項目Ｖ５ */
     zrnphenkanbfrsyup                                  NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）Ｐ返還用変更前主契約Ｐ */
     ...
     zrnsyukeiyakupkyktuuka                             NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）主契約Ｐ（契約通貨） */
     zrnbfrsyupkyktuuka                                 NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）変更前主契約Ｐ（契約通貨） */
     zrntekiyoukawaserate7keta                          NUMBER      (7,2)                                                     NOT NULL  ,  /* （連携用）適用為替レート（７桁） */
     zrnyobiv22                                         CHAR        (22)                                                      NOT NULL  ,  /* （連携用）予備項目Ｖ２２ */
     zrnyobiv83                                         CHAR        (83)                                                      NOT NULL     /* （連携用）予備項目Ｖ８３ */
)
;

ALTER TABLE ZT_DrtenTsryInfoRn ADD CONSTRAINT PK_DrtenTsryInfoRn PRIMARY KEY (
