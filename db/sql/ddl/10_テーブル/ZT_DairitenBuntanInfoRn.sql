CREATE TABLE ZT_DairitenBuntanInfoRn (
     ...
     zrntesuuryoubuntanwariai                           NUMBER      (3)                                                       NOT NULL  ,  /* （連携用）手数料分担割合 */
     zrnyobiv67                                         CHAR        (67)                                                      NOT NULL     /* （連携用）予備項目Ｖ６７ */
)
;

ALTER TABLE ZT_DairitenBuntanInfoRn ADD CONSTRAINT PK_DairitenBuntanInfoRn PRIMARY KEY (
