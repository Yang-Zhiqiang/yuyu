CREATE TABLE ZT_KzhuriSyuunouKekkaTr (
...
ALTER TABLE ZT_KzhuriSyuunouKekkaTr ADD CONSTRAINT PK_KzhuriSyuunouKekkaTr PRIMARY KEY (
     ztrsyono                                                 , /* （取込用）証券番号 */
