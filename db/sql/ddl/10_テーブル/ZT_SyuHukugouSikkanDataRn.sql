CREATE TABLE ZT_SyuHukugouSikkanDataRn (
     ...
     zrnijitoukeikeikan                                 NUMBER      (11,3)                                                    NOT NULL  ,  /* （連携用）医事統計用経過Ｎ */
     zrnijitoukeisiboun                                 NUMBER      (5)                                                       NOT NULL  ,  /* （連携用）医事統計用死亡Ｎ */
     zrnijitoukeikeikas                                 NUMBER      (11,1)                                                    NOT NULL  ,  /* （連携用）医事統計用経過Ｓ */
     zrnijitoukeisibous                                 NUMBER      (9)                                                       NOT NULL  ,  /* （連携用）医事統計用死亡Ｓ */
     zrnyobiv20                                         CHAR        (20)                                                      NOT NULL     /* （連携用）予備項目Ｖ２０ */
)
;

ALTER TABLE ZT_SyuHukugouSikkanDataRn ADD CONSTRAINT PK_SyuHukugouSikkanDataRn PRIMARY KEY (
