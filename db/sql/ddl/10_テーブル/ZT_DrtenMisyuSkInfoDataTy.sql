CREATE TABLE ZT_DrtenMisyuSkInfoDataTy (
     ...
     zty1kaip                                           NUMBER      (11)                                                                ,  /* （中継用）１回分保険料 */
     ztynexthurikaeyoteigk                              NUMBER      (11)                                                                ,  /* （中継用）次回振替予定金額 */
...
ALTER TABLE ZT_DrtenMisyuSkInfoDataTy ADD CONSTRAINT PK_DrtenMisyuSkInfoDataTy PRIMARY KEY (
     ztysyono                                                 , /* （中継用）証券番号 */
