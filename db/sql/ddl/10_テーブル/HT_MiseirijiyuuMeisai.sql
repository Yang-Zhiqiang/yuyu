CREATE TABLE HT_MiseirijiyuuMeisai (
     ...
     krkdai1kaikeijyougkyen                             NUMBER      (13)                                                                ,  /* 仮受金（第１回）計上額（円） */
     krkdai1kaikeijyougkyen$                            VARCHAR     (10)                                                                ,  /* 仮受金（第１回）計上額（円）(通貨型) */
     krkdai1kaikeijyougkgaika                           NUMBER      (13)                                                                ,  /* 仮受金（第１回）計上額（外貨） */
     krkdai1kaikeijyougkgaika$                          VARCHAR     (10)                                                                ,  /* 仮受金（第１回）計上額（外貨）(通貨型) */
     krkdai1kaituukasyu                                 VARCHAR     (3)                                                                    /* 仮受金（第１回）通貨種類 */
)
;

ALTER TABLE HT_MiseirijiyuuMeisai ADD CONSTRAINT PK_MiseirijiyuuMeisai PRIMARY KEY (
     mosno                                                      /* 申込番号 */
) ;
