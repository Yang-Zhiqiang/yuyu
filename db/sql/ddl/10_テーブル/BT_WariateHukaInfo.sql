CREATE TABLE BT_WariateHukaInfo (
...
ALTER TABLE BT_WariateHukaInfo ADD CONSTRAINT PK_WariateHukaInfo PRIMARY KEY (
...
CREATE INDEX IX1_WariateHukaInfo ON BT_WariateHukaInfo (
     kouteikanriid                                            , /* 工程管理ＩＤ */
     subSystemId                                              , /* サブシステムＩＤ */
     jimutetuzukicd                                           , /* 事務手続コード */
     wrthukatskid                                               /* 割当不可タスクID */
