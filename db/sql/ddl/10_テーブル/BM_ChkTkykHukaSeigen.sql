CREATE TABLE BM_ChkTkykHukaSeigen (
     ...
     sntkhoukbnfrom                                     NUMBER      (2)                                                       NOT NULL  ,  /* 選択方法区分自                                       */
     sntkhoukbnto                                       NUMBER      (2)                                                       NOT NULL  ,  /* 選択方法区分至                                       */
...
ALTER TABLE BM_ChkTkykHukaSeigen ADD CONSTRAINT PK_ChkTkykHukaSeigen PRIMARY KEY (
