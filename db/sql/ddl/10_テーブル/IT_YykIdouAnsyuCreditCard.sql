CREATE TABLE IT_YykIdouAnsyuCreditCard (
...
ALTER TABLE IT_YykIdouAnsyuCreditCard ADD CONSTRAINT PK_YykIdouAnsyuCreditCard PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;

CREATE INDEX IX1_YykIdouAnsyuCreditCard ON IT_YykIdouAnsyuCreditCard (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;
