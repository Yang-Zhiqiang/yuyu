CREATE TABLE HT_SkHubiDetail (
     ...
     skrenrakujikou                                     VARCHAR     (4672)                                                              ,  /* 新契約連絡事項 */
...
ALTER TABLE HT_SkHubiDetail ADD CONSTRAINT PK_SkHubiDetail PRIMARY KEY (
     mosno                                                    , /* 申込番号 */
     hubisikibetukey                                          , /* 不備識別キー */
     renno3keta                                                 /* 連番（３桁） */
) ;

CREATE INDEX IX1_SkHubiDetail ON HT_SkHubiDetail (
     hasinymd                                                   /* 発信日 */
) ;
