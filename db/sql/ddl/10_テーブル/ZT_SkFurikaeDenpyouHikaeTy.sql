CREATE TABLE ZT_SkFurikaeDenpyouHikaeTy (
     ...
     ztykjhikaeinjikm                                   VARCHAR     (3)                                                                 ,  /* （中継用）漢字控印字項目                                  */
     ...
     ztykanjyoukbnnm                                    VARCHAR     (6)                                                                 ,  /* （中継用）勘定区分名                                    */
     ztykjtantoukanm                                    VARCHAR     (8)                                                                 ,  /* （中継用）漢字担当課名                                   */
     ztykjtantoucd                                      VARCHAR     (1)                                                                 ,  /* （中継用）漢字担当コード                                  */
     ztykjsystemnm                                      VARCHAR     (10)                                                                ,  /* （中継用）漢字システム名                                  */
     ztykarikurikosikingaku                             VARCHAR     (12)                                                                ,  /* （中継用）借方繰越金額                                   */
     ztykasikurikosikingaku                             VARCHAR     (12)                                                                ,  /* （中継用）貸方繰越金額                                   */
     ztydenpyoukbnnm                                    VARCHAR     (4)                                                                 ,  /* （中継用）伝票区分名                                    */
     ztykjkarikurikosigkhyjkm                           VARCHAR     (2)                                                                 ,  /* （中継用）漢字借方繰越合計表示項目                             */
     ztykarikurikosigkkingaku                           VARCHAR     (13)                                                                ,  /* （中継用）借方繰越合計金額                                 */
     ztykjkasikurikosigkhyjkm                           VARCHAR     (2)                                                                 ,  /* （中継用）漢字貸方繰越合計表示項目                             */
     ztykasikurikosigkkingaku                           VARCHAR     (13)                                                                ,  /* （中継用）貸方繰越合計金額                                 */
     ztykjtekiyou1                                      VARCHAR     (70)                                                                ,  /* （中継用）漢字摘要１                                    */
     ztykjtekiyou2                                      VARCHAR     (70)                                                                ,  /* （中継用）漢字摘要２                                    */
     ztykjtekiyou3                                      VARCHAR     (70)                                                                ,  /* （中継用）漢字摘要３                                    */
     ztykjkarikanjyoukamokunm1                          VARCHAR     (20)                                                                ,  /* （中継用）漢字借方勘定科目名１                               */
     ztykjkasikanjyoukamokunm1                          VARCHAR     (20)                                                                ,  /* （中継用）漢字貸方勘定科目名１                               */
     ...
     ztykjkaritekiyoukm1                                VARCHAR     (26)                                                                ,  /* （中継用）漢字借方摘要項目１                                */
     ztykjkasitekiyoukm1                                VARCHAR     (26)                                                                ,  /* （中継用）漢字貸方摘要項目１                                */
     ztykjkarikanjyoukamokunm2                          VARCHAR     (20)                                                                ,  /* （中継用）漢字借方勘定科目名２                               */
     ztykjkasikanjyoukamokunm2                          VARCHAR     (20)                                                                ,  /* （中継用）漢字貸方勘定科目名２                               */
     ...
     ztykjkaritekiyoukm2                                VARCHAR     (26)                                                                ,  /* （中継用）漢字借方摘要項目２                                */
     ztykjkasitekiyoukm2                                VARCHAR     (26)                                                                ,  /* （中継用）漢字貸方摘要項目２                                */
     ztykjkarikanjyoukamokunm3                          VARCHAR     (20)                                                                ,  /* （中継用）漢字借方勘定科目名３                               */
     ztykjkasikanjyoukamokunm3                          VARCHAR     (20)                                                                ,  /* （中継用）漢字貸方勘定科目名３                               */
     ...
     ztykjkaritekiyoukm3                                VARCHAR     (26)                                                                ,  /* （中継用）漢字借方摘要項目３                                */
     ztykjkasitekiyoukm3                                VARCHAR     (26)                                                                ,  /* （中継用）漢字貸方摘要項目３                                */
     ztykjkarikanjyoukamokunm4                          VARCHAR     (20)                                                                ,  /* （中継用）漢字借方勘定科目名４                               */
     ztykjkasikanjyoukamokunm4                          VARCHAR     (20)                                                                ,  /* （中継用）漢字貸方勘定科目名４                               */
     ...
     ztykjkaritekiyoukm4                                VARCHAR     (26)                                                                ,  /* （中継用）漢字借方摘要項目４                                */
     ztykjkasitekiyoukm4                                VARCHAR     (26)                                                                ,  /* （中継用）漢字貸方摘要項目４                                */
...
ALTER TABLE ZT_SkFurikaeDenpyouHikaeTy ADD CONSTRAINT PK_SkFurikaeDenpyouHikaeTy PRIMARY KEY (
