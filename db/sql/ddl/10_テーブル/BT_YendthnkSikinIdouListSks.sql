CREATE TABLE BT_YendthnkSikinIdouListSks (
...
ALTER TABLE BT_YendthnkSikinIdouListSks ADD CONSTRAINT PK_YendthnkSikinIdouListSks PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     keiriyendthnkkbn                                         , /* 経理用円建変更区分 */
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX1_YendthnkSikinIdouListSks ON BT_YendthnkSikinIdouListSks (
     syoriYmd                                                   /* 処理年月日 */
) ;
