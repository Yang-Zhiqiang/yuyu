CREATE TABLE BT_YendthnkSikinIdouData (
...
ALTER TABLE BT_YendthnkSikinIdouData ADD CONSTRAINT PK_YendthnkSikinIdouData PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     keiriyendthnkkbn                                         , /* 経理用円建変更区分 */
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX1_YendthnkSikinIdouData ON BT_YendthnkSikinIdouData (
     syoriYmd                                                   /* 処理年月日 */
) ;
