CREATE TABLE IT_YykIdouNaiyoHrhnk (
...
ALTER TABLE IT_YykIdouNaiyoHrhnk ADD CONSTRAINT PK_YykIdouNaiyoHrhnk PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;

CREATE INDEX IX1_YykIdouNaiyoHrhnk ON IT_YykIdouNaiyoHrhnk (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;
