CREATE TABLE ZT_EgsyokuinSysRendouTy (
     ...
     ztydrtenegsyokuinatkiwari                          NUMBER      (3)                                                                 ,  /* （中継用）代理店営業職員扱割合 */
     ...
     ztybosdairitentsratkiwari                          NUMBER      (3)                                                                 ,  /* （中継用）募集代理店手数料扱割合 */
...
ALTER TABLE ZT_EgsyokuinSysRendouTy ADD CONSTRAINT PK_EgsyokuinSysRendouTy PRIMARY KEY (
