CREATE TABLE ZT_IjiToukeiIdouInfoRn (
     ...
     zrnyobisuuti7x1                                    NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）予備数値７＿１ */
     zrnyobisuuti7x2                                    NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）予備数値７＿２ */
     zrnyobimojihan15                                   CHAR        (15)                                                      NOT NULL  ,  /* （連携用）予備文字半角１５ */
     zrnyobimojihan51                                   CHAR        (51)                                                      NOT NULL     /* （連携用）予備文字半角５１ */
)
;

ALTER TABLE ZT_IjiToukeiIdouInfoRn ADD CONSTRAINT PK_IjiToukeiIdouInfoRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
