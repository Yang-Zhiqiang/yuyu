CREATE TABLE IT_KhHubiMikaisyouList (
     ...
     hubitourokuktntnm                                  VARCHAR     (15)                                                                ,  /* 不備登録担当者名                                      */
     hubisyouninktntnm                                  VARCHAR     (15)                                                                ,  /* 不備承認担当者名                                      */
     hassinkaisuu                                       NUMBER      (2)                                                                 ,  /* 発信回数                                          */
...
ALTER TABLE IT_KhHubiMikaisyouList ADD CONSTRAINT PK_KhHubiMikaisyouList PRIMARY KEY (
