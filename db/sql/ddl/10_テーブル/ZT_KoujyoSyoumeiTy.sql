CREATE TABLE ZT_KoujyoSyoumeiTy (
     ...
     ztyuktnmkn                                         VARCHAR     (18)                                                                ,  /* （中継用）受取人名（カナ） */
     ...
     ztysyoumeinndseireki                               VARCHAR     (5)                                                                 ,  /* （中継用）証明年度（西暦） */
     ztyuktnmknmeikj                                    VARCHAR     (17)                                                                ,  /* （中継用）受取人名（漢字） */
     ztynenkinuktseiymdseireki                          VARCHAR     (11)                                                                ,  /* （中継用）年金受取人生年月日（西暦） */
     ztysyono3                                          VARCHAR     (11)                                                                ,  /* （中継用）証券番号３ */
     ztyhknsyurui                                       VARCHAR     (15)                                                                ,  /* （中継用）保険種類 */
     ...
     ztynkshrstartymdseireki                            VARCHAR     (11)                                                                ,  /* （中継用）年金支払開始日（西暦） */
     ztyphrkkkn                                         VARCHAR     (2)                                                                 ,  /* （中継用）保険料払込期間 */
     ztyhrkkaisuunm                                     VARCHAR     (2)                                                                 ,  /* （中継用）払込回数（数） */
     ztykjnnkkoujyum                                    VARCHAR     (1)                                                                 ,  /* （中継用）個人年金控除有無 */
     ztyuktmidasi                                       VARCHAR     (3)                                                                 ,  /* （中継用）受取人見出し */
     ztymidasisub                                       VARCHAR     (5)                                                                 ,  /* （中継用）見出し副題 */
     ztykoujyosyoumeifreearea                           VARCHAR     (10)                                                                ,  /* （中継用）控除証明書フリーエリア */
     ...
     ztyphrkkknjyoutai                                  VARCHAR     (4)                                                                 ,  /* （中継用）保険料払込状態 */
     ztysyoumeiymdseireki                               VARCHAR     (11)                                                                ,  /* （中継用）証明日（西暦） */
...
ALTER TABLE ZT_KoujyoSyoumeiTy ADD CONSTRAINT PK_KoujyoSyoumeiTy PRIMARY KEY (
