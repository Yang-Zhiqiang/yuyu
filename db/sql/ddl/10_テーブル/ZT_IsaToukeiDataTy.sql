CREATE TABLE ZT_IsaToukeiDataTy (
     ...
     ztysibous7                                         NUMBER      (7)                                                                 ,  /* （中継用）死亡Ｓ（７桁） */
     ...
     ztyjissituhosyous                                  NUMBER      (7)                                                                 ,  /* （中継用）実質保障Ｓ */
     ...
     ztyteikisiharaikinmanen                            NUMBER      (7)                                                                 ,  /* （中継用）定期支払金（万円） */
...
ALTER TABLE ZT_IsaToukeiDataTy ADD CONSTRAINT PK_IsaToukeiDataTy PRIMARY KEY (
     ztymosno                                                   /* （中継用）申込番号 */
) ;
