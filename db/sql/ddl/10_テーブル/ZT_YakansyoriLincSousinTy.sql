CREATE TABLE ZT_YakansyoriLincSousinTy (
     ...
     ztyknjhhknmei30                                    VARCHAR     (30)                                                                ,  /* （中継用）漢字被保険者名（３０桁） */
     ztykjkyknm30                                       VARCHAR     (30)                                                                ,  /* （中継用）漢字契約者名（３０桁） */
...
ALTER TABLE ZT_YakansyoriLincSousinTy ADD CONSTRAINT PK_YakansyoriLincSousinTy PRIMARY KEY (
