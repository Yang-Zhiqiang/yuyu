CREATE TABLE IT_HokenSyoukenHukaInfo (
...
ALTER TABLE IT_HokenSyoukenHukaInfo ADD CONSTRAINT PK_HokenSyoukenHukaInfo PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;

CREATE INDEX IX1_HokenSyoukenHukaInfo ON IT_HokenSyoukenHukaInfo (
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;

CREATE INDEX IX2_HokenSyoukenHukaInfo ON IT_HokenSyoukenHukaInfo (
     tyouhyouymd                                                /* 帳票作成日 */
) ;
