...
ALTER TABLE JT_SkKihon ADD CONSTRAINT PK_SkKihon PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_SkKihon ON JT_SkKihon (
     seikyuusyubetu                                             /* 請求種別 */
) ;

CREATE INDEX IX2_SkKihon ON JT_SkKihon (
     gaibuinsatuoutymd                                          /* 外部印刷出力日 */
) ;

CREATE INDEX IX3_SkKihon ON JT_SkKihon (
