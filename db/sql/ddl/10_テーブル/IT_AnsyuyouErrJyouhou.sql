CREATE TABLE IT_AnsyuyouErrJyouhou (
     ...
     ansyuyouerrnaiyou                                  VARCHAR     (70)                                                      NOT NULL  ,  /* 案内収納用エラー内容 */
...
ALTER TABLE IT_AnsyuyouErrJyouhou ADD CONSTRAINT PK_AnsyuyouErrJyouhou PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
