CREATE TABLE ZT_SntkInfoTourokuTy (
     ...
     ztytaisyounm                                       VARCHAR     (18)                                                                ,  /* （中継用）対象者名 */
     ztykjtaisyounm                                     VARCHAR     (15)                                                                ,  /* （中継用）漢字対象者名 */
...
ALTER TABLE ZT_SntkInfoTourokuTy ADD CONSTRAINT PK_SntkInfoTourokuTy PRIMARY KEY (
