CREATE TABLE ZT_FstpUriageSeikyuuDataRn (
     ...
     zrnseikyuukngk11keta                               NUMBER      (11)                                                      NOT NULL  ,  /* （連携用）請求金額（１１桁） */
...
ALTER TABLE ZT_FstpUriageSeikyuuDataRn ADD CONSTRAINT PK_FstpUriageSeikyuuDataRn PRIMARY KEY (
