CREATE TABLE IT_DattaiTuutiKzhuri (
     ...
     osirasemongon1                                     VARCHAR     (52)                                                                ,  /* お知らせ文言１ */
     osirasemongon2                                     VARCHAR     (52)                                                                ,  /* お知らせ文言２ */
     osirasemongon3                                     VARCHAR     (52)                                                                ,  /* お知らせ文言３ */
     osirasemongon4                                     VARCHAR     (52)                                                                ,  /* お知らせ文言４ */
     osirasemongon5                                     VARCHAR     (52)                                                                ,  /* お知らせ文言５ */
     osirasemongon6                                     VARCHAR     (52)                                                                ,  /* お知らせ文言６ */
     osirasemongon7                                     VARCHAR     (52)                                                                ,  /* お知らせ文言７ */
     osirasemongon8                                     VARCHAR     (52)                                                                ,  /* お知らせ文言８ */
     osirasemongon9                                     VARCHAR     (52)                                                                ,  /* お知らせ文言９ */
     hhknnmkj                                           VARCHAR     (15)                                                                ,  /* 被保険者名（漢字） */
     kzinfo30keta1                                      VARCHAR     (30)                                                                ,  /* 口座情報（３０桁）１ */
     kzinfo30keta2                                      VARCHAR     (30)                                                                ,  /* 口座情報（３０桁）２ */
     kzinfo30keta3                                      VARCHAR     (30)                                                                ,  /* 口座情報（３０桁）３ */
...
ALTER TABLE IT_DattaiTuutiKzhuri ADD CONSTRAINT PK_IT_DattaiTuutiKzhuri PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;
