CREATE TABLE ZT_DrtenKykIdouDetailRn (
     ...
     zrnkykmfksnctrlkh                                  NUMBER      (7)                                                       NOT NULL  ,  /* （連携用）契約ＭＦ更新ＣＴＲ（保全） */
     ...
     zrnkjsyagaihknnm                                   VARCHAR     (30)                                                      NOT NULL  ,  /* （連携用）漢字社外向け保険名 */
     zrntelno                                           CHAR        (14)                                                      NOT NULL  ,  /* （連携用）電話番号 */
     zrnhensyuubosyuudrtennm                            VARCHAR     (27)                                                      NOT NULL  ,  /* （連携用）編集後漢字募集代理店名 */
     zrnkyknmkjdirtnkykido                              VARCHAR     (20)                                                      NOT NULL  ,  /* （連携用）契約者名（漢字）（代理店契約異動明細） */
     ...
     zrnhjnnmkj                                         VARCHAR     (35)                                                      NOT NULL  ,  /* （連携用）法人名（漢字） */
...
ALTER TABLE ZT_DrtenKykIdouDetailRn ADD CONSTRAINT PK_DrtenKykIdouDetailRn PRIMARY KEY (
