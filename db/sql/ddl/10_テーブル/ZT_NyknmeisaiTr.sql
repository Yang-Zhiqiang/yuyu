CREATE TABLE ZT_NyknmeisaiTr (
     ...
     ztrsimukebanknmkn                                  VARCHAR     (15)                                                                ,  /* （取込用）仕向銀行名 */
     ztrsimuketennmkn                                   VARCHAR     (15)                                                                ,  /* （取込用）仕向店名 */
     ztrtekiyounaiyou                                   VARCHAR     (20)                                                                ,  /* （取込用）摘要内容 */
...
ALTER TABLE ZT_NyknmeisaiTr ADD CONSTRAINT PK_NyknmeisaiTr PRIMARY KEY (
