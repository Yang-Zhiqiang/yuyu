CREATE TABLE MT_DsKokyakuKanri_Z (
     ...
     dskokyakunmkn                                      VARCHAR     (62)                                                                ,  /* ＤＳ顧客名（カナ） */
     dskokyakunmkj                                      VARCHAR     (62)                                                                ,  /* ＤＳ顧客名（漢字） */
...
ALTER TABLE MT_DsKokyakuKanri_Z ADD CONSTRAINT PK_DsKokyakuKanri PRIMARY KEY (
     dskokno                                                    /* ＤＳ顧客番号 */
) ;

CREATE INDEX IX1_DsKokyakuKanri ON MT_DsKokyakuKanri_Z (
