...
ALTER TABLE HT_SmbcStyKanriSsRireki_Z ADD CONSTRAINT PK_SmbcStyKanriSsRireki PRIMARY KEY (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_SmbcStyKanriSsRireki ON HT_SmbcStyKanriSsRireki_Z (
     mosno                                                      /* 申込番号 */
) ;
