CREATE TABLE ZT_KhGinkouMdhnFollowCallRn_Z (
     zrnsyono                                           CHAR        (11)                                                      NOT NULL  ,  /* （連携用）証券番号 */
     zrnsyorikbn                                        CHAR        (1)                                                       NOT NULL  ,  /* （連携用）処理区分 */
     zrnannaip                                          DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）案内保険料 */
     ...
     zrnttkekin                                         DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）今期立替金額 */
     zrnttkeganri                                       DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）立替元利金合計 */
     zrnttkersk                                         DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）立替利息 */
     ...
     zrnkjkyknm35keta                                   GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）漢字契約者名（３５桁） */
     ...
     zrnkyksyaadr                                       GRAPHIC     (62)                                                      NOT NULL  ,  /* （連携用）契約者住所 */
     ...
     zrnhknmeisyou15keta                                GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）保険名称（１５桁） */
...
ALTER TABLE ZT_KhGinkouMdhnFollowCallRn_Z ADD CONSTRAINT PK_KhGinkouMdhnFollowCallRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
