CREATE TABLE HW_SikinIdouWk_Z (
     ...
     sikinidougaku                                      DECIMAL     (13)                                                                ,  /* 資金移動額 */
...
ALTER TABLE HW_SikinIdouWk_Z ADD CONSTRAINT PK_SikinIdouWk PRIMARY KEY (
     nyksyoriymd                                              , /* 入金処理日 */
     itirenno                                                   /* 一連番号 */
) ;

CREATE INDEX IX1_SikinIdouWk ON HW_SikinIdouWk_Z (
     syoriYmd                                                 , /* 処理年月日 */
