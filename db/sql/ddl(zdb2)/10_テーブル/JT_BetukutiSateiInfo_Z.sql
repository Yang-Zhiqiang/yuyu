...
ALTER TABLE JT_BetukutiSateiInfo_Z ADD CONSTRAINT PK_BetukutiSateiInfo PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
