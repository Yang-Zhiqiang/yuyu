CREATE TABLE ZT_HknkykIdouInfoRn_Z (
     ...
     zrnhokenkngk13                                     DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）保険金額Ｎ１３ */
     zrnp13                                             DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）保険料Ｎ１３ */
     zrnptumitatekin13                                  DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）保険料積立金Ｎ１３ */
     zrnkiykhnrikn13                                    DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）解約返戻金Ｎ１３ */
     zrnidouhokenkngk                                   DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）異動保険金額 */
     zrnidoup                                           DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）異動保険料 */
     zrnidouptumitatekin                                DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）異動保険料積立金 */
     zrnidoukiykhnrikn                                  DECIMAL     (13,2)                                                    NOT NULL  ,  /* （連携用）異動解約返戻金 */
...
ALTER TABLE ZT_HknkykIdouInfoRn_Z ADD CONSTRAINT PK_HknkykIdouInfoRn PRIMARY KEY (
