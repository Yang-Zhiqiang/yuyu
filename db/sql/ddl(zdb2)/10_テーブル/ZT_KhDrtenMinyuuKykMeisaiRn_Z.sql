CREATE TABLE ZT_KhDrtenMinyuuKykMeisaiRn_Z (
     ...
     zrndrtnbsyunnmisyou                                GRAPHIC     (10)                                                      NOT NULL  ,  /* （連携用）代理店募集人名称（漢字） */
     ...
     zrnhrkgk                                           DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）払込額 */
     ...
     zrnknyukknmei                                      CHAR        (54)                                                      NOT NULL  ,  /* （連携用）金融機関名 */
     zrnknyykknstnmei                                   CHAR        (50)                                                      NOT NULL  ,  /* （連携用）金融機関支店名 */
...
ALTER TABLE ZT_KhDrtenMinyuuKykMeisaiRn_Z ADD CONSTRAINT PK_KhDrtenMinyuuKykMeisaiRn PRIMARY KEY (
