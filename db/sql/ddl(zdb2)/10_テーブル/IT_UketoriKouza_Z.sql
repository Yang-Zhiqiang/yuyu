CREATE TABLE IT_UketoriKouza_Z (
...
ALTER TABLE IT_UketoriKouza_Z ADD CONSTRAINT PK_UketoriKouza PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     uktsyukbn                                                , /* 受取人種類区分 */
...
CREATE INDEX IX1_UketoriKouza ON IT_UketoriKouza_Z (
     syono                                                    , /* 証券番号 */
     uktsyukbn                                                , /* 受取人種類区分 */
     uktsyurenno                                                /* 受取人種類別連番 */
) ;
