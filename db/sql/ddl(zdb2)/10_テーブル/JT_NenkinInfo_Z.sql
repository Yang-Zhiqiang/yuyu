CREATE TABLE JT_NenkinInfo_Z (
     ...
     teinkkikingkgaika                                  DECIMAL     (13)                                                                ,  /* 定額年金年金基金額（外貨） */
     teinkkikingkgaika$                                 VARCHAR     (10)                                                                ,  /* 定額年金年金基金額（外貨）(通貨型) */
     teinkkikingken                                     DECIMAL     (13)                                                                ,  /* 定額年金年金基金額（円貨） */
     ...
     nknengk                                            DECIMAL     (13)                                                                ,  /* 年金年額 */
     nknengk$                                           VARCHAR     (10)                                                                ,  /* 年金年額(通貨型) */
     bnktnkgk                                           DECIMAL     (13)                                                                ,  /* 分割年金額 */
...
ALTER TABLE JT_NenkinInfo_Z ADD CONSTRAINT PK_NenkinInfo PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
