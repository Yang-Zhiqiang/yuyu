CREATE TABLE ZT_Ratep2Rn_Z (
     ...
     zrnprate                                           DECIMAL     (9,6)                                                     NOT NULL  ,  /* （連携用）Ｐレート */
     zrnpdatesrate                                      DECIMAL     (9,6)                                                     NOT NULL     /* （連携用）Ｐ建Ｓレート */
)
;

ALTER TABLE ZT_Ratep2Rn_Z ADD CONSTRAINT PK_Ratep2Rn PRIMARY KEY (
