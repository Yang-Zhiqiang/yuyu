CREATE TABLE MT_DsTourokuUkKanri_Z (
...
ALTER TABLE MT_DsTourokuUkKanri_Z ADD CONSTRAINT PK_DsTourokuUkKanri PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     dsttdksyubetukbn                                         , /* ＤＳ手続種別区分 */
     datarenno                                                  /* データ連番 */
) ;

CREATE INDEX IX1_DsTourokuUkKanri ON MT_DsTourokuUkKanri_Z (
     tourokustatus                                            , /* 登録ステータス */
     dsjimukaisiymd                                             /* ＤＳ事務開始日 */
) ;

CREATE INDEX IX2_DsTourokuUkKanri ON MT_DsTourokuUkKanri_Z (
     dsjimukaisiymd                                             /* ＤＳ事務開始日 */
) ;
