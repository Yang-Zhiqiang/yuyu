CREATE TABLE ZT_KijituTouraiAnnaiTy_Z (
     ...
     ztyhurikaeyokokumsg32keta1                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）１ */
     ztyhurikaeyokokumsg32keta2                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）２ */
     ztyhurikaeyokokumsg32keta3                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）３ */
     ztyhurikaeyokokumsg32keta4                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）４ */
     ztyhurikaeyokokumsg32keta5                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）５ */
     ztyhurikaeyokokumsg32keta6                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）６ */
     ztyhurikaeyokokumsg32keta7                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）７ */
     ztyhurikaeyokokumsg32keta8                         VARCHAR     (66)                                                                ,  /* （中継用）振替予告メッセージ（３２桁）８ */
     ...
     ztykjttrnnfreearea1                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア１ */
     ztykjttrnnfreearea2                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア２ */
     ztykjttrnnfreearea3                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア３ */
     ztykjttrnnfreearea4                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア４ */
     ztykjttrnnfreearea5                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア５ */
     ztykjttrnnfreearea6                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア６ */
     ztykjttrnnfreearea7                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア７ */
     ...
     ztykzhurikaeymdseireki                             VARCHAR     (24)                                                                ,  /* （中継用）口座振替日（西暦） */
     ztykzinfo1                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報１ */
     ztykzinfo2                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報２ */
     ztykzinfo3                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報３ */
     ztykzinfo4                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報４ */
     ztykzinfo5                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報５ */
     ztykzinfo6                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報６ */
     ztykzinfo7                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報７ */
     ztykzinfo8                                         VARCHAR     (56)                                                                ,  /* （中継用）口座情報８ */
     ztyhknjytukikan                                    VARCHAR     (38)                                                                ,  /* （中継用）保険料充当期間 */
     ztyhrkgk1                                          VARCHAR     (56)                                                                ,  /* （中継用）払込金額１ */
     ztyhrkgk2                                          VARCHAR     (56)                                                                ,  /* （中継用）払込金額２ */
     ztyhrkgk3                                          VARCHAR     (56)                                                                ,  /* （中継用）払込金額３ */
     ztyhrkgk4                                          VARCHAR     (56)                                                                ,  /* （中継用）払込金額４ */
     ztyyobiv146                                        VARCHAR     (146)                                                               ,  /* （中継用）予備項目Ｖ１４６ */
     ztyansyuyouyobin10x7                               VARCHAR     (10)                                                                ,  /* （中継用）案内収納用予備項目Ｎ１０＿７ */
     ztykjttrnnfreearea8                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア８ */
     ztykjttrnnfreearea9                                VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア９ */
     ztykjttrnnfreearea10                               VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア１０ */
     ztykjttrnnfreearea11                               VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア１１ */
     ztykjttrnnfreearea12                               VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア１２ */
     ztykjttrnnfreearea13                               VARCHAR     (72)                                                                ,  /* （中継用）期日到来案内フリーエリア１３ */
...
ALTER TABLE ZT_KijituTouraiAnnaiTy_Z ADD CONSTRAINT PK_KijituTouraiAnnaiTy PRIMARY KEY (
