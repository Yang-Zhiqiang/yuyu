CREATE TABLE BT_DenpyoData_Z (
     ...
     hijynbrsikinidouyouflg                             CHAR        (1)                                                                 ,  /* 平準払資金移動要フラグ */
     hijynbrsikinidougk                                 DECIMAL     (13)                                                                ,  /* 平準払資金移動金額 */
...
ALTER TABLE BT_DenpyoData_Z ADD CONSTRAINT PK_DenpyoData PRIMARY KEY (
     densyskbn                                                , /* 伝票用システム区分 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_DenpyoData ON BT_DenpyoData_Z (
     syoriYmd                                                 , /* 処理年月日 */
     kanjyoukmkcd                                               /* 勘定科目コード */
) ;

CREATE INDEX IX2_DenpyoData ON BT_DenpyoData_Z (
     denymd                                                   , /* 伝票日付 */
     syoriYmd                                                 , /* 処理年月日 */
     densyorikbn                                                /* 伝票処理区分 */
) ;

CREATE INDEX IX3_DenpyoData ON BT_DenpyoData_Z (
     keirisyono                                                 /* 経理用証券番号 */
) ;
