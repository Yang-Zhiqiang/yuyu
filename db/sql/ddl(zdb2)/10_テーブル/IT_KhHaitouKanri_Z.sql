CREATE TABLE IT_KhHaitouKanri_Z (
...
ALTER TABLE IT_KhHaitouKanri_Z ADD CONSTRAINT PK_HaitouKanri PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     haitounendo                                              , /* 配当年度 */
     renno                                                    , /* 連番 */
...
CREATE INDEX IX1_HaitouKanri ON IT_KhHaitouKanri_Z (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX2_HaitouKanri ON IT_KhHaitouKanri_Z (
     haitounendo                                                /* 配当年度 */
) ;
