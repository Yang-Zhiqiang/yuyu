CREATE TABLE ZT_KouzaHnknTuutiRn_Z (
     ...
     zrnhrkymdmdkj                                      GRAPHIC     (6)                                                       NOT NULL  ,  /* （連携用）払込日（月日漢字） */
     zrnsyono2                                          CHAR        (11)                                                      NOT NULL  ,  /* （連携用）証券番号２ */
     zrnnyknaiyoumidasi                                 GRAPHIC     (2)                                                       NOT NULL  ,  /* （連携用）入金内容見出し */
     zrnymdmidasi                                       GRAPHIC     (10)                                                      NOT NULL  ,  /* （連携用）日付見出し */
     zrnkingakumidasi                                   GRAPHIC     (10)                                                      NOT NULL  ,  /* （連携用）金額見出し */
     zrnnyknymdseirekikj                                GRAPHIC     (11)                                                      NOT NULL  ,  /* （連携用）入金日（西暦漢字） */
     zrnnyuukinngaku                                    CHAR        (13)                                                      NOT NULL  ,  /* （連携用）入金額 */
     zrnpjyuutouym                                      GRAPHIC     (18)                                                      NOT NULL  ,  /* （連携用）保険料充当年月 */
     ...
     zrntyusyaku                                        GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）注釈 */
     zrnyobiv160                                        CHAR        (160)                                                     NOT NULL  ,  /* （連携用）予備項目Ｖ１６０ */
     zrnansyuyouyobin10x5                               CHAR        (10)                                                      NOT NULL     /* （連携用）案内収納用予備項目Ｎ１０＿５ */
)
;

ALTER TABLE ZT_KouzaHnknTuutiRn_Z ADD CONSTRAINT PK_KouzaHnknTuutiRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
