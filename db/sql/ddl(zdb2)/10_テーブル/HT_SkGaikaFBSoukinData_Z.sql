CREATE TABLE HT_SkGaikaFBSoukinData_Z (
...
ALTER TABLE HT_SkGaikaFBSoukinData_Z ADD CONSTRAINT PK_SkGaikaFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SkGaikaFBSoukinData ON HT_SkGaikaFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_SkGaikaFBSoukinData ON HT_SkGaikaFBSoukinData_Z (
     mosno                                                      /* 申込番号 */
) ;
