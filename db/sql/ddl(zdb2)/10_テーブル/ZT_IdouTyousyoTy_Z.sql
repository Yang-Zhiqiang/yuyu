CREATE TABLE ZT_IdouTyousyoTy_Z (
     ...
     ztykjoldkykadr                                     VARCHAR     (126)                                                               ,  /* （中継用）漢字旧契約者住所 */
     ztykjoldkyknm35                                    VARCHAR     (72)                                                                ,  /* （中継用）漢字旧契約者名（３５桁） */
     ...
     ztykyksibouhyoukagk                                DECIMAL     (11)                                                                ,  /* （中継用）契約者死亡評価額 */
     ztykihrkmp                                         DECIMAL     (11)                                                                ,  /* （中継用）既払込保険料 */
     ztyoldkykkihrkmpyouhyj                             VARCHAR     (1)                                                                 ,  /* （中継用）旧契約者既払込保険料要表示 */
     ztyoldkykkihrkmp                                   DECIMAL     (11)                                                                ,  /* （中継用）旧契約者既払込保険料 */
...
ALTER TABLE ZT_IdouTyousyoTy_Z ADD CONSTRAINT PK_IdouTyousyoTy PRIMARY KEY (
