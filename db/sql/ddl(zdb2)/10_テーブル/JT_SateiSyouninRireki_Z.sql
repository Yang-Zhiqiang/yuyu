CREATE TABLE JT_SateiSyouninRireki_Z (
     ...
     reportcomment                                      VARCHAR     (2498)                                                              ,  /* 帳票用コメント */
...
ALTER TABLE JT_SateiSyouninRireki_Z ADD CONSTRAINT PK_SateiSyouninRireki PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
