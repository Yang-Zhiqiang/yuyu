CREATE TABLE HT_BAK_SyoriCTL_Z (
...
ALTER TABLE HT_BAK_SyoriCTL_Z ADD CONSTRAINT PK_BAK_SyoriCTL PRIMARY KEY (
     mosno                                                    , /* 申込番号 */
     trkssikibetukey                                            /* 取消識別キー */
) ;

CREATE INDEX IX1_BAK_SyoriCTL ON HT_BAK_SyoriCTL_Z (
     srsyoriymd                                               , /* 成立処理日 */
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX2_BAK_SyoriCTL ON HT_BAK_SyoriCTL_Z (
     syono                                                      /* 証券番号 */
) ;
