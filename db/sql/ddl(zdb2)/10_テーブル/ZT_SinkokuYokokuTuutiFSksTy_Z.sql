CREATE TABLE ZT_SinkokuYokokuTuutiFSksTy_Z (
     ...
     ztysinkokunenwareki                                VARCHAR     (12)                                                      NOT NULL  ,  /* （中継用）申告年（和暦） */
     ztymidasi1                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し１ */
     ztymidasi2                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し２ */
     ztymidasi3                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し３ */
     ztymidasi4                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し４ */
     ztymidasi5                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し５ */
     ztymidasi6                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し６ */
     ztymidasi7                                         VARCHAR     (18)                                                                ,  /* （中継用）見出し７ */
     ztykihonjouhoumongon1                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言１ */
     ztykihonjouhoumongon2                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言２ */
     ztykihonjouhoumongon3                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言３ */
     ztykihonjouhoumongon4                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言４ */
     ztykihonjouhoumongon5                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言５ */
     ztykihonjouhoumongon6                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言６ */
     ztykihonjouhoumongon7                              VARCHAR     (36)                                                                ,  /* （中継用）基本情報文言７ */
     ...
     ztykykymdwa                                        VARCHAR     (24)                                                                ,  /* （中継用）契約年月日（和暦） */
     ztyhrkkaisuunm                                     VARCHAR     (2)                                                                 ,  /* （中継用）払込回数（数） */
     ztysakuseiymdwareki                                VARCHAR     (24)                                                                ,  /* （中継用）作成年月日（和暦） */
...
ALTER TABLE ZT_SinkokuYokokuTuutiFSksTy_Z ADD CONSTRAINT PK_SinkokuYokokuTuutiFSksTy PRIMARY KEY (
