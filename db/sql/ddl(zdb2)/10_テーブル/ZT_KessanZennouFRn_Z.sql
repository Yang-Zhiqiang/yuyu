CREATE TABLE ZT_KessanZennouFRn_Z (
     ...
     zrnzennoukaisijizndk                               DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）前納開始時残高 */
     zrnkykymd                                          CHAR        (8)                                                       NOT NULL  ,  /* （連携用）契約年月日 */
     zrnzennouwrbkrt                                    DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）前納割引率 */
     zrnrthndzndk1                                      DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）利率変動時残高１ */
     zrntkyrt1                                          DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）適用利率１ */
     zrnrthndymd1                                       CHAR        (8)                                                       NOT NULL  ,  /* （連携用）利率変動年月日１ */
     zrnrthndzndk2                                      DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）利率変動時残高２ */
     zrntkyrt2                                          DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）適用利率２ */
     zrnrthndymd2                                       CHAR        (8)                                                       NOT NULL  ,  /* （連携用）利率変動年月日２ */
     zrnrthndzndk3                                      DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）利率変動時残高３ */
     zrntkyrt3                                          DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）適用利率３ */
     zrnrthndymd3                                       CHAR        (8)                                                       NOT NULL  ,  /* （連携用）利率変動年月日３ */
     zrnrthndzndk4                                      DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）利率変動時残高４ */
     zrntkyrt4                                          DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）適用利率４ */
     zrnrthndymd4                                       CHAR        (8)                                                       NOT NULL  ,  /* （連携用）利率変動年月日４ */
     zrntndmatuzndk                                     DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）当年度末残高 */
     zrntndmatutkyrt                                    DECIMAL     (7,6)                                                     NOT NULL  ,  /* （連携用）当年度末適用利率 */
...
ALTER TABLE ZT_KessanZennouFRn_Z ADD CONSTRAINT PK_KessanZennouFRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
