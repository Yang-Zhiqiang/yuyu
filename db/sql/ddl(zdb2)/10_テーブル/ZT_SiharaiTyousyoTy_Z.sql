CREATE TABLE ZT_SiharaiTyousyoTy_Z (
     ...
     ztyshrtysyjyuusyo                                  VARCHAR     (126)                                                               ,  /* （中継用）支払調書住所 */
     ztyuktnmkj35                                       VARCHAR     (72)                                                                ,  /* （中継用）受取人名（漢字）（３５桁） */
     ztydaihyouktkbn                                    VARCHAR     (1)                                                                 ,  /* （中継用）代表受取人区分 */
     ztykjdaihyouuktnm                                  VARCHAR     (32)                                                                ,  /* （中継用）漢字代表受取人名 */
     ztyuktmnmeigibangou                                VARCHAR     (3)                                                                 ,  /* （中継用）受取人ＭＮ名義番号 */
     ztyyobiv24                                         VARCHAR     (24)                                                                ,  /* （中継用）予備項目Ｖ２４ */
     ztymfjyuusyocd                                     VARCHAR     (7)                                                                 ,  /* （中継用）ＭＦ住所コード */
     ztymfjyuusyo                                       VARCHAR     (126)                                                               ,  /* （中継用）ＭＦ住所 */
     ...
     ztykjoldkykkaiadr                                  VARCHAR     (126)                                                               ,  /* （中継用）漢字旧契約者下位住所 */
     ztykjoldkyknm                                      VARCHAR     (72)                                                                ,  /* （中継用）漢字旧契約者名 */
     ...
     ztyshrgk11                                         DECIMAL     (11)                                                                ,  /* （中継用）支払金額Ｎ１１ */
     ztywarimsishrgk                                    DECIMAL     (11)                                                                ,  /* （中継用）割増支払金額 */
     ztyznnphr                                          DECIMAL     (11)                                                                ,  /* （中継用）前納Ｐ等返戻金 */
     ztyttkekstkganri                                   DECIMAL     (11)                                                                ,  /* （中継用）立替貸付元利金 */
     ztysshkd                                           DECIMAL     (11)                                                                ,  /* （中継用）差引Ｄ */
     ztysasihikisiharaigaku                             DECIMAL     (11)                                                                ,  /* （中継用）差引支払金額 */
     ztymihrkmp                                         DECIMAL     (11)                                                                ,  /* （中継用）未払込Ｐ */
     ztyshrtienrsk11                                    DECIMAL     (11)                                                                ,  /* （中継用）支払遅延利息Ｎ１１ */
     ztytysyouhtykeihi                                  DECIMAL     (11)                                                                ,  /* （中継用）調書用必要経費 */
     ztygenkykhtykeihiyouhyj                            VARCHAR     (1)                                                                 ,  /* （中継用）現契約者必要経費要表示 */
     ztygenkykhtykeihi                                  DECIMAL     (11)                                                                ,  /* （中継用）現契約者必要経費 */
     ...
     ztyshrtysyhknsyukbn                                VARCHAR     (32)                                                                ,  /* （中継用）支払調書保険種類区分 */
...
ALTER TABLE ZT_SiharaiTyousyoTy_Z ADD CONSTRAINT PK_SiharaiTyousyoTy PRIMARY KEY (
