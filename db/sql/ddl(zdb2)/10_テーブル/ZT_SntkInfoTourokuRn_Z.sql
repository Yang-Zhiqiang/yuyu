CREATE TABLE ZT_SntkInfoTourokuRn_Z (
     ...
     zrnkjtaisyounm                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）対象者漢字姓名 */
...
ALTER TABLE ZT_SntkInfoTourokuRn_Z ADD CONSTRAINT PK_SntkInfoTourokuRn PRIMARY KEY (
