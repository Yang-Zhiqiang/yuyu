CREATE TABLE BT_OnlineGknyknmeisai_Z (
     ...
     hrkmtekiyounaiyouej                                VARCHAR     (98)                                                                ,  /* （振込用）摘要内容（英字） */
...
ALTER TABLE BT_OnlineGknyknmeisai_Z ADD CONSTRAINT PK_OnlineGknyknmeisai PRIMARY KEY (
