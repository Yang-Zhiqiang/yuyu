CREATE TABLE ZT_TmttHaitoukinMeisaiTy_Z (
     ...
     ztyzennendokurikosid                               DECIMAL     (11)                                                                ,  /* （中継用）前年度繰越Ｄ */
     ztytounendod                                       DECIMAL     (11)                                                                ,  /* （中継用）当年度Ｄ */
     ztytounendomatutumitated                           DECIMAL     (11)                                                                ,  /* （中継用）当年度末積立Ｄ */
...
ALTER TABLE ZT_TmttHaitoukinMeisaiTy_Z ADD CONSTRAINT PK_TmttHaitoukinMeisaiTy PRIMARY KEY (
