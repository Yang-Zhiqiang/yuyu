CREATE TABLE ZT_DrtenSkKykDtlSyokaiTy_Z (
     ...
     ztyvithrkkaisuu                                    VARCHAR     (8)                                                                 ,  /* （中継用）Ｖｉｔ払込回数 */
     ztyvithrkkeiro                                     VARCHAR     (8)                                                                 ,  /* （中継用）Ｖｉｔ払込経路 */
     ztyzkomivitriyoury                                 DECIMAL     (11)                                                                ,  /* （中継用）税込Ｖｉｔ利用料 */
     ztyvitnyknkaisuu                                   VARCHAR     (3)                                                                 ,  /* （中継用）Ｖｉｔ入金回数 */
     ztyvitbikou                                        VARCHAR     (42)                                                                ,  /* （中継用）Ｖｉｔ備考 */
     ztyyobiv25                                         VARCHAR     (25)                                                                   /* （中継用）予備項目Ｖ２５ */
)
;

ALTER TABLE ZT_DrtenSkKykDtlSyokaiTy_Z ADD CONSTRAINT PK_DrtenSkKykDtlSyokaiTy PRIMARY KEY (
