CREATE TABLE HT_SmbcStyKanri_Z (
     datarenymd                                         VARCHAR     (8)                                                       NOT NULL  ,  /* データ連動日 */
     datasakuseirenno                                   DECIMAL     (7)                                                       NOT NULL  ,  /* データ作成連番 */
     ...
     smbckyknmkn                                        VARCHAR     (162)                                                               ,  /* ＳＭＢＣ＿契約者名（カナ） */
...
ALTER TABLE HT_SmbcStyKanri_Z ADD CONSTRAINT PK_SmbcStyKanri PRIMARY KEY (
     datarenymd                                               , /* データ連動日 */
     datasakuseirenno                                           /* データ作成連番 */
) ;

CREATE INDEX IX1_SmbcStyKanri ON HT_SmbcStyKanri_Z (
     datarenymd                                               , /* データ連動日 */
     datasakuseirenno                                         , /* データ作成連番 */
     rendouflg                                                  /* 連動フラグ */
) ;

CREATE INDEX IX2_SmbcStyKanri ON HT_SmbcStyKanri_Z (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX3_SmbcStyKanri ON HT_SmbcStyKanri_Z (
     mosno                                                      /* 申込番号 */
) ;
