CREATE TABLE ZT_DirectMailDataRn_Z (
     ...
     zrnhknnm                                           GRAPHIC     (40)                                                      NOT NULL  ,  /* （連携用）保険名称 */
...
ALTER TABLE ZT_DirectMailDataRn_Z ADD CONSTRAINT PK_DirectMailDataRn PRIMARY KEY (
     zrnsyono                                                   /* （連携用）証券番号 */
) ;
