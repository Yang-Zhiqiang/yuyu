CREATE TABLE IW_KhGengakuWk_Z (
     ...
     newkihonhknkngaku                                  DECIMAL     (13)                                                                ,  /* 新基本保険金額 */
     newkihonhknkngaku$                                 VARCHAR     (10)                                                                ,  /* 新基本保険金額(通貨型) */
     newhrkp                                            DECIMAL     (13)                                                                ,  /* 新払込保険料 */
...
ALTER TABLE IW_KhGengakuWk_Z ADD CONSTRAINT PK_KhGengakuWk PRIMARY KEY (
