CREATE TABLE JT_SiJinsokuShrTtdkInfo_Z (
     ...
     syoruikeikaeigyoubisuu                             DECIMAL     (3)                                                                 ,  /* 書類受付経過営業日数 */
     syorikeikaeigyoubisuu                              DECIMAL     (3)                                                                 ,  /* 処理経過営業日数 */
...
ALTER TABLE JT_SiJinsokuShrTtdkInfo_Z ADD CONSTRAINT PK_SiJinsokuShrTtdkInfo PRIMARY KEY (
...
CREATE INDEX IX1_SiJinsokuShrTtdkInfo ON JT_SiJinsokuShrTtdkInfo_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
