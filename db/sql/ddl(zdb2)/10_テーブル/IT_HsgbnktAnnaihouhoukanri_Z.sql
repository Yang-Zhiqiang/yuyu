CREATE TABLE IT_HsgbnktAnnaihouhoukanri_Z (
...
ALTER TABLE IT_HsgbnktAnnaihouhoukanri_Z ADD CONSTRAINT PK_HsgbnktAnnaihouhoukanri PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     hsgymd                                                     /* 被災害年月日 */
) ;

CREATE INDEX IX1_HsgbnktAnnaihouhoukanri ON IT_HsgbnktAnnaihouhoukanri_Z (
     hsgymd                                                     /* 被災害年月日 */
) ;

CREATE INDEX IX2_HsgbnktAnnaihouhoukanri ON IT_HsgbnktAnnaihouhoukanri_Z (
