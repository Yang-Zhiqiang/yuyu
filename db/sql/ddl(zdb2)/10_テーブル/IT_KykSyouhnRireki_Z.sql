CREATE TABLE IT_KykSyouhnRireki_Z (
...
ALTER TABLE IT_KykSyouhnRireki_Z ADD CONSTRAINT PK_KykSyouhnRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
...
CREATE INDEX IX1_KykSyouhnRireki ON IT_KykSyouhnRireki_Z (
     syono                                                    , /* 証券番号 */
     syutkkbn                                                 , /* 主契約特約区分 */
     syouhncd                                                 , /* 商品コード */
     syouhnsdno                                               , /* 商品世代番号 */
...
CREATE INDEX IX2_KykSyouhnRireki ON IT_KykSyouhnRireki_Z (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;
