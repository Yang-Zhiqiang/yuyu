CREATE TABLE ZT_KaiykHrSoutougakuTy_Z (
     ...
     ztyryumsbbnkaiyakuhr                               DECIMAL     (11)                                                                ,  /* （中継用）料増部分解約返戻金 */
...
ALTER TABLE ZT_KaiykHrSoutougakuTy_Z ADD CONSTRAINT PK_KaiykHrSoutougakuTy PRIMARY KEY (
