CREATE TABLE ZT_KouzaHnknTuutiTy_Z (
     ...
     ztyhrkymdmdkj                                      VARCHAR     (14)                                                                ,  /* （中継用）払込日（月日漢字） */
     ztysyono2                                          VARCHAR     (11)                                                                ,  /* （中継用）証券番号２ */
     ztymidasinyknaiyoumidasi                           VARCHAR     (6)                                                                 ,  /* （中継用）入金内容見出し */
     ztyymdmidasi                                       VARCHAR     (22)                                                                ,  /* （中継用）日付見出し */
     ztykingakumidasi                                   VARCHAR     (22)                                                                ,  /* （中継用）金額見出し */
     ztynyknymdseirekikj                                VARCHAR     (24)                                                                ,  /* （中継用）入金日（西暦漢字） */
     ztynyuukinngaku                                    VARCHAR     (13)                                                                ,  /* （中継用）入金額 */
     ztypjyuutouym                                      VARCHAR     (38)                                                                ,  /* （中継用）保険料充当年月 */
...
ALTER TABLE ZT_KouzaHnknTuutiTy_Z ADD CONSTRAINT PK_KouzaHnknTuutiTy PRIMARY KEY (
     ztysyono                                                 , /* （中継用）証券番号 */
