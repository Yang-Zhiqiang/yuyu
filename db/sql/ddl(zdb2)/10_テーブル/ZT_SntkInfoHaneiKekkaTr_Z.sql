CREATE TABLE ZT_SntkInfoHaneiKekkaTr_Z (
     ztrsntkinfono                                      VARCHAR     (11)                                                      NOT NULL  ,  /* （取込用）選択情報番号 */
     ztrrenno                                           DECIMAL     (2)                                                       NOT NULL  ,  /* （取込用）連番 */
...
ALTER TABLE ZT_SntkInfoHaneiKekkaTr_Z ADD CONSTRAINT PK_SntkInfoHaneiKekkaTr PRIMARY KEY (
