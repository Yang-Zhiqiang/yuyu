...
ALTER TABLE AT_UserHenkouRireki_Z ADD CONSTRAINT AT_UserHenkouRirekiPk PRIMARY KEY (
     uniqueId                                                   /* ユニークＩＤ */
) ;

CREATE INDEX AT_UserHenkouRirekiIdx1 ON AT_UserHenkouRireki_Z (
     userId                                                     /* ユーザーＩＤ */
) ;
