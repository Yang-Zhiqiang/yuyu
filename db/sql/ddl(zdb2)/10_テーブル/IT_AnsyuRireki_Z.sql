...
ALTER TABLE IT_AnsyuRireki_Z ADD CONSTRAINT PK_AnsyuRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     nyknaiyoukbn                                             , /* 入金内容区分 */
     jyuutouym                                                , /* 充当年月 */
...
CREATE INDEX IX1_AnsyuRireki ON IT_AnsyuRireki_Z (
     syono                                                    , /* 証券番号 */
     nyknaiyoukbn                                             , /* 入金内容区分 */
     jyuutouym                                                , /* 充当年月 */
     annaino                                                    /* 案内番号 */
