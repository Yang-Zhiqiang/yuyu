CREATE TABLE JT_SiFBSoukinData_Z (
...
ALTER TABLE JT_SiFBSoukinData_Z ADD CONSTRAINT PK_SiFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SiFBSoukinData ON JT_SiFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
