CREATE TABLE JT_AksrendouzumiSkKykInfo_Z (
     ...
     syoruiimagerendousuu                               DECIMAL     (5)                                                                 ,  /* 書類イメージ連動数 */
...
ALTER TABLE JT_AksrendouzumiSkKykInfo_Z ADD CONSTRAINT PK_AksrendouzumiSkKykInfo PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                      /* 証券番号 */
) ;
