CREATE TABLE ZT_TumitateYosokuTy_Z (
     ...
     ztytmttknysktaisyoukensuu                          DECIMAL     (7)                                                                 ,  /* （中継用）積立金予測対象件数 */
     ztykyktuukakyktmttkngk                             DECIMAL     (13,2)                                                              ,  /* （中継用）契約通貨建契約時積立金額 */
     ztykyktuukakisitmttkngk                            DECIMAL     (13,2)                                                              ,  /* （中継用）契約通貨建期始積立金額 */
     ztykyktuukaysktmttkngk                             DECIMAL     (13,2)                                                              ,  /* （中継用）契約通貨建予測積立金額 */
...
ALTER TABLE ZT_TumitateYosokuTy_Z ADD CONSTRAINT PK_TumitateYosokuTy PRIMARY KEY (
