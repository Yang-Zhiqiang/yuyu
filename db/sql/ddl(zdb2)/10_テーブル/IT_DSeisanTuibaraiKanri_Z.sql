CREATE TABLE IT_DSeisanTuibaraiKanri_Z (
...
ALTER TABLE IT_DSeisanTuibaraiKanri_Z ADD CONSTRAINT PK_DSeisanTuibaraiKanri PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     haitounendo                                                /* 配当年度 */
) ;

CREATE INDEX IX1_DSeisanTuibaraiKanri ON IT_DSeisanTuibaraiKanri_Z (
     haitounendo                                                /* 配当年度 */
) ;
