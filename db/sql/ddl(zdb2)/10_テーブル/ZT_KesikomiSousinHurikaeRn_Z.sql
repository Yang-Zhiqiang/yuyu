CREATE TABLE ZT_KesikomiSousinHurikaeRn_Z (
     ...
     zrndengk                                           DECIMAL     (15)                                                      NOT NULL  ,  /* （連携用）伝票金額 */
...
ALTER TABLE ZT_KesikomiSousinHurikaeRn_Z ADD CONSTRAINT PK_KesikomiSousinHurikaeRn PRIMARY KEY (
