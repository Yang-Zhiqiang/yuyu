CREATE TABLE ST_SkOikmKaikei_Z (
...
ALTER TABLE ST_SkOikmKaikei_Z ADD CONSTRAINT PK_SkOikmKaikei PRIMARY KEY (
     densyskbn                                                , /* 伝票用システム区分 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_SkOikmKaikei ON ST_SkOikmKaikei_Z (
     denymd                                                   , /* 伝票日付 */
     syoriYmd                                                 , /* 処理年月日 */
     densyorikbn                                                /* 伝票処理区分 */
) ;
