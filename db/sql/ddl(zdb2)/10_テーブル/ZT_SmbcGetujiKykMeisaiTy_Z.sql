CREATE TABLE ZT_SmbcGetujiKykMeisaiTy_Z (
     ...
     ztykyknmknsmbcgetuji                               VARCHAR     (142)                                                               ,  /* （中継用）契約者名（カナ）（ＳＭＢＣ月次契約Ｆ） */
     ztykyknmkjsmbcgetuji                               VARCHAR     (72)                                                                ,  /* （中継用）契約者名（漢字）（ＳＭＢＣ月次契約Ｆ） */
     ztyhhknnmkjsmbcgetuji                              VARCHAR     (72)                                                                ,  /* （中継用）被保険者名（漢字）（ＳＭＢＣ月次契約Ｆ） */
     ztyitijibrp                                        DECIMAL     (11)                                                                ,  /* （中継用）一時払保険料 */
     ztygoukeip2                                        DECIMAL     (11)                                                                ,  /* （中継用）合計保険料２ */
     ztyzenkizennoup                                    DECIMAL     (11)                                                                ,  /* （中継用）全期前納保険料 */
     ...
     ztygetumatuymdidouw                                DECIMAL     (11)                                                                ,  /* （中継用）月末日異動解約返戻金 */
     ztygetumatuymdsibous                               DECIMAL     (11)                                                                ,  /* （中継用）月末日死亡保険金 */
...
ALTER TABLE ZT_SmbcGetujiKykMeisaiTy_Z ADD CONSTRAINT PK_SmbcGetujiKykMeisaiTy PRIMARY KEY (
