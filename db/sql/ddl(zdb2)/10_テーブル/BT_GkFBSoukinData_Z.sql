CREATE TABLE BT_GkFBSoukinData_Z (
...
ALTER TABLE BT_GkFBSoukinData_Z ADD CONSTRAINT PK_GkFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_GkFBSoukinData ON BT_GkFBSoukinData_Z (
     syoriYmd                                                 , /* 処理年月日 */
     gkgyoumucd                                                 /* 外貨業務コード */
) ;
