CREATE TABLE IW_TmttkinYskWk_Z (
     ...
     kyktuukap                                          DECIMAL     (13)                                                                ,  /* 契約通貨建保険料 */
     kyktuukap$                                         VARCHAR     (10)                                                                ,  /* 契約通貨建保険料(通貨型) */
     kyktuukatmttkngk                                   DECIMAL     (13)                                                                ,  /* 契約通貨建積立金額 */
     kyktuukatmttkngk$                                  VARCHAR     (10)                                                                ,  /* 契約通貨建積立金額(通貨型) */
     kyktuukakaiyakuhrgk                                DECIMAL     (13)                                                                ,  /* 契約通貨建解約返戻金額 */
...
ALTER TABLE IW_TmttkinYskWk_Z ADD CONSTRAINT PK_KhTmttkinYskWk PRIMARY KEY (
     syono                                                      /* 証券番号 */
) ;
