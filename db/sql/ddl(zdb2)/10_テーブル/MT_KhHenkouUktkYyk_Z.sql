CREATE TABLE MT_KhHenkouUktkYyk_Z (
...
ALTER TABLE MT_KhHenkouUktkYyk_Z ADD CONSTRAINT PK_KhHenkouUktkYyk PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     hozenhenkouuktkrenno                                       /* 保全変更受付連番 */
) ;

CREATE INDEX IX1_KhHenkouUktkYyk ON MT_KhHenkouUktkYyk_Z (
     syoriyoteiymd                                            , /* 処理予定日 */
     uktksyorikbn                                             , /* 受付処理区分 */
     uktkjyoutaikbn                                             /* 受付状態区分 */
) ;

CREATE INDEX IX2_KhHenkouUktkYyk ON MT_KhHenkouUktkYyk_Z (
     uktksyorikbn                                             , /* 受付処理区分 */
     uktkjyoutaikbn                                             /* 受付状態区分 */
) ;
