CREATE TABLE ZT_FstpUriageSeikyuuKekkaRn_Z (
     ...
     zrnseikyuukngk                                     DECIMAL     (13)                                                      NOT NULL  ,  /* （連携用）請求金額 */
...
ALTER TABLE ZT_FstpUriageSeikyuuKekkaRn_Z ADD CONSTRAINT PK_FstpUriageSeikyuuKekkaRn PRIMARY KEY (
