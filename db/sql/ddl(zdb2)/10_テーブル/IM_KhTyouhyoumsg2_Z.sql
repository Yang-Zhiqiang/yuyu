CREATE TABLE IM_KhTyouhyoumsg2_Z (
     ...
     khtyouhyoumsgbunruikbn1                            VARCHAR     (3)                                                       NOT NULL  ,  /* 契約保全帳票メッセージ分類区分１ */
     khtyouhyoumsgbunruikbn2                            VARCHAR     (3)                                                       NOT NULL  ,  /* 契約保全帳票メッセージ分類区分２ */
     khtyouhyoumsgbunruikbn3                            VARCHAR     (3)                                                       NOT NULL  ,  /* 契約保全帳票メッセージ分類区分３ */
     ...
     sksnm                                              VARCHAR     (102)                                                                  /* 請求書名 */
)
;

ALTER TABLE IM_KhTyouhyoumsg2_Z ADD CONSTRAINT PK_KhTyouhyoumsg2 PRIMARY KEY (
     syoruiCd                                                 , /* 書類コード */
     meigihnkjiyuu                                            , /* 名義変更事由 */
     kyksbumu                                                 , /* 契約者死亡有無 */
     shrumu                                                   , /* 支払有無区分 */
     tuityouumu                                               , /* 追徴有無区分 */
     khtyouhyoumsgbunruikbn1                                  , /* 契約保全帳票メッセージ分類区分１ */
     khtyouhyoumsgbunruikbn2                                  , /* 契約保全帳票メッセージ分類区分２ */
     khtyouhyoumsgbunruikbn3                                    /* 契約保全帳票メッセージ分類区分３ */
) ;
