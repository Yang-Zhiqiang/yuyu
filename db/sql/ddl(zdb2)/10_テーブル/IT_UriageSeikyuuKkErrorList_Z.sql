CREATE TABLE IT_UriageSeikyuuKkErrorList_Z (
     ...
     credituriagegk                                     DECIMAL     (13)                                                      NOT NULL  ,  /* クレジットカード売上金額 */
...
ALTER TABLE IT_UriageSeikyuuKkErrorList_Z ADD CONSTRAINT PK_UriageSeikyuuKkErrorList PRIMARY KEY (
     syono                                                    , /* 証券番号 */
