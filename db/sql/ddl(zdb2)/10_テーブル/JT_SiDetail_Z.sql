CREATE TABLE JT_SiDetail_Z (
     ...
     nitigakuhokenkngk                                  DECIMAL     (13)                                                                ,  /* 日額・保険金額 */
     nitigakuhokenkngk$                                 VARCHAR     (10)                                                                ,  /* 日額・保険金額(通貨型) */
     nissuubairitu                                      DECIMAL     (4)                                                                 ,  /* 日数・倍率 */
     kyhkintanikbn                                      VARCHAR     (1)                                                                 ,  /* 給付金単位区分 */
     kyhkg                                              DECIMAL     (13)                                                                ,  /* 給付金額 */
     kyhkg$                                             VARCHAR     (10)                                                                ,  /* 給付金額(通貨型) */
     yenkyhgk                                           DECIMAL     (13)                                                                ,  /* 円換算給付金額 */
     ...
     hokenkinshrwariai                                  DECIMAL     (4,3)                                                               ,  /* 保険金支払割合 */
...
ALTER TABLE JT_SiDetail_Z ADD CONSTRAINT PK_SiDetail PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
