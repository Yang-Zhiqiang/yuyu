CREATE TABLE ZT_SkKaikeiTorihikiFileRn_Z (
     ...
     zrnkingaku                                         DECIMAL     (15)                                                      NOT NULL  ,  /* （連携用）金額 */
...
ALTER TABLE ZT_SkKaikeiTorihikiFileRn_Z ADD CONSTRAINT PK_SkKaikeiTorihikiFileRn PRIMARY KEY (
