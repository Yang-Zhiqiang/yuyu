CREATE TABLE HT_BAK_SmbcStyKanri_Z (
...
ALTER TABLE HT_BAK_SmbcStyKanri_Z ADD CONSTRAINT PK_BAK_SmbcStyKanri PRIMARY KEY (
     datarenymd                                               , /* データ連動日 */
     trkssikibetukey                                          , /* 取消識別キー */
     datasakuseirenno                                           /* データ作成連番 */
) ;

CREATE INDEX IX1_BAK_SmbcStyKanri ON HT_BAK_SmbcStyKanri_Z (
     datarenymd                                               , /* データ連動日 */
     datasakuseirenno                                         , /* データ作成連番 */
     rendouflg                                                  /* 連動フラグ */
) ;
