CREATE TABLE IT_KihrkmpSeisanRireki_Z (
...
ALTER TABLE IT_KihrkmpSeisanRireki_Z ADD CONSTRAINT PK_KihrkmpSeisanRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     renno                                                      /* 連番 */
) ;

CREATE INDEX IX1_KihrkmpSeisanRireki ON IT_KihrkmpSeisanRireki_Z (
     syono                                                    , /* 証券番号 */
     renno                                                      /* 連番 */
) ;
