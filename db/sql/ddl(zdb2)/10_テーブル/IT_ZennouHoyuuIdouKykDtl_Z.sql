CREATE TABLE IT_ZennouHoyuuIdouKykDtl_Z (
     ...
     toukimatuzennouzndk                                DECIMAL     (11)                                                                ,  /* 当期末前納残高金額 */
     toukimatuzennouzndk$                               VARCHAR     (10)                                                                ,  /* 当期末前納残高金額(通貨型) */
     toukijyuutoup                                      DECIMAL     (11)                                                                ,  /* 当期充当Ｐ */
     toukijyuutoup$                                     VARCHAR     (10)                                                                ,  /* 当期充当Ｐ(通貨型) */
     toukizennouseisangk                                DECIMAL     (11)                                                                ,  /* 当期前納精算額 */
     toukizennouseisangk$                               VARCHAR     (10)                                                                ,  /* 当期前納精算額(通貨型) */
     toukizennounyuukinkgk                              DECIMAL     (11)                                                                ,  /* 当期前納入金額 */
     toukizennounyuukinkgk$                             VARCHAR     (10)                                                                ,  /* 当期前納入金額(通貨型) */
     yokukinenbaraip                                    DECIMAL     (11)                                                                ,  /* 翌期年払Ｐ */
     yokukinenbaraip$                                   VARCHAR     (10)                                                                ,  /* 翌期年払Ｐ(通貨型) */
     wrbkrttkyrt                                        DECIMAL     (11)                                                                ,  /* 割引利率適用残高 */
...
ALTER TABLE IT_ZennouHoyuuIdouKykDtl_Z ADD CONSTRAINT PK_ZennouHoyuuIdouKykDtl PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     sakuseiymd                                               , /* 作成年月日 */
     syoricd                                                  , /* 処理コード */
