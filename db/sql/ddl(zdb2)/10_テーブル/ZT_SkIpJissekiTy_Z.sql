CREATE TABLE ZT_SkIpJissekiTy_Z (
     ...
     ztyatkiwari3keta                                   DECIMAL     (3)                                                                 ,  /* （中継用）扱割合（３桁） */
     ...
     ztyrendouyouharaikomip                             DECIMAL     (11)                                                                ,  /* （中継用）連動用払込Ｐ */
...
ALTER TABLE ZT_SkIpJissekiTy_Z ADD CONSTRAINT PK_SkIpJissekiTy PRIMARY KEY (
