CREATE TABLE IT_DrtenMinyuKykTaisyo_Z (
     ...
     jkijyutoukaisuuy                                   DECIMAL     (2)                                                                 ,  /* 次回案内充当回数（年） */
     jkijyutoukaisuum                                   DECIMAL     (2)                                                                 ,  /* 次回案内充当回数（月） */
...
ALTER TABLE IT_DrtenMinyuKykTaisyo_Z ADD CONSTRAINT PK_DrtenMinyuKykTaisyo PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syoriYmd                                                 , /* 処理年月日 */
