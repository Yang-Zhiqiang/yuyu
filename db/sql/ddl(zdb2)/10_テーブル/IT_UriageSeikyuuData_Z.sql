CREATE TABLE IT_UriageSeikyuuData_Z (
...
ALTER TABLE IT_UriageSeikyuuData_Z ADD CONSTRAINT PK_UriageSeikyuuData PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_UriageSeikyuuData ON IT_UriageSeikyuuData_Z (
     syono                                                      /* 証券番号 */
) ;
