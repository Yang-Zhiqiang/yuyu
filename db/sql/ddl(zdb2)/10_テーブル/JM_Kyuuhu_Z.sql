CREATE TABLE JM_Kyuuhu_Z (
     kyuuhucd                                           VARCHAR     (4)                                                       NOT NULL  ,  /* 給付コード */
     seikyuusyubetu                                     VARCHAR     (2)                                                                 ,  /* 請求種別 */
     kyuuhuname                                         VARCHAR     (62)                                                                ,  /* 給付名 */
     kyuuhunamegamen                                    VARCHAR     (62)                                                                ,  /* 給付名（画面用） */
     kyuuhunamereport                                   VARCHAR     (62)                                                                ,  /* 給付名（帳票用） */
     ...
     hokenkngkhyoujikbn                                 DECIMAL     (1)                                                                 ,  /* 保険金額表示区分 */
     hokenkngkhyoujimsg1                                VARCHAR     (22)                                                                ,  /* 保険金額表示メッセージ１ */
     hokenkngkhyoujimsg2                                VARCHAR     (22)                                                                ,  /* 保険金額表示メッセージ２ */
...
ALTER TABLE JM_Kyuuhu_Z ADD CONSTRAINT PK_Kyuuhu PRIMARY KEY (
     kyuuhucd                                                   /* 給付コード */
) ;
