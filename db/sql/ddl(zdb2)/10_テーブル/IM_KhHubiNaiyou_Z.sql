CREATE TABLE IM_KhHubiNaiyou_Z (
     ...
     hubinaiyouhyoujijyun                               DECIMAL     (3)                                                       NOT NULL  ,  /* 不備内容表示順 */
     hubinaiyoucd                                       VARCHAR     (5)                                                       NOT NULL  ,  /* 不備内容コード */
     hubinaiyou                                         VARCHAR     (82)                                                                ,  /* 不備内容 */
     hubisyoruimsg                                      VARCHAR     (318)                                                               ,  /* 不備書類用メッセージ */
...
ALTER TABLE IM_KhHubiNaiyou_Z ADD CONSTRAINT PK_KhHubiNaiyou PRIMARY KEY (
