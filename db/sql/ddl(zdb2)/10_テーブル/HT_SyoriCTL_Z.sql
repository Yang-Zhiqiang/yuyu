CREATE TABLE HT_SyoriCTL_Z (
     ...
     creditnrkumu                                       VARCHAR     (1)                                                                 ,  /* クレジットカード情報入力有無 */
     creditnrkhbumu                                     VARCHAR     (1)                                                                 ,  /* クレジットカード情報入力不備有無 */
     creditnrkvrfjkkbn                                  VARCHAR     (1)                                                                 ,  /* クレジットカード情報入力ベリファイ状況区分 */
     ...
     nyknkwsrate                                        DECIMAL     (7,4)                                                               ,  /* 入金用為替レート */
     authorikakymd                                      VARCHAR     (8)                                                                 ,  /* オーソリ確認日 */
     fstauthorikanryoymd                                VARCHAR     (8)                                                                 ,  /* 初回オーソリ完了日 */
     cardinfohnkkbn                                     VARCHAR     (1)                                                                 ,  /* カード情報変更区分 */
     authorijkkbn                                       VARCHAR     (1)                                                                 ,  /* オーソリ状況区分 */
     authorisousinkhkbn                                 VARCHAR     (1)                                                                 ,  /* オーソリ送信可否区分 */
     uriagesousinkbn                                    VARCHAR     (1)                                                                 ,  /* 売上送信区分 */
     kbtauthoritrkymd                                   VARCHAR     (8)                                                                 ,  /* 個別オーソリ登録日 */
     ...
     itipclskjkkbn                                      VARCHAR     (1)                                                                 ,  /* １ＰＣＬ請求状況区分 */
     annaisakuseikbn                                    VARCHAR     (1)                                                                 ,  /* 送付案内作成状況区分 */
     annaikaisuu                                        DECIMAL     (2)                                                                 ,  /* 案内回数 */
...
ALTER TABLE HT_SyoriCTL_Z ADD CONSTRAINT PK_SyoriCTL PRIMARY KEY (
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX1_SyoriCTL ON HT_SyoriCTL_Z (
     srsyoriymd                                               , /* 成立処理日 */
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX2_SyoriCTL ON HT_SyoriCTL_Z (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX3_SyoriCTL ON HT_SyoriCTL_Z (
     skeijimukbn                                                /* 新契約事務区分 */
) ;
