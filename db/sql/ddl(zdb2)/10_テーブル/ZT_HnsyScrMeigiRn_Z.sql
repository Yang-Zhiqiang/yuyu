CREATE TABLE ZT_HnsyScrMeigiRn_Z (
     ...
     zrntaisyounmkj                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）対象者姓名（漢字） */
     ...
     zrnkankeinmkj1                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）関係者名（漢字）１ */
     zrnkankeinmkj2                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）関係者名（漢字）２ */
     zrnkankeinmkj3                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）関係者名（漢字）３ */
     zrnkankeinmkj4                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）関係者名（漢字）４ */
     zrnkankeinmkj5                                     GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）関係者名（漢字）５ */
...
ALTER TABLE ZT_HnsyScrMeigiRn_Z ADD CONSTRAINT PK_HnsyScrMeigiRn PRIMARY KEY (
