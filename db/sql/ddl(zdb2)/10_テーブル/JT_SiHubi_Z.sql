CREATE TABLE JT_SiHubi_Z (
     ...
     hassinsakikaisuu1                                  DECIMAL     (2)                                                                 ,  /* 発信先別発信回数１ */
     hassinsakikaisuu2                                  DECIMAL     (2)                                                                 ,  /* 発信先別発信回数２ */
     hasinsakibetuhasinkaisuu3                          DECIMAL     (2)                                                                 ,  /* 発信先別発信回数３ */
...
ALTER TABLE JT_SiHubi_Z ADD CONSTRAINT PK_SiHubi PRIMARY KEY (
