CREATE TABLE IT_KhBikinkanri_Z (
     ...
     gaikazennouseisankgk                               DECIMAL     (13)                                                                ,  /* 外貨前納精算金額 */
     ...
     gaikamikeikap                                      DECIMAL     (13)                                                                ,  /* 外貨未経過保険料 */
...
ALTER TABLE IT_KhBikinkanri_Z ADD CONSTRAINT PK_KhBikinkanri PRIMARY KEY (
     syono                                                    , /* 証券番号 */
