CREATE TABLE HT_SkCreditCardQrTrkMihanei_Z (
     ...
     creditauthorigk                                    DECIMAL     (7)                                                                 ,  /* クレジットカードオーソリ金額 */
...
ALTER TABLE HT_SkCreditCardQrTrkMihanei_Z ADD CONSTRAINT PK_SkCreditCardQrTrkMihanei PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
...
CREATE INDEX IX1_SkCreditCardQrTrkMihanei ON HT_SkCreditCardQrTrkMihanei_Z (
     nykmosno                                                   /* 入金用申込番号 */
) ;
