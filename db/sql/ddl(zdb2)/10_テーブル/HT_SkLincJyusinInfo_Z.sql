CREATE TABLE HT_SkLincJyusinInfo_Z (
     ...
     renno2                                             DECIMAL     (4)                                                       NOT NULL  ,  /* 連番２ */
     sousinymd                                          VARCHAR     (8)                                                       NOT NULL  ,  /* 送信日 */
     lincrecordsyubetu                                  DECIMAL     (2)                                                                 ,  /* ＬＩＮＣ＿レコード種別 */
     linchenkoutype                                     VARCHAR     (1)                                                                 ,  /* ＬＩＮＣ＿変更タイプ */
     lincsyorikekkakekkacd                              DECIMAL     (1)                                                                 ,  /* ＬＩＮＣ＿処理結果_結果コード */
     lincsyorikekkakekkajiyu                            DECIMAL     (2)                                                                 ,  /* ＬＩＮＣ＿処理結果_結果事由 */
     lincsyorikekkaerrkouban                            DECIMAL     (3)                                                                 ,  /* ＬＩＮＣ＿処理結果_エラー項番 */
     lincnayoserecordsuu                                DECIMAL     (3)                                                                 ,  /* ＬＩＮＣ＿名寄せレコード数 */
     linckanyuusyano                                    DECIMAL     (12)                                                                ,  /* ＬＩＮＣ＿加入者番号 */
     lincnayoseyomiknnm                                 VARCHAR     (66)                                                                ,  /* ＬＩＮＣ＿名寄せ読みカナ氏名 */
     ...
     linckjhngflg                                       DECIMAL     (1)                                                                 ,  /* ＬＩＮＣ＿漢字範囲外フラッグ */
     ...
     linc15sai1000manflg                                DECIMAL     (1)                                                                 ,  /* ＬＩＮＣ＿１５歳未満１０００万超フラッグ */
     linclincsyoriymd                                   DECIMAL     (8)                                                                 ,  /* ＬＩＮＣ＿ＬＩＮＣ処理日 */
...
ALTER TABLE HT_SkLincJyusinInfo_Z ADD CONSTRAINT PK_SkLincJyusinInfo PRIMARY KEY (
