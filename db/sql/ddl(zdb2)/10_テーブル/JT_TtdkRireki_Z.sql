...
ALTER TABLE JT_TtdkRireki_Z ADD CONSTRAINT PK_TtdkRireki PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
     ttdkrrkskbtkey                                             /* 手続履歴識別キー */
) ;

CREATE INDEX IX1_TtdkRireki ON JT_TtdkRireki_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
