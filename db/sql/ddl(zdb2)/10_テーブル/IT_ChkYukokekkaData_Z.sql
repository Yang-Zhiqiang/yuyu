CREATE TABLE IT_ChkYukokekkaData_Z (
...
ALTER TABLE IT_ChkYukokekkaData_Z ADD CONSTRAINT PK_ChkYukokekkaData PRIMARY KEY (
     ansyuusyskbn                                             , /* 案内収納用システム区分 */
     yuukoukekkarenno                                           /* 有効性確認結果データ連番 */
) ;

CREATE INDEX IX1_ChkYukokekkaData ON IT_ChkYukokekkaData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
