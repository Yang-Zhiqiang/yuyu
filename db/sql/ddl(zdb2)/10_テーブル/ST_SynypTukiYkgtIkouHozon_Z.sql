CREATE TABLE ST_SynypTukiYkgtIkouHozon_Z (
     srkijyunym                                         VARCHAR     (6)                                                       NOT NULL  ,  /* 数理用基準年月 */
     sequenceno                                         DECIMAL     (8)                                                       NOT NULL  ,  /* シーケンス番号 */
     ...
     zennoujiikkatubaraijytgk                           DECIMAL     (11)                                                                ,  /* 前納時一括払充当額 */
...
ALTER TABLE ST_SynypTukiYkgtIkouHozon_Z ADD CONSTRAINT PK_SynypTukiYkgtIkouHozon PRIMARY KEY (
     srkijyunym                                               , /* 数理用基準年月 */
     sequenceno                                               , /* シーケンス番号 */
     syono                                                    , /* 証券番号 */
