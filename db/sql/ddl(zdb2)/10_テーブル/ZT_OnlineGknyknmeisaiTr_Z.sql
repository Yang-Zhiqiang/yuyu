CREATE TABLE ZT_OnlineGknyknmeisaiTr_Z (
     ...
     ztrtekiyounaiyouej                                 VARCHAR     (98)                                                                ,  /* （取込用）摘要内容（英字） */
...
ALTER TABLE ZT_OnlineGknyknmeisaiTr_Z ADD CONSTRAINT PK_OnlineGknyknmeisaiTr PRIMARY KEY (
