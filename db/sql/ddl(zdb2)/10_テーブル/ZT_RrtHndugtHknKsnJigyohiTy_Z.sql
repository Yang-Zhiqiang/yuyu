CREATE TABLE ZT_RrtHndugtHknKsnJigyohiTy_Z (
     ...
     ztypjuutoujikawaserate                             DECIMAL     (9,6)                                                               ,  /* （中継用）保険料充当時為替レート */
     ...
     ztyvhireilritu                                     DECIMAL     (13,11)                                                             ,  /* （中継用）Ｖ比例Ｌ率 */
     ztyyobin13                                         DECIMAL     (13)                                                                ,  /* （中継用）予備項目Ｎ１３ */
     ztyphireilwrbkritu                                 DECIMAL     (13,11)                                                             ,  /* （中継用）Ｐ比例Ｌ割引率 */
     ztygetumatutumitatekin                             DECIMAL     (11)                                                                ,  /* （中継用）月末積立金 */
...
ALTER TABLE ZT_RrtHndugtHknKsnJigyohiTy_Z ADD CONSTRAINT PK_RrtHndugtHknKsnJigyohiTy PRIMARY KEY (
