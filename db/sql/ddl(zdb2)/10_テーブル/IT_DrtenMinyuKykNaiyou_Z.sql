CREATE TABLE IT_DrtenMinyuKykNaiyou_Z (
...
ALTER TABLE IT_DrtenMinyuKykNaiyou_Z ADD CONSTRAINT PK_DrtenMinyuKykNaiyou PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syoriym                                                    /* 処理年月 */
) ;
