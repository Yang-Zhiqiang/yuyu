...
ALTER TABLE HT_MosDairiten_Z ADD CONSTRAINT PK_MosDairiten PRIMARY KEY (
     mosno                                                    , /* 申込番号 */
     renno                                                      /* 連番 */
) ;

CREATE INDEX IX1_MosDairiten ON HT_MosDairiten_Z (
     oyadrtencd                                                 /* 親代理店コード */
) ;

CREATE INDEX IX2_MosDairiten ON HT_MosDairiten_Z (
     tratkiagcd                                                 /* 取扱代理店コード */
) ;
