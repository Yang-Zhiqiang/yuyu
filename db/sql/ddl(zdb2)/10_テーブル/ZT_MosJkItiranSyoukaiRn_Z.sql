CREATE TABLE ZT_MosJkItiranSyoukaiRn_Z (
     ...
     zrnkjhjnnm                                         GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）漢字法人名 */
     zrnyobiv93                                         CHAR        (93)                                                      NOT NULL    /* （連携用）予備項目Ｖ９３ */
)
;

ALTER TABLE ZT_MosJkItiranSyoukaiRn_Z ADD CONSTRAINT PK_MosJkItiranSyoukaiRn PRIMARY KEY (
     zrnmosym                                                 , /* （連携用）申込月度 */
     zrnmosno                                                 , /* （連携用）申込番号 */
