CREATE TABLE BM_SjkkkTyouseiyouRiritu2_Z (
     ...
     sjkkktyouseiyouriritu                              DECIMAL     (5,4)                                                               ,  /* 市場価格調整用利率 */
...
ALTER TABLE BM_SjkkkTyouseiyouRiritu2_Z ADD CONSTRAINT PK_SjkkkTyouseiyouRiritu2 PRIMARY KEY (
     syouhncd                                                 , /* 商品コード */
