CREATE TABLE IT_TesuuryouSyouhnRireki_Z (
...
ALTER TABLE IT_TesuuryouSyouhnRireki_Z ADD CONSTRAINT PK_TesuuryouSyouhnRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_TesuuryouSyouhnRireki ON IT_TesuuryouSyouhnRireki_Z (
     syono                                                    , /* 証券番号 */
     tsrysyorikbn                                             , /* 手数料処理区分 */
     renno                                                    , /* 連番 */
     syutkkbn                                                 , /* 主契約特約区分 */
