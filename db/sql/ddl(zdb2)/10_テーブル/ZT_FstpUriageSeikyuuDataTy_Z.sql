CREATE TABLE ZT_FstpUriageSeikyuuDataTy_Z (
     ...
     ztyseikyuukngk11keta                               DECIMAL     (11)                                                      NOT NULL  ,  /* （中継用）請求金額（１１桁） */
...
ALTER TABLE ZT_FstpUriageSeikyuuDataTy_Z ADD CONSTRAINT PK_FstpUriageSeikyuuDataTy PRIMARY KEY (
