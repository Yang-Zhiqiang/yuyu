...
ALTER TABLE JT_SateiIppanHanteiInfo_Z ADD CONSTRAINT PK_SateiIppanHanteiInfo PRIMARY KEY (
     skno                                                     , /* 請求番号 */
     syono                                                    , /* 証券番号 */
