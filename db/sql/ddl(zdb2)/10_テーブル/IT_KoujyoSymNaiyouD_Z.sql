CREATE TABLE IT_KoujyoSymNaiyouD_Z (
...
ALTER TABLE IT_KoujyoSymNaiyouD_Z ADD CONSTRAINT PK_KoujyoSymNaiyouD PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     syouhncd                                                 , /* 商品コード */
     renno3keta                                                 /* 連番（３桁） */
...
CREATE INDEX IX1_KoujyoSymNaiyouD ON IT_KoujyoSymNaiyouD_Z (
     syono                                                    , /* 証券番号 */
     syouhncd                                                 , /* 商品コード */
     renno3keta                                                 /* 連番（３桁） */
) ;
