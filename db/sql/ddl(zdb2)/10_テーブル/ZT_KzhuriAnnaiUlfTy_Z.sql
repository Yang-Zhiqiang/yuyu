CREATE TABLE ZT_KzhuriAnnaiUlfTy_Z (
     ...
     ztykeizokup                                        DECIMAL     (11)                                                                ,  /* （中継用）継続保険料 */
     ztyiktwaribikikgk                                  DECIMAL     (11)                                                                ,  /* （中継用）一括割引額 */
...
ALTER TABLE ZT_KzhuriAnnaiUlfTy_Z ADD CONSTRAINT PK_KzhuriAnnaiUlfTy PRIMARY KEY (
     ztysyono                                                 , /* （中継用）証券番号 */
