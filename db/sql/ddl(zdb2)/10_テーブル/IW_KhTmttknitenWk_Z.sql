CREATE TABLE IW_KhTmttknitenWk_Z (
     kouteikanriid                                      VARCHAR     (20)                                                      NOT NULL  ,  /* 工程管理ＩＤ */
     syono                                              VARCHAR     (20)                                                                ,  /* 証券番号 */
     skssakuseiymd                                      VARCHAR     (8)                                                                 ,  /* 請求書作成日 */
     tmttknitenkbn                                      VARCHAR     (1)                                                                 ,  /* 積立金移転区分 */
     uktkkigenymd                                       VARCHAR     (8)                                                                 ,  /* 受付期限日 */
...
ALTER TABLE IW_KhTmttknitenWk_Z ADD CONSTRAINT PK_KhTmttknitenWk PRIMARY KEY (
