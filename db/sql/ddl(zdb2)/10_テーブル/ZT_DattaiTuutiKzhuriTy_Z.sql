CREATE TABLE ZT_DattaiTuutiKzhuriTy_Z (
     ...
     ztykzinfo30keta1                                   VARCHAR     (62)                                                                ,  /* （中継用）口座情報（３０桁）１ */
     ztykzinfo30keta2                                   VARCHAR     (62)                                                                ,  /* （中継用）口座情報（３０桁）２ */
     ztykzinfo30keta3                                   VARCHAR     (62)                                                                ,  /* （中継用）口座情報（３０桁）３ */
...
ALTER TABLE ZT_DattaiTuutiKzhuriTy_Z ADD CONSTRAINT PK_DattaiTuutiKzhuriTy PRIMARY KEY (
