CREATE TABLE HW_CreditTrkHaneierrList_Z (
     ...
     credittrkhaneierrriyuu                             VARCHAR     (62)                                                                ,  /* クレジットカード登録反映エラー理由 */
...
ALTER TABLE HW_CreditTrkHaneierrList_Z ADD CONSTRAINT PK_CreditTrkHaneierrList PRIMARY KEY (
     tyouhyouymd                                              , /* 帳票作成日 */
     datarenno                                                  /* データ連番 */
) ;
