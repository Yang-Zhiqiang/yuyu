CREATE TABLE ZT_SyuHukugouSikkanDataTy_Z (
     ...
     ztyijitoukeikeikan                                 DECIMAL     (11,3)                                                              ,  /* （中継用）医事統計用経過Ｎ */
     ztyijitoukeisiboun                                 DECIMAL     (5)                                                                 ,  /* （中継用）医事統計用死亡Ｎ */
     ztyijitoukeikeikas                                 DECIMAL     (11,1)                                                              ,  /* （中継用）医事統計用経過Ｓ */
     ztyijitoukeisibous                                 DECIMAL     (9)                                                                 ,  /* （中継用）医事統計用死亡Ｓ */
...
ALTER TABLE ZT_SyuHukugouSikkanDataTy_Z ADD CONSTRAINT PK_SyuHukugouSikkanDataTy PRIMARY KEY (
