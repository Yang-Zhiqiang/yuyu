CREATE TABLE ZT_KijituTouraiAnnaiRn_Z (
     ...
     zrnhurikaeyokokumsg32keta1                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）１ */
     zrnhurikaeyokokumsg32keta2                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）２ */
     zrnhurikaeyokokumsg32keta3                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）３ */
     zrnhurikaeyokokumsg32keta4                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）４ */
     zrnhurikaeyokokumsg32keta5                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）５ */
     zrnhurikaeyokokumsg32keta6                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）６ */
     zrnhurikaeyokokumsg32keta7                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）７ */
     zrnhurikaeyokokumsg32keta8                         GRAPHIC     (32)                                                      NOT NULL  ,  /* （連携用）振替予告メッセージ（３２桁）８ */
     ...
     zrnkjttrnnfreearea1                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア１ */
     zrnkjttrnnfreearea2                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア２ */
     zrnkjttrnnfreearea3                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア３ */
     zrnkjttrnnfreearea4                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア４ */
     zrnkjttrnnfreearea5                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア５ */
     zrnkjttrnnfreearea6                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア６ */
     zrnkjttrnnfreearea7                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア７ */
     ...
     zrnkzhurikaeymdseireki                             GRAPHIC     (11)                                                      NOT NULL  ,  /* （連携用）口座振替日（西暦） */
     zrnkzinfo1                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報１ */
     zrnkzinfo2                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報２ */
     zrnkzinfo3                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報３ */
     zrnkzinfo4                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報４ */
     zrnkzinfo5                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報５ */
     zrnkzinfo6                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報６ */
     zrnkzinfo7                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報７ */
     zrnkzinfo8                                         GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）口座情報８ */
     zrnhknjytukikan                                    GRAPHIC     (18)                                                      NOT NULL  ,  /* （連携用）保険料充当期間 */
     zrnhrkgk1                                          GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）払込金額１ */
     zrnhrkgk2                                          GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）払込金額２ */
     zrnhrkgk3                                          GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）払込金額３ */
     zrnhrkgk4                                          GRAPHIC     (27)                                                      NOT NULL  ,  /* （連携用）払込金額４ */
     zrnyobiv146                                        CHAR        (146)                                                     NOT NULL  ,  /* （連携用）予備項目Ｖ１４６ */
     zrnansyuyouyobin10x7                               CHAR        (10)                                                      NOT NULL  ,  /* （連携用）案内収納用予備項目Ｎ１０＿７ */
     zrnkjttrnnfreearea8                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア８ */
     zrnkjttrnnfreearea9                                GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア９ */
     zrnkjttrnnfreearea10                               GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア１０ */
     zrnkjttrnnfreearea11                               GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア１１ */
     zrnkjttrnnfreearea12                               GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア１２ */
     zrnkjttrnnfreearea13                               GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）期日到来案内フリーエリア１３ */
     zrnyobiv84                                         CHAR        (84)                                                      NOT NULL  ,  /* （連携用）予備項目Ｖ８４ */
     zrnansyuyouyobin10x8                               CHAR        (10)                                                      NOT NULL     /* （連携用）案内収納用予備項目Ｎ１０＿８ */
)
;

ALTER TABLE ZT_KijituTouraiAnnaiRn_Z ADD CONSTRAINT PK_KijituTouraiAnnaiRn PRIMARY KEY (
