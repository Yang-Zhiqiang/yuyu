CREATE TABLE ZT_HnsyScrMeigiTy_Z (
     ztyhnsyrecordkbn                                   VARCHAR     (3)                                                                 ,  /* （中継用）反社レコ－ド区分 */
     ztykijyunym                                        VARCHAR     (6)                                                                 ,  /* （中継用）基準年月 */
     ztytaisyounmkn                                     VARCHAR     (38)                                                      NOT NULL  ,  /* （中継用）対象者姓名（カナ） */
     ztytaisyounmkj                                     VARCHAR     (32)                                                      NOT NULL  ,  /* （中継用）対象者姓名（漢字） */
     ...
     ztykankeinmkn1                                     VARCHAR     (38)                                                                ,  /* （中継用）関係者名（カナ）１ */
     ztykankeinmkn2                                     VARCHAR     (38)                                                                ,  /* （中継用）関係者名（カナ）２ */
     ztykankeinmkn3                                     VARCHAR     (38)                                                                ,  /* （中継用）関係者名（カナ）３ */
     ztykankeinmkn4                                     VARCHAR     (38)                                                                ,  /* （中継用）関係者名（カナ）４ */
     ztykankeinmkn5                                     VARCHAR     (38)                                                                ,  /* （中継用）関係者名（カナ）５ */
     ztykankeinmkj1                                     VARCHAR     (32)                                                                ,  /* （中継用）関係者名（漢字）１ */
     ztykankeinmkj2                                     VARCHAR     (32)                                                                ,  /* （中継用）関係者名（漢字）２ */
     ztykankeinmkj3                                     VARCHAR     (32)                                                                ,  /* （中継用）関係者名（漢字）３ */
     ztykankeinmkj4                                     VARCHAR     (32)                                                                ,  /* （中継用）関係者名（漢字）４ */
     ztykankeinmkj5                                     VARCHAR     (32)                                                                ,  /* （中継用）関係者名（漢字）５ */
     ...
     ztykykmfkykknnm                                    VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ契約者カナ姓名 */
     ztykykmfkykkjnm                                    VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ契約者漢字姓名 */
     ztykykmfkykseiymd                                  VARCHAR     (8)                                                                 ,  /* （中継用）契約ＭＦ契約者生年月日 */
     ztykykmfhhkknnm                                    VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ被保険者カナ姓名 */
     ztykykmfhhkkjnm                                    VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ被保険者漢字姓名 */
     ztykykmfhhkseiymd                                  VARCHAR     (8)                                                                 ,  /* （中継用）契約ＭＦ被保険者生年月日 */
     ztykykmfdai2knnm                                   VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ第２被カナ姓名 */
     ztykykmfdai2kjnm                                   VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ第２被漢字姓名 */
     ztykykmfdai2seiymd                                 VARCHAR     (8)                                                                 ,  /* （中継用）契約ＭＦ第２被生年月日 */
     ztykykmfsbuktknnm                                  VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ死亡受取人カナ姓名 */
     ztykykmfsbuktkjnm                                  VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ死亡受取人漢字姓名 */
     ztykykmfsbuktseiymd                                VARCHAR     (8)                                                                 ,  /* （中継用）契約ＭＦ死亡受取人生年月日 */
     ztykykmfdai2ktknnm                                 VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ第２受取人カナ姓名 */
     ztykykmfdai2ktkjnm                                 VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ第２受取人漢字姓名 */
     ztykykmfdai2ktseiymd                               VARCHAR     (8)                                                                 ,  /* （中継用）契約ＭＦ第２受取人生年月日 */
     ztykykmfmnkktknnm                                  VARCHAR     (38)                                                                ,  /* （中継用）契約ＭＦ満期受取人カナ姓名 */
     ztykykmfmnkktkjnm                                  VARCHAR     (32)                                                                ,  /* （中継用）契約ＭＦ満期受取人漢字姓名 */
...
ALTER TABLE ZT_HnsyScrMeigiTy_Z ADD CONSTRAINT PK_HnsyScrMeigiTy PRIMARY KEY (
