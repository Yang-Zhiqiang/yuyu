CREATE TABLE ZT_KinyuuKikanInfoRn_Z (
     ...
     zrnkanjikinyuukikannm                              GRAPHIC     (20)                                                      NOT NULL  ,  /* （連携用）漢字金融機関名 */
     zrnkanjisitennm                                    GRAPHIC     (20)                                                      NOT NULL  ,  /* （連携用）漢字支店名 */
     ...
     zrnkinyuutesuuryou                                 DECIMAL     (5)                                                       NOT NULL  ,  /* （連携用）手数料 */
...
ALTER TABLE ZT_KinyuuKikanInfoRn_Z ADD CONSTRAINT PK_KinyuuKikanInfoRn PRIMARY KEY (
