CREATE TABLE BT_SikinIdouRireki_Z (
...
ALTER TABLE BT_SikinIdouRireki_Z ADD CONSTRAINT PK_SikinIdouRireki PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
     keirisyorirenno                                            /* 経理用処理連番 */
) ;

CREATE INDEX IX1_SikinIdouRireki ON BT_SikinIdouRireki_Z (
     syono                                                      /* 証券番号 */
) ;
