CREATE TABLE ZT_SkKouhuriUkTrkkekkaTr_Z (
     ...
     ztrkzmeiginmei                                     VARCHAR     (62)                                                                ,  /* （取込用）口座名義人名 */
...
ALTER TABLE ZT_SkKouhuriUkTrkkekkaTr_Z ADD CONSTRAINT PK_SkKouhuriUkTrkkekkaTr PRIMARY KEY (
