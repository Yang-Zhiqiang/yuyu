CREATE TABLE IT_KykSonotaTkyk_Z (
     ...
     nksgkhosyuwari                                     DECIMAL     (3)                                                                 ,  /* 年金総額保証割合 */
     ...
     kwstargetrate                                      DECIMAL     (3)                                                                 ,  /* 為替ターゲットレート */
     ...
     nkshrtkyknksyukkn                                  DECIMAL     (2)                                                                 ,  /* 年金支払特約年金期間 */
     ...
     targettkykkijyungk                                 DECIMAL     (13)                                                                ,  /* ターゲット特約基準金額 */
...
ALTER TABLE IT_KykSonotaTkyk_Z ADD CONSTRAINT PK_KykSonotaTkyk PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_KykSonotaTkyk ON IT_KykSonotaTkyk_Z (
     syono                                                      /* 証券番号 */
) ;
