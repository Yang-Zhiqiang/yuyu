CREATE TABLE ST_YuukoukykHtjynbknKarid_Z (
     ...
     znnndkrkskrwratdruigk                              DECIMAL     (11)                                                                ,  /* 前年度繰越仮割当Ｄ累計額 */
     znnndkrkskrwratdruigk$                             VARCHAR     (10)                                                                ,  /* 前年度繰越仮割当Ｄ累計額(通貨型) */
     tounendokariwariated                               DECIMAL     (11)                                                                ,  /* 当年度仮割当Ｄ */
     tounendokariwariated$                              VARCHAR     (10)                                                                ,  /* 当年度仮割当Ｄ(通貨型) */
     tndmatukrkskrwratdruigk                            DECIMAL     (11)                                                                ,  /* 当年度末仮割当Ｄ累計額 */
     tndmatukrkskrwratdruigk$                           VARCHAR     (10)                                                                ,  /* 当年度末仮割当Ｄ累計額(通貨型) */
     kariwariatedrisoku                                 DECIMAL     (11)                                                                ,  /* 仮割当Ｄ利息 */
...
ALTER TABLE ST_YuukoukykHtjynbknKarid_Z ADD CONSTRAINT PK_YuukoukykHtjynbknKarid PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
