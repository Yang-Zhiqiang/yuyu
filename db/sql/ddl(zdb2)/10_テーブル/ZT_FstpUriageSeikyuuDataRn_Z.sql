CREATE TABLE ZT_FstpUriageSeikyuuDataRn_Z (
     ...
     zrnseikyuukngk11keta                               DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）請求金額（１１桁） */
...
ALTER TABLE ZT_FstpUriageSeikyuuDataRn_Z ADD CONSTRAINT PK_FstpUriageSeikyuuDataRn PRIMARY KEY (
     zrnuriageymd6keta                                        , /* （連携用）売上年月日（６桁） */
     zrncreditkessaiyouno                                     , /* （連携用）クレジットカード決済用番号 */
     zrnsyono                                                 , /* （連携用）証券番号 */
     zrnrecordno                                              , /* （連携用）レコード番号 */
     zrnseikyuukngk11keta                                       /* （連携用）請求金額（１１桁） */
) ;
