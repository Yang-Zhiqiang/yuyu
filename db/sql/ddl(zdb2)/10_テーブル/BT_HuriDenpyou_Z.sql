CREATE TABLE BT_HuriDenpyou_Z (
     ...
     furikaedenpyouitirenno                             DECIMAL     (3)                                                                 ,  /* 振替伝票一連番号 */
...
ALTER TABLE BT_HuriDenpyou_Z ADD CONSTRAINT PK_HuriDenpyou PRIMARY KEY (
     densyskbn                                                , /* 伝票用システム区分 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_HuriDenpyou ON BT_HuriDenpyou_Z (
     syoriYmd                                                 , /* 処理年月日 */
     torihikino                                                 /* 取引番号 */
) ;
