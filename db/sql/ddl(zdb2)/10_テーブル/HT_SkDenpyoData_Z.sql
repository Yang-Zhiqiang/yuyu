CREATE TABLE HT_SkDenpyoData_Z (
...
ALTER TABLE HT_SkDenpyoData_Z ADD CONSTRAINT PK_SkDenpyoData PRIMARY KEY (
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_SkDenpyoData ON HT_SkDenpyoData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_SkDenpyoData ON HT_SkDenpyoData_Z (
     hrkkaisuu                                                  /* 払込回数 */
) ;

CREATE INDEX IX3_SkDenpyoData ON HT_SkDenpyoData_Z (
     mosno                                                      /* 申込番号 */
) ;
