CREATE TABLE IT_NyuukinKakusyouData_Z (
...
ALTER TABLE IT_NyuukinKakusyouData_Z ADD CONSTRAINT PK_NyuukinKakusyouData PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     nyuukinkakusyouno                                        , /* 入金確証番号 */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_NyuukinKakusyouData ON IT_NyuukinKakusyouData_Z (
     syono                                                      /* 証券番号 */
) ;
