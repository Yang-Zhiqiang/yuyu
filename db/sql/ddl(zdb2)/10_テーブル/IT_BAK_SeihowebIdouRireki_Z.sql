CREATE TABLE IT_BAK_SeihowebIdouRireki_Z (
     ...
     seihowebidoukbnnaiyou1                             VARCHAR     (46)                                                                ,  /* 生保Ｗｅｂ異動区分内容１ */
     seihowebidoukbnnaiyou2                             VARCHAR     (46)                                                                ,  /* 生保Ｗｅｂ異動区分内容２ */
...
ALTER TABLE IT_BAK_SeihowebIdouRireki_Z ADD CONSTRAINT PK_BAK_SeihowebIdouRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
