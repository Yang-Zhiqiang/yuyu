CREATE TABLE MT_DsHaisinErrorList2_Z (
     dsdatasakuseiymd                                   VARCHAR     (8)                                                       NOT NULL  ,  /* ＤＳデータ作成日 */
     dsmailhaisinrenban                                 DECIMAL     (9)                                                       NOT NULL  ,  /* ＤＳメール配信連番 */
...
ALTER TABLE MT_DsHaisinErrorList2_Z ADD CONSTRAINT PK_DsHaisinErrorList2 PRIMARY KEY (
     dsdatasakuseiymd                                         , /* ＤＳデータ作成日 */
     dsmailhaisinrenban                                         /* ＤＳメール配信連番 */
) ;

CREATE INDEX IX1_DsHaisinErrorList2 ON MT_DsHaisinErrorList2_Z (
     dssousinno                                                 /* ＤＳ送信番号 */
) ;
