...
ALTER TABLE IT_KoujyoSym_Z ADD CONSTRAINT PK_KoujyoSym PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     nendo                                                    , /* 年度 */
     tyouhyouymd                                              , /* 帳票作成日 */
...
CREATE INDEX IX1_KoujyoSym ON IT_KoujyoSym_Z (
     syono                                                    , /* 証券番号 */
     nendo                                                    , /* 年度 */
     tyouhyouymd                                              , /* 帳票作成日 */
     renno                                                      /* 連番 */
...
CREATE INDEX IX2_KoujyoSym ON IT_KoujyoSym_Z (
     tyouhyouymd                                                /* 帳票作成日 */
) ;
