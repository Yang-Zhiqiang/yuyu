CREATE TABLE ZT_HknkykIdouInfoTy_Z (
     ...
     ztyhokenkngk13                                     DECIMAL     (13,2)                                                              ,  /* （中継用）保険金額Ｎ１３ */
     ztyp13                                             DECIMAL     (13,2)                                                              ,  /* （中継用）保険料Ｎ１３ */
     ztyptumitatekin13                                  DECIMAL     (13,2)                                                              ,  /* （中継用）保険料積立金Ｎ１３ */
     ztykiykhnrikn13                                    DECIMAL     (13,2)                                                              ,  /* （中継用）解約返戻金Ｎ１３ */
     ztyidouhokenkngk                                   DECIMAL     (13,2)                                                              ,  /* （中継用）異動保険金額 */
     ztyidoup                                           DECIMAL     (13,2)                                                              ,  /* （中継用）異動保険料 */
     ztyidouptumitatekin                                DECIMAL     (13,2)                                                              ,  /* （中継用）異動保険料積立金 */
     ztyidoukiykhnrikn                                  DECIMAL     (13,2)                                                              ,  /* （中継用）異動解約返戻金 */
...
ALTER TABLE ZT_HknkykIdouInfoTy_Z ADD CONSTRAINT PK_HknkykIdouInfoTy PRIMARY KEY (
