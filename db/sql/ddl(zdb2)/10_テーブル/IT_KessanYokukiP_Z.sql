CREATE TABLE IT_KessanYokukiP_Z (
     kbnkey                                             VARCHAR     (2)                                                       NOT NULL  ,  /* 区分キー */
     keijyouym                                          DECIMAL     (6)                                                       NOT NULL  ,  /* 計上年月 */
     ...
     syoumetucd                                         DECIMAL     (4)                                                                 ,  /* 消滅コード */
     jkipjytym                                          VARCHAR     (6)                                                                 ,  /* 次回Ｐ充当年月 */
     haraikomip                                         DECIMAL     (11)                                                                ,  /* 払込Ｐ */
     haraikomip$                                        VARCHAR     (10)                                                                ,  /* 払込Ｐ(通貨型) */
     syukykp                                            DECIMAL     (11)                                                                ,  /* 主契約Ｐ */
     syukykp$                                           VARCHAR     (10)                                                                ,  /* 主契約Ｐ(通貨型) */
     zennyknmonth                                       DECIMAL     (2)                                                                 ,  /* 前回入金月数 */
     ...
     tkkzkp                                             DECIMAL     (11)                                                                ,  /* 特約継続Ｐ */
     tkkzkp$                                            VARCHAR     (10)                                                                ,  /* 特約継続Ｐ(通貨型) */
     keizokuphurikaekngk                                DECIMAL     (11)                                                                ,  /* 継続Ｐ振替金額 */
     ...
     itijibrzugktkp                                     DECIMAL     (11)                                                                ,  /* 一時払増額特約Ｐ */
     pazukarikingk                                      DECIMAL     (11)                                                                ,  /* Ｐ預り金額 */
     ...
     iktyknndp                                          DECIMAL     (13)                                                                ,  /* 一括払翌年度保険料 */
     iktyknndp$                                         VARCHAR     (10)                                                                ,  /* 一括払翌年度保険料(通貨型) */
     kigetumaenyknyknndp                                DECIMAL     (13)                                                                ,  /* 期月前入金翌年度保険料 */
     kigetumaenyknyknndp$                               VARCHAR     (10)                                                                ,  /* 期月前入金翌年度保険料(通貨型) */
     yknndpkei                                          DECIMAL     (13)                                                                ,  /* 翌年度保険料合計 */
     yknndpkei$                                         VARCHAR     (10)                                                                ,  /* 翌年度保険料合計(通貨型) */
     yobi03xn13                                         DECIMAL     (13)                                                                ,  /* 予備０３＿Ｎ１３ */
...
ALTER TABLE IT_KessanYokukiP_Z ADD CONSTRAINT PK_KessanYokukiP PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     keijyouym                                                , /* 計上年月 */
     syono                                                      /* 証券番号 */
) ;
