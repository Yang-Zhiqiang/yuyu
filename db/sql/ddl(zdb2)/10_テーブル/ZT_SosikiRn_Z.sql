CREATE TABLE ZT_SosikiRn_Z (
     ...
     zrnsosikikanjikaiadr30                             GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）組織漢字下位住所（３０文字） */
     zrnkanjibilunm15                                   GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）漢字ビル名称（１５文字） */
     ...
     zrnnewkanjisosikikaiadr30                          GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）(変更後)漢字組織下位住所（３０文字） */
     zrnnewkanjibilunm15                                GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）(変更後)漢字ビル名称（１５文字） */
...
ALTER TABLE ZT_SosikiRn_Z ADD CONSTRAINT PK_SosikiRn PRIMARY KEY (
