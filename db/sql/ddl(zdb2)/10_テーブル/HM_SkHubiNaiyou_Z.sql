CREATE TABLE HM_SkHubiNaiyou_Z (
     skhubikoumokucd                                    VARCHAR     (2)                                                       NOT NULL  ,  /* 新契約不備項目コード */
     skhubinaiyoucd                                     VARCHAR     (5)                                                       NOT NULL  ,  /* 新契約不備内容コード */
     skhubinaiyou                                       VARCHAR     (82)                                                                ,  /* 新契約不備内容 */
     skhubinaiyousentakumongon                          VARCHAR     (52)                                                                ,  /* 新契約不備内容選択文言 */
...
ALTER TABLE HM_SkHubiNaiyou_Z ADD CONSTRAINT PK_SkHubiNaiyou PRIMARY KEY (
