CREATE TABLE ZT_ZitkAzukarikinSrRendouTy_Z (
     ...
     ztyyoteirisoku                                     DECIMAL     (11)                                                                ,  /* （中継用）予定利息 */
     ...
     ztytndmatuzndkgaika                                DECIMAL     (11)                                                                ,  /* （中継用）当年度末残高（外貨） */
...
ALTER TABLE ZT_ZitkAzukarikinSrRendouTy_Z ADD CONSTRAINT PK_ZitkAzukarikinSrRendouTy PRIMARY KEY (
