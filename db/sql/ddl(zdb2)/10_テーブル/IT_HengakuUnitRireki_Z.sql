CREATE TABLE IT_HengakuUnitRireki_Z (
...
ALTER TABLE IT_HengakuUnitRireki_Z ADD CONSTRAINT PK_HengakuUnitRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_HengakuUnitRireki ON IT_HengakuUnitRireki_Z (
     syono                                                    , /* 証券番号 */
     unitfundkbn                                              , /* ユニットファンド区分 */
     henkousikibetukey                                          /* 変更識別キー */
) ;
