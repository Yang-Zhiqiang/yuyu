CREATE TABLE BM_WariateHukaInfoKanri_Z (
...
ALTER TABLE BM_WariateHukaInfoKanri_Z ADD CONSTRAINT PK_WariateHukaInfoKanri PRIMARY KEY (
...
CREATE INDEX IX1_WariateHukaInfoKanri ON BM_WariateHukaInfoKanri_Z (
     subSystemId                                              , /* サブシステムＩＤ */
     jimutetuzukicd                                           , /* 事務手続コード */
     currenttskid                                             , /* 現在タスクID */
     nexttskid                                                  /* 次回タスクID */
