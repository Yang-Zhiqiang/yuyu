CREATE TABLE IT_KhGaikaFBSoukinData_Z (
...
ALTER TABLE IT_KhGaikaFBSoukinData_Z ADD CONSTRAINT PK_KhGaikaFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_KhGaikaFBSoukinData ON IT_KhGaikaFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_KhGaikaFBSoukinData ON IT_KhGaikaFBSoukinData_Z (
     syono                                                      /* 証券番号 */
) ;
