CREATE TABLE BT_KbtKarikanjyou_Z (
     kbtkarikanjyouskbtkey                              DECIMAL     (8)                                                       NOT NULL  ,  /* 個別仮勘定識別キー */
...
ALTER TABLE BT_KbtKarikanjyou_Z ADD CONSTRAINT PK_KbtKarikanjyou PRIMARY KEY (
     kbtkarikanjyouskbtkey                                      /* 個別仮勘定識別キー */
) ;

CREATE INDEX IX1_KbtKarikanjyou ON BT_KbtKarikanjyou_Z (
     denymd                                                     /* 伝票日付 */
) ;

CREATE INDEX IX2_KbtKarikanjyou ON BT_KbtKarikanjyou_Z (
     keirisyono                                                 /* 経理用証券番号 */
) ;
