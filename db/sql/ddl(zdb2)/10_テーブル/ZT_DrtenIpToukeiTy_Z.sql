CREATE TABLE ZT_DrtenIpToukeiTy_Z (
     ...
     ztyatkisyadrtenatkiwari                            DECIMAL     (3)                                                                 ,  /* （中継用）扱者代理店扱割合 */
     ...
     ztytsrybnwari                                      DECIMAL     (3)                                                                 ,  /* （中継用）手数料分割割合 */
     ...
     ztytansyukukjdhybosyuunm                           VARCHAR     (16)                                                                ,  /* （中継用）短縮漢字代表募集人名 */
     ztyknkyknm15                                       VARCHAR     (32)                                                                ,  /* （中継用）カナ契約者名（１５文字） */
     ...
     ztysykihrkpgaika                                   DECIMAL     (13,2)                                                              ,  /* （中継用）初回払込Ｐ（外貨） */
     ztyyennykntkarihyouji                              VARCHAR     (1)                                                                 ,  /* （中継用）円入金特約有表示 */
     ztygaikanykntkarihyouji                            VARCHAR     (1)                                                                 ,  /* （中継用）外貨入金特約有表示 */
     ztykihonsgaika                                     DECIMAL     (13,2)                                                              ,  /* （中継用）基本Ｓ（外貨） */
     ztytekiyoukawaserate                               DECIMAL     (7,4)                                                               ,  /* （中継用）適用為替レート */
     ...
     ztysykihrkpsiteituuka                              DECIMAL     (13,2)                                                              ,  /* （中継用）初回払込Ｐ（指定通貨） */
     ...
     ztycardbrandkbn                                    VARCHAR     (22)                                                                ,  /* （中継用）カードブランド */
     ...
     ztyteikisiharaikin                                 DECIMAL     (13,2)                                                              ,  /* （中継用）定期支払金 */
...
ALTER TABLE ZT_DrtenIpToukeiTy_Z ADD CONSTRAINT PK_DrtenIpToukeiTy PRIMARY KEY (
