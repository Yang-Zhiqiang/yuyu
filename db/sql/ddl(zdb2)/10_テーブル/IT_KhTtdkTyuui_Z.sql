CREATE TABLE IT_KhTtdkTyuui_Z (
     kbnkey                                             VARCHAR     (2)                                                       NOT NULL  ,  /* 区分キー */
     syono                                              VARCHAR     (20)                                                      NOT NULL  ,  /* 証券番号 */
     ttdktyuuisetymd                                    VARCHAR     (8)                                                                 ,  /* 手続注意設定日 */
     ttdktyuuisetnm                                     VARCHAR     (42)                                                                ,  /* 手続注意設定者名 */
     kktyuitakbn                                        VARCHAR     (2)                                                                 ,  /* 契約管理注意取扱区分 */
     ttdktyuuinaiyou1                                   VARCHAR     (82)                                                                ,  /* 手続注意内容１ */
     ttdktyuuinaiyou2                                   VARCHAR     (82)                                                                ,  /* 手続注意内容２ */
     ttdktyuuinaiyou3                                   VARCHAR     (82)                                                                ,  /* 手続注意内容３ */
     ...
     ttdktyuuikbnhsknaiyou1                             VARCHAR     (190)                                                               ,  /* 手続注意区分補足内容１ */
     ttdktyuuikbnhsknaiyou2                             VARCHAR     (190)                                                               ,  /* 手続注意区分補足内容２ */
     ttdktyuuikbnhsknaiyou3                             VARCHAR     (190)                                                               ,  /* 手続注意区分補足内容３ */
     ttdktyuuikbnhsknaiyou4                             VARCHAR     (190)                                                               ,  /* 手続注意区分補足内容４ */
     ttdktyuuikbnhsknaiyou5                             VARCHAR     (190)                                                               ,  /* 手続注意区分補足内容５ */
...
ALTER TABLE IT_KhTtdkTyuui_Z ADD CONSTRAINT PK_KhTtdkTyuui PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_KhTtdkTyuui ON IT_KhTtdkTyuui_Z (
     syono                                                      /* 証券番号 */
) ;
