CREATE TABLE HT_MosKihon_Z (
     ...
     mosheijyunp2                                       DECIMAL     (13)                                                                ,  /* 申込平準払Ｐ＿２ */
     mosheijyunp2$                                      VARCHAR     (10)                                                                ,  /* 申込平準払Ｐ＿２(通貨型) */
     mosikkatup2                                        DECIMAL     (13)                                                                ,  /* 申込一括払Ｐ＿２ */
     mosikkatup2$                                       VARCHAR     (10)                                                                ,  /* 申込一括払Ｐ＿２(通貨型) */
     moszennoupsyokaiari2                               DECIMAL     (13)                                                                ,  /* 申込前納Ｐ（初回含）＿２ */
...
ALTER TABLE HT_MosKihon_Z ADD CONSTRAINT PK_MosKihon PRIMARY KEY (
     mosno                                                      /* 申込番号 */
) ;

CREATE INDEX IX1_MosKihon ON HT_MosKihon_Z (
     uktkid                                                     /* 受付管理ＩＤ */
) ;

CREATE INDEX IX2_MosKihon ON HT_MosKihon_Z (
     mosymd                                                     /* 申込日 */
) ;

CREATE INDEX IX3_MosKihon ON HT_MosKihon_Z (
     bosyuuym                                                   /* 募集年月 */
) ;

CREATE INDEX IX4_MosKihon ON HT_MosKihon_Z (
     seisekiym                                                  /* 成績計上年月 */
) ;

CREATE INDEX IX5_MosKihon ON HT_MosKihon_Z (
