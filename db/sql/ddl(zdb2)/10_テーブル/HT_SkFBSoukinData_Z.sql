CREATE TABLE HT_SkFBSoukinData_Z (
...
ALTER TABLE HT_SkFBSoukinData_Z ADD CONSTRAINT PK_SkFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SkFBSoukinData ON HT_SkFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_SkFBSoukinData ON HT_SkFBSoukinData_Z (
     mosno                                                      /* 申込番号 */
) ;
