CREATE TABLE IT_BAK_KhHasseijiKazeiRireki_Z (
     ...
     hasseijikngk                                       DECIMAL     (13)                                                                ,  /* 発生時金額 */
     hasseijikngk$                                      VARCHAR     (10)                                                                ,  /* 発生時金額(通貨型) */
     hasseijigstszeigk                                  DECIMAL     (13)                                                                ,  /* 発生時源泉徴収税額 */
     hasseijigstszeigk$                                 VARCHAR     (10)                                                                ,  /* 発生時源泉徴収税額(通貨型) */
     yenkansangkgoukei                                  DECIMAL     (13)                                                                ,  /* 円換算額合計 */
     yenkansangkgoukei$                                 VARCHAR     (10)                                                                ,  /* 円換算額合計(通貨型) */
     yenkansansyukngkgoukei                             DECIMAL     (13)                                                                ,  /* 円換算主たる金額小計 */
     ...
     kykadr1kj                                          VARCHAR     (62)                                                                ,  /* 契約者住所１（漢字） */
     kykadr2kj                                          VARCHAR     (62)                                                                ,  /* 契約者住所２（漢字） */
     kykadr3kj                                          VARCHAR     (62)                                                                ,  /* 契約者住所３（漢字） */
...
ALTER TABLE IT_BAK_KhHasseijiKazeiRireki_Z ADD CONSTRAINT PK_BAK_KhHasseijiKazeiRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
