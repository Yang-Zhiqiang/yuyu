CREATE TABLE JT_SiGaikaFBSoukinData_Z (
...
ALTER TABLE JT_SiGaikaFBSoukinData_Z ADD CONSTRAINT PK_SiGaikaFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_SiGaikaFBSoukinData ON JT_SiGaikaFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
