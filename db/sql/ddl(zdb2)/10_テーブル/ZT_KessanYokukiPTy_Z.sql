CREATE TABLE ZT_KessanYokukiPTy_Z (
     ztykeijyouym                                       VARCHAR     (6)                                                       NOT NULL  ,  /* （中継用）計上年月 */
     ...
     ztyzennyknmonth                                    DECIMAL     (2)                                                                 ,  /* （中継用）前回入金月数 */
     ztyzenyuukinymd                                    VARCHAR     (8)                                                                 ,  /* （中継用）前回入金年月日 */
     ztyjidoukousinhyouji                               VARCHAR     (1)                                                                 ,  /* （中継用）自動更新表示 */
     ztytenkanhyouji                                    VARCHAR     (1)                                                                 ,  /* （中継用）転換表示 */
     ztyhosyouikkatumnoshyouji                          VARCHAR     (1)                                                                 ,  /* （中継用）保障一括見直表示 */
     ztyyobi01xv40                                      VARCHAR     (40)                                                                ,  /* （中継用）予備０１＿Ｖ４０ */
     ztytkkzkp                                          DECIMAL     (11)                                                                ,  /* （中継用）特約継続Ｐ */
     ztykeizokuphurikaekngk                             DECIMAL     (11)                                                                ,  /* （中継用）継続Ｐ振替金額 */
     ztykeizokuphurikaekaisiym                          VARCHAR     (6)                                                                 ,  /* （中継用）継続Ｐ振替開始年月 */
     ztyharaikomipannaisaikaiym                         VARCHAR     (6)                                                                 ,  /* （中継用）払込Ｐ案内再開年月 */
     ztytkkzkkouryokukaisiymd                           VARCHAR     (8)                                                                 ,  /* （中継用）特約継続効力開始年月日 */
     ztyhrimngtkykpjyuutouhoukbn                        VARCHAR     (1)                                                                 ,  /* （中継用）払満後特約Ｐ充当方法区分 */
     ztyjkitkpjytym                                     VARCHAR     (6)                                                                 ,  /* （中継用）次回特約Ｐ充当年月 */
     ztyitijibrzugktkp                                  DECIMAL     (11)                                                                ,  /* （中継用）一時払増額特約Ｐ */
     ztypazukarikingk                                   DECIMAL     (11)                                                                ,  /* （中継用）Ｐ預り金額 */
     ztyzennoukbn                                       VARCHAR     (1)                                                                 ,  /* （中継用）前納区分 */
     ztyzennoukaisiymd                                  VARCHAR     (8)                                                                 ,  /* （中継用）前納開始年月日 */
     ztyzennounyuukinymd                                VARCHAR     (8)                                                                 ,  /* （中継用）前納入金年月日 */
     ztyyokukipbunruicd                                 VARCHAR     (3)                                                                 ,  /* （中継用）翌期Ｐ分類コード */
     ztymisyoricd1                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード１ */
     ztymisyoricd2                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード２ */
     ztymisyoricd3                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード３ */
     ztymisyoricd4                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード４ */
     ztymisyoricd5                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード５ */
     ztymisyoricd6                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード６ */
     ztymisyoricd7                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード７ */
     ztymisyoricd8                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード８ */
     ztymisyoricd9                                      VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード９ */
     ztymisyoricd10                                     VARCHAR     (4)                                                                 ,  /* （中継用）未処理コード１０ */
     ztyyobi02xv39                                      VARCHAR     (39)                                                                ,  /* （中継用）予備０２＿Ｖ３９ */
     ...
     ztyiktyknndp                                       DECIMAL     (15)                                                                ,  /* （中継用）一括払翌年度保険料 */
     ztykigetumaenyknyknndp                             DECIMAL     (15)                                                                ,  /* （中継用）期月前入金翌年度保険料 */
     ztyyknndpkei                                       DECIMAL     (15)                                                                ,  /* （中継用）翌年度保険料合計 */
     ztyyobi03xn15                                      DECIMAL     (15)                                                                ,  /* （中継用）予備０３＿Ｎ１５ */
     ztyyobi04xv23                                      VARCHAR     (23)                                                                ,  /* （中継用）予備０４＿Ｖ２３ */
...
ALTER TABLE ZT_KessanYokukiPTy_Z ADD CONSTRAINT PK_KessanYokukiPTy PRIMARY KEY (
