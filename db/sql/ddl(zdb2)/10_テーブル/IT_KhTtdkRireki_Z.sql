CREATE TABLE IT_KhTtdkRireki_Z (
...
ALTER TABLE IT_KhTtdkRireki_Z ADD CONSTRAINT PK_KhTtdkRireki PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;

CREATE INDEX IX1_KhTtdkRireki ON IT_KhTtdkRireki_Z (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                          /* 変更識別キー */
) ;

CREATE INDEX IX2_KhTtdkRireki ON IT_KhTtdkRireki_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX3_KhTtdkRireki ON IT_KhTtdkRireki_Z (
     gyoumuKousinKinou                                          /* 業務用更新機能ＩＤ */
) ;

CREATE INDEX IX4_KhTtdkRireki ON IT_KhTtdkRireki_Z (
     syorikbn                                                 , /* 処理区分 */
     syoriYmd                                                   /* 処理年月日 */
) ;
