CREATE TABLE ZT_SeirituInfoTy_Z (
     ...
     ztykihons9                                         DECIMAL     (9)                                                                 ,  /* （中継用）基本Ｓ（９桁） */
     ztyhsys                                            DECIMAL     (11)                                                                ,  /* （中継用）保障Ｓ */
     ztytkbriknsnhrkp                                   DECIMAL     (11)                                                                ,  /* （中継用）月払換算払込Ｐ */
     ...
     ztysinkeiyakujiyoteiriritu                         DECIMAL     (5,4)                                                               ,  /* （中継用）新契約時予定利率 */
     ztysiteituukakihons                                DECIMAL     (13,2)                                                              ,  /* （中継用）指定通貨建基本Ｓ */
     ztyhrktuukakbn                                     VARCHAR     (1)                                                                 ,  /* （中継用）払込通貨区分 */
     ztysiteituukakbn                                   VARCHAR     (1)                                                                 ,  /* （中継用）指定通貨区分 */
     ztyhrktuukatukiknznhrkp                            DECIMAL     (13,2)                                                              ,  /* （中継用）払込通貨建月換算払込Ｐ */
     ztysiteituukatukiknznhrkp                          DECIMAL     (13,2)                                                              ,  /* （中継用）指定通貨建月換算払込Ｐ */
     ztyyennyknrate                                     DECIMAL     (7,4)                                                               ,  /* （中継用）円入金レート */
     ztygaikanyknrate                                   DECIMAL     (7,4)                                                               ,  /* （中継用）外貨入金レート */
     ztyjyudkaigomehrtkarihyj                           VARCHAR     (1)                                                                 ,  /* （中継用）重度介護前払特約有表示 */
     ztysyksbyensitihsyutkykrate                        DECIMAL     (7,4)                                                               ,  /* （中継用）初期死亡時円換算最低保証特約用為替レート */
     ztysjkkktyouseiriritu                              DECIMAL     (5,4)                                                               ,  /* （中継用）市場価格調整用利率 */
     ztytargettkmkht                                    DECIMAL     (3)                                                                 ,  /* （中継用）ターゲット特約目標値 */
     ztyteirituhaibunwari                               VARCHAR     (3)                                                                 ,  /* （中継用）定率部分配分割合 */
     ztyzenkizennouhyouji                               VARCHAR     (1)                                                                 ,  /* （中継用）全期前納表示 */
     ztypwaribikikbn                                    VARCHAR     (2)                                                                 ,  /* （中継用）Ｐ割引区分 */
     ztypwaribikihanteigk                               DECIMAL     (11)                                                                ,  /* （中継用）Ｐ割引判定金額 */
...
ALTER TABLE ZT_SeirituInfoTy_Z ADD CONSTRAINT PK_SeirituInfoTy PRIMARY KEY (
