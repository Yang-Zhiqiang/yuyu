CREATE TABLE IT_KhFBSoukinData_Z (
...
ALTER TABLE IT_KhFBSoukinData_Z ADD CONSTRAINT PK_KhFBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_KhFBSoukinData ON IT_KhFBSoukinData_Z (
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX2_KhFBSoukinData ON IT_KhFBSoukinData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
