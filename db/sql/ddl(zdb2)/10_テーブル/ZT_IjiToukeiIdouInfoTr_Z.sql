CREATE TABLE ZT_IjiToukeiIdouInfoTr_Z (
     ztrsyono                                           VARCHAR     (11)                                                      NOT NULL  ,  /* （取込用）証券番号 */
     ztrsyoriymd                                        VARCHAR     (8)                                                                 ,  /* （取込用）処理年月日 */
     ztrkykmfksnctr                                     DECIMAL     (7)                                                       NOT NULL  ,  /* （取込用）契約ＭＦ更新ＣＴＲ */
     ...
     ztrkisnkihons                                      DECIMAL     (7)                                                                 ,  /* （取込用）計算基本Ｓ */
     ztrimustiyusbus                                    DECIMAL     (7)                                                                 ,  /* （取込用）医務査定用死亡Ｓ */
     ztrshrs                                            DECIMAL     (7)                                                                 ,  /* （取込用）支払Ｓ */
     ...
     ztryobisuuti7x1                                    DECIMAL     (7)                                                                 ,  /* （取込用）予備数値７＿１ */
     ztryobisuuti7x2                                    DECIMAL     (7)                                                                 ,  /* （取込用）予備数値７＿２ */
...
ALTER TABLE ZT_IjiToukeiIdouInfoTr_Z ADD CONSTRAINT PK_IjiToukeiIdouInfoTr PRIMARY KEY (
     ztrsyono                                                 , /* （取込用）証券番号 */
