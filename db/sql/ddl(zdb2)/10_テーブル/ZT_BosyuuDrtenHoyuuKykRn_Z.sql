CREATE TABLE ZT_BosyuuDrtenHoyuuKykRn_Z (
     ...
     zrnhhknadrkj50                                     GRAPHIC     (50)                                                      NOT NULL  ,  /* （連携用）被保険者漢字住所５０ */
     ...
     zrnknjsyuhsynm                                     GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字主契約保種名 */
     ...
     zrnkjtkhosyunm1                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名１ */
     ...
     zrnkjtkhosyunm2                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名２ */
     ...
     zrnkjtkhosyunm3                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名３ */
     ...
     zrnkjtkhosyunm4                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名４ */
     ...
     zrnkjtkhosyunm5                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名５ */
     ...
     zrnkjtkhosyunm6                                    GRAPHIC     (8)                                                       NOT NULL  ,  /* （連携用）漢字特約保種名６ */
     ...
     zrnkyknmkjbsdirtnhykyk                             GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）契約者名(漢字）（募集代理店保有契約） */
     ...
     zrnbosyuunm                                        GRAPHIC     (17)                                                      NOT NULL  ,  /* （連携用）募集人氏名 */
     ...
     zrnsgsbs                                           DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）災害死亡S */
     ...
     zrnsiteituukaitijibrp                              DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）指定通貨建一時払保険料 */
     zrnsiteituukasyus                                  DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）指定通貨建主契約保険金額 */
     zrnsiteituukasbs                                   DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）指定通貨建死亡保険金額 */
     zrnsiteituukasaigaisbs                             DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）指定通貨建災害死亡保険金額 */
     zrnsiteituukacd                                    CHAR        (3)                                                       NOT NULL  ,  /* （連携用）指定通貨コード */
     zrnhrktuukaitijibrp                                DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）払込通貨建一時払保険料 */
     ...
     zrnkjsbuktnm30                                     GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）漢字死亡受取人名３０ */
     zrnmnkuktnm30                                      GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）漢字満期受取人名３０ */
     zrnkjkykdairinm                                    GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）漢字契約者代理人名 */
     zrnkjsiteidairinm30                                GRAPHIC     (30)                                                      NOT NULL  ,  /* （連携用）漢字指定代理人名３０ */
     ...
     zrntikskzuktnmkj                                   GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）定期支払金受取人名（漢字） */
...
ALTER TABLE ZT_BosyuuDrtenHoyuuKykRn_Z ADD CONSTRAINT PK_BosyuuDrtenHoyuuKykRn PRIMARY KEY (
