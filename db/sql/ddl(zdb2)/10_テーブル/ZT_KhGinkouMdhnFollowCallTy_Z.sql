CREATE TABLE ZT_KhGinkouMdhnFollowCallTy_Z (
     ztysyono                                           VARCHAR     (11)                                                      NOT NULL  ,  /* （中継用）証券番号 */
     ztysyorikbn                                        VARCHAR     (1)                                                                 ,  /* （中継用）処理区分 */
     ztyannaip                                          DECIMAL     (11)                                                                ,  /* （中継用）案内保険料 */
     ztyyobiv8                                          VARCHAR     (8)                                                                 ,  /* （中継用）予備項目Ｖ８ */
     ztyminyuuym                                        VARCHAR     (6)                                                       NOT NULL  ,  /* （中継用）未入年月 */
     ztyskymd                                           VARCHAR     (8)                                                                 ,  /* （中継用）失効年月日 */
     ztyskhr                                            DECIMAL     (11)                                                                ,  /* （中継用）失効時返戻金 */
     ztyttkekin                                         DECIMAL     (11)                                                                ,  /* （中継用）今期立替金額 */
     ztyttkeganri                                       DECIMAL     (11)                                                                ,  /* （中継用）立替元利金合計 */
     ztyttkersk                                         DECIMAL     (11)                                                                ,  /* （中継用）立替利息 */
     ...
     ztykjkyknm35keta                                   VARCHAR     (72)                                                                ,  /* （中継用）漢字契約者名（３５桁） */
     ztyknkyksyamei                                     VARCHAR     (84)                                                                ,  /* （中継用）カナ契約者名 */
     ...
     ztykyksyaadr                                       VARCHAR     (126)                                                               ,  /* （中継用）契約者住所 */
     ...
     ztyhknmeisyou15keta                                VARCHAR     (32)                                                                ,  /* （中継用）保険名称（１５桁） */
...
ALTER TABLE ZT_KhGinkouMdhnFollowCallTy_Z ADD CONSTRAINT PK_KhGinkouMdhnFollowCallTy PRIMARY KEY (
     ztysyono                                                 , /* （中継用）証券番号 */
