CREATE TABLE BT_BuntanInfo_Z (
     ...
     tesuuryoubuntanwariai                              DECIMAL     (3)                                                                 ,  /* 手数料分担割合 */
...
ALTER TABLE BT_BuntanInfo_Z ADD CONSTRAINT PK_BuntanInfo PRIMARY KEY (
     drtencd                                                  , /* 代理店コード */
...
CREATE INDEX IX1_BuntanInfo ON BT_BuntanInfo_Z (
     drtencd                                                  , /* 代理店コード */
     dairitensyouhincd                                        , /* 代理店商品コード */
     tesuuryoubuntanstartym                                     /* 手数料分担開始年月 */
) ;
