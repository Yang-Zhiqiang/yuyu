CREATE TABLE MW_DsNeugokiHanteiKekkaWk_Z (
...
ALTER TABLE MW_DsNeugokiHanteiKekkaWk_Z ADD CONSTRAINT PK_DsNeugokiHanteiKekkaWk PRIMARY KEY (
     dsdatasakuseiymd                                         , /* ＤＳデータ作成日 */
     syono                                                      /* 証券番号 */
) ;

CREATE INDEX IX1_DsNeugokiHanteiKekkaWk ON MW_DsNeugokiHanteiKekkaWk_Z (
     syono                                                      /* 証券番号 */
) ;
