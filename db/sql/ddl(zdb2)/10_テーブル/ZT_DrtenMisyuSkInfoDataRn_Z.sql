CREATE TABLE ZT_DrtenMisyuSkInfoDataRn_Z (
     zrnsyono                                           CHAR        (11)                                                      NOT NULL  ,  /* （連携用）証券番号 */
     zrnbsydrtencd                                      CHAR        (7)                                                       NOT NULL  ,  /* （連携用）募集代理店コード */
     zrnkykymd                                          CHAR        (8)                                                       NOT NULL  ,  /* （連携用）契約年月日 */
     zrnhnsyugknjkyksynm                                GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）編集後漢字契約者名 */
     ...
     zrn1kaip                                           DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）１回分保険料 */
     zrnnexthurikaeyoteigk                              DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）次回振替予定金額 */
...
ALTER TABLE ZT_DrtenMisyuSkInfoDataRn_Z ADD CONSTRAINT PK_DrtenMisyuSkInfoDataRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
