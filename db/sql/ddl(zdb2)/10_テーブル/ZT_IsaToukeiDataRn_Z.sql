CREATE TABLE ZT_IsaToukeiDataRn_Z (
     ...
     zrnsibous7                                         DECIMAL     (7)                                                       NOT NULL  ,  /* （連携用）死亡Ｓ（７桁） */
     ...
     zrnbmi                                             DECIMAL     (3)                                                       NOT NULL  ,  /* （連携用）ＢＭＩ */
     ...
     zrnjissituhosyous                                  DECIMAL     (7)                                                       NOT NULL  ,  /* （連携用）実質保障Ｓ */
     ...
     zrnteikisiharaikinmanen                            DECIMAL     (7)                                                       NOT NULL  ,  /* （連携用）定期支払金（万円） */
     zrnyobiv45                                         CHAR        (45)                                                      NOT NULL     /* （連携用）予備項目Ｖ４５ */
)
;

ALTER TABLE ZT_IsaToukeiDataRn_Z ADD CONSTRAINT PK_IsaToukeiDataRn PRIMARY KEY (
     zrnmosno                                                   /* （連携用）申込番号 */
) ;
