CREATE TABLE HW_SyuHukugouSikkanZhkWk_Z (
     syono                                              VARCHAR     (20)                                                      NOT NULL  ,  /* 証券番号 */
     hknnendo                                           DECIMAL     (2)                                                       NOT NULL  ,  /* 保険年度 */
     ijitoukeidaihyousyurui                             VARCHAR     (2)                                                                 ,  /* 医事統計用代表種類 */
     kyknendo                                           VARCHAR     (4)                                                                 ,  /* 契約年度 */
     hhknsei                                            VARCHAR     (1)                                                                 ,  /* 被保険者性別 */
     kykage                                             DECIMAL     (3)                                                                 ,  /* 加入年齢 */
     toutatunenrei                                      DECIMAL     (3)                                                                 ,  /* 到達年齢 */
     ...
     ijitoukeikeikan                                    DECIMAL     (7,6)                                                               ,  /* 医事統計用経過Ｎ */
     ijitoukeisiboun                                    DECIMAL     (5)                                                                 ,  /* 医事統計用死亡Ｎ */
     ijitoukeikeikas                                    DECIMAL     (14,5)                                                              ,  /* 医事統計用経過Ｓ */
     ijitoukeisibous                                    DECIMAL     (9)                                                                 ,  /* 医事統計用死亡Ｓ */
...
ALTER TABLE HW_SyuHukugouSikkanZhkWk_Z ADD CONSTRAINT PK_SyuHukugouSikkanZhkWk PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     hknnendo                                                   /* 保険年度 */
) ;

CREATE INDEX IX1_SyuHukugouSikkanZhkWk ON HW_SyuHukugouSikkanZhkWk_Z (
     hknnendo                                                 , /* 保険年度 */
