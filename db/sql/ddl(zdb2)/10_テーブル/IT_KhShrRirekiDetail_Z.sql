CREATE TABLE IT_KhShrRirekiDetail_Z (
...
ALTER TABLE IT_KhShrRirekiDetail_Z ADD CONSTRAINT PK_KhShrRirekiDetail PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
...
CREATE INDEX IX1_KhShrRirekiDetail ON IT_KhShrRirekiDetail_Z (
     syono                                                    , /* 証券番号 */
     henkousikibetukey                                        , /* 変更識別キー */
     syouhncd                                                 , /* 商品コード */
     syouhnsdno                                               , /* 商品世代番号 */
