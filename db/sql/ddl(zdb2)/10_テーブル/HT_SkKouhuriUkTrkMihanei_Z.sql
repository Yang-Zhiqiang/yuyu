CREATE TABLE HT_SkKouhuriUkTrkMihanei_Z (
...
ALTER TABLE HT_SkKouhuriUkTrkMihanei_Z ADD CONSTRAINT PK_SkKouhuriUkTrkMihanei PRIMARY KEY (
     syoriYmd                                                 , /* 処理年月日 */
     syukkncd                                                 , /* 収納機関コード */
...
CREATE INDEX IX1_SkKouhuriUkTrkMihanei ON HT_SkKouhuriUkTrkMihanei_Z (
     nykmosno                                                   /* 入金用申込番号 */
) ;
