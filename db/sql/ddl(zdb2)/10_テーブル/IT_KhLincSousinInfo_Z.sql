CREATE TABLE IT_KhLincSousinInfo_Z (
...
ALTER TABLE IT_KhLincSousinInfo_Z ADD CONSTRAINT PK_KhLincSousinInfo PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
...
CREATE INDEX IX1_KhLincSousinInfo ON IT_KhLincSousinInfo_Z (
     lincsoujyusinsyskbn                                      , /* ＬＩＮＣ送受信用システム区分 */
     syono                                                    , /* 証券番号 */
     renno                                                      /* 連番 */
) ;
