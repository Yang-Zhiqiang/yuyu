CREATE TABLE IT_KhDenpyoData_Z (
...
ALTER TABLE IT_KhDenpyoData_Z ADD CONSTRAINT PK_KhDenpyoData PRIMARY KEY (
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_KhDenpyoData ON IT_KhDenpyoData_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;

CREATE INDEX IX2_KhDenpyoData ON IT_KhDenpyoData_Z (
     syono                                                      /* 証券番号 */
) ;
