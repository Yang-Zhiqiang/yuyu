CREATE TABLE BT_SinkeiyakuHurikaeDen_Z (
...
ALTER TABLE BT_SinkeiyakuHurikaeDen_Z ADD CONSTRAINT PK_SinkeiyakuHurikaeDen PRIMARY KEY (
     densyskbn                                                , /* 伝票用システム区分 */
     denrenno                                                 , /* 伝票データ連番 */
     edano                                                      /* 枝番号 */
) ;

CREATE INDEX IX1_SinkeiyakuHurikaeDen ON BT_SinkeiyakuHurikaeDen_Z (
     syoriYmd                                                   /* 処理年月日 */
) ;
