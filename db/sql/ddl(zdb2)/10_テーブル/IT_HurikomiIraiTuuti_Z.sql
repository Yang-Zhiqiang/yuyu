CREATE TABLE IT_HurikomiIraiTuuti_Z (
     ...
     tsinadr4kj                                         VARCHAR     (62)                                                                ,  /* 通信先住所４（漢字） */
...
ALTER TABLE IT_HurikomiIraiTuuti_Z ADD CONSTRAINT PK_HurikomiIraiTuuti PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;

CREATE INDEX IX1_HurikomiIraiTuuti ON IT_HurikomiIraiTuuti_Z (
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;
