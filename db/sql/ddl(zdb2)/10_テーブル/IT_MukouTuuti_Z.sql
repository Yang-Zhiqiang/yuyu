...
ALTER TABLE IT_MukouTuuti_Z ADD CONSTRAINT PK_MukouTuuti PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;

CREATE INDEX IX1_MukouTuuti ON IT_MukouTuuti_Z (
     syono                                                    , /* 証券番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;
