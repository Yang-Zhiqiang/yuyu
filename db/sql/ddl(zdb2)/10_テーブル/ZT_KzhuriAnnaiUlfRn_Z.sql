CREATE TABLE ZT_KzhuriAnnaiUlfRn_Z (
     ...
     zrnkeizokup                                        DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）継続保険料 */
     zrniktwaribikikgk                                  DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）一括割引額 */
...
ALTER TABLE ZT_KzhuriAnnaiUlfRn_Z ADD CONSTRAINT PK_KzhuriAnnaiUlfRn PRIMARY KEY (
     zrnsyono                                                 , /* （連携用）証券番号 */
