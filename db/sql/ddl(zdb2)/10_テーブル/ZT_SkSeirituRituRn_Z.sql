CREATE TABLE ZT_SkSeirituRituRn_Z (
     zrneigyouhonbusisyacd                              CHAR        (7)                                                       NOT NULL  ,  /* （連携用）営業本部支社コード */
     zrnsisyanm                                         GRAPHIC     (20)                                                      NOT NULL  ,  /* （連携用）支社名 */
     zrnsosikicd                                        CHAR        (7)                                                       NOT NULL  ,  /* （連携用）組織コード */
     zrnkanjisosikinm20                                 GRAPHIC     (20)                                                      NOT NULL  ,  /* （連携用）漢字組織名（２０文字） */
     ...
     zrnsinhsys                                         DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）新保障Ｓ */
...
ALTER TABLE ZT_SkSeirituRituRn_Z ADD CONSTRAINT PK_SkSeirituRituRn PRIMARY KEY (
