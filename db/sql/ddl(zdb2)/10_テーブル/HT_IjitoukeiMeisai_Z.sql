CREATE TABLE HT_IjitoukeiMeisai_Z (
     syono                                              VARCHAR     (20)                                                      NOT NULL  ,  /* 証券番号 */
     renno8keta                                         DECIMAL     (8)                                                       NOT NULL  ,  /* 連番（８桁） */
     ...
     jissituhosyous                                     DECIMAL     (13)                                                                ,  /* 実質保障Ｓ */
     jissituhosyous$                                    VARCHAR     (10)                                                                ,  /* 実質保障Ｓ(通貨型) */
     jissituhosyousmanen                                DECIMAL     (9)                                                                 ,  /* 実質保障Ｓ（万円） */
     ...
     teikisiharaikinmanen                               DECIMAL     (9)                                                                 ,  /* 定期支払金（万円） */
     teikisiharaikinmanen$                              VARCHAR     (10)                                                                   /* 定期支払金（万円）(通貨型) */
)
;

ALTER TABLE HT_IjitoukeiMeisai_Z ADD CONSTRAINT PK_IjitoukeiMeisai PRIMARY KEY (
     syono                                                    , /* 証券番号 */
     renno8keta                                                 /* 連番（８桁） */
) ;

CREATE INDEX IX1_IjitoukeiMeisai ON HT_IjitoukeiMeisai_Z (
     syoumetuymd                                                /* 消滅日 */
) ;

CREATE INDEX IX2_IjitoukeiMeisai ON HT_IjitoukeiMeisai_Z (
     kykymd                                                     /* 契約日 */
) ;
