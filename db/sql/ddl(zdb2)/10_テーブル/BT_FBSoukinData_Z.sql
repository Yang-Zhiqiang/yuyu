CREATE TABLE BT_FBSoukinData_Z (
     ...
     fbsoukinbatchkbn                                   VARCHAR     (1)                                                                    /* ＦＢ送金バッチ区分 */
)
;

ALTER TABLE BT_FBSoukinData_Z ADD CONSTRAINT PK_FBSoukinData PRIMARY KEY (
     fbsoukindatasikibetukey                                    /* ＦＢ送金データ識別キー */
) ;

CREATE INDEX IX1_FBSoukinData ON BT_FBSoukinData_Z (
     syoriYmd                                                 , /* 処理年月日 */
