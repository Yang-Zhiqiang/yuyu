CREATE TABLE ZT_TiginSinkinBosTr_Z (
     ...
     ztrseihowebhhknadr                                 VARCHAR     (250)                                                               ,  /* （取込用）生保Ｗｅｂ被保険者住所 */
     ztrseihowebkykknnm                                 VARCHAR     (38)                                                                ,  /* （取込用）生保Ｗｅｂ契約者カナ氏名 */
     ztrseihowebkykkjnm                                 VARCHAR     (24)                                                                ,  /* （取込用）生保Ｗｅｂ契約者漢字氏名 */
     ...
     ztrseihowebkykadr                                  VARCHAR     (250)                                                               ,  /* （取込用）生保Ｗｅｂ契約者住所 */
     ztrseihowebhknsyuruino                             VARCHAR     (3)                                                                 ,  /* （取込用）生保Ｗｅｂ保険種類番号 */
     ztrseihowebhjkktkbn                                VARCHAR     (1)                                                                 ,  /* （取込用）生保Ｗｅｂ報状告知区分 */
     ztrseihowebhknkkn                                  DECIMAL     (2)                                                                 ,  /* （取込用）生保Ｗｅｂ保険期間 */
     ztrseihowebphrkkikn                                DECIMAL     (2)                                                                 ,  /* （取込用）生保ＷｅｂＰ払込期間 */
     ...
     ztrseihowebkihons                                  DECIMAL     (9)                                                                 ,  /* （取込用）生保Ｗｅｂ基本Ｓ */
     ...
     ztrseihowebsbuktknnm                               VARCHAR     (38)                                                                ,  /* （取込用）生保Ｗｅｂ死亡受取人カナ氏名 */
     ztrseihowebsbuktkjnm                               VARCHAR     (24)                                                                ,  /* （取込用）生保Ｗｅｂ死亡受取人漢字氏名 */
     ...
     ztrseihowebteiwkkn                                 DECIMAL     (9)                                                                 ,  /* （取込用）生保Ｗｅｂ低Ｗ期間 */
     ...
     ztrseihowebsykihrkp1                               DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ初回払込Ｐ１ */
     ztrseihowebmosp1                                   DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ申込Ｐ１ */
     ...
     ztrseihowebtargettkmkht                            DECIMAL     (3)                                                                 ,  /* （取込用）生保Ｗｅｂターゲット特約目標値 */
     ztrseihowebnykntuukanykngk                         DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ入金通貨入金額 */
     ztrseihowebnykntukfsthrkp                          DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ入金通貨初回払込Ｐ */
     ztrseihowebnykntuknexthrkp                         DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ入金通貨次回払込Ｐ */
     ztrseihowebsaimankihyj                             VARCHAR     (1)                                                                 ,  /* （取込用）生保Ｗｅｂ才満期表示 */
     ztrseihowebrayhyj                                  VARCHAR     (1)                                                                 ,  /* （取込用）生保ＷｅｂＲＡＹ表示 */
     ztrseihowebgnykntuknykngk                          DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨入金通貨入金額 */
     ztrseihowebgnykntukfsthrkp                         DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨入金通貨初回Ｐ */
     ztrseihowebgnykntuknxthrkp                         DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨入金通貨次回Ｐ */
     ztrseihowebgaikakihonp                             DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨基本Ｐ */
     ztrseihowebkaigmehrtkarihyj                        VARCHAR     (1)                                                                 ,  /* （取込用）生保Ｗｅｂ介護前払特約有表示 */
     ztrseihowebyenhsyutkarihyj                         VARCHAR     (1)                                                                 ,  /* （取込用）生保Ｗｅｂ円最低保証特約有表示 */
     ztrseihowebgaikakihons                             DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨基本Ｓ */
     ztrseihowebdai1hknkkn                              DECIMAL     (2)                                                                 ,  /* （取込用）生保Ｗｅｂ第１保険期間 */
     ...
     ztrseihowebssrndhbnwr                              DECIMAL     (3)                                                                 ,  /* （取込用）生保Ｗｅｂ指数連動部分配分割合 */
     ztrseihowebtrtrndhbnwr                             DECIMAL     (3)                                                                 ,  /* （取込用）生保Ｗｅｂ定率積立部分配分割合 */
     ztrseihowebsueokikkn                               DECIMAL     (2)                                                                 ,  /* （取込用）生保Ｗｅｂ据置期間 */
     ...
     ztrseihowebikkatup                                 DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ一括払Ｐ */
     ztrseihowebikkatubaraikbn                          VARCHAR     (1)                                                                 ,  /* （取込用）生保Ｗｅｂ一括払区分 */
     ztrseihowebiktbrikaisuu                            DECIMAL     (2)                                                                 ,  /* （取込用）生保Ｗｅｂ一括払回数 */
     ztrseihowebzennoup                                 DECIMAL     (10)                                                                ,  /* （取込用）生保Ｗｅｂ前納Ｐ */
     ztrseihowebgaikazennoup                            DECIMAL     (13)                                                                ,  /* （取込用）生保Ｗｅｂ外貨前納Ｐ */
     ztrseihowebzennoukkn                               DECIMAL     (2)                                                                 ,  /* （取込用）生保Ｗｅｂ前納期間 */
...
ALTER TABLE ZT_TiginSinkinBosTr_Z ADD CONSTRAINT PK_TiginSinkinBosTr PRIMARY KEY (
...
CREATE INDEX IX1_TiginSinkinBosTr ON ZT_TiginSinkinBosTr_Z (
