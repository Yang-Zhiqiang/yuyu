CREATE TABLE ZT_SiharaiTyousyoRn_Z (
     ...
     zrnuktnmkj35                                       GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）受取人名（漢字）（３５桁） */
     zrndaihyouktkbn                                    CHAR        (1)                                                       NOT NULL  ,  /* （連携用）代表受取人区分 */
     zrnkjdaihyouuktnm                                  GRAPHIC     (15)                                                      NOT NULL  ,  /* （連携用）漢字代表受取人名 */
     ...
     zrnmfjyuusyo                                       GRAPHIC     (62)                                                      NOT NULL  ,  /* （連携用）ＭＦ住所 */
     ...
     zrnkjoldkykkaiadr                                  GRAPHIC     (62)                                                      NOT NULL  ,  /* （連携用）漢字旧契約者下位住所 */
     zrnkjoldkyknm                                      GRAPHIC     (35)                                                      NOT NULL  ,  /* （連携用）漢字旧契約者名 */
     ...
     zrnshrgk11                                         DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）支払金額Ｎ１１ */
     zrnwarimsishrgk                                    DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）割増支払金額 */
     zrnznnphr                                          DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）前納Ｐ等返戻金 */
     zrnttkekstkganri                                   DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）立替貸付元利金 */
     zrnsshkd                                           DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）差引Ｄ */
     zrnsasihikisiharaigaku                             DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）差引支払金額 */
     zrnmihrkmp                                         DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）未払込Ｐ */
     zrnshrtienrsk11                                    DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）支払遅延利息Ｎ１１ */
     zrntysyouhtykeihi                                  DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）調書用必要経費 */
     zrngenkykhtykeihiyouhyj                            CHAR        (1)                                                       NOT NULL  ,  /* （連携用）現契約者必要経費要表示 */
     zrngenkykhtykeihi                                  DECIMAL     (11)                                                      NOT NULL  ,  /* （連携用）現契約者必要経費 */
...
ALTER TABLE ZT_SiharaiTyousyoRn_Z ADD CONSTRAINT PK_SiharaiTyousyoRn PRIMARY KEY (
