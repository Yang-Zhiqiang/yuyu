CREATE TABLE HT_YuukoukknKykList_Z (
     ...
     syusyouhnnm                                        VARCHAR     (82)                                                                ,  /* 主契約商品名 */
     dntcd                                              VARCHAR     (8)                                                                 ,  /* 団体コード */
     dntnm                                              VARCHAR     (62)                                                                ,  /* 団体名 */
     ...
     rfstphrkkeiro                                      VARCHAR     (22)                                                                ,  /* （帳票用）初回保険料払込経路 */
...
ALTER TABLE HT_YuukoukknKykList_Z ADD CONSTRAINT PK_YuukoukknKykList PRIMARY KEY (
     mosno                                                    , /* 申込番号 */
     tyouhyouymd                                                /* 帳票作成日 */
) ;
