CREATE TABLE IT_KhHenkouUktk_Z (
...
ALTER TABLE IT_KhHenkouUktk_Z ADD CONSTRAINT PK_KhHenkouUktk PRIMARY KEY (
     kbnkey                                                   , /* 区分キー */
     syono                                                    , /* 証券番号 */
     hozenhenkouuktkrenno                                       /* 保全変更受付連番 */
) ;

CREATE INDEX IX1_KhHenkouUktk ON IT_KhHenkouUktk_Z (
     syoriyoteiymd                                            , /* 処理予定日 */
     uktksyorikbn                                             , /* 受付処理区分 */
