CREATE VIEW ZT_KsnKbkSsuRnduHknJigyohiTy AS SELECT
     ...
     ztyloadingkeijyoym ,         /* （中継用）ローディング計上年月 */
     ztysihankiksnydatahyj ,         /* （中継用）四半期決算用データ表示 */
     ztygmkijyhyj ,         /* （中継用）月末計上表示 */
     ztysuuriyouyobin12 ,         /* （中継用）数理用予備項目Ｎ１２ */
     ztyyobiv20 ,         /* （中継用）予備項目Ｖ２０ */
     ztyyobin11x18 ,         /* （中継用）予備項目Ｎ１１＿１８ */
     ztyvhireilkisnyukngkx1 ,         /* （中継用）Ｖ比例Ｌ計算用金額＿１ */
     ztyyobin11x19 ,         /* （中継用）予備項目Ｎ１１＿１９ */
     ztyyobin11x20 ,         /* （中継用）予備項目Ｎ１１＿２０ */
     ztyyobin11x21 ,         /* （中継用）予備項目Ｎ１１＿２１ */
     ztyvhireilkisnyukngkx2 ,         /* （中継用）Ｖ比例Ｌ計算用金額＿２ */
     ztyyobin11x22 ,         /* （中継用）予備項目Ｎ１１＿２２ */
     ztyyobin11x23 ,         /* （中継用）予備項目Ｎ１１＿２３ */
     ztyrpkeisanyousibous ,         /* （中継用）ＲＰ計算用死亡Ｓ */
     ztykikens ,         /* （中継用）危険保険金 */
     ztyvhireialpha ,         /* （中継用）Ｖ比例α */
     ztyvhireibeta ,         /* （中継用）Ｖ比例β */
     ztykikenp ,         /* （中継用）危険保険料 */
     ztyvhireilritu ,         /* （中継用）Ｖ比例Ｌ率 */
     ztykikenpritu ,         /* （中継用）危険保険料率 */
     ztytumimasimaew ,         /* （中継用）積増前Ｗ */
     ...
     kousinKinou ,         /* 更新機能 */
     version           /* バージョン */
FROM ZT_KsnKbkSsuRnduHknJigyohiTy_Z;