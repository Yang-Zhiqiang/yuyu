CREATE VIEW ZT_KbkSsuRnduHknKimatuVTy AS SELECT
     ...
     ztyvkimatutirttumitatekin ,         /* （中継用）Ｖ用期末定率部分積立金 */
     ztykimatusisuutumitatekin ,         /* （中継用）期末指数部分積立金 */
     ztyvyoutykzenoutouymdsisuu ,         /* （中継用）Ｖ用直前応当日指数 */
     ztytykzensisuukijyunymd ,         /* （中継用）直前指数基準年月日 */
     ztyvyoukimatusisuu ,         /* （中継用）Ｖ用期末指数 */
     ztykmtsisuukijyunymd ,         /* （中継用）期末指数基準年月日 */
     ztyvyoutmttknzoukaritujygn ,         /* （中継用）Ｖ用積立金増加率上限 */
     ztyvyousetteibairitu ,         /* （中継用）Ｖ用設定倍率 */
     ztyvyourendouritu ,         /* （中継用）Ｖ用連動率 */
     ztysuuriyouyobin3x2 ,         /* （中継用）数理用予備項目Ｎ３＿２ */
     ztyyobiv8x2 ,         /* （中継用）予備項目Ｖ８＿２ */
     ztykimatusisuutyokugotmttkn ,         /* （中継用）期末指数部分直後積立金 */
     ztyyobin11x19 ,         /* （中継用）予備項目Ｎ１１＿１９ */
     ztyyobin11x20 ,         /* （中継用）予備項目Ｎ１１＿２０ */
     ztyjmttirttumitatekinnplus0 ,         /* （中継用）事末定率部分積立金（Ｎ＋０） */
     ztyjmttirttumitatekinnplus1 ,         /* （中継用）事末定率部分積立金（Ｎ＋１） */
     ztyjmttirttumitatekinnplus2 ,         /* （中継用）事末定率部分積立金（Ｎ＋２） */
     ztyjmtssutumitatekinnplus0 ,         /* （中継用）事末指数部分積立金（Ｎ＋０） */
     ztyjmtssutumitatekinnplus1 ,         /* （中継用）事末指数部分積立金（Ｎ＋１） */
     ztyjmtssutumitatekinnplus2 ,         /* （中継用）事末指数部分積立金（Ｎ＋２） */
     ztyjmtmvatyouseigownplus0 ,         /* （中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋０） */
     ztyjmtmvakeisanjiwnplus0 ,         /* （中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋０） */
     ztyjmtmvatyouseigownplus1 ,         /* （中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋１） */
     ztyjmtmvakeisanjiwnplus1 ,         /* （中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋１） */
     ztyjmtmvatyouseigownplus2 ,         /* （中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋２） */
     ztyjmtmvakeisanjiwnplus2 ,         /* （中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋２） */
     ztyyobin11x21 ,         /* （中継用）予備項目Ｎ１１＿２１ */
     ztyyobin11x22 ,         /* （中継用）予備項目Ｎ１１＿２２ */
     ztyyobin11x23 ,         /* （中継用）予備項目Ｎ１１＿２３ */
     ztyyobin11x4 ,         /* （中継用）予備項目Ｎ１１＿４ */
     ztyyobin11x25 ,         /* （中継用）予備項目Ｎ１１＿２５ */
     ztyyobin11x26 ,         /* （中継用）予備項目Ｎ１１＿２６ */
     ztysuuriyouyobin15 ,         /* （中継用）数理用予備項目Ｎ１５ */
     ztysuuriyouyobin15x2 ,         /* （中継用）数理用予備項目Ｎ１５＿２ */
     ...
     kousinKinou ,         /* 更新機能 */
     version           /* バージョン */
FROM ZT_KbkSsuRnduHknKimatuVTy_Z;