CREATE VIEW ZT_SyuHukugouSikkanDataRn AS SELECT
     ...
     zrnijitoukeikeikan ,         /* （連携用）医事統計用経過Ｎ */
     zrnijitoukeisiboun ,         /* （連携用）医事統計用死亡Ｎ */
     zrnijitoukeikeikas ,         /* （連携用）医事統計用経過Ｓ */
     zrnijitoukeisibous ,         /* （連携用）医事統計用死亡Ｓ */
     zrnyobiv20           /* （連携用）予備項目Ｖ２０ */
FROM ZT_SyuHukugouSikkanDataRn_Z;