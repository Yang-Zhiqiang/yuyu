CREATE VIEW ST_IdouMeisaiTyukeiyouItzHzn AS SELECT
     ...
     ztysrkouryokuhasseiymd ,         /* （中継用）数理用効力発生年月日 */
     ztysrhenkousikibetukey ,         /* （中継用）数理用変更識別キー */
     ztysrhoseirecordhanbetukbn ,         /* （中継用）数理用補正用レコード判別区分 */
     ztysrhoseihenkousikibetukey ,         /* （中継用）数理用補正用変更識別キー */
     ztysrteikishrtkykhukaumu ,         /* （中継用）数理用定期支払特約付加有無 */
     kousinsyaId ,         /* 更新者ＩＤ */
     kousinTime ,         /* 更新時間 */
     kousinKinou ,         /* 更新機能 */
     version           /* バージョン */
FROM ST_IdouMeisaiTyukeiyouItzHzn_Z;