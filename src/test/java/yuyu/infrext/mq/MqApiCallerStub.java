 ...
 */
public class MqApiCallerStub extends MqApiCaller {
    ...
    public String call(String SyoriCd, String UserData) {
        ...
        if (caller == BzTrksIraiMqTest_exec1.class
            ...
            sbTestYou.append("1234567890123456789012345678901234567890");
        ...
        else if (caller == DairitenTesuuryouInfoSyutokuTest_exec.class && (SYORIPTN.equals(TESTPATTERN7))) {
            StringBuffer sbTestYou = new StringBuffer();
            sbTestYou.append("0000");
            sbTestYou.append("0");
            sbTestYou.append("0");
        ...
        else if (caller == DairitenTesuuryouInfoSyutokuTest_exec.class && (SYORIPTN.equals(TESTPATTERN8))) {
            StringBuffer sbTestYou = new StringBuffer();
            sbTestYou.append("0000");
            sbTestYou.append("0");
            sbTestYou.append("0");
