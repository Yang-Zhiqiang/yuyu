 ...
 */
public class MqApiCallerStubForSinkeiyaku extends MqApiCaller {
    ...
    public String call(String SyoriCd, String UserData, String SosikiCd, String OperatorId) {
        ...
        if (caller == BzKykNaiyouHaneiMqTest_exec2.class
        ...
        if(caller == BzSakuinTsnSyoukaiMqTest_exec.class){
            if ((SYORIPTN.equals(TESTPATTERN5) || SYORIPTN.equals(TESTPATTERN6))) {
    ...
    public String call(String SyoriCd, String UserData) {
        ...
        else if (caller == BzKykNaiyouHaneiMqTest_exec1.class && (SYORIPTN.equals("error1"))) {

            throw new MqFailedException(1);
        }
        else if (caller == BzKykNaiyouHaneiMqTest_exec1.class && (SYORIPTN.equals("error2"))) {

            throw new MqFailedException(2);
        }
        else if (caller == BzKykNaiyouHaneiMqTest_exec1.class && (SYORIPTN.equals("error3"))) {

            throw new MqFailedException(3);
        }
        else if (caller == BzKykNaiyouHaneiMqTest_exec1.class && (SYORIPTN.equals("error4"))) {
        ...
        if (caller == HbSeihoWebMosSyoukaiTest_execPostForm.class) {
            StringBuffer sbTestYou = new StringBuffer();
            sbTestYou.append("PAS4");
            sbTestYou.append("1");
            sbTestYou.append("1");
            sbTestYou.append("11000123456");
            sbTestYou.append("12000123.45");
            sbTestYou.append("13000123456");
            sbTestYou.append("14000123.46");
            sbTestYou.append("1234567");
            sbTestYou.append("201601");
            sbTestYou.append("201612");
            sbTestYou.append("01");
            sbTestYou.append("12345678901234567890123456");
            sbTestYou.append("15000123456");
            sbTestYou.append("16000123.47");
            sbTestYou.append("17000123456");
            sbTestYou.append("18000123.48");
            sbTestYou.append("19000123456");
            sbTestYou.append("20000123.49");
            sbTestYou.append("1234567890123456789012");
            sbTestYou.append("201606");
            sbTestYou.append("1234567890123456789012345678901234567890123456789012345");

            testData = sbTestYou.toString();
        }
        if ( caller == BzSakuinTsnSyoukaiMqTest_exec.class) {
            if ((SYORIPTN.equals("error1"))) {
                throw new MqFailedException(1);
            }
            else if ((SYORIPTN.equals("error2"))) {
                throw new MqFailedException(2);
            }
            else if ((SYORIPTN.equals("error3"))) {
                throw new MqFailedException(3);
            }
            else if ((SYORIPTN.equals("error4"))) {
                throw new MqFailedException(4);
            }
            else if ((SYORIPTN.equals(TESTPATTERN2))) {
                StringBuffer sbTestYou = new StringBuffer();
        ...
        if(caller == BzTrksIraiMqTest_exec1.class){
            ...
            else if (SYORIPTN.equals("error1")) {
        ...
        if(caller == DairitenTesuuryouInfoSyutokuTest_exec.class){
            ...
            if ((SYORIPTN.equals(TESTPATTERN1))) {
                ...
                sbTestYou.append("1");
                sbTestYou.append("1");
                sbTestYou.append("12345678901234567890123456789012345678");
                sbTestYou.append("15000123456");
                sbTestYou.append("16000123.47");
                sbTestYou.append("1");
                sbTestYou.append("17000123456");
                ...
                sbTestYou.append("20000123.49");
                sbTestYou.append("1");
                sbTestYou.append("1234567890123456789");
                sbTestYou.append("201606");
                sbTestYou.append("1234567890123456789012345678901234567890123456789012345");
            ...
            else if ((SYORIPTN.equals(TESTPATTERN9))) {
                StringBuffer sbTestYou = new StringBuffer();
                ...
                sbTestYou.append("0");
                sbTestYou.append("11000123456");
                sbTestYou.append("12000123045");
                sbTestYou.append("13000123456");
                sbTestYou.append("14000123046");
                sbTestYou.append("1234567");
                sbTestYou.append("2");
                sbTestYou.append("2");
                sbTestYou.append("12345678901234567890123456789012345678");
                sbTestYou.append("15000123456");
                sbTestYou.append("16000123047");
                sbTestYou.append("2");
                sbTestYou.append("17000123456");
                sbTestYou.append("18000123048");
                sbTestYou.append("2");
                sbTestYou.append("19000123456");
                sbTestYou.append("20000123049");
                sbTestYou.append("2");
                sbTestYou.append("1234567890123456789");
                sbTestYou.append("201606");
                sbTestYou.append("1234567890123456789012345678901234567890123456789012345");
            ...
            else if ((SYORIPTN.equals(TESTPATTERN10))) {
                StringBuffer sbTestYou = new StringBuffer();
