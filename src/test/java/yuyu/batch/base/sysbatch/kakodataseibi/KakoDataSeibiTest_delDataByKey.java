...
/**
 * 過去データ整備DAOクラスの<br />
 * delDataByKey のテストクラス<br />
 */
@RunWith(SWAKTestRunner.class)
public class KakoDataSeibiTest_delDataByKey extends AbstractTest {
    ...
    public void test001() {
        ...
        try {
            kakoDataSeibiDao.delDataByKey(tableId, sakujyoKey, sakujyokijynYmd);
        } catch (Exception e) {
    ...
    public void test002() {
        ...
        long resultCount = kakoDataSeibiDao.delDataByKey(tableId, sakujyoKey, sakujyokijynYmd);
