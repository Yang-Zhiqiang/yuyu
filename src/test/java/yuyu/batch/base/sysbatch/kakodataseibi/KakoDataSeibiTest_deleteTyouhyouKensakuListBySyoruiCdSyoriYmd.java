...
/**
 * 過去データ整備DAOクラスの<br />
 * deleteTyouhyouKensakuListBySyoruiCdSyoriYmd のテストクラス<br />
 */
@RunWith(SWAKTestRunner.class)
public class KakoDataSeibiTest_deleteTyouhyouKensakuListBySyoruiCdSyoriYmd extends AbstractTest {
    ...
    public void test001() {
        ...
        long resultCount = kakoDataSeibiDao.deleteTyouhyouKensakuListBySyoruiCdSyoriYmd(syoruiCd, syoriYmd);
