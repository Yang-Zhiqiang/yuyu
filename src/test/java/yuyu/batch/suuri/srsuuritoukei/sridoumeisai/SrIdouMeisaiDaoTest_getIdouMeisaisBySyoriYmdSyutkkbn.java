...
/**
 * SrIdouMeisaiDaoクラスの、<br />
 * getIdouMeisaisBySyoriYmdSyutkkbn() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class SrIdouMeisaiDaoTest_getIdouMeisaisBySyoriYmdSyutkkbn {

    @Inject
    private SrIdouMeisaiDao srIdouMeisaiDao;
    @Inject
    ...
    public static void TestDataInsert() {
        ...
        SrIdouMeisaiDao srIdouMeisaiDao = SWAKInjector.getInstance(SrIdouMeisaiDao.class);

        try (ExDBResults<SV_IdouMeisai> sV_IdouMeisaiResults =
            srIdouMeisaiDao.getIdouMeisaisBySyoriYmdSyutkkbn(BizDate.valueOf(20160920),BizDate.valueOf(20160920), C_SyutkKbn.SYU)) {

            Assert.assertFalse(sV_IdouMeisaiResults.iterator().hasNext());
        }
    ...
    public void noResult1() {
        ...
        try (ExDBResults<SV_IdouMeisai> sV_IdouMeisaiResults =
            srIdouMeisaiDao.getIdouMeisaisBySyoriYmdSyutkkbn(BizDate.valueOf(20170920), BizDate.valueOf(20160920),C_SyutkKbn.SYU)) {
    ...
    public void normal10() {
        try (ExDBResults<SV_IdouMeisai> sV_IdouMeisaiResults =
            srIdouMeisaiDao.getIdouMeisaisBySyoriYmdSyutkkbn(BizDate.valueOf(20160920), BizDate.valueOf(20160921), C_SyutkKbn.SYU)) {

            int iCount = 0;
            Iterator<SV_IdouMeisai> iter = sV_IdouMeisaiResults.iterator();
            SV_IdouMeisai sV_IdouMeisai = null;
            while (iter.hasNext()) {

                sV_IdouMeisai = iter.next();
                iCount++;

                Assert.assertEquals("11807111118", sV_IdouMeisai.getSyono());
                Assert.assertEquals(C_SyutkKbn.SYU, sV_IdouMeisai.getSyutkkbn());
                Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                Assert.assertEquals("khkaiyaku", sV_IdouMeisai.getGyoumuKousinKinou());
                Assert.assertEquals("20160921000000000", sV_IdouMeisai.getGyoumuKousinTime());
    ...
    public void normal2() {
        try (ExDBResults<SV_IdouMeisai> sV_IdouMeisaiResults =
            srIdouMeisaiDao.getIdouMeisaisBySyoriYmdSyutkkbn(BizDate.valueOf(20160920),BizDate.valueOf(20160921), C_SyutkKbn.TK)) {
            ...
            while (iter.hasNext()) {
                ...
                if (1 == iCount) {
                    ...
                    Assert.assertEquals("11807111200", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.BLNK, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khseinengappiseiteisei", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000000", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.BLNK, sV_IdouMeisai.getSyorikbn());
                ...
                if (2 == iCount) {
                    ...
                    Assert.assertEquals(C_Syoumetujiyuu.BLNK, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khgengaku", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000001", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.BLNK, sV_IdouMeisai.getSyorikbn());
                ...
                if (3 == iCount) {
                    ...
                    Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khkaiyaku", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.BLNK, sV_IdouMeisai.getSyorikbn());
                ...
                if (4 == iCount) {
                    ...
                    Assert.assertEquals("11807111211", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.SBMUKOU, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBMUKOU, sV_IdouMeisai.getSyorikbn());
                ...
                if (5 == iCount) {
                    ...
                    Assert.assertEquals("11807111222", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.SBMUKOU, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160921), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBMUKOU_SHRNASI, sV_IdouMeisai.getSyorikbn());
                ...
                if (6 == iCount) {
                    ...
                    Assert.assertEquals("11807111185", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.SBMUKOU, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160922), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBMUKOU_KIHRKPSHR, sV_IdouMeisai.getSyorikbn());
                ...
                if (7 == iCount) {
                    ...
                    Assert.assertEquals("11807111174", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.MENSEKI, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160923), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBMENSEKI_SHRNASI, sV_IdouMeisai.getSyorikbn());
                ...
                if (8 == iCount) {
                    ...
                    Assert.assertEquals("11807111163", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.MENSEKI, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160924), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBMENSEKI, sV_IdouMeisai.getSyorikbn());
                ...
                if (9 == iCount) {
                    ...
                    Assert.assertEquals("11807111152", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.SBKAIJO, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160925), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.SBKAIJO, sV_IdouMeisai.getSyorikbn());
                ...
                if (10 == iCount) {
                    ...
                    Assert.assertEquals("11807111141", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.MUKOU, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160926), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.MUKOU, sV_IdouMeisai.getSyorikbn());
                ...
                if (11 == iCount) {
                    ...
                    Assert.assertEquals("11807111130", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.KAIJO, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160927), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.KAIJO, sV_IdouMeisai.getSyorikbn());
                ...
                if (12 == iCount) {
                    ...
                    Assert.assertEquals("11807111129", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.CLGOFF, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160928), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.CLGOFF, sV_IdouMeisai.getSyorikbn());
                ...
                if (13 == iCount) {
                    ...
                    Assert.assertEquals("11807111118", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(C_Syoumetujiyuu.KYKTORIKESI, sV_IdouMeisai.getSyoumetujiyuu());
                    Assert.assertEquals(BizDate.valueOf(20160929), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SyoriKbn.KYKTORIKESI, sV_IdouMeisai.getSyorikbn());
                ...
                if (14 == iCount) {
                    ...
                    Assert.assertEquals("11807111196", sV_IdouMeisai.getSyono());
                    Assert.assertEquals(C_SyutkKbn.TK, sV_IdouMeisai.getSyutkkbn());
                    Assert.assertEquals(BizDate.valueOf(20161001), sV_IdouMeisai.getSyoriYmd());
                    Assert.assertEquals("khjyuusyohenkou", sV_IdouMeisai.getGyoumuKousinKinou());
                    Assert.assertEquals("20160921000000002", sV_IdouMeisai.getGyoumuKousinTime());
                    Assert.assertEquals(C_SeikyuuSyubetu.SB, sV_IdouMeisai.getSeikyuusyubetu());
