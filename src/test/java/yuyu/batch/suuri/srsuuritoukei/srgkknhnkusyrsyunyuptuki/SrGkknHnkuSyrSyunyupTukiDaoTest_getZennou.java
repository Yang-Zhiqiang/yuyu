...
public class SrGkknHnkuSyrSyunyupTukiDaoTest_getZennou {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SrGkknHnkuSyrSyunyupTukiDaoTest_getZennou.class, fileName,
                sheetName);
