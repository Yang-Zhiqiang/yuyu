...
public class SrGkknHnkuSyrSyunyupTukiDaoTest_getSiKekkaBySyono {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SrGkknHnkuSyrSyunyupTukiDaoTest_getSiKekkaBySyono.class, fileName,
                sheetName);
