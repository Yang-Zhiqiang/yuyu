...
public class SrGkknHnkuSyrSyunyupTukiDaoTest_getNyknJissekiRirekisBySyonoNyktrksdenno {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SrGkknHnkuSyrSyunyupTukiDaoTest_getNyknJissekiRirekisBySyonoNyktrksdenno.class, fileName,
                sheetName);
