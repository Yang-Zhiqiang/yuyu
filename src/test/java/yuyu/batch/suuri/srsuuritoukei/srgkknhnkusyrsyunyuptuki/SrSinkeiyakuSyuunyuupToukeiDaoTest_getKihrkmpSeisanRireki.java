...
public class SrSinkeiyakuSyuunyuupToukeiDaoTest_getKihrkmpSeisanRireki {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SrSinkeiyakuSyuunyuupToukeiDaoTest_getKihrkmpSeisanRireki.class, fileName,
                sheetName);
