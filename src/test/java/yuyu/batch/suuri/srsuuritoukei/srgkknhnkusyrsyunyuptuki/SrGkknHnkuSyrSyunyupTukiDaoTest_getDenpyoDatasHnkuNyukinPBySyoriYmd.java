...
public class SrGkknHnkuSyrSyunyupTukiDaoTest_getDenpyoDatasHnkuNyukinPBySyoriYmd {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SrGkknHnkuSyrSyunyupTukiDaoTest_getDenpyoDatasHnkuNyukinPBySyoriYmd.class,
                fileName,
                sheetName);
