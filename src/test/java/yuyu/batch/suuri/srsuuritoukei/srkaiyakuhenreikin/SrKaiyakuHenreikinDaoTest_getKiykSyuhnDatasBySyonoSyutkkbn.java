 ...
 * 数理<br />
 * 解約返戻金相当額情報作成<br />
 * 契約商品情報ビューエンティティリスト取得（証券番号、主契約特約区分）のテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class SrKaiyakuHenreikinDaoTest_getKiykSyuhnDatasBySyonoSyutkkbn {

    //    @Inject
    //    SrKaiyakuHenreikinDao srKaiyakuHenreikinDao;
    //
    ...
    //
    //        List<SV_KiykSyuhnData> sV_KiykSyuhnDataLst = srKaiyakuHenreikinDao.getKiykSyuhnDatasBySyonoSyutkkbn(P_SYONO_02, C_SyutkKbn.NONE);
    ...
    //
    //        List<SV_KiykSyuhnData> sV_KiykSyuhnDataLst = srKaiyakuHenreikinDao.getKiykSyuhnDatasBySyonoSyutkkbn(P_SYONO_03, C_SyutkKbn.SYU);
    //
    //        Assert.assertEquals(0, sV_KiykSyuhnDataLst.size());
    //    }
    //
    ...
    //    public void normal2(){
    //
    //        List<SV_KiykSyuhnData> sV_KiykSyuhnDataLst = srKaiyakuHenreikinDao.getKiykSyuhnDatasBySyonoSyutkkbn(P_SYONO_01, C_SyutkKbn.NONE);
    //
    //        Assert.assertEquals(3, sV_KiykSyuhnDataLst.size());
    //
    //        Assert.assertEquals(P_SYONO_01, sV_KiykSyuhnDataLst.get(0).getSyono());
    //        Assert.assertEquals(C_SyutkKbn.NONE, sV_KiykSyuhnDataLst.get(0).getSyutkkbn());
    //        Assert.assertEquals(P_SYOUHNCD_01, sV_KiykSyuhnDataLst.get(0).getSyouhncd());
    //        Assert.assertEquals(P_SYOUHNSDNO_01, sV_KiykSyuhnDataLst.get(0).getSyouhnsdno());
    //        Assert.assertEquals(P_KYKSYOUHNRENNO_01, sV_KiykSyuhnDataLst.get(0).getKyksyouhnrenno());
    //        Assert.assertEquals(P_HENKOUSIKIBETUKEY_01, sV_KiykSyuhnDataLst.get(0).getHenkousikibetukey());
    //
    //        Assert.assertEquals(P_SYONO_01, sV_KiykSyuhnDataLst.get(1).getSyono());
    //        Assert.assertEquals(C_SyutkKbn.NONE, sV_KiykSyuhnDataLst.get(1).getSyutkkbn());
    //        Assert.assertEquals(P_SYOUHNCD_01, sV_KiykSyuhnDataLst.get(1).getSyouhncd());
    //        Assert.assertEquals(P_SYOUHNSDNO_01, sV_KiykSyuhnDataLst.get(1).getSyouhnsdno());
    //        Assert.assertEquals(P_KYKSYOUHNRENNO_02, sV_KiykSyuhnDataLst.get(1).getKyksyouhnrenno());
    //        Assert.assertEquals(P_HENKOUSIKIBETUKEY_02, sV_KiykSyuhnDataLst.get(1).getHenkousikibetukey());
    //
    //        Assert.assertEquals(P_SYONO_01, sV_KiykSyuhnDataLst.get(2).getSyono());
    //        Assert.assertEquals(C_SyutkKbn.NONE, sV_KiykSyuhnDataLst.get(2).getSyutkkbn());
    //        Assert.assertEquals(P_SYOUHNCD_01, sV_KiykSyuhnDataLst.get(2).getSyouhncd());
    //        Assert.assertEquals(P_SYOUHNSDNO_01, sV_KiykSyuhnDataLst.get(2).getSyouhnsdno());
    //        Assert.assertEquals(P_KYKSYOUHNRENNO_01, sV_KiykSyuhnDataLst.get(2).getKyksyouhnrenno());
    //        Assert.assertEquals(P_HENKOUSIKIBETUKEY_04, sV_KiykSyuhnDataLst.get(2).getHenkousikibetukey());
    //    }
    //
    //    @Test
    //    @TestOrder(40)
    ...
    //
    //        List<SV_KiykSyuhnData> sV_KiykSyuhnDataLst = srKaiyakuHenreikinDao.getKiykSyuhnDatasBySyonoSyutkkbn("", C_SyutkKbn.NONE);
    //
    //        assertEquals(0, sV_KiykSyuhnDataLst.size());
    //    }
}
