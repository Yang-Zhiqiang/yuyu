...
public class BzRenkeiHenkanFileRenkeiSousinDaoTest_getAllByTableid {
    ...
    public static void TestDataInsert() {
        ...
        try(ExDBResults<ZT_DsKariPasswordTuutiTy> rs =  bzRenkeiHenkanFileRenkeiSousinDao.getAllByTableid("ZT_DsKariPasswordTuutiTy")){
    ...
    public void Test_002() {
        int count = 0;
        try(ExDBResults<ZT_TokuteiKankeiHoujinRn> rs =  bzRenkeiHenkanFileRenkeiSousinDao.getAllByTableid("ZT_TokuteiKankeiHoujinRn");){
    ...
    public void Test_003() {
        int count = 0;
        try(ExDBResults<AS_KinouModeSiborikomi> rs =  bzRenkeiHenkanFileRenkeiSousinDao.getAllByTableid("AS_KinouModeSiborikomi");){
    ...
    public void Test_004() {
        try{
            bzRenkeiHenkanFileRenkeiSousinDao.getAllByTableid("ZT_DsKariPassword");
