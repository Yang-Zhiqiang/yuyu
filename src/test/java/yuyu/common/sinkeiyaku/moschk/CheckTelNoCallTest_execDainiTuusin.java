...
/**
 * 電話番号チェック呼出しクラスのメソッド {@link CheckTelNoCall#execDainiTuusin(MosnaiCheckParam)} テスト用クラスです。<br />
 */
@RunWith(SWAKTestRunner.class)
public class CheckTelNoCallTest_execDainiTuusin {
    ...
    public static void insertTestData(){
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckTelNoCallTest_execDainiTuusin.class, fileName, sheetName);
    ...
    @Transactional
    @TestOrder(20)
    public void testExecDainiTuusin_A1() {
        ...
        checkTelNoCall.execDainiTuusin(mosnaiCheckParam);
    ...
    @Transactional
    @TestOrder(30)
    public void testExecDainiTuusin_A2() {
