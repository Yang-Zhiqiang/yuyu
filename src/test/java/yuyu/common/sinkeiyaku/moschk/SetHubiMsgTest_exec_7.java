...
/**
 * 不備メッセージ設定クラスのメソッド {@link SetHubiMsg#exec(C_KetsrhkosKbn, C_SyoruiCdKbn, String, MosnaiCheckParam,
 * C_TknKbn, C_MsgKbn)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class SetHubiMsgTest_exec_7 {
    ...
    public void testExec_A1() {
        ...
        setHubiMsg.exec(ketsrhkosKbn, syoruiCdKbn, message, mosnaiCheckParam, tknKbn, pMsgKbn);
