...
/**
 * 申込内容チェック実施要否判定のメソッド {@link HanteiMoschk#hanteiMosSyouhnSaiteiP(BM_SyouhnZokusei, List<BM_SyouhnZokusei>)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class HanteiMoschkTest_hanteiMosSyouhnSaiteiP {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataMaker.insDataByDataId("データ016", testDataAndTblMap);
    ...
    @Transactional
    @TestOrder(10)
    public void testHanteiMosSyouhnSaiteiP_A1() {

        C_YouhiKbn youhiKbn = hanteiMoschk.hanteiMosSyouhnSaiteiP(null, null);
    ...
    @Transactional
    @TestOrder(20)
    public void testHanteiMosSyouhnSaiteiP_A2() {
    ...
    @Transactional
    @TestOrder(30)
    public void testHanteiMosSyouhnSaiteiP_A3() {
