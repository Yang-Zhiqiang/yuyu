...
/**
 * 電話番号チェック呼出しクラスのメソッド {@link CheckTelNoCall#execKok(MosnaiCheckParam)} テスト用クラスです。<br />
 */
@RunWith(SWAKTestRunner.class)
public class CheckTelNoCallTest_execKok {
    ...
    public static void insertTestData(){
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckTelNoCallTest_execKok.class, fileName, sheetName);
    ...
    public void testExecKok_A1() {
        ...
        checkTelNoCall.execKok(mosnaiCheckParam);
