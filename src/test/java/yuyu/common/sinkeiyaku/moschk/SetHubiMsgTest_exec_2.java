...
/**
 * 不備メッセージ設定クラスのメソッド {@link SetHubiMsg#exec(C_KetsrhkosKbn, C_HubisyubetusyousaiKbn, String, MosnaiCheckParam, C_TknKbn, C_MsgKbn)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class SetHubiMsgTest_exec_2 {
    ...
    public void testExec_A1() {
        ...
        setHubiMsg.exec(ketsrhkosKbn, hubisyubetusyousaiKbn, message, mosnaiCheckParam, tknKbn, pMsgKbn);
