...
/**
 * 不備メッセージ設定クラスのメソッド {@link SetHubiMsg#exec(C_KetsrhkosKbn, C_SpKeisanKahiKbn,
 * C_HubisyubetusyousaiKbn, String, MosnaiCheckParam, C_TknKbn, C_MsgKbn)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class SetHubiMsgTest_exec_8 {
    ...
    public void testExec_A1() {
        ...
        setHubiMsg.exec(ketsrhkosKbn, spKeisanKahiKbn, hubisyubetusyousaiKbn, message, mosnaiCheckParam,
            tknKbn, pMsgKbn);
    ...
    public void testExec_A2() {
        ...
        exClassificationEquals(mosnaiCheckParam.getKetteiSijisyoYouhiKbn(), C_KetsijisyoyhKbn.HUYOU,
            "決定指示書要否区分");
        ...
        exClassificationEquals(mosnaiCheckParam.getKthjiSpKeisanKahiKbn(), C_SpKeisanKahiKbn.MISETTEI,
            "決定保留時ＳＰ計算可否区分");
        ...
        exClassificationEquals(hubiMsgList.get(0).getHubisyubetusyousaikbn(), C_HubisyubetusyousaiKbn.SPHUBI,
            "不備種別詳細区分");
    ...
    public void testExec_A3() {
        ...
        exNumericEquals(mosnaiCheckParam.getListKetteiSijiMsg().size(), 0, "決定指示ＭＳＧ件数");
        exNumericEquals(mosnaiCheckParam.getListKekkaGmnMsg().size(), 0, "結果画面ＭＳＧ件数");
        exClassificationEquals(mosnaiCheckParam.getKthjiSpKeisanKahiKbn(), C_SpKeisanKahiKbn.SPKEISANKA,
            "決定保留時ＳＰ計算可否区分");
