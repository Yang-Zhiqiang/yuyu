...
/**
 * 契約者性別チェッククラスのメソッド {@link CheckKykSeibetu#exec(MosnaiCheckParam)} テスト用クラスです。<br />
 */
@RunWith(SWAKTestRunner.class)
public class CheckKykSeibetuTest_exec {
    ...
    private final static String fileName = "UT_SP_単体テスト仕様書_契約者性別チェック";
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckKykSeibetuTest_exec.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        checkKykSeibetu.exec(mosnaiCheckParam);
        ...
        exStringEquals(hubiMsg.get(0).getHubimsg(), "契約者性別は不要です。", "不備メッセージ");
    ...
    public void testExec_A3() {
        ...
        exStringEquals(hubiMsg.get(0).getHubimsg(), "法人契約の契被同一は取扱えません。", "不備メッセージ");
        exClassificationEquals(hubiMsg.get(0).getHubisyubetukbn(), C_HubisyubetuKbn.KETHORYU_HUBI, "不備種別区分");
        exStringEquals(hubiMsg.get(0).getGyoumuKousinsyaId(), "user001", "業務用更新者ＩＤ");
        exStringEquals(hubiMsg.get(0).getGyoumuKousinTime(), "20150529111400000", "業務用更新時間");
    }
    ...
    public void testExec_A4() {
        ...
        exStringEquals(hubiMsg.get(0).getHubimsg(), "契約者性別の入力が必要です。", "不備メッセージ");
        exClassificationEquals(hubiMsg.get(0).getHubisyubetukbn(), C_HubisyubetuKbn.KETHORYU_HUBI, "不備種別区分");
        exStringEquals(hubiMsg.get(0).getGyoumuKousinsyaId(), "user001", "業務用更新者ＩＤ");
        exStringEquals(hubiMsg.get(0).getGyoumuKousinTime(), "20150529111400000", "業務用更新時間");
    }
