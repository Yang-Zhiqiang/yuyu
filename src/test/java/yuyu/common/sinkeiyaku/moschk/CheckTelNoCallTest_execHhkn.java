...
/**
 * 電話番号チェック呼出しクラスのメソッド {@link CheckTelNoCall#execHhkn(MosnaiCheckParam)} テスト用クラスです。<br />
 */
@RunWith(SWAKTestRunner.class)
public class CheckTelNoCallTest_execHhkn {
    ...
    public static void insertTestData(){
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckTelNoCallTest_execHhkn.class, fileName, sheetName);
    ...
    public void testExecHhkn_A1() {
        ...
        checkTelNoCall.execHhkn(mosnaiCheckParam);
