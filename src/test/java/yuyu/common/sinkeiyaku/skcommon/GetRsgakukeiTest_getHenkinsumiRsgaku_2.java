...
/**
 * 領収金額合計取得クラスのメソッド {@link getHenkinsumiRsgaku#exec(HT_SyoriCTL,C_Tuukasyu)} テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class GetRsgakukeiTest_getHenkinsumiRsgaku_2 {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetRsgakukeiTest_getHenkinsumiRsgaku_2.class, fileName, sheetName);
    ...
    public void testGetHenkinsumiRsgaku_A1() {
        ...
        getRsgakukei.getHenkinsumiRsgaku(syoriCTL, C_Tuukasyu.USD);
