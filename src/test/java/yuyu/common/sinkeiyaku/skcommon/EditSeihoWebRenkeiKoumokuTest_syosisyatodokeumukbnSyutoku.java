...
/**
 * 生保Ｗｅｂ連携項目編集のメソッド{@link EditSeihoWebRenkeiKoumoku#syosisyatodokeumukbnSyutoku()} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class EditSeihoWebRenkeiKoumokuTest_syosisyatodokeumukbnSyutoku {
    ...
    @Test
    @TestOrder(10)
    public void testSyosisyatodokeumukbnSyutoku_A1(){
        ...
        C_UmuKbn umuKbn = editSeihoWebRenkeiKoumoku.syosisyatodokeumukbnSyutoku(pTaisyoukoumokuti1,
    ...
    @Test
    @TestOrder(20)
    public void testSyosisyatodokeumukbnSyutoku_A2(){
