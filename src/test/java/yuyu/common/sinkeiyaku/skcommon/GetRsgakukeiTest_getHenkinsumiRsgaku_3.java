...
/**
 * 領収金額合計取得クラスのメソッド {@link getHenkinsumiRsgaku#exec(HT_SyoriCTL,BizDate)} テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class GetRsgakukeiTest_getHenkinsumiRsgaku_3 {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetRsgakukeiTest_getHenkinsumiRsgaku_3.class, fileName, sheetName);
    ...
    public void testGetHenkinsumiRsgaku_A1() {
        ...
        getRsgakukei.getHenkinsumiRsgaku(syoriCTL, BizDate.valueOf("20160420"));
