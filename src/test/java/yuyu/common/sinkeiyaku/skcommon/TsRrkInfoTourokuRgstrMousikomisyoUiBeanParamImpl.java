...
/**
 * 訂正履歴情報登録RgstrMousikomisyoインタフェースの実装クラス
 */
public class TsRrkInfoTourokuRgstrMousikomisyoUiBeanParamImpl extends AbstractUiBean
implements TsRrkInfoTourokuRgstrMousikomisyoUiBeanParam {
    ...
    public C_Tkhukaumu getTeikisiharaitkykhkkbn() {
     ...
     public void setSyukihons(BizCurrency syukihons) {
         this.syukihons = syukihons;
     }
     ...
     public void setSyuhknkknsmnkbn(C_HknkknsmnKbn syuhknkknsmnkbn) {
         this.syuhknkknsmnkbn = syuhknkknsmnkbn;
     }
     ...
     public void setSyuhrkkknsmnkbn(C_HrkkknsmnKbn syuhrkkknsmnkbn) {
         this.syuhrkkknsmnkbn = syuhrkkknsmnkbn;
     }
     ...
     public void setKzhuritourokuhoukbn(C_KzhuritourokuhouKbn kzhuritourokuhoukbn) {
         this.kzhuritourokuhoukbn = kzhuritourokuhoukbn;
     }
     ...
     public void setKhnchkcmnt(String khnchkcmnt) {
         this.khnchkcmnt = khnchkcmnt;
     }
     ...
     public void setTrkkzknmkn2(String trkkzknmkn2) {
         this.trkkzknmkn2 = trkkzknmkn2;
     }
     ...
     public void setTrkkzknmkj2(String trkkzknmkj2) {
         this.trkkzknmkj2 = trkkzknmkj2;
     }
     ...
     public void setTrkkzknmkjkhukakbn2(C_KjkhukaKbn trkkzknmkjkhukakbn2) {
         this.trkkzknmkjkhukakbn2 = trkkzknmkjkhukakbn2;
     }
     ...
     public void setTrkkzkseiymd2(BizDate trkkzkseiymd2) {
         this.trkkzkseiymd2 = trkkzkseiymd2;
     }
     ...
     public void setTrkkzksei2(C_Seibetu trkkzksei2) {
         this.trkkzksei2 = trkkzksei2;
     }
     ...
     public void setTrkkzktdk2(C_Tdk trkkzktdk2) {
         this.trkkzktdk2 = trkkzktdk2;
     }
     ...
     public void setTrkkzktsindousiteikbn2(C_TsindousiteiKbn trkkzktsindousiteikbn2) {
         this.trkkzktsindousiteikbn2 = trkkzktsindousiteikbn2;
     }
     ...
     public void setTrkkzkyno2(String trkkzkyno2) {
         this.trkkzkyno2 = trkkzkyno2;
     }
     ...
     public void setTrkkzkadr1kj2(String trkkzkadr1kj2) {
         this.trkkzkadr1kj2 = trkkzkadr1kj2;
     }
     ...
     public void setTrkkzkadr2kj2(String trkkzkadr2kj2) {
         this.trkkzkadr2kj2 = trkkzkadr2kj2;
     }
     ...
     public void setTrkkzkadr3kj2(String trkkzkadr3kj2) {
         this.trkkzkadr3kj2 = trkkzkadr3kj2;
     }
     ...
     public void setTrkkzktelno2(String trkkzktelno2) {
         this.trkkzktelno2 = trkkzktelno2;
     }
     ...
     public void setKykdrtkykhukakbn(C_Tkhukaumu kykdrtkykhukakbn) {
         this.kykdrtkykhukakbn = kykdrtkykhukakbn;
     }
     ...
     public void setKykdrkbn(C_UktKbn kykdrkbn) {
         this.kykdrkbn = kykdrkbn;
     }
