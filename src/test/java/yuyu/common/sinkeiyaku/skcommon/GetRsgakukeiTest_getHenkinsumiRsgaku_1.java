...
/**
 * 領収金額合計取得クラスのメソッド {@link getHenkinsumiRsgaku#exec(HT_SyoriCTL)} テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class GetRsgakukeiTest_getHenkinsumiRsgaku_1 {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetRsgakukeiTest_getHenkinsumiRsgaku_1.class, fileName, sheetName);
