...
/**
 * 領収金額合計取得クラスのメソッド {@link getPkakinsumiRsgaku#exec(HT_SyoriCTL,C_Tuukasyu)} テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class GetRsgakukeiTest_getPkakinsumiRsgaku_2 {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetRsgakukeiTest_getPkakinsumiRsgaku_2.class, fileName, sheetName);
    ...
    public void testGetPkakinsumiRsgaku_A1() {
        ...
        getRsgakukei.getPkakinsumiRsgaku(syoriCTL, C_Tuukasyu.USD);
