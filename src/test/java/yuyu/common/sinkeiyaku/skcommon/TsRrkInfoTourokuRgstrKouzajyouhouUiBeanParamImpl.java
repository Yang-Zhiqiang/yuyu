...
/**
 * 訂正履歴情報登録RgstrKouzajyouhouインタフェースの実装クラス
 */
public class TsRrkInfoTourokuRgstrKouzajyouhouUiBeanParamImpl extends AbstractUiBean
implements TsRrkInfoTourokuRgstrKouzajyouhouUiBeanParam {
