...
/**
 * 領収金額合計取得クラスのメソッド {@link getPkakinsumiRsgaku#exec(HT_SyoriCTL,BizDate)} テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class GetRsgakukeiTest_getPkakinsumiRsgaku_3 {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetRsgakukeiTest_getPkakinsumiRsgaku_3.class, fileName, sheetName);
    ...
    public void testGetPkakinsumiRsgaku_A1() {
        ...
        getRsgakukei.getPkakinsumiRsgaku(syoriCTL, BizDate.valueOf("20160420"));
