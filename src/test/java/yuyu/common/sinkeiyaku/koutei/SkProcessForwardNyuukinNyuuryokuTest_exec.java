...
/**
 * SkProcessForwardNyuukinNyuuryokuクラスのメソッド {@link SkProcessForwardNyuukinNyuuryoku#exec(SkProcessForwardInBean)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class SkProcessForwardNyuukinNyuuryokuTest_exec {

    @Inject
    private SkProcessForwardNyuukinNyuuryoku skProcessForwardNyuukinNyuuryoku;

    private final static String fileName = "UT-SP_単体テスト仕様書_新契約工程遷移（入金入力）";
    ...
    public static void testInit() {
        ...
        BzGetProcessSummaryMockForSinkeiyaku.caller = SkProcessForwardNyuukinNyuuryokuTest_exec.class;
        BzProcessForwardMockForSinkeiyaku.caller = SkProcessForwardNyuukinNyuuryokuTest_exec.class;
        SkProcessForwardMoschkExecMockForSinkeiyaku.caller = SkProcessForwardNyuukinNyuuryokuTest_exec.class;
        BzOutputProcessRecordMockForSinkeiyaku.caller = SkProcessForwardNyuukinNyuuryokuTest_exec.class;
    }
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SkProcessForwardNyuukinNyuuryokuTest_exec.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        skProcessForwardInBean.setMosNo("870000015");
        ...
        exStringEquals(bzGetProcessSummaryInBean1.getMosNo(), "870000015", "申込番号");
        ...
        exStringEquals(bzProcessForwardInBean1.getKouteiKanriId(), "1234", "工程管理ID");
        exStringEquals(bzProcessForwardInBean1.getJimuTetuzukiCd(), ISkCommonKoumoku.JIMUTETUZUKICD_SKMAINDAIRITEN, "事務手続コード");
        exStringEquals(bzProcessForwardInBean1.getKouteiLockKey(), "1", "工程ロックキー");
        ...
        exStringEquals(bzGetProcessSummaryInBean2.getMosNo(), "870000015", "申込番号");
        ...
        exStringEquals(skProcessForwardInBean1.getMosNo(), "870000015", "申込番号");
