...
import yuyu.common.hozen.khcommon.SetCreditUriageSeikyuubiMockForKhansyuu;
...
public class EditHrhnKanryoTuutiTest_editTBL {
    ...
    public void testEditTBL_A1() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta12(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）１２");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta13(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）１３");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta14(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１４");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta15(), "", "振替予告メッセージ（３４桁）１５");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta16(), "＊保険料は当社所定の為替レートで円換算した金額をお払い込みいただき", "振替予告メッセージ（３４桁）１６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta17(), "　ます。", "振替予告メッセージ（３４桁）１７");
    ...
    public void testEditTBL_A2() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta10(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）１０");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta11(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）１１");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta12(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１２");
    ...
    public void testEditTBL_A7() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta13(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）１３");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta14(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）１４");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta15(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１５");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta16(), "", "振替予告メッセージ（３４桁）１６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta17(), "", "振替予告メッセージ（３４桁）１７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta18(), "", "振替予告メッセージ（３４桁）１８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta19(), "", "振替予告メッセージ（３４桁）１９");
    ...
    public void testEditTBL_A9() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta5(), "", "振替予告メッセージ（３４桁）６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta6(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta7(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta8(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１２");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta9(), "", "振替予告メッセージ（３４桁）９");
    ...
    public void testEditTBL_A11() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta13(), "", "振替予告メッセージ（３４桁）１３");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta14(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）１４");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta15(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）１５");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta16(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta17(), "", "振替予告メッセージ（３４桁）１７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta18(), "", "振替予告メッセージ（３４桁）１８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta19(), "", "振替予告メッセージ（３４桁）１９");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta20(), "", "振替予告メッセージ（３４桁）２０");
    ...
    public void testEditTBL_A12() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta7(), "", "振替予告メッセージ（３４桁）７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta8(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta9(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）９");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta10(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１０");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta11(), "", "振替予告メッセージ（３４桁）１１");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta12(), "", "振替予告メッセージ（３４桁）１２");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta13(), "", "振替予告メッセージ（３４桁）１３");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta14(), "", "振替予告メッセージ（３４桁）１４");
    ...
    public void testEditTBL_A13() {
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta4(), "　振り替えが開始します。", "振替予告メッセージ（３４桁）４");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta5(), "", "振替予告メッセージ（３４桁）５");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta6(), "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、", "振替予告メッセージ（３４桁）６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta7(), "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について", "振替予告メッセージ（３４桁）７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta8(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta9(), "", "振替予告メッセージ（３４桁）９");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta10(), "", "振替予告メッセージ（３４桁）１０");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta11(), "", "振替予告メッセージ（３４桁）１１");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta12(), "", "振替予告メッセージ（３４桁）１２");
    ...
    public void testEditTBL_A29() {
        ...
        exStringEquals(hrhnTtdkKan.getSyono(), "99806001010", "証券番号");
        exClassificationEquals(hrhnTtdkKan.getSyoruiCd(), C_SyoruiCdKbn.AS_HRHNKANRYOTUUTI_DNP, "書類コード");
        exDateEquals(hrhnTtdkKan.getTyouhyouymd(), BizDate.valueOf(20170607), "帳票作成日");
        exStringEquals(hrhnTtdkKan.getShskyno(), "1234567", "送付先郵便番号");
        exStringEquals(hrhnTtdkKan.getShsadr1kj(), "通信先住所１", "送付先住所１（漢字）（３０桁）");
        ...
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta12(), "　「保険料」と表示しております。", "振替予告メッセージ（３４桁）１２");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta13(), "", "振替予告メッセージ（３４桁）１３");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta14(), "＊保険料は当社所定の為替レートで円換算した金額をお払い込みいただき", "振替予告メッセージ（３４桁）１４");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta15(), "　ます。", "振替予告メッセージ（３４桁）１５");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta16(), "", "振替予告メッセージ（３４桁）１６");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta17(), "＊当通知は口座変更完了のお知らせになります。", "振替予告メッセージ（３４桁）１７");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta18(), "　払込回数のご変更は２０１７年　１月の保険料より適用となります。", "振替予告メッセージ（３４桁）１８");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta19(), "", "振替予告メッセージ（３４桁）１９");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta20(), "", "振替予告メッセージ（３４桁）２０");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta21(), "", "振替予告メッセージ（３４桁）２１");
        exStringEquals(hrhnTtdkKan.getHrkykkmsg34keta22(), "", "振替予告メッセージ（３４桁）２２");
