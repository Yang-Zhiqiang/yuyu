...
public class SetHrhnSyoriKbnTest_exec {
    ...
    public void testExec_A8() {
        ...
        exClassificationEquals(csyoriKbn, C_SyoriKbn.TIKIKTSYURUIHENKOU, "<処理区分>定期一括払種類変更");
    }
    ...
    public void testExec_A9() {
        ...
        exClassificationEquals(csyoriKbn, C_SyoriKbn.TIKIKTSYURUIHENKOU_KOUZAHENKOU, "<処理区分>定期一括払種類変更・口座変更");
    }
    ...
    public void testExec_A10() {
        ...
        exClassificationEquals(csyoriKbn, C_SyoriKbn.TIKIKTSYURUIHENKOU_YOHURIHENNYUU, "<処理区分>定期一括払種類変更・預振編入");
    }
    ...
    public void testExec_A12() {
        ...
        exClassificationEquals(csyoriKbn, C_SyoriKbn.TIKIKTSYURUIHENKOU_CRECAHENNYUU, "<処理区分>定期一括払種類変更・クレカ編入");
    }
