...
/**
 * 月払領収金額計算{@link KeisanTukiRsgaku}のモッククラスです。<br />
 */
public class KeisanTukiRsgakuMockForKhansyuu extends KeisanTukiRsgaku {
    ...
    public C_ErrorKbn exec(KeisanTukiRsgakuBean pKeisanTukiRsgakuBean) {
        ...
        return super.exec(pKeisanTukiRsgakuBean);
    }
    ...
    public String getErrorRiyuu () {
        ...
        if (caller == KeisanRsgakuTest_exec1.class) {
            ...
            if (TESTPATTERN2.equals(SYORIPTN)) {
                ...
                return KeisanRsgakuConstants.ERRRIYUU_WARIBIKITEKIYOUKIKAN_ERR;
            }
        }
