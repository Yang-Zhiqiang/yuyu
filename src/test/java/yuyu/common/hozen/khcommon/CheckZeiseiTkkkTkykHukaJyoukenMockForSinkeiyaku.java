...
/**
 * 税制適格特約付加条件チェック{@link CheckZeiseiTkkkTkykHukaJyouken}のモッククラスです。<br />
 */
public class CheckZeiseiTkkkTkykHukaJyoukenMockForSinkeiyaku extends CheckZeiseiTkkkTkykHukaJyouken{
    ...
    public C_ErrorKbn checkZeiseiTkkkTkykHukaJk(C_Tdk pKykTdk, C_UktKbn pNenkinuktKbn, int pHhknNen,
        ...
        if (caller == CheckTblMosKihonTest_exec1.class) {
            ...
            else if (TESTPATTERN11.equals(SYORIPTN) || TESTPATTERN12.equals(SYORIPTN) || TESTPATTERN13.equals(SYORIPTN) ||
