...
/**
 * 基準日後積立金判定メソッド {@link HanteiKhSisuurendoTmttknJyoutai#execKijunymdgoTmttknHantei(HanteiTmttknJyoutaiBean)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class HanteiKhSisuurendoTmttknJyoutaiTest_exec1 {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(HanteiKhSisuurendoTmttknJyoutaiTest_exec1.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        hanteiTmttknJyoutaiBean.setHanteiKijyunymd(BizDate.valueOf("20180101"));
        hanteiTmttknJyoutaiBean.setKykymd(BizDate.valueOf("20180102"));
