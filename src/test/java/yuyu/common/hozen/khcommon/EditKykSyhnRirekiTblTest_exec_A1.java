...
/**
 * 契約商品履歴TBL編集クラスのメソッド {@link EditKykSyhnRirekiTbl#exec(KhozenCommonParam, String, C_SyutkKbn, String, int, int)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class EditKykSyhnRirekiTblTest_exec_A1 {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(EditKykSyhnRirekiTblTest_exec_A1.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        editKykSyhnRirekiTbl.exec(kCParam, syoNo1, C_SyutkKbn.SYU, "MD11",1, 11);
        ...
        exStringEquals(kykSyouhnRireki.getKbnkey(), "01", "区分キー");

        exStringEquals(kykSyouhnRireki.getSyono(), syoNo1, "証券番号");
        ...
        exStringEquals(syouhnTokujouRireki.getSyono(), syoNo1, "証券番号");
    ...
    public void testExec_A2() {
        ...
        editKykSyhnRirekiTbl.exec(kCParam, syoNo2, C_SyutkKbn.SYU, "MD11",1, 12);
        HozenDomManager hozenDomManager = SWAKInjector.getInstance(HozenDomManager.class);

        IT_KykKihon kykKihon = hozenDomManager.getKykKihon(syoNo2);
        exNumericEquals(kykKihon.getKhTtdkRirekis().get(0).getHengakuUnitRirekis().size(), 0,"契約商品履歴テーブルエンティティリストの要素数");
