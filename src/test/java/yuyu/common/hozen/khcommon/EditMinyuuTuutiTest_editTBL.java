...
public class EditMinyuuTuutiTest_editTBL {
    ...
    public void testEditTBL_A1(){
        ...
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg19(), "＊予定利率変動型５年ごと利差配当付指定通貨建個人年金保険は、円貨払込額", "未入通知追加メッセージ１９");
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg20(), "　（定期一括払いの場合は、定期一括払円貨払込額）について「保険料」と表示し", "未入通知追加メッセージ２０");
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg21(), "　ております。", "未入通知追加メッセージ２１");
    ...
    public void testEditTBL_A5(){
        ...
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg18(), "＊予定利率変動型５年ごと利差配当付指定通貨建個人年金保険は、円貨払込額", "未入通知追加メッセージ１８");
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg19(), "　（定期一括払いの場合は、定期一括払円貨払込額）について「保険料」と表示し", "未入通知追加メッセージ１９");
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg20(), "　ております。", "未入通知追加メッセージ２０");
        exStringEquals(itKouzahuriMinyuTuuti.getMinyuttaddmsg21(), "", "未入通知追加メッセージ２１");
        exStringEquals(itKouzahuriMinyuTuuti.getTuutisyuruicd(), "0001", "通知種類コード");
        exClassificationEquals(itKouzahuriMinyuTuuti.getSaikokutuutizumiflg(), C_Skszumiflg.MISAKUSEI, "催告通知作成済フラグ");
        exClassificationEquals(itKouzahuriMinyuTuuti.getHrkkeiro(), C_Hrkkeiro.KOUHURI, "払込経路");
