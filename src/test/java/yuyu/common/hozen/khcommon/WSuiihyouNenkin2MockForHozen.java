 ...
 */
public class WSuiihyouNenkin2MockForHozen extends WSuiihyouNenkin2{
    ...
    public List<IT_Suiihyou> exec(WSuiihyouParam pWSuiihyouParam) {
        ...
        if (caller == EditSuiihyouTblNenkin2Test_editTBL.class) {
            if (TESTPATTERN1.equals(SYORIPTN)) {
                ...
                IT_Suiihyou suiihyou0;
                for (int i = 0; i < 12; i++) {
                    suiihyou0 = new IT_Suiihyou("01", "11807111174", tyouhyouymd.addDays(i), i);
                    if (i == 9 ) {
                        suiihyou0.setCalckijyunymd(BizDate.valueOf("20140303"));
                    }
                    else {
