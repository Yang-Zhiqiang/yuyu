...
/**
 * {@link EditSyoukenTblNenkin2}のモッククラスです。<br />
 */
public class EditSyoukenTblNenkin2MockForHozen extends EditSyoukenTblNenkin2 {
    ...
    public EditSyoukenTblNenkin2MockForHozen() {
        super();
    }
    ...
    public void editTBL(
        ...
        super.editTBL(pHokenSyouken, pKykKihon, pEditHokenSyoukenParam, pNyknJissekiRirekiLst, pKykSya, pSyuKykSyouhnLst,
            pKykSonotaTkyk, pSibouhokenLst, pSiteiDairi, pSksyoukenskskbn, pSinkykjyoutai, pGengakuExistsCheck, pSbUktNmKjHukaKbn, pZennou);
    }
}
