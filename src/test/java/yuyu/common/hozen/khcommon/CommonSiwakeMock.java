...
/**
 * {@link CommonSiwake}のモッククラスです<br />
 */
public class CommonSiwakeMock extends CommonSiwake {
    ...
    public CommonSiwakeOutBean exec(CommonSiwakeInBean pCommonSiwakeInBean) {
        ...
        if (caller == EditKaiyakuTblUpdateTest_exec.class) {
            ...
            if (TESTPATTERN1.equals(SYORIPTN)) {
                ...
                bzSiwakeMeisaiBean3.setIbDenyenkagk(BizCurrency.valueOf(200, BizCurrencyTypes.YEN));
                ...
                bzSiwakeMeisaiBean3.setIbTaisyakukbn(C_TaisyakuKbn.KARIKATA);
