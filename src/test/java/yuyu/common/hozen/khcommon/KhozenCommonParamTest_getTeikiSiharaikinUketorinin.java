...
/**
 * 契約保全共通パラメータクラスのメソッド {@link KhozenCommonParam#getTeikiSiharaikinUketorinin(String)}
 * テスト用クラスです <br />
 */
@RunWith(OrderedRunner.class)
public class KhozenCommonParamTest_getTeikiSiharaikinUketorinin {
    ...
    @Test
    @TestOrder(10)
    public void testGetTeikiSiharaikinUketorinin_A1() {

        String syoNo = "60806040014";

        IT_KykUkt kykUkt = khozenCommonParam.getTeikiSiharaikinUketorinin(syoNo);
    ...
    @Test
    @TestOrder(20)
    public void testGetTeikiSiharaikinUketorinin_A2() {
    ...
    @Test
    @TestOrder(30)
    public void testGetTeikiSiharaikinUketorinin_A3() {
        ...
        exStringEquals(syono, "11807111130", "証券番号");
