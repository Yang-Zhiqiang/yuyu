...
/**
 * 前納期間利率取得処理クラスのメソッド {@link GetZennouKikanRiritu#exec(
 * BizDate,BizDate,BizDate)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class GetZennouKikanRirituTest_exec {

    @Inject
    private GetZennouKikanRiritu getZennouKikanRiritu;

    private final static String fileName = "UT-SP_単体テスト仕様書（共通）_前納期間利率取得処理";
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetZennouKikanRirituTest_exec.class,
                fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        C_ErrorKbn errorKbn = getZennouKikanRiritu.exec(pKikanfrom, pKikanto, pKykYmd);
        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "結果区分");
        BizNumber zennouKikanRiritu = getZennouKikanRiritu.getZennouKikanRiritu();
        List<BizDate> zennouTmttrituHnkbiList = getZennouKikanRiritu.getZennouTmttrituHnkbiList();
        List<BizNumber> newZennouTmttrituList = getZennouKikanRiritu.getNewZennouTmttrituList();
