...
/**
 * {@link EditSuiihyouTblNenkin2}のモッククラスです。<br />
 */
public class EditSuiihyouTblNenkin2MockForHozen extends EditSuiihyouTblNenkin2 {
    ...
    public EditSuiihyouTblNenkin2MockForHozen(){
        super();
    }
    ...
    public void editTBL(KhozenCommonParam pKkanriCommonParam,
        ...
        super.editTBL(pKkanriCommonParam, pKykKihon, pKykSyohnSyuLst, pKykSyouhnLst, pHhknSya, pSyoriYmd,
            pEditHokenSyoukenParam, pCSinsaihkKbn, pSyouhnZokusei, pKykSonotaTkyk, pZennou);
    }
}
