...
/**
 * {@link EditSyoukenTblSyuusin3MockForHozen}のモッククラスです。<br />
 */
public class EditSyoukenTblSyuusin3MockForHozen extends EditSyoukenTblSyuusin3{
    ...
    public EditSyoukenTblSyuusin3MockForHozen() {
        super();
    }
    ...
    public void editTBL(IT_HokenSyouken pHokenSyouken, IT_KykKihon pKykKihon,
        ...
        super.editTBL(pHokenSyouken, pKykKihon, pKykSya, pHhknSya, pSyuKykSyouhnLst, pNyknJissekiRirekiLst,
            pKykSonotaTkyk, pSiteiDairi, pSibouhokenLst, pEditHokenSyoukenParam, pSyoriYmd, pSbUktNmKjHukaKbn,
            pGengakuExistsCheck, pSksyoukenskskbn, pSinkykjyoutai, pSyouhnZokusei, pYendthnkSyoriKbn, pZennou);
    }
}
