...
/**
 * 通算用金額取得クラスのメソッド {@link GetKhTuusanyouKngk#getTsnyouitijip(
 * BM_SyouhnZokusei,IT_KykSyouhn)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class GetKhTuusanyouKngkTest_getTsnyouItijip {
    ...
    public static void testInit() {
        HenkanTuukaMockForHozen.caller = GetKhTuusanyouKngkTest_getTsnyouItijip.class;
    }
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetKhTuusanyouKngkTest_getTsnyouItijip.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(120)
    public void testGetTsnyouItijip_A1() {
        ...
        BizCurrency tsnyouitijip = getKhTuusanyouKngk.getTsnyouItijip(psyouhnZokusei,pkykSyouhn);

        exBizCalcbleEquals(tsnyouitijip, BizCurrency.valueOf(0,BizCurrencyTypes.YEN), "通算用一時払Ｐ");

    }

    @Test
    @TestOrder(130)
    public void testGetTsnyouItijip_A2() {
    ...
    @Test
    @TestOrder(140)
    public void testGetTsnyouItijip_A3() {
        ...
        exBizCalcbleEquals(tsnyouitijip, BizCurrency.valueOf(10000.00,BizCurrencyTypes.DOLLAR), "通算用一時払Ｐ");

    }

    @Test
    @TestOrder(150)
    public void testGetTsnyouItijip_A4() {
