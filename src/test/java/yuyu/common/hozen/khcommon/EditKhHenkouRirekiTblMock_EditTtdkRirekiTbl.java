 ...
 */
public class EditKhHenkouRirekiTblMock_EditTtdkRirekiTbl extends EditKhHenkouRirekiTbl {
    ...
    public List<IT_KhHenkouRireki> exec(IT_KykKihon pKykKihon, IT_BAK_KykKihon pBakKykKihon, IT_AnsyuKihon pAnsyuKihon,
        ...
        if (KhozenCommonParam.getFunctionId() == "KhozenCommonParam") {
            return khHenkouRirekiLst;
        } else if (KhozenCommonParam.getFunctionId() == "EditTtdkRirekiTbl") {
            khHenkouRireki.setBfrnaiyou("1");
            khHenkouRirekiLst.add(khHenkouRireki);
            return khHenkouRirekiLst;
        } else if (KhozenCommonParam.getFunctionId() == "asdfgasdfgasdfgasdfgasdfgasdfgasdfgasdfgasdfgasdfg") {
            return khHenkouRirekiLst;
        }
