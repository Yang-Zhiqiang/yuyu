...
/**
 * {@link EditKykSyhnRirekiTbl}のモッククラスです<br />
 */
public class EditKykSyhnRirekiTblMock extends EditKykSyhnRirekiTbl {
        ...
        if (caller == EditKaiyakuTblUpdateTest_exec.class) {
            ...
            if (TESTPATTERN1.equals(SYORIPTN)) {
                ...
                if (kykKihon != null) {
                    ...
                    kykSyouhnRireki.setSyouhncd("SH01");
                    ...
                    syouhnTokujouRireki.setSyouhncd("SH01");
