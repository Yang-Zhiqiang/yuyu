...
/**
 * 契約内容のお知らせ編集６クラスのメソッド {@link EditKykNaiyouOsirase6#editInfo(IT_KykKihon,BizDate,BizDate,KawaseRateBean,ZT_GaikaKokyakuTuutiTy)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class EditKykNaiyouOsirase6Test_editInfo {

    @Inject
    private EditKykNaiyouOsirase6 editKykNaiyouOsirase6;

    private final static String fileName = "UT-SP_単体テスト仕様書（共通）_契約内容のお知らせ編集６";
    ...
    public static void testInit() {
        ...
        CalcHkShrKngkMockForHozen.caller = EditKykNaiyouOsirase6Test_editInfo.class;
    }
    ...
    public void testEditInfo_A1() {
        ...
        ZT_GaikaKokyakuTuutiTy newGaikaKokyakuTuutiTy = editKykNaiyouOsirase6.editInfo(kykKihon,syoriYmd,kykoutoubi,kawaseRateBean,gaikaKokyakuTuutiTy);
        ...
        exStringEquals(newGaikaKokyakuTuutiTy.getZtydai2hknkkntowa(), "以降（終身）", "（中継用）第２保険期間至（和暦）");
        ...
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd2(), "05021", "（中継用）保障内容補足メッセージコード２");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd3(), "", "（中継用）保障内容補足メッセージコード３");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd4(), "05020", "（中継用）保障内容補足メッセージコード４");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd5(), "05005", "（中継用）保障内容補足メッセージコード５");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd6(), "05022", "（中継用）保障内容補足メッセージコード６");
    ...
    public void testEditInfo_A2() {
        ...
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd3(), "", "（中継用）保障内容補足メッセージコード３");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd4(), "05020", "（中継用）保障内容補足メッセージコード４");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd5(), "05022", "（中継用）保障内容補足メッセージコード５");
    ...
    public void testEditInfo_A5() {
        ...
        exStringEquals(newGaikaKokyakuTuutiTy.getZtymkhgkwari(), "", "（中継用）目標額割合");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtymkhgkhyoujikbn(), "0", "（中継用）目標額表示区分");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd1(), "05021", "（中継用）保障内容補足メッセージコード１");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd2(), "", "（中継用）保障内容補足メッセージコード２");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd3(), "", "（中継用）保障内容補足メッセージコード３");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd4(), "05020", "（中継用）保障内容補足メッセージコード４");
        exStringEquals(newGaikaKokyakuTuutiTy.getZtyhosyouhskmsgcd5(), "05022", "（中継用）保障内容補足メッセージコード５");
    ...
    public void testEditInfo_A11() {
        ...
        editKykNaiyouOsirase6.editInfo(kykKihon,syoriYmd,kykoutoubi,kawaseRateBean,gaikaKokyakuTuutiTy);

        C_ErrorKbn errkbn = editKykNaiyouOsirase6.getCommonErrorKbn();
