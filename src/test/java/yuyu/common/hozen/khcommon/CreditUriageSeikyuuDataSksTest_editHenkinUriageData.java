 ...
 * #editHenkinUriageData(KhozenCommonParam,UriageSeikyuuDataSksParam)}
 * テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class CreditUriageSeikyuuDataSksTest_editHenkinUriageData extends AbstractTest{
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CreditUriageSeikyuuDataSksTest_editHenkinUriageData.class, fileName, sheetName);
    ...
    public void testExec_C1() {
        ...
        uriageSeikyuuDataSksParam.setJyuutouym(BizDateYM.valueOf(2019, 07));

        IT_UriageSeikyuuData uriageSeikyuuData =  creditUriageSeikyuuDataSks.editHenkinUriageData(khozenCommonParam,
        ...
        exStringEquals(uriageSeikyuuData.getRecordno(),"21","レコード番号");
        exDateEquals(uriageSeikyuuData.getSyoriYmd(), BizDate.valueOf(20181020), "処理年月日");
        exClassificationEquals(uriageSeikyuuData.getCredituriageseikyuukbn(), C_CreditUriageSeikyuuKbn.MINUS, "クレジットカード売上請求区分");
        exClassificationEquals(uriageSeikyuuData.getAuthorikbn(),C_AuthoriKbn.MOSNAINISITAGAU , "オーソリ区分");
    ...
    public void testExec_C2() {
        ...
        exStringEquals(uriageSeikyuuData.getSyono(),"99806031293","証券番号");
        exStringEquals(uriageSeikyuuData.getCreditkessaiyouno(),"00000000005","クレジットカード決済用番号");
        exDateEquals(uriageSeikyuuData.getUriagenengappi(),BizDate.valueOf(20181019),"売上年月日");
        exNumericEquals(uriageSeikyuuData.getRenno3keta(),4,"連番（３桁）");
