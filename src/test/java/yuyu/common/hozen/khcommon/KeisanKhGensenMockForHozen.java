...
/**
 * 源泉徴収額計算{@link KeisanKhGensen}のモッククラスです<br />
 */
public class KeisanKhGensenMockForHozen extends KeisanKhGensen {
    ...
    public BizCurrency getGensen() {
        ...
        if (caller == KeisanCommonKaiyakuTest_keisanKaiyakuseisankin.class) {
            ...
            if (TESTPATTERN4.equals(SYORIPTN)) {
                return BizCurrency.valueOf(3001, BizCurrencyTypes.DOLLAR);
            }
        }
