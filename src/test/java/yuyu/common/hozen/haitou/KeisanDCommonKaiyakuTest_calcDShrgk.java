...
import yuyu.common.hozen.haitou.KeisanDCommonKaiyaku.NrkKmkKaiyakuNaibuBean;
...
/**
 * 配当共通計算（解約）のメソッド {@link KeisanDCommonKaiyaku#calcDShrgk(String, BizDate, BizDate)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class KeisanDCommonKaiyakuTest_calcDShrgk {

    @Inject
    private KeisanDCommonKaiyaku keisanDCommonKaiyaku;
    ...
    public static void testInit() {
        ...
        SetDNndMockForHozen.caller = KeisanDCommonKaiyakuTest_calcDShrgk.class;
        DBAccessDCommonMockForHozen.caller = KeisanDCommonKaiyakuTest_calcDShrgk.class;
        KeisanDGanrikinMockForHozen.caller = KeisanDCommonKaiyakuTest_calcDShrgk.class;
        NaiteiKakuteiRateHanteiMockForHozen.caller = KeisanDCommonKaiyakuTest_calcDShrgk.class;
    }
  ...
  //
  //        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(null, CALCKIJYUNYMD, SYORIYMD, BizDateYM.valueOf(201703));
  //
  //        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
  //        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), null, "配当支払金");
  //        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), null, "仮割当Ｄ元利金（配当支払金用）");
  //
  //        HaitouErrorInfo haitouErrorInfo = keisanDCommonKaiyaku.getErrorInfo().get(0);
  //        exStringEquals(haitouErrorInfo.getKinouId(), keisanDCommonKaiyaku.getClass().getSimpleName(), "機能ID");
  ...
  //    }
    ...
    public void testCalcDShrgk_A2() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, null, SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A3() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, CALCKIJYUNYMD, null, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A4() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, CALCKIJYUNYMD, SYORIYMD, BizDateYM.valueOf(201703));

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), null, "配当支払金");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), null, "仮割当Ｄ元利金（配当支払金用）");

        List<HaitouErrorInfo> haitouErrorInfoList = keisanDCommonKaiyaku.getErrorInfo();
        ...
        exStringEquals(haitouErrorInfoList.get(1).getKinouId(), keisanDCommonKaiyaku.getClass().getSimpleName(), "機能ID");
    ...
    public void testCalcDShrgk_A5() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, BizDate.valueOf(20140301), SYORIYMD, BizDateYM.valueOf(201703));

        exClassificationEquals(errorKbn, C_ErrorKbn.OK, "エラー区分");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), BizCurrency.valueOf(13), "配当支払金");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), BizCurrency.valueOf(0),
            "仮割当Ｄ元利金（配当支払金用）");
    ...
    public void testCalcDShrgk_A6() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, BizDate.valueOf(20140303), SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A7() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, BizDate.valueOf(20140302), SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A8() {
        ...
        exClassificationEquals(errorKbn, C_ErrorKbn.OK, "エラー区分");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), BizCurrency.valueOf(-1), "配当支払金");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), BizCurrency.valueOf(0),
            "仮割当Ｄ元利金（配当支払金用）");
    ...
    public void testCalcDShrgk_A9() {
        ...
        exClassificationEquals(errorKbn, C_ErrorKbn.OK, "エラー区分");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), BizCurrency.valueOf(0), "配当支払金");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), BizCurrency.valueOf(0),
            "仮割当Ｄ元利金（配当支払金用）");
    ...
    public void testCalcDShrgk_A14() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk(SYONO, CALCKIJYUNYMD, SYORIYMD, BizDateYM.valueOf(201703));
        EditDshrTukiDKoumokuBean editDshrTukiDKoumokuBean = keisanDCommonKaiyaku.getEditDshrTukiDKoumokuBean();
        NrkKmkKaiyakuNaibuBean nrkKmkKaiyakuNaibuBean = keisanDCommonKaiyaku.getNrkKmkKaiyakuNaibuBean();


        exClassificationEquals(errorKbn, C_ErrorKbn.OK, "エラー区分");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getDShrkn(), BizCurrency.valueOf(22), "配当支払金");
        exBizCalcbleEquals(keisanDCommonKaiyaku.getKariwariateDGanrikinForDShrkn(), BizCurrency.valueOf(9),
            "仮割当Ｄ元利金（配当支払金用）");
        ...
        exBizCalcbleEquals(editDshrTukiDKoumokuBean.getHaitouganrikincalcKari(), BizCurrency.valueOf(13), "配当元利金計算（仮割当Ｄ元利金）");
        exBooleanEquals(editDshrTukiDKoumokuBean.getGanrikincalcKariwariatedRirituLst() == null, true, "元利金計算仮割当Ｄ利率リスト");
        exBizCalcbleEquals(editDshrTukiDKoumokuBean.getHaitouganrikincalcTumi(), BizCurrency.valueOf(13), "配当元利金計算（積立Ｄ元利金）");
        ...
        exBizCalcbleEquals(editDshrTukiDKoumokuBean.getHaitoushrKin(), BizCurrency.valueOf(22), "配当支払金");
        exBizCalcbleEquals(editDshrTukiDKoumokuBean.getKariwariatedganrikinDshr(), BizCurrency.valueOf(9), "仮割当Ｄ元利金（配当支払金用）");

        exStringEquals(nrkKmkKaiyakuNaibuBean.getSyono(), "18806000014", "証券番号");
        exDateEquals(nrkKmkKaiyakuNaibuBean.getCalckijyunymd(), BizDate.valueOf(20170301), "計算基準日");
        exDateEquals(nrkKmkKaiyakuNaibuBean.getSyoriymd(), BizDate.valueOf(20180506), "処理年月日");
        exDateYMEquals(nrkKmkKaiyakuNaibuBean.getJkipjytym(), BizDateYM.valueOf(201703), "次回Ｐ充当年月");
    }
    ...
    public void testCalcDShrgk_A16() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", null, SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A17() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", CALCKIJYUNYMD, null, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A18() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", CALCKIJYUNYMD, SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A19() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", BizDate.valueOf(20140301), SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A20() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", BizDate.valueOf(20140303), SYORIYMD, BizDateYM.valueOf(201703));
    ...
    public void testCalcDShrgk_A21() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", BizDate.valueOf(20140302), SYORIYMD, BizDateYM.valueOf(201703));
    ...
    @Test
    @TestOrder(240)
    public void testCalcDShrgk_A24() {
    ...
    @Test
    @TestOrder(250)
    public void testCalcDShrgk_A25() {
        ...
        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001032", CALCKIJYUNYMD, SYORIYMD, BizDateYM.valueOf(201703));
    ...
    @Test
    @TestOrder(260)
    public void testCalcDShrgk_A26() {
    ...
    @Test
    @TestOrder(270)
    public void testCalcDShrgk_A27() {
    ...
    @Test
    @TestOrder(280)
    public void testCalcDShrgk_A28() {

        C_ErrorKbn errorKbn = keisanDCommonKaiyaku.calcDShrgk("99806001010", CALCKIJYUNYMD, SYORIYMD, null);
    ...
    @Test
    @TestOrder(290)
    public void testCalcDShrgk_A29() {
