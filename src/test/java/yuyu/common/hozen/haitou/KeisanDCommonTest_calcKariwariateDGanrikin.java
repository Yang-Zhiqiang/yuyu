...
/**
 * 配当共通計算のメソッド {@link KeisanDCommon#calcKariwariateDGanrikin(String, BizDate)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class KeisanDCommonTest_calcKariwariateDGanrikin {
    ...
    public static void testInit() {
        ...
        SetDNndMockForHozen.caller = KeisanDCommonTest_calcKariwariateDGanrikin.class;
        DBAccessDCommonMockForHozen.caller = KeisanDCommonTest_calcKariwariateDGanrikin.class;
        KeisanDGanrikinMockForHozen.caller = KeisanDCommonTest_calcKariwariateDGanrikin.class;
    }
    ...
    @Test
    @TestOrder(10)
    public void testCalcKariwariateDGanrikin_A1() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(null, CALCKIJYUNYMD);

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
        exBooleanEquals(keisanDCommon.getKhHaitouKanri() == null, true, "配当管理TBLエンティティ");
        exClassificationEquals(keisanDCommon.getKhHaitouKanriNaiteiKakuteiKbn(), null, "内定確定区分");
        exBooleanEquals(keisanDCommon.getKeyInfoKhHaitouKanriBean() == null, true, "キー情報（配当管理TBL）Bean");
    ...
    @Test
    @TestOrder(20)
    public void testCalcKariwariateDGanrikin_A2() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, null);
    ...
    @Test
    @TestOrder(30)
    public void testCalcKariwariateDGanrikin_A3() {

        MockObjectManager.initialize();
        SetDNndMockForHozen.SYORIPTN = SetDNndMockForHozen.TESTPATTERN1;

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, CALCKIJYUNYMD);
    ...
    @Test
    @TestOrder(40)
    public void testCalcKariwariateDGanrikin_A4() {
        ...
        exStringEquals((String) MockObjectManager.getArgument(DBAccessDCommonMockForHozen.class,
            "getKijyunymdTykzenHaitouKanriSyu", 0, 0), SYONO, "証券番号");
        exDateEquals((BizDate) MockObjectManager.getArgument(DBAccessDCommonMockForHozen.class,
            "getKijyunymdTykzenHaitouKanriSyu", 0, 1),
            BizDate.valueOf(20020305), "基準日");
    ...
    @Test
    @TestOrder(50)
    public void testCalcKariwariateDGanrikin_A5() {
        ...
        exBooleanEquals(keisanDCommon.getKhHaitouKanri() != null, true, "配当管理TBLエンティティ");
        exClassificationEquals(keisanDCommon.getKhHaitouKanriNaiteiKakuteiKbn(), C_NaiteiKakuteiKbn.KAKUTEI, "内定確定区分");
        exBooleanEquals(keisanDCommon.getKeyInfoKhHaitouKanriBean() != null, true, "キー情報（配当管理TBL）Bean");
    ...
    @Test
    @TestOrder(60)
    public void testCalcKariwariateDGanrikin_A6() {

        MockObjectManager.initialize();

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, BizDate.valueOf(20000102));

        exClassificationEquals(errorKbn, C_ErrorKbn.OK, "エラー区分");
        BizCurrency kariwariateDGanrikin = keisanDCommon.getKariwariateDGanrikin();
        exBizCalcbleEquals(kariwariateDGanrikin, BizCurrency.valueOf(0), "配当元利金（仮割当Ｄ元利金）");
        List<BizNumber> kariwariateDRiritu = keisanDCommon.getKariwariateDRirituList();
        exBooleanEquals(kariwariateDRiritu.size() == 0, true, "配当利率リスト（仮割当Ｄ元利金）");
    }

    @Test
    @TestOrder(210)
    public void testCalcKariwariateDGanrikin_B1() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(null, CALCKIJYUNYMD, BizDate.valueOf(20170401));
    ...
    @Test
    @TestOrder(220)
    public void testCalcKariwariateDGanrikin_B2() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, null, BizDate.valueOf(20170401));
    ...
    @Test
    @TestOrder(230)
    public void testCalcKariwariateDGanrikin_B3() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, CALCKIJYUNYMD, null);
    ...
    @Test
    @TestOrder(240)
    public void testCalcKariwariateDGanrikin_B4() {

        MockObjectManager.initialize();
        SetDNndMockForHozen.SYORIPTN = SetDNndMockForHozen.TESTPATTERN1;

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin(SYONO, BizDate.valueOf(20130304), BizDate.valueOf(20130302));
    ...
    @Test
    @TestOrder(250)
    public void testCalcKariwariateDGanrikin_B5() {
    ...
    @Test
    @TestOrder(260)
    public void testCalcKariwariateDGanrikin_B6() {
        ...
        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin("99806001010", BizDate.valueOf(20130304), BizDate.valueOf(20130303));
    ...
    @Test
    @TestOrder(270)
    public void testCalcKariwariateDGanrikin_B7() {

        MockObjectManager.initialize();

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin("99806001010", BizDate.valueOf(20130304), BizDate.valueOf(20130301));
    ...
    @Test
    @TestOrder(280)
    public void testCalcKariwariateDGanrikin_B8() {

        C_ErrorKbn errorKbn = keisanDCommon.calcKariwariateDGanrikin("", CALCKIJYUNYMD, BizDate.valueOf(20170401));
