...
/**
 * 配当支払チェック（減額）クラスのメソッド {@link CheckDShrGengaku#checkDShr(String , BizDate, BizDate)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class CheckDShrGengakuTest_checkDShr {
    ...
    @Inject
    CheckDShrGengaku checkDShrGengaku;
    ...
    public static void testInit() {
        ...
        CheckDSeigouMockForHozen.caller = CheckDShrGengakuTest_checkDShr.class;
        CheckDJyoutaiMockForHozen.caller = CheckDShrGengakuTest_checkDShr.class;
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckDShrGengakuTest_checkDShr.class, fileName, sheetName);
    ...
    public void testCheckDShr_A1() {
        ...
        errorKbn = checkDShrGengaku.checkDShr(null, BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "結果区分");
        List<HaitouErrorInfo> HaitouErrorInfoLst = checkDShrGengaku.getErrorInfo();

        exNumericEquals(HaitouErrorInfoLst.size(), 1, "エラー情報のサイズ");
        exStringEquals(HaitouErrorInfoLst.get(0).getKinouId(), checkDShrGengaku.getClass().getSimpleName(), "機能ID");
        ...
        exClassificationEquals(checkDShrGengaku.getDHuseigouUmu(), null, "配当不整合有無");
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), null, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), null, "処理可否区分");
    ...
    public void testCheckDShr_A2() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("", BizDate.valueOf(20180401),BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A3() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", null, BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A4() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, null);
    ...
    public void testCheckDShr_A5() {
        ...
        errorKbn = checkDShrGengaku.checkDShr(null, null, BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A6() {
        ...
        errorKbn = checkDShrGengaku.checkDShr(null, BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, null);
    ...
    public void testCheckDShr_A7() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", null, BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, null);
    ...
    public void testCheckDShr_A8() {
        ...
        errorKbn = checkDShrGengaku.checkDShr(null, null, null, null, null);
    ...
    public void testCheckDShr_A9() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "結果区分");
        List<HaitouErrorInfo> HaitouErrorInfoLst = checkDShrGengaku.getErrorInfo();

        exNumericEquals(HaitouErrorInfoLst.size(), 2, "エラー情報のサイズ");
        exStringEquals(HaitouErrorInfoLst.get(1).getKinouId(), checkDShrGengaku.getClass().getSimpleName(), "機能ID");
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo1(), "NoError", "エラ情報１（大分類）");
    ...
    public void testCheckDShr_A10() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111336", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrGengaku.getDHuseigouUmu(), C_UmuKbn.NONE, "配当不整合有無");
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), C_UmuKbn.NONE, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), C_SyorikahiKbn.SYORIHUKA, "処理可否区分");
        exClassificationEquals(checkDShrGengaku.getDHaneiYmdUmu(), C_UmuKbn.ARI, "配当金反映日有無");
    ...
    public void testCheckDShr_A11() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111347", BizDate.valueOf(20181201), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrGengaku.getDHuseigouUmu(), C_UmuKbn.NONE, "配当不整合有無");
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), C_UmuKbn.ARI, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), C_SyorikahiKbn.SYORIHUKA, "処理可否区分");
        exClassificationEquals(checkDShrGengaku.getDHaneiYmdUmu(), C_UmuKbn.NONE, "配当金反映日有無");
    ...
    public void testCheckDShr_A12() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111358", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo1(), "NoError", "エラー情報１（大分類）");
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrGengaku.getDHuseigouUmu(), C_UmuKbn.ARI, "配当不整合有無");
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), C_UmuKbn.NONE, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), C_SyorikahiKbn.SYORIHUKA, "処理可否区分");
        exClassificationEquals(checkDShrGengaku.getDHaneiYmdUmu(), C_UmuKbn.NONE, "配当金反映日有無");
    ...
    public void testCheckDShr_A13() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111358", BizDate.valueOf(20181201), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A14() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111369", BizDate.valueOf(20181201), BizDateYM.valueOf(201812), C_YouhiKbn.YOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A15() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111370", BizDate.valueOf(20180401), BizDateYM.valueOf(201802), C_YouhiKbn.YOU, BizDate.valueOf(20181130));
        ...
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDJyoutaiMockForHozen.class, "execForMibaraiHaitouHantei", 0, 0),
            BizDate.valueOf(20180228), "判定基準日");
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDJyoutaiMockForHozen.class, "execForMibaraiHaitouHantei", 0, 1),
            BizDate.valueOf(20181130), "契約日");
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDJyoutaiMockForHozen.class, "execForMibaraiHaitouHantei", 0, 2),
            BizDate.valueOf(20181230), "円建変更日");
    ...
    public void testCheckDShr_A16() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111381", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.YOU, BizDate.valueOf(20181130));
        ...
        exClassificationEquals(checkDShrGengaku.getDHuseigouUmu(), C_UmuKbn.NONE, "配当不整合有無");
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), C_UmuKbn.NONE, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), C_SyorikahiKbn.SYORIKANOU, "処理可否区分");
        exClassificationEquals(checkDShrGengaku.getDHaneiYmdUmu(), C_UmuKbn.NONE, "配当金反映日有無");
    ...
    public void testCheckDShr_A17() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111381", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
        ...
        exClassificationEquals(checkDShrGengaku.getMihaneiDUmu(), null, "未反映配当金有無");
        exClassificationEquals(checkDShrGengaku.getSyorikahiKbn(), null, "処理可否区分");
        exClassificationEquals(checkDShrGengaku.getDShrYmdUmu(), null, "配当金支払日有無");
    ...
    public void testCheckDShr_A18() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", BizDate.valueOf(20180401), null, C_YouhiKbn.YOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A19() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", BizDate.valueOf(20180401), null, C_YouhiKbn.HUYOU, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A20() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111185", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), null, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A21() {
        ...
        errorKbn = checkDShrGengaku.checkDShr("11807111680", BizDate.valueOf(20180401), BizDateYM.valueOf(201804), C_YouhiKbn.YOU, BizDate.valueOf(20181130));
        ...
        exStringEquals((String)MockObjectManager.getArgument(CheckDSeigouMockForHozen.class, "exec", 0, 0), "11807111680", "証券番号");
        exDateYEquals((BizDateY)MockObjectManager.getArgument(CheckDSeigouMockForHozen.class, "exec", 0, 1), BizDateY.valueOf(2020), "契約ＭＦ配当年度");
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDSeigouMockForHozen.class, "exec", 0, 2), BizDate.valueOf(20181202), "契約日");
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDSeigouMockForHozen.class, "exec", 0, 3), BizDate.valueOf(20181130), "円建変更日");
        exDateEquals((BizDate)MockObjectManager.getArgument(CheckDSeigouMockForHozen.class, "exec", 0, 4), BizDate.valueOf(20181130), "処理年月日");
