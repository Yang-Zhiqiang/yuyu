 ...
 */
public class SetHokenNndMock extends SetHokenNnd {
    ...
    public SetHokenNnd.HokenNndBean exec(BizDate pKijyunymd, BizDate pHanteiymd) {
        ...
        else if (caller == CheckDSeigouTest_checkKykMfHaitounendo.class ) {
            if (TESTPATTERN1.equals(SYORIPTN)) {
                return null;
            }
            else if (TESTPATTERN2.equals(SYORIPTN)) {
        ...
        else if (caller == CheckDSeigouTest_exec.class ) {
            if (TESTPATTERN1.equals(SYORIPTN)) {
                return null;
            }
            else if (TESTPATTERN2.equals(SYORIPTN)) {
        ...
        else if (caller == CheckDSeigouTest_checkTumitateDkanriTBL.class ) {
            if (TESTPATTERN1.equals(SYORIPTN)) {
                return null;
            }
            else if (TESTPATTERN2.equals(SYORIPTN)) {
        ...
        else if (caller == CheckDSeigouTest_checkTumitateDkanriTBLYendtHnkMae.class ) {
            if (TESTPATTERN1.equals(SYORIPTN)) {
                return null;
            }
            else if (TESTPATTERN2.equals(SYORIPTN)) {
