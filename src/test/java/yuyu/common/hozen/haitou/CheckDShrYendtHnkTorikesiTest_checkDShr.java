...
/**
 * 配当支払チェック（円建変更取消）クラスのメソッド {@link CheckDShrYendtHnkTorikesi#checkDShr(String , BizDate, BizDate)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class CheckDShrYendtHnkTorikesiTest_checkDShr {

    @Inject
    CheckDShrYendtHnkTorikesi checkDShrYendtHnkTorikesi;
    ...
    public static void testInit() {
        ...
        CheckDSeigouMockForHozen.caller = CheckDShrYendtHnkTorikesiTest_checkDShr.class;
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckDShrYendtHnkTorikesiTest_checkDShr.class, fileName, sheetName);
    ...
    public void testCheckDShr_A1() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr(null, BizDate.valueOf(20180401), BizDate.valueOf(20181130));

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "結果区分");
        List<HaitouErrorInfo> HaitouErrorInfoLst = checkDShrYendtHnkTorikesi.getErrorInfo();

        exNumericEquals(HaitouErrorInfoLst.size(), 1, "エラー情報のサイズ");
        exStringEquals(HaitouErrorInfoLst.get(0).getKinouId(), checkDShrYendtHnkTorikesi.getClass().getSimpleName(), "機能ID");
        ...
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHuseigouUmu(), null, "配当不整合有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getSyorikahiKbn(), null, "処理可否区分");
    ...
    public void testCheckDShr_A2() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A3() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111185", null, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A4() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111185", BizDate.valueOf(20180401), null);
    ...
    public void testCheckDShr_A5() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr(null, null, BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A6() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr(null, BizDate.valueOf(20180401), null);
    ...
    public void testCheckDShr_A7() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111185", null, null);
    ...
    public void testCheckDShr_A8() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr(null, null, null);
    ...
    public void testCheckDShr_A9() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111185", BizDate.valueOf(20180401), BizDate.valueOf(20181130));

        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "結果区分");
        List<HaitouErrorInfo> HaitouErrorInfoLst = checkDShrYendtHnkTorikesi.getErrorInfo();

        exNumericEquals(HaitouErrorInfoLst.size(), 2, "エラー情報のサイズ");
        exStringEquals(HaitouErrorInfoLst.get(1).getKinouId(), checkDShrYendtHnkTorikesi.getClass().getSimpleName(), "機能ID");
    ...
    public void testCheckDShr_A10() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111336", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo1(), "NoError", "エラー情報１（大分類）");
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHuseigouUmu(), C_UmuKbn.NONE, "配当不整合有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getSyorikahiKbn(), C_SyorikahiKbn.SYORIHUKA, "処理可否区分");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHaneiYmdUmu(), C_UmuKbn.ARI, "配当金反映日有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDShrYmdUmu(), C_UmuKbn.ARI, "配当金支払日有無");
    ...
    public void testCheckDShr_A11() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111451", BizDate.valueOf(20181231), BizDate.valueOf(20171130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHuseigouUmu(), C_UmuKbn.NONE, "配当不整合有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getSyorikahiKbn(), C_SyorikahiKbn.SYORIKANOU, "処理可否区分");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHaneiYmdUmu(), C_UmuKbn.NONE, "配当金反映日有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDShrYmdUmu(), C_UmuKbn.NONE, "配当金支払日有無");
    ...
    public void testCheckDShr_A12() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111358", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
        ...
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo1(), "NoError", "エラー情報１（大分類）");
        exStringEquals(HaitouErrorInfoLst.get(0).getErrorInfo2(), "NoError", "エラー情報２（小分類）");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHuseigouUmu(), C_UmuKbn.ARI, "配当不整合有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getSyorikahiKbn(), C_SyorikahiKbn.SYORIHUKA, "処理可否区分");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDHaneiYmdUmu(), C_UmuKbn.NONE, "配当金反映日有無");
        exClassificationEquals(checkDShrYendtHnkTorikesi.getDShrYmdUmu(), C_UmuKbn.NONE, "配当金支払日有無");
    ...
    public void testCheckDShr_A13() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111392", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A14() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111406", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A15() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111439", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
    ...
    public void testCheckDShr_A16() {
        ...
        errorKbn = checkDShrYendtHnkTorikesi.checkDShr("11807111440", BizDate.valueOf(20180401), BizDate.valueOf(20181130));
