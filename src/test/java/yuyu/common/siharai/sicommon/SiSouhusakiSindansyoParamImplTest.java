...
/**
 * 保険金給付金支払 保険金給付金支払共通 送付先情報(診断書料支払)Paramインターフェース実装クラス（テスト用）
 */
public class SiSouhusakiSindansyoParamImplTest implements SiSouhusakiSindansyoParam, EditSkTblParam {
