...
/**
 * 保険金給付金支払 保険金給付金支払共通 支払査定設定Param、請求基本情報表示インターフェース実現クラス
 */
public class CommonViewUiBeanParamImpl10 implements ViewSiharaiSateiUiBeanParam, ViewSkKihonUiBeanParam {
