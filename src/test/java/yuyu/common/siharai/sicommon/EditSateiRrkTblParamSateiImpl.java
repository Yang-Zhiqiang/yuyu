...
/**
 * 保険金給付金支払 保険金給付金支払共通 査定承認履歴TBL編集パラメータ（処理結果(査定)Param）実現クラス
 */
public class EditSateiRrkTblParamSateiImpl implements EditSateiRrkTblParam, SiSyoriKekkaSateiParam {
