 ...
 */
public class KeiyakuInfoSyutokuMock extends KeiyakuInfoSyutoku {
    ...
    public void getInfos(KeiyakuPrm pKp) {
        if (caller == SiharaiWorklistViewValuesCreatorTest_create.class && "SN000000001".equals(pKp.getSyono())) {
            super.getInfos(pKp);
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon.setKyknmkj("契約者名１");
            siKykKihon.setSyono("SN000000001");
            siKykKihon.setKyknmkn("カナ１");
            JT_SiKykSyouhn siKykSyouhn = siKykKihon.createSiKykSyouhn();
            siKykSyouhn.setSyouhncd("M110");
        ...
        if (caller == SiharaiWorklistViewValuesCreatorTest_create.class && "SN000000002".equals(pKp.getSyono())) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon.setKyknmkj("契約者名２");
            siKykKihon.setSyono("SN000000002");
            siKykKihon.setKyknmkn("カナ２");
            JT_SiKykSyouhn siKykSyouhn = siKykKihon.createSiKykSyouhn();
            siKykSyouhn.setSyouhncd("M111");
            siKykSyouhn.setSyouhnsdno(1);
        ...
        if (caller == SiharaiWorklistViewValuesCreatorTest_create.class && "SN000000003".equals(pKp.getSyono())) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon.setKyknmkj("契約者名３");
            siKykKihon.setSyono("SN000000003");
            siKykKihon.setKyknmkn("カナ３");
            JT_SiKykSyouhn siKykSyouhn = siKykKihon.createSiKykSyouhn();
            siKykSyouhn.setSyouhncd("M112");
            siKykSyouhn.setSyouhnsdno(1);
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN2.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN3.equals(SYORIPTN)
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN4.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN5.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN6.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN7.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN8.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN9.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN10.equals(SYORIPTN)
        ...
        if (caller == CheckSbSkNaiyouTest_exec.class && TESTPATTERN11.equals(SYORIPTN)) {
        ...
        if (caller == SateiKekkaNyuuryokuChkTest_exec.class && TESTPATTERN1.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon = null;
        ...
        if (caller == SateiKekkaNyuuryokuChkTest_exec.class && TESTPATTERN2.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon.setSyono("17809000023");
        ...
        if (caller == SateiKekkaNyuuryokuChkTest_exec.class && TESTPATTERN3.equals(SYORIPTN)) {
            JT_SiKykKihon siKykKihon = new JT_SiKykKihon();
            siKykKihon.setNstkhkumu(C_UmuKbn.NONE);
            siKykKihon.setYuukousyoumetukbn(C_YuukousyoumetuKbn.SYOUMETU);
            siKykKihon.setSyono("17809000045");
    ...
    public List<JT_SiKykKihon> getKykKihons() {
        if (caller == SiharaiWorklistViewValuesCreatorTest_create.class) {
