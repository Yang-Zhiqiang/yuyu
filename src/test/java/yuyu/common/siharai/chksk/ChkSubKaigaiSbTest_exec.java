...
/**
 * 海外死亡チェックのメソッド{@link ChkSubKaigaiSb#exec(C_UmuKbn, List<ChkKekkaBean>)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class ChkSubKaigaiSbTest_exec {
    @Inject
    private ChkSubKaigaiSb chkSubKaigaiSb;
    ...
    public void testExec_A1() {
        ...
        chkSubKaigaiSb.exec(C_UmuKbn.ARI, chkKekkaBeanLst);
        exNumericEquals(chkKekkaBeanLst.size(), 1, "件数");
        exClassificationEquals(chkKekkaBeanLst.get(0).getSKNaiyouChkKbn(), C_SKNaiyouChkKbn.SATEICHK_KAIGAISIBOU,
            "請求内容チェック区分");
    ...
    public void testExec_A2() {
        ...
        exClassificationEquals(chkKekkaBeanLst.get(1).getSKNaiyouChkKbn(), C_SKNaiyouChkKbn.SATEICHK_KAIGAISIBOU,
            "請求内容チェック区分");
    ...
    public void testExec_A3() {
        List<ChkKekkaBean> chkKekkaBeanLst = new ArrayList<>();
        chkSubKaigaiSb.exec(C_UmuKbn.NONE, chkKekkaBeanLst);
