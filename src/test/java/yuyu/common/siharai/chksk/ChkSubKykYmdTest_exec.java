...
/**
 * 保険金給付金支払 請求内容チェック 契約日チェッククラス
 */
@RunWith(OrderedRunner.class)
public class ChkSubKykYmdTest_exec {

    @Inject
    private ChkSubKykYmd chkSubKykYmd;
    ...
    public void testExec1(){
        ...
        BizDate kykYmd = BizDate.valueOf("20180118");
        List<ChkKekkaBean> chkKekkaBeanList = new ArrayList<>();
        ChkKekkaBean chkKekkaBean = SWAKInjector.getInstance(ChkKekkaBean.class);

        chkKekkaBeanList.add(chkKekkaBean);
        chkSubKykYmd.exec(hanteiKijyunYmd, kykYmd, chkKekkaBeanList);
    ...
    public void testExec3(){
        BizDate hanteiKijyunYmd = BizDate.valueOf("20180118");
        BizDate kykYmd = BizDate.valueOf("20180119");
        List<ChkKekkaBean> chkKekkaBeanList = new ArrayList<>();
        ...
        exClassificationEquals(chkKekkaBeanList.get(2).getSKNaiyouChkKbn(), C_SKNaiyouChkKbn.KYKYMDCHECK_CHK,"請求内容チェック区分");
    }
    ...
    public void testExec5(){
        BizDate hanteiKijyunYmd = BizDate.valueOf("20180118");
        BizDate kykYmd = BizDate.valueOf("20180117");
        List<ChkKekkaBean> chkKekkaBeanList = new ArrayList<>();
        chkSubKykYmd.exec(hanteiKijyunYmd, kykYmd, chkKekkaBeanList);
