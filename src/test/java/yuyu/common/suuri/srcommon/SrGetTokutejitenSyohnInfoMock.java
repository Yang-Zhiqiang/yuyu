...
public class SrGetTokutejitenSyohnInfoMock extends SrGetTokutejitenSyohnInfo {
    ...
    public TkJitenKeiyakuSyouhinBean exec(C_TokutejitenSyoriKbn pTokutejitenSyoriKbn, String pTokutejitenSyono,
        ...
        if ((caller == SrSuuriKeisanVHeijyunTest_exec.class) && TESTPATTERN1.equals(SYORIPTN)) {
        ...
        else if ((caller == SrSuuriKeisanVHeijyunTest_exec.class) && TESTPATTERN2.equals(SYORIPTN)) {
            TkJitenKeiyakuSyouhinBean tkJitenKeiyakuSyouhinBean = new TkJitenKeiyakuSyouhinBean();
            tkJitenKeiyakuSyouhinBean.setTkJitenKeiyakuSyouhinKijyunBeanAto(null);
            return tkJitenKeiyakuSyouhinBean;
        }
