...
/**
 * ワークフロー呼出ユーティリティクラスのメソッド {@link WorkFlowUtility#getCountOfKakoJissekiTaskSummaryByTask(BizDate pSyoriYmdFrom, BizDate pSyoriYmdTo, String pJimutetuzukiCd, String[] pTaskId, String pUserId)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class WorkFlowUtilityTest46 {

    private final static String fileName = "UT-SP_単体テスト仕様書（共通）_【46_処理残件数取得_過去実績サマリ分(事務手続・処理日・タスク指定)】";
    ...
    public void testGetCountOfKakoJissekiTaskSummaryByTask_A1() {
        ...
        GetCountOfTaskSummaryByTaskResultBean ret = WorkFlowUtility.getCountOfKakoJissekiTaskSummaryByTask(
            BizDate.valueOf(20180108), BizDate.valueOf(20180108), "101223301", new String[]{"task101"}, "userId101");
    ...
    public void testGetCountOfKakoJissekiTaskSummaryByTask_A2() {
        ...
        GetCountOfTaskSummaryByTaskResultBean ret = WorkFlowUtility.getCountOfKakoJissekiTaskSummaryByTask(
            BizDate.valueOf(20180111), BizDate.valueOf(20180113), "201223301", new String[]{"task201"}, "kyouyuu");
        exStringEquals(ret.getSyorikekkaStatus(), "0", "処理結果ステータス");
        exStringEquals(ret.getSyousaiMessageCd(), null, "詳細メッセージコード");
        exStringEquals(ret.getSyousaiMessage(), null, "詳細メッセージ");
        List<CountOfTaskSummaryByTaskBean> countOfKakoJissekiTaskSummaryBeanLst =
    ...
    public void testGetCountOfKakoJissekiTaskSummaryByTask_A3() {
        ...
        GetCountOfTaskSummaryByTaskResultBean ret = WorkFlowUtility.getCountOfKakoJissekiTaskSummaryByTask(
            BizDate.valueOf(20180118), BizDate.valueOf(20180122), "301223301", new String[]{"task300","task301","task302","task303"}, null);
        exStringEquals(ret.getSyorikekkaStatus(), "0", "処理結果ステータス");
        exStringEquals(ret.getSyousaiMessageCd(), null, "詳細メッセージコード");
        exStringEquals(ret.getSyousaiMessage(), null, "詳細メッセージ");
        List<CountOfTaskSummaryByTaskBean> countOfKakoJissekiTaskSummaryBeanLst =
            ret.getCountOfTaskSummaryBean();
        exNumericEquals(countOfKakoJissekiTaskSummaryBeanLst.size(), 3, "件数");
        ...
        exStringEquals(countOfKakoJissekiTaskSummaryBeanLst.get(0).getTaskNm(), "task300", "タスク名");
    ...
    public void testGetCountOfKakoJissekiTaskSummaryByTask_A4() {
        ...
        GetCountOfTaskSummaryByTaskResultBean ret = WorkFlowUtility.getCountOfKakoJissekiTaskSummaryByTask(
            BizDate.valueOf(20180127), BizDate.valueOf(20180130), "401223301", new String[]{"task401","task402"}, "");
        exStringEquals(ret.getSyorikekkaStatus(), "0", "処理結果ステータス");
        exStringEquals(ret.getSyousaiMessageCd(), null, "詳細メッセージコード");
        exStringEquals(ret.getSyousaiMessage(), null, "詳細メッセージ");
        List<CountOfTaskSummaryByTaskBean> countOfKakoJissekiTaskSummaryBeanLst =
