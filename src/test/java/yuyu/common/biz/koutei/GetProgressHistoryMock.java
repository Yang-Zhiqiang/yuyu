 ...
 */
public class GetProgressHistoryMock extends GetProgressHistory{
    ...
    public List<GetProgressHistoryOutBean> exec(String kouteiKanriId){
        ...
        if(caller ==SetProgressHistoryTest_exec.class && kouteiKanriId == "ParProgressId"){
        ...
        } else if (caller ==SetProgressHistoryTest_exec.class && kouteiKanriId == "ParProgressId2"){
