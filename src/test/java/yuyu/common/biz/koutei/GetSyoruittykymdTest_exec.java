...
/**
 * 書類到着日取得のメソッド {@link GetSyoruittykymd#exec(String, C_SyoruiCdKbn)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class GetSyoruittykymdTest_exec {
    ...
    public void testExec_A1() {
        ...
        BizDate syoruiTtykYmd = getSyoruittykymd.exec(pKouteiKanriId, pSyoruiCd);
    ...
    public void testExec_A4() {
        IwfImageClientMockForBiz.mode = "dl-02";
        ...
        exDateEquals(syoruiTtykYmd, BizDate.valueOf("20150717"), "書類到着日");
    }
    ...
    public void testExec_A5() {
        ...
        try {
            getSyoruittykymd.exec(pKouteiKanriId, pSyoruiCd);
