...
/**
 * 代理店情報取得（親代理店、事務所指定）クラスのメソッド {@link BzGetAgInfoJimusyo#exec(String,String)}テスト用クラスです<br />
 */
@RunWith(SWAKTestRunner.class)
public class BzGetAgInfoJimusyoTest_exec extends AbstractTest {

    @Inject
    private BzGetAgInfoJimusyo bzGetAgInfoJimusyo;

    private final static String fileName = "UT_SP_単体テスト仕様書_代理店情報取得（親代理店、事務所指定）";
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BzGetAgInfoJimusyoTest_exec.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        String drtenjimCd = "2111";

        List<BzGetAgInfoBean> bzGetAgInfoBeanList = bzGetAgInfoJimusyo.exec(oyadrtenCd, drtenjimCd);
    ...
    public void testExec_A3() {
        ...
        String oyadrtenCd = "4144142";

        String drtenjimCd = "4111";
    ...
    public void testExec_A4() {
        ...
        String oyadrtenCd = "5155152";

        String drtenjimCd = "5111";
        ...
        exStringEquals(bzGetAgInfoBeanList.get(0).getOyadrtenCd(), "5155152", "親代理店コード");
        ...
        exStringEquals(bzGetAgInfoBeanList.get(0).getKinyuuSitenCd(), "5010", "金融機関支店コード");
        exStringEquals(bzGetAgInfoBeanList.get(0).getDrtenJimCd(), "5111", "代理店事務所コード");
        ...
        exStringEquals(bzGetAgInfoBeanList.get(1).getOyadrtenCd(), "5155153", "親代理店コード");
        ...
        exStringEquals(bzGetAgInfoBeanList.get(2).getOyadrtenCd(), "5155154", "親代理店コード");
        ...
        exStringEquals(bzGetAgInfoBeanList.get(3).getOyadrtenCd(), "5155155", "親代理店コード");
