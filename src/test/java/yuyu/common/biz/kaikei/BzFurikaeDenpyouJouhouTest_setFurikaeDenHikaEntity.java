...
/**
 * 振替伝票情報クラスのメソッド {@link BzFurikaeDenpyouJouhou#setFurikaeDenHikaEntity()} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class BzFurikaeDenpyouJouhouTest_setFurikaeDenHikaEntity{
    ...
    @Test
    @TestOrder(10)
    public void testSetFurikaeDenHikaEntity_A1() {
        ...
        furikaeDenpyouPage.setHuridenYouHassouKbn(C_HuridenYouHassouKbn.HASSOUSAKI2);
        ...
        bzFurikaeDenpyouJouhou.setKjTekiyouHikae1("漢字摘要一");

        bzFurikaeDenpyouJouhou.setKjTekiyouHikae2("漢字摘要二");

        bzFurikaeDenpyouJouhou.setKjTekiyouHikae3("漢字摘要三");

        FurikaeDenpyouParamImpl impl = SWAKInjector.getInstance(FurikaeDenpyouParamImpl.class);

        bzFurikaeDenpyouJouhou.setFurikaeDenHikaEntity(impl, furikaeDenpyouPage);

        exStringEquals(impl.getZtykytkmksyoruicd(), "CM037", "（中継用）共通項目書類コード");
        ...
        exStringEquals(impl.getZtykytkmkseifukukbn(), "2", "（中継用）共通項目正副区分");
        exStringEquals(impl.getZtykytkmkfuridenhassoukbn(), "02", "（中継用）共通項目振替伝票用発送区分");
        ...
        exStringEquals(impl.getZtykjhikaeinjikm(), "＊控＊", "（中継用）漢字控印字項目");
    ...
    @Test
    @TestOrder(20)
    public void testSetFurikaeDenHikaEntity_A2() {
        FurikaeDenpyouPage furikaeDenpyouPage = new FurikaeDenpyouPage();
