...
/**
 * {@link IwfImageClient}のモッククラスです。<br />
 */
public class IwfImageClientMockForBiz extends IwfImageClient {
        ...
        if("Test".equals(caller)){
            ...
            switch(mode) {
                ...
                case "21-11":
                    ...
                    wSGetImageByIdResponse.setSyousaimsgcd("IWF0000");
                    wSGetImageByIdResponse.setSyousaimsg("正常終了しました。");
                    imageInfoBean.setImageid("ImageId04");
                    imageInfoBean.setGyoumukey("GyoumuKey01");
                    imageInfoBean.setTorikomisyoruicd("SyoruiCd01");
                    imageInfoBean.setSyoruitoutyakutime(sdf.format(cal.getTime()));
                    imageInfoBean.setKengenumu("1");
                    ...
                    ImageInfoBean imageInfoBean1 = new ImageInfoBean();
                    imageInfoBean1.setImageid("ImageId04");
                    imageInfoBean1.setGyoumukey("GyoumuKey02");
                    imageInfoBean1.setTorikomisyoruicd("SyoruiCd02");
                    imageInfoBean1.setSyoruitoutyakutime(sdf.format(cal.getTime()));
                    imageInfoBean1.setKengenumu("1");
                    imageInfoBean1.setPdfimage(b);
                    iIBeanList.add(imageInfoBean1);
                    wSGetImageByIdResponse.setImageinfolist(iIBeanList);

                    ImageInfoBean imageInfoBean2 = new ImageInfoBean();
                    imageInfoBean2.setImageid("ImageId04");
                    imageInfoBean2.setGyoumukey("GyoumuKey03");
                    imageInfoBean2.setTorikomisyoruicd("SyoruiCd03");
                    imageInfoBean2.setSyoruitoutyakutime(sdf.format(cal.getTime()));
                    imageInfoBean2.setKengenumu("0");
                    imageInfoBean2.setPdfimage(b);
                    iIBeanList.add(imageInfoBean2);
                    wSGetImageByIdResponse.setImageinfolist(iIBeanList);
                    break;
                case "dl01-01":
                    wSGetImageByIdResponse.setKekkastatus("9");
        ...
        if("Test".equals(caller)) {
            ...
            switch(mode) {
                ...
                case "23-06":
                    ...
                    break;
                case "23-07":
                    response.setKekkastatus(null);
                    response.setSyousaimsgcd("IWF0002");
                    response.setSyousaimsg("必須入力チェックエラー１");
                    break;
                case "23-08":
                    response.setKekkastatus("9");
                    response.setSyousaimsgcd("IWF0002");
                    response.setSyousaimsg("必須入力チェックエラー２");
                    break;
                case "23-09":
                    response.setKekkastatus("9");
                    response.setSyousaimsgcd("IWF3073");
                    response.setSyousaimsg("必須入力チェックエラー３");
                    break;
                case "23-10":
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IWF3073");
                    response.setSyousaimsg("必須入力チェックエラー４");
                    break;
                default:
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IWF0000");
        ...
        if("Test".equals(caller)) {
            ...
            switch(mode) {
                ...
                case "qs-99":
                    ...
                    bean.setImageid("");
                    bean.setGyoumukey("");
                    bean.setTorikomisyoruicd("cm099");
                    bean.setSyoruitoutyakutime("");
                    bean.setKengenumu("");
                    beanList.add(bean);
                ...
                case "qs-104":
                    ...
                    bean.setImageid("ImageId01");
                    bean.setGyoumukey("sk032");
                    bean.setTorikomisyoruicd("sk032");
                    bean.setSyoruitoutyakutime("20160111151630111");
                    bean.setKouteijyoutai("10");
                    bean.setKengenumu("1");
                    bean.setTourokuaccountid("test");
                ...
                case "qs-105":
                    ...
                    response.setImagepropslist(new ArrayList<ImagePropsBean>());
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IWF0000");
                    response.setSyousaimsg("正常終了しました。");
                    break;
