...
public class IwfKouteiClientMock extends IwfKouteiClient {
    ...
    public GetProcessSummaryOutBean execGetProcessSummary(GetProcessSummaryInBean inBean) {
        ...
        else if (caller2 == SkSyoruitoutyakuOperateProcessTest_operateProcessForMultipleBranch.class) {
            GetProcessSummaryOutBean getProcessSummaryOutBean = new GetProcessSummaryOutBean();
            getProcessSummaryOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return getProcessSummaryOutBean;

        }
        else if (caller2 == SkProcessCreateTest_exec.class) {
            GetProcessSummaryOutBean getProcessSummaryOutBean = new GetProcessSummaryOutBean();
            getProcessSummaryOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return getProcessSummaryOutBean;
    ...
    public LockProcessOutBean execLockProcess(LockProcessInBean inBean) {
        ...
        if ("Test".equals(caller)) {
            ...
            LockProcessOutBean response = new LockProcessOutBean();
            response.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return response;
    ...
    public ProcessUpdateOutBean execProcessUpdate(ProcessUpdateInBean inBean) {
        ...
        else if (caller2 == BzProcessUpdateTest_exec.class) {
            ProcessUpdateOutBean response = new ProcessUpdateOutBean();
            if (mode == "1") {
                response.setKekkastatus("0");
                response.setSyousaimsgcd("IWF0000");
                ...
                response.setKekkastatus("syorikekkakbn");
                ...
                response.setKekkastatus("syorikekkakbn");
                response.setSyousaimsgcd("IWF2021");
            }
            else if (mode == "6") {
                response.setKekkastatus("syorikekkakbn");
                response.setSyousaimsgcd("IWF2022");
            }
            else if (mode == "7") {
                response.setKekkastatus("syorikekkakbn");
                response.setSyousaimsgcd("IWF2023");
            }
            else if (mode == "8") {
                response.setKekkastatus("syorikekkakbn");
                response.setSyousaimsgcd("IWF2024");
            }
            else if (mode == "9") {
                response.setKekkastatus("syorikekkakbn");
                response.setSyousaimsgcd("IWF2025");
            }
            else if (mode == "10") {
                if (inBean.getGyoumukey() == "0001") {
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IWF0000");
                } else {
                    response.setKekkastatus("syorikekkakbn");
        ...
        else if (caller2 == SkProcessUpdateTest_exec_1.class) {
            ProcessUpdateOutBean processUpdateOutBean = new ProcessUpdateOutBean();
            processUpdateOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return processUpdateOutBean;
        }
        else if (caller2 == SkProcessUpdateTest_exec_2.class) {
            ProcessUpdateOutBean processUpdateOutBean = new ProcessUpdateOutBean();
            processUpdateOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return processUpdateOutBean;
        }
    ...
    public UnlockProcessOutBean execUnlockProcess(UnlockProcessInBean inBean) {
        if ("Test".equals(caller)) {
            ...
            UnlockProcessOutBean unlockProcessOutBean = new UnlockProcessOutBean();
            unlockProcessOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return unlockProcessOutBean;
        }
        else if (caller2 == SkProcessUpdateTest_exec_2.class) {
            UnlockProcessOutBean unlockProcessOutBean = new UnlockProcessOutBean();
            unlockProcessOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
    ...
    public GetExecutableTasksOutBean execGetExecutableTasks(GetExecutableTasksInBean inBean) {
        ...
        if (caller2 == BzGetExecutableTasksTest_exec.class) {

            switch (mode) {

                case "1":
                    response.setKekkastatus("9");
                    response.setSyousaimsgcd("IWF2070");
                    response.setSyousaimsg("権限IDが取得できませんでした。");
                    List<ExecutableTaskInfoBean> list1 = new ArrayList<ExecutableTaskInfoBean>();
                    response.setExecutableTaskInfos(list1);
                    break;
                case "2":
                    response.setKekkastatus("9");
                    response.setSyousaimsgcd("EAF1004");
                    response.setSyousaimsg("指定データ異常が発生しました。");
                    ExecutableTaskInfoBean executableTaskInfoBean2 = new ExecutableTaskInfoBean();
                    executableTaskInfoBean2.setFlowId("98765431");
                    executableTaskInfoBean2.setNodeName("3234212");
                    List<ExecutableTaskInfoBean> list2 = new ArrayList<ExecutableTaskInfoBean>();
                    list2.add(executableTaskInfoBean2);
                    response.setExecutableTaskInfos(list2);
                    break;
                case "3":
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IAC0009");
                    response.setSyousaimsg("処理が完了しました。");
                    ExecutableTaskInfoBean executableTaskInfoBean3 = new ExecutableTaskInfoBean();
                    executableTaskInfoBean3.setFlowId("98765432");
                    executableTaskInfoBean3.setNodeName("3234213");
                    List<ExecutableTaskInfoBean> list3 = new ArrayList<ExecutableTaskInfoBean>();
                    list3.add(executableTaskInfoBean3);
                    response.setExecutableTaskInfos(list3);
                    break;
                case "4":
                    response.setKekkastatus("0");
                    response.setSyousaimsgcd("IAC0009");
                    response.setSyousaimsg("処理が完了しました。");
                    ExecutableTaskInfoBean executableTaskInfoBean4 = new ExecutableTaskInfoBean();
                    executableTaskInfoBean4.setFlowId("98765433");
                    executableTaskInfoBean4.setNodeName("3234214");
                    ExecutableTaskInfoBean executableTaskInfoBean5 = new ExecutableTaskInfoBean();
                    executableTaskInfoBean5.setFlowId("98765434");
                    executableTaskInfoBean5.setNodeName("3234215");
                    List<ExecutableTaskInfoBean> list4 = new ArrayList<ExecutableTaskInfoBean>();
                    list4.add(executableTaskInfoBean4);
                    list4.add(executableTaskInfoBean5);
                    response.setExecutableTaskInfos(list4);
                    break;
            }
        }
        return response;
    ...
    public ProcessForwardOutBean execProcessForward(ProcessForwardInBean inBean, Object... contditions) {
        ...
        if ("Test".equals(caller)) {
            ...
            ProcessForwardOutBean processForwardOutBean = new ProcessForwardOutBean();
            processForwardOutBean.setKekkastatus(BzIwfUtilConstants.API_RESULTCD_OK);
            return processForwardOutBean;
