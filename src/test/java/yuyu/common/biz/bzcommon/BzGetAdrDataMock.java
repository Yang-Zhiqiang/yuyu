...
/**
 * {@link BzGetAdrData}のモッククラスです。<br />
 */
public class BzGetAdrDataMock extends BzGetAdrData{
    ...
    public void execTodouhukenCdByPostalcd(String pPostalCd) {
        ...
        if (caller == EditKaiyakuTblUpdateTest_exec.class && TESTPATTERN1.equals(SYORIPTN)) {
            return;
        }
