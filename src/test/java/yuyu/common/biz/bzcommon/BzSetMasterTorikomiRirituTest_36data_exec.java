...
public class BzSetMasterTorikomiRirituTest_36data_exec {
    ...
    public void testExce_A1() {
        ...
        exDateEquals(yoteiRiritu.getKijyunfromymd(),BizDate.valueOf(20190101),"基準日自");
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0380),"予定利率");
        ...
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0275),"予定利率");
        exBizCalcbleEquals(yoteiRiritu.getTumitateriritu(),BizNumber.valueOf(0.0000),"積立利率");
        exBizCalcbleEquals(yoteiRiritu.getTmttknzoukaritujygn(),BizNumber.valueOf(0.0000),"積立金増加率上限");
        exBizCalcbleEquals(yoteiRiritu.getSetteibairitu(),BizNumber.valueOf(0.00),"設定倍率");
        ...
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0345),"予定利率");
        exBizCalcbleEquals(yoteiRiritu.getTumitateriritu(),BizNumber.valueOf(0.0245),"積立利率");
        exBizCalcbleEquals(yoteiRiritu.getTmttknzoukaritujygn(),BizNumber.valueOf(0.1080),"積立金増加率上限");
        exBizCalcbleEquals(yoteiRiritu.getSetteibairitu(),BizNumber.valueOf(1.08),"設定倍率");
        ...
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0385),"予定利率");
        exBizCalcbleEquals(yoteiRiritu.getTumitateriritu(),BizNumber.valueOf(0.0285),"積立利率");
        exBizCalcbleEquals(yoteiRiritu.getTmttknzoukaritujygn(),BizNumber.valueOf(0.1250),"積立金増加率上限");
        exBizCalcbleEquals(yoteiRiritu.getSetteibairitu(),BizNumber.valueOf(1.25),"設定倍率");
        ...
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.AUD,"通貨種類");
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0250),"予定利率");
        exBizCalcbleEquals(yoteiRiritu.getTumitateriritu(),BizNumber.valueOf(0.0150),"積立利率");
        exBizCalcbleEquals(yoteiRiritu.getTmttknzoukaritujygn(),BizNumber.valueOf(0.0360),"積立金増加率上限");
        ...
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.AUD,"通貨種類");
        exBizCalcbleEquals(yoteiRiritu.getYoteiriritu(),BizNumber.valueOf(0.0290),"予定利率");
        exBizCalcbleEquals(yoteiRiritu.getTumitateriritu(),BizNumber.valueOf(0.0190),"積立利率");
        exBizCalcbleEquals(yoteiRiritu.getTmttknzoukaritujygn(),BizNumber.valueOf(0.0535),"積立金増加率上限");
        exBizCalcbleEquals(yoteiRiritu.getSetteibairitu(),BizNumber.valueOf(1.00),"設定倍率");
        ...
        yoteiRiritu = bzSetMasterTorikomiRirituBean.getYoteiRirituList().get(24);

        exStringEquals(yoteiRiritu.getSyouhncd(),"ﾕﾁ","商品コード");
        exStringEquals(yoteiRiritu.getYoteiriritutkybr1(),"","予定利率適用分類１");
        exStringEquals(yoteiRiritu.getYoteiriritutkybr2(),"","予定利率適用分類２");
        exDateEquals(yoteiRiritu.getKijyunfromymd(),BizDate.valueOf(20190501),"基準日自");
        exDateEquals(yoteiRiritu.getKijyuntoymd(),BizDate.valueOf(20190501),"基準日至");
        exClassificationEquals(yoteiRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        ...
        yoteiRiritu = bzSetMasterTorikomiRirituBean.getYoteiRirituList().get(25);
        ...
        yoteiRiritu = bzSetMasterTorikomiRirituBean.getYoteiRirituList().get(26);
        ...
        yoteiRiritu = bzSetMasterTorikomiRirituBean.getYoteiRirituList().get(27);
    ...
    public void testExce_A2() {
        ...
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyunfromymd(),BizDate.valueOf(20190101),"基準日自");
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(sjkkkTyouseiyouRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0436),"市場価格調整用利率");
        ...
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0295),"市場価格調整用利率");
        ...
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(sjkkkTyouseiyouRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0393),"市場価格調整用利率");
        ...
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(sjkkkTyouseiyouRiritu.getTuukasyu(),C_Tuukasyu.USD,"通貨種類");
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0438),"市場価格調整用利率");
        ...
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(sjkkkTyouseiyouRiritu.getTuukasyu(),C_Tuukasyu.AUD,"通貨種類");
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0264),"市場価格調整用利率");
        ...
        exDateEquals(sjkkkTyouseiyouRiritu.getKijyuntoymd(),BizDate.valueOf(20190115),"基準日至");
        exClassificationEquals(sjkkkTyouseiyouRiritu.getTuukasyu(),C_Tuukasyu.AUD,"通貨種類");
        exBizCalcbleEquals(sjkkkTyouseiyouRiritu.getSjkkktyouseiyouriritu(),BizNumber.valueOf(0.0315),"市場価格調整用利率");
