...
/**
 * 市場価格調整用利率取得クラスのメソッド {@link GetSjkkktyouseiyouriritu#exec(GetSjkkktyouseiyourirituBean)} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class GetSjkkktyouseiyourirituTest_exec extends AbstractTest {
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(GetSjkkktyouseiyourirituTest_exec.class, fileName, sheetName);
    ...
    public void testExec_A1() {
        ...
        C_ErrorKbn errorKbn = getSjkkktyouseiyouriritu.exec(bean);
