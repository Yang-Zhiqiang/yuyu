...
/**
 * {@link CheckKouzaNo}のモッククラスです。<br />
 */
public class CheckKouzaNoMockForKhansyuu extends CheckKouzaNo {
    ...
    public boolean isCheckOK(String pKouzaNo, C_Tuukasyu pTuukasyu) {
        ...
        if (CheckKzhuriKouzaTest_execA1.class == caller) {
        ...
        if (CheckKzhuriKouzaTest_execA2.class == caller) {
