...
public class SaibanBizTest_getHenkouSikibetukey_A1 {
    private String SHO_NO = "12345";

    @Test
    public void testHenkouSikibetukey_A1() {
    ...
    public void testHenkouSikibetukey_C1() {
        try{
            SaibanBiz.getHenkouSikibetukey("");
    ...
    @Test(expected = BizAppException.class)
    public void testHenkouSikibetukey_C2() {
        try{
            SaibanBiz.getHenkouSikibetukey(null);
        }catch(BizAppException e){
            exStringEquals(e.getMessage(), "引数が不正です。", "証券番号");
            throw e;
        }
