 ...
 */
public class KeisanTienrisokuMock extends KeisanTienrisoku {
    ...
    public KeisanTienrisokuBean exec(BizDate pSyoruiUkeYmd, BizDate pHubiKanryouYmd, BizDate pTyakkinYmd,
        ...
        if (caller == KeisanTienRisokuTest_exec.class && TESTPATTERN1.equals(SYORIPTN)) {
            ...
            keisanTienrisokuBean.setShrtienrsk(BizCurrency.valueOf(100,BizCurrencyTypes.YEN));
            keisanTienrisokuBean.setShrtienrskStartYmd(BizDate.valueOf(20160329));
            keisanTienrisokuBean.setShrtienrskEndYmd(BizDate.valueOf(20160401));
            keisanTienrisokuBean.setShrtienNissuu(10);
