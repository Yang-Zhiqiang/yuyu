 ...
 */
public class BizPropertyInitializerTestEntity extends GenBizPropertyInitializerTestEntity {
    private static final long serialVersionUID = 1L;

    public BizPropertyInitializerTestEntity() {
    }
    ...
    public ExDBPrimaryKey getPrimaryKey() {
        return null;
    }
