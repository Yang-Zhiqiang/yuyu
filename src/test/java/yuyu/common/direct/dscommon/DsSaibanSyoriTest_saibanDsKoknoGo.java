...
public class DsSaibanSyoriTest_saibanDsKoknoGo {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsSaibanSyoriTest_saibanDsKoknoGo.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void testSaibanDsKoknoGo_A1() {

        String result =  dsSaibanSyori.saibanDsKokno();

        exStringEquals(result, "8000037431", "ＤＳ顧客番号");
