...
/**
 * ＤＳ目標額変更共通チェッククラスのメソッド {@link CheckDsMkhgkHenkou#chkMkhgkHnkUktkDataUpd(String pSyono, Integer pHnkgoMkhgkWari)}テスト用クラスです<br />
 */
@RunWith(OrderedRunner.class)
public class CheckDsMkhgkHenkouTest_chkMkhgkHnkUktkDataUpd extends AbstractTest {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(CheckDsMkhgkHenkouTest_chkMkhgkHnkUktkDataUpd.class, fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void testChkMkhgkHnkUktkDataUpd_A1() {
        ...
        C_ErrorKbn errorKbn = checkDsMkhgkHenkou.chkMkhgkHnkUktkDataUpd(syono, hnkgoMkhgkWari);
    ...
    @Test
    @TestOrder(20)
    public void testChkMkhgkHnkUktkDataUpd_A2() {
    ...
    @Test
    @TestOrder(30)
    public void testChkMkhgkHnkUktkDataUpd_A3() {
    ...
    @Test
    @TestOrder(40)
    public void testChkMkhgkHnkUktkDataUpd_A4() {
    ...
    @Test
    @TestOrder(50)
    public void testChkMkhgkHnkUktkDataUpd_A5() {
    ...
    @Test
    @TestOrder(60)
    public void testChkMkhgkHnkUktkDataUpd_A6() {
    ...
    @Test
    @TestOrder(70)
    public void testChkMkhgkHnkUktkDataUpd_A7() {
    ...
    @Test
    @TestOrder(80)
    public void testChkMkhgkHnkUktkDataUpd_A8() {
    ...
    @Test
    @TestOrder(90)
    public void testChkMkhgkHnkUktkDataUpd_A9() {
    ...
    @Test
    @TestOrder(100)
    public void testChkMkhgkHnkUktkDataUpd_A10() {
        ...
        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
        exClassificationEquals(checkDsMkhgkHenkou.getCheckDsMkhgkHenkouKekkaKbn(),
            C_CheckDsMkhgkHenkouKekkaKbn.MKHGKHNKKANOUKIKANGAI, "ＤＳ目標額変更共通チェック結果区分");
        exClassificationEquals(checkDsMkhgkHenkou.getMkhgkHenkoukykKahiKbn(),
            C_KahiKbn.KA, "目標額変更契約表示可否区分");
    }
    ...
    @Test
    @TestOrder(110)
    public void testChkMkhgkHnkUktkDataUpd_A11() {
        ...
        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
        exClassificationEquals(checkDsMkhgkHenkou.getCheckDsMkhgkHenkouKekkaKbn(),
            C_CheckDsMkhgkHenkouKekkaKbn.HOZENYUUKOUJYOUTAI, "ＤＳ目標額変更共通チェック結果区分");
        exClassificationEquals(checkDsMkhgkHenkou.getMkhgkHenkoukykKahiKbn(),
            C_KahiKbn.KA, "目標額変更契約表示可否区分");
    }
    ...
    @Test
    @TestOrder(120)
    public void testChkMkhgkHnkUktkDataUpd_A12() {
        ...
        exClassificationEquals(errorKbn, C_ErrorKbn.ERROR, "エラー区分");
        exClassificationEquals(checkDsMkhgkHenkou.getCheckDsMkhgkHenkouKekkaKbn(),
            C_CheckDsMkhgkHenkouKekkaKbn.TETUDUKITYUUI, "ＤＳ目標額変更共通チェック結果区分");
        exClassificationEquals(checkDsMkhgkHenkou.getMkhgkHenkoukykKahiKbn(),
            C_KahiKbn.KA, "目標額変更契約表示可否区分");
    }
    ...
    @Test
    @TestOrder(130)
    public void testChkMkhgkHnkUktkDataUpd_A13() {
