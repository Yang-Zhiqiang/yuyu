...
public class DsSaibanSyoriTest_saibanDsKoknoNana {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsSaibanSyoriTest_saibanDsKoknoNana.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void DsSaibanSyoriTest_saibanDsKoknoNana_A1() {

        String result = dsSaibanSyori.saibanDsKokno();

        exStringEquals(result, "8000156505", "ＤＳ顧客番号");
