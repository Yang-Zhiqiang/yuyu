...
public class DsSaibanSyoriTest_saibanDsKoknoHati {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsSaibanSyoriTest_saibanDsKoknoHati.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void DsSaibanSyoriTest_saibanDsKoknoHati_A1() {

        String result = dsSaibanSyori.saibanDsKokno();

        exStringEquals(result, "8000042570", "ＤＳ顧客番号");
