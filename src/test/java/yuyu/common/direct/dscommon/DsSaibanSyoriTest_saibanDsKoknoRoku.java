...
public class DsSaibanSyoriTest_saibanDsKoknoRoku {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsSaibanSyoriTest_saibanDsKoknoRoku.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void DsSaibanSyoriTest_saibanDsKoknoRoku_A1() {

        String result = dsSaibanSyori.saibanDsKokno();

        exStringEquals(result, "8000003755", "ＤＳ顧客番号");
