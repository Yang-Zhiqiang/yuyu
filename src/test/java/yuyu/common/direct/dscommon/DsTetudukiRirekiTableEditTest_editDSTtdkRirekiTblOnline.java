...
/**
 * ＤＳ手続履歴テーブル編集クラスのメソッド {@link DsTetudukiRirekiTableEdit#editDSTtdkRirekiTblOnline()} テスト用クラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblOnline {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblOnline.class,
                fileName, sheetName);
            testDataMaker.insDataByDataId("準備データ２", testDataAndTblMap);
    ...
    @Transactional
    @TestOrder(10)
    public void testEditDSTtdkRirekiTblOnline_A1() {
        ...
        try{
            editDSTtdkRirekiTbl.editDSTtdkRirekiTblOnline(dsTetudukiRirekiTableEditParam);
        }
    ...
    @Transactional
    @TestOrder(20)
    public void testEditDSTtdkRirekiTblOnline_A2() {
        ...
        exStringEquals(dsTtdkRireki.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "ＤＳ手続履歴テーブルエンティティ．業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki1.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki3.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki4.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki5.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
    ...
    @Transactional
    @TestOrder(30)
    public void testEditDSTtdkRirekiTblOnline_A3() {
        ...
        List<MT_DsHenkouRireki> dsHenkouRirekiLst = dsTtdkRireki.getDsHenkouRirekis();
        exNumericEquals(dsHenkouRirekiLst.size(), 40, "ＤＳ変更履歴情報件数");
        ...
        exStringEquals(dsHenkouRireki6.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki7.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki8.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki9.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki10.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki11.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki12.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki13.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exClassificationEquals(dsHenkouRireki14.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki14.getHanbetukoumokunm(), "ＤＳ顧客契約情報　証券番号：17806000024", "判別項目名");
        exStringEquals(dsHenkouRireki14.getHenkoukoumokuid(), "pplessrenjidssymenttdkhyj", "変更項目ID");
        exStringEquals(dsHenkouRireki14.getHenkoukoumokunm(), "ペーパーレス連動時ＤＳ書面手続表示", "変更項目名");
        exStringEquals(dsHenkouRireki14.getBfrnaiyouoriginal(), "0", "変更前内容原本");
        exStringEquals(dsHenkouRireki14.getBfrnaiyou(), "未設定", "変更前内容");
        exStringEquals(dsHenkouRireki14.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki14.getNewnaiyou(), "書面手続き", "変更後内容");
        exStringEquals(dsHenkouRireki14.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exClassificationEquals(dsHenkouRireki15.getHnksyuruikbn(), C_HnkSyuruiKbn.SAKUJYO, "変更種類区分");
        exStringEquals(dsHenkouRireki15.getHanbetukoumokunm(), "ＤＳ顧客契約情報　証券番号：17806000035", "判別項目名");
        ...
        exStringEquals(dsHenkouRireki15.getBfrnaiyou(), "証券番号：17806000035", "変更前内容");
        exStringEquals(dsHenkouRireki15.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki15.getNewnaiyou(), "", "変更後内容");
        exStringEquals(dsHenkouRireki15.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki16.getTablenm(), "ＤＳ顧客契約テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki16.getTableid(), "MT_DsKokyakuKeiyaku", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki16.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki16.getHanbetukoumokunm(), "ＤＳ顧客契約情報　証券番号：17806000046", "判別項目名");
        exStringEquals(dsHenkouRireki16.getHenkoukoumokuid(), "syono", "変更項目ID");
        exStringEquals(dsHenkouRireki16.getHenkoukoumokunm(), "証券番号", "変更項目名");
        ...
        exStringEquals(dsHenkouRireki16.getNewnaiyou(), "証券番号：17806000046", "変更後内容");
        exStringEquals(dsHenkouRireki16.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki17.getHenkoukoumokuid(), "dskrhnnkakcd", "変更項目ID");
        exStringEquals(dsHenkouRireki17.getHenkoukoumokunm(), "ＤＳ仮本人確認コード", "変更項目名");
        exStringEquals(dsHenkouRireki17.getBfrnaiyouoriginal(), "***", "変更前内容原本");
        exStringEquals(dsHenkouRireki17.getBfrnaiyou(), "***", "変更前内容");
        exStringEquals(dsHenkouRireki17.getNewnaiyouoriginal(), "***", "変更後内容原本");
        exStringEquals(dsHenkouRireki17.getNewnaiyou(), "***", "変更後内容");
        exStringEquals(dsHenkouRireki17.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki18.getHenkoukoumokuid(), "dskrhnnkakcdsetkbn", "変更項目ID");
        exStringEquals(dsHenkouRireki18.getHenkoukoumokunm(), "ＤＳ仮本人確認コード設定区分", "変更項目名");
        exStringEquals(dsHenkouRireki18.getBfrnaiyouoriginal(), "1", "変更前内容原本");
        exStringEquals(dsHenkouRireki18.getBfrnaiyou(), "ＤＳ新規登録時", "変更前内容");
        exStringEquals(dsHenkouRireki18.getNewnaiyouoriginal(), "2", "変更後内容原本");
        exStringEquals(dsHenkouRireki18.getNewnaiyou(), "仮パスワードの再発行時", "変更後内容");
        exStringEquals(dsHenkouRireki18.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki19.getHenkoukoumokuid(), "dskrhnnkakcdsetymd", "変更項目ID");
        exStringEquals(dsHenkouRireki19.getHenkoukoumokunm(), "ＤＳ仮本人確認コード設定年月日", "変更項目名");
        exStringEquals(dsHenkouRireki19.getBfrnaiyouoriginal(), "20160301", "変更前内容原本");
        exStringEquals(dsHenkouRireki19.getBfrnaiyou(), "20160301", "変更前内容");
        exStringEquals(dsHenkouRireki19.getNewnaiyouoriginal(), "20160316", "変更後内容原本");
        exStringEquals(dsHenkouRireki19.getNewnaiyou(), "20160316", "変更後内容");
        exStringEquals(dsHenkouRireki19.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki20.getHenkoukoumokuid(), "dskrhnnkakcdyuukouymd", "変更項目ID");
        exStringEquals(dsHenkouRireki20.getHenkoukoumokunm(), "ＤＳ仮本人確認コード有効年月日", "変更項目名");
        exStringEquals(dsHenkouRireki20.getBfrnaiyouoriginal(), "20160501", "変更前内容原本");
        exStringEquals(dsHenkouRireki20.getBfrnaiyou(), "20160501", "変更前内容");
        exStringEquals(dsHenkouRireki20.getNewnaiyouoriginal(), "20160517", "変更後内容原本");
        exStringEquals(dsHenkouRireki20.getNewnaiyou(), "20160517", "変更後内容");
        exStringEquals(dsHenkouRireki20.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki21.getHenkoukoumokuid(), "dshnnkakcd", "変更項目ID");
        exStringEquals(dsHenkouRireki21.getHenkoukoumokunm(), "ＤＳ本人確認コード", "変更項目名");
        exStringEquals(dsHenkouRireki21.getBfrnaiyouoriginal(), "***", "変更前内容原本");
        exStringEquals(dsHenkouRireki21.getBfrnaiyou(), "***", "変更前内容");
        exStringEquals(dsHenkouRireki21.getNewnaiyouoriginal(), "***", "変更後内容原本");
        exStringEquals(dsHenkouRireki21.getNewnaiyou(), "***", "変更後内容");
        exStringEquals(dsHenkouRireki21.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki22.getHenkoukoumokuid(), "dshnnkakcdsetymd", "変更項目ID");
        exStringEquals(dsHenkouRireki22.getHenkoukoumokunm(), "ＤＳ本人確認コード設定年月日", "変更項目名");
        exStringEquals(dsHenkouRireki22.getBfrnaiyouoriginal(), "20160419", "変更前内容原本");
        exStringEquals(dsHenkouRireki22.getBfrnaiyou(), "20160419", "変更前内容");
        exStringEquals(dsHenkouRireki22.getNewnaiyouoriginal(), "20160420", "変更後内容原本");
        exStringEquals(dsHenkouRireki22.getNewnaiyou(), "20160420", "変更後内容");
        exStringEquals(dsHenkouRireki22.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki23.getTablenm(), "ＤＳ本人確認コードテーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki23.getTableid(), "MT_DsHonninKakuninCd", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki23.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki23.getHanbetukoumokunm(), "ＤＳ本人確認コード情報", "判別項目名");
        exStringEquals(dsHenkouRireki23.getHenkoukoumokuid(), "zenkaidskrhnnkakcd", "変更項目ID");
        exStringEquals(dsHenkouRireki23.getHenkoukoumokunm(), "前回ＤＳ仮本人確認コード", "変更項目名");
        exStringEquals(dsHenkouRireki23.getBfrnaiyouoriginal(), "***", "変更前内容原本");
        exStringEquals(dsHenkouRireki23.getBfrnaiyou(), "***", "変更前内容");
        exStringEquals(dsHenkouRireki23.getNewnaiyouoriginal(), "***", "変更後内容原本");
        exStringEquals(dsHenkouRireki23.getNewnaiyou(), "***", "変更後内容");
        exStringEquals(dsHenkouRireki23.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki24.getHenkoukoumokuid(), "syokailoginymd", "変更項目ID");
        exStringEquals(dsHenkouRireki24.getHenkoukoumokunm(), "初回ログイン年月日", "変更項目名");
        exStringEquals(dsHenkouRireki24.getBfrnaiyouoriginal(), "20150418", "変更前内容原本");
        exStringEquals(dsHenkouRireki24.getBfrnaiyou(), "20150418", "変更前内容");
        exStringEquals(dsHenkouRireki24.getNewnaiyouoriginal(), "20150518", "変更後内容原本");
        exStringEquals(dsHenkouRireki24.getNewnaiyou(), "20150518", "変更後内容");
        exStringEquals(dsHenkouRireki24.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki25.getHenkoukoumokuid(), "syokailogintime", "変更項目ID");
        exStringEquals(dsHenkouRireki25.getHenkoukoumokunm(), "初回ログイン時刻", "変更項目名");
        exStringEquals(dsHenkouRireki25.getBfrnaiyouoriginal(), "082514", "変更前内容原本");
        exStringEquals(dsHenkouRireki25.getBfrnaiyou(), "082514", "変更前内容");
        exStringEquals(dsHenkouRireki25.getNewnaiyouoriginal(), "093420", "変更後内容原本");
        exStringEquals(dsHenkouRireki25.getNewnaiyou(), "093420", "変更後内容");
        exStringEquals(dsHenkouRireki25.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki26.getHenkoukoumokuid(), "syokailoginbaitaikbn", "変更項目ID");
        exStringEquals(dsHenkouRireki26.getHenkoukoumokunm(), "初回ログイン媒体区分", "変更項目名");
        exStringEquals(dsHenkouRireki26.getBfrnaiyouoriginal(), "0", "変更前内容原本");
        exStringEquals(dsHenkouRireki26.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki26.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki26.getNewnaiyou(), "ＰＣ", "変更後内容");
        exStringEquals(dsHenkouRireki26.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki27.getHenkoukoumokuid(), "saisinloginymd", "変更項目ID");
        exStringEquals(dsHenkouRireki27.getHenkoukoumokunm(), "最新ログイン年月日", "変更項目名");
        exStringEquals(dsHenkouRireki27.getBfrnaiyouoriginal(), "20160415", "変更前内容原本");
        exStringEquals(dsHenkouRireki27.getBfrnaiyou(), "20160415", "変更前内容");
        exStringEquals(dsHenkouRireki27.getNewnaiyouoriginal(), "20160427", "変更後内容原本");
        exStringEquals(dsHenkouRireki27.getNewnaiyou(), "20160427", "変更後内容");
        exStringEquals(dsHenkouRireki27.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki28.getHenkoukoumokuid(), "saisinlogintime", "変更項目ID");
        exStringEquals(dsHenkouRireki28.getHenkoukoumokunm(), "最新ログイン時刻", "変更項目名");
        exStringEquals(dsHenkouRireki28.getBfrnaiyouoriginal(), "124517", "変更前内容原本");
        exStringEquals(dsHenkouRireki28.getBfrnaiyou(), "124517", "変更前内容");
        exStringEquals(dsHenkouRireki28.getNewnaiyouoriginal(), "142836", "変更後内容原本");
        exStringEquals(dsHenkouRireki28.getNewnaiyou(), "142836", "変更後内容");
        exStringEquals(dsHenkouRireki28.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki29.getHenkoukoumokuid(), "saisinloginbaitaikbn", "変更項目ID");
        exStringEquals(dsHenkouRireki29.getHenkoukoumokunm(), "最新ログイン媒体区分", "変更項目名");
        exStringEquals(dsHenkouRireki29.getBfrnaiyouoriginal(), "0", "変更前内容原本");
        exStringEquals(dsHenkouRireki29.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki29.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki29.getNewnaiyou(), "ＰＣ", "変更後内容");
        exStringEquals(dsHenkouRireki29.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki30.getHenkoukoumokuid(), "dshnnkakcderrorkaisuu", "変更項目ID");
        exStringEquals(dsHenkouRireki30.getHenkoukoumokunm(), "ＤＳ本人確認コードエラー回数", "変更項目名");
        exStringEquals(dsHenkouRireki30.getBfrnaiyouoriginal(), "1", "変更前内容原本");
        exStringEquals(dsHenkouRireki30.getBfrnaiyou(), "1", "変更前内容");
        exStringEquals(dsHenkouRireki30.getNewnaiyouoriginal(), "2", "変更後内容原本");
        exStringEquals(dsHenkouRireki30.getNewnaiyou(), "2", "変更後内容");
        exStringEquals(dsHenkouRireki30.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki31.getHenkoukoumokuid(), "dskokyakunmerrorkaisuu", "変更項目ID");
        exStringEquals(dsHenkouRireki31.getHenkoukoumokunm(), "ＤＳ顧客名エラー回数", "変更項目名");
        exStringEquals(dsHenkouRireki31.getBfrnaiyouoriginal(), "3", "変更前内容原本");
        exStringEquals(dsHenkouRireki31.getBfrnaiyou(), "3", "変更前内容");
        exStringEquals(dsHenkouRireki31.getNewnaiyouoriginal(), "4", "変更後内容原本");
        exStringEquals(dsHenkouRireki31.getNewnaiyou(), "4", "変更後内容");
        exStringEquals(dsHenkouRireki31.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki32.getHenkoukoumokuid(), "dskokyakuseiymderrorkaisuu", "変更項目ID");
        exStringEquals(dsHenkouRireki32.getHenkoukoumokunm(), "ＤＳ顧客生年月日エラー回数", "変更項目名");
        exStringEquals(dsHenkouRireki32.getBfrnaiyouoriginal(), "5", "変更前内容原本");
        exStringEquals(dsHenkouRireki32.getBfrnaiyou(), "5", "変更前内容");
        exStringEquals(dsHenkouRireki32.getNewnaiyouoriginal(), "6", "変更後内容原本");
        exStringEquals(dsHenkouRireki32.getNewnaiyou(), "6", "変更後内容");
        exStringEquals(dsHenkouRireki32.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki33.getTablenm(), "ＤＳログイン管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki33.getTableid(), "MT_DsLoginKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki33.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki33.getHanbetukoumokunm(), "ＤＳログイン管理情報", "判別項目名");
        exStringEquals(dsHenkouRireki33.getHenkoukoumokuid(), "dskokyakutelnoerrorkaisuu", "変更項目ID");
        exStringEquals(dsHenkouRireki33.getHenkoukoumokunm(), "ＤＳ顧客電話番号エラー回数", "変更項目名");
        exStringEquals(dsHenkouRireki33.getBfrnaiyouoriginal(), "7", "変更前内容原本");
        exStringEquals(dsHenkouRireki33.getBfrnaiyou(), "7", "変更前内容");
        exStringEquals(dsHenkouRireki33.getNewnaiyouoriginal(), "8", "変更後内容原本");
        exStringEquals(dsHenkouRireki33.getNewnaiyou(), "8", "変更後内容");
        exStringEquals(dsHenkouRireki33.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki34.getHenkoukoumokuid(), "dsmailtourokujyoutaikbn", "変更項目ID");
        exStringEquals(dsHenkouRireki34.getHenkoukoumokunm(), "ＤＳメール登録状態区分", "変更項目名");
        exStringEquals(dsHenkouRireki34.getBfrnaiyouoriginal(), "2", "変更前内容原本");
        exStringEquals(dsHenkouRireki34.getBfrnaiyou(), "削除", "変更前内容");
        exStringEquals(dsHenkouRireki34.getNewnaiyouoriginal(), "0", "変更後内容原本");
        exStringEquals(dsHenkouRireki34.getNewnaiyou(), "未登録", "変更後内容");
        exStringEquals(dsHenkouRireki34.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki35.getHenkoukoumokuid(), "dsmailaddress", "変更項目ID");
        exStringEquals(dsHenkouRireki35.getHenkoukoumokunm(), "ＤＳメールアドレス", "変更項目名");
        exStringEquals(dsHenkouRireki35.getBfrnaiyouoriginal(), "def@co.jp", "変更前内容原本");
        exStringEquals(dsHenkouRireki35.getBfrnaiyou(), "def@co.jp", "変更前内容");
        exStringEquals(dsHenkouRireki35.getNewnaiyouoriginal(), "abc@co.jp", "変更後内容原本");
        exStringEquals(dsHenkouRireki35.getNewnaiyou(), "abc@co.jp", "変更後内容");
        exStringEquals(dsHenkouRireki35.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki36.getHenkoukoumokuid(), "dsmailsousinjyoutaikbn", "変更項目ID");
        exStringEquals(dsHenkouRireki36.getHenkoukoumokunm(), "ＤＳメール送信状態区分", "変更項目名");
        exStringEquals(dsHenkouRireki36.getBfrnaiyouoriginal(), "2", "変更前内容原本");
        exStringEquals(dsHenkouRireki36.getBfrnaiyou(), "停止", "変更前内容");
        exStringEquals(dsHenkouRireki36.getNewnaiyouoriginal(), "0", "変更後内容原本");
        exStringEquals(dsHenkouRireki36.getNewnaiyou(), "", "変更後内容");
        exStringEquals(dsHenkouRireki36.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki37.getHenkoukoumokuid(), "dsmailsousintisrykbn", "変更項目ID");
        exStringEquals(dsHenkouRireki37.getHenkoukoumokunm(), "ＤＳメール送信停止理由区分", "変更項目名");
        exStringEquals(dsHenkouRireki37.getBfrnaiyouoriginal(), "0", "変更前内容原本");
        exStringEquals(dsHenkouRireki37.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki37.getNewnaiyouoriginal(), "3", "変更後内容原本");
        exStringEquals(dsHenkouRireki37.getNewnaiyou(), "顧客消滅", "変更後内容");
        exStringEquals(dsHenkouRireki37.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        ...
        exStringEquals(dsHenkouRireki38.getHenkoukoumokuid(), "dstourokuymdtime", "変更項目ID");
        exStringEquals(dsHenkouRireki38.getHenkoukoumokunm(), "ＤＳ登録日時", "変更項目名");
        ...
        exStringEquals(dsHenkouRireki38.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki38.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki39 = dsHenkouRirekiLst.get(38);
        exStringEquals(dsHenkouRireki39.getDskokno(), "1000000002", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki39.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki39.getRenno(), 39, "連番");
        exStringEquals(dsHenkouRireki39.getTablenm(), "ＤＳメールアドレステーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki39.getTableid(), "MT_DsMailAddress", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki39.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki39.getHanbetukoumokunm(), "ＤＳメールアドレス情報　ＤＳメールアドレス連番：100000002", "判別項目名");
        exStringEquals(dsHenkouRireki39.getHenkoukoumokuid(), "dskousinymdtime", "変更項目ID");
        exStringEquals(dsHenkouRireki39.getHenkoukoumokunm(), "ＤＳ更新日時", "変更項目名");
        exStringEquals(dsHenkouRireki39.getBfrnaiyouoriginal(), "20161013", "変更前内容原本");
        exStringEquals(dsHenkouRireki39.getBfrnaiyou(), "20161013", "変更前内容");
        exStringEquals(dsHenkouRireki39.getNewnaiyouoriginal(), "20161012", "変更後内容原本");
        exStringEquals(dsHenkouRireki39.getNewnaiyou(), "20161012", "変更後内容");
        exStringEquals(dsHenkouRireki39.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki39.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
    }

    @Test
    @Transactional
    @TestOrder(40)
    public void testEditDSTtdkRirekiTblOnline_A4() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000003");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000003");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000003", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000003", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
        exClassificationEquals(dsTtdkRireki.getHenkourrkumu(), C_UmuKbn.ARI, "ＤＳ手続履歴テーブルエンティティ．変更履歴有無");
        exStringEquals(dsTtdkRireki.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "ＤＳ手続履歴テーブルエンティティ．業務用更新機能ＩＤ");
        ...
        List<MT_DsHenkouRireki> dsHenkouRirekiLst = dsTtdkRireki.getDsHenkouRirekis();
        exNumericEquals(dsHenkouRirekiLst.size(), 2, "ＤＳ変更履歴情報件数");

        MT_DsHenkouRireki dsHenkouRireki = dsHenkouRirekiLst.get(0);
        exStringEquals(dsHenkouRireki.getDskokno(), "1000000003", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki.getHenkousikibetukey(), "200000000000000003", "変更識別キー");
        exNumericEquals(dsHenkouRireki.getRenno(), 1, "連番");
        exStringEquals(dsHenkouRireki.getTablenm(), "ＤＳ顧客契約テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki.getTableid(), "MT_DsKokyakuKeiyaku", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki.getHanbetukoumokunm(), "ＤＳ顧客契約情報　証券番号：17806000068", "判別項目名");
        exStringEquals(dsHenkouRireki.getHenkoukoumokuid(), "syono", "変更項目ID");
        exStringEquals(dsHenkouRireki.getHenkoukoumokunm(), "証券番号", "変更項目名");
        exStringEquals(dsHenkouRireki.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki.getNewnaiyou(), "証券番号：17806000068", "変更後内容");
        exStringEquals(dsHenkouRireki.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki2 = dsHenkouRirekiLst.get(1);
        exStringEquals(dsHenkouRireki2.getDskokno(), "1000000003", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki2.getHenkousikibetukey(), "200000000000000003", "変更識別キー");
        exNumericEquals(dsHenkouRireki2.getRenno(), 2, "連番");
        exStringEquals(dsHenkouRireki2.getTablenm(), "ＤＳメールアドレステーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki2.getTableid(), "MT_DsMailAddress", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki2.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki2.getHanbetukoumokunm(), "ＤＳメールアドレス情報　ＤＳメールアドレス連番：100000005", "判別項目名");
        ...
        exStringEquals(dsHenkouRireki2.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki2.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki2.getNewnaiyou(), "ＤＳ顧客番号：1000000003", "変更後内容");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
    }
    ...
    @Transactional
    @TestOrder(50)
    public void testEditDSTtdkRirekiTblOnline_A5() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000004");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000004");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000004", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000004", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
        exClassificationEquals(dsTtdkRireki.getHenkourrkumu(), C_UmuKbn.ARI, "ＤＳ手続履歴テーブルエンティティ．変更履歴有無");
        exStringEquals(dsTtdkRireki.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "ＤＳ手続履歴テーブルエンティティ．業務用更新機能ＩＤ");
        ...
        MT_DsHenkouRireki dsHenkouRireki1 = dsHenkouRirekiLst.get(0);
        exStringEquals(dsHenkouRireki1.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki1.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki1.getRenno(), 1, "連番");
        exStringEquals(dsHenkouRireki1.getTablenm(), "ＤＳ顧客管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki1.getTableid(), "MT_DsKokyakuKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki1.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        ...
        MT_DsHenkouRireki dsHenkouRireki2 = dsHenkouRirekiLst.get(1);
        exStringEquals(dsHenkouRireki2.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki2.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki2.getRenno(), 2, "連番");
        exStringEquals(dsHenkouRireki2.getTablenm(), "ＤＳ顧客管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki2.getTableid(), "MT_DsKokyakuKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki2.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        ...
        exStringEquals(dsHenkouRireki2.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki2.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki2.getNewnaiyouoriginal(), "20160303", "変更後内容原本");
        exStringEquals(dsHenkouRireki2.getNewnaiyou(), "20160303", "変更後内容");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki3 = dsHenkouRirekiLst.get(2);
        exStringEquals(dsHenkouRireki3.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki3.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki3.getRenno(), 3, "連番");
        ...
        exClassificationEquals(dsHenkouRireki3.getHnksyuruikbn(), C_HnkSyuruiKbn.SAKUJYO, "変更種類区分");
        exStringEquals(dsHenkouRireki3.getHanbetukoumokunm(), "ＤＳ顧客契約情報　証券番号：17806000079", "判別項目名");
        ...
        exStringEquals(dsHenkouRireki3.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki3.getBfrnaiyou(), "証券番号：17806000079", "変更前内容");
        exStringEquals(dsHenkouRireki3.getNewnaiyouoriginal(), "", "変更後内容原本");
        ...
        MT_DsHenkouRireki dsHenkouRireki4 = dsHenkouRirekiLst.get(3);
        exStringEquals(dsHenkouRireki4.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki4.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki4.getRenno(), 4, "連番");
        ...
        exStringEquals(dsHenkouRireki4.getHenkoukoumokuid(), "dskrhnnkakcd", "変更項目ID");
        exStringEquals(dsHenkouRireki4.getHenkoukoumokunm(), "ＤＳ仮本人確認コード", "変更項目名");
        exStringEquals(dsHenkouRireki4.getBfrnaiyouoriginal(), "***", "変更前内容原本");
        exStringEquals(dsHenkouRireki4.getBfrnaiyou(), "***", "変更前内容");
        exStringEquals(dsHenkouRireki4.getNewnaiyouoriginal(), "***", "変更後内容原本");
        ...
        MT_DsHenkouRireki dsHenkouRireki5 = dsHenkouRirekiLst.get(4);
        exStringEquals(dsHenkouRireki5.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki5.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki5.getRenno(), 5, "連番");
        ...
        exStringEquals(dsHenkouRireki5.getHenkoukoumokuid(), "dskrhnnkakcdsetkbn", "変更項目ID");
        exStringEquals(dsHenkouRireki5.getHenkoukoumokunm(), "ＤＳ仮本人確認コード設定区分", "変更項目名");
        exStringEquals(dsHenkouRireki5.getBfrnaiyouoriginal(), "1", "変更前内容原本");
        exStringEquals(dsHenkouRireki5.getBfrnaiyou(), "ＤＳ新規登録時", "変更前内容");
        exStringEquals(dsHenkouRireki5.getNewnaiyouoriginal(), "", "変更後内容原本");
        ...
        MT_DsHenkouRireki dsHenkouRireki6 = dsHenkouRirekiLst.get(5);
        exStringEquals(dsHenkouRireki6.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki6.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki6.getRenno(), 6, "連番");
        ...
        exStringEquals(dsHenkouRireki6.getBfrnaiyouoriginal(), "20150417", "変更前内容原本");
        exStringEquals(dsHenkouRireki6.getBfrnaiyou(), "20150417", "変更前内容");
        ...
        MT_DsHenkouRireki dsHenkouRireki7 = dsHenkouRirekiLst.get(6);
        exStringEquals(dsHenkouRireki7.getDskokno(), "1000000004", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki7.getHenkousikibetukey(), "200000000000000004", "変更識別キー");
        exNumericEquals(dsHenkouRireki7.getRenno(), 7, "連番");
        ...
        exStringEquals(dsHenkouRireki7.getHenkoukoumokuid(), "syokailogintime", "変更項目ID");
        exStringEquals(dsHenkouRireki7.getHenkoukoumokunm(), "初回ログイン時刻", "変更項目名");
        exStringEquals(dsHenkouRireki7.getBfrnaiyouoriginal(), "082516", "変更前内容原本");
        exStringEquals(dsHenkouRireki7.getBfrnaiyou(), "082516", "変更前内容");
        exStringEquals(dsHenkouRireki7.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki7.getNewnaiyou(), "", "変更後内容");
        exStringEquals(dsHenkouRireki7.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki7.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
    }
    ...
    @Transactional
    @TestOrder(60)
    public void testEditDSTtdkRirekiTblOnline_A6() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000005");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000005");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000005", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000005", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
    ...
    @Transactional
    @TestOrder(70)
    public void testEditDSTtdkRirekiTblOnline_A7() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000006");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000002");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000006", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000002", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
        exClassificationEquals(dsTtdkRireki.getHenkourrkumu(), C_UmuKbn.ARI, "ＤＳ手続履歴テーブルエンティティ．変更履歴有無");
        ...
        MT_DsHenkouRireki dsHenkouRireki1 = dsHenkouRirekiLst.get(0);
        exStringEquals(dsHenkouRireki1.getDskokno(), "1000000006", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki1.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki1.getRenno(), 1, "連番");
        exStringEquals(dsHenkouRireki1.getTablenm(), "ＤＳメールアドレステーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki1.getTableid(), "MT_DsMailAddress", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki1.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki1.getHanbetukoumokunm(), "ＤＳメールアドレス情報　ＤＳメールアドレス連番：100000006", "判別項目名");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokuid(), "dskokno", "変更項目ID");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokunm(), "ＤＳ顧客番号", "変更項目名");
        exStringEquals(dsHenkouRireki1.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki1.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki1.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki1.getNewnaiyou(), "ＤＳ顧客番号：1000000006", "変更後内容");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki2 = dsHenkouRirekiLst.get(1);
        exStringEquals(dsHenkouRireki2.getDskokno(), "1000000006", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki2.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki2.getRenno(), 2, "連番");
        exStringEquals(dsHenkouRireki2.getTablenm(), "ＤＳ取引サービス管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki2.getTableid(), "MT_DsTorihikiServiceKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki2.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki2.getHanbetukoumokunm(), "ＤＳ取引サービス管理情報　証券番号：17806000404", "判別項目名");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokuid(), "dstrhkserviceriyoujkkbn", "変更項目ID");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokunm(), "ＤＳ取引サービス利用状況区分", "変更項目名");
        exStringEquals(dsHenkouRireki2.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki2.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki2.getNewnaiyouoriginal(), "2", "変更後内容原本");
        exStringEquals(dsHenkouRireki2.getNewnaiyou(), "利用不可", "変更後内容");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki3 = dsHenkouRirekiLst.get(2);
        exStringEquals(dsHenkouRireki3.getDskokno(), "1000000006", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki3.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki3.getRenno(), 3, "連番");
        exStringEquals(dsHenkouRireki3.getTablenm(), "ＤＳ取引サービス管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki3.getTableid(), "MT_DsTorihikiServiceKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki3.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki3.getHanbetukoumokunm(), "ＤＳ取引サービス管理情報　証券番号：17806000404", "判別項目名");
        exStringEquals(dsHenkouRireki3.getHenkoukoumokuid(), "dstrhkserviceteisiriyuukbn", "変更項目ID");
        exStringEquals(dsHenkouRireki3.getHenkoukoumokunm(), "ＤＳ取引サービス停止理由区分", "変更項目名");
        exStringEquals(dsHenkouRireki3.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki3.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki3.getNewnaiyouoriginal(), "2", "変更後内容原本");
        exStringEquals(dsHenkouRireki3.getNewnaiyou(), "お客様要望", "変更後内容");
        exStringEquals(dsHenkouRireki3.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki3.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki4 = dsHenkouRirekiLst.get(3);
        exStringEquals(dsHenkouRireki4.getDskokno(), "1000000006", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki4.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki4.getRenno(), 4, "連番");
        exStringEquals(dsHenkouRireki4.getTablenm(), "ＤＳ取引サービス管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki4.getTableid(), "MT_DsTorihikiServiceKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki4.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki4.getHanbetukoumokunm(), "ＤＳ取引サービス管理情報　証券番号：17806000404", "判別項目名");
        exStringEquals(dsHenkouRireki4.getHenkoukoumokuid(), "dstrhkservicetourokuymd", "変更項目ID");
        exStringEquals(dsHenkouRireki4.getHenkoukoumokunm(), "ＤＳ取引サービス登録年月日", "変更項目名");
        exStringEquals(dsHenkouRireki4.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki4.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki4.getNewnaiyouoriginal(), "20180410", "変更後内容原本");
        exStringEquals(dsHenkouRireki4.getNewnaiyou(), "20180410", "変更後内容");
        exStringEquals(dsHenkouRireki4.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki4.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki5 = dsHenkouRirekiLst.get(4);
        exStringEquals(dsHenkouRireki5.getDskokno(), "1000000006", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki5.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki5.getRenno(), 5, "連番");
        exStringEquals(dsHenkouRireki5.getTablenm(), "ＤＳ取引サービス管理テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki5.getTableid(), "MT_DsTorihikiServiceKanri", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki5.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki5.getHanbetukoumokunm(), "ＤＳ取引サービス管理情報　証券番号：17806000404", "判別項目名");
        exStringEquals(dsHenkouRireki5.getHenkoukoumokuid(), "dstrhkservicekanyukeirokbn", "変更項目ID");
        exStringEquals(dsHenkouRireki5.getHenkoukoumokunm(), "ＤＳ取引サービス加入経路区分", "変更項目名");
        exStringEquals(dsHenkouRireki5.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki5.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki5.getNewnaiyouoriginal(), "2", "変更後内容原本");
        exStringEquals(dsHenkouRireki5.getNewnaiyou(), "中途加入", "変更後内容");
        exStringEquals(dsHenkouRireki5.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki5.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
    ...
    @Transactional
    @TestOrder(80)
    public void testEditDSTtdkRirekiTblOnline_A8() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000007");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000002");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000007", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000002", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
        exClassificationEquals(dsTtdkRireki.getHenkourrkumu(), C_UmuKbn.ARI, "ＤＳ手続履歴テーブルエンティティ．変更履歴有無");
        ...
        MT_DsHenkouRireki dsHenkouRireki1 = dsHenkouRirekiLst.get(0);
        exStringEquals(dsHenkouRireki1.getDskokno(), "1000000007", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki1.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki1.getRenno(), 1, "連番");
        exStringEquals(dsHenkouRireki1.getTablenm(), "ＤＳメールアドレステーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki1.getTableid(), "MT_DsMailAddress", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki1.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki1.getHanbetukoumokunm(), "ＤＳメールアドレス情報　ＤＳメールアドレス連番：100000007", "判別項目名");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokuid(), "dskokno", "変更項目ID");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokunm(), "ＤＳ顧客番号", "変更項目名");
        exStringEquals(dsHenkouRireki1.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki1.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki1.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki1.getNewnaiyou(), "ＤＳ顧客番号：1000000007", "変更後内容");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki2 = dsHenkouRirekiLst.get(1);
        exStringEquals(dsHenkouRireki2.getDskokno(), "1000000007", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki2.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki2.getRenno(), 2, "連番");
        exStringEquals(dsHenkouRireki2.getTablenm(), "ＤＳ送金用口座テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki2.getTableid(), "MT_DsSoukinyouKouza", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki2.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki2.getHanbetukoumokunm(), "ＤＳ送金用口座情報　証券番号：17806000415　ＤＳ送金用口座情報　口座種類区分：外貨口座", "判別項目名");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokuid(), "yokinkbn", "変更項目ID");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokunm(), "預金種目区分", "変更項目名");
        exStringEquals(dsHenkouRireki2.getBfrnaiyouoriginal(), "2", "変更前内容原本");
        exStringEquals(dsHenkouRireki2.getBfrnaiyou(), "当座", "変更前内容");
        exStringEquals(dsHenkouRireki2.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki2.getNewnaiyou(), "普通", "変更後内容");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki3 = dsHenkouRirekiLst.get(2);
        exStringEquals(dsHenkouRireki3.getDskokno(), "1000000007", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki3.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki3.getRenno(), 3, "連番");
        exStringEquals(dsHenkouRireki3.getTablenm(), "ＤＳ送金用口座テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki3.getTableid(), "MT_DsSoukinyouKouza", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki3.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki3.getHanbetukoumokunm(), "ＤＳ送金用口座情報　証券番号：17806000415　ＤＳ送金用口座情報　口座種類区分：外貨口座", "判別項目名");
        exStringEquals(dsHenkouRireki3.getHenkoukoumokuid(), "kouzano", "変更項目ID");
        exStringEquals(dsHenkouRireki3.getHenkoukoumokunm(), "口座番号", "変更項目名");
        exStringEquals(dsHenkouRireki3.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki3.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki3.getNewnaiyouoriginal(), "10", "変更後内容原本");
        exStringEquals(dsHenkouRireki3.getNewnaiyou(), "10", "変更後内容");
        exStringEquals(dsHenkouRireki3.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki3.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki4 = dsHenkouRirekiLst.get(3);
        exStringEquals(dsHenkouRireki4.getDskokno(), "1000000007", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki4.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki4.getRenno(), 4, "連番");
        exStringEquals(dsHenkouRireki4.getTablenm(), "ＤＳ送金用口座テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki4.getTableid(), "MT_DsSoukinyouKouza", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki4.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki4.getHanbetukoumokunm(), "ＤＳ送金用口座情報　証券番号：17806000415　ＤＳ送金用口座情報　口座種類区分：外貨口座", "判別項目名");
        exStringEquals(dsHenkouRireki4.getHenkoukoumokuid(), "kzdoukbn", "変更項目ID");
        exStringEquals(dsHenkouRireki4.getHenkoukoumokunm(), "口座名義人同一区分", "変更項目名");
        exStringEquals(dsHenkouRireki4.getBfrnaiyouoriginal(), "2", "変更前内容原本");
        exStringEquals(dsHenkouRireki4.getBfrnaiyou(), "指定", "変更前内容");
        exStringEquals(dsHenkouRireki4.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki4.getNewnaiyou(), "同一", "変更後内容");
        exStringEquals(dsHenkouRireki4.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki4.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
    }
    ...
    @Transactional
    @TestOrder(90)
    public void testEditDSTtdkRirekiTblOnline_A9() {

        DsTetudukiRirekiTableEditParam dsTetudukiRirekiTableEditParam = new DsTetudukiRirekiTableEditParamImpl();
        dsTetudukiRirekiTableEditParam.setDskokno("1000000008");
        dsTetudukiRirekiTableEditParam.setHenkousikibetukey("200000000000000002");
        dsTetudukiRirekiTableEditParam.setSyoriYmd(BizDate.valueOf("2016/04/13"));
        dsTetudukiRirekiTableEditParam.setDssyorikbn(C_DsSyoriKbn.LOGIN_SEIKOU);
        dsTetudukiRirekiTableEditParam.setHenkouRrkYouhi(C_YouhiKbn.YOU);
        ...
        MT_DsTtdkRireki dsTtdkRireki = dsTtdkRirekiLst.get(0);
        exStringEquals(dsTtdkRireki.getDskokno(), "1000000008", "ＤＳ手続履歴テーブルエンティティ．ＤＳ顧客番号");
        exStringEquals(dsTtdkRireki.getHenkousikibetukey(), "200000000000000002", "ＤＳ手続履歴テーブルエンティティ．変更識別キー");
        exDateEquals(dsTtdkRireki.getSyoriYmd(), BizDate.valueOf("2016/04/13"), "ＤＳ手続履歴テーブルエンティティ．処理年月日");
        exClassificationEquals(dsTtdkRireki.getDssyorikbn(), C_DsSyoriKbn.LOGIN_SEIKOU, "ＤＳ手続履歴テーブルエンティティ．ＤＳ処理区分");
        exClassificationEquals(dsTtdkRireki.getHenkourrkumu(), C_UmuKbn.ARI, "ＤＳ手続履歴テーブルエンティティ．変更履歴有無");
        ...
        MT_DsHenkouRireki dsHenkouRireki1 = dsHenkouRirekiLst.get(0);
        exStringEquals(dsHenkouRireki1.getDskokno(), "1000000008", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki1.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki1.getRenno(), 1, "連番");
        exStringEquals(dsHenkouRireki1.getTablenm(), "ＤＳメールアドレステーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki1.getTableid(), "MT_DsMailAddress", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki1.getHnksyuruikbn(), C_HnkSyuruiKbn.TUIKA, "変更種類区分");
        exStringEquals(dsHenkouRireki1.getHanbetukoumokunm(), "ＤＳメールアドレス情報　ＤＳメールアドレス連番：100000008", "判別項目名");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokuid(), "dskokno", "変更項目ID");
        exStringEquals(dsHenkouRireki1.getHenkoukoumokunm(), "ＤＳ顧客番号", "変更項目名");
        exStringEquals(dsHenkouRireki1.getBfrnaiyouoriginal(), "", "変更前内容原本");
        exStringEquals(dsHenkouRireki1.getBfrnaiyou(), "", "変更前内容");
        exStringEquals(dsHenkouRireki1.getNewnaiyouoriginal(), "", "変更後内容原本");
        exStringEquals(dsHenkouRireki1.getNewnaiyou(), "ＤＳ顧客番号：1000000008", "変更後内容");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki1.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");

        MT_DsHenkouRireki dsHenkouRireki2 = dsHenkouRirekiLst.get(1);
        exStringEquals(dsHenkouRireki2.getDskokno(), "1000000008", "ＤＳ顧客番号");
        exStringEquals(dsHenkouRireki2.getHenkousikibetukey(), "200000000000000002", "変更識別キー");
        exNumericEquals(dsHenkouRireki2.getRenno(), 2, "連番");
        exStringEquals(dsHenkouRireki2.getTablenm(), "ＤＳ特定取引用暗証番号テーブル", "テーブル名称");
        exStringEquals(dsHenkouRireki2.getTableid(), "MT_DsTorihikiyouAnsyono", "テーブルＩＤ");
        exClassificationEquals(dsHenkouRireki2.getHnksyuruikbn(), C_HnkSyuruiKbn.HENKOU, "変更種類区分");
        exStringEquals(dsHenkouRireki2.getHanbetukoumokunm(), "ＤＳ特定取引用暗証番号情報　証券番号：17806000426", "判別項目名");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokuid(), "tktrhkansyonoerrorkaisuu", "変更項目ID");
        exStringEquals(dsHenkouRireki2.getHenkoukoumokunm(), "特定取引用暗証番号エラー回数", "変更項目名");
        exStringEquals(dsHenkouRireki2.getBfrnaiyouoriginal(), "0", "変更前内容原本");
        exStringEquals(dsHenkouRireki2.getBfrnaiyou(), "0", "変更前内容");
        exStringEquals(dsHenkouRireki2.getNewnaiyouoriginal(), "1", "変更後内容原本");
        exStringEquals(dsHenkouRireki2.getNewnaiyou(), "1", "変更後内容");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinKinou(), "DsTetudukiRirekiTableEditTest_editDSTtdkRirekiTblO", "業務用更新機能ＩＤ");
        exStringEquals(dsHenkouRireki2.getGyoumuKousinsyaId(), "JUnit", "業務用更新者ＩＤ");
