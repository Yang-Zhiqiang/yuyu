...
public class DsSaibanSyoriTest_saibanDsKoknoYoh {
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(DsSaibanSyoriTest_saibanDsKoknoYoh.class,
                fileName, sheetName);
    ...
    @Test
    @TestOrder(10)
    public void testSaibanDsKoknoYoh_A1() {

        String result =  dsSaibanSyori.saibanDsKokno();

        exStringEquals(result, "8000427328", "ＤＳ顧客番号");
