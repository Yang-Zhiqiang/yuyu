...
/**
 * 備金契約仮割当Ｄ集計表帳票テスト用クラス<br />
 */
@RunWith(OrderedRunner.class)
public class SrBikinkykkariwariatedlistTest {
    ...
    public void testCreateReport1(){
        ReportServicesBean reportTestBean =
            createReport.createNewReportServiceBean("suuri", "", "SrBikinkykkariwariatedlistTest", C_SyoruiCdKbn.SR_BIKINKYKKARIWARIATEDLIST);
