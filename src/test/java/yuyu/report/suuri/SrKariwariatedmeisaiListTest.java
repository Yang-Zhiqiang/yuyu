...
/**
 * 仮割当配当金明細表 帳票テスト用クラス<br />
 */
@RunWith(OrderedRunner.class)
public class SrKariwariatedmeisaiListTest {
    ...
    public void testCreateReport1() {
        ...
        ReportServicesBean reportTestBean =
            createReport.createNewReportServiceBean("suuri", "", "SrKariwariatedmeisaiListTest",C_SyoruiCdKbn.SR_KARIWARIATEDMEISAILIS);
