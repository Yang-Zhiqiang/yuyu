...
/**
 * 区分経理用積立配当金明細表 帳票テスト用クラス<br />
 */
@RunWith(OrderedRunner.class)
public class SrKbnkeiriyoutmttdmeisailistTest {
    ...
    public void testCreateReport1() {
        ...
        ReportServicesBean reportTestBean =
            createReport.createNewReportServiceBean("suuri", "", "SrKbnkeiriyoutmttdmeisailistTest",C_SyoruiCdKbn.SR_KBNKEIRIYOUTMTTDMEISAILIST);
        ...
        srHaitoukinMeisaiListDataSourceBean.setIrSeg(null);
    ...
    public void testCreateReport3() {
        ...
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("特定疾病保障");
        srHaitoukinMeisaiListDataSourceBean.setSrHaitoukinmeisailistsubdatasourcebeanList(srHaitoukinMeisaiListSubDataSourceBeanList1);
        dataSouceList.add(srHaitoukinMeisaiListDataSourceBean);
        ...
        srHaitoukinMeisaiListDataSourceBean = new SrHaitoukinMeisaiListDataSourceBean();
        srHaitoukinMeisaiListDataSourceBean.setIrKbnkeirisegcd("０１０５");
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("変額");
        srHaitoukinMeisaiListDataSourceBean.setSrHaitoukinmeisailistsubdatasourcebeanList(srHaitoukinMeisaiListSubDataSourceBeanList2);
        dataSouceList.add(srHaitoukinMeisaiListDataSourceBean);
    ...
    public void testCreateReport5() {
        ...
        for (int i = 0; i < 1998; i++) {
            ...
            srHaitoukinMeisaiListDataSourceBean.setIrSeg("ＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷ");
    ...
    public void testCreateReport6() {
        ...
        srHaitoukinMeisaiListDataSourceBean = new SrHaitoukinMeisaiListDataSourceBean();
        srHaitoukinMeisaiListDataSourceBean.setIrKbnkeirisegcd("０１０６");
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("積立");
        ...
        srHaitoukinMeisaiListDataSourceBean = new SrHaitoukinMeisaiListDataSourceBean();
        srHaitoukinMeisaiListDataSourceBean.setIrKbnkeirisegcd("０１０７");
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("集定Ⅱ型");
        ...
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("３年ごと利率変動型積立保険（特約）");
        ...
        srHaitoukinMeisaiListDataSourceBean = new SrHaitoukinMeisaiListDataSourceBean();
        srHaitoukinMeisaiListDataSourceBean.setIrKbnkeirisegcd("");
        srHaitoukinMeisaiListDataSourceBean.setIrSeg("全種合計");
