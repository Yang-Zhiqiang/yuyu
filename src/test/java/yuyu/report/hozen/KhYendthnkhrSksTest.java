...
public class KhYendthnkhrSksTest extends AbstractTest {
    ...
    public void testCreateReport1(){
        ReportServicesBean reportTestBean =
            createReport.createNewReportServiceBean("hozen", "", "KhYendthnkhrSksTest", C_SyoruiCdKbn.KK_YENDTHNKHNRKN_SKS);
    ...
    public void testCreateReport5(){
        ...
        khSeikyuusyoBean.setIrKhhrshrjiyuu(C_Khhrshrjiyuu.KYKSB);
        khSeikyuusyoBean.setIrFatcakakuninyhkbn(C_YouhiblnkKbn.YOU);
