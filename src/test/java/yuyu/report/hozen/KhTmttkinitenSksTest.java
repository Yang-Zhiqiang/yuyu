...
public class KhTmttkinitenSksTest  extends AbstractTest {
    ...
    public void testCreateReport1() {
        ReportServicesBean reportTestBean =
            createReport.createNewReportServiceBean("hozen", "", "kh_tmttkiniiten_sksTest", C_SyoruiCdKbn.KK_TUMITATEKINITEN_SKS);
        ...
        khSeikyuusyoBean.setIrTmttknitenymd("ＷＷ99年99月99日");
    ...
    public void testCreateReport2(){
        ...
        khSeikyuusyoBean.setIrTmttknitenkbn(C_Tmttknitenkbn.ITEN);
        khSeikyuusyoBean.setIrTmttknitenymd("平成 2年 2月 2日");
        ...
        bzSksKaisyasiyouranBean.setIrTyouhyousakuseiymd("平成 3年 3月 3日");
        bzSksKaisyasiyouranBean.setIrHozonkkn("消滅後2年");
    ...
    public void testCreateReport3(){
        ...
        khSeikyuusyoBean.setIrTmttknitenkbn(C_Tmttknitenkbn.ITEN);
        khSeikyuusyoBean.setIrTmttknitenymd("");
    ...
    public void testCreateReport4(){
        ...
        khSeikyuusyoBean.setIrTmttknitenkbn(C_Tmttknitenkbn.ITEN);
        khSeikyuusyoBean.setIrTmttknitenymd(null);
    ...
    public void testCreateReport5() {
        ...
        khSeikyuusyoBean.setIrTsinadr2kj("ＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷ");
        khSeikyuusyoBean.setIrTsinadr3kj("ＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷＷ");
        khSeikyuusyoBean.setIrTmttknitenkbn(C_Tmttknitenkbn.ITEN_TORIKESI);
        khSeikyuusyoBean.setIrTmttknitenymd("ＷＷ99年99月99日");
