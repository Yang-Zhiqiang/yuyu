 ...
 * getNyknJissekiRirekisBySyonoNnykdenno メソッドのテストクラスです。
 *  @author  朱紅妍
 * @version 2019/01/28  新規作成
 *          2019/02/11 朱紅妍 SLC指摘対応
 * @see SrCommonKinouDao#getNyknJissekiRirekisBySyonoNnykdenno()
 */
@RunWith(OrderedRunner.class)
public class SuuriDomManagerTest_getNyknJissekiRirekisBySyonoNnykdenno {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getNyknJissekiRirekisBySyonoNnykdenno";
    ...
    public static void preProcess() {
        ...
        List<IT_NyknJissekiRireki> nyknJissekiRireki = srCommonKinouDao.
            getNyknJissekiRirekisBySyonoNnykdenno("60806000033", "03k2fjh2mzhpv4wcnq");
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(SuuriDomManagerTest_getNyknJissekiRirekisBySyonoNnykdenno.class, fileName,
                sheetName);
    ...
    public void noResult1() {
        ...
        List<IT_NyknJissekiRireki> nyknJissekiRirekiLst = srCommonKinouDao.
            getNyknJissekiRirekisBySyonoNnykdenno("60806000022", "03k2fjh2mzhpv4wcnq");
    ...
    public void normal2() {
        ...
        List<IT_NyknJissekiRireki> nyknJissekiRirekiLst = srCommonKinouDao.
            getNyknJissekiRirekisBySyonoNnykdenno("60806000044", "03k2fjh2mzhpv4wcnq");
