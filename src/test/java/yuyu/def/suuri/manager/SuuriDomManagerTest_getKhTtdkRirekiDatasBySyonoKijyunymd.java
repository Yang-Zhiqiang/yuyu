 ...
 * getKhTtdkRirekiDatasBySyonoKijyunymd メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class SuuriDomManagerTest_getKhTtdkRirekiDatasBySyonoKijyunymd {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getKhTtdkRirekiDatasBySyonoKijyunymd";
    ...
    public static void preProcess() {
        ...
        List<IT_KhTtdkRireki> khTtdkRirekiLst = srCommonKinouDao.getKhTtdkRirekiDatasBySyonoKijyunymd(
            "11807111130", BizDate.valueOf(20190613));
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(
                SuuriDomManagerTest_getKhTtdkRirekiDatasBySyonoKijyunymd.class, fileName, sheetName);
    ...
    public void noResult1() {
        ...
        List<IT_KhTtdkRireki> khTtdkRirekiLst = srCommonKinouDao.getKhTtdkRirekiDatasBySyonoKijyunymd(
            "11807111130", BizDate.valueOf(20200613));
    ...
    public void normal1() {
        ...
        assertEquals(1, khTtdkRirekiLst.size());

        exStringEquals("03", khTtdkRirekiLst.get(0).getKbnkey(), "区分キー");
        exStringEquals("11807111130", khTtdkRirekiLst.get(0).getSyono(), "証券番号");
        exStringEquals("000000000000000003", khTtdkRirekiLst.get(0).getHenkousikibetukey(), "変更識別キー");
    }
    ...
    public void normal2() {
        List<IT_KhTtdkRireki> khTtdkRirekiLst = srCommonKinouDao.getKhTtdkRirekiDatasBySyonoKijyunymd(
            "11807111152", BizDate.valueOf(20190613));
        ...
        exStringEquals("000000000000000006", khTtdkRirekiLst.get(0).getHenkousikibetukey(), "変更識別キー");

        exStringEquals("05", khTtdkRirekiLst.get(1).getKbnkey(), "区分キー");
        exStringEquals("11807111152", khTtdkRirekiLst.get(1).getSyono(), "証券番号");
        exStringEquals("000000000000000005", khTtdkRirekiLst.get(1).getHenkousikibetukey(), "変更識別キー");

        exStringEquals("05", khTtdkRirekiLst.get(2).getKbnkey(), "区分キー");
        exStringEquals("11807111152", khTtdkRirekiLst.get(2).getSyono(), "証券番号");
        exStringEquals("000000000000000004", khTtdkRirekiLst.get(2).getHenkousikibetukey(), "変更識別キー");
    }
}
