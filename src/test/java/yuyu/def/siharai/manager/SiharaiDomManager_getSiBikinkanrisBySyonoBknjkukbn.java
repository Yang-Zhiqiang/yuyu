 ...
 * 数理<br />
 * 異動明細情報作成<br />
 * 保険金給付金備金管理テーブルエンティティリスト　備金例外区分≠備金削除のテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class SiharaiDomManager_getSiBikinkanrisBySyonoBknjkukbn {
    ...
    public static void insertTestData() {
        ...
        List<JT_SiBikinkanri> siBikinkanriList = siharaiDomManager.getSiBikinkanrisBySyonoBknjkukbn("11807111118");
        ...
        JT_SiBikinkanri siBikinkanri3 = new JT_SiBikinkanri("1000001", "11807111118", BizDate.valueOf(20160101), C_BkncdKbn.BLNK, BizDate.valueOf(20161222), "1000");
        siBikinkanri3.setBknrigikbn(C_BknrigiKbn.BLNK);
        siBikinkanri3.setBknjkukbn(C_BknJkuKbn.SAIBI);

        siharaiDomManager.insert(siBikinkanri3);

        JT_SiBikinkanri siBikinkanri4 = new JT_SiBikinkanri("1000001", "11807111118", BizDate.valueOf(20160101), C_BkncdKbn.BLNK, BizDate.valueOf(20161223), "1000");
        siBikinkanri4.setBknrigikbn(C_BknrigiKbn.DEL);
        siBikinkanri4.setBknjkukbn(C_BknJkuKbn.SINBI);

        siharaiDomManager.insert(siBikinkanri4);

        JT_SiBikinkanri siBikinkanri5 = new JT_SiBikinkanri("1000003", "11807111141", BizDate.valueOf(20160103), C_BkncdKbn.BLNK, BizDate.valueOf(20161220), "1003");
        siBikinkanri5.setBknrigikbn(C_BknrigiKbn.BLNK);
        siBikinkanri5.setBknjkukbn(C_BknJkuKbn.SINBI);

        siharaiDomManager.insert(siBikinkanri5);

        JT_SiBikinkanri siBikinkanri6 = new JT_SiBikinkanri("1000003", "11807111141", BizDate.valueOf(20160104), C_BkncdKbn.BLNK, BizDate.valueOf(20161220), "1003");
        ...
        JT_SiBikinkanri siBikinkanri7 = new JT_SiBikinkanri("1000003", "11807111141", BizDate.valueOf(20160105), C_BkncdKbn.BLNK, BizDate.valueOf(20161220), "1003");
        siBikinkanri7.setBknrigikbn(C_BknrigiKbn.BLNK);
    ...
    public void noResult1() {
        ...
        List<JT_SiBikinkanri> siBikinkanriList = siharaiDomManager.getSiBikinkanrisBySyonoBknjkukbn("11807111406");
    ...
    public void normal2() {
        ...
        List<JT_SiBikinkanri> siBikinkanriList = siharaiDomManager.getSiBikinkanrisBySyonoBknjkukbn("11807111141");
    ...
    public void blankCondition1() {
        ...
        List<JT_SiBikinkanri> siBikinkanriList = siharaiDomManager.getSiBikinkanrisBySyonoBknjkukbn("");
