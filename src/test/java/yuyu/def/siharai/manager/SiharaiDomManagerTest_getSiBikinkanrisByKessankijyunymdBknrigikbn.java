 ...
 * 保険金<br />
 * 保険金給付金備金情報抽出<br />
 * 保険金給付金備金管理テーブルエンティティリスト取得　決算基準日かつ備金例外区分のテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class SiharaiDomManagerTest_getSiBikinkanrisByKessankijyunymdBknrigikbn {
    ...
    public static void insertTestData() {
        ...
        List<JT_SiBikinkanri> sibikinkanriLst = siharaiDomManager.getSiBikinkanrisByKessankijyunymdBknrigikbn(P_KESSANKIJYUNYMD_001, C_BknrigiKbn.ADD);
    ...
    public void noResult1(){
        ...
        List<JT_SiBikinkanri> sibikinkanriLst = siharaiDomManager.getSiBikinkanrisByKessankijyunymdBknrigikbn(P_KESSANKIJYUNYMD_001, C_BknrigiKbn.BLNK);
    ...
    public void normal1() {
        ...
        Assert.assertEquals(P_KESSANKIJYUNYMD_001, sibikinkanriLst.get(0).getKessankijyunymd());
        ...
        Assert.assertEquals(P_KYUUHUCD_01, sibikinkanriLst.get(0).getKyuuhucd());
    ...
    public void normal2() {
        ...
        List<JT_SiBikinkanri> sibikinkanriLst = siharaiDomManager.getSiBikinkanrisByKessankijyunymdBknrigikbn(P_KESSANKIJYUNYMD_001, C_BknrigiKbn.DEL);
