 ...
 * getSiKekkasByKakutyoujobcd() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class SiharaiDomManagerTest_getSiKekkasByKakutyoujobcd {
    ...
    public static void insertTestData() {
        ...
        try (ExDBResults<JT_SiKekka> beans =siharaiDomManager.getSiKekkasByKakutyoujobcd("RBA5")) {

            Assert.assertFalse(beans.iterator().hasNext());}

        JT_SiKekka siKekka1 = new JT_SiKekka(C_ShiharaikekkadataKbn.valueOf("1"), "11807111118", "A100", 10, 1, C_SyutkKbn.valueOf("1"));
    ...
    public void normal10(){
        ...
        ExDBResults<JT_SiKekka> beans = siharaiDomManager.getSiKekkasByKakutyoujobcd("RBA5");
