...
/**
 * 金融機関情報連動ファイルテーブルのテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class ZdbDomManagerTest_getKinyuuKikanInfoRnsByZrnsitencdNe4Space {
    @Inject
    ...
    public static void insertTestData() {
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.getKinyuuKikanInfoRnsByZrnsitencdNe4Space()){

            Assert.assertFalse(beans.iterator().hasNext());

        }

        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn1 = new ZT_KinyuuKikanInfoRn();
        kinyuuKikanInfoRn1.setZrnkinyuukikancd("1111");
        kinyuuKikanInfoRn1.setZrnsitencd("    ");
    ...
    public void normal1() {
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn2 = new ZT_KinyuuKikanInfoRn("","");
        kinyuuKikanInfoRn2.setZrnkinyuukikancd("1113");
        kinyuuKikanInfoRn2.setZrnsitencd("a111");
        kinyuuKikanInfoRn2.setZrntenpokbn("02");
        kinyuuKikanInfoRn2.setZrnkousinymd("20150102");
        kinyuuKikanInfoRn2.setZrnsinsetuymd("20150102");
        kinyuuKikanInfoRn2.setZrnhaisiymd("20150102");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn3 = new ZT_KinyuuKikanInfoRn();
        kinyuuKikanInfoRn3.setZrnkinyuukikancd("1112");
        kinyuuKikanInfoRn3.setZrnsitencd("a111");
        kinyuuKikanInfoRn3.setZrntenpokbn("03");
        kinyuuKikanInfoRn3.setZrnkousinymd("20150103");
        kinyuuKikanInfoRn3.setZrnsinsetuymd("20150103");
        kinyuuKikanInfoRn3.setZrnhaisiymd("20150103");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn4 = new ZT_KinyuuKikanInfoRn();
        kinyuuKikanInfoRn4.setZrnkinyuukikancd("1111");
        kinyuuKikanInfoRn4.setZrnsitencd("aaa1");
        kinyuuKikanInfoRn4.setZrntenpokbn("04");
        kinyuuKikanInfoRn4.setZrnkousinymd("20150104");
        kinyuuKikanInfoRn4.setZrnsinsetuymd("20150104");
        kinyuuKikanInfoRn4.setZrnhaisiymd("20150104");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn5 = new ZT_KinyuuKikanInfoRn();
        kinyuuKikanInfoRn5.setZrnkinyuukikancd("1111");
        kinyuuKikanInfoRn5.setZrnsitencd("aa11");
        kinyuuKikanInfoRn5.setZrntenpokbn("05");
        kinyuuKikanInfoRn5.setZrnkousinymd("20150105");
        kinyuuKikanInfoRn5.setZrnsinsetuymd("20150105");
        kinyuuKikanInfoRn5.setZrnhaisiymd("20150105");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn6 = new ZT_KinyuuKikanInfoRn();
        kinyuuKikanInfoRn6.setZrnkinyuukikancd("1111");
        kinyuuKikanInfoRn6.setZrnsitencd("a111");
        kinyuuKikanInfoRn6.setZrntenpokbn("06");
        kinyuuKikanInfoRn6.setZrnkousinymd("20150106");
        kinyuuKikanInfoRn6.setZrnsinsetuymd("20150106");
        kinyuuKikanInfoRn6.setZrnhaisiymd("20150106");
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.getKinyuuKikanInfoRnsByZrnsitencdNe4Space()){
            ...
            while (iter.hasNext()) {
                ...
                if (1 == iCount) {
                    Assert.assertEquals("1111", zT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("a111", zT_KinyuuKikanInfoRn.getZrnsitencd());
                    continue;
                }

                if (2 == iCount) {
                    Assert.assertEquals("1111", zT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("aa11", zT_KinyuuKikanInfoRn.getZrnsitencd());
                    continue;
                }

                if (3 == iCount) {
                    Assert.assertEquals("1111", zT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("aaa1", zT_KinyuuKikanInfoRn.getZrnsitencd());
                    continue;
                }
                if (4 == iCount) {
                    Assert.assertEquals("1112", zT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("a111", zT_KinyuuKikanInfoRn.getZrnsitencd());
                    continue;
                }
                if (5 == iCount) {
                    Assert.assertEquals("1113", zT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("a111", zT_KinyuuKikanInfoRn.getZrnsitencd());
                    continue;
                }
            }
