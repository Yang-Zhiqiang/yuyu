...
/**
 * getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd() メソッドのテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class ZdbDomManagerTest_getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd {
    ...
    public static void insertTestData() {
        ...
        try (ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.
            getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd("4")){

            Assert.assertFalse(beans.iterator().hasNext());
        }

        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn1 = new ZT_KinyuuKikanInfoRn("1234", "0000");
        ...
        kinyuuKikanInfoRn1.setZrnkinyuutesuuryou(1000);
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn2 = new ZT_KinyuuKikanInfoRn("4321", "0000");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn3 = new ZT_KinyuuKikanInfoRn("5698", "0003");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn4 = new ZT_KinyuuKikanInfoRn("5698", "0002");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn5 = new ZT_KinyuuKikanInfoRn("5698", "0001");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn6 = new ZT_KinyuuKikanInfoRn("5688", "0003");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn7 = new ZT_KinyuuKikanInfoRn("5678", "0003");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn8 = new ZT_KinyuuKikanInfoRn("1323", "    ");
        kinyuuKikanInfoRn8.setZrntenpokbn("01");
        kinyuuKikanInfoRn8.setZrnkousinymd("20150101");
        kinyuuKikanInfoRn8.setZrnsinsetuymd("20150101");
        kinyuuKikanInfoRn8.setZrnhaisiymd("20150101");
        kinyuuKikanInfoRn8.setZrnkanakinyuukikannm("ｷﾝﾕｳｷｷﾝﾕｳｷｷﾝﾕｳｷｷﾝﾕｳｷｷﾝﾕｳｷ");
        kinyuuKikanInfoRn8.setZrnkanasitennm("ｼﾃﾝﾒｲｼﾃﾝﾒｲｼﾃﾝﾒｲｼﾃﾝﾒｲｼﾃﾝﾒｲ");
        kinyuuKikanInfoRn8.setZrnkanjikinyuukikannm("金融");
        kinyuuKikanInfoRn8.setZrnkanjisitennm("支店");
        kinyuuKikanInfoRn8.setZrneijikinyuukikannm("abcdefghijkabcdefghijkabcdefghijkabcdefghijkabcdefghijkabcde");
        kinyuuKikanInfoRn8.setZrneijisitennm("abcdefghijkabcdefghijkabcdefghijkabcdefghijkabcdefghijkabcde");
        kinyuuKikanInfoRn8.setZrncsskyouteikaisiymd("20161114");
        kinyuuKikanInfoRn8.setZrncsskyouteikaijyoymd("20161114");
        kinyuuKikanInfoRn8.setZrnkokunaikawasehyouji("1");
        kinyuuKikanInfoRn8.setZrnhurikomikanousitenhyouji("1");
        kinyuuKikanInfoRn8.setZrngyoutaikbn("01");
        kinyuuKikanInfoRn8.setZrnyofurikyouteikaisiymd("20181212");
        kinyuuKikanInfoRn8.setZrnyofurikyouteikaijyoymd("20181212");
        kinyuuKikanInfoRn8.setZrnitakusyakinyuucd("1111");
        kinyuuKikanInfoRn8.setZrnitakusyasitencd("2222");
        kinyuuKikanInfoRn8.setZrnitakusyayokinkbn("1");
        kinyuuKikanInfoRn8.setZrnitakusyakouzano("12345678");
        kinyuuKikanInfoRn8.setZrntsrkeisanhoukbn("1");
        kinyuuKikanInfoRn8.setZrnkinyuutesuuryou(10000);
        kinyuuKikanInfoRn8.setZrnitakusyacd("0123456789");
        kinyuuKikanInfoRn8.setZrntapekoukankbn1("1");
        kinyuuKikanInfoRn8.setZrnmdsisyacd("1234567");
        kinyuuKikanInfoRn8.setZrnzzkkyouteikaisiymd("20181212");
        kinyuuKikanInfoRn8.setZrnzzkkyouteikaijyoymd("20181212");
        kinyuuKikanInfoRn8.setZrnhuhoyofuriinfokousinymd("20181212");
        kinyuuKikanInfoRn8.setZrnyobiv17("12345678901234567");

        zdbDomManager.insert(kinyuuKikanInfoRn8);
    ...
    public void noResult1() {
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.
            getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd("2")){
    ...
    public void normal1() {
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd("4")){
            ...
            while (iter.hasNext()) {
                ...
                iCount++;
                if (1 == iCount) {
                    Assert.assertEquals("1234", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0000", ZT_KinyuuKikanInfoRn.getZrnsitencd());
                }
            }
    ...
    public void normal2() {
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.
            getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd("8")){
            ...
            while (iter.hasNext()) {
                ...
                iCount++;
                if (1 == iCount) {
                    Assert.assertEquals("5678", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0003", ZT_KinyuuKikanInfoRn.getZrnsitencd());
                }
                if (2 == iCount) {
                    Assert.assertEquals("5688", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0003", ZT_KinyuuKikanInfoRn.getZrnsitencd());
                }
                if (3 == iCount) {
                    Assert.assertEquals("5698", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0001", ZT_KinyuuKikanInfoRn.getZrnsitencd());
                }
                if (4 == iCount) {
                    Assert.assertEquals("5698", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0002", ZT_KinyuuKikanInfoRn.getZrnsitencd());
                }
                if (5 == iCount) {
                    Assert.assertEquals("5698", ZT_KinyuuKikanInfoRn.getZrnkinyuukikancd());
                    Assert.assertEquals("0003", ZT_KinyuuKikanInfoRn.getZrnsitencd());
    ...
    public void blank() {
        ...
        try(ExDBResults<ZT_KinyuuKikanInfoRn> beans = zdbDomManager.
            getKinyuuKikanInfoRnsByZrnkinyuukikancdKeta4Zrnsitencd("")){
            int iCount = 0;
            for (ZT_KinyuuKikanInfoRn zrnsitencd : beans) {
                if(zrnsitencd != null){
                    iCount++;
                }
            }
