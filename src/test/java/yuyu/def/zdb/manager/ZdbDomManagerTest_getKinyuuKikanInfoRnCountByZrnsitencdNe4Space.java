...
public class ZdbDomManagerTest_getKinyuuKikanInfoRnCountByZrnsitencdNe4Space {
    ...
    public static void insertTestData() {
        ...
        Long kinyuukikaninfoSize= zdbDomManager.getKinyuuKikanInfoRnCountByZrnsitencdNe4Space();

        Assert.assertEquals(0,kinyuukikaninfoSize.intValue());

        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn1 = new ZT_KinyuuKikanInfoRn("A001", "    ");
    ...
    public void normal1(){
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn2 = new ZT_KinyuuKikanInfoRn("A002", "0001");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn3 = new ZT_KinyuuKikanInfoRn("A003", "0211");
        ...
        ZT_KinyuuKikanInfoRn kinyuuKikanInfoRn4 = new ZT_KinyuuKikanInfoRn("A004", "0211");
