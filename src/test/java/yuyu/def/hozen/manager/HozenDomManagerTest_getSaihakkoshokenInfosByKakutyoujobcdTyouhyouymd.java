 ...
 * 契約保全<br />
 * 再発行証券Ｆ作成<br />
 * 再発行証券情報（大量）取得　新規再発行区分が再発行かつ証券再発行区分が証券再発行のテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class HozenDomManagerTest_getSaihakkoshokenInfosByKakutyoujobcdTyouhyouymd {

    @Inject
    HozenDomManager hozenDomManager;

    static String P_JOB_CD_01 = "JCD01";
    static String P_JOB_CD_02 = "RBT1";
    ...
    public static void insertTestData() {
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            getSaihakkoshokenInfosByKakutyoujobcdTyouhyouymd(P_JOB_CD_01, P_TYOUHYOUYMD_01)){
        ...
        iT_HokenSyouken11.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);
        ...
        iT_HokenSyouken21.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken21.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);

        IT_HokenSyouken iT_HokenSyouken22 = iT_KykKihon2.createHokenSyouken();
        iT_HokenSyouken22.setTyouhyouymd(P_TYOUHYOUYMD_02);
        iT_HokenSyouken22.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken22.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);

        IT_HokenSyouken iT_HokenSyouken23 = iT_KykKihon2.createHokenSyouken();
        iT_HokenSyouken23.setTyouhyouymd(P_TYOUHYOUYMD_03);
        iT_HokenSyouken23.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken23.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);
        ...
        iT_HokenSyouken31.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken31.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);

        IT_HokenSyouken iT_HokenSyouken32 = iT_KykKihon3.createHokenSyouken();
        iT_HokenSyouken32.setTyouhyouymd(P_TYOUHYOUYMD_03);
        iT_HokenSyouken32.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken32.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);
        ...
        iT_HokenSyouken41.setSinsaihkkbn(C_SinsaihkKbn.SAI);
        iT_HokenSyouken41.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);
        ...
        iT_HokenSyouken51.setSyoukensaihkkbn(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU);
        ...
        iT_HokenSyouken61.setSinsaihkkbn(C_SinsaihkKbn.SAI);
    ...
    public void noResult1() {
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            getSaihakkoshokenInfosByKakutyoujobcdTyouhyouymd(P_JOB_CD_01, BizDate.valueOf(20150303))){
    ...
    public void normal1() {
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            ...
            Iterator<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> iter = exDBResBean.iterator();
            SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean bean = null;
            int iCount = 0;
            while (iter.hasNext()) {
                ...
                if (1 == iCount) {
                    ...
                    Assert.assertEquals(C_SyoukensaihkKbn.SYOUKENSAIHAKKOU, bean.getIT_HokenSyouken().getSyoukensaihkkbn());
    ...
    public void normal2() {
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            getSaihakkoshokenInfosByKakutyoujobcdTyouhyouymd(P_JOB_CD_01, P_TYOUHYOUYMD_02)){
    ...
    public void testSkippedFilter40(){
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            getSaihakkoshokenInfosByKakutyoujobcdTyouhyouymd(P_JOB_CD_02, P_TYOUHYOUYMD_02)){
    ...
    public void testSkippedFilter51(){
        ...
        try(ExDBResults<SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean> exDBResBean = hozenDomManager.
            ...
            int iCount = 0;
            for (SaihakkoshokenInfosByKakutyoujobcdTyouhyouymdBean bean : exDBResBean) {
