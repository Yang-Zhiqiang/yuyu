 ...
 * getKhHenkouRirekiHenkousikibetukeyItemsBySyono() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class HozenDomManagerTest_getKhHenkouRirekiHenkousikibetukeyItemsBySyono {
    ...
    public static void preProcess() {
        ...
        int iCount = 0;
        List<KhHenkouRirekiHenkousikibetukeyItemsBySyonoBean> list = hozenDomManager.getKhHenkouRirekiHenkousikibetukeyItemsBySyono("11807111130");
    ...
    public void noResult1() {
        ...
        List<KhHenkouRirekiHenkousikibetukeyItemsBySyonoBean> list = hozenDomManager.getKhHenkouRirekiHenkousikibetukeyItemsBySyono("11807111119");
    ...
    public void normal21() {
        ...
        List<KhHenkouRirekiHenkousikibetukeyItemsBySyonoBean> list = hozenDomManager.getKhHenkouRirekiHenkousikibetukeyItemsBySyono("11807111118");

        Assert.assertEquals(1, list.size());
        Assert.assertEquals("111", list.get(0).getHenkousikibetukey());
    ...
    public void normal31() {
        ...
        List<KhHenkouRirekiHenkousikibetukeyItemsBySyonoBean> list = hozenDomManager.getKhHenkouRirekiHenkousikibetukeyItemsBySyono("11807111129");

        Assert.assertEquals(3, list.size());

        Assert.assertEquals("444", list.get(0).getHenkousikibetukey());
        Assert.assertEquals("ええええ", list.get(0).getBfrnaiyouoriginal());
        Assert.assertEquals("せせせせ", list.get(0).getNewnaiyouoriginal());
        Assert.assertEquals("333", list.get(1).getHenkousikibetukey());
        Assert.assertEquals("うううう", list.get(1).getBfrnaiyouoriginal());
        Assert.assertEquals("すすすす", list.get(1).getNewnaiyouoriginal());
        Assert.assertEquals("222", list.get(2).getHenkousikibetukey());
        Assert.assertEquals("いいいい", list.get(2).getBfrnaiyouoriginal());
        Assert.assertEquals("しししし", list.get(2).getNewnaiyouoriginal());
