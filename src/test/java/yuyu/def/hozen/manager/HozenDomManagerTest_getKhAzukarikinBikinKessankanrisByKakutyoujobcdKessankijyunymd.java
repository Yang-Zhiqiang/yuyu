 ...
 * 契約保全<br />
 * 契約保全預り金備金リスト作成<br />
 * 預り金備金決算管理テーブルエンティティリスト(大量)取得のテストクラス<br />
 */
@RunWith(OrderedRunner.class)
public class HozenDomManagerTest_getKhAzukarikinBikinKessankanrisByKakutyoujobcdKessankijyunymd {

    @Inject
    HozenDomManager hozenDomManager;

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getKhAzukarikinBikinKessankanrisByKakutyoujobcdKessankijyunymd";
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(HozenDomManagerTest_getKhAzukarikinBikinKessankanrisByKakutyoujobcdKessankijyunymd.class,
                fileName, sheetName);
    ...
    private void insertData(String pDate) {
        try {
            TestDataMaker testDataMaker = new TestDataMaker();
            HashMap<String, Map<String, List<Map<String, String>>>> testDataAndTblMap;
            testDataAndTblMap = testDataMaker.getInData(HozenDomManagerTest_getKhAzukarikinBikinKessankanrisByKakutyoujobcdKessankijyunymd.class, fileName, sheetName);
    ...
    public void noResult1() {
        ...
        try(ExDBResults<IT_AzukarikinKessankanri> exDBResBean = hozenDomManager.
            getKhAzukarikinBikinKessankanrisByKakutyoujobcdKessankijyunymd("RBGEX000", BizDate.valueOf(20190624))){
    ...
    public void skippedFilter1() {
        ...
        deleteData();
        BT_SkipKey bT_SkipKey1 = new BT_SkipKey("RBGEX000_IT_AzukarikinKessankanri_60806000103");
        bT_SkipKey1.setKakutyoujobcd("RBGEX000");
    ...
    public void skippedFilter2() {
        ...
        bT_SkipKey1.setRecoveryfilterkey1("60806000103");
        hozenDomManager.insert(bT_SkipKey1);
        BT_SkipKey bT_SkipKey2 = new BT_SkipKey("RBGEX000_IT_AzukarikinKessankanri_60806000206");
        bT_SkipKey2.setKakutyoujobcd("RBGEX000");
