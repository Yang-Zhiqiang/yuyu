 ...
 * getKykSyouhnsyutaniBySyono() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class HozenDomManagerTest_getKykSyouhnsyutaniBySyono {
    ...
    public static void insertTestData() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000032");
        Assert.assertEquals(0, kykSyouhnsyutaniBySyonoBeanLst.size());
        ...
        IT_KykSyouhn kykSyouhn17 = kykKihon6.createKykSyouhn();
        kykSyouhn17.setSyutkkbn(C_SyutkKbn.valueOf("2"));
        kykSyouhn17.setSyouhncd("M110");
        kykSyouhn17.setSyouhnsdno(1);
        kykSyouhn17.setKyksyouhnrenno(1);
        kykSyouhn17.setKouryokuhasseiymd(BizDate.valueOf(20140701));
        kykSyouhn17.setGyoumuKousinKinou("125");
    ...
    public void noResult1() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000087");
        Assert.assertEquals(0, kykSyouhnsyutaniBySyonoBeanLst.size());
    ...
    public void normal1() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000010");

        Assert.assertEquals(1, kykSyouhnsyutaniBySyonoBeanLst.size());
        Assert.assertEquals(BizDate.valueOf(20150201), kykSyouhnsyutaniBySyonoBeanLst.get(0).getKouryokuhasseiymd());
        Assert.assertEquals(null, kykSyouhnsyutaniBySyonoBeanLst.get(0).getGyoumuKousinKinou());
    ...
    public void normal2() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000065");

        Assert.assertEquals(1, kykSyouhnsyutaniBySyonoBeanLst.size());
        Assert.assertEquals(BizDate.valueOf(20140701), kykSyouhnsyutaniBySyonoBeanLst.get(0).getKouryokuhasseiymd());
        Assert.assertEquals("125", kykSyouhnsyutaniBySyonoBeanLst.get(0).getGyoumuKousinKinou());
    ...
    public void normal3() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000076");

        Assert.assertEquals(1, kykSyouhnsyutaniBySyonoBeanLst.size());
        Assert.assertEquals(BizDate.valueOf(20140702), kykSyouhnsyutaniBySyonoBeanLst.get(0).getKouryokuhasseiymd());
        Assert.assertEquals("125", kykSyouhnsyutaniBySyonoBeanLst.get(0).getGyoumuKousinKinou());
    ...
    public void normal5() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000021");

        for(KykSyouhnsyutaniBySyonoBean bean:kykSyouhnsyutaniBySyonoBeanLst){
    ...
    public void normal7() {
        ...
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("11807000043");
    ...
    public void blankCondition1() {
        List<KykSyouhnsyutaniBySyonoBean> kykSyouhnsyutaniBySyonoBeanLst = hozenDomManager.getKykSyouhnsyutaniBySyono("");
