 ...
 * getSkHubiDetailCountByMosnoTrkymdHasinymdKaisyouymd() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class SinkeiyakuDomManagerTest_getSkHubiDetailCountByMosnoTrkymdHasinymdKaisyouymd {
    ...
    public static void insertTestData() {
        ...
        Long count = sinkeiyakuDomManager.getSkHubiDetailCountByMosnoTrkymdHasinymdKaisyouymd("791112220");
        ...
        skHubiDetail2.setRenno3keta(115);
        skHubiDetail2.setTrkymd(BizDate.valueOf(20160215));
        skHubiDetail2.setHasinymd(BizDate.valueOf(20160115));

        HT_SkHubiDetail skHubiDetail3 = skHubi1.createSkHubiDetail();
        skHubiDetail3.setRenno3keta(112);
        skHubiDetail3.setHasinymd(BizDate.valueOf(20160115));

        HT_SkHubiDetail skHubiDetail4 = skHubi1.createSkHubiDetail();
        skHubiDetail4.setRenno3keta(113);
        ...
        skHubiDetail5.setKaisyouymd(BizDate.valueOf(20160215));
        ...
        skHubiDetail6.setTrkymd(BizDate.valueOf(20160215));
    ...
    public void noResult1() {
        Long count = sinkeiyakuDomManager.getSkHubiDetailCountByMosnoTrkymdHasinymdKaisyouymd("791112246");
        Assert.assertEquals(new Long(0), count);
    }
    ...
    public void blankCondition1() {
        Long count = sinkeiyakuDomManager.getSkHubiDetailCountByMosnoTrkymdHasinymdKaisyouymd("");
        Assert.assertEquals(new Long(0), count);
    }
}
