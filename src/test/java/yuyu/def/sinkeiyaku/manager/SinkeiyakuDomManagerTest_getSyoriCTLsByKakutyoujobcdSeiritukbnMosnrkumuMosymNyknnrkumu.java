 ...
 * getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class SinkeiyakuDomManagerTest_getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu {
    ...
    public static void insertTestData() {
        ...
        try (ExDBUpdatableResults<HT_SyoriCTL> beans =
            sinkeiyakuDomManager.getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu("RGH0", BizDateYM.valueOf(201609), BizDateYM.valueOf(201609))) {
        ...
        syoriCTL6.setNyknnrkumu(C_UmuKbn.valueOf("0"));
        ...
        syoriCTL9.setNyknnrkumu(C_UmuKbn.valueOf("1"));
    ...
    public void normal1() {
        ...
        ExDBUpdatableResults<HT_SyoriCTL> beans = sinkeiyakuDomManager.getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu("RGH0",
            BizDateYM.valueOf(201610), BizDateYM.valueOf(201610));
        ...
        for (HT_SyoriCTL syoriCTL : beans) {
            ...
            if (1 == iCount) {
                Assert.assertEquals("791112295", syoriCTL.getMosno());
            }
        }
    ...
    public void normal2() {
        ...
        datamap.put($("791112295"), "1");

        ExDBUpdatableResults<HT_SyoriCTL> beans = sinkeiyakuDomManager.getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu("RGH0",
            BizDateYM.valueOf(201612), BizDateYM.valueOf(201610));
    ...
    public void testSkippedFilter1() {
        ...
        int iCount = 0;
        try(ExDBUpdatableResults<HT_SyoriCTL> beans = sinkeiyakuDomManager.getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu(
            "RGH0", BizDateYM.valueOf(201612), BizDateYM.valueOf(201610));){
            for (HT_SyoriCTL syoriCTL : beans) {
                iCount++;
            }
    ...
    public void testSkippedFilter50(){
        ...
        key3.setRecoveryfilterkey1("791112295");
    ...
    public void testSkippedFilter51(){
        ...
        try(ExDBUpdatableResults<HT_SyoriCTL> beans = sinkeiyakuDomManager.getSyoriCTLsByKakutyoujobcdSeiritukbnMosnrkumuMosymNyknnrkumu(
            "RGH0", BizDateYM.valueOf(201612), BizDateYM.valueOf(201610));){
            for(HT_SyoriCTL syoriCTL : beans){
                assertNotEquals(syoriCTL.getMosno(), "791112295");
    ...
    public void testSkippedFilter60(){
        ...
        key1.setRecoveryfilterkey1("791112287");
