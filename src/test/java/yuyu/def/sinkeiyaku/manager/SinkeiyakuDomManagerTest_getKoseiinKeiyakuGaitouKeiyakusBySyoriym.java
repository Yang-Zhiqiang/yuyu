...
public class SinkeiyakuDomManagerTest_getKoseiinKeiyakuGaitouKeiyakusBySyoriym {
    ...
    public static void insertTestData() {
        ...
        List<HT_MosDairiten> mosDairitenLst = sinkeiyakuDomManager.getKoseiinKeiyakuGaitouKeiyakusBySyoriym(BizDateYM.valueOf(201507));
        Assert.assertEquals(0, mosDairitenLst.size());

        HT_SyoriCTL syoriCTL = new HT_SyoriCTL("10000000050");
        syoriCTL.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
        ...
        syoriCTL1.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
        ...
        syoriCTL2.setKouseiinkykkbn(C_KouseiinkykKbn.SBUKT_KOUSEIIN);
        ...
        syoriCTL3.setKouseiinkykkbn(C_KouseiinkykKbn.ANY_DAIRITENSYOKUIN);
        ...
        syoriCTL4.setKouseiinkykkbn(C_KouseiinkykKbn.STDRSK_BOSYUU);
        ...
        syoriCTL5.setKouseiinkykkbn(C_KouseiinkykKbn.SBUKT_STDRSK);
        ...
        syoriCTL6.setKouseiinkykkbn(C_KouseiinkykKbn.GAITOUNASI);
        ...
        syoriCTL7.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
        ...
        syoriCTL8.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
        ...
        syoriCTL9.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
        ...
        syoriCTL10.setKouseiinkykkbn(C_KouseiinkykKbn.HHKN_KOUSEIIN);
    ...
    public void noResult1() {
        ...
        List<HT_MosDairiten> mosDairitenLst = sinkeiyakuDomManager.getKoseiinKeiyakuGaitouKeiyakusBySyoriym(BizDateYM.valueOf(201506));
        Assert.assertEquals(0, mosDairitenLst.size());
    ...
    public void normal1() {
        ...
        List<HT_MosDairiten> mosDairitenLst = sinkeiyakuDomManager.getKoseiinKeiyakuGaitouKeiyakusBySyoriym(BizDateYM.valueOf(201508));
