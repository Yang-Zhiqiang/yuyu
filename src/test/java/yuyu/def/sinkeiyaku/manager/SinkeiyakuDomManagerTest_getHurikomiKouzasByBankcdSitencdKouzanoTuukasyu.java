...
public class SinkeiyakuDomManagerTest_getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu {
    ...
    public static void insertTestData() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0001", "123", "1234567", C_Tuukasyu.JPY);
        ...
        hurikomiKouza8.setKouzano("001234567");
        hurikomiKouza8.setTuukasyu(C_Tuukasyu.JPY);
        hurikomiKouza8.setHrkmirnincd("hk0008");

        sinkeiyakuDomManager.insert(hurikomiKouza8);

        HM_HurikomiKouza hurikomiKouza9 = new HM_HurikomiKouza();
        hurikomiKouza9.setBankcd("0001");
        hurikomiKouza9.setSitencd("123");
        hurikomiKouza9.setKouzano("0001234567");
        hurikomiKouza9.setTuukasyu(C_Tuukasyu.JPY);
        hurikomiKouza9.setHrkmirnincd("hk0009");

        sinkeiyakuDomManager.insert(hurikomiKouza9);
    ...
    public void noResult1() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0003", "123", "1234567", C_Tuukasyu.JPY);
        Assert.assertEquals(0, hurikomiKouzaLst.size());
    ...
    public void normal1() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0002", "123", "0001234567", C_Tuukasyu.JPY);
    ...
    public void normal2() {
        ...
        datamap.put($("0001","123","001234567",C_Tuukasyu.JPY,"hk0008"), "1");
        datamap.put($("0001","123","0001234567",C_Tuukasyu.JPY,"hk0009"), "1");

        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0001", "123", "0001234567", C_Tuukasyu.JPY);
        ...
        Assert.assertEquals(5, hurikomiKouzaLst.size());
    ...
    public void blank1() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("", "123", "1234567", C_Tuukasyu.JPY);
        Assert.assertEquals(0, hurikomiKouzaLst.size());
    ...
    public void blank2() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0001", "", "1234567", C_Tuukasyu.JPY);
        Assert.assertEquals(0, hurikomiKouzaLst.size());
    ...
    public void blank3() {
        ...
        List<HM_HurikomiKouza> hurikomiKouzaLst = sinkeiyakuDomManager.getHurikomiKouzasByBankcdSitencdKouzanoTuukasyu("0001", "123", "", C_Tuukasyu.JPY);
        Assert.assertEquals(0, hurikomiKouzaLst.size());
