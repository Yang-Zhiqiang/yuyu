 ...
 * getSmbcStyKanrisBySyonoRendouflg() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class SinkeiyakuDomManagerTest_getSmbcStyKanrisBySyonoRendouflg {
    ...
    public static void insertTestData() {
        ...
        List<HT_SmbcStyKanri> smbcStyKanriLst = sinkeiyakuDomManager.getSmbcStyKanrisBySyonoRendouflg("11807111118");
    ...
    public void noResult1(){
        ...
        List<HT_SmbcStyKanri> smbcStyKanriLst = sinkeiyakuDomManager.getSmbcStyKanrisBySyonoRendouflg("11807111141");
    ...
    public void normal2(){
        ...
        List<HT_SmbcStyKanri> smbcStyKanriLst = sinkeiyakuDomManager.getSmbcStyKanrisBySyonoRendouflg("11807111130");
    ...
    public void blankCondition1() {
        ...
        List<HT_SmbcStyKanri> smbcStyKanriLst = sinkeiyakuDomManager.getSmbcStyKanrisBySyonoRendouflg("");
