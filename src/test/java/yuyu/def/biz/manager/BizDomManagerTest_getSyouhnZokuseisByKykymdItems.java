 ...
 * getSyouhnZokuseisByKykymdItems() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getSyouhnZokuseisByKykymdItems {

    @Inject
    BizDomManager bizDomManager;

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getSyouhnZokuseisByKykymdItems";
    ...
    public static void preProcess() {
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisByKykymdItems(BizDate.valueOf(20160811), C_SyutkKbn.TK,
    ...
    public static void insertTestData() {
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getSyouhnZokuseisByKykymdItems.class,
                fileName, sheetName);
    ...
    public void noResult1(){
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisByKykymdItems(BizDate.valueOf(20160817), C_SyutkKbn.SYU,
            C_HknsyuruiNo.GAIKAITIJIBRIHENGAKUNK_BLEND, 11, 11,C_Tuukasyu.AUD,C_UmuKbn.ARI, C_Sknenkinsyu.KKTI5, C_UmuKbn.ARI);
    ...
    public void normal2(){
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisByKykymdItems(BizDate.valueOf(20160810), C_SyutkKbn.SYU,
            C_HknsyuruiNo.GAIKAITIJIBRIHENGAKUNK_BLEND, 11, 11,C_Tuukasyu.AUD,C_UmuKbn.ARI, C_Sknenkinsyu.KKTI5, C_UmuKbn.ARI);
