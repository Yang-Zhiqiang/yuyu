...
public class BizDomManagerTest_getChkJhNenreiHani2CountByPkHhknsei {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkJhNenreiHani2CountByPkHhknsei";
    ...
    public static void preProcess() {
        ...
        Long count = bizDomManager.getChkJhNenreiHani2CountByPkHhknsei(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
            4,
    ...
    public static void insertSubData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkJhNenreiHani2CountByPkHhknsei.class,
                fileName, sheetName);
