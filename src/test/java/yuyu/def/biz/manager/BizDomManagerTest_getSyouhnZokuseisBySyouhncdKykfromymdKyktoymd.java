 ...
 * getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd {
    ...
    public static void insertTestData() {
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd("1001", BizDate.valueOf(20160215));
    ...
    public void noResult1(){
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd("1001", BizDate.valueOf(20160217));
    ...
    public void normal2(){
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd("1003", BizDate.valueOf(20160223));
    ...
    public void blankCondition1() {
        ...
        List<BM_SyouhnZokusei> syouhnZokuseiLst = bizDomManager.getSyouhnZokuseisBySyouhncdKykfromymdKyktoymd("", BizDate.valueOf(20160215));
