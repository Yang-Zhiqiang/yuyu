 ...
 * getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu";
    ...
    public static void preProcess() {
        ...
        List<BM_ChkNenreiHani2> chkNenreiHani2List = bizDomManager.getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
    ...
    public static void insertSubData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu.class,
                fileName, sheetName);
    ...
    public void normal3() {
        ...
        chkNenreiHani2List = bizDomManager.getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumu(
            C_Channelcd.SMTB,
            "ｱ1",
            10,
            BizNumber.valueOf(30),
