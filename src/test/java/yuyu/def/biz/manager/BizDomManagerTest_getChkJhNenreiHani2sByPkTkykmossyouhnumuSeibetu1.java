 ...
 * getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1 {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1";
    ...
    public static void preProcess() {
        ...
        List<BM_ChkJhNenreiHani2> chkJhNenreiHani2List = bizDomManager.getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
            C_KataKbn.HONNIN,
    ...
    public static void insertSubData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1.class,
                fileName, sheetName);
    ...
    public void normal3() {
        ...
        exBizCalcbleEquals(chkJhNenreiHani2List.get(0).getSyuyoteiriritufrom(), BizNumber.valueOf(1.1233), "主契約予定利率自");
        exBizCalcbleEquals(chkJhNenreiHani2List.get(0).getSyuyoteirirituto(), BizNumber.valueOf(1.1235), "主契約予定利率至");
        exNumericEquals(chkJhNenreiHani2List.get(0).getSyudai1hknkkn(), 7, "主契約第１保険期間");
    ...
    public void blankCondition() {
        ...
        chkJhNenreiHani2List = bizDomManager.getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu1(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
            C_KataKbn.HONNIN,
