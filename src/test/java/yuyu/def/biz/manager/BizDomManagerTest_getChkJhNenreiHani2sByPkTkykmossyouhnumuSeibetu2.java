 ...
 * getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2 {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2";
    ...
    public static void preProcess() {
        ...
        List<BM_ChkJhNenreiHani2> chkJhNenreiHani2List = bizDomManager.getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
            C_KataKbn.HONNIN,
    ...
    public static void insertSubData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2.class,
                fileName, sheetName);
    ...
    public void blankCondition() {
        ...
        chkJhNenreiHani2List = bizDomManager.getChkJhNenreiHani2sByPkTkykmossyouhnumuSeibetu2(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
            C_KataKbn.HONNIN,
