...
public class BizDomManagerTest_getSjkkkTyouseiyouRiritusByPk2 {
    ...
    public static void insertTestData() {
        ...
        List<BM_SjkkkTyouseiyouRiritu> BM_SjkkkTyouseiyouRiritu = bizDomManager.getSjkkkTyouseiyouRiritusByPk("01",
            C_Tuukasyu.JPY, C_HhknNenKbn.BLNK, BizDate.valueOf(20161022));

        Assert.assertEquals(0,BM_SjkkkTyouseiyouRiritu.size());

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu1 = new BM_SjkkkTyouseiyouRiritu("01", C_Tuukasyu.JPY,
            C_HhknNenKbn.BLNK, BizDate.valueOf(20161020), BizDate.valueOf(20161024));

        bizDomManager.insert(sjkkkTyouseiyouRiritu1);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu2 = new BM_SjkkkTyouseiyouRiritu("02", C_Tuukasyu.EUR,
            C_HhknNenKbn.NANAJYUUGOSAIIKA, BizDate.valueOf(20160702), BizDate.valueOf(20160704));

        bizDomManager.insert(sjkkkTyouseiyouRiritu2);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu3 = new BM_SjkkkTyouseiyouRiritu("02", C_Tuukasyu.EUR,
            C_HhknNenKbn.NANAJYUUGOSAIIKA, BizDate.valueOf(20160703), BizDate.valueOf(20160704));

        bizDomManager.insert(sjkkkTyouseiyouRiritu3);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu4 = new BM_SjkkkTyouseiyouRiritu("02", C_Tuukasyu.EUR,
            C_HhknNenKbn.NANAJYUUGOSAIIKA, BizDate.valueOf(20160702), BizDate.valueOf(20160703));

        bizDomManager.insert(sjkkkTyouseiyouRiritu4);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu5 = new BM_SjkkkTyouseiyouRiritu("03", C_Tuukasyu.JPY,
            C_HhknNenKbn.BLNK, BizDate.valueOf(20161020), BizDate.valueOf(20161024));

        bizDomManager.insert(sjkkkTyouseiyouRiritu5);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu6 = new BM_SjkkkTyouseiyouRiritu("01", C_Tuukasyu.USD,
            C_HhknNenKbn.BLNK, BizDate.valueOf(20161020), BizDate.valueOf(20161024));

        bizDomManager.insert(sjkkkTyouseiyouRiritu6);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu7 = new BM_SjkkkTyouseiyouRiritu("01", C_Tuukasyu.JPY,
            C_HhknNenKbn.NANAJYUUROKUSAIIJYOU, BizDate.valueOf(20161020), BizDate.valueOf(20161024));

        bizDomManager.insert(sjkkkTyouseiyouRiritu7);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu8 = new BM_SjkkkTyouseiyouRiritu("01", C_Tuukasyu.JPY,
            C_HhknNenKbn.BLNK, BizDate.valueOf(20161023), BizDate.valueOf(20161024));

        bizDomManager.insert(sjkkkTyouseiyouRiritu8);

        BM_SjkkkTyouseiyouRiritu sjkkkTyouseiyouRiritu9 = new BM_SjkkkTyouseiyouRiritu("01", C_Tuukasyu.JPY,
            C_HhknNenKbn.BLNK, BizDate.valueOf(20161020), BizDate.valueOf(20161021));
    ...
    public void normal1(){
        ...
        assertEquals(C_HhknNenKbn.BLNK, BM_SjkkkTyouseiyouRiritu.get(0).getHhknnenkbn());
        assertEquals(BizDate.valueOf(20161020), BM_SjkkkTyouseiyouRiritu.get(0).getKykfromymd());
        assertEquals(BizDate.valueOf(20161024), BM_SjkkkTyouseiyouRiritu.get(0).getKyktoymd());
    }
    @Test
    @TestOrder(30)
    public void normal2(){
        ...
        List<BM_SjkkkTyouseiyouRiritu> BM_SjkkkTyouseiyouRiritu  = bizDomManager.getSjkkkTyouseiyouRiritusByPk("02",
            C_Tuukasyu.EUR, C_HhknNenKbn.NANAJYUUGOSAIIKA, BizDate.valueOf(20160703));

        Assert.assertEquals(3,BM_SjkkkTyouseiyouRiritu.size());

        Map<String,String> map = new HashMap<String,String>();
        map.put($("02",C_Tuukasyu.valueOf("EUR"),C_HhknNenKbn.NANAJYUUGOSAIIKA,BizDate.valueOf(20160702),BizDate.valueOf(20160703)), "1");
        map.put($("02",C_Tuukasyu.valueOf("EUR"),C_HhknNenKbn.NANAJYUUGOSAIIKA,BizDate.valueOf(20160702),BizDate.valueOf(20160704)), "1");
        map.put($("02",C_Tuukasyu.valueOf("EUR"),C_HhknNenKbn.NANAJYUUGOSAIIKA,BizDate.valueOf(20160703),BizDate.valueOf(20160704)), "1");
