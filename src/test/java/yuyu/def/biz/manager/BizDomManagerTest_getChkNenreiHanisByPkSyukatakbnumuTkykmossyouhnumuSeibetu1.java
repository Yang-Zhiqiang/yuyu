 ...
 * 新契約<br />
 * 申込商品TBLチェック<br />
 * 年齢範囲チェックマスタエンティティリスト取得　主キー範囲、主契約型区分有無、特約申込商品情報有無、性別のテストクラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1 {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1";
    ...
    private final static BizNumber      nen5              = BizNumber.valueOf(32);
    ...
    public static void preProcess() {
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd1, syusyouhncd1, syouhnsdno1, nen1, seibetu1, syukatakbn1, syuhknkkn1, syuhknkknsmnkbn1,
            syuhrkkkn1, syuhrkkknsmnkbn1, syuyoteiriritu1, tksyouhncd1, tkhknkkn1, tkhknkknsmnkbn1, tkhrkkkn1, tkhrkkknsmnkbn1,
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1.class, fileName,
                sheetName);
    ...
    public void normal1() {
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst1 = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd1, syusyouhncd1, syouhnsdno1, nen1, seibetu1, syukatakbn1, syuhknkkn1, syuhknkknsmnkbn1,
            syuhrkkkn1, syuhrkkknsmnkbn1, syuyoteiriritu1, tksyouhncd1, tkhknkkn1, tkhknkknsmnkbn1, tkhrkkkn1,
            tkhrkkknsmnkbn1, syukatakbnumu1, tkykmossyouhnumu1);
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst2 = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd3, syusyouhncd3, syouhnsdno3, nen3, seibetu3, syukatakbn3, syuhknkkn3, syuhknkknsmnkbn3,
            syuhrkkkn3, syuhrkkknsmnkbn3, syuyoteiriritu1, tksyouhncd3, tkhknkkn3, tkhknkknsmnkbn3, tkhrkkkn3,
            tkhrkkknsmnkbn3, syukatakbnumu3, tkykmossyouhnumu3);
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst3 = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd4, syusyouhncd4, syouhnsdno4, nen4, seibetu4, syukatakbn4, syuhknkkn4, syuhknkknsmnkbn4,
            syuhrkkkn4, syuhrkkknsmnkbn4, syuyoteiriritu1, tksyouhncd4, tkhknkkn4, tkhknkknsmnkbn4, tkhrkkkn4,
            tkhrkkknsmnkbn4, syukatakbnumu4, tkykmossyouhnumu4);
    ...
    public void normal2() {
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            ...
            syuhrkkkn5, syuhrkkknsmnkbn5, syuyoteiriritu1, tksyouhncd5, tkhknkkn5, tkhknkknsmnkbn5, tkhrkkkn5,
            tkhrkkknsmnkbn5, syukatakbnumu5, tkykmossyouhnumu5);

        Assert.assertEquals(4, chkNenreiHaniLst.size());

        Map<String,String> map = new HashMap<String,String>();

        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 19, 20, 1, 2, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12, C_HrkkknsmnKbn.BLNK, Bn(31), Bn(32), Bn(1.1111), Bn(1.1112), Bn(10), "E002", Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36, C_HrkkknsmnKbn.BLNK, Bn(31), Bn(32)), "1");
        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 19, 21, 1, 3, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12, C_HrkkknsmnKbn.BLNK, Bn(31), Bn(33), Bn(1.1111), Bn(1.1113), Bn(10), "E002", Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36, C_HrkkknsmnKbn.BLNK, Bn(31), Bn(33)), "1");
        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 20, 20, 2, 2, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12, C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), Bn(1.1112), Bn(1.1112), Bn(10), "E002", Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36, C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32)), "1");
        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 20, 21, 2, 3, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12, C_HrkkknsmnKbn.BLNK, Bn(32), Bn(33), Bn(1.1112), Bn(1.1113), Bn(10), "E002", Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36, C_HrkkknsmnKbn.BLNK, Bn(32), Bn(33)), "1");
    ...
    public void blankCondition1() {
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd1, "", syouhnsdno1, nen1, seibetu1, syukatakbn1, syuhknkkn1, syuhknkknsmnkbn1,
            syuhrkkkn1, syuhrkkknsmnkbn1, syuyoteiriritu1, tksyouhncd1, tkhknkkn1, tkhknkknsmnkbn1, tkhrkkkn1, tkhrkkknsmnkbn1,
            syukatakbnumu1, tkykmossyouhnumu1);
    ...
    public void blankCondition2() {
        ...
        List<BM_ChkNenreiHani> chkNenreiHaniLst = bizDomManager.getChkNenreiHanisByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            channelcd1, syusyouhncd1, syouhnsdno1, nen1, seibetu1, syukatakbn1, syuhknkkn1, syuhknkknsmnkbn1,
            syuhrkkkn1, syuhrkkknsmnkbn1, syuyoteiriritu1, "", tkhknkkn1, tkhknkknsmnkbn1, tkhrkkkn1, tkhrkkknsmnkbn1,
            syukatakbnumu1, tkykmossyouhnumu1);
