 ...
 * 新契約<br />
 * 申込商品TBLチェック<br />
 * 年齢範囲事方書チェックマスタエンティティリスト取得 主キー範囲、特約申込商品情報有無、性別、年齢なしのテストクラスです。<br />
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2 {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2";
    ...
    public static void preProcess() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.SMBC,
            "M210", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.NENMANKI, 8, C_HrkkknsmnKbn.NENMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.ARI, "M310", BizNumber.valueOf(28),
            C_HknkknsmnKbn.NENMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.NENMANKI);
    ...
    public static void insertTestData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2.class, fileName,
                sheetName);
    ...
    public void noResult1() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.SHOP,
            "M210", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.NENMANKI, 8, C_HrkkknsmnKbn.NENMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.ARI, "M310", BizNumber.valueOf(28),
            C_HknkknsmnKbn.NENMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.NENMANKI);
    ...
    public void normal1() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst1 = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.SMBC,
            "M210", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.NENMANKI, 8, C_HrkkknsmnKbn.NENMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.ARI, "M310", BizNumber.valueOf(28),
            C_HknkknsmnKbn.NENMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.NENMANKI);
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst2 = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.TIGIN,
            "M890", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.SAIMANKI, 8, C_HrkkknsmnKbn.SAIMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.NONE, "M000", BizNumber.valueOf(28),
            C_HknkknsmnKbn.SAIMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.SAIMANKI);
    ...
    public void normal2() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.YUUSEIGINKOU,
            "E001", 20, C_KataKbn.HONIN_KO, 8, C_HknkknsmnKbn.BLNK, 12, C_HrkkknsmnKbn.BLNK, 2,
            BizNumber.valueOf(1.4567), C_UmuKbn.ARI, "E002", BizNumber.valueOf(38),
            C_HknkknsmnKbn.BLNK, BizNumber.valueOf(36), C_HrkkknsmnKbn.BLNK);

        Assert.assertEquals(4, chkJhNenreiHaniLst.size());

        Map<String,String> map = new HashMap<String,String>();

        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 19, 20, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), Bn(1.4566), Bn(1.4567), Bn(10), "E002",
            Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), 2, 3), "1");

        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 19, 21, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), Bn(1.4566), Bn(1.4568), Bn(10), "E002",
            Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36,
        ...
        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 20, 20, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12,
            ...
            Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), 1, 2), "1");

        map.put($(C_Channelcd.YUUSEIGINKOU, "E001", 20, 21, C_KataKbn.HONIN_KO, 8, 8, C_HknkknsmnKbn.BLNK, 12, 12,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), Bn(1.4567), Bn(1.4568), Bn(10), "E002",
            Bn(38), 38, C_HknkknsmnKbn.BLNK, Bn(36), 36,
            C_HrkkknsmnKbn.BLNK, Bn(32), Bn(32), 1, 3), "1");
    ...
    public void blankCondition1() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.SHOP,
            "", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.NENMANKI, 8, C_HrkkknsmnKbn.NENMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.ARI, "M310", BizNumber.valueOf(28),
            C_HknkknsmnKbn.NENMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.NENMANKI);
    ...
    public void blankCondition2() {
        ...
        List<BM_ChkJhNenreiHani> chkJhNenreiHaniLst = bizDomManager.getChkJhNenreiHanisByPkTkykmossyouhnumuSeibetu2(C_Channelcd.SHOP,
            "M210", 10, C_KataKbn.HONIN_KO, 4, C_HknkknsmnKbn.NENMANKI, 8, C_HrkkknsmnKbn.NENMANKI, 1,
            BizNumber.valueOf(1.1235), C_UmuKbn.ARI, "", BizNumber.valueOf(28),
            C_HknkknsmnKbn.NENMANKI, BizNumber.valueOf(26), C_HrkkknsmnKbn.NENMANKI);
