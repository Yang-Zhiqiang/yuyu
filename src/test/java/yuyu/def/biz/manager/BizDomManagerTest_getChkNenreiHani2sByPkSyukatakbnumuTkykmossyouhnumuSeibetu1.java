 ...
 * getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1() メソッドのテストクラスです。
 */
@RunWith(OrderedRunner.class)
public class BizDomManagerTest_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1 {

    private final static String fileName = "UT-SP_単体テスト仕様書（DomManager）_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1";
    ...
    public static void preProcess() {
        ...
        List<BM_ChkNenreiHani2> chkNenreiHani2List = bizDomManager.getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            C_Channelcd.SMBC,
            "ｱ1",
            10,
    ...
    public static void insertSubData() {
        ...
        try {
            ...
            testDataAndTblMap = testDataMaker.getInData(BizDomManagerTest_getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1.class,
                fileName, sheetName);
    ...
    public void normal3() {
        ...
        chkNenreiHani2List = bizDomManager.getChkNenreiHani2sByPkSyukatakbnumuTkykmossyouhnumuSeibetu1(
            C_Channelcd.SMTB,
            "ｱ1",
            10,
            BizNumber.valueOf(30),
