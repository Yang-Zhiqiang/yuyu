...
public class MT_DsKokyakuKanriTest_getDsHaisinErrorListsByDsdatasakuseiymd {
    ...
    public static void insertTestData() {
        ...
        if (dsKokyakuKanri1 == null) {
            ...
            List<MT_DsHaisinErrorList> dsHaisinErrorListLst = dsKokyakuKanri1.getDsHaisinErrorListsByDsdatasakuseiymd(BizDate.valueOf(20161015));
            ...
            dsHaisinErrorList2.setDsdatasakuseiymd(BizDate.valueOf(20161016));
            dsHaisinErrorList2.setDsmailaddressrenban(2001);
            ...
            dsHaisinErrorList4.setDsdatasakuseiymd(BizDate.valueOf(20161017));
            dsHaisinErrorList4.setDsmailaddressrenban(2003);

            MT_DsHaisinErrorList dsHaisinErrorList5 = dsKokyakuKanri1.createDsHaisinErrorList();
            dsHaisinErrorList5.setDsdatasakuseiymd(BizDate.valueOf(20161017));
            dsHaisinErrorList5.setDsmailaddressrenban(2004);
    ...
    public void noResult1() {
        ...
        MT_DsKokyakuKanri dsKokyakuKanri1 = directDomManager.getDsKokyakuKanri("100001");
        List<MT_DsHaisinErrorList> dsHaisinErrorListLst = dsKokyakuKanri1.getDsHaisinErrorListsByDsdatasakuseiymd(BizDate.valueOf(20161020));
    ...
    public void normal2() {
        ...
        MT_DsKokyakuKanri dsKokyakuKanri1 = directDomManager.getDsKokyakuKanri("100001");
        List<MT_DsHaisinErrorList> dsHaisinErrorListLst = dsKokyakuKanri1.getDsHaisinErrorListsByDsdatasakuseiymd(BizDate.valueOf(20161017));
        ...
        Assert.assertEquals(BizDate.valueOf(20161017), dsHaisinErrorListLst.get(1).getDsdatasakuseiymd());
        Assert.assertEquals("100001", dsHaisinErrorListLst.get(1).getDskokno());
        Assert.assertEquals(2003, dsHaisinErrorListLst.get(1).getDsmailaddressrenban().intValue());

        Assert.assertEquals(BizDate.valueOf(20161017), dsHaisinErrorListLst.get(2).getDsdatasakuseiymd());
        Assert.assertEquals("100001", dsHaisinErrorListLst.get(2).getDskokno());
        Assert.assertEquals(2004, dsHaisinErrorListLst.get(2).getDsmailaddressrenban().intValue());
    }
}
