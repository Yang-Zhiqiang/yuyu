...
public class HT_SyoriCTLTest_getHenkinSumHnkngkByHnkntuukasyuHnknsyoriymdLe {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnkntuukasyuHnknsyoriymdLe(C_Tuukasyu.JPY, BizDate.valueOf(20150405));
            ...
            henkin3.setRenno(3);
            henkin3.setHnknsyoriymd(BizDate.valueOf(20150404));
            ...
            henkin4.setRenno(4);
            henkin4.setHnknsyoriymd(BizDate.valueOf(20150406));
            ...
            henkin7.setRenno(7);
            henkin7.setHnknsyoriymd(BizDate.valueOf(20160404));
            ...
            henkin8.setRenno(8);
            henkin8.setHnknsyoriymd(BizDate.valueOf(20160403));
            ...
            henkin9.setRenno(9);
            henkin9.setHnknsyoriymd(BizDate.valueOf(20160402));
            ...
            henkin16.setHnknsyoriymd(BizDate.valueOf(20160405));
    ...
    public void noResult1() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnkntuukasyuHnknsyoriymdLe(C_Tuukasyu.JPY, BizDate.valueOf(20150403));
        Assert.assertEquals(0, sumHnkngkMap.size());
    }
    ...
    public void normal2() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnkntuukasyuHnknsyoriymdLe(C_Tuukasyu.JPY, BizDate.valueOf(20160405));
