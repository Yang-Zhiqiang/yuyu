...
public class HT_SyoriCTLTest_getNyuukinSumRsgakuByRstuukasyuNyksyoriymd {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumRsgakuMap = syoriCTL1.getNyuukinSumRsgakuByRstuukasyuNyksyoriymd(C_Tuukasyu.JPY,
                    BizDate.valueOf(20150405));
            ...
            nyuukin4.setRenno(4);
            nyuukin4.setNyksyoriymd(BizDate.valueOf(20150405));
            nyuukin4.setRsgaku(BizCurrency.valueOf(100, BizCurrencyTypes.YEN));
            nyuukin4.setRstuukasyu(C_Tuukasyu.valueOf("USD"));

            HT_Nyuukin nyuukin5 = syoriCTL1.createNyuukin();
            nyuukin5.setRenno(5);
            nyuukin5.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin5.setRsgaku(BizCurrency.valueOf(100, BizCurrencyTypes.YEN));
            nyuukin5.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin6 = syoriCTL1.createNyuukin();
            nyuukin6.setRenno(6);
            nyuukin6.setNyksyoriymd(BizDate.valueOf(20160404));
            nyuukin6.setRsgaku(BizCurrency.valueOf(0, BizCurrencyTypes.YEN));
            nyuukin6.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin7 = syoriCTL1.createNyuukin();
            nyuukin7.setRenno(7);
            nyuukin7.setNyksyoriymd(BizDate.valueOf(20160403));
            nyuukin7.setRsgaku(BizCurrency.valueOf(25, BizCurrencyTypes.MANYEN));
            nyuukin7.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin8 = syoriCTL1.createNyuukin();
            nyuukin8.setRenno(8);
            nyuukin8.setNyksyoriymd(BizDate.valueOf(20160402));
            nyuukin8.setRsgaku(BizCurrency.valueOf(34, BizCurrencyTypes.MANYEN));
            ...
            nyuukin9.setRsgaku(BizCurrency.valueOf(77.5, BizCurrencyTypes.DOLLAR));
            nyuukin9.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin10 = syoriCTL1.createNyuukin();
            nyuukin10.setRenno(10);
            nyuukin10.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin10.setRsgaku(BizCurrency.valueOf(22.5, BizCurrencyTypes.DOLLAR));
            nyuukin10.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin11 = syoriCTL1.createNyuukin();
            nyuukin11.setRenno(11);
            nyuukin11.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin11.setRsgaku(BizCurrency.valueOf(0, BizCurrencyTypes.AU_DOLLAR));
            nyuukin11.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin12 = syoriCTL1.createNyuukin();
            nyuukin12.setRenno(12);
            nyuukin12.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin12.setRsgaku(BizCurrency.valueOf(400, BizCurrencyTypes.AU_DOLLAR));
            nyuukin12.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin13 = syoriCTL1.createNyuukin();
            nyuukin13.setRenno(13);
            nyuukin13.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin13.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin14 = syoriCTL1.createNyuukin();
            nyuukin14.setRenno(14);
            nyuukin14.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin14.setRsgaku(BizCurrency.valueOf(600, BizCurrencyTypes.EURO));
            nyuukin14.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin15 = syoriCTL1.createNyuukin();
            nyuukin15.setRenno(15);
            nyuukin15.setNyksyoriymd(BizDate.valueOf(20160405));
            nyuukin15.setRsgaku(BizCurrency.valueOf(1000, BizCurrencyTypes.EURO));
            nyuukin15.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));

            HT_Nyuukin nyuukin16 = syoriCTL1.createNyuukin();
            nyuukin16.setRenno(16);
            nyuukin16.setRsgaku(BizCurrency.valueOf(300, BizCurrencyTypes.YEN));
            nyuukin16.setRstuukasyu(C_Tuukasyu.valueOf("JPY"));
