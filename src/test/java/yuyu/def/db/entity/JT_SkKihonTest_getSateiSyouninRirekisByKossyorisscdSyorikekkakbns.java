...
public class JT_SkKihonTest_getSateiSyouninRirekisByKossyorisscdSyorikekkakbns {

    @Inject
    private SiharaiDomManager siharaiDomManager;

    private final static C_SyorikekkaKbn[] syorikekkaKbn1 = {C_SyorikekkaKbn.BLNK};
    private final static C_SyorikekkaKbn[] syorikekkaKbn2 = {C_SyorikekkaKbn.HORYUU, C_SyorikekkaKbn.HUBI};
    private final static C_SyorikekkaKbn[] syorikekkaKbn3 = {C_SyorikekkaKbn.BLNK, C_SyorikekkaKbn.HORYUU, C_SyorikekkaKbn.HUBI};
    ...
    public static void insertTestData() {
        ...
        if (skKihon1 == null) {
            ...
            Assert.assertEquals(0, skKihon1.getSateiSyouninRirekisByKossyorisscdSyorikekkakbns("K001", syorikekkaKbn1).size());
            ...
            sateiSyouninRireki2.setSyorikekkakbn(C_SyorikekkaKbn.KAKUNIN);
        ...
        sateiSyouninRireki4.setSyorikekkakbn(C_SyorikekkaKbn.BLNK);
        ...
        sateiSyouninRireki5.setSyorikekkakbn(C_SyorikekkaKbn.HORYUU);
        sateiSyouninRireki5.setKossyorisscd("K003");
    ...
    public void noResult1() {
        ...
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisByKossyorisscdSyorikekkakbns("K001", syorikekkaKbn2);
    ...
    public void normal1() {
        JT_SkKihon SkKihon = siharaiDomManager.getSkKihon("10000000001", "11807111118");
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisByKossyorisscdSyorikekkakbns("K001",syorikekkaKbn3);
    ...
    public void normal2() {
        ...
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisByKossyorisscdSyorikekkakbns("K003", syorikekkaKbn3);
    ...
    public void blankCondition() {
        JT_SkKihon SkKihon = siharaiDomManager.getSkKihon("10000000002", "11807111129");
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisByKossyorisscdSyorikekkakbns("", syorikekkaKbn1);
