...
public class HT_SkHubiTest_getSkHubiDetailsByKaisyouymd {
    @Inject
    ...
    public static void insertTestData() {
        ...
        if (syoriCTLLst.size() == 0) {
            ...
            List<HT_SkHubiDetail> skHubiDetailLst = skHubi.getSkHubiDetailsByKaisyouymd(BizDate.valueOf("20150201"));

            Assert.assertEquals(0, skHubiDetailLst.size());

            HT_SkHubiDetail skHubiDetail = skHubi.createSkHubiDetail();
            skHubiDetail.setRenno3keta(2);
            skHubiDetail.setKaisyouymd(BizDate.valueOf("20150201"));

            HT_SkHubiDetail skHubiDetail2 = skHubi.createSkHubiDetail();
            skHubiDetail2.setRenno3keta(3);
            skHubiDetail2.setKaisyouymd(BizDate.valueOf("20150201"));

            HT_SkHubiDetail skHubiDetail3 = skHubi.createSkHubiDetail();
            skHubiDetail3.setRenno3keta(4);
            skHubiDetail3.setKaisyouymd(BizDate.valueOf("20150201"));

            HT_SkHubiDetail skHubiDetail4 = skHubi.createSkHubiDetail();
            skHubiDetail4.setRenno3keta(5);
            skHubiDetail4.setKaisyouymd(BizDate.valueOf("20150301"));
            ...
            skHubiDetail5.setKaisyouymd(null);

            HT_SkHubiDetail skHubiDetail7 = skHubi2.createSkHubiDetail();
            skHubiDetail7.setRenno3keta(2);
            skHubiDetail7.setKaisyouymd(BizDate.valueOf("20150501"));
    ...
    public void noResult1() {
        ...
        List<HT_SkHubiDetail> skHubiDetailLst = syoriCtl.getSkHubis().get(0).getSkHubiDetailsByKaisyouymd(BizDate.valueOf("20150501"));
    ...
    public void normal1() {
        ...
        List<HT_SkHubiDetail> skHubiDetailLst = syoriCtl.getSkHubis().get(0).getSkHubiDetailsByKaisyouymd(null);
    ...
    public void normal2() {
        ...
        List<HT_SkHubiDetail> skHubiDetailLst = syoriCtl.getSkHubis().get(0).getSkHubiDetailsByKaisyouymd(BizDate.valueOf("20150201"));
        ...
        Assert.assertEquals(Integer.valueOf(2), skHubiDetailLst.get(0).getRenno3keta());
        ...
        Assert.assertEquals(Integer.valueOf(3), skHubiDetailLst.get(1).getRenno3keta());
