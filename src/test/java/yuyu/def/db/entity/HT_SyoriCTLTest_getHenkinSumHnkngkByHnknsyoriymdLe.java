...
public class HT_SyoriCTLTest_getHenkinSumHnkngkByHnknsyoriymdLe {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnknsyoriymdLe(BizDate.valueOf(20150405));
            Assert.assertEquals(0, sumHnkngkMap.size());

            HT_Henkin henkin1 = syoriCTL1.createHenkin();
            henkin1.setRenno(1);
            henkin1.setHnknsyoriymd(BizDate.valueOf(20150405));
            henkin1.setHnkngk(BizCurrency.valueOf(100, BizCurrencyTypes.YEN));

            HT_Henkin henkin2 = syoriCTL1.createHenkin();
            henkin2.setRenno(2);
            henkin2.setHnknsyoriymd(BizDate.valueOf(20150404));
            henkin2.setHnkngk(BizCurrency.valueOf(200, BizCurrencyTypes.YEN));

            HT_Henkin henkin3 = syoriCTL1.createHenkin();
            henkin3.setRenno(3);
            henkin3.setHnknsyoriymd(BizDate.valueOf(20150406));
            henkin3.setHnkngk(BizCurrency.valueOf(300, BizCurrencyTypes.YEN));
            ...
            henkin6.setRenno(6);
            henkin6.setHnknsyoriymd(BizDate.valueOf(20160404));
            henkin6.setHnkngk(BizCurrency.valueOf(0, BizCurrencyTypes.YEN));

            HT_Henkin henkin7 = syoriCTL1.createHenkin();
            henkin7.setRenno(7);
            henkin7.setHnknsyoriymd(BizDate.valueOf(20160403));
            henkin7.setHnkngk(BizCurrency.valueOf(25, BizCurrencyTypes.MANYEN));

            HT_Henkin henkin8 = syoriCTL1.createHenkin();
            henkin8.setRenno(8);
            henkin8.setHnknsyoriymd(BizDate.valueOf(20160402));
            henkin8.setHnkngk(BizCurrency.valueOf(34, BizCurrencyTypes.MANYEN));

            HT_Henkin henkin9 = syoriCTL1.createHenkin();
            henkin9.setRenno(9);
            henkin9.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin9.setHnkngk(BizCurrency.valueOf(77.5, BizCurrencyTypes.DOLLAR));

            HT_Henkin henkin10 = syoriCTL1.createHenkin();
            henkin10.setRenno(10);
            henkin10.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin10.setHnkngk(BizCurrency.valueOf(22.5, BizCurrencyTypes.DOLLAR));

            HT_Henkin henkin11 = syoriCTL1.createHenkin();
            henkin11.setRenno(11);
            henkin11.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin11.setHnkngk(BizCurrency.valueOf(0, BizCurrencyTypes.AU_DOLLAR));

            HT_Henkin henkin12 = syoriCTL1.createHenkin();
            henkin12.setRenno(12);
            henkin12.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin12.setHnkngk(BizCurrency.valueOf(400, BizCurrencyTypes.AU_DOLLAR));

            HT_Henkin henkin13 = syoriCTL1.createHenkin();
            henkin13.setRenno(13);
            henkin13.setHnknsyoriymd(BizDate.valueOf(20160405));

            HT_Henkin henkin14 = syoriCTL1.createHenkin();
            henkin14.setRenno(14);
            henkin14.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin14.setHnkngk(BizCurrency.valueOf(600, BizCurrencyTypes.EURO));

            HT_Henkin henkin15 = syoriCTL1.createHenkin();
            henkin15.setRenno(15);
            henkin15.setHnknsyoriymd(BizDate.valueOf(20160405));
            henkin15.setHnkngk(BizCurrency.valueOf(1000, BizCurrencyTypes.EURO));
    ...
    public void noResult1() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnknsyoriymdLe(BizDate.valueOf(20150403));
        Assert.assertEquals(0, sumHnkngkMap.size());
    }
    ...
    public void normal2() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnknsyoriymdLe(BizDate.valueOf(20160405));
