...
public class HT_SyoriCTLTest_getNyuukinSumRsgakuByRyosyuymd {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            nyuukin10.setRyosyuymd(BizDate.valueOf(20160405));
            ...
            nyuukin11.setRyosyuymd(BizDate.valueOf(20160405));
            ...
            nyuukin12.setRyosyuymd(BizDate.valueOf(20160405));

            HT_Nyuukin nyuukin13 = syoriCTL1.createNyuukin();
            nyuukin13.setRenno(13);
            nyuukin13.setRyosyuymd(BizDate.valueOf(20160405));
            ...
            nyuukin14.setRyosyuymd(BizDate.valueOf(20160405));
    ...
    public void noResult1() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumRsgakuMap = syoriCTL1.getNyuukinSumRsgakuByRyosyuymd(BizDate.valueOf(20150403));
        Assert.assertEquals(0, sumRsgakuMap.size());
    }
    ...
    public void normal2() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumRsgakuMap = syoriCTL1.getNyuukinSumRsgakuByRyosyuymd(BizDate.valueOf(20160405));
