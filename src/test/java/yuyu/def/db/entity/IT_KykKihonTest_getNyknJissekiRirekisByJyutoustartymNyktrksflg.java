...
public class IT_KykKihonTest_getNyknJissekiRirekisByJyutoustartymNyktrksflg {
    ...
    public static void insertTestData() {
        ...
        if (kykKihon1 == null) {
            ...
            Assert.assertEquals(0, kykKihon1.getNyknJissekiRirekisByJyutoustartymNyktrksflg(BizDateYM.valueOf(201606)).size());
    ...
    public void noResult1() {
        ...
        List<IT_NyknJissekiRireki> nyknJissekiRirekiList = kykKihon.getNyknJissekiRirekisByJyutoustartymNyktrksflg(BizDateYM.valueOf(201603));
    ...
    public void normal1() {
        IT_KykKihon kykKihon = hozenDomManager.getKykKihon("11807111129");
        List<IT_NyknJissekiRireki> nyknJissekiRirekiList = kykKihon.getNyknJissekiRirekisByJyutoustartymNyktrksflg(BizDateYM.valueOf(201602));

        Assert.assertEquals(1, nyknJissekiRirekiList.size());

        Assert.assertEquals("11", nyknJissekiRirekiList.get(0).getKbnkey());
        Assert.assertEquals("11807111129", nyknJissekiRirekiList.get(0).getSyono());
        Assert.assertEquals(BizDateYM.valueOf(201602), nyknJissekiRirekiList.get(0).getJyutoustartym());
        Assert.assertEquals(21, nyknJissekiRirekiList.get(0).getRenno().intValue());
    ...
    public void normal2() {
        ...
        Assert.assertEquals(2, nyknJissekiRirekiList.size());
        ...
        Assert.assertEquals("11", nyknJissekiRirekiList.get(1).getKbnkey());
        Assert.assertEquals("11807111118", nyknJissekiRirekiList.get(1).getSyono());
        Assert.assertEquals(BizDateYM.valueOf(201602), nyknJissekiRirekiList.get(1).getJyutoustartym());
        Assert.assertEquals(22, nyknJissekiRirekiList.get(1).getRenno().intValue());
