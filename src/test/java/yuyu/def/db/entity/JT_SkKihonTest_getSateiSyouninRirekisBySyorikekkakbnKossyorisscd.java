...
public class JT_SkKihonTest_getSateiSyouninRirekisBySyorikekkakbnKossyorisscd {
    ...
    public static void insertTestData() {
        ...
        if (skKihon1 == null) {
            ...
            Assert.assertEquals(0, skKihon1.getSateiSyouninRirekisBySyorikekkakbnKossyorisscd(C_SyorikekkaKbn.BLNK, "K001").size());
    ...
    public void noResult1() {
        ...
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisBySyorikekkakbnKossyorisscd(C_SyorikekkaKbn.BLNK, "K100");
    ...
    public void normal1() {
        JT_SkKihon SkKihon = siharaiDomManager.getSkKihon("10000000001", "11807111118");
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisBySyorikekkakbnKossyorisscd(C_SyorikekkaKbn.BLNK, "K001");
    ...
    public void normal2() {
        ...
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisBySyorikekkakbnKossyorisscd(C_SyorikekkaKbn.HUBI, "K003");
    ...
    public void blank() {
        JT_SkKihon SkKihon = siharaiDomManager.getSkKihon("10000000002", "11807111129");
        List<JT_SateiSyouninRireki> sateiSyouninRirekiList = SkKihon.getSateiSyouninRirekisBySyorikekkakbnKossyorisscd(C_SyorikekkaKbn.HUBI, "");
