...
public class HT_SyoriCTLTest_getHenkinSumHnkngkByPkakinsyoriymd {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByPkakinsyoriymd(BizDate.valueOf(20150405));
            ...
            henkin3.setPkakinsyoriymd(BizDate.valueOf(20150406));
    ...
    public void noResult1() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByPkakinsyoriymd(BizDate.valueOf(20150403));
        Assert.assertEquals(0, sumHnkngkMap.size());
    }
    ...
    public void normal2() {
        HT_SyoriCTL syoriCTL1 = sinkeiyakuDomManager.getSyoriCTL("791112220");
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByPkakinsyoriymd(BizDate.valueOf(20160405));
