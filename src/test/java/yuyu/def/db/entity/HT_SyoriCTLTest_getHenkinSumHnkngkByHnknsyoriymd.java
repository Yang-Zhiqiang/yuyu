...
public class HT_SyoriCTLTest_getHenkinSumHnkngkByHnknsyoriymd {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnknsyoriymd();
            Assert.assertEquals(0, sumHnkngkMap.size());

            HT_Henkin henkin1 = syoriCTL1.createHenkin();
            henkin1.setRenno(10);
            henkin1.setHnknsyoriymd(BizDate.valueOf(20160101));
        ...
        henkin3.setRenno(12);
        henkin3.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin3.setHnkngk(BizCurrency.valueOf(3000, BizCurrencyTypes.YEN));

        HT_Henkin henkin4 = syoriCTL2.createHenkin();
        henkin4.setRenno(13);
        henkin3.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin4.setHnkngk(BizCurrency.valueOf(0, BizCurrencyTypes.YEN));

        HT_Henkin henkin5 = syoriCTL2.createHenkin();
        henkin5.setRenno(14);
        henkin5.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin5.setHnkngk(BizCurrency.valueOf(25, BizCurrencyTypes.MANYEN));

        HT_Henkin henkin6 = syoriCTL2.createHenkin();
        henkin6.setRenno(15);
        henkin6.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin6.setHnkngk(BizCurrency.valueOf(34, BizCurrencyTypes.MANYEN));


        HT_Henkin henkin7 = syoriCTL2.createHenkin();
        henkin7.setRenno(16);
        henkin7.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin7.setHnkngk(BizCurrency.valueOf(66.5, BizCurrencyTypes.DOLLAR));

        HT_Henkin henkin8 = syoriCTL2.createHenkin();
        henkin8.setRenno(17);
        henkin8.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin8.setHnkngk(BizCurrency.valueOf(43.5, BizCurrencyTypes.DOLLAR));

        HT_Henkin henkin9 = syoriCTL2.createHenkin();
        henkin9.setRenno(18);
        henkin9.setHnknsyoriymd(BizDate.valueOf(20160101));

        HT_Henkin henkin10 = syoriCTL2.createHenkin();
        henkin10.setRenno(19);
        henkin10.setHnknsyoriymd(BizDate.valueOf(20160101));
        ...
        henkin11.setHnknsyoriymd(BizDate.valueOf(20160101));
        ...
        henkin12.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin12.setHnkngk(BizCurrency.valueOf(600, BizCurrencyTypes.EURO));

        HT_Henkin henkin13 = syoriCTL2.createHenkin();
        henkin13.setRenno(22);
        henkin13.setHnknsyoriymd(BizDate.valueOf(20160101));
        henkin13.setHnkngk(BizCurrency.valueOf(1000, BizCurrencyTypes.EURO));
    ...
    public void normal2() {
        ...
        Assert.assertEquals(BizCurrency.valueOf(110, BizCurrencyTypes.DOLLAR), sumHnkngkMap.get(BizCurrencyTypes.DOLLAR));
