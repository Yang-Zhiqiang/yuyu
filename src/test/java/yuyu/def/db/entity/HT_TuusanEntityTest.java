...
/**
 * 通算テーブル エンティティのテストクラス<br />
 */
@RunWith(SWAKTestRunner.class)
public class HT_TuusanEntityTest implements EntityTestInterface {
    ...
    public void ToHT_SyoriCTL() {
        ...
        HT_Tuusan hT_Tuusan = hT_SyoriCTL.getTuusan();
        HT_SyoriCTL result_hT_SyoriCTL = hT_Tuusan.getSyoriCTL();
