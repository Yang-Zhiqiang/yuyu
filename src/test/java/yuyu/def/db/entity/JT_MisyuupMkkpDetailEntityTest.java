...
/**
 * 未収Ｐ未経過Ｐ明細テーブル エンティティのテストクラス<br />
 */
@RunWith(SWAKTestRunner.class)
public class JT_MisyuupMkkpDetailEntityTest {
    ...
    public void getSk() {
        ...
        List<JT_MisyuupMkkpDetail> JT_MisyuupMkkpDetails = jT_Sk1.getMisyuupMkkpDetails();
        JT_MisyuupMkkpDetail JT_MisyuupMkkpDetail1 = JT_MisyuupMkkpDetails.get(0);
        JT_Sk jT_Sk2 = JT_MisyuupMkkpDetail1.getSk();
