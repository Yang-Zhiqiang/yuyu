...
public class HT_SyoriCTLTest_getHenkinsByHnknsyoriymdNull {
    ...
    public static void insertTestData() {
        ...
        if (syoriCtl2 == null) {
            ...
            Assert.assertEquals(0, syoriCtl2.getHenkinsByHnknsyoriymdNull().size());
        ...
        if (syoriCtl3 == null) {
            ...
            HT_Henkin henkin3 = syoriCtl3.createHenkin();
            henkin3.setRenno(2);
    ...
    public void normal1() {
        ...
        Assert.assertEquals("791112238", henkinList.get(0).getMosno());
