...
public class JT_SkKihonTest_getTtdkRirekByTtdkrrkskbtkey {
    ...
    public static void insertTestData() {
        ...
        Assert.assertEquals(null, jT_SkKihon.getTtdkRirekByTtdkrrkskbtkey(P_TTDKRRKSKBTKEY_001));
    ...
    public void noResult1() {
        ...
        Assert.assertEquals(null, skKihon.getTtdkRirekByTtdkrrkskbtkey(P_TTDKRRKSKBTKEY_002));
    }
    ...
    public void normal1() {
        ...
        JT_TtdkRireki jT_TtdkRireki = skKihon.getTtdkRirekByTtdkrrkskbtkey(P_TTDKRRKSKBTKEY_001);
