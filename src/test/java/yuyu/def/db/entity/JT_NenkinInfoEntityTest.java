...
/**
 * 年金情報テーブル エンティティのテストクラス<br />
 */
@RunWith(SWAKTestRunner.class)
public class JT_NenkinInfoEntityTest {
    ...
    public static void insertTestData() {
        ...
        JT_NenkinInfo jT_NenkinInfo1 = jT_Sk1.createNenkinInfo();
        jT_NenkinInfo1.setSeikyuurirekino(pSeikyuurirekino);
    ...
    public void getSk() {
        ...
        JT_Sk jT_Sk2 = JT_NenkinInfo1.getSk();
