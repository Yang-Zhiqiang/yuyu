...
public class HT_SyoriCTLTest_getHenkinSumHnkngkByHnkntuukasyu {
    ...
    public static void insertTestData() {
        ...
        if( null == syoriCTL1 ) {
            ...
            Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnkntuukasyu(C_Tuukasyu.JPY);
        ...
        henkin3.setHnkntuukasyu(C_Tuukasyu.EUR);
        ...
        henkin7.setRenno(16);
        henkin7.setHnkngk(BizCurrency.valueOf(77.5, BizCurrencyTypes.DOLLAR));
        henkin7.setHnkntuukasyu(C_Tuukasyu.EUR);

        HT_Henkin henkin8 = syoriCTL2.createHenkin();
        henkin8.setRenno(17);
        henkin8.setHnkngk(BizCurrency.valueOf(22.5, BizCurrencyTypes.DOLLAR));
        henkin8.setHnkntuukasyu(C_Tuukasyu.EUR);

        HT_Henkin henkin9 = syoriCTL2.createHenkin();
        henkin9.setRenno(18);
        henkin9.setHnkngk(BizCurrency.valueOf(0, BizCurrencyTypes.AU_DOLLAR));
        henkin9.setHnkntuukasyu(C_Tuukasyu.EUR);

        HT_Henkin henkin10 = syoriCTL2.createHenkin();
        henkin10.setRenno(19);
        henkin10.setHnkngk(BizCurrency.valueOf(400, BizCurrencyTypes.AU_DOLLAR));
    ...
    public void normal2() {
        ...
        Map<CurrencyType, BizCurrency> sumHnkngkMap = syoriCTL1.getHenkinSumHnkngkByHnkntuukasyu(C_Tuukasyu.EUR);
