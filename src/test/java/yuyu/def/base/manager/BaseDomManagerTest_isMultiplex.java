 ...
 * isMultiplex() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
 public class BaseDomManagerTest_isMultiplex extends AbstractTest {
     ...
     public void test001(){
         ...
         String resulrIsMultiplex = "";
         try {
             baseDomManager.getBatch(pKinouId).isMultiplex();
         } catch (Exception e) {
             resulrIsMultiplex = null;
         }

         assertEquals(null, resulrIsMultiplex);
     }

     @Test
     public void test002(){
         String pKinouId = "KI00000001";
         boolean pIsMultiplex = true;
         boolean resulrIsMultiplex = baseDomManager.getBatch(pKinouId).isMultiplex();

         assertEquals(pIsMultiplex, resulrIsMultiplex);
     }
