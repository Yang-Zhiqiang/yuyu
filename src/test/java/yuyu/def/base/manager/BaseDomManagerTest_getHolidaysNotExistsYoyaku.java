 ...
 * getHolidaysNotExistsYoyaku() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getHolidaysNotExistsYoyaku extends AbstractTest {
    ...
    public static void insertTestData() {
        ...
        String pHolidayCd13 = "HC00000013";
        String pHolidayCd14 = "HC00000014";
        String pHolidayCd15 = "HC00000015";
        String pHolidayCd16 = "HC00000016";
        String pHolidayCd17 = "HC00000017";
        String pHolidayCd18 = "HC00000018";
        String pHolidayCd19 = "HC00000019";
        String pHolidayCd20 = "HC00000020";
        ...
        AT_Holiday aT_Holiday1 = aT_HolidayGroup1.getHoliday(pHolidayCd1);
        if ( null == aT_Holiday1 ) {

            aT_Holiday1 = aT_HolidayGroup1.createHoliday();
            aT_Holiday1.setHolidayCd(pHolidayCd1);
            aT_Holiday1.setTekiyouYmdFrom(pTekiyouYmdFrom1);
            aT_Holiday1.setTekiyouYmdTo(pTekiyouYmdTo1);
            aT_Holiday1.setHolidayPattern(pHolidayPattern1);
            aT_Holiday1.setHolidayPatternNm(pHolidayPatternNm1);

        }

        baseDomManager.update(aT_HolidayGroup1);

        AT_Holiday aT_Holiday2 = aT_HolidayGroup2.getHoliday(pHolidayCd2);
        if ( null == aT_Holiday2 ) {

            aT_Holiday2 = aT_HolidayGroup2.createHoliday();
            aT_Holiday2.setHolidayCd(pHolidayCd2);
            aT_Holiday2.setTekiyouYmdFrom(pTekiyouYmdFrom2);
            aT_Holiday2.setTekiyouYmdTo(pTekiyouYmdTo2);
            aT_Holiday2.setHolidayPattern(pHolidayPattern2);
            aT_Holiday2.setHolidayPatternNm(pHolidayPatternNm2);

        }

        AT_Holiday aT_Holiday3 = aT_HolidayGroup2.getHoliday(pHolidayCd3);
        if ( null == aT_Holiday3 ) {

            aT_Holiday3 = aT_HolidayGroup2.createHoliday();
            aT_Holiday3.setHolidayCd(pHolidayCd3);
            aT_Holiday3.setTekiyouYmdFrom(pTekiyouYmdFrom3);
            aT_Holiday3.setTekiyouYmdTo(pTekiyouYmdTo3);
            aT_Holiday3.setHolidayPattern(pHolidayPattern3);
            aT_Holiday3.setHolidayPatternNm(pHolidayPatternNm3);

        }

        AT_Holiday aT_Holiday4 = aT_HolidayGroup2.getHoliday(pHolidayCd4);
        if ( null == aT_Holiday4 ) {

            aT_Holiday4 = aT_HolidayGroup2.createHoliday();
            aT_Holiday4.setHolidayCd(pHolidayCd4);
            aT_Holiday4.setTekiyouYmdFrom(pTekiyouYmdFrom4);
            aT_Holiday4.setTekiyouYmdTo(pTekiyouYmdTo4);
            aT_Holiday4.setHolidayPattern(pHolidayPattern4);
            aT_Holiday4.setHolidayPatternNm(pHolidayPatternNm4);

        }

        baseDomManager.update(aT_HolidayGroup2);

        AT_Holiday aT_Holiday5 = aT_HolidayGroup3.getHoliday(pHolidayCd5);
        if ( null == aT_Holiday5 ) {

            aT_Holiday5 = aT_HolidayGroup3.createHoliday();
            aT_Holiday5.setHolidayCd(pHolidayCd5);
            aT_Holiday5.setTekiyouYmdFrom(pTekiyouYmdFrom5);
            aT_Holiday5.setTekiyouYmdTo(pTekiyouYmdTo5);
            aT_Holiday5.setHolidayPattern(pHolidayPattern5);
            aT_Holiday5.setHolidayPatternNm(pHolidayPatternNm5);

        }

        AT_Holiday aT_Holiday6 = aT_HolidayGroup3.getHoliday(pHolidayCd6);
        if ( null == aT_Holiday6 ) {

            aT_Holiday6 = aT_HolidayGroup3.createHoliday();
            aT_Holiday6.setHolidayCd(pHolidayCd6);
            aT_Holiday6.setTekiyouYmdFrom(pTekiyouYmdFrom6);
            aT_Holiday6.setTekiyouYmdTo(pTekiyouYmdTo6);
            aT_Holiday6.setHolidayPattern(pHolidayPattern6);
            aT_Holiday6.setHolidayPatternNm(pHolidayPatternNm6);

        }

        AT_Holiday aT_Holiday7 = aT_HolidayGroup3.getHoliday(pHolidayCd7);
        if ( null == aT_Holiday7 ) {

            aT_Holiday7 = aT_HolidayGroup3.createHoliday();
            aT_Holiday7.setHolidayCd(pHolidayCd7);
            aT_Holiday7.setTekiyouYmdFrom(pTekiyouYmdFrom7);
            aT_Holiday7.setTekiyouYmdTo(pTekiyouYmdTo7);
            aT_Holiday7.setHolidayPattern(pHolidayPattern7);
            aT_Holiday7.setHolidayPatternNm(pHolidayPatternNm7);

        }

        AT_Holiday aT_Holiday8 = aT_HolidayGroup3.getHoliday(pHolidayCd8);
        if ( null == aT_Holiday8 ) {

            aT_Holiday8 = aT_HolidayGroup3.createHoliday();
            aT_Holiday8.setHolidayCd(pHolidayCd8);
            aT_Holiday8.setTekiyouYmdFrom(pTekiyouYmdFrom8);
            aT_Holiday8.setTekiyouYmdTo(pTekiyouYmdTo8);
            aT_Holiday8.setHolidayPattern(pHolidayPattern8);
            aT_Holiday8.setHolidayPatternNm(pHolidayPatternNm8);

        }

        AT_Holiday aT_Holiday9 = aT_HolidayGroup3.getHoliday(pHolidayCd9);
        if ( null == aT_Holiday9 ) {

            aT_Holiday9 = aT_HolidayGroup3.createHoliday();
            aT_Holiday9.setHolidayCd(pHolidayCd9);
            aT_Holiday9.setTekiyouYmdFrom(pTekiyouYmdFrom9);
            aT_Holiday9.setTekiyouYmdTo(pTekiyouYmdTo9);
            aT_Holiday9.setHolidayPattern(pHolidayPattern9);
            aT_Holiday9.setHolidayPatternNm(pHolidayPatternNm9);

        }

        AT_Holiday aT_Holiday10 = aT_HolidayGroup3.getHoliday(pHolidayCd10);
        if ( null == aT_Holiday10 ) {

            aT_Holiday10 = aT_HolidayGroup3.createHoliday();
            aT_Holiday10.setHolidayCd(pHolidayCd10);
            aT_Holiday10.setTekiyouYmdFrom(pTekiyouYmdFrom10);
            aT_Holiday10.setTekiyouYmdTo(pTekiyouYmdTo10);
            aT_Holiday10.setHolidayPattern(pHolidayPattern10);
            aT_Holiday10.setHolidayPatternNm(pHolidayPatternNm10);

        }

        AT_Holiday aT_Holiday11 = aT_HolidayGroup3.getHoliday(pHolidayCd11);
        if ( null == aT_Holiday11 ) {

            aT_Holiday11 = aT_HolidayGroup3.createHoliday();
            aT_Holiday11.setHolidayCd(pHolidayCd11);
            aT_Holiday11.setTekiyouYmdFrom(pTekiyouYmdFrom11);
            aT_Holiday11.setTekiyouYmdTo(pTekiyouYmdTo11);
            aT_Holiday11.setHolidayPattern(pHolidayPattern11);
            aT_Holiday11.setHolidayPatternNm(pHolidayPatternNm11);

        }

        AT_Holiday aT_Holiday12 = aT_HolidayGroup3.getHoliday(pHolidayCd12);
        if ( null == aT_Holiday12 ) {

            aT_Holiday12 = aT_HolidayGroup3.createHoliday();
            aT_Holiday12.setHolidayCd(pHolidayCd12);
            aT_Holiday12.setTekiyouYmdFrom(pTekiyouYmdFrom12);
            aT_Holiday12.setTekiyouYmdTo(pTekiyouYmdTo12);
            aT_Holiday12.setHolidayPattern(pHolidayPattern12);
            aT_Holiday12.setHolidayPatternNm(pHolidayPatternNm12);

        }

        baseDomManager.update(aT_HolidayGroup3);

        AT_HolidayYoyaku aT_HolidayYoyaku1 = aT_HolidayGroup1.getHolidayYoyaku(pHolidayCd2);
        if ( null == aT_HolidayYoyaku1 ) {

            aT_HolidayYoyaku1 = aT_HolidayGroup1.createHolidayYoyaku();
            aT_HolidayYoyaku1.setHolidayCd(pHolidayCd2);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku2 = aT_HolidayGroup2.getHolidayYoyaku(pHolidayCd5);
        if ( null == aT_HolidayYoyaku2 ) {

            aT_HolidayYoyaku2 = aT_HolidayGroup2.createHolidayYoyaku();
            aT_HolidayYoyaku2.setHolidayCd(pHolidayCd5);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku3 = aT_HolidayGroup2.getHolidayYoyaku(pHolidayCd6);
        if ( null == aT_HolidayYoyaku3 ) {

            aT_HolidayYoyaku3 = aT_HolidayGroup2.createHolidayYoyaku();
            aT_HolidayYoyaku3.setHolidayCd(pHolidayCd6);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku4 = aT_HolidayGroup2.getHolidayYoyaku(pHolidayCd7);
        if ( null == aT_HolidayYoyaku4 ) {

            aT_HolidayYoyaku4 = aT_HolidayGroup2.createHolidayYoyaku();
            aT_HolidayYoyaku4.setHolidayCd(pHolidayCd7);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku5 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd12);
        if ( null == aT_HolidayYoyaku5 ) {

            aT_HolidayYoyaku5 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku5.setHolidayCd(pHolidayCd20);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku6 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd13);
        if ( null == aT_HolidayYoyaku6 ) {

            aT_HolidayYoyaku6 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku6.setHolidayCd(pHolidayCd13);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku7 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd14);
        if ( null == aT_HolidayYoyaku7 ) {

            aT_HolidayYoyaku7 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku7.setHolidayCd(pHolidayCd14);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku8 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd15);
        if ( null == aT_HolidayYoyaku8 ) {

            aT_HolidayYoyaku8 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku8.setHolidayCd(pHolidayCd15);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku9 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd16);
        if ( null == aT_HolidayYoyaku9 ) {

            aT_HolidayYoyaku9 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku9.setHolidayCd(pHolidayCd16);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku10 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd17);
        if ( null == aT_HolidayYoyaku10 ) {

            aT_HolidayYoyaku10 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku10.setHolidayCd(pHolidayCd17);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku11 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd18);
        if ( null == aT_HolidayYoyaku11 ) {

            aT_HolidayYoyaku11 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku11.setHolidayCd(pHolidayCd18);
        ...
        AT_HolidayYoyaku aT_HolidayYoyaku12 = aT_HolidayGroup3.getHolidayYoyaku(pHolidayCd19);
        if ( null == aT_HolidayYoyaku12 ) {

            aT_HolidayYoyaku12 = aT_HolidayGroup3.createHolidayYoyaku();
            aT_HolidayYoyaku12.setHolidayCd(pHolidayCd19);
    ...
    public static void deleteTestData() {
        ...
        if ( null != aT_HolidayGroup1 ) {
            ...
            aT_HolidayGroup1.getHolidays().removeAll(aT_HolidayGroup1.getHolidays());
        ...
        if ( null != aT_HolidayGroup2 ) {
            ...
            aT_HolidayGroup2.getHolidays().removeAll(aT_HolidayGroup2.getHolidays());
        ...
        if ( null != aT_HolidayGroup3 ) {
            ...
            aT_HolidayGroup3.getHolidays().removeAll(aT_HolidayGroup3.getHolidays());
    ...
    public void test001(){
        ...
        List<AT_Holiday> aT_HolidayList = baseDomManager.getHolidaysNotExistsYoyaku(pHolidayGroupCd);

        assertEquals(0, aT_HolidayList.size());
    ...
    public void test002(){
        ...
        assertEquals(1, aT_HolidayList.size());
    ...
    public void test003(){
        ...
        assertEquals(3, aT_HolidayList.size());
    ...
    public void test005(){
        ...
        List<AT_Holiday> resultaT_HolidayList = ImmutableList.copyOf(Iterables.filter(aT_HolidayList, new Predicate<AT_Holiday>() {

            @Override
            public boolean apply(AT_Holiday paT_HolidayEntity) {
                ...
                for (String holidayGroupCd : pHolidayGroupCdList) {
                    if (holidayGroupCd.equals(paT_HolidayEntity.getHolidayGroupCd())) {
                        return true;
                    }
                }
        ...
        long count = resultaT_HolidayList.size();
    ...
    public void test006(){
        ...
        assertEquals(pHolidayPattern1, aT_HolidayList.get(0).getHolidayPattern());
        assertEquals(pTekiyouYmdTo1, aT_HolidayList.get(0).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom1, aT_HolidayList.get(0).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm1, aT_HolidayList.get(0).getHolidayPatternNm());

        assertEquals(pHolidayPattern2, aT_HolidayList.get(1).getHolidayPattern());
        assertEquals(pTekiyouYmdTo2, aT_HolidayList.get(1).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom2, aT_HolidayList.get(1).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm2, aT_HolidayList.get(1).getHolidayPatternNm());

        assertEquals(pHolidayPattern3, aT_HolidayList.get(2).getHolidayPattern());
        assertEquals(pTekiyouYmdTo3, aT_HolidayList.get(2).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom4, aT_HolidayList.get(2).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm3, aT_HolidayList.get(2).getHolidayPatternNm());

        assertEquals(pHolidayPattern4, aT_HolidayList.get(3).getHolidayPattern());
        assertEquals(pTekiyouYmdTo4, aT_HolidayList.get(3).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom3, aT_HolidayList.get(3).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm4, aT_HolidayList.get(3).getHolidayPatternNm());

        assertEquals(pHolidayPattern5, aT_HolidayList.get(4).getHolidayPattern());
        assertEquals(pTekiyouYmdTo5, aT_HolidayList.get(4).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom6, aT_HolidayList.get(4).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm5, aT_HolidayList.get(4).getHolidayPatternNm());

        assertEquals(pHolidayPattern6, aT_HolidayList.get(5).getHolidayPattern());
        assertEquals(pTekiyouYmdTo6, aT_HolidayList.get(5).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom5, aT_HolidayList.get(5).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm6, aT_HolidayList.get(5).getHolidayPatternNm());

        assertEquals(pHolidayPattern7, aT_HolidayList.get(6).getHolidayPattern());
        assertEquals(pTekiyouYmdTo7, aT_HolidayList.get(6).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom7, aT_HolidayList.get(6).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm8, aT_HolidayList.get(6).getHolidayPatternNm());

        assertEquals(pHolidayPattern8, aT_HolidayList.get(7).getHolidayPattern());
        assertEquals(pTekiyouYmdTo8, aT_HolidayList.get(7).getTekiyouYmdTo());
        assertEquals(pTekiyouYmdFrom8, aT_HolidayList.get(7).getTekiyouYmdFrom());
        assertEquals(pHolidayPatternNm7, aT_HolidayList.get(7).getHolidayPatternNm());
