 ...
 * getKinouModesByKadouTimeGroup() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getKinouModesByKadouTimeGroup extends AbstractTest {
    ...
    public void test001(){
        ...
        List<AS_KinouMode> aS_KinouModeList = baseDomManager.getKinouModesByKadouTimeGroup(pKadouTimeGroupCd);

        assertEquals(0, aS_KinouModeList.size());
    ...
    public void test002(){
        ...
        assertEquals(1, aS_KinouModeList.size());
    ...
    public void test003(){
        ...
        assertEquals(3, aS_KinouModeList.size());
    ...
    public void test005(){
        ...
        List<AS_KinouMode> resultaS_KinouModeList = ImmutableList.copyOf(Iterables.filter(aS_KinouModeList, new Predicate<AS_KinouMode>() {

            @Override
            public boolean apply(AS_KinouMode paS_KinouModeEntity) {

                List<String> pKinouModeIdList = new ArrayList<String>();
                pKinouModeIdList.add("KMI0000001");
                pKinouModeIdList.add("KMI0000002");
                pKinouModeIdList.add("KMI0000003");
                pKinouModeIdList.add("KMI0000004");

                for (String kinouModeId : pKinouModeIdList) {
                    if (kinouModeId.equals(paS_KinouModeEntity.getKinouModeId())) {
                        return true;
                    }
                }
        ...
        long count = resultaS_KinouModeList.size();
