 ...
 * selAccessLogs() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_selAccessLogs extends AbstractTest {
    ...
    public static void insertTestData() {
        ...
        long pTimeStamp1 = setSyoriTime(BizDate.valueOf("20150105"));
        long pTimeStamp2 = setSyoriTime(BizDate.valueOf("20150103"));
        long pTimeStamp3 = setSyoriTime(BizDate.valueOf("20150104"));
    ...
    public void Test001() {
        ...
        String pSessionId = "SEI0000001";
        C_AccessLogSyubetuKbn pLogKindCd = C_AccessLogSyubetuKbn.BLNK;
        List<AT_AccessLog> aT_AccessLogList = baseDomManager.selAccessLogs(pSubSystemId, pCategoryId, pKinouId, pKinouKbn, pSyoriYmdFrom,
            pSyoriTimeFrom, pSyoriYmdTo, pSyoriTimeTo, pUserId, pIpAddress, pSessionId, pLogKindCd);

        assertEquals(0,  aT_AccessLogList.size());
    }
    ...
    public void Test002() {
        ...
        assertEquals(1,  aT_AccessLogList.size());
    }
    ...
    public void Test003() {
        ...
        assertEquals(3,  aT_AccessLogList.size());
    }
    ...
    public void Test005() {
        ...
        assertEquals(5,  aT_AccessLogList.size());
    }
    ...
    public void Test006() {
        ...
        String pKinouId = "KI00000001";
        C_KinouKbn pKinouKbn = C_KinouKbn.ONLINE;
        BizDate pSyoriYmdFrom = BizDate.valueOf("20150103");
        String pSyoriTimeFrom = "0000";
        BizDate pSyoriYmdTo = BizDate.valueOf("20150105");
        String pSyoriTimeTo = "2359";
        String pUserId = "SUI0000001";
        String pIpAddress = "IA00000001";
        String pSessionId = "SEI0000001";
        ...
        assertEquals(pTimeStamp1,  aT_AccessLogList.get(0).getTimeStamp());
        assertEquals(pLogId1,  aT_AccessLogList.get(0).getLogId());

        assertEquals(pTimeStamp3,  aT_AccessLogList.get(1).getTimeStamp());
        assertEquals(pLogId3,  aT_AccessLogList.get(1).getLogId());

        assertEquals(pTimeStamp2,  aT_AccessLogList.get(2).getTimeStamp());
        assertEquals(pLogId2,  aT_AccessLogList.get(2).getLogId());
    }
