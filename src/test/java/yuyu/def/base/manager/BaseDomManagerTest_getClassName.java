 ...
 * getClassName() メソッドのテストクラスです。
 */@RunWith(SWAKTestRunner.class)
 public class BaseDomManagerTest_getClassName extends AbstractTest {
     ...
     public void test001(){
         ...
         String resulrClassName = "";
         try {
             baseDomManager.getBatch(pKinouId).getClassName();
         } catch (Exception e) {
             resulrClassName = null;
         }

         assertEquals(null, resulrClassName);
     }
     ...
     public void test002(){
         ...
         String resulrClassName = baseDomManager.getBatch(pKinouId).getClassName();

         assertEquals(pBatchClass, resulrClassName);
     }
