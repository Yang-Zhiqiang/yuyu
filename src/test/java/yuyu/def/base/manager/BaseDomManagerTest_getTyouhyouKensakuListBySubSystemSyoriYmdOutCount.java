 ...
 * getTyouhyouKensakuListBySubSystemSyoriYmdOutCount() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getTyouhyouKensakuListBySubSystemSyoriYmdOutCount extends AbstractTest {
    ...
    public static void insertTestData() {
        ...
        if ( null == aT_TyouhyouKensaku5 ) {
            ...
            aT_TyouhyouKensaku5.setSyoruiCd(pSyoruiCd1);
        ...
        if ( null == aT_TyouhyouKensaku6 ) {
            ...
            aT_TyouhyouKensaku6.setSyoruiCd(pSyoruiCd1);
        ...
        if ( null == aT_TyouhyouKensaku11 ) {
            ...
            aT_TyouhyouKensaku11.setSyoruiCd(pSyoruiCd1);
        ...
        if ( null == aT_TyouhyouKensaku12 ) {
            ...
            aT_TyouhyouKensaku12.setSyoruiCd(pSyoruiCd1);
        ...
        if ( null == aT_TyouhyouKensaku13 ) {
            ...
            aT_TyouhyouKensaku13.setSyoruiCd(pSyoruiCd1);
        ...
        if ( null == aT_TyouhyouKensaku14 ) {
            ...
            aT_TyouhyouKensaku14.setSyoruiCd(pSyoruiCd1);
    ...
    public void test001(){
        ...
        String pOutCount = "0";
        List<AT_TyouhyouKensaku> aT_TyouhyouKensakuList = baseDomManager.getTyouhyouKensakuListBySubSystemSyoriYmdOutCount(pSubSystemId, pSyoriYmd, pOutCount);
    ...
    public void test006(){
        ...
        assertEquals(pPageCount3, aT_TyouhyouKensakuList.get(0).getPageCount());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(0).getKensakuKey1());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(0).getKensakuKey2());
        ...
        assertEquals(pPageCount3, aT_TyouhyouKensakuList.get(1).getPageCount());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(1).getKensakuKey1());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(1).getKensakuKey2());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(1).getKensakuKey3());
        assertEquals(pKensakuKey5, aT_TyouhyouKensakuList.get(1).getKensakuKey4());
        ...
        assertEquals(pPageCount2, aT_TyouhyouKensakuList.get(2).getPageCount());
        ...
        assertEquals(pPageCount1, aT_TyouhyouKensakuList.get(3).getPageCount());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(3).getKensakuKey1());
        assertEquals(pKensakuKey2, aT_TyouhyouKensakuList.get(3).getKensakuKey2());
        ...
        assertEquals(pPageCount1, aT_TyouhyouKensakuList.get(4).getPageCount());
        assertEquals(pKensakuKey2, aT_TyouhyouKensakuList.get(4).getKensakuKey1());
        assertEquals(pKensakuKey2, aT_TyouhyouKensakuList.get(4).getKensakuKey2());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(4).getKensakuKey3());
        assertEquals(pKensakuKey4, aT_TyouhyouKensakuList.get(4).getKensakuKey4());
        ...
        assertEquals(pPageCount1, aT_TyouhyouKensakuList.get(5).getPageCount());
        ...
        assertEquals(pKensakuKey5, aT_TyouhyouKensakuList.get(5).getKensakuKey3());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(6).getSyoruiCd());
        assertEquals(pPageCount4, aT_TyouhyouKensakuList.get(6).getPageCount());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(6).getKensakuKey1());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(6).getKensakuKey2());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(7).getSyoruiCd());
        assertEquals(pPageCount4, aT_TyouhyouKensakuList.get(7).getPageCount());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(7).getKensakuKey1());
        assertEquals(pKensakuKey4, aT_TyouhyouKensakuList.get(7).getKensakuKey2());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(8).getSyoruiCd());
        assertEquals(pPageCount3, aT_TyouhyouKensakuList.get(8).getPageCount());
        assertEquals(pKensakuKey1, aT_TyouhyouKensakuList.get(8).getKensakuKey1());
        assertEquals(pKensakuKey2, aT_TyouhyouKensakuList.get(8).getKensakuKey2());
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(8).getKensakuKey3());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(9).getSyoruiCd());
        assertEquals(pPageCount3, aT_TyouhyouKensakuList.get(9).getPageCount());
        ...
        assertEquals(pKensakuKey3, aT_TyouhyouKensakuList.get(9).getKensakuKey3());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(10).getSyoruiCd());
        ...
        assertEquals(pSyoruiCd2, aT_TyouhyouKensakuList.get(11).getSyoruiCd());
