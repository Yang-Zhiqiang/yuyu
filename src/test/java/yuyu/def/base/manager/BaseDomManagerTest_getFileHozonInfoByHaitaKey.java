 ...
 * etFileHozonInfoByHaitaKey() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getFileHozonInfoByHaitaKey extends AbstractTest {
    ...
    public void test001(){
        ...
        List<AT_FileHozonInfo> aT_FileHozonInfoList = baseDomManager.getFileHozonInfoByHaitaKey(pFileSyuruiCd, pHaitaKey);
