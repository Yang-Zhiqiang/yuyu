 ...
 * getBatchDate() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getBatchDate extends AbstractTest {
    ...
    public void test001(){
        BizDate pBatchExecDate = BizDate.valueOf("20150806");
        BizDate pBizDate = baseDomManager.getBatchDate();

        assertEquals(pBatchExecDate, pBizDate);
    }
}
