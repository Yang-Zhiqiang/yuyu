 ...
 * getMethodName() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
 public class BaseDomManagerTest_getMethodName extends AbstractTest {
     ...
     public void test001(){
         ...
         String resulrMethodName = "";
         try {
             baseDomManager.getBatch(pKinouId).getMethodName();
         } catch (Exception e) {
             resulrMethodName = null;
         }

         assertEquals(null, resulrMethodName);
     }

     @Test
     public void test002(){
         String pKinouId = "KI00000001";
         String pMethodName = null;
         String resulrMethodName = baseDomManager.getBatch(pKinouId).getMethodName();

         assertEquals(pMethodName, resulrMethodName);
     }
