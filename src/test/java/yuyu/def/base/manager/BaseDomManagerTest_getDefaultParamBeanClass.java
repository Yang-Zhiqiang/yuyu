 ...
 * getDefaultParamBeanClass() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
 public class BaseDomManagerTest_getDefaultParamBeanClass extends AbstractTest {
     ...
     public void test001(){
         ...
         String resulrBatchParamBean = "";
         try {
             baseDomManager.getBatch(pKinouId).getDefaultParamBeanClass();
         } catch (Exception e) {
             resulrBatchParamBean = null;
         }

         assertEquals(null, resulrBatchParamBean);
     }

     @Test
     public void test002(){
         String pKinouId = "KI00000001";
         String pBatchParamBean = "yuyu.infr.batch.BatchParam";
         String resulrBatchParamBean = baseDomManager.getBatch(pKinouId).getDefaultParamBeanClass();

         assertEquals(pBatchParamBean, resulrBatchParamBean);
     }
