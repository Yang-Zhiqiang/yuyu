 ...
 * getKinousByCategory() メソッドのテストクラスです。
 */
@RunWith(SWAKTestRunner.class)
public class BaseDomManagerTest_getKinousByCategory extends AbstractTest {
    ...
    public static void insertTestData() {
        ...
        int pSubSystemSortNo1 = 3;
        int pSubSystemSortNo2 = 1;
        int pSubSystemSortNo3 = 2;
        ...
        int pCategorySortNo1 = 1;
        int pCategorySortNo2 = 2;
        int pCategorySortNo3 = 3;
        ...
        if ( null == aS_Kinou2 ) {
            ...
            aS_Kinou2.setCategoryId(pCategoryId2);
        ...
        if ( null == aS_Kinou3 ) {
            ...
            aS_Kinou3.setCategoryId(pCategoryId2);
        ...
        if ( null == aS_Kinou4 ) {
            ...
            aS_Kinou4.setSubSystemId(pSubSystemId1);
        ...
        if ( null == aS_Kinou5 ) {
            ...
            aS_Kinou5.setSubSystemId(pSubSystemId1);
            aS_Kinou5.setCategoryId(pCategoryId3);
        ...
        if ( null == aS_Kinou6 ) {
            ...
            aS_Kinou6.setSubSystemId(pSubSystemId1);
            aS_Kinou6.setCategoryId(pCategoryId3);
        ...
        if ( null == aS_Kinou7 ) {
            ...
            aS_Kinou7.setSubSystemId(pSubSystemId1);
            aS_Kinou7.setCategoryId(pCategoryId3);
        ...
        if ( null == aS_Kinou8 ) {
            ...
            aS_Kinou8.setSubSystemId(pSubSystemId2);
            aS_Kinou8.setCategoryId(pCategoryId3);
        ...
        if ( null == aS_Kinou9 ) {
            ...
            aS_Kinou9.setSubSystemId(pSubSystemId2);
            aS_Kinou9.setCategoryId(pCategoryId3);
    ...
    public void test001(){
        ...
        List<AS_Kinou> aS_KinouList = baseDomManager.getKinousByCategory(pCategoryId);
    ...
    public void test006(){
        ...
        assertEquals(pSubSystemId2, aS_KinouList.get(0).getSubSystemId());
        assertEquals(pKinouId5, aS_KinouList.get(0).getKinouId());

        assertEquals(pSubSystemId2, aS_KinouList.get(1).getSubSystemId());
        assertEquals(pKinouId4, aS_KinouList.get(1).getKinouId());

        assertEquals(pSubSystemId3, aS_KinouList.get(2).getSubSystemId());
        assertEquals(pKinouId7, aS_KinouList.get(2).getKinouId());

        assertEquals(pSubSystemId3, aS_KinouList.get(3).getSubSystemId());
        assertEquals(pKinouId6, aS_KinouList.get(3).getKinouId());

        assertEquals(pSubSystemId1, aS_KinouList.get(4).getSubSystemId());
        assertEquals(pKinouId2, aS_KinouList.get(4).getKinouId());

        assertEquals(pSubSystemId1, aS_KinouList.get(5).getSubSystemId());
        assertEquals(pKinouId1, aS_KinouList.get(5).getKinouId());

        assertEquals(pSubSystemId1, aS_KinouList.get(6).getSubSystemId());
