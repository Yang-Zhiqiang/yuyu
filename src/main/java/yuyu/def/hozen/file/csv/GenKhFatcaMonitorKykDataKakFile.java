...
/**
 * （保全）ＦＡＴＣＡモニタリング確認中契約データファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenKhFatcaMonitorKykDataKakFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenKhFatcaMonitorKykDataKakFile() {
    }
