...
/**
 * （保全）早期解約データファイル（銀行） データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenKhSoukiKaiyakuDataFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenKhSoukiKaiyakuDataFile() {
    }
    ...
    @Column(order = 6, label = "解約受付日")
    private String ifcKaiyakuymd;

    public String getIfcKaiyakuymd() {
        return ifcKaiyakuymd;
    }

    public void setIfcKaiyakuymd(String pIfcKaiyakuymd) {
        ifcKaiyakuymd = pIfcKaiyakuymd;
    }
