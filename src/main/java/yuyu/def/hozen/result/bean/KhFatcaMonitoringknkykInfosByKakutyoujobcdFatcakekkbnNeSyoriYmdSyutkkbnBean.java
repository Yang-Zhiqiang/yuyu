...
/**
 * ＦＡＴＣＡモニタリング確認契約情報Beanクラスです。<br />
 */
@AllArgsConstructor
public class KhFatcaMonitoringknkykInfosByKakutyoujobcdFatcakekkbnNeSyoriYmdSyutkkbnBean implements Serializable,EntityContainer {
