...
/**
 * ＦＡＴＣＡ暦年報告情報Beanクラスです。<br />
 */
@AllArgsConstructor
public class FatcaRekinennReportInfosByKakutyoujobcdKouryokuendymdSyutkkbnFatcakekkbnBean implements Serializable,EntityContainer {
