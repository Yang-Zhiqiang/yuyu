...
/**
 * ＦＡＴＣＡモニタリング確認中契約情報Beanクラスです。<br />
 */
@AllArgsConstructor
public class KhFatcaMonitoringKakninInfosByKakutyoujobcdFatcakekkbnSyoriYmdSyutkkbnBean implements Serializable,EntityContainer {
