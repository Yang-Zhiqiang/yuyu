 ...
 * 外貨翌日繰越金額取得Beanです。<br />
 */
public class GkYokuziturkKgsByDensyskbnSyorizumiflgSyoriYmdZengetuLastdTuukasyuBean implements Serializable {

    public GkYokuziturkKgsByDensyskbnSyorizumiflgSyoriYmdZengetuLastdTuukasyuBean(
