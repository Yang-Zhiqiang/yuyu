...
/**
 * （新契約）当月発信不備一覧レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenSkTougetuHassinHubiLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenSkTougetuHassinHubiLayoutFile() {
    }
    ...
    @Column(order = 19, label = "成立区分")
    private String ifcSeiritukbn;

    public String getIfcSeiritukbn() {
        return ifcSeiritukbn;
    }

    public void setIfcSeiritukbn(String pIfcSeiritukbn) {
        ifcSeiritukbn = pIfcSeiritukbn;
    }

    @Column(order = 20, label = "不備解消日")
