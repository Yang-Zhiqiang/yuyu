...
/**
 * （新契約）モニタリングデータ（クーリングオフ）ＣＳＶＦ データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenSkMonitoringDataCoolingoffCsvFile implements Serializable {


    private static final long serialVersionUID = 1L;


    public GenSkMonitoringDataCoolingoffCsvFile() {
    }
