...
/**
 * （新契約）構成員契約リストレイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenSkKouseiinkeiyakuLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenSkKouseiinkeiyakuLayoutFile() {
    }
    ...
    @Column(order = 8, label = "パターン")
    private String ifcKouseiinnkykpattern;

    public String getIfcKouseiinnkykpattern() {
        return ifcKouseiinnkykpattern;
    }

    public void setIfcKouseiinnkykpattern(String pIfcKouseiinnkykpattern) {
        ifcKouseiinnkykpattern = pIfcKouseiinnkykpattern;
    }

    @Column(order = 9, label = "特記事項欄")
