...
/**
 * （新契約）連携用ＳＭＢＣペーパーレス申込情報ファイル データレイアウトのBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@Head(newlineCode="\r\n",encoding=YuyuStandardCharsets.WINDOWS_31J_STRING)
public class SkRnSmbcPaperlessMosFile extends GenSkRnSmbcPaperlessMosFile {

    private static final long serialVersionUID = 1L;

    public SkRnSmbcPaperlessMosFile() {
    }
