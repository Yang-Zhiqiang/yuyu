...
/**
 * （共通）外貨ＦＢ送金（経由銀行レコード）レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzGkFbsoukinKeiyuRecordLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzGkFbsoukinKeiyuRecordLayoutFile() {
    }
    ...
    @Column(order = 13, length = 76)
    private String iffFbdummy76;

    public String getIffFbdummy76() {
        return iffFbdummy76;
    }

    public void setIffFbdummy76(String pIffFbdummy76) {
        iffFbdummy76 = pIffFbdummy76;
    }
