...
/**
 * （共通）外貨ＦＢ送金（依頼人レコード）レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzGkFbsoukinIraininRecordLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzGkFbsoukinIraininRecordLayoutFile() {
    }
    ...
    private String iffFbiraininnmkigou;

    public String getIffFbiraininnmkigou() {
        return iffFbiraininnmkigou;
    }

    public void setIffFbiraininnmkigou(String pIffFbiraininnmkigou) {
        iffFbiraininnmkigou = pIffFbiraininnmkigou;
    }

    @Column(order = 8, length = 140)
    private String iffFbiraininnmdata;

    public String getIffFbiraininnmdata() {
        return iffFbiraininnmdata;
    }

    public void setIffFbiraininnmdata(String pIffFbiraininnmdata) {
        iffFbiraininnmdata = pIffFbiraininnmdata;
    }
