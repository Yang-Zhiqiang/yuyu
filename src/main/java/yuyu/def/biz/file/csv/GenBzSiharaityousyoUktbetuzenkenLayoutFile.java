...
/**
 * （共通）支払調書（受取人別）全件ファイルレイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzSiharaityousyoUktbetuzenkenLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzSiharaityousyoUktbetuzenkenLayoutFile() {
    }
    ...
    @Column(order = 16, label = "（ＩＦｃ）保険金等受取人個人・法人区分")
    ...
    @Column(order = 17, label = "（ＩＦｃ）契約者等住所（居所）又は所在地")
    ...
    @Column(order = 18, label = "（ＩＦｃ）契約者等国外住所表示")
    ...
    @Column(order = 19, label = "（ＩＦｃ）契約者等氏名又は名称")
    ...
    @Column(order = 20, label = "（ＩＦｃ）契約者等個人・法人区分")
    ...
    @Column(order = 21, label = "（ＩＦｃ）被保険者等住所（居所）又は所在地")
    ...
    @Column(order = 22, label = "（ＩＦｃ）被保険者等国外住所表示")
    ...
    @Column(order = 23, label = "（ＩＦｃ）被保険者等氏名又は名称")
    ...
    @Column(order = 24, label = "（ＩＦｃ）被保険者等個人・法人区分")
    ...
    @Column(order = 25, label = "（ＩＦｃ）保険金額等")
    ...
    @Column(order = 26, label = "（ＩＦｃ）増加又は割増保険金額等")
    ...
    @Column(order = 27, label = "（ＩＦｃ）未払利益配当金等")
    ...
    @Column(order = 28, label = "（ＩＦｃ）貸付金額・同未収利息")
    ...
    @Column(order = 29, label = "（ＩＦｃ）未払込保険料等")
    ...
    @Column(order = 30, label = "（ＩＦｃ）前納保険料等払戻金")
    ...
    @Column(order = 31, label = "（ＩＦｃ）差引支払保険金額等")
    ...
    @Column(order = 32, label = "（ＩＦｃ）既払込保険料等")
    ...
    @Column(order = 33, label = "（ＩＦｃ）既払込保険料等の剰余金又は割戻金")
    ...
    @Column(order = 34, label = "（ＩＦｃ）保険事故等")
    ...
    @Column(order = 35, label = "（ＩＦｃ）保険事故等発生年")
    ...
    @Column(order = 36, label = "（ＩＦｃ）保険事故等発生月")
    ...
    @Column(order = 37, label = "（ＩＦｃ）保険事故等発生日")
    ...
    @Column(order = 38, label = "（ＩＦｃ）保険等の種類")
    ...
    @Column(order = 39, label = "（ＩＦｃ）保険金等支払年")
    ...
    @Column(order = 40, label = "（ＩＦｃ）保険金等支払月")
    ...
    @Column(order = 41, label = "（ＩＦｃ）保険金等支払日")
