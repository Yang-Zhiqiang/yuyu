...
/**
 * （共通）専用帳票一括印刷送信ファイル（保険証券（一時払）レコード）レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzIkkatuinsatuHknSyoukenItijiLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzIkkatuinsatuHknSyoukenItijiLayoutFile() {
    }
    ...
    @Column(order = 153, label = "（ＩＦｃ）通信先郵便番号")
    ...
    @Column(order = 154, label = "（ＩＦｃ）通信先住所１（漢字）")
    ...
    @Column(order = 155, label = "（ＩＦｃ）通信先住所２（漢字）")
    ...
    @Column(order = 156, label = "（ＩＦｃ）通信先住所３（漢字）")
    ...
    @Column(order = 157, label = "（ＩＦｃ）通信先住所４（漢字）")
    ...
    @Column(order = 158, label = "（ＩＦｃ）相手先証券番号")
    ...
    @Column(order = 159, label = "（ＩＦｃ）新規再発行区分")
    ...
    @Column(order = 160, label = "（ＩＦｃ）代理店コード")
    ...
    @Column(order = 161, label = "（ＩＦｃ）代理店名（漢字）")
    ...
    @Column(order = 162, label = "（ＩＦｃ）解約返戻金有無区分")
    ...
    @Column(order = 163, label = "（ＩＦｃ）解約返戻金")
    ...
    @Column(order = 164, label = "（ＩＦｃ）死亡返還金")
    ...
    @Column(order = 165, label = "（ＩＦｃ）不担保部位名１")
    ...
    @Column(order = 166, label = "（ＩＦｃ）不担保期間１")
    ...
    @Column(order = 167, label = "（ＩＦｃ）不担保部位名２")
    ...
    @Column(order = 168, label = "（ＩＦｃ）不担保期間２")
    ...
    @Column(order = 169, label = "（ＩＦｃ）不担保部位名３")
    ...
    @Column(order = 170, label = "（ＩＦｃ）不担保期間３")
    ...
    @Column(order = 171, label = "（ＩＦｃ）不担保部位名４")
    ...
    @Column(order = 172, label = "（ＩＦｃ）不担保期間４")
    ...
    @Column(order = 173, label = "（ＩＦｃ）保険証券書留区分")
    ...
    @Column(order = 174, label = "（ＩＦｃ）取扱コード")
    ...
    @Column(order = 175, label = "（ＩＦｃ）帳票コード")
    ...
    @Column(order = 176, label = "（ＩＦｃ）帳票連絡先識別区分")
    ...
    @Column(order = 177, label = "（ＩＦｃ）がん責任開始日")
    ...
    @Column(order = 178, label = "（ＩＦｃ）がん入院給付日額")
    ...
    @Column(order = 179, label = "（ＩＦｃ）型区分_1")
    ...
    @Column(order = 180, label = "（ＩＦｃ）型区分_2")
    ...
    @Column(order = 181, label = "（ＩＦｃ）型区分_3")
    ...
    @Column(order = 182, label = "（ＩＦｃ）型区分_4")
    ...
    @Column(order = 183, label = "（ＩＦｃ）型区分_5")
    ...
    @Column(order = 184, label = "（ＩＦｃ）型区分_6")
    ...
    @Column(order = 185, label = "（ＩＦｃ）型区分_7")
    ...
    @Column(order = 186, label = "（ＩＦｃ）型区分_8")
    ...
    @Column(order = 187, label = "（ＩＦｃ）型区分_9")
    ...
    @Column(order = 188, label = "（ＩＦｃ）型区分_10")
    ...
    @Column(order = 189, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_1")
    ...
    @Column(order = 190, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_2")
    ...
    @Column(order = 191, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_3")
    ...
    @Column(order = 192, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_4")
    ...
    @Column(order = 193, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_5")
    ...
    @Column(order = 194, label = "（ＩＦｃ）死亡保険金受取人生年月日_1")
    ...
    @Column(order = 195, label = "（ＩＦｃ）死亡保険金受取人生年月日_2")
    ...
    @Column(order = 196, label = "（ＩＦｃ）死亡保険金受取人生年月日_3")
    ...
    @Column(order = 197, label = "（ＩＦｃ）死亡保険金受取人生年月日_4")
    ...
    @Column(order = 198, label = "（ＩＦｃ）死亡保険金受取人生年月日_5")
    ...
    @Column(order = 199, label = "（ＩＦｃ）死亡保険金受取人超過人数")
    ...
    @Column(order = 200, label = "（ＩＦｃ）死亡保険金超過人数分割割合")
    ...
    @Column(order = 201, label = "（ＩＦｃ）分割割合_1")
    ...
    @Column(order = 202, label = "（ＩＦｃ）分割割合_2")
    ...
    @Column(order = 203, label = "（ＩＦｃ）分割割合_3")
    ...
    @Column(order = 204, label = "（ＩＦｃ）分割割合_4")
    ...
    @Column(order = 205, label = "（ＩＦｃ）分割割合_5")
    ...
    @Column(order = 206, label = "（ＩＦｃ）エンド")
