...
/**
 * （共通）専用帳票一括印刷送信ファイル（保険証券レコード）レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzIkkatuinsatuHknsyoukenRecordLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzIkkatuinsatuHknsyoukenRecordLayoutFile() {
    }
    ...
    @Column(order = 7, label = "（ＩＦｃ）責任開始日")
    ...
    @Column(order = 8, label = "（ＩＦｃ）商品名（証券用）")
    ...
    @Column(order = 9, label = "（ＩＦｃ）契約者名（漢字）")
    ...
    @Column(order = 10, label = "（ＩＦｃ）契約者名漢字化不可区分")
    ...
    @Column(order = 11, label = "（ＩＦｃ）被保険者名（漢字）")
    ...
    @Column(order = 12, label = "（ＩＦｃ）被保険者名漢字化不可区分")
    ...
    @Column(order = 13, label = "（ＩＦｃ）被保険者生年月日")
    ...
    @Column(order = 14, label = "（ＩＦｃ）被保険者性別")
    ...
    @Column(order = 15, label = "（ＩＦｃ）被保険者年齢")
    ...
    @Column(order = 16, label = "（ＩＦｃ）死亡返還金受取人氏名（漢字）")
    ...
    @Column(order = 17, label = "（ＩＦｃ）死亡返還金受取人生年月日")
    ...
    @Column(order = 18, label = "（ＩＦｃ）指定代理請求人名（漢字）")
    ...
    @Column(order = 19, label = "（ＩＦｃ）指定代理請求人生年月日")
    ...
    @Column(order = 20, label = "（ＩＦｃ）払込保険料")
    ...
    @Column(order = 21, label = "（ＩＦｃ）払込回数")
    ...
    @Column(order = 22, label = "（ＩＦｃ）払込経路")
    ...
    @Column(order = 23, label = "（ＩＦｃ）主契約特約区分_1")
    ...
    @Column(order = 24, label = "（ＩＦｃ）主契約特約区分_2")
    ...
    @Column(order = 25, label = "（ＩＦｃ）主契約特約区分_3")
    ...
    @Column(order = 26, label = "（ＩＦｃ）主契約特約区分_4")
    ...
    @Column(order = 27, label = "（ＩＦｃ）主契約特約区分_5")
    ...
    @Column(order = 28, label = "（ＩＦｃ）主契約特約区分_6")
    ...
    @Column(order = 29, label = "（ＩＦｃ）主契約特約区分_7")
    ...
    @Column(order = 30, label = "（ＩＦｃ）主契約特約区分_8")
    ...
    @Column(order = 31, label = "（ＩＦｃ）主契約特約区分_9")
    ...
    @Column(order = 32, label = "（ＩＦｃ）主契約特約区分_10")
    ...
    @Column(order = 33, label = "（ＩＦｃ）商品コード_1")
    ...
    @Column(order = 34, label = "（ＩＦｃ）商品コード_2")
    ...
    @Column(order = 35, label = "（ＩＦｃ）商品コード_3")
    ...
    @Column(order = 36, label = "（ＩＦｃ）商品コード_4")
    ...
    @Column(order = 37, label = "（ＩＦｃ）商品コード_5")
    ...
    @Column(order = 38, label = "（ＩＦｃ）商品コード_6")
    ...
    @Column(order = 39, label = "（ＩＦｃ）商品コード_7")
    ...
    @Column(order = 40, label = "（ＩＦｃ）商品コード_8")
    ...
    @Column(order = 41, label = "（ＩＦｃ）商品コード_9")
    ...
    @Column(order = 42, label = "（ＩＦｃ）商品コード_10")
    ...
    @Column(order = 43, label = "（ＩＦｃ）商品世代番号_1")
    ...
    @Column(order = 44, label = "（ＩＦｃ）商品世代番号_2")
    ...
    @Column(order = 45, label = "（ＩＦｃ）商品世代番号_3")
    ...
    @Column(order = 46, label = "（ＩＦｃ）商品世代番号_4")
    ...
    @Column(order = 47, label = "（ＩＦｃ）商品世代番号_5")
    ...
    @Column(order = 48, label = "（ＩＦｃ）商品世代番号_6")
    ...
    @Column(order = 49, label = "（ＩＦｃ）商品世代番号_7")
    ...
    @Column(order = 50, label = "（ＩＦｃ）商品世代番号_8")
    ...
    @Column(order = 51, label = "（ＩＦｃ）商品世代番号_9")
    ...
    @Column(order = 52, label = "（ＩＦｃ）商品世代番号_10")
    ...
    @Column(order = 53, label = "（ＩＦｃ）契約商品連番_1")
    ...
    @Column(order = 54, label = "（ＩＦｃ）契約商品連番_2")
    ...
    @Column(order = 55, label = "（ＩＦｃ）契約商品連番_3")
    ...
    @Column(order = 56, label = "（ＩＦｃ）契約商品連番_4")
    ...
    @Column(order = 57, label = "（ＩＦｃ）契約商品連番_5")
    ...
    @Column(order = 58, label = "（ＩＦｃ）契約商品連番_6")
    ...
    @Column(order = 59, label = "（ＩＦｃ）契約商品連番_7")
    ...
    @Column(order = 60, label = "（ＩＦｃ）契約商品連番_8")
    ...
    @Column(order = 61, label = "（ＩＦｃ）契約商品連番_9")
    ...
    @Column(order = 62, label = "（ＩＦｃ）契約商品連番_10")
    ...
    @Column(order = 63, label = "（ＩＦｃ）給付限度型区分_1")
    ...
    @Column(order = 64, label = "（ＩＦｃ）給付限度型区分_2")
    ...
    @Column(order = 65, label = "（ＩＦｃ）給付限度型区分_3")
    ...
    @Column(order = 66, label = "（ＩＦｃ）給付限度型区分_4")
    ...
    @Column(order = 67, label = "（ＩＦｃ）給付限度型区分_5")
    ...
    @Column(order = 68, label = "（ＩＦｃ）給付限度型区分_6")
    ...
    @Column(order = 69, label = "（ＩＦｃ）給付限度型区分_7")
    ...
    @Column(order = 70, label = "（ＩＦｃ）給付限度型区分_8")
    ...
    @Column(order = 71, label = "（ＩＦｃ）給付限度型区分_9")
    ...
    @Column(order = 72, label = "（ＩＦｃ）給付限度型区分_10")
    ...
    @Column(order = 73, label = "（ＩＦｃ）保険期間歳満期区分_1")
    ...
    @Column(order = 74, label = "（ＩＦｃ）保険期間歳満期区分_2")
    ...
    @Column(order = 75, label = "（ＩＦｃ）保険期間歳満期区分_3")
    ...
    @Column(order = 76, label = "（ＩＦｃ）保険期間歳満期区分_4")
    ...
    @Column(order = 77, label = "（ＩＦｃ）保険期間歳満期区分_5")
    ...
    @Column(order = 78, label = "（ＩＦｃ）保険期間歳満期区分_6")
    ...
    @Column(order = 79, label = "（ＩＦｃ）保険期間歳満期区分_7")
    ...
    @Column(order = 80, label = "（ＩＦｃ）保険期間歳満期区分_8")
    ...
    @Column(order = 81, label = "（ＩＦｃ）保険期間歳満期区分_9")
    ...
    @Column(order = 82, label = "（ＩＦｃ）保険期間歳満期区分_10")
    ...
    @Column(order = 83, label = "（ＩＦｃ）保険期間_1")
    ...
    @Column(order = 84, label = "（ＩＦｃ）保険期間_2")
    ...
    @Column(order = 85, label = "（ＩＦｃ）保険期間_3")
    ...
    @Column(order = 86, label = "（ＩＦｃ）保険期間_4")
    ...
    @Column(order = 87, label = "（ＩＦｃ）保険期間_5")
    ...
    @Column(order = 88, label = "（ＩＦｃ）保険期間_6")
    ...
    @Column(order = 89, label = "（ＩＦｃ）保険期間_7")
    ...
    @Column(order = 90, label = "（ＩＦｃ）保険期間_8")
    ...
    @Column(order = 91, label = "（ＩＦｃ）保険期間_9")
    ...
    @Column(order = 92, label = "（ＩＦｃ）保険期間_10")
    ...
    @Column(order = 93, label = "（ＩＦｃ）払込期間歳満期区分_1")
    ...
    @Column(order = 94, label = "（ＩＦｃ）払込期間歳満期区分_2")
    ...
    @Column(order = 95, label = "（ＩＦｃ）払込期間歳満期区分_3")
    ...
    @Column(order = 96, label = "（ＩＦｃ）払込期間歳満期区分_4")
    ...
    @Column(order = 97, label = "（ＩＦｃ）払込期間歳満期区分_5")
    ...
    @Column(order = 98, label = "（ＩＦｃ）払込期間歳満期区分_6")
    ...
    @Column(order = 99, label = "（ＩＦｃ）払込期間歳満期区分_7")
    ...
    @Column(order = 100, label = "（ＩＦｃ）払込期間歳満期区分_8")
    ...
    @Column(order = 101, label = "（ＩＦｃ）払込期間歳満期区分_9")
    ...
    @Column(order = 102, label = "（ＩＦｃ）払込期間歳満期区分_10")
    ...
    @Column(order = 103, label = "（ＩＦｃ）払込期間_1")
    ...
    @Column(order = 104, label = "（ＩＦｃ）払込期間_2")
    ...
    @Column(order = 105, label = "（ＩＦｃ）払込期間_3")
    ...
    @Column(order = 106, label = "（ＩＦｃ）払込期間_4")
    ...
    @Column(order = 107, label = "（ＩＦｃ）払込期間_5")
    ...
    @Column(order = 108, label = "（ＩＦｃ）払込期間_6")
    ...
    @Column(order = 109, label = "（ＩＦｃ）払込期間_7")
    ...
    @Column(order = 110, label = "（ＩＦｃ）払込期間_8")
    ...
    @Column(order = 111, label = "（ＩＦｃ）払込期間_9")
    ...
    @Column(order = 112, label = "（ＩＦｃ）払込期間_10")
    ...
    @Column(order = 113, label = "（ＩＦｃ）商品名_1")
    ...
    @Column(order = 114, label = "（ＩＦｃ）商品名_2")
    ...
    @Column(order = 115, label = "（ＩＦｃ）商品名_3")
    ...
    @Column(order = 116, label = "（ＩＦｃ）商品名_4")
    ...
    @Column(order = 117, label = "（ＩＦｃ）商品名_5")
    ...
    @Column(order = 118, label = "（ＩＦｃ）商品名_6")
    ...
    @Column(order = 119, label = "（ＩＦｃ）商品名_7")
    ...
    @Column(order = 120, label = "（ＩＦｃ）商品名_8")
    ...
    @Column(order = 121, label = "（ＩＦｃ）商品名_9")
    ...
    @Column(order = 122, label = "（ＩＦｃ）商品名_10")
    ...
    @Column(order = 123, label = "（ＩＦｃ）基本Ｓ_1")
    ...
    @Column(order = 124, label = "（ＩＦｃ）基本Ｓ_2")
    ...
    @Column(order = 125, label = "（ＩＦｃ）基本Ｓ_3")
    ...
    @Column(order = 126, label = "（ＩＦｃ）基本Ｓ_4")
    ...
    @Column(order = 127, label = "（ＩＦｃ）基本Ｓ_5")
    ...
    @Column(order = 128, label = "（ＩＦｃ）基本Ｓ_6")
    ...
    @Column(order = 129, label = "（ＩＦｃ）基本Ｓ_7")
    ...
    @Column(order = 130, label = "（ＩＦｃ）基本Ｓ_8")
    ...
    @Column(order = 131, label = "（ＩＦｃ）基本Ｓ_9")
    ...
    @Column(order = 132, label = "（ＩＦｃ）基本Ｓ_10")
    ...
    @Column(order = 133, label = "（ＩＦｃ）保険料_1")
    ...
    @Column(order = 134, label = "（ＩＦｃ）保険料_2")
    ...
    @Column(order = 135, label = "（ＩＦｃ）保険料_3")
    ...
    @Column(order = 136, label = "（ＩＦｃ）保険料_4")
    ...
    @Column(order = 137, label = "（ＩＦｃ）保険料_5")
    ...
    @Column(order = 138, label = "（ＩＦｃ）保険料_6")
    ...
    @Column(order = 139, label = "（ＩＦｃ）保険料_7")
    ...
    @Column(order = 140, label = "（ＩＦｃ）保険料_8")
    ...
    @Column(order = 141, label = "（ＩＦｃ）保険料_9")
    ...
    @Column(order = 142, label = "（ＩＦｃ）保険料_10")
    ...
    @Column(order = 143, label = "（ＩＦｃ）基本Ｓ種類区分_1")
    ...
    @Column(order = 144, label = "（ＩＦｃ）基本Ｓ種類区分_2")
    ...
    @Column(order = 145, label = "（ＩＦｃ）基本Ｓ種類区分_3")
    ...
    @Column(order = 146, label = "（ＩＦｃ）基本Ｓ種類区分_4")
    ...
    @Column(order = 147, label = "（ＩＦｃ）基本Ｓ種類区分_5")
    ...
    @Column(order = 148, label = "（ＩＦｃ）基本Ｓ種類区分_6")
    ...
    @Column(order = 149, label = "（ＩＦｃ）基本Ｓ種類区分_7")
    ...
    @Column(order = 150, label = "（ＩＦｃ）基本Ｓ種類区分_8")
    ...
    @Column(order = 151, label = "（ＩＦｃ）基本Ｓ種類区分_9")
    ...
    @Column(order = 152, label = "（ＩＦｃ）基本Ｓ種類区分_10")
    ...
    @Column(order = 153, label = "（ＩＦｃ）手術給付金型区分_1")
    ...
    @Column(order = 154, label = "（ＩＦｃ）手術給付金型区分_2")
    ...
    @Column(order = 155, label = "（ＩＦｃ）手術給付金型区分_3")
    ...
    @Column(order = 156, label = "（ＩＦｃ）手術給付金型区分_4")
    ...
    @Column(order = 157, label = "（ＩＦｃ）手術給付金型区分_5")
    ...
    @Column(order = 158, label = "（ＩＦｃ）手術給付金型区分_6")
    ...
    @Column(order = 159, label = "（ＩＦｃ）手術給付金型区分_7")
    ...
    @Column(order = 160, label = "（ＩＦｃ）手術給付金型区分_8")
    ...
    @Column(order = 161, label = "（ＩＦｃ）手術給付金型区分_9")
    ...
    @Column(order = 162, label = "（ＩＦｃ）手術給付金型区分_10")
    ...
    @Column(order = 163, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_1")
    ...
    @Column(order = 164, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_2")
    ...
    @Column(order = 165, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_3")
    ...
    @Column(order = 166, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_4")
    ...
    @Column(order = 167, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_5")
    ...
    @Column(order = 168, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_6")
    ...
    @Column(order = 169, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_7")
    ...
    @Column(order = 170, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_8")
    ...
    @Column(order = 171, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_9")
    ...
    @Column(order = 172, label = "（ＩＦｃ）６大生活習慣病追加給付型区分_10")
    ...
    @Column(order = 173, label = "（ＩＦｃ）基本給付金額_1")
    ...
    @Column(order = 174, label = "（ＩＦｃ）基本給付金額_2")
    ...
    @Column(order = 175, label = "（ＩＦｃ）基本給付金額_3")
    ...
    @Column(order = 176, label = "（ＩＦｃ）基本給付金額_4")
    ...
    @Column(order = 177, label = "（ＩＦｃ）基本給付金額_5")
    ...
    @Column(order = 178, label = "（ＩＦｃ）基本給付金額_6")
    ...
    @Column(order = 179, label = "（ＩＦｃ）基本給付金額_7")
    ...
    @Column(order = 180, label = "（ＩＦｃ）基本給付金額_8")
    ...
    @Column(order = 181, label = "（ＩＦｃ）基本給付金額_9")
    ...
    @Column(order = 182, label = "（ＩＦｃ）基本給付金額_10")
    ...
    @Column(order = 183, label = "（ＩＦｃ）通信先郵便番号")
    ...
    @Column(order = 184, label = "（ＩＦｃ）通信先住所１（漢字）")
    ...
    @Column(order = 185, label = "（ＩＦｃ）通信先住所２（漢字）")
    ...
    @Column(order = 186, label = "（ＩＦｃ）通信先住所３（漢字）")
    ...
    @Column(order = 187, label = "（ＩＦｃ）通信先住所４（漢字）")
    ...
    @Column(order = 188, label = "（ＩＦｃ）相手先証券番号")
    ...
    @Column(order = 189, label = "（ＩＦｃ）新規再発行区分")
    private C_SinsaihkKbn ifcSinsaihkkbn;

    public C_SinsaihkKbn getIfcSinsaihkkbn() {
        return ifcSinsaihkkbn;
    }

    public void setIfcSinsaihkkbn(C_SinsaihkKbn pIfcSinsaihkkbn) {
        ifcSinsaihkkbn = pIfcSinsaihkkbn;
    }

    @Column(order = 190, label = "（ＩＦｃ）案内状同封有無区分")
    private C_UmuKbn ifcAnnaijydhumukbn;

    public C_UmuKbn getIfcAnnaijydhumukbn() {
        return ifcAnnaijydhumukbn;
    }

    public void setIfcAnnaijydhumukbn(C_UmuKbn pIfcAnnaijydhumukbn) {
        ifcAnnaijydhumukbn = pIfcAnnaijydhumukbn;
    }
    ...
    @Column(order = 205, label = "（ＩＦｃ）保険証券書留区分")
    private C_YouhiKbn ifcHknsyokakitomekbn;

    public C_YouhiKbn getIfcHknsyokakitomekbn() {
        return ifcHknsyokakitomekbn;
    }

    public void setIfcHknsyokakitomekbn(C_YouhiKbn pIfcHknsyokakitomekbn) {
        ifcHknsyokakitomekbn = pIfcHknsyokakitomekbn;
    }
    ...
    @Column(order = 213, label = "（ＩＦｃ）証券印字形式区分")
    private Integer ifcSyoinjitypekbn;

    public Integer getIfcSyoinjitypekbn() {
        return ifcSyoinjitypekbn;
    }

    public void setIfcSyoinjitypekbn(Integer pIfcSyoinjitypekbn) {
        ifcSyoinjitypekbn = pIfcSyoinjitypekbn;
    }

    @Column(order = 214, label = "（ＩＦｃ）手続種類区分")
    ...
    @Column(order = 215, label = "（ＩＦｃ）契約変更内容")
    private String ifcKykhnknaiyou;

    public String getIfcKykhnknaiyou() {
        return ifcKykhnknaiyou;
    }

    public void setIfcKykhnknaiyou(String pIfcKykhnknaiyou) {
        ifcKykhnknaiyou = pIfcKykhnknaiyou;
    }

    @Column(order = 216, label = "（ＩＦｃ）特条削減期間")
    private C_Tkjyskgnkkn ifcTkjyskgnkknkbn;

    public C_Tkjyskgnkkn getIfcTkjyskgnkknkbn() {
        return ifcTkjyskgnkknkbn;
    }

    public void setIfcTkjyskgnkknkbn(C_Tkjyskgnkkn pIfcTkjyskgnkknkbn) {
        ifcTkjyskgnkknkbn = pIfcTkjyskgnkknkbn;
    }

    @Column(order = 217, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_1")
    ...
    @Column(order = 218, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_2")
    ...
    @Column(order = 219, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_3")
    ...
    @Column(order = 220, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_4")
    ...
    @Column(order = 221, label = "（ＩＦｃ）死亡保険金受取人氏名（漢字）_5")
    ...
    @Column(order = 222, label = "（ＩＦｃ）死亡保険金受取人生年月日_1")
    ...
    @Column(order = 223, label = "（ＩＦｃ）死亡保険金受取人生年月日_2")
    ...
    @Column(order = 224, label = "（ＩＦｃ）死亡保険金受取人生年月日_3")
    ...
    @Column(order = 225, label = "（ＩＦｃ）死亡保険金受取人生年月日_4")
    ...
    @Column(order = 226, label = "（ＩＦｃ）死亡保険金受取人生年月日_5")
    ...
    @Column(order = 227, label = "（ＩＦｃ）死亡保険金受取人超過人数")
    ...
    @Column(order = 228, label = "（ＩＦｃ）死亡保険金超過人数分割割合")
    ...
    @Column(order = 229, label = "（ＩＦｃ）分割割合_1")
    ...
    @Column(order = 230, label = "（ＩＦｃ）分割割合_2")
    ...
    @Column(order = 231, label = "（ＩＦｃ）分割割合_3")
    ...
    @Column(order = 232, label = "（ＩＦｃ）分割割合_4")
    ...
    @Column(order = 233, label = "（ＩＦｃ）分割割合_5")
    ...
    @Column(order = 234, label = "（ＩＦｃ）エンド")
