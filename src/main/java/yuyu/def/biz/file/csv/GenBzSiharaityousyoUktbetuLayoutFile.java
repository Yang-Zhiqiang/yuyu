...
/**
 * （共通）支払調書（受取人別）ファイルレイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzSiharaityousyoUktbetuLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzSiharaityousyoUktbetuLayoutFile() {
    }

    @Column(order = 1, label = "（ＩＦｃ）法定資料種類区分")
    ...
    @Column(order = 2, label = "（ＩＦｃ）整理番号１")
    ...
    @Column(order = 3, label = "（ＩＦｃ）本支店等区分番号")
    ...
    @Column(order = 4, label = "（ＩＦｃ）提出義務者の住所（居所）又は所在地")
    ...
    @Column(order = 5, label = "（ＩＦｃ）提出義務者の氏名又は名称")
    ...
    @Column(order = 6, label = "（ＩＦｃ）提出義務者の電話番号")
    ...
    @Column(order = 7, label = "（ＩＦｃ）整理番号２")
    ...
    @Column(order = 8, label = "（ＩＦｃ）提出者の住所（居所）又は所在地")
    ...
    @Column(order = 9, label = "（ＩＦｃ）提出者の氏名又は名称")
    ...
    @Column(order = 10, label = "（ＩＦｃ）訂正表示")
    ...
    @Column(order = 12, label = "（ＩＦｃ）保険金等受取人住所（居所）又は所在地")
    ...
    @Column(order = 13, label = "（ＩＦｃ）保険金等受取人国外住所表示")
    ...
    @Column(order = 14, label = "（ＩＦｃ）保険金等受取人氏名又は名称")
    ...
    @Column(order = 15, label = "（ＩＦｃ）保険金等受取人個人・法人区分")
    private C_Kojinhjn ifcHknknuktkojinhjnkbn;

    public C_Kojinhjn getIfcHknknuktkojinhjnkbn() {
        return ifcHknknuktkojinhjnkbn;
    }

    public void setIfcHknknuktkojinhjnkbn(C_Kojinhjn pIfcHknknuktkojinhjnkbn) {
        ifcHknknuktkojinhjnkbn = pIfcHknknuktkojinhjnkbn;
    }
    ...
    @Column(order = 19, label = "（ＩＦｃ）契約者等個人・法人区分")
    private C_Kojinhjn ifcKykkojinhjnkbn;

    public C_Kojinhjn getIfcKykkojinhjnkbn() {
        return ifcKykkojinhjnkbn;
    }

    public void setIfcKykkojinhjnkbn(C_Kojinhjn pIfcKykkojinhjnkbn) {
        ifcKykkojinhjnkbn = pIfcKykkojinhjnkbn;
    }

    @Column(order = 20, label = "（ＩＦｃ）被保険者等住所（居所）又は所在地")
    ...
    @Column(order = 21, label = "（ＩＦｃ）被保険者等国外住所表示")
    ...
    @Column(order = 22, label = "（ＩＦｃ）被保険者等氏名又は名称")
    ...
    @Column(order = 23, label = "（ＩＦｃ）被保険者等個人・法人区分")
    private C_Kojinhjn ifcHhkkojinhjnkbn;

    public C_Kojinhjn getIfcHhkkojinhjnkbn() {
        return ifcHhkkojinhjnkbn;
    }

    public void setIfcHhkkojinhjnkbn(C_Kojinhjn pIfcHhkkojinhjnkbn) {
        ifcHhkkojinhjnkbn = pIfcHhkkojinhjnkbn;
    }

    @Column(order = 24, label = "（ＩＦｃ）保険金額等")
    ...
    @Column(order = 25, label = "（ＩＦｃ）増加又は割増保険金額等")
    ...
    @Column(order = 26, label = "（ＩＦｃ）未払利益配当金等")
    ...
    @Column(order = 27, label = "（ＩＦｃ）貸付金額・同未収利息")
    ...
    @Column(order = 28, label = "（ＩＦｃ）未払込保険料等")
    ...
    @Column(order = 29, label = "（ＩＦｃ）前納保険料等払戻金")
    ...
    @Column(order = 30, label = "（ＩＦｃ）差引支払保険金額等")
    ...
    @Column(order = 31, label = "（ＩＦｃ）既払込保険料等")
    ...
    @Column(order = 32, label = "（ＩＦｃ）既払込保険料等の剰余金又は割戻金")
    private String ifcKihrkmpetcjyoykwrmdsk;

    public String getIfcKihrkmpetcjyoykwrmdsk() {
        return ifcKihrkmpetcjyoykwrmdsk;
    }

    public void setIfcKihrkmpetcjyoykwrmdsk(String pIfcKihrkmpetcjyoykwrmdsk) {
        ifcKihrkmpetcjyoykwrmdsk = pIfcKihrkmpetcjyoykwrmdsk;
    }

    @Column(order = 33, label = "（ＩＦｃ）保険事故等")
    ...
    @Column(order = 34, label = "（ＩＦｃ）保険事故等発生年")
    ...
    @Column(order = 35, label = "（ＩＦｃ）保険事故等発生月")
    ...
    @Column(order = 36, label = "（ＩＦｃ）保険事故等発生日")
    ...
    @Column(order = 37, label = "（ＩＦｃ）保険等の種類")
    ...
    @Column(order = 38, label = "（ＩＦｃ）保険金等支払年")
    ...
    @Column(order = 39, label = "（ＩＦｃ）保険金等支払月")
    ...
    @Column(order = 40, label = "（ＩＦｃ）保険金等支払日")
    ...
    @Column(order = 41, label = "（ＩＦｃ）提出年")
    private String ifcTeisyutuy;

    public String getIfcTeisyutuy() {
        return ifcTeisyutuy;
    }

    public void setIfcTeisyutuy(String pIfcTeisyutuy) {
        ifcTeisyutuy = pIfcTeisyutuy;
    }

    @Column(order = 42, label = "（ＩＦｃ）提出月")
    private String ifcTeisyutum;

    public String getIfcTeisyutum() {
        return ifcTeisyutum;
    }

    public void setIfcTeisyutum(String pIfcTeisyutum) {
        ifcTeisyutum = pIfcTeisyutum;
    }

    @Column(order = 43, label = "（ＩＦｃ）提出日")
    private String ifcTeisyutud;

    public String getIfcTeisyutud() {
        return ifcTeisyutud;
    }

    public void setIfcTeisyutud(String pIfcTeisyutud) {
        ifcTeisyutud = pIfcTeisyutud;
    }

    @Column(order = 44, label = "（ＩＦｃ）摘要")
