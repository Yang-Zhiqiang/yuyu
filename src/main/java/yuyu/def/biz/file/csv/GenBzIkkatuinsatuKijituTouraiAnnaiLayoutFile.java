...
/**
 * （共通）専用帳票一括印刷送信ファイル（期日到来案内レコード）レイアウトファイル データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzIkkatuinsatuKijituTouraiAnnaiLayoutFile implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzIkkatuinsatuKijituTouraiAnnaiLayoutFile() {
    }
    ...
    @Column(order = 9, label = "（ＩＦｃ）領収金額（１３，３桁）")
    ...
    @Column(order = 15, label = "（ＩＦｃ）保護項目名")
    ...
    @Column(order = 16, label = "（ＩＦｃ）契約者名（漢字）")
    ...
    @Column(order = 17, label = "（ＩＦｃ）通信先郵便番号")
    ...
    @Column(order = 18, label = "（ＩＦｃ）通信先住所１（漢字）")
    ...
    @Column(order = 19, label = "（ＩＦｃ）通信先住所２（漢字）")
    ...
    @Column(order = 20, label = "（ＩＦｃ）通信先住所３（漢字）")
    ...
    @Column(order = 21, label = "（ＩＦｃ）通信先住所４（漢字）")
    ...
    @Column(order = 22, label = "（ＩＦｃ）被保険者名（漢字）")
    ...
    @Column(order = 24, label = "（ＩＦｃ）銀行名（漢字）")
    ...
    @Column(order = 25, label = "（ＩＦｃ）支店名（漢字）")
    ...
    @Column(order = 26, label = "（ＩＦｃ）預金種目区分")
    ...
    @Column(order = 27, label = "（ＩＦｃ）預金種目名（漢字）")
    ...
    @Column(order = 28, label = "（ＩＦｃ）代理店コード")
    ...
    @Column(order = 29, label = "（ＩＦｃ）代理店名（漢字）")
    ...
    @Column(order = 31, label = "（ＩＦｃ）帳票作成日")
