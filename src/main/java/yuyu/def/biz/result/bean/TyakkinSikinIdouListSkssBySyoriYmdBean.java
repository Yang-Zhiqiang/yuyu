...
/**
 * 着金日分資金移動リスト作成用データBeanです。<br />
 */
public class TyakkinSikinIdouListSkssBySyoriYmdBean implements Serializable {

    public TyakkinSikinIdouListSkssBySyoriYmdBean(
        BizDate pTyakkinymd, C_Segcd pSeg1cd, C_Tuukasyu pKyktuukasyu,
