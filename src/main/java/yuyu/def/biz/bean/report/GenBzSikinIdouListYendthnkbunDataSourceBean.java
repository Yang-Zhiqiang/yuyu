...
/**
 * （共通）資金移動リスト（円建変更分）帳票DSBEAN データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzSikinIdouListYendthnkbunDataSourceBean implements IReportDataSouceBean {

    private static final long serialVersionUID = 1L;

    public GenBzSikinIdouListYendthnkbunDataSourceBean() {
    }
    ...
    private String irKeiriyendthnkkbnnm;

    public String getIrKeiriyendthnkkbnnm() {
        return irKeiriyendthnkkbnnm;
    }

    public void setIrKeiriyendthnkkbnnm(String pIrKeiriyendthnkkbnnm) {
        irKeiriyendthnkkbnnm = pIrKeiriyendthnkkbnnm;
    }

    private String irSikinidoulisttyuukimsg;

    public String getIrSikinidoulisttyuukimsg() {
        return irSikinidoulisttyuukimsg;
    }

    public void setIrSikinidoulisttyuukimsg(String pIrSikinidoulisttyuukimsg) {
        irSikinidoulisttyuukimsg = pIrSikinidoulisttyuukimsg;
    }
