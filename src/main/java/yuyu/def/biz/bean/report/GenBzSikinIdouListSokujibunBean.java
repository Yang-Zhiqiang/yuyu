...
/**
 * （共通）資金移動リスト（即時分）帳票BEAN データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenBzSikinIdouListSokujibunBean implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenBzSikinIdouListSokujibunBean() {
    }
