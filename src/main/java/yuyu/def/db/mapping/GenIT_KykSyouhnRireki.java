...
import yuyu.def.db.id.PKIT_KykSyouhnRireki;
import yuyu.def.db.meta.GenQIT_KykSyouhnRireki;
...
/**
 * 契約商品履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_KykSyouhnRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykSyouhnRireki}</td><td colspan="3">契約商品履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KykSyouhnRireki
 * @see     PKIT_KykSyouhnRireki
 * @see     QIT_KykSyouhnRireki
 * @see     GenQIT_KykSyouhnRireki
 */
@MappedSuperclass
@Table(name=GenIT_KykSyouhnRireki.TABLE_NAME)
@IdClass(value=PKIT_KykSyouhnRireki.class)
@TypeDefs({
...
public abstract class GenIT_KykSyouhnRireki extends AbstractExDBEntity<IT_KykSyouhnRireki, PKIT_KykSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykSyouhnRireki";
    ...
    private final PKIT_KykSyouhnRireki primaryKey;

    public GenIT_KykSyouhnRireki() {
        primaryKey = new PKIT_KykSyouhnRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_KykSyouhnRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykSyouhnRireki> getMetaClass() {
        return QIT_KykSyouhnRireki.class;
    }

    @Id
    @Column(name=GenIT_KykSyouhnRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykSyouhnRireki.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KykSyouhnRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_KykSyouhnRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_KykSyouhnRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_KykSyouhnRireki.KYKSYOUHNRENNO)
    ...
    @Id
    @Column(name=GenIT_KykSyouhnRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KykSyouhnRireki.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_KykSyouhnRireki.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.KYKYMD)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KYKYMDSITEIUMUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.GANSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.HKSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.HKGANSKNNKAISIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyouhnRireki.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KykSyouhnRireki.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KykSyouhnRireki.KYKNEN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyouhnRireki.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KATAKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.PMNJTKKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.RYOURITUSDNO)
    ...
    @Column(name=GenIT_KykSyouhnRireki.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_KykSyouhnRireki.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.NKSYUKBN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.NENKINKKN)
    ...
    @Column(name=GenIT_KykSyouhnRireki.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykSyouhnRireki.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.YENDTHNKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.KYKJISISUURENDOURATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.TUMITATERIRITU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.TMTTKNHAIBUNJYOUTAI)
    ...
    @Column(name=GenIT_KykSyouhnRireki.SISUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KykSyouhnRireki.GSBUNRIKZKAKUNINUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KykSyouhnRireki.GSBUNRITAISYOU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhnRireki.TMTTKNITENYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.LOADINGHNKGTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.RENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhnRireki.TEIKISHRRITU)
    ...
    @Column(name=GenIT_KykSyouhnRireki.DAI1HKNKKN)
    @Range(min="0", max="99")
