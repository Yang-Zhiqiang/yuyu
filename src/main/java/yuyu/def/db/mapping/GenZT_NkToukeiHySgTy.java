...
/**
 * 年金統計Ｆ保有照合用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkToukeiHySgTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkToukeiHySgTy}</td><td colspan="3">年金統計Ｆ保有照合用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_NkToukeiHySgTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_NkToukeiHySgTy
 * @see     PKZT_NkToukeiHySgTy
 * @see     QZT_NkToukeiHySgTy
 * @see     GenQZT_NkToukeiHySgTy
 */
@MappedSuperclass
@Table(name=GenZT_NkToukeiHySgTy.TABLE_NAME)
@IdClass(value=PKZT_NkToukeiHySgTy.class)
public abstract class GenZT_NkToukeiHySgTy extends AbstractExDBEntity<ZT_NkToukeiHySgTy, PKZT_NkToukeiHySgTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkToukeiHySgTy";
    ...
    private final PKZT_NkToukeiHySgTy primaryKey;

    public GenZT_NkToukeiHySgTy() {
        primaryKey = new PKZT_NkToukeiHySgTy();
    }

    public GenZT_NkToukeiHySgTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_NkToukeiHySgTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_NkToukeiHySgTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkToukeiHySgTy> getMetaClass() {
        return QZT_NkToukeiHySgTy.class;
    }

    @Id
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYSTEMCD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYULFKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYIDOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOUIN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINSYU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYCURRENTDAY)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYCURRENTTIME)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKASANNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKKNSETYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTEIZOURITU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYDKIGETU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUNENDOD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSIHARAIUKETUKEBASYO)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSHIHARAIHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV1X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV1X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV1X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV8X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV8X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV59)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYYOBIV17)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINKKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINENKINSYURUIKIGOU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINKSHRKKN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINKHHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKIMSNKDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYSAISYUUNENKINKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZENNENDOKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZNZNNNDKAIMASINKZOUGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZNZNZNNNDKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUNENDOKAIMASINENKIND)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASITYUUSIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASIHUKKIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYKAIMASINKKIGOUSDKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMAEATUATOATUKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMAEATUATOATUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYMAEATUATOATUHENDOUGONKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYATOATUSAISYUUKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYATOATUKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYZNZNZNNNDATATKIMSNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYTOUNENDATOATUKAIMASINKD)
    ...
    @Column(name=GenZT_NkToukeiHySgTy.ZTYUWANOSEATOATUKAIMASINKGK)
