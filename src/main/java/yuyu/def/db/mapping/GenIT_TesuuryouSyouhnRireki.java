...
import yuyu.def.db.id.PKIT_TesuuryouSyouhnRireki;
import yuyu.def.db.meta.GenQIT_TesuuryouSyouhnRireki;
...
/**
 * 手数料情報商品履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_TesuuryouSyouhnRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_TesuuryouSyouhnRireki}</td><td colspan="3">手数料情報商品履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTsrysyorikbn tsrysyorikbn}</td><td>手数料処理区分</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_TsrysyoriKbn}</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_TesuuryouSyouhnRireki
 * @see     PKIT_TesuuryouSyouhnRireki
 * @see     QIT_TesuuryouSyouhnRireki
 * @see     GenQIT_TesuuryouSyouhnRireki
 */
@MappedSuperclass
@Table(name=GenIT_TesuuryouSyouhnRireki.TABLE_NAME)
@IdClass(value=PKIT_TesuuryouSyouhnRireki.class)
@TypeDefs({
...
public abstract class GenIT_TesuuryouSyouhnRireki extends AbstractExDBEntity<IT_TesuuryouSyouhnRireki, PKIT_TesuuryouSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_TesuuryouSyouhnRireki";
    ...
    private final PKIT_TesuuryouSyouhnRireki primaryKey;

    public GenIT_TesuuryouSyouhnRireki() {
        primaryKey = new PKIT_TesuuryouSyouhnRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_TesuuryouSyouhnRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_TesuuryouSyouhnRireki> getMetaClass() {
        return QIT_TesuuryouSyouhnRireki.class;
    }

    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.TSRYSYORIKBN)
    ...
    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.RENNO)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.GANSKNNKAISIYMD)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKNEN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KATAKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.PMNJTKKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.RYOURITUSDNO)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_TesuuryouSyouhnRireki.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.NKSYUKBN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.NENKINKKN)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_TesuuryouSyouhnRireki.GYOUMUKOUSINTIME)
