...
import yuyu.def.db.id.PKIT_BAK_KykSyouhnRireki;
...
/**
 * 契約商品履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KykSyouhnRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KykSyouhnRireki}</td><td colspan="3">契約商品履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_KykSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_KykSyouhnRireki
 * @see     QIT_BAK_KykSyouhnRireki
 * @see     GenQIT_BAK_KykSyouhnRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KykSyouhnRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_KykSyouhnRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KykSyouhnRireki extends AbstractExDBEntity<IT_BAK_KykSyouhnRireki, PKIT_BAK_KykSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KykSyouhnRireki";
    ...
    private final PKIT_BAK_KykSyouhnRireki primaryKey;

    public GenIT_BAK_KykSyouhnRireki() {
        primaryKey = new PKIT_BAK_KykSyouhnRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KykSyouhnRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KykSyouhnRireki> getMetaClass() {
        return QIT_BAK_KykSyouhnRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKSYOUHNRENNO)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhnRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKYMD)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKYMDSITEIUMUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.GANSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.HKSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.HKGANSKNNKAISIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKNEN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.PMNJTKKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.RYOURITUSDNO)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.NKSYUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.NENKINKKN)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.YENDTHNKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.KYKJISISUURENDOURATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.TUMITATERIRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.TMTTKNHAIBUNJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.SISUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSyouhnRireki.GSBUNRIKZKAKUNINUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSyouhnRireki.GSBUNRITAISYOU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.TMTTKNITENYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.LOADINGHNKGTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.RENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhnRireki.TEIKISHRRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhnRireki.DAI1HKNKKN)
    @Range(min="0", max="99")
