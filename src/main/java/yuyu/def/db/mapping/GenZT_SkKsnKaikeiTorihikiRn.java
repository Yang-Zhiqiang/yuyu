...
/**
 * 新契約決算用会計取引Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkKsnKaikeiTorihikiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKsnKaikeiTorihikiRn}</td><td colspan="3">新契約決算用会計取引Ｆテーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymd zrntorihikiymd}</td><td>（連携用）取引年月日</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinon7 zrntorihikinon7}</td><td>（連携用）取引番号Ｎ７</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntaisyakukbnn zrntaisyakukbnn}</td><td>（連携用）貸借区分（数値）</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkanjyoukamokucdn zrnkanjyoukamokucdn}</td><td>（連携用）勘定科目コード（数値）</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyobiv4 zrnyobiv4}</td><td>（連携用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsuitoubumon zrnsuitoubumon}</td><td>（連携用）出納部門</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkingaku zrnkingaku}</td><td>（連携用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrntekiyoucd zrntekiyoucd}</td><td>（連携用）摘要コード</td><td align="center">{@link PKZT_SkKsnKaikeiTorihikiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkKsnKaikeiTorihikiRn
 * @see     PKZT_SkKsnKaikeiTorihikiRn
 * @see     QZT_SkKsnKaikeiTorihikiRn
 * @see     GenQZT_SkKsnKaikeiTorihikiRn
 */
@MappedSuperclass
@Table(name=GenZT_SkKsnKaikeiTorihikiRn.TABLE_NAME)
@IdClass(value=PKZT_SkKsnKaikeiTorihikiRn.class)
public abstract class GenZT_SkKsnKaikeiTorihikiRn extends AbstractExDBEntityForZDB<ZT_SkKsnKaikeiTorihikiRn, PKZT_SkKsnKaikeiTorihikiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKsnKaikeiTorihikiRn";
    ...
    private final PKZT_SkKsnKaikeiTorihikiRn primaryKey;

    public GenZT_SkKsnKaikeiTorihikiRn() {
        primaryKey = new PKZT_SkKsnKaikeiTorihikiRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKsnKaikeiTorihikiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKsnKaikeiTorihikiRn> getMetaClass() {
        return QZT_SkKsnKaikeiTorihikiRn.class;
    }

    private String zrnlen;

    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNLEN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKAIKEITANI)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNSYORICD)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTORIHIKINON7)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNSYORIYMDN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNSIMEKIRIKBN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKESSANKBN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNYOBIV20)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKAISYAKANTORIHIKIKBN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTUKEKAEKBN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTABLEKOSUU)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNYOBIV4)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNSUITOUBUMON)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNKINGAKU)
    ...
    @Id
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNTEKIYOUCD)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_SkKsnKaikeiTorihikiRn.ZRNMEISAIKANRYOUKBN)
