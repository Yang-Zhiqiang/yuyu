...
/**
 * 通常配当所要額Ｆ（Ｎ＋２）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusTwoTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusTwoTy}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋２）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusTwoTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusTwoTy
 * @see     PKZT_TjHitsyyugkNplusTwoTy
 * @see     QZT_TjHitsyyugkNplusTwoTy
 * @see     GenQZT_TjHitsyyugkNplusTwoTy
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusTwoTy.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusTwoTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusTwoTy extends AbstractExDBEntity<ZT_TjHitsyyugkNplusTwoTy, PKZT_TjHitsyyugkNplusTwoTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusTwoTy";
    ...
    private final PKZT_TjHitsyyugkNplusTwoTy primaryKey;

    public GenZT_TjHitsyyugkNplusTwoTy() {
        primaryKey = new PKZT_TjHitsyyugkNplusTwoTy();
    }

    public GenZT_TjHitsyyugkNplusTwoTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusTwoTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusTwoTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusTwoTy> getMetaClass() {
        return QZT_TjHitsyyugkNplusTwoTy.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoTy.ZTYTOKUYAKUKOUMOKUV180X50)
