...
import yuyu.def.db.id.PKIT_BAK_YykIdouAnsyuCreditCard;
...
/**
 * 予約異動案内収納用クレジット払バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_YykIdouAnsyuCreditCard} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_YykIdouAnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_YykIdouAnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_YykIdouAnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_YykIdouAnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_YykIdouAnsyuCreditCard
 * @see     QIT_BAK_YykIdouAnsyuCreditCard
 * @see     GenQIT_BAK_YykIdouAnsyuCreditCard
 */
@MappedSuperclass
@Table(name=GenIT_BAK_YykIdouAnsyuCreditCard.TABLE_NAME)
@IdClass(value=PKIT_BAK_YykIdouAnsyuCreditCard.class)
@TypeDefs({
...
public abstract class GenIT_BAK_YykIdouAnsyuCreditCard extends AbstractExDBEntity<IT_BAK_YykIdouAnsyuCreditCard, PKIT_BAK_YykIdouAnsyuCreditCard> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_YykIdouAnsyuCreditCard";
    ...
    private final PKIT_BAK_YykIdouAnsyuCreditCard primaryKey;

    public GenIT_BAK_YykIdouAnsyuCreditCard() {
        primaryKey = new PKIT_BAK_YykIdouAnsyuCreditCard();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_YykIdouAnsyuCreditCard getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_YykIdouAnsyuCreditCard> getMetaClass() {
        return QIT_BAK_YykIdouAnsyuCreditCard.class;
    }

    @Id
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.YUKOUKACHKYMD)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.YUUKOUKAKUJKKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.AUTHORIJKKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.AUTHORITRKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.AUTHORIKANRYOYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.JKIPJYTYM)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.SYOUNINNO)
    @MaxLength(max=6)
    @Digit
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.TANMATUSYORINO)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_YykIdouAnsyuCreditCard.GYOUMUKOUSINTIME)
