...
import yuyu.def.db.id.PKIT_KhHenkouUktkKaiyaku;
...
/**
 * 契約保全変更受付内容（解約）テーブル テーブルのマッピング情報クラスで、 {@link IT_KhHenkouUktkKaiyaku} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhHenkouUktkKaiyaku ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhHenkouUktkKaiyaku ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHozenhenkouuktkrenno hozenhenkouuktkrenno}</td><td>保全変更受付連番</td><td align="center">{@link PKIT_KhHenkouUktkKaiyaku ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KhHenkouUktkKaiyaku.TABLE_NAME)
@IdClass(value=PKIT_KhHenkouUktkKaiyaku.class)
@TypeDefs({
...
public abstract class GenIT_KhHenkouUktkKaiyaku extends AbstractExDBEntity<IT_KhHenkouUktkKaiyaku, PKIT_KhHenkouUktkKaiyaku> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhHenkouUktkKaiyaku";
    ...
    private final PKIT_KhHenkouUktkKaiyaku primaryKey;

    public GenIT_KhHenkouUktkKaiyaku() {
        primaryKey = new PKIT_KhHenkouUktkKaiyaku();
    }
    ...
    @Transient
    @Override
    public PKIT_KhHenkouUktkKaiyaku getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhHenkouUktkKaiyaku> getMetaClass() {
        return QIT_KhHenkouUktkKaiyaku.class;
    }

    @Id
    @Column(name=GenIT_KhHenkouUktkKaiyaku.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhHenkouUktkKaiyaku.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhHenkouUktkKaiyaku.HOZENHENKOUUKTKRENNO)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.INPUTSHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.YENSHRTKHKUMU)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.YOKINKBN)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.KZDOUKBN)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhHenkouUktkKaiyaku.GYOUMUKOUSINTIME)
