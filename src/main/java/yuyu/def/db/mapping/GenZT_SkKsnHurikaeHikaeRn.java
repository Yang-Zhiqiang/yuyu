...
/**
 * 新契約決算用振替伝票（控）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkKsnHurikaeHikaeRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKsnHurikaeHikaeRn}</td><td colspan="3">新契約決算用振替伝票（控）テーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikinoc8 zrntorihikinoc8}</td><td>（連携用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinoedano zrntorihikinoedano}</td><td>（連携用）取引番号枝番号</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymdgengokbn zrntorihikiymdgengokbn}</td><td>（連携用）取引年月日元号区分</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinen zrntorihikinen}</td><td>（連携用）取引年</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikituki zrntorihikituki}</td><td>（連携用）取引月</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikibi zrntorihikibi}</td><td>（連携用）取引日</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkKsnHurikaeHikaeRn
 * @see     PKZT_SkKsnHurikaeHikaeRn
 * @see     QZT_SkKsnHurikaeHikaeRn
 * @see     GenQZT_SkKsnHurikaeHikaeRn
 */
@MappedSuperclass
@Table(name=GenZT_SkKsnHurikaeHikaeRn.TABLE_NAME)
@IdClass(value=PKZT_SkKsnHurikaeHikaeRn.class)
public abstract class GenZT_SkKsnHurikaeHikaeRn extends AbstractExDBEntityForZDB<ZT_SkKsnHurikaeHikaeRn, PKZT_SkKsnHurikaeHikaeRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKsnHurikaeHikaeRn";
    ...
    private final PKZT_SkKsnHurikaeHikaeRn primaryKey;

    public GenZT_SkKsnHurikaeHikaeRn() {
        primaryKey = new PKZT_SkKsnHurikaeHikaeRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKsnHurikaeHikaeRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKsnHurikaeHikaeRn> getMetaClass() {
        return QZT_SkKsnHurikaeHikaeRn.class;
    }

    private String zrnkytkmksyoruicd;

    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNTORIHIKIBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKANJYOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJTANTOUCD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeRn.ZRNKJKASITEKIYOUKM4)
