...
import yuyu.def.db.id.PKIT_KykSya;
import yuyu.def.db.meta.GenQIT_KykSya;
...
/**
 * 契約者テーブル テーブルのマッピング情報クラスで、 {@link IT_KykSya} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykSya}</td><td colspan="3">契約者テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykSya ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykSya ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KykSya.TABLE_NAME)
@IdClass(value=PKIT_KykSya.class)
@TypeDefs({
...
public abstract class GenIT_KykSya extends AbstractExDBEntity<IT_KykSya, PKIT_KykSya> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykSya";
    ...
    private final PKIT_KykSya primaryKey;

    public GenIT_KykSya() {
        primaryKey = new PKIT_KykSya();
    }

    public GenIT_KykSya(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_KykSya(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_KykSya getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykSya> getMetaClass() {
        return QIT_KykSya.class;
    }

    @Id
    @Column(name=GenIT_KykSya.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykSya.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KykSya.KOKNO)
    ...
    @Column(name=GenIT_KykSya.KYKSAKUINMEINO)
    ...
    @Column(name=GenIT_KykSya.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.KYKNMKJKHUKAKBN)
    ...
    @Column(name=GenIT_KykSya.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSya.KYKSEI)
    ...
    @Column(name=GenIT_KykSya.KKKYKTDK)
    ...
    @Column(name=GenIT_KykSya.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_KykSya.TSINADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_KykSya.DAI2TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_KykSya.TSINMAILADDRESS)
    @MaxLength(max=40)
    ...
    @Column(name=GenIT_KykSya.KINMUSAKINM)
    @MaxLength(max=25)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.HJNDAIYKKBN)
    ...
    @Column(name=GenIT_KykSya.HJNDAIYKNM)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.HJNDAINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.HJNDAINMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSya.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykSya.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykSya.GYOUMUKOUSINTIME)
