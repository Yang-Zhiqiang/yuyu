...
import yuyu.def.db.id.PKIT_HrkeIraiInfo;
import yuyu.def.db.meta.GenQIT_HrkeIraiInfo;
...
/**
 * 振替依頼情報テーブル テーブルのマッピング情報クラスで、 {@link IT_HrkeIraiInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_HrkeIraiInfo}</td><td colspan="3">振替依頼情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_HrkeIraiInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_HrkeIraiInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_HrkeIraiInfo ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_HrkeIraiInfo
 * @see     PKIT_HrkeIraiInfo
 * @see     QIT_HrkeIraiInfo
 * @see     GenQIT_HrkeIraiInfo
 */
@MappedSuperclass
@Table(name=GenIT_HrkeIraiInfo.TABLE_NAME)
@IdClass(value=PKIT_HrkeIraiInfo.class)
@TypeDefs({
...
public abstract class GenIT_HrkeIraiInfo extends AbstractExDBEntity<IT_HrkeIraiInfo, PKIT_HrkeIraiInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_HrkeIraiInfo";
    ...
    private final PKIT_HrkeIraiInfo primaryKey;

    public GenIT_HrkeIraiInfo() {
        primaryKey = new PKIT_HrkeIraiInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_HrkeIraiInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_HrkeIraiInfo> getMetaClass() {
        return QIT_HrkeIraiInfo.class;
    }

    @Id
    @Column(name=GenIT_HrkeIraiInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_HrkeIraiInfo.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_HrkeIraiInfo.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_HrkeIraiInfo.HRKEANNAIJKKBN)
    ...
    @Column(name=GenIT_HrkeIraiInfo.HRKEYOUSIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HrkeIraiInfo.NYKSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HrkeIraiInfo.RYOSYUYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HrkeIraiInfo.TORIKESIYMD)
    ...
    @Column(name=GenIT_HrkeIraiInfo.NYKNAIYOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HrkeIraiInfo.HRKKIGEN)
    ...
    @Column(name=GenIT_HrkeIraiInfo.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_HrkeIraiInfo.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_HrkeIraiInfo.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_HrkeIraiInfo.KZKPANNAIJIYUUKBN)
    ...
    @Column(name=GenIT_HrkeIraiInfo.COMMENT124KETA)
    ...
    @Column(name=GenIT_HrkeIraiInfo.HRKKAISUU)
    ...
    @Column(name=GenIT_HrkeIraiInfo.SYORISOSIKICD)
    ...
    @Column(name=GenIT_HrkeIraiInfo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_HrkeIraiInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_HrkeIraiInfo.GYOUMUKOUSINTIME)
