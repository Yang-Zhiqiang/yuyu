...
/**
 * 株価指数連動保険異動ＶＦテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_KbkSsuRnduHknIdouVRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KbkSsuRnduHknIdouVRn}</td><td colspan="3">株価指数連動保険異動ＶＦテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_KbkSsuRnduHknIdouVRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_KbkSsuRnduHknIdouVRn
 * @see     PKZT_KbkSsuRnduHknIdouVRn
 * @see     QZT_KbkSsuRnduHknIdouVRn
 * @see     GenQZT_KbkSsuRnduHknIdouVRn
 */
@MappedSuperclass
@Table(name=GenZT_KbkSsuRnduHknIdouVRn.TABLE_NAME)
@IdClass(value=PKZT_KbkSsuRnduHknIdouVRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KbkSsuRnduHknIdouVRn extends AbstractExDBEntityForZDB<ZT_KbkSsuRnduHknIdouVRn, PKZT_KbkSsuRnduHknIdouVRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KbkSsuRnduHknIdouVRn";
    ...
    private final PKZT_KbkSsuRnduHknIdouVRn primaryKey;

    public GenZT_KbkSsuRnduHknIdouVRn() {
        primaryKey = new PKZT_KbkSsuRnduHknIdouVRn();
    }

    public GenZT_KbkSsuRnduHknIdouVRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_KbkSsuRnduHknIdouVRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_KbkSsuRnduHknIdouVRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KbkSsuRnduHknIdouVRn> getMetaClass() {
        return QZT_KbkSsuRnduHknIdouVRn.class;
    }

    @Id
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNVYOURENDOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknIdouVRn.ZRNYOBIV20)
