...
/**
 * 通常配当所要額Ｆ（Ｎ＋１）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusOneTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusOneTy}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋１）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusOneTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusOneTy
 * @see     PKZT_TjHitsyyugkNplusOneTy
 * @see     QZT_TjHitsyyugkNplusOneTy
 * @see     GenQZT_TjHitsyyugkNplusOneTy
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusOneTy.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusOneTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusOneTy extends AbstractExDBEntity<ZT_TjHitsyyugkNplusOneTy, PKZT_TjHitsyyugkNplusOneTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusOneTy";
    ...
    private final PKZT_TjHitsyyugkNplusOneTy primaryKey;

    public GenZT_TjHitsyyugkNplusOneTy() {
        primaryKey = new PKZT_TjHitsyyugkNplusOneTy();
    }

    public GenZT_TjHitsyyugkNplusOneTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusOneTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusOneTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusOneTy> getMetaClass() {
        return QZT_TjHitsyyugkNplusOneTy.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneTy.ZTYTOKUYAKUKOUMOKUV180X50)
