...
import yuyu.def.db.id.PKBT_IdouKhBosyuudrItjhzn;
import yuyu.def.db.meta.GenQBT_IdouKhBosyuudrItjhzn;
import yuyu.def.db.meta.QBT_IdouKhBosyuudrItjhzn;
import yuyu.infr.validation.constraints.SyoukenNo;

/**
 * 異動契約保全募集代理店一時保存テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouKhBosyuudrItjhzn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKBT_IdouKhBosyuudrItjhzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouKhBosyuudrItjhzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKBT_IdouKhBosyuudrItjhzn
 * @see     QBT_IdouKhBosyuudrItjhzn
 * @see     GenQBT_IdouKhBosyuudrItjhzn
 */
@MappedSuperclass
@Table(name=GenBT_IdouKhBosyuudrItjhzn.TABLE_NAME)
@IdClass(value=PKBT_IdouKhBosyuudrItjhzn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBT_IdouKhBosyuudrItjhzn extends AbstractExDBEntity<BT_IdouKhBosyuudrItjhzn, PKBT_IdouKhBosyuudrItjhzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouKhBosyuudrItjhzn";
    ...
    private final PKBT_IdouKhBosyuudrItjhzn primaryKey;

    public GenBT_IdouKhBosyuudrItjhzn() {
        primaryKey = new PKBT_IdouKhBosyuudrItjhzn();
    }

    public GenBT_IdouKhBosyuudrItjhzn(String pSyono, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouKhBosyuudrItjhzn(pSyono, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouKhBosyuudrItjhzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouKhBosyuudrItjhzn> getMetaClass() {
        return QBT_IdouKhBosyuudrItjhzn.class;
    }

    @Id
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.DAIRITENCD1)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.BUNWARI1)
    ...
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.DAIRITENCD2)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.BUNWARI2)
    ...
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.KANRISOSIKICD1)
    ...
    @Column(name=GenBT_IdouKhBosyuudrItjhzn.KANRISOSIKICD2)
