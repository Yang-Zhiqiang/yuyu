...
/**
 * 入金確証データバックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_NyuukinKakusyouData} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_NyuukinKakusyouData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getNyuukinkakusyouno nyuukinkakusyouno}</td><td>入金確証番号</td><td align="center">{@link PKIT_BAK_NyuukinKakusyouData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_NyuukinKakusyouData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_NyuukinKakusyouData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_BAK_NyuukinKakusyouData.TABLE_NAME)
@IdClass(value=PKIT_BAK_NyuukinKakusyouData.class)
@TypeDefs({
...
public abstract class GenIT_BAK_NyuukinKakusyouData extends AbstractExDBEntity<IT_BAK_NyuukinKakusyouData, PKIT_BAK_NyuukinKakusyouData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_NyuukinKakusyouData";
    ...
    private final PKIT_BAK_NyuukinKakusyouData primaryKey;

    public GenIT_BAK_NyuukinKakusyouData() {
        primaryKey = new PKIT_BAK_NyuukinKakusyouData();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_NyuukinKakusyouData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_NyuukinKakusyouData> getMetaClass() {
        return QIT_BAK_NyuukinKakusyouData.class;
    }

    @Id
    @Column(name=GenIT_BAK_NyuukinKakusyouData.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYUUKINKAKUSYOUNO)
    ...
    @Id
    @Column(name=GenIT_BAK_NyuukinKakusyouData.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_NyuukinKakusyouData.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYKSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYUUKINKAKUSYOUNRKYMD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYKKEIRO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.HRKKAISUU)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.IKTNYUUKINNUMU)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_NyuukinKakusyouData.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.DENRENNO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.EDANO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.SUITOUBUMONCD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYKHOUHOUKBN)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.TIKIKTBRISYURUIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYKDENYMD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.TABAKARIKANJYONO)
    @Length(length=2)
    @Digit
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYUUKINKAKUSYOUNRKNO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.NYUURYOKUKBN)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.SUITONO)
    @Length(length=2)
    @Digit
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.HRKMYOUSINKKBN)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.SUITOSOSHIKICD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.KZHURIKAEBANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.KZHURIKAESITENCD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.UKETUKETENCD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.CVSCD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.RYOUSYUUHM)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.HURIKOMIYOUSIOKYKSMNO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.HURIKOMIYOUSIKAKUNINNO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.KINYUUKIKANKBN)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.SYUUDAIKOCD)
    ...
    @Column(name=GenIT_BAK_NyuukinKakusyouData.CREDITURIAGESEIKYUUKBN)
