...
/**
 * 決算計上用ＲＡＹ事業費Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KsnRayJigyohiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KsnRayJigyohiTy}</td><td colspan="3">決算計上用ＲＡＹ事業費Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_KsnRayJigyohiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_KsnRayJigyohiTy
 * @see     PKZT_KsnRayJigyohiTy
 * @see     QZT_KsnRayJigyohiTy
 * @see     GenQZT_KsnRayJigyohiTy
 */
@MappedSuperclass
@Table(name=GenZT_KsnRayJigyohiTy.TABLE_NAME)
@IdClass(value=PKZT_KsnRayJigyohiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KsnRayJigyohiTy extends AbstractExDBEntity<ZT_KsnRayJigyohiTy, PKZT_KsnRayJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KsnRayJigyohiTy";
    ...
    private final PKZT_KsnRayJigyohiTy primaryKey;

    public GenZT_KsnRayJigyohiTy() {
        primaryKey = new PKZT_KsnRayJigyohiTy();
    }

    public GenZT_KsnRayJigyohiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_KsnRayJigyohiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_KsnRayJigyohiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KsnRayJigyohiTy> getMetaClass() {
        return QZT_KsnRayJigyohiTy.class;
    }

    @Id
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYLOADINGKEIJYOYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSIHANKIKSNYDATAHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYGMKIJYHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV20)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X18)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREILKISNYUKNGKX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X21)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREILKISNYUKNGKX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X23)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYRPKEISANYOUSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIKENS)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREIALPHA)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREIBETA)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIKENP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYVHIREILRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYKIKENPRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYTUMIMASIMAEW)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X27)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X28)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X29)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X30)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X31)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIN11X32)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KsnRayJigyohiTy.ZTYYOBIV19)
