...
/**
 * 年金原資Ｆ保有照合用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkGensiHySgTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkGensiHySgTy}</td><td colspan="3">年金原資Ｆ保有照合用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_NkGensiHySgTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_NkGensiHySgTy
 * @see     PKZT_NkGensiHySgTy
 * @see     QZT_NkGensiHySgTy
 * @see     GenQZT_NkGensiHySgTy
 */
@MappedSuperclass
@Table(name=GenZT_NkGensiHySgTy.TABLE_NAME)
@IdClass(value=PKZT_NkGensiHySgTy.class)
public abstract class GenZT_NkGensiHySgTy extends AbstractExDBEntity<ZT_NkGensiHySgTy, PKZT_NkGensiHySgTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkGensiHySgTy";
    ...
    private final PKZT_NkGensiHySgTy primaryKey;

    public GenZT_NkGensiHySgTy() {
        primaryKey = new PKZT_NkGensiHySgTy();
    }

    public GenZT_NkGensiHySgTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_NkGensiHySgTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_NkGensiHySgTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkGensiHySgTy> getMetaClass() {
        return QZT_NkGensiHySgTy.class;
    }

    @Id
    @Column(name=GenZT_NkGensiHySgTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSYSTEMCD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYULFKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYIDOUYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSYOUIN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINSYU)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYCURRENTDAY)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYCURRENTTIME)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINGENSINO)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINGENSINAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNKKIKINGK)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYGENSINAIYOUKIHONNKGK)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNEWMONEYGAKU)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYNENKINGENSIHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYDKEISANYOUNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiHySgTy.ZTYKGYNKYOUZEISEITKKAKSJGNS)
