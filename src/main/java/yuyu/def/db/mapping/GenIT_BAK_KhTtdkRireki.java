...
import yuyu.def.db.id.PKIT_BAK_KhTtdkRireki;
...
/**
 * 契約保全手続履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhTtdkRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhTtdkRireki}</td><td colspan="3">契約保全手続履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhTtdkRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhTtdkRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhTtdkRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_KhTtdkRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_KhTtdkRireki
 * @see     QIT_BAK_KhTtdkRireki
 * @see     GenQIT_BAK_KhTtdkRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhTtdkRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhTtdkRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhTtdkRireki extends AbstractExDBEntity<IT_BAK_KhTtdkRireki, PKIT_BAK_KhTtdkRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhTtdkRireki";
    ...
    private final PKIT_BAK_KhTtdkRireki primaryKey;

    public GenIT_BAK_KhTtdkRireki() {
        primaryKey = new PKIT_BAK_KhTtdkRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhTtdkRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhTtdkRireki> getMetaClass() {
        return QIT_BAK_KhTtdkRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhTtdkRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhTtdkRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhTtdkRireki.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhTtdkRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.SYORISOSIKICD)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.SHRSYOUSAIUMU)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.SYORIKBN)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.HONNINKAKNINKEKKAKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KhTtdkRireki.HENKOURRKUMU)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.SMBCKANRIID)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.NAYOSEKIHONTBLSKBTKEY)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.KOUTEIKANRIID)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.YOUKYUUNO)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhTtdkRireki.GYOUMUKOUSINTIME)
