...
import yuyu.def.db.id.PKHT_Tokujyou;
import yuyu.def.db.meta.GenQHT_Tokujyou;
...
/**
 * 特条テーブル テーブルのマッピング情報クラスで、 {@link HT_Tokujyou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_Tokujyou}</td><td colspan="3">特条テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_Tokujyou ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenHT_Tokujyou.TABLE_NAME)
@IdClass(value=PKHT_Tokujyou.class)
@TypeDefs({
...
public abstract class GenHT_Tokujyou extends AbstractExDBEntity<HT_Tokujyou, PKHT_Tokujyou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_Tokujyou";
    ...
    private final PKHT_Tokujyou primaryKey;

    public GenHT_Tokujyou() {
        primaryKey = new PKHT_Tokujyou();
    }

    public GenHT_Tokujyou(String pMosno) {
        primaryKey = new PKHT_Tokujyou(pMosno);
    }

    @Transient
    @Override
    public PKHT_Tokujyou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_Tokujyou> getMetaClass() {
        return QHT_Tokujyou.class;
    }

    @Id
    @Column(name=GenHT_Tokujyou.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_Tokujyou.TKJYHYOUTEN)
    ...
    @Column(name=GenHT_Tokujyou.TKJYSKGNKKN)
    ...
    @Column(name=GenHT_Tokujyou.HTNPBUICD1)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenHT_Tokujyou.HTNPKKN1)
    ...
    @Column(name=GenHT_Tokujyou.HTNPBUICD2)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_Tokujyou.HTNPKKN2)
    ...
    @Column(name=GenHT_Tokujyou.HTNPBUICD3)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_Tokujyou.HTNPKKN3)
    ...
    @Column(name=GenHT_Tokujyou.HTNPBUICD4)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_Tokujyou.HTNPKKN4)
    ...
    @Column(name=GenHT_Tokujyou.TOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenHT_Tokujyou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_Tokujyou.GYOUMUKOUSINTIME)
