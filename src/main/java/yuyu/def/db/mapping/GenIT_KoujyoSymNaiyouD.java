...
import yuyu.def.db.id.PKIT_KoujyoSymNaiyouD;
...
/**
 * 控除証明内容Ｄテーブル テーブルのマッピング情報クラスで、 {@link IT_KoujyoSymNaiyouD} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KoujyoSymNaiyouD}</td><td colspan="3">控除証明内容Ｄテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KoujyoSymNaiyouD ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KoujyoSymNaiyouD ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_KoujyoSymNaiyouD ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKIT_KoujyoSymNaiyouD ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_KoujyoSymNaiyouD
 * @see     QIT_KoujyoSymNaiyouD
 * @see     GenQIT_KoujyoSymNaiyouD
 */
@MappedSuperclass
@Table(name=GenIT_KoujyoSymNaiyouD.TABLE_NAME)
@IdClass(value=PKIT_KoujyoSymNaiyouD.class)
@TypeDefs({
...
public abstract class GenIT_KoujyoSymNaiyouD extends AbstractExDBEntity<IT_KoujyoSymNaiyouD, PKIT_KoujyoSymNaiyouD> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KoujyoSymNaiyouD";
    ...
    private final PKIT_KoujyoSymNaiyouD primaryKey;

    public GenIT_KoujyoSymNaiyouD() {
        primaryKey = new PKIT_KoujyoSymNaiyouD();
    }
    ...
    @Transient
    @Override
    public PKIT_KoujyoSymNaiyouD getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KoujyoSymNaiyouD> getMetaClass() {
        return QIT_KoujyoSymNaiyouD.class;
    }

    @Id
    @Column(name=GenIT_KoujyoSymNaiyouD.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyouD.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyouD.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyouD.RENNO3KETA)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.KOUJYOSYOUMEINND)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.HAITOUNENDO)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.HAITOUKANRIRENNO)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.HAITOUKINSKSKBN)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.HAITOUMEISAIKBN)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.KJSMHAKKOUZUMIFLG)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.SAKUJYOFLG)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KoujyoSymNaiyouD.GYOUMUKOUSINTIME)
