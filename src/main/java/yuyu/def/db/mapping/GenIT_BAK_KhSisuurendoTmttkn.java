...
import yuyu.def.db.id.PKIT_BAK_KhSisuurendoTmttkn;
import yuyu.def.db.meta.GenQIT_BAK_KhSisuurendoTmttkn;
import yuyu.def.db.meta.QIT_BAK_KhSisuurendoTmttkn;
import yuyu.infr.validation.constraints.SyoukenNo;

/**
 * 指数連動積増型年金積立金バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhSisuurendoTmttkn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhSisuurendoTmttkn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhSisuurendoTmttkn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhSisuurendoTmttkn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTmttkntaisyouym tmttkntaisyouym}</td><td>積立金対象年月</td><td align="center">{@link PKIT_BAK_KhSisuurendoTmttkn ○}</td><td align="center">V</td><td>BizDateYM</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KhSisuurendoTmttkn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KhSisuurendoTmttkn
 * @see     QIT_BAK_KhSisuurendoTmttkn
 * @see     GenQIT_BAK_KhSisuurendoTmttkn
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhSisuurendoTmttkn.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhSisuurendoTmttkn.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhSisuurendoTmttkn extends AbstractExDBEntity<IT_BAK_KhSisuurendoTmttkn, PKIT_BAK_KhSisuurendoTmttkn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhSisuurendoTmttkn";
    ...
    private final PKIT_BAK_KhSisuurendoTmttkn primaryKey;

    public GenIT_BAK_KhSisuurendoTmttkn() {
        primaryKey = new PKIT_BAK_KhSisuurendoTmttkn();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhSisuurendoTmttkn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhSisuurendoTmttkn> getMetaClass() {
        return QIT_BAK_KhSisuurendoTmttkn.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TMTTKNTAISYOUYM)
    ...
    @Id
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.RENNO)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TMTTKNKOURYOKUKAISIYMD)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.SISUUUPRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TMTTKNZOUKARITU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TMTTKNHANEITMMSHANTEIYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.TMTTKNHANEISISUU)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhSisuurendoTmttkn.GYOUMUKOUSINTIME)
