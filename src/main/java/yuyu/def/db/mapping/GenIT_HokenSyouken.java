...
import yuyu.def.db.id.PKIT_HokenSyouken;
...
/**
 * 保険証券テーブル テーブルのマッピング情報クラスで、 {@link IT_HokenSyouken} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_HokenSyouken}</td><td colspan="3">保険証券テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_HokenSyouken ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_HokenSyouken ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_HokenSyouken ○}</td><td align="center">V</td><td>BizDate</td></tr>
 ...
 * </table>
 * @see     IT_HokenSyouken
 * @see     PKIT_HokenSyouken
 * @see     QIT_HokenSyouken
 * @see     GenQIT_HokenSyouken
 */
@MappedSuperclass
@Table(name=GenIT_HokenSyouken.TABLE_NAME)
@IdClass(value=PKIT_HokenSyouken.class)
@TypeDefs({
...
public abstract class GenIT_HokenSyouken extends AbstractExDBEntity<IT_HokenSyouken, PKIT_HokenSyouken> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_HokenSyouken";
    ...
    private final PKIT_HokenSyouken primaryKey;

    public GenIT_HokenSyouken() {
        primaryKey = new PKIT_HokenSyouken();
    }
    ...
    @Transient
    @Override
    public PKIT_HokenSyouken getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_HokenSyouken> getMetaClass() {
        return QIT_HokenSyouken.class;
    }

    @Id
    @Column(name=GenIT_HokenSyouken.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_HokenSyouken.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_HokenSyouken.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_HokenSyouken.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_HokenSyouken.SINSAIHKKBN)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENSAIHKKBN)
    ...
    @Column(name=GenIT_HokenSyouken.INSIZEISHRYOUHIKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HASSOUKBN)
    ...
    @Column(name=GenIT_HokenSyouken.KOUJYOSYOUMEIUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyouken.SUIIHYOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyouken.KANRYOUTUUTIUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyouken.STDRSKTIRASIDOUHUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyouken.DSTIRASIDOUHUUKBN)
    ...
    @Column(name=GenIT_HokenSyouken.AISYOUMEIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyouken.SYOTNSHUYOUPOSTUMUKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD11)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD12)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD13)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD14)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD15)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD16)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD17)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD18)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD19)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANHIDARIMSGCD20)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD11)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD12)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD13)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD14)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD15)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD16)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD17)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD18)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD19)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANMIGIIMSGCD20)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.HYOUJIRANSKNNKAISIYMD)
    ...
    @Column(name=GenIT_HokenSyouken.HYOUJIRANYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.HYOUJIRANSJKKKTUSIRRT)
    ...
    @Column(name=GenIT_HokenSyouken.HKNSYUKIGOU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYOHAKKOUYMD)
    ...
    @Column(name=GenIT_HokenSyouken.HANBAINM)
    ...
    @Column(name=GenIT_HokenSyouken.SEISIKIHKNNM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.KOURYOKUKAISIYMD)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.KYKNMKJKHUKAKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_KjkhukaKbn")
    @Column(name=GenIT_HokenSyouken.HHKNNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_HokenSyouken.HHKNSEI)
    ...
    @Column(name=GenIT_HokenSyouken.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI1)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN2)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN2)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI2)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN3)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN3)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM3)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI3)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN4)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN4)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM4)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI4)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN5)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN5)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM5)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI5)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN6)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN6)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM6)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI6)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN7)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN7)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM7)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI7)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN8)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN8)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM8)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI8)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN9)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN9)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM9)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI9)
    ...
    @Type(type="UserType_C_SyoukenUktMidasiKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTMIDASIKBN10)
    ...
    @Type(type="UserType_C_SyoukenUktKbn")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTKBN10)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTNM10)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SYOUKENUKTBNWARI10)
    ...
    @Column(name=GenIT_HokenSyouken.PMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.PMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.PMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.PTUUKATYPE)
    ...
    @Column(name=GenIT_HokenSyouken.PTUUKA)
    ...
    @Column(name=GenIT_HokenSyouken.PTOKUYAKUMSGCD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.KYKYMD)
    ...
    @Column(name=GenIT_HokenSyouken.PHRKKKNMIDASIKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HRKKKNMSGKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HRKKAISUUMSGKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HRKKITUKIMSGKBN)
    ...
    @Column(name=GenIT_HokenSyouken.HRKHOUHOUMSGKBN)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN1)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN1)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO1)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO1)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN2)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN2)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO2)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO2)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN3)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN3)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO3)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO3)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN4)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN4)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO4)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO4)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN5)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN5)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO5)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO5)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN6)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN6)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO6)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO6)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN7)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN7)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO7)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO7)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN8)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN8)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO8)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO8)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN9)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN9)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO9)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO9)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKRENBAN10)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKMSGKBN10)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSMSGKBN10)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKHKNKKNMSGKBN10)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKSTUUKATYPE10)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI1HKNKKN10)
    ...
    @Column(name=GenIT_HokenSyouken.SYUKYKTKYKDAI2HKNKKN10)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI1HKNKKNYMDTO10)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SYUTKDAI2HKNKKNYMDTO10)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD11)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD12)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD13)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD14)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTMSGCD15)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.KYKNIYUSTITJBRPTUUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD11)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD12)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD13)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD14)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD15)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD16)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD17)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD18)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD19)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANMSGCD20)
    ...
    @Column(name=GenIT_HokenSyouken.SONOTANYRANSITEITUUKA)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANNYKNTUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.SONOTANYRANNYKNTUUKASYU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANENKHRIKMRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANSTIGIKWSRATE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANKJNKNGKTUKTYPE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANKJNKNGKRATE)
    ...
    @Column(name=GenIT_HokenSyouken.SONOTANYRANKJNKNGKTUUKA)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANPENTUKTYPE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANMKHWARIAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANYTIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANSJKKKTUSIRRT)
    ...
    @Column(name=GenIT_HokenSyouken.STNAIYOURANGAIMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_HokenSyouken.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.TNKNMISSMSG)
    ...
    @Column(name=GenIT_HokenSyouken.ERRORMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SISYACD)
    @Length(length=3)
    @SingleByteStrings
    ...
    @Column(name=GenIT_HokenSyouken.DUHUTUSNRNTOUSAADRMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.DUHUTUSNRNSYONO)
    ...
    @Column(name=GenIT_HokenSyouken.CHANNELCD)
    ...
    @Column(name=GenIT_HokenSyouken.DAIRITENMIDASIKBN)
    ...
    @Column(name=GenIT_HokenSyouken.DRTENNM1KJ)
    ...
    @Column(name=GenIT_HokenSyouken.DRTENNM2KJ)
    ...
    @Column(name=GenIT_HokenSyouken.AISATUMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.CCMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.HSKMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.HOSYOUNYMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.HOSYOUNYHIHKNSYAMEIKANJI)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUMIDASIMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUMIDASIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNIGIMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNIGIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNHRSMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNHRSMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNSMRMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKNMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKNMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKNSMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKNSMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI3HKNKKNMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI3HKNKKNMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1HKNKKNYMDTO)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SIBOUITJBRPYENTUUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SIBOUDAI1KJNKNGKTUUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2HKNKKNYMDTO)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SIBOUDAI2KJNKNGKTUUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.SIBOUDAI3KJNKNGKTUUKTYPE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.DAI1SKWSRATEYENDAKA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.DAI1SKWSRATEYENKIJYUN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.DAI1SKWSRATEYENYASU)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU01)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD01)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE01)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU01)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU01)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU01)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE01)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU02)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD02)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE02)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU02)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU02)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU02)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE02)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU03)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD03)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE03)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU03)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU03)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU03)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE03)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU04)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD04)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE04)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU04)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU04)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU04)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE04)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU05)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD05)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE05)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU05)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU05)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU05)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE05)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU06)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD06)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE06)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU06)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU06)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU06)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE06)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU07)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD07)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE07)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU07)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU07)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU07)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE07)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU08)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD08)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE08)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU08)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU08)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU08)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE08)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU09)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD09)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE09)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU09)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU09)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU09)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE09)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SKEIKANENSUU10)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.DAI1SIBOUSNENOUTOUYMD10)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPE10)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMU10)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKIJYUNUMU10)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMU10)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPE10)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1STUUKTYPEHURYO)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENDAKAUMUHURYO)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENKJNUMUHURYO)
    ...
    @Column(name=GenIT_HokenSyouken.DAI1SYENYENYASUUMUHURYO)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI1SYENTUUKTYPEHURYO)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI2STUUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI2SYENTUUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI3STUUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.DAI3SYENTUUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUINJIPTNKBN)
    ...
    @Column(name=GenIT_HokenSyouken.MKHYOUYENSYSNIKOUMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.MKHYOUYENSYSNIKOUMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.MKHYOUYENSYSNIKOUMSGCD3)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.MKHYOUYENSYSNIKOUGKTYPE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.MKHYOUYENSYSNIKOUWRA)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKMSGCDST1)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKMSGCDST2)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRUKTGKUMU)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKKYKTUUKA)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRTKYKSTDMSGCD)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRJRUGKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN01)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN01)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN02)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN02)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN03)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN03)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN04)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN04)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN05)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN05)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN06)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN06)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN07)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN07)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN08)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN08)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN09)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN09)
    ...
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSIKUHHKNNEN10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.KAIGOMAEHRSTIKKN10)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDUE01)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDUE02)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDUE03)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDUE04)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMKNSNHYUPTN)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDST01)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDST02)
    ...
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMMSGCDST03)
    ...
    @Column(name=GenIT_HokenSyouken.STDSTMMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.FSTPMSGCD)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.FSTPHRKPKNGKKEITUUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.FSTPONEGAIMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.DSMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUHNHUTAIMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.SYOUHNHUTAIMSGCD2)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.PYENTUUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.TOIAWASESAKIHANYOUMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.ANNAIHANYOUMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD5)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.WITIJIBRPTUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.WYENHRKGKTUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyouken.WYENITIJIBRPTUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.KOUJYOSYOUMEIMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.KOUJYOSYOUMEIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.KOUJYOSYOUMEIMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.KOUJYOSYOUMEIHSKMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.NENKOUJYOSYOUMEIHSKMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN1)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN2)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN3)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN4)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN5)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN6)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN7)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN8)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN9)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN10)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN11)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN12)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN13)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN14)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN15)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN16)
    ...
    @Type(type="UserType_C_TokusyuSyoriNaiyouKbn")
    @Column(name=GenIT_HokenSyouken.TOKUSYUSYORINAIYOUKBN17)
    ...
    @Column(name=GenIT_HokenSyouken.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_HokenSyouken.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_HokenSyouken.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_HokenSyouken.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyouken.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANNKSHRSTARTYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANNENKINKKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANYENSYSNHKHNKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANTMTTKNZKRTJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SONOTANYRANSETTEIBAIRITU)
    ...
    @Column(name=GenIT_HokenSyouken.SONOTANYRANTMTTKNGKTUKTYPE)
    ...
    @Column(name=GenIT_HokenSyouken.SONOTANYRANSISUUNM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyouken.KGMAEHRTKDAI1HKNKKNMNRYYMD)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.NKMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD3)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD4)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD5)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD8)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD9)
    ...
    @Column(name=GenIT_HokenSyouken.SIBOUKYUUHUKINMSGCD10)
    ...
    @Column(name=GenIT_HokenSyouken.NKSHRSTARTZENYMD)
    ...
    @Column(name=GenIT_HokenSyouken.MKHYOUYENNKHKNHENTKTYPE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.MKHYOUYENNKHKNHENTKMKHWARI)
    ...
    @Column(name=GenIT_HokenSyouken.HAIBUNWARIMSGCD1)
    ...
    @Column(name=GenIT_HokenSyouken.HAIBUNWARIMSGCD2)
    ...
    @Column(name=GenIT_HokenSyouken.HAIBUNWARIMSGCD3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.TEIRITUTMTTHBNWR)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SISUUTMTTHBNWR)
    ...
    @Column(name=GenIT_HokenSyouken.SISUUANNAIMSG1)
    ...
    @Column(name=GenIT_HokenSyouken.SISUUANNAIMSG2)
    ...
    @Column(name=GenIT_HokenSyouken.SISUUANNAIMSG3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.HUTANHIYUSTMYTIJIHIRITU)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD21)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD22)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD23)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD31)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD32)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCD33)
    ...
    @Column(name=GenIT_HokenSyouken.WMSGCDST1)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD6)
    ...
    @Column(name=GenIT_HokenSyouken.WTYUUIJIKOUMSGCD7)
    ...
    @Column(name=GenIT_HokenSyouken.TANTOCD)
    ...
    @Column(name=GenIT_HokenSyouken.PHRKKTUKI)
    ...
    @Column(name=GenIT_HokenSyouken.YAKKANJYURYOUHOUKBN)
    ...
    @Column(name=GenIT_HokenSyouken.YAKKANBUNSYONO)
    ...
    @Column(name=GenIT_HokenSyouken.SIORINO)
    ...
    @Column(name=GenIT_HokenSyouken.SIORIWEBUKTRIANNAIMSGCD)
    ...
    @Column(name=GenIT_HokenSyouken.SAGYOUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SISUUUPKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyouken.SISUUDOWNKAISUU)
