...
/**
 * ＲＡＹ異動ＶＦテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RayIdouVTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayIdouVTy}</td><td colspan="3">ＲＡＹ異動ＶＦテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RayIdouVTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RayIdouVTy.TABLE_NAME)
@IdClass(value=PKZT_RayIdouVTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayIdouVTy extends AbstractExDBEntity<ZT_RayIdouVTy, PKZT_RayIdouVTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayIdouVTy";
    ...
    private final PKZT_RayIdouVTy primaryKey;

    public GenZT_RayIdouVTy() {
        primaryKey = new PKZT_RayIdouVTy();
    }

    public GenZT_RayIdouVTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RayIdouVTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RayIdouVTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayIdouVTy> getMetaClass() {
        return QZT_RayIdouVTy.class;
    }

    @Id
    @Column(name=GenZT_RayIdouVTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVTy.ZTYVYOURENDOURITU)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X21)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X23)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV15)
    ...
    @Column(name=GenZT_RayIdouVTy.ZTYYOBIV20)
