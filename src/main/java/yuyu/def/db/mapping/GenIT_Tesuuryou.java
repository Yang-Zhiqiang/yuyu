...
import yuyu.def.db.id.PKIT_Tesuuryou;
...
/**
 * 手数料情報テーブル テーブルのマッピング情報クラスで、 {@link IT_Tesuuryou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_Tesuuryou}</td><td colspan="3">手数料情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_Tesuuryou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_Tesuuryou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTsrysyorikbn tsrysyorikbn}</td><td>手数料処理区分</td><td align="center">{@link PKIT_Tesuuryou ○}</td><td align="center">V</td><td>{@link C_TsrysyoriKbn}</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_Tesuuryou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_Tesuuryou.TABLE_NAME)
@IdClass(value=PKIT_Tesuuryou.class)
@TypeDefs({
...
public abstract class GenIT_Tesuuryou extends AbstractExDBEntity<IT_Tesuuryou, PKIT_Tesuuryou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_Tesuuryou";
    ...
    private final PKIT_Tesuuryou primaryKey;

    public GenIT_Tesuuryou() {
        primaryKey = new PKIT_Tesuuryou();
    }
    ...
    @Transient
    @Override
    public PKIT_Tesuuryou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_Tesuuryou> getMetaClass() {
        return QIT_Tesuuryou.class;
    }

    @Id
    @Column(name=GenIT_Tesuuryou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_Tesuuryou.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_Tesuuryou.TSRYSYORIKBN)
    ...
    @Id
    @Column(name=GenIT_Tesuuryou.RENNO)
    ...
    @Column(name=GenIT_Tesuuryou.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_Tesuuryou.KOURYOKUHASSEIYM)
    ...
    @Column(name=GenIT_Tesuuryou.NYKNKAISUUY)
    ...
    @Column(name=GenIT_Tesuuryou.NYKNKAISUUM)
    ...
    @Column(name=GenIT_Tesuuryou.MIKEIKAPARIFLG)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_Tesuuryou.MISYUUPARIFLG)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_Tesuuryou.SEISEKIYM)
    ...
    @Column(name=GenIT_Tesuuryou.HRKKAISUU)
    ...
    @Column(name=GenIT_Tesuuryou.HRKKEIRO)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_Tesuuryou.JKIPJYTYM)
    ...
    @Column(name=GenIT_Tesuuryou.HAITOUNENDO)
    ...
    @Column(name=GenIT_Tesuuryou.CIFCD)
    @MaxLength(max=15)
    @AlphaDigit
    ...
    @Column(name=GenIT_Tesuuryou.SMBCKANRIID)
    ...
    @Column(name=GenIT_Tesuuryou.BOSKYKJYOUTAI)
    ...
    @Column(name=GenIT_Tesuuryou.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_Tesuuryou.BOSYUUYM)
    @ValidDateYm
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_Tesuuryou.NYKNYMD)
    ...
    @Column(name=GenIT_Tesuuryou.YENKANSANTKYKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_Tesuuryou.YENKANSANTKYKWSRATEYMD)
    ...
    @Column(name=GenIT_Tesuuryou.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_Tesuuryou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_Tesuuryou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_Tesuuryou.GYOUMUKOUSINTIME)
