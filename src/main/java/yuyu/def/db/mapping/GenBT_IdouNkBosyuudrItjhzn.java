...
import yuyu.def.db.id.PKBT_IdouNkBosyuudrItjhzn;
...
/**
 * 異動年金支払募集代理店一時保存テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouNkBosyuudrItjhzn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getNksysyno nksysyno}</td><td>年金証書番号</td><td align="center">{@link PKBT_IdouNkBosyuudrItjhzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouNkBosyuudrItjhzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKBT_IdouNkBosyuudrItjhzn
 * @see     QBT_IdouNkBosyuudrItjhzn
 * @see     GenQBT_IdouNkBosyuudrItjhzn
 */
@MappedSuperclass
@Table(name=GenBT_IdouNkBosyuudrItjhzn.TABLE_NAME)
@IdClass(value=PKBT_IdouNkBosyuudrItjhzn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBT_IdouNkBosyuudrItjhzn extends AbstractExDBEntity<BT_IdouNkBosyuudrItjhzn, PKBT_IdouNkBosyuudrItjhzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouNkBosyuudrItjhzn";
    ...
    private final PKBT_IdouNkBosyuudrItjhzn primaryKey;

    public GenBT_IdouNkBosyuudrItjhzn() {
        primaryKey = new PKBT_IdouNkBosyuudrItjhzn();
    }

    public GenBT_IdouNkBosyuudrItjhzn(String pNksysyno, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouNkBosyuudrItjhzn(pNksysyno, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouNkBosyuudrItjhzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouNkBosyuudrItjhzn> getMetaClass() {
        return QBT_IdouNkBosyuudrItjhzn.class;
    }

    @Id
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.NKSYSYNO)
    @NenkinSyousyoNo
    ...
    @Id
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.DAIRITENCD1)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.BUNWARI1)
    ...
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.DAIRITENCD2)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.BUNWARI2)
    ...
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.KANRISOSIKICD1)
    ...
    @Column(name=GenBT_IdouNkBosyuudrItjhzn.KANRISOSIKICD2)
