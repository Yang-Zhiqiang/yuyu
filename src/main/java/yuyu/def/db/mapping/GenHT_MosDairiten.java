...
import yuyu.def.db.id.PKHT_MosDairiten;
import yuyu.def.db.meta.GenQHT_MosDairiten;
...
/**
 * 申込代理店テーブル テーブルのマッピング情報クラスで、 {@link HT_MosDairiten} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_MosDairiten}</td><td colspan="3">申込代理店テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_MosDairiten ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKHT_MosDairiten ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     HT_MosDairiten
 * @see     PKHT_MosDairiten
 * @see     QHT_MosDairiten
 * @see     GenQHT_MosDairiten
 */
@MappedSuperclass
@Table(name=GenHT_MosDairiten.TABLE_NAME)
@IdClass(value=PKHT_MosDairiten.class)
@TypeDefs({
...
public abstract class GenHT_MosDairiten extends AbstractExDBEntity<HT_MosDairiten, PKHT_MosDairiten> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_MosDairiten";
    ...
    private final PKHT_MosDairiten primaryKey;

    public GenHT_MosDairiten() {
        primaryKey = new PKHT_MosDairiten();
    }

    public GenHT_MosDairiten(String pMosno, Integer pRenno) {
        primaryKey = new PKHT_MosDairiten(pMosno, pRenno);
    }

    @Transient
    @Override
    public PKHT_MosDairiten getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_MosDairiten> getMetaClass() {
        return QHT_MosDairiten.class;
    }

    @Id
    @Column(name=GenHT_MosDairiten.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_MosDairiten.RENNO)
    ...
    @Column(name=GenHT_MosDairiten.BSYUJOYADRTENCD)
    ...
    @Column(name=GenHT_MosDairiten.DRTENSYKBN)
    ...
    @Column(name=GenHT_MosDairiten.KINYUUCD)
    ...
    @Column(name=GenHT_MosDairiten.KINYUUSITENCD)
    ...
    @Column(name=GenHT_MosDairiten.TRATKIAGCD)
    ...
    @Column(name=GenHT_MosDairiten.OYADRTENCD)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.JIMUSYOCD)
    @Length(length=4)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.BOSYUUTRKNO)
    ...
    @Column(name=GenHT_MosDairiten.CIFCD)
    @MaxLength(max=15)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.DRTENCD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.BOSYUUCD)
    @MaxLength(max=6)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.INPUTBOSYUUCD)
    @Length(length=7)
    @Digit
    @Modulus10w21
    ...
    @Column(name=GenHT_MosDairiten.DAIBOSYUUCD)
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_MosDairiten.TRATKIKOUINNCD)
    ...
    @Column(name=GenHT_MosDairiten.YUUSEIKBN)
    ...
    @Column(name=GenHT_MosDairiten.KYOKUSYOCD)
    ...
    @Column(name=GenHT_MosDairiten.YUUSEISYAINNO)
    ...
    @Column(name=GenHT_MosDairiten.DRTENKANRISOSIKICD)
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_MosDairiten.GYOUSEKIKEIJYOUSAKISOSIKICD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosDairiten.BUNWARI)
    ...
    @Column(name=GenHT_MosDairiten.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_MosDairiten.GYOUMUKOUSINTIME)
