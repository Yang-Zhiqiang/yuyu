...
import yuyu.def.db.id.PKBT_Gknyknmeisai;
import yuyu.def.db.meta.GenQBT_Gknyknmeisai;
import yuyu.def.db.meta.QBT_Gknyknmeisai;

/**
 * 外貨入出金明細テーブル テーブルのマッピング情報クラスで、 {@link BT_Gknyknmeisai} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getHrkmsakuseiymd hrkmsakuseiymd}</td><td>（振込用）作成日</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmrenrakuymd hrkmrenrakuymd}</td><td>（振込用）連絡日</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmrenrakukaisuu hrkmrenrakukaisuu}</td><td>（振込用）連絡回数</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getHrkmbankcd hrkmbankcd}</td><td>（振込用）銀行番号</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getHrkmshitencd hrkmshitencd}</td><td>（振込用）支店番号</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmsitennmej hrkmsitennmej}</td><td>（振込用）支店名（英字）</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmyokinkbn hrkmyokinkbn}</td><td>（振込用）預金種目区分</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmkouzano hrkmkouzano}</td><td>（振込用）口座番号</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmkznmej hrkmkznmej}</td><td>（振込用）口座名（英字）</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkmzndktuukasyu hrkmzndktuukasyu}</td><td>（振込用）残高通貨種類</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getHrkmsyorino1 hrkmsyorino1}</td><td>（振込用）処理通番１</td><td align="center">{@link PKBT_Gknyknmeisai ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     BT_Gknyknmeisai
 * @see     PKBT_Gknyknmeisai
 * @see     QBT_Gknyknmeisai
 * @see     GenQBT_Gknyknmeisai
 */
@MappedSuperclass
@Table(name=GenBT_Gknyknmeisai.TABLE_NAME)
@IdClass(value=PKBT_Gknyknmeisai.class)
public abstract class GenBT_Gknyknmeisai extends AbstractExDBEntity<BT_Gknyknmeisai, PKBT_Gknyknmeisai> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_Gknyknmeisai";
    ...
    private final PKBT_Gknyknmeisai primaryKey;

    public GenBT_Gknyknmeisai() {
        primaryKey = new PKBT_Gknyknmeisai();
    }
    ...
    @Transient
    @Override
    public PKBT_Gknyknmeisai getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_Gknyknmeisai> getMetaClass() {
        return QBT_Gknyknmeisai.class;
    }

    private String hrkmdatakbn1;

    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSYUBETUCD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMCDKBN)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMSAKUSEIYMD)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMRENRAKUYMD)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMRENRAKUKAISUU)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKNJYYMDFROM)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKNJYYMDTO)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMBANKCD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMBANKNMEJ)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSITENCDTORI)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSITENNMEJTORI)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMSHITENCD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSITENNMEJ)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMYOKINKBN)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMKOUZANO)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKZNMEJ)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMZNDKTUUKASYU)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMZNDKSSKETA)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMGKTRHKMAEZNDK)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKASIKOSIKBN)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMYOBIV86)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKBN1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKOUSEI)
    ...
    @Id
    @Column(name=GenBT_Gknyknmeisai.HRKMSYORINO1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKNJYYMD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKSNYMD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMIRIBARAIKBN)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTRHKKBN)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTRHKTUUKASYU)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTRHKSSKETA)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMGKTRHKGK)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMBANKSYOUKAINO)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTRHKSYOUKAINO)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTEKIYOUNAIYOUEJ)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMYOBIV103)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKBN2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTKOUSEIKBN)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMTRKSCD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSYORINO2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMBANKSYOUKAINO2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSIMUKEYMD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSETUJYUYMD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSOUKINSYU)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMVALUEYMD)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSKNTUUKASYU)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMSKNSSKETA)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMGKSOUKINGK)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMIRNINNMEJ)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMYOBIV40)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN4)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKBN3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDSUU1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDNO1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENSUU1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENKETA1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHEN1)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN5)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKBN4)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDSUU2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDNO2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENSUU2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENKETA2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHEN2)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDATAKBN6)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDTRECORDKBN5)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDSUU3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMDOURECORDNO3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENSUU3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHENKETA3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMKAHEN3)
    ...
    @Column(name=GenBT_Gknyknmeisai.HRKMRENSAKUSEIYMD)
