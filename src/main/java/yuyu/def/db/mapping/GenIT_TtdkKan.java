...
import yuyu.def.db.id.PKIT_TtdkKan;
import yuyu.def.db.meta.GenQIT_TtdkKan;
...
/**
 * 手続完了テーブル テーブルのマッピング情報クラスで、 {@link IT_TtdkKan} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_TtdkKan}</td><td colspan="3">手続完了テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_TtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_TtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_TtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_TtdkKan.TABLE_NAME)
@IdClass(value=PKIT_TtdkKan.class)
@TypeDefs({
...
public abstract class GenIT_TtdkKan extends AbstractExDBEntity<IT_TtdkKan, PKIT_TtdkKan> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_TtdkKan";
    ...
    private final PKIT_TtdkKan primaryKey;

    public GenIT_TtdkKan() {
        primaryKey = new PKIT_TtdkKan();
    }
    ...
    @Transient
    @Override
    public PKIT_TtdkKan getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_TtdkKan> getMetaClass() {
        return QIT_TtdkKan.class;
    }

    @Id
    @Column(name=GenIT_TtdkKan.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_TtdkKan.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_TtdkKan.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_TtdkKan.SYORUICD)
    ...
    @Column(name=GenIT_TtdkKan.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.HASSOUKBN)
    ...
    @Column(name=GenIT_TtdkKan.TANTOUSITUKBN)
    ...
    @Column(name=GenIT_TtdkKan.SYOUKENDHUMUKBN)
    ...
    @Column(name=GenIT_TtdkKan.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SHSNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASEYNO)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASEKAISYANMKJ)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASETELNO)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_TtdkKan.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_TtdkKan.TETUDUKISYUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_TtdkKan.SHRUMU)
    ...
    @Column(name=GenIT_TtdkKan.SYORIKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.KYKYMD)
    ...
    @Column(name=GenIT_TtdkKan.SYOUHNNM)
    @MaxLength(max=40)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_TtdkKan.YENSHRTKTEKIUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_TtdkKan.TTDKNAIYOUUMUKBN)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU1)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU2)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU3)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU4)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU5)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU6)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU7)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU8)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU9)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOU10)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.SHRYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.CALCKIJYUNYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.KAIYKYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.SHRTUUKASYU)
    ...
    @Column(name=GenIT_TtdkKan.SHRTUUKASYURYK)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.HNKNTUUKASYU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.HNKNYMD)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU1)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU2)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU3)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU4)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU5)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU6)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU7)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU8)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU9)
    ...
    @Column(name=GenIT_TtdkKan.TEKIYOU10)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU1)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU2)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU3)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU4)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU5)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU6)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU7)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU8)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU9)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KNGKMISITUUKASYU10)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU1)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU2)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU3)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU4)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU5)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU6)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU7)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU8)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU9)
    ...
    @Column(name=GenIT_TtdkKan.BIKOU10)
    ...
    @Column(name=GenIT_TtdkKan.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.BANKNMKJ)
    @MaxLength(max=20)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SITENNMKJ)
    @MaxLength(max=20)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.YOKINKBN)
    ...
    @Column(name=GenIT_TtdkKan.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_TtdkKan.KZSYURUIKBN)
    ...
    @Column(name=GenIT_TtdkKan.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.SOUKINSAKISITEIKBN)
    ...
    @Column(name=GenIT_TtdkKan.HTSIRYOSYUKBN)
    ...
    @Column(name=GenIT_TtdkKan.KAIYAKUJIYUU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_TtdkKan.ZEIMUMONGONOUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUMONGON1)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUMONGON2)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUMONGON3)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUMONGON4)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUMONGON5)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGONHYOUDAI)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON1)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON2)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON3)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON4)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON5)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON6)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON7)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON8)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON9)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON10)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON11)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON12)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON13)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON14)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON15)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON16)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON17)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON18)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON19)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON20)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON21)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON22)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON23)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON24)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON25)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON26)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON27)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON28)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON29)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON30)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON31)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON32)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON33)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON34)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON35)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON36)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON37)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON38)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON39)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON40)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON41)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON42)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON43)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON44)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON45)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON46)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON47)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON48)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON49)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEMONGON50)
    ...
    @Column(name=GenIT_TtdkKan.OSIRASEINJIHUYOUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_TtdkKan.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_TtdkKan.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_TtdkKan.KYKHNKKAISUU)
    ...
    @Column(name=GenIT_TtdkKan.ZEIMUNAIYOUHENSYUCTRLKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKYMD)
    ...
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKINFO)
    ...
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKGKHUGOU1)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKKNGKTUKSYU1)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKKNGKHUGOU2)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_TtdkKan.KYKNIYUHNKKNGKTUKSYU2)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU1)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU2)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU3)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU4)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU5)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU6)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU7)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU8)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU9)
    ...
    @Type(type="UserType_C_HugouKbn")
    @Column(name=GenIT_TtdkKan.SHRKNGKMEISAIHUGOU10)
    ...
    @Column(name=GenIT_TtdkKan.DOCUMENTID)
    @MaxLength(max=24)
    @SingleByteStrings
    ...
    @Column(name=GenIT_TtdkKan.SKSMONGONKBN1)
    ...
    @Type(type="UserType_C_SksmongonKbn")
    @Column(name=GenIT_TtdkKan.SKSMONGONKBN2)
    ...
    @Column(name=GenIT_TtdkKan.TORITUGISYASYOZOKUNM)
    ...
    @Column(name=GenIT_TtdkKan.TORITUGISYAKJNCD)
    ...
    @Column(name=GenIT_TtdkKan.TORITUGISYANM)
    ...
    @Column(name=GenIT_TtdkKan.HOZONKIKAN)
    ...
    @Column(name=GenIT_TtdkKan.SHRNAIYOUHSKMONGON1)
    ...
    @Column(name=GenIT_TtdkKan.SHRNAIYOUHSKMONGON2)
    ...
    @Column(name=GenIT_TtdkKan.YENDTHNKZEIMUINFOHSKKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_TtdkKan.YUUYOKKNTYOUKAUMU)
    ...
    @Column(name=GenIT_TtdkKan.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_TtdkKan.DSEISANSHRTTDKNM)
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKKBN1)
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKSEI1)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.TRKKZKSEIYMD1)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKYNO1)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR1KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR2KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR3KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKTELNO1)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKTELNOMTRKHYOUJI1)
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKTDK1)
    ...
    @Type(type="UserType_C_TrkKzkKbn")
    @Column(name=GenIT_TtdkKan.TRKKZKKBN2)
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_Seibetu")
    @Column(name=GenIT_TtdkKan.TRKKZKSEI2)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.TRKKZKSEIYMD2)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKYNO2)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR1KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR2KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKADR3KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.TRKKZKTELNO2)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Type(type="UserType_C_Tdk")
    @Column(name=GenIT_TtdkKan.TRKKZKTDK2)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.KYKOMTTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KZKOMTTUTKBN1)
    ...
    @Column(name=GenIT_TtdkKan.KZKOMTTUTKBN2)
    ...
    @Column(name=GenIT_TtdkKan.HHKOMTTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.HHKDROMTTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRIOMTTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKURTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KZKURTUTKBN1)
    ...
    @Column(name=GenIT_TtdkKan.KZKURTUTKBN2)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRURTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRIURTUTKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKAISTMSGKBN)
    ...
    @Column(name=GenIT_TtdkKan.KZKAISTMSGKBN1)
    ...
    @Column(name=GenIT_TtdkKan.KZKAISTMSGKBN2)
    ...
    @Column(name=GenIT_TtdkKan.HHKAISTMSGKBN)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRAISTMSGKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRIAISTMSGKBN)
    ...
    @Column(name=GenIT_TtdkKan.SAKUJYOKZKNMKJ)
    ...
    @Column(name=GenIT_TtdkKan.TTDKNAIYOUKBN)
    ...
    @Column(name=GenIT_TtdkKan.KZKTAISYOUKYKKBN)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRTAISYOUKYKKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRITAISYOUKYKKBN)
    ...
    @Column(name=GenIT_TtdkKan.MOSHNKNIYMSGKBN1)
    ...
    @Column(name=GenIT_TtdkKan.KYKMOSHNKNIYMSG2)
    ...
    @Column(name=GenIT_TtdkKan.KZKMOSHNKNIYMSG21)
    ...
    @Column(name=GenIT_TtdkKan.KZKMOSHNKNIYMSG22)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRMOSHNKNIYMSG2)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRIMOSHNKNIYMSG2)
    ...
    @Column(name=GenIT_TtdkKan.KYKDRMSGKBN)
    ...
    @Column(name=GenIT_TtdkKan.KYKHHKDRMSG)
    ...
    @Column(name=GenIT_TtdkKan.KZKHHKDRMSG1)
    ...
    @Column(name=GenIT_TtdkKan.KZKHHKDRMSG2)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG1)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG2)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG3)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG4)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG5)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG6)
    ...
    @Column(name=GenIT_TtdkKan.DUHUBUTUMSG7)
    ...
    @Column(name=GenIT_TtdkKan.KYKIGAIDHBTMSG1)
    ...
    @Column(name=GenIT_TtdkKan.KYKIGAIDHBTMSG2)
    ...
    @Column(name=GenIT_TtdkKan.KYKIGAIDHBTMSG3)
    ...
    @Column(name=GenIT_TtdkKan.KYKIGAIDHBTMSG4)
    ...
    @Column(name=GenIT_TtdkKan.KIYAKUHUNYUUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.YAKKANKIYAKUHUNYUUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.KYKTRKTRSHUUNYUUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.KZKTRKTRSHUUNYUUHYOUJI1)
    ...
    @Column(name=GenIT_TtdkKan.KZKTRKTRSHUUNYUUHYOUJI2)
    ...
    @Column(name=GenIT_TtdkKan.KYKDRHUUNYUUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRHUUNYUUHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.KYKDAIRINMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.KYKDRSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.KYKDRYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_TtdkKan.KYKDRADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.KYKDRADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.KYKDRADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.KYKDRTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_TtdkKan.HHKDRNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TtdkKan.HHKDRSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TtdkKan.HHKDRYNO)
    ...
    @Column(name=GenIT_TtdkKan.HHKDRADR1KJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.HHKDRADR2KJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.HHKDRADR3KJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_TtdkKan.HHKDRTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_TtdkKan.HHKDRTELNOMTRKHYOUJI)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO2)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO3)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO4)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO5)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO6)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO7)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO8)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO9)
    ...
    @Column(name=GenIT_TtdkKan.KHSYONO10)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO1)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO2)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO3)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO4)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO5)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO6)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO7)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO8)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO9)
    ...
    @Column(name=GenIT_TtdkKan.KHMOSNO10)
    ...
    @Column(name=GenIT_TtdkKan.HNSNHUTOUHUUNYUUHYOUJI)
