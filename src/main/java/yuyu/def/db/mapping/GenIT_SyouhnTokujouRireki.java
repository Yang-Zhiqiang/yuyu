...
import yuyu.def.db.id.PKIT_SyouhnTokujouRireki;
import yuyu.def.db.meta.GenQIT_SyouhnTokujouRireki;
...
/**
 * 商品特条履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_SyouhnTokujouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_SyouhnTokujouRireki}</td><td colspan="3">商品特条履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_SyouhnTokujouRireki
 * @see     PKIT_SyouhnTokujouRireki
 * @see     QIT_SyouhnTokujouRireki
 * @see     GenQIT_SyouhnTokujouRireki
 */
@MappedSuperclass
@Table(name=GenIT_SyouhnTokujouRireki.TABLE_NAME)
@IdClass(value=PKIT_SyouhnTokujouRireki.class)
@TypeDefs({
...
public abstract class GenIT_SyouhnTokujouRireki extends AbstractExDBEntity<IT_SyouhnTokujouRireki, PKIT_SyouhnTokujouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_SyouhnTokujouRireki";
    ...
    private final PKIT_SyouhnTokujouRireki primaryKey;

    public GenIT_SyouhnTokujouRireki() {
        primaryKey = new PKIT_SyouhnTokujouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_SyouhnTokujouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_SyouhnTokujouRireki> getMetaClass() {
        return QIT_SyouhnTokujouRireki.class;
    }

    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.KYKSYOUHNRENNO)
    ...
    @Id
    @Column(name=GenIT_SyouhnTokujouRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.TKJYHYOUTEN)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.TKJYSKGNKKN)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPBUICD1)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPKKN1)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPBUICD2)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPKKN2)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPBUICD3)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPKKN3)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPBUICD4)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_SyouhnTokujouRireki.HTNPKKN4)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.TOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_SyouhnTokujouRireki.GYOUMUKOUSINTIME)
