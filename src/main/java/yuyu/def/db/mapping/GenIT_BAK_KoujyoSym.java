...
import yuyu.def.db.id.PKIT_BAK_KoujyoSym;
import yuyu.def.db.meta.GenQIT_BAK_KoujyoSym;
...
/**
 * 控除証明書バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KoujyoSym} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KoujyoSym}</td><td colspan="3">控除証明書バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getNendo nendo}</td><td>年度</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KoujyoSym ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KoujyoSym
 * @see     PKIT_BAK_KoujyoSym
 * @see     QIT_BAK_KoujyoSym
 * @see     GenQIT_BAK_KoujyoSym
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KoujyoSym.TABLE_NAME)
@IdClass(value=PKIT_BAK_KoujyoSym.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KoujyoSym extends AbstractExDBEntity<IT_BAK_KoujyoSym, PKIT_BAK_KoujyoSym> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KoujyoSym";
    ...
    private final PKIT_BAK_KoujyoSym primaryKey;

    public GenIT_BAK_KoujyoSym() {
        primaryKey = new PKIT_BAK_KoujyoSym();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KoujyoSym getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KoujyoSym> getMetaClass() {
        return QIT_BAK_KoujyoSym.class;
    }

    @Id
    @Column(name=GenIT_BAK_KoujyoSym.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KoujyoSym.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KoujyoSym.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KoujyoSym.NENDO)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TYOUHYOUYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_BAK_KoujyoSym.RENNO)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KJSMSAKUSEISYORIKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TEKIYOUSEIDOKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.SYOUMEIYMD)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.SYOUMEISTARTYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_KoujyoSym.SYOUMEIENDYM)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.SYOUMEIKKNTUKISUU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.SYOUMEIKKNNENSUU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.UKTNMKJADDSAMA)
    @MaxLength(max=17)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KoujyoSym.NENKINUKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KoujyoSym.HKNSYURUINMRYKKJ)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KoujyoSym.KYKYMD)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.HKNKKNSMNKBNSYU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.HKNKKNSYU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.NENKANHRKKAISUU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.PHRKKKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KoujyoSym.NKSHRSTARTYMD)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.NKNSHRY)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.HAITOUKINUKETORIHOUKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KJNNKKOUJYUM)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASEYNO)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASETELNO)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.TOIAWASETELNO2)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.HASSOUKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.DRTENCD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_KoujyoSym.DRTENNMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KoujyoSym.HENGAKUUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KoujyoSym.NEWSYOUMEIGKUMUKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KOUJYOSYOUMEISENTAKUKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.UKTNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_KoujyoSym.SAIHKHYJKBN)
    ...
    @Column(name=GenIT_BAK_KoujyoSym.KOUJYOSYOUMEIMSGKBN)
