...
/**
 * 備金異動明細Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_BikinIdouMeisaiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_BikinIdouMeisaiRn}</td><td colspan="3">備金異動明細Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_BikinIdouMeisaiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_BikinIdouMeisaiRn
 * @see     PKZT_BikinIdouMeisaiRn
 * @see     QZT_BikinIdouMeisaiRn
 * @see     GenQZT_BikinIdouMeisaiRn
 */
@MappedSuperclass
@Table(name=GenZT_BikinIdouMeisaiRn.TABLE_NAME)
@IdClass(value=PKZT_BikinIdouMeisaiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_BikinIdouMeisaiRn extends AbstractExDBEntityForZDB<ZT_BikinIdouMeisaiRn, PKZT_BikinIdouMeisaiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_BikinIdouMeisaiRn";
    ...
    private final PKZT_BikinIdouMeisaiRn primaryKey;

    public GenZT_BikinIdouMeisaiRn() {
        primaryKey = new PKZT_BikinIdouMeisaiRn();
    }

    public GenZT_BikinIdouMeisaiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_BikinIdouMeisaiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_BikinIdouMeisaiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_BikinIdouMeisaiRn> getMetaClass() {
        return QZT_BikinIdouMeisaiRn.class;
    }

    @Id
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKSYASKINMEINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEIKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEIGYOUSEKIHYJSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNALMYOUSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEINENBARAIKANSANP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGYOUSEKIHYOUJISRANK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTEIKIBAIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANGODATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAITEKYKDATAKANRINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAITEKYKDATAKANRINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNSYOKAIPCASHLESSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYOKAIPANNAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZENNOUKAISIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNZENNOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEIZONKYUUHUKINSITEIY)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNALMYOUSEIZONKYHKNSITEIMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNJIKAIPJYUUTOUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADKEISANKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADKEISANKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADKEISANKBNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADKEISANKBNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV6X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIMATUVYOUTUMIMASIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKMTVYUSNHKNFUNDTMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEINENKANSANP3X1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEINENKANSANP3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEINENKANSANP3X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEINENKANSANP3X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKMTVYUHIJYNBRITMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIMATUVYOUITJBRTMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X33)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHAITOUYOULOADINGKIJYUNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUMITATED)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKARIWARIATED)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUZENSIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUZENTUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUGOSIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUGOTUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUGOKYUUHUTAISYOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTYOKUGOCBKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYOKAISIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYOKAITUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNCBNAYOSETUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHITENKANKEIYAKUSUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNGOUKEIPBUBUNTENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAIDAIHKTGTIKKIKKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSISYUTNKNHKTGKUJYGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X34)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKKYKYMDX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTKBTDKISNYUSX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYGKX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIHYOUJIX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKNENKNSNPX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKKYKYMDX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTKBTDKISNYUSX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYGKX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIHYOUJIX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKNENKNSNPX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKKYKYMDX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTKBTDKISNYUSX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYGKX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIHYOUJIX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKNENKNSNPX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKKYKYMDX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNTKBTDKISNYUSX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTNKNKAIYKKUJYGKX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIHYOUJIX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHTNKNKYKNENKNSNPX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHKTGTIKKIKKKNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSWINGMINYUUPHRKEKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSWINGMINYUUPHRKEJYUTUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFTOUNENDOITIJITOUNYUUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFKAIYAKUKUJYHKTGGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAIYAKUKOUJYOTUKISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFKAIYAKUHENREIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUUSEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISYAKEISYOUSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISYAZAISEKIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISYABOSYUUJIAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISYABSYJISIKAKUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNAATUKAISYASIKAKUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNOKYKSMKUZTRHKKITIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHOYUUSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYOKANSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTANTOUSYAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTANTOUSYAKBNNEW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNCLUBSUMISEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTANTOUSYAJYOUTAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSONOTAYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIJIBARAIKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIJIBARAITEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNITIJIBARAISONOTAYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTENKANTEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSZOUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVESTINGYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSIPPEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSEIJINBYOUTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNJYOSEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTUUINTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSAITEIHOSYOUI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVKISOITJBRKHNYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNVKISORRTZEROIKAHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHOYUUSISYACD2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNDFTUJYUKUJYKISNKISIYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTIKIKKTBRIJYUTUTKSU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSYUNYUMRTIKYKJTIGNGTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNHHKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIV10X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTRKZSGKAIYKKJYNSTMTKZNDK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNPMENKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNSUURIYOUYOBIN13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X35)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X36)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNYOBIN11X37)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X12)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X15)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X16)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X17)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X18)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X19)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X20)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X21)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X22)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X23)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X24)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X25)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X26)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X27)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X28)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X29)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X30)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X31)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X32)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X33)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X34)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X35)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X36)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X37)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X38)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X39)
    ...
    @Column(name=GenZT_BikinIdouMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X40)
