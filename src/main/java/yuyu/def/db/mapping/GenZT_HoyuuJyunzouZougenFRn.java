...
/**
 * 保有純増増減Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_HoyuuJyunzouZougenFRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_HoyuuJyunzouZougenFRn}</td><td colspan="3">保有純増増減Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_HoyuuJyunzouZougenFRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_HoyuuJyunzouZougenFRn.TABLE_NAME)
@IdClass(value=PKZT_HoyuuJyunzouZougenFRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_HoyuuJyunzouZougenFRn extends AbstractExDBEntityForZDB<ZT_HoyuuJyunzouZougenFRn, PKZT_HoyuuJyunzouZougenFRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_HoyuuJyunzouZougenFRn";
    ...
    private final PKZT_HoyuuJyunzouZougenFRn primaryKey;

    public GenZT_HoyuuJyunzouZougenFRn() {
        primaryKey = new PKZT_HoyuuJyunzouZougenFRn();
    }

    public GenZT_HoyuuJyunzouZougenFRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_HoyuuJyunzouZougenFRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_HoyuuJyunzouZougenFRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_HoyuuJyunzouZougenFRn> getMetaClass() {
        return QZT_HoyuuJyunzouZougenFRn.class;
    }

    @Id
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTANTOUKOJINCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTANTOUSYASETTEIYM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKEIJYOUSAKIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKEIJYOUSAKISOSIKI)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNUTIWAKEKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTANTOUKEIYAKUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKYDATKIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYONO)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSAISINBSYYM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMARUTEISYURUIKIGOU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIN3)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKYKNIYUTKSYTIOUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTEISYUUHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNITIJIBRYOUROUHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSEIZONMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTEIGENMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYNYMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNREGUARDMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNREGUARDMRSYUHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNVGUARDMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAIGONKTKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNGOUKEISISTTKYKTKKNSNP)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHSYS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKENSUUN3)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHENKOUGOHOSYOUS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHTNS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHARAIKOMIP)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAIYAKUSIHARAIKNGK)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSIKKOUNYKNKAISUU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHHKNNEN2KETA)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKJKYKNM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTSINKIHONTIKUCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYORISOSIKICD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTIKUSYOKANSISYAKIJYHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKEIZOKUTYUUIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTYOHKKEIYAKUTYUUIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X4)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNDANTAISYOZOKUCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSUPERKNKUSEIKATUPACKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNJIKOKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKIKEIYAKUTYUUIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYUUSEIS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNCLUBSUMISEIKAIINKYKKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNGATKIHMKKNRKMAEKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNGATKISETTEIKOUHOKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNBOSYUU25KEIKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTOKUTEIDAISYOKUDANHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHOYUUIKANTSGKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTOKUBETURULETIKUHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNFIELDTANTOUSYAARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X5)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNCATKIHMKKNRKMAEKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNCATKISETTEIKOUHOKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSEPPANKEIJYOUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV7)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNHOSYOUMINAOSIKAISUUV2)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTENKANGOSYONO)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNQPACKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTENKANGOQPACKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYURUIHNKUTKBTTRTKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNTNKNGSYUHNKUTKBTTRTKHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKIBANHIKITUGIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X6)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYOUMETUCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNJIKAIPJYUUTOUYM)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAIGOMARUSYUUHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNYOBIV1X7)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYORITORIKESIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMRTIKOUSINKATAKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNPMENKBNV1)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSYUKEIYAKUTKKNSNP)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNNENKANSANP)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNDAI3BUNYANENKANSANP)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNNYUUINTKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNNYUUINTKYKHUKAHYJ20IJYOU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNNYUUINTKYKHUKAHYJ5IJYOU)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMARUSYOTKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMARUJYUUTKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAKUDAIMARUITKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAKUNYUUTKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNMARUITKYKHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSTDAIRISEIKYUUTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKENSUUYUUGUUKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAIGOSYNYTEIKIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKAIGOSYNYTEIKISHRKSKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNGYOUSEKIBOSYUJISIKAKUCD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNGYSKBOSHTNSINEIYKSNKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSIKTSYNYMRTIHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSIKTSYNYTEIKIKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSEIKATUSYUUNYUUMRTIS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNLIVGUARDHUKAHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNLIVGUARDS)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNBLUEKZJTKAISIYMD)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKNKUZUSNZYRTSTKBN)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNKZKTOUROKUSERVICEARIHYJ)
    ...
    @Column(name=GenZT_HoyuuJyunzouZougenFRn.ZRNSITEITUUKAKBN)
