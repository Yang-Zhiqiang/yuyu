...
/**
 * ＳＭＢＣ募集テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SmbcBosRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SmbcBosRn}</td><td colspan="3">ＳＭＢＣ募集テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnseihowebidkbn zrnseihowebidkbn}</td><td>（連携用）生保ＷｅｂＩＤ区分</td><td align="center">{@link PKZT_SmbcBosRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnseihowebkojincd zrnseihowebkojincd}</td><td>（連携用）生保Ｗｅｂ個人コード</td><td align="center">{@link PKZT_SmbcBosRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnseihowebitijihozonhyouji zrnseihowebitijihozonhyouji}</td><td>（連携用）生保Ｗｅｂ一時保存表示</td><td align="center">{@link PKZT_SmbcBosRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnseihowebsekno zrnseihowebsekno}</td><td>（連携用）生保Ｗｅｂ設計書番号</td><td align="center">{@link PKZT_SmbcBosRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_SmbcBosRn.TABLE_NAME)
@IdClass(value=PKZT_SmbcBosRn.class)
public abstract class GenZT_SmbcBosRn extends AbstractExDBEntityForZDB<ZT_SmbcBosRn, PKZT_SmbcBosRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SmbcBosRn";
    ...
    private final PKZT_SmbcBosRn primaryKey;

    public GenZT_SmbcBosRn() {
        primaryKey = new PKZT_SmbcBosRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SmbcBosRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SmbcBosRn> getMetaClass() {
        return QZT_SmbcBosRn.class;
    }

    @Id
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBIDKBN)
    ...
    @Id
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKOJINCD)
    ...
    @Id
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBITIJIHOZONHYOUJI)
    ...
    @Id
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSEKNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBCALCKIJYUNYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNSEIYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNSEIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMRHKIHONTIKUCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNADR)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKSYASEIYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKSYASEIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKKIHONTIKUCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKADR)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHKNSYURUINO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHJKKTKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHKNKKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPHRKKIKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHRKKEIROKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSDPDKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKIHONS)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNKSYURUIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBLNTKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNKSHRARIHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMOSNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSEKYKKIGENYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSKSJSITENCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBUKTNRKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBUKTTDKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBUKTKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBUKTKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBUKTSEIYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMOSPRTZMHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBFSTMOSSKSYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHNSYUKYKTDKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBBSYUTRKNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHJNKYKHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKSYKMCD1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKSYKMCD2)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKSYKMCD3)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKSYKMCD4)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKSYKMCD5)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTEIWKKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNTELNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKTELNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKNHJNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKJHJNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKNDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKJDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBDAIHYOUKTGKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSYKIHRKP1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMOSP1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTKIYOUGYOUTAIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPAPERLESSMOSHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBDATASOUSINZMHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBDRTNSKNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSBNKSYUKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBAATKISYAKNYUUCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKEIHIDOUITUHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSITEITUUKAKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNYKNTUUKAKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTARGETTKARIHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTARGETTKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTARGETTKMKHT)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNYKNTUUKANYKNGK)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNYKNTUKFSTHRKP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBNYKNTUKNEXTHRKP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSAIMANKIHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBRAYHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGNYKNTUKNYKNGK)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGNYKNTUKFSTHRKP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGNYKNTUKNXTHRKP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGAIKAKIHONP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKAIGMEHRTKARIHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBYENHSYUTKARIHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGAIKAKIHONS)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBDAI1HKNKKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKSYKGYCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKOTTMSK)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNSYKGYCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNOTTMSK)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNNENSYUUKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLHHKNKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLKYKKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLHRKKEIROKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLSBUKTNRKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLSBUKTTDKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLSBUKTKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLSBUKTKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLSBUKTSEIYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLHHKNTELNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLKYKTELNO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLKIHONTIKUCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLTSINADRKAI)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLHIIKIHONTIKUCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBPLHHKNADR)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHNYPPLTZMHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSSRNDHBNWR)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBTRTRNDHBNWR)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBSUEOKIKKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMNKUKTNRKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMNKUKTTDKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMNKUKTKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMNKUKTKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBMNKUKTSEIYMD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBANKENKANRINO)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBIKKATUP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBIKKATUBARAIKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBIKTBRIKAISUU)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBZENNOUP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBGAIKAZENNOUP)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBZENNOUKKN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBZENNOUHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYDBOSYUUKJNCD)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKTRKMOSKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKTDKKBN1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKKNNM1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKKJNM1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKSEIKBN1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKSEIYMD1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKKYKDOUKYOHYJ1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKYNO1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKADR1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKZKTELNO1)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKDRTKKANOUHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRTKKANOUHYJ)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBDRTKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBKYKDRNRKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRNRKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRTDKKBN)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRKNNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRKJNM)
    ...
    @Column(name=GenZT_SmbcBosRn.ZRNSEIHOWEBHHKNDRSEIYMD)
