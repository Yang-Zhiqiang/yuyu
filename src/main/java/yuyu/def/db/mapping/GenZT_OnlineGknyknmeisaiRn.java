...
/**
 * オンライン外貨入出金明細テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_OnlineGknyknmeisaiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_OnlineGknyknmeisaiRn}</td><td colspan="3">オンライン外貨入出金明細テーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrnsakuseiymd zrnsakuseiymd}</td><td>（連携用）作成日</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnrenrakuymd zrnrenrakuymd}</td><td>（連携用）連絡日</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnrenrakukaisuu zrnrenrakukaisuu}</td><td>（連携用）連絡回数</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnbankcd zrnbankcd}</td><td>（連携用）銀行番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnshitencd zrnshitencd}</td><td>（連携用）支店番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsitennmej zrnsitennmej}</td><td>（連携用）支店名（英字）</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyokinkbn zrnyokinkbn}</td><td>（連携用）預金種目区分</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkouzano zrnkouzano}</td><td>（連携用）口座番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkznmej zrnkznmej}</td><td>（連携用）口座名（英字）</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnzndktuukasyu zrnzndktuukasyu}</td><td>（連携用）残高通貨種類</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnsyorino1 zrnsyorino1}</td><td>（連携用）処理通番１</td><td align="center">{@link PKZT_OnlineGknyknmeisaiRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_OnlineGknyknmeisaiRn
 * @see     PKZT_OnlineGknyknmeisaiRn
 * @see     QZT_OnlineGknyknmeisaiRn
 * @see     GenQZT_OnlineGknyknmeisaiRn
 */
@MappedSuperclass
@Table(name=GenZT_OnlineGknyknmeisaiRn.TABLE_NAME)
@IdClass(value=PKZT_OnlineGknyknmeisaiRn.class)
public abstract class GenZT_OnlineGknyknmeisaiRn extends AbstractExDBEntityForZDB<ZT_OnlineGknyknmeisaiRn, PKZT_OnlineGknyknmeisaiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_OnlineGknyknmeisaiRn";
    ...
    private final PKZT_OnlineGknyknmeisaiRn primaryKey;

    public GenZT_OnlineGknyknmeisaiRn() {
        primaryKey = new PKZT_OnlineGknyknmeisaiRn();
    }
    ...
    @Transient
    @Override
    public PKZT_OnlineGknyknmeisaiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_OnlineGknyknmeisaiRn> getMetaClass() {
        return QZT_OnlineGknyknmeisaiRn.class;
    }

    private String zrndatakbn1;

    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSYUBETUCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNCDKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSAKUSEIYMD)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNRENRAKUYMD)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNRENRAKUKAISUU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKNJYYMDFROM)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKNJYYMDTO)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNBANKCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNBANKNMEJ)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSITENCDTORI)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSITENNMEJTORI)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSHITENCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSITENNMEJ)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNYOKINKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKOUZANO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKZNMEJ)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNZNDKTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNZNDKSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNGKTRHKMAEZNDK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKASIKOSIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNYOBIV86)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKBN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKOUSEI)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSYORINO1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKNJYYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKSNYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNIRIBARAIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTRHKKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTRHKTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTRHKSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNGKTRHKGK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNBANKSYOUKAINO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTRHKSYOUKAINO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTEKIYOUNAIYOUEJ)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNYOBIV103)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKBN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTKOUSEIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNTRKSCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSYORINO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNBANKSYOUKAINO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSIMUKEYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSETUJYUYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSOUKINSYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNVALUEYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSKNTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNSKNSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNGKSOUKINGK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNIRNINNM)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNYOBIV40)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN4)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKBN3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDSUU1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDNO1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENSUU1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENKETA1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHEN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN5)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKBN4)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDSUU2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDNO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENSUU2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENKETA2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHEN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDATAKBN6)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDTRECORDKBN5)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDSUU3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNDOURECORDNO3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENSUU3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHENKETA3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiRn.ZRNKAHEN3)
