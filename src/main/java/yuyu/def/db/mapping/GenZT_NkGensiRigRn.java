...
/**
 * 年金原資Ｆ例月用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkGensiRigRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkGensiRigRn}</td><td colspan="3">年金原資Ｆ例月用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_NkGensiRigRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkGensiRigRn.TABLE_NAME)
@IdClass(value=PKZT_NkGensiRigRn.class)
public abstract class GenZT_NkGensiRigRn extends AbstractExDBEntityForZDB<ZT_NkGensiRigRn, PKZT_NkGensiRigRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkGensiRigRn";
    ...
    private final PKZT_NkGensiRigRn primaryKey;

    public GenZT_NkGensiRigRn() {
        primaryKey = new PKZT_NkGensiRigRn();
    }

    public GenZT_NkGensiRigRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_NkGensiRigRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_NkGensiRigRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkGensiRigRn> getMetaClass() {
        return QZT_NkGensiRigRn.class;
    }

    @Id
    @Column(name=GenZT_NkGensiRigRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSYSTEMCD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNULFKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNIDOUYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSYOUIN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINSYU)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNCURRENTDAY)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNCURRENTTIME)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINGENSINO)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINGENSINAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNKKIKINGK)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNGENSINAIYOUKIHONNKGK)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNEWMONEYGAKU)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNNENKINGENSIHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNDKEISANYOUNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiRigRn.ZRNKGYNKYOUZEISEITKKAKSJGNS)
