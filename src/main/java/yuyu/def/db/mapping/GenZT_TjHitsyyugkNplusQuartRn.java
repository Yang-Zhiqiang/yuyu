...
/**
 * 通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusQuartRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusQuartRn}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusQuartRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusQuartRn
 * @see     PKZT_TjHitsyyugkNplusQuartRn
 * @see     QZT_TjHitsyyugkNplusQuartRn
 * @see     GenQZT_TjHitsyyugkNplusQuartRn
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusQuartRn.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusQuartRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusQuartRn extends AbstractExDBEntityForZDB<ZT_TjHitsyyugkNplusQuartRn, PKZT_TjHitsyyugkNplusQuartRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusQuartRn";
    ...
    private final PKZT_TjHitsyyugkNplusQuartRn primaryKey;

    public GenZT_TjHitsyyugkNplusQuartRn() {
        primaryKey = new PKZT_TjHitsyyugkNplusQuartRn();
    }

    public GenZT_TjHitsyyugkNplusQuartRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusQuartRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusQuartRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusQuartRn> getMetaClass() {
        return QZT_TjHitsyyugkNplusQuartRn.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartRn.ZRNTOKUYAKUKOUMOKUV180X50)
