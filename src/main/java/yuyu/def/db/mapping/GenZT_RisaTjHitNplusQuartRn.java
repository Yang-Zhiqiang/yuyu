...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RisaTjHitNplusQuartRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RisaTjHitNplusQuartRn}</td><td colspan="3">利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_RisaTjHitNplusQuartRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_RisaTjHitNplusQuartRn
 * @see     PKZT_RisaTjHitNplusQuartRn
 * @see     QZT_RisaTjHitNplusQuartRn
 * @see     GenQZT_RisaTjHitNplusQuartRn
 */
@MappedSuperclass
@Table(name=GenZT_RisaTjHitNplusQuartRn.TABLE_NAME)
@IdClass(value=PKZT_RisaTjHitNplusQuartRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RisaTjHitNplusQuartRn extends AbstractExDBEntityForZDB<ZT_RisaTjHitNplusQuartRn, PKZT_RisaTjHitNplusQuartRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RisaTjHitNplusQuartRn";
    ...
    private final PKZT_RisaTjHitNplusQuartRn primaryKey;

    public GenZT_RisaTjHitNplusQuartRn() {
        primaryKey = new PKZT_RisaTjHitNplusQuartRn();
    }

    public GenZT_RisaTjHitNplusQuartRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_RisaTjHitNplusQuartRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_RisaTjHitNplusQuartRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RisaTjHitNplusQuartRn> getMetaClass() {
        return QZT_RisaTjHitNplusQuartRn.class;
    }

    @Id
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNERRKBNV1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKEIYAKUNENDO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKEIYAKUM)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRN5NENMEOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSAISITUTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYUUKOUTYUUSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSYOUMETUYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSYOUMETUYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTENKANYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTENKANYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTUUJYOUDSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTUUJYOUDSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUHRKBBNKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUHRKBBNKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUHRKBBNKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUHRKBBNKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTNKNHKTGKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTNKNHKTGKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTNKNHKTGKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUTNKNHKTGKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSAISITUKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSAISITUKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSAISITUKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSAISITUKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHRKBBNKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHRKBBNKDTISYUNNKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUSANGOHRKBBNKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNHKTGKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNHKTGKDTISYUNENKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUSANGOTNKNHKTGKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUUSANGOHUTUUSIBOUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSAISITUKAPPADSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUUSANGOSAISITUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSISTKAPPADTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUUSANGOGOUKEIKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNDTAISYOUV)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSYUSISTKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSYUSISTKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSYUSISTKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTNKNYUSYUSISTKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSYUSISTKAPPADSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSYUSISTKDTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSAIMNKKYKHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNGKDTYKNNDSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNGKDTYKYKNNDSYOYOUGAKUYOU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNDKEISANJIKWSRATE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNDKEISANJIKWSRATETKYYMD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV6X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X12)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X13)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X14)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X15)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X16)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X17)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X18)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X19)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X20)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X21)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X22)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X23)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X24)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X25)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X26)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X27)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X28)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X29)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X30)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X31)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X32)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X33)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X34)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X35)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X36)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X37)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X38)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X39)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartRn.ZRNTOKUYAKUKOUMOKUV120X40)
