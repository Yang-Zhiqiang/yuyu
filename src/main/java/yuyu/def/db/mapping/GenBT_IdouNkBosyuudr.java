...
import yuyu.def.db.id.PKBT_IdouNkBosyuudr;
...
/**
 * 異動年金支払募集代理店テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouNkBosyuudr} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_IdouNkBosyuudr}</td><td colspan="3">異動年金支払募集代理店テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getNksysyno nksysyno}</td><td>年金証書番号</td><td align="center">{@link PKBT_IdouNkBosyuudr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouNkBosyuudr ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKBT_IdouNkBosyuudr
 * @see     QBT_IdouNkBosyuudr
 * @see     GenQBT_IdouNkBosyuudr
 */
@MappedSuperclass
@Table(name=GenBT_IdouNkBosyuudr.TABLE_NAME)
@IdClass(value=PKBT_IdouNkBosyuudr.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBT_IdouNkBosyuudr extends AbstractExDBEntity<BT_IdouNkBosyuudr, PKBT_IdouNkBosyuudr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouNkBosyuudr";
    ...
    private final PKBT_IdouNkBosyuudr primaryKey;

    public GenBT_IdouNkBosyuudr() {
        primaryKey = new PKBT_IdouNkBosyuudr();
    }

    public GenBT_IdouNkBosyuudr(String pNksysyno, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouNkBosyuudr(pNksysyno, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouNkBosyuudr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouNkBosyuudr> getMetaClass() {
        return QBT_IdouNkBosyuudr.class;
    }

    @Id
    @Column(name=GenBT_IdouNkBosyuudr.NKSYSYNO)
    @NenkinSyousyoNo
    ...
    @Id
    @Column(name=GenBT_IdouNkBosyuudr.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouNkBosyuudr.DAIRITENCD1)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenBT_IdouNkBosyuudr.BUNWARI1)
    ...
    @Column(name=GenBT_IdouNkBosyuudr.DAIRITENCD2)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBT_IdouNkBosyuudr.BUNWARI2)
    ...
    @Column(name=GenBT_IdouNkBosyuudr.KANRISOSIKICD1)
    ...
    @Column(name=GenBT_IdouNkBosyuudr.KANRISOSIKICD2)
