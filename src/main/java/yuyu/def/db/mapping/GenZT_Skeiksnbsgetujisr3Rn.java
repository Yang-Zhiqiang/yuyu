...
/**
 * 新契約決算ベース月次成立Ｆテーブル３（連） テーブルのマッピング情報クラスで、 {@link ZT_Skeiksnbsgetujisr3Rn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_Skeiksnbsgetujisr3Rn}</td><td colspan="3">新契約決算ベース月次成立Ｆテーブル３（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrnktgysyono zrnktgysyono}</td><td>（連携用）結合用証券番号</td><td align="center">{@link PKZT_Skeiksnbsgetujisr3Rn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_Skeiksnbsgetujisr3Rn
 * @see     PKZT_Skeiksnbsgetujisr3Rn
 * @see     QZT_Skeiksnbsgetujisr3Rn
 * @see     GenQZT_Skeiksnbsgetujisr3Rn
 */
@MappedSuperclass
@Table(name=GenZT_Skeiksnbsgetujisr3Rn.TABLE_NAME)
@IdClass(value=PKZT_Skeiksnbsgetujisr3Rn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Skeiksnbsgetujisr3Rn extends AbstractExDBEntityForZDB<ZT_Skeiksnbsgetujisr3Rn, PKZT_Skeiksnbsgetujisr3Rn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Skeiksnbsgetujisr3Rn";
    ...
    private final PKZT_Skeiksnbsgetujisr3Rn primaryKey;

    public GenZT_Skeiksnbsgetujisr3Rn() {
        primaryKey = new PKZT_Skeiksnbsgetujisr3Rn();
    }

    public GenZT_Skeiksnbsgetujisr3Rn(String pZrnktgysyono) {
        primaryKey = new PKZT_Skeiksnbsgetujisr3Rn(pZrnktgysyono);
    }

    @Transient
    @Override
    public PKZT_Skeiksnbsgetujisr3Rn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Skeiksnbsgetujisr3Rn> getMetaClass() {
        return QZT_Skeiksnbsgetujisr3Rn.class;
    }

    private String zrnktgysyrymd;

    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKTGYSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKTGYFILERENNO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBOSYUUKEIROKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSYOKAIPCASHLESSNYUKINHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKIGKYHSITIHSYUTKYKARIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSYOKAIPSWINGRIYOUKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBOSYUUDAIRITENGYOUSYUKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNCIFCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNTOKUSYUJIMUTORIATUKAIKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNPMENTKYKYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNPMENTKYKYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNPMENTKYKYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNPMENTKYKYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHSYUIKKTMNOSDFNYUKNHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNIKKTMNOSKIKIYUTKYKP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNIKKTMNOSKIKIYUFNDSISTP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKANYUJISYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKSNYUHSYUIKKTMINOSNNSKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNAATUKAISYADIRTNBSYNNHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBATKISYADIRTNBOSYUNINHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNDIRTNAATUKAISYAKOJINCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNDIRTNBATUKAISYAKOJINCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSYUUSEISYOUKEIKANENSUU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSYURUIHNKUTKBTTRTKHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKTKYKHKJYUTIKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNTNKNSYOKAIPCLESSRIYOUHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHRKTEISIKIBOUHYOUJI)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBUNKATUGOSONZOKUKEIYAKUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNMOSKIZKPHRKEKNGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNKEIZOKUPHURIKAEJIJIKAIP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBUNKATUMAEKEIYAKUKIHONS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBUNKATUMAEKEIYAKUSIBOUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKMODS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKSIGIWRMSTKYKS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKSYUGITKYKS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMKYKSIGINYINTKYKNTGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKKNKUTKYKNTGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKHNTIYUNBRIKNSNP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNDAI2NAIBUWARIMODOSIGAKU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNTNKNGKYKKSTKGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNBNKTMEKYKKSTKGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNSONZOKUKYKKASITUKEGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHNGKMNRYOUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX1X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX2X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX3X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX4X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX5X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX1X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX2X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX3X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX4X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX5X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX1X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX2X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX3X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX4X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX5X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX1X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX2X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX3X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX4X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX5X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX1X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX2X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYBX3X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr3Rn.ZRNHTNKNKIGMRSYUKGUYB