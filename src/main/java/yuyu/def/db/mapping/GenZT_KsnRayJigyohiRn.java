...
/**
 * 決算計上用ＲＡＹ事業費Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_KsnRayJigyohiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KsnRayJigyohiRn}</td><td colspan="3">決算計上用ＲＡＹ事業費Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_KsnRayJigyohiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_KsnRayJigyohiRn
 * @see     PKZT_KsnRayJigyohiRn
 * @see     QZT_KsnRayJigyohiRn
 * @see     GenQZT_KsnRayJigyohiRn
 */
@MappedSuperclass
@Table(name=GenZT_KsnRayJigyohiRn.TABLE_NAME)
@IdClass(value=PKZT_KsnRayJigyohiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KsnRayJigyohiRn extends AbstractExDBEntityForZDB<ZT_KsnRayJigyohiRn, PKZT_KsnRayJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KsnRayJigyohiRn";
    ...
    private final PKZT_KsnRayJigyohiRn primaryKey;

    public GenZT_KsnRayJigyohiRn() {
        primaryKey = new PKZT_KsnRayJigyohiRn();
    }

    public GenZT_KsnRayJigyohiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_KsnRayJigyohiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_KsnRayJigyohiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KsnRayJigyohiRn> getMetaClass() {
        return QZT_KsnRayJigyohiRn.class;
    }

    @Id
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNLOADINGKEIJYOYM)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSIHANKIKSNYDATAHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNGMKIJYHYJ)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV20)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X18)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREILKISNYUKNGKX1)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREILKISNYUKNGKX2)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNRPKEISANYOUSIBOUS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIKENS)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREIALPHA)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREIBETA)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIKENP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNVHIREILRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNKIKENPRITU)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNTUMIMASIMAEW)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KsnRayJigyohiRn.ZRNYOBIV19)
