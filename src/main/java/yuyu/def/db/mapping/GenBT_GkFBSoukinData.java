...
import yuyu.def.db.id.PKBT_GkFBSoukinData;
import yuyu.def.db.meta.GenQBT_GkFBSoukinData;
...
/**
 * 外貨ＦＢ送金データテーブル テーブルのマッピング情報クラスで、 {@link BT_GkFBSoukinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_GkFBSoukinData}</td><td colspan="3">外貨ＦＢ送金データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getFbsoukindatasikibetukey fbsoukindatasikibetukey}</td><td>ＦＢ送金データ識別キー</td><td align="center">{@link PKBT_GkFBSoukinData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     BT_GkFBSoukinData
 * @see     PKBT_GkFBSoukinData
 * @see     QBT_GkFBSoukinData
 * @see     GenQBT_GkFBSoukinData
 */
@MappedSuperclass
@Table(name=GenBT_GkFBSoukinData.TABLE_NAME)
@IdClass(value=PKBT_GkFBSoukinData.class)
@TypeDefs({
...
public abstract class GenBT_GkFBSoukinData extends AbstractExDBEntity<BT_GkFBSoukinData, PKBT_GkFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_GkFBSoukinData";
    ...
    private final PKBT_GkFBSoukinData primaryKey;

    public GenBT_GkFBSoukinData() {
        primaryKey = new PKBT_GkFBSoukinData();
    }

    public GenBT_GkFBSoukinData(String pFbsoukindatasikibetukey) {
        primaryKey = new PKBT_GkFBSoukinData(pFbsoukindatasikibetukey);
    }

    @Transient
    @Override
    public PKBT_GkFBSoukinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_GkFBSoukinData> getMetaClass() {
        return QBT_GkFBSoukinData.class;
    }

    @Id
    @Column(name=GenBT_GkFBSoukinData.FBSOUKINDATASIKIBETUKEY)
    ...
    @Column(name=GenBT_GkFBSoukinData.DENRENNO)
    ...
    @Column(name=GenBT_GkFBSoukinData.EDANO)
    ...
    @Column(name=GenBT_GkFBSoukinData.DENSYSKBN)
    ...
    @Column(name=GenBT_GkFBSoukinData.GKGYOUMUCD)
    ...
    @Column(name=GenBT_GkFBSoukinData.TANTOSITUCD)
    ...
    @Column(name=GenBT_GkFBSoukinData.SYORICD)
    ...
    @Column(name=GenBT_GkFBSoukinData.SYORISOSIKICD)
    ...
    @Column(name=GenBT_GkFBSoukinData.SYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_GkFBSoukinData.DENYMD)
    ...
    @Column(name=GenBT_GkFBSoukinData.KEIRISYONO)
    ...
    @Column(name=GenBT_GkFBSoukinData.SHRHOUSITEIKBN)
    ...
    @Column(name=GenBT_GkFBSoukinData.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenBT_GkFBSoukinData.BANKNMEJ)
    ...
    @Column(name=GenBT_GkFBSoukinData.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBT_GkFBSoukinData.SITENNMEJ)
    ...
    @Column(name=GenBT_GkFBSoukinData.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenBT_GkFBSoukinData.KZMEIGINMEI)
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_GkFBSoukinData.SHRTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenBT_GkFBSoukinData.KYKTUUKASYU)
    ...
    @Column(name=GenBT_GkFBSoukinData.SOUKINKWSRATE)
    ...
    @Column(name=GenBT_GkFBSoukinData.IRNINNMEI)
