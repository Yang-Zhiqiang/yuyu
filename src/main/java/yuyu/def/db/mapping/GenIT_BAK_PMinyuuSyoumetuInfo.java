...
import yuyu.def.db.id.PKIT_BAK_PMinyuuSyoumetuInfo;
...
/**
 * Ｐ未入消滅情報バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_PMinyuuSyoumetuInfo} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_PMinyuuSyoumetuInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_PMinyuuSyoumetuInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_PMinyuuSyoumetuInfo ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_PMinyuuSyoumetuInfo
 * @see     QIT_BAK_PMinyuuSyoumetuInfo
 * @see     GenQIT_BAK_PMinyuuSyoumetuInfo
 */
@MappedSuperclass
@Table(name=GenIT_BAK_PMinyuuSyoumetuInfo.TABLE_NAME)
@IdClass(value=PKIT_BAK_PMinyuuSyoumetuInfo.class)
@TypeDefs({
...
public abstract class GenIT_BAK_PMinyuuSyoumetuInfo extends AbstractExDBEntity<IT_BAK_PMinyuuSyoumetuInfo, PKIT_BAK_PMinyuuSyoumetuInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_PMinyuuSyoumetuInfo";
    ...
    private final PKIT_BAK_PMinyuuSyoumetuInfo primaryKey;

    public GenIT_BAK_PMinyuuSyoumetuInfo() {
        primaryKey = new PKIT_BAK_PMinyuuSyoumetuInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_PMinyuuSyoumetuInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_PMinyuuSyoumetuInfo> getMetaClass() {
        return QIT_BAK_PMinyuuSyoumetuInfo.class;
    }

    @Id
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SYORIYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SYOUMETUYMD)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.JIDOUSOUKINHUKARIYUU)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.TTDKTYUUIHANTEIKEKKA)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.STKNSETKBN)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SHRTUUKASYU)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.SHRKWSRATE)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_PMinyuuSyoumetuInfo.GYOUMUKOUSINTIME)
