...
/**
 * 年金配当所要額Ｆ期中報告用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkHitKtyRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkHitKtyRn}</td><td colspan="3">年金配当所要額Ｆ期中報告用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnnksyousyono zrnnksyousyono}</td><td>（連携用）年金証書番号</td><td align="center">{@link PKZT_NkHitKtyRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkHitKtyRn.TABLE_NAME)
@IdClass(value=PKZT_NkHitKtyRn.class)
public abstract class GenZT_NkHitKtyRn extends AbstractExDBEntityForZDB<ZT_NkHitKtyRn, PKZT_NkHitKtyRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkHitKtyRn";
    ...
    private final PKZT_NkHitKtyRn primaryKey;

    public GenZT_NkHitKtyRn() {
        primaryKey = new PKZT_NkHitKtyRn();
    }

    public GenZT_NkHitKtyRn(String pZrnnksyousyono) {
        primaryKey = new PKZT_NkHitKtyRn(pZrnnksyousyono);
    }

    @Transient
    @Override
    public PKZT_NkHitKtyRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkHitKtyRn> getMetaClass() {
        return QZT_NkHitKtyRn.class;
    }

    @Id
    @Column(name=GenZT_NkHitKtyRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNNENKINTYPEKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNNENKINITIJISIHARAINENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNMANRYOUKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKEIYAKUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNSEIZONKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOTEIRIRITUN5)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRN5NNGT3NNGTOUTUBKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV7)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV15)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNGYOUSEKIHYOUJISIBOUS)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYUUKOUTYUUSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNSYOUMETUJISYOYOUGAKUYOU1)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNSYOUMETUJISYOYOUGAKUYOU2)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNRISADTAISYOUV)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNNKNENGK)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNSYUKEIYAKUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKAIMASINENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV8)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV38)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKEISANKIJYUNYMD)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTOUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOKUYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTOUNENDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYKNNDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNZNNNDSEISIKIWRATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTOUNENDODHANEIZUMIHYOUJI)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTOUNENDOOUTOUBIJITEND)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTUNNDOUTUBIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTUNNDMTIKUYKNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYKNNDOUTUBIKOUYKNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNZNNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKTYUMTIKUTUNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNTUNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNKTYUMTIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_NkHitKtyRn.ZRNYOBIV16)
