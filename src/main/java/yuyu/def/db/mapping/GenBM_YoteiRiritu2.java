...
/**
 * 予定利率マスタ２ テーブルのマッピング情報クラスで、 {@link BM_YoteiRiritu2} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_YoteiRiritu2}</td><td colspan="3">予定利率マスタ２</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKBM_YoteiRiritu2 ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getYoteiriritutkybr1 yoteiriritutkybr1}</td><td>予定利率適用分類１</td><td align="center">{@link PKBM_YoteiRiritu2 ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getYoteiriritutkybr2 yoteiriritutkybr2}</td><td>予定利率適用分類２</td><td align="center">{@link PKBM_YoteiRiritu2 ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getKijyunfromymd kijyunfromymd}</td><td>基準日自</td><td align="center">{@link PKBM_YoteiRiritu2 ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getKijyuntoymd kijyuntoymd}</td><td>基準日至</td><td align="center">{@link PKBM_YoteiRiritu2 ○}</td><td align="center">V</td><td>BizDate</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBM_YoteiRiritu2.TABLE_NAME)
@IdClass(value=PKBM_YoteiRiritu2.class)
@TypeDefs({
    @TypeDef(name="BizDateType", typeClass=BizDateType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class),
    @TypeDef(name="UserType_C_Tuukasyu", typeClass=UserType_C_Tuukasyu.class)
})
public abstract class GenBM_YoteiRiritu2 extends AbstractExDBEntity<BM_YoteiRiritu2, PKBM_YoteiRiritu2> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_YoteiRiritu2";
    ...
    private final PKBM_YoteiRiritu2 primaryKey;

    public GenBM_YoteiRiritu2() {
        primaryKey = new PKBM_YoteiRiritu2();
    }
    ...
    @Transient
    @Override
    public PKBM_YoteiRiritu2 getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_YoteiRiritu2> getMetaClass() {
        return QBM_YoteiRiritu2.class;
    }

    @Id
    @Column(name=GenBM_YoteiRiritu2.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenBM_YoteiRiritu2.YOTEIRIRITUTKYBR1)
    ...
    @Id
    @Column(name=GenBM_YoteiRiritu2.YOTEIRIRITUTKYBR2)
    ...
    @Column(name=GenBM_YoteiRiritu2.KIJYUNFROMYMD)
    ...
    @Id
    @Type(type="BizDateType")
    @Column(name=GenBM_YoteiRiritu2.KIJYUNTOYMD)
    ...
    @Column(name=GenBM_YoteiRiritu2.TUUKASYU)
    ...
    @Column(name=GenBM_YoteiRiritu2.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_YoteiRiritu2.TUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_YoteiRiritu2.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_YoteiRiritu2.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_YoteiRiritu2.LOADINGHNKGTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_YoteiRiritu2.RENDOURITU)
