...
import yuyu.def.db.id.PKIT_BAK_TrkKzk;
...
/**
 * 登録家族バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_TrkKzk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_TrkKzk}</td><td colspan="3">登録家族バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_TrkKzk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_TrkKzk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_TrkKzk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkkzkkbn trkkzkkbn}</td><td>登録家族区分</td><td align="center">{@link PKIT_BAK_TrkKzk ○}</td><td align="center">V</td><td>{@link C_TrkKzkKbn}</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_BAK_TrkKzk.TABLE_NAME)
@IdClass(value=PKIT_BAK_TrkKzk.class)
@TypeDefs({
...
public abstract class GenIT_BAK_TrkKzk extends AbstractExDBEntity<IT_BAK_TrkKzk, PKIT_BAK_TrkKzk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_TrkKzk";
    ...
    private final PKIT_BAK_TrkKzk primaryKey;

    public GenIT_BAK_TrkKzk() {
        primaryKey = new PKIT_BAK_TrkKzk();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_TrkKzk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_TrkKzk> getMetaClass() {
        return QIT_BAK_TrkKzk.class;
    }

    @Id
    @Column(name=GenIT_BAK_TrkKzk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_TrkKzk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_TrkKzk.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKKBN)
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKSETTEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKSEI)
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKTDK)
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_BAK_TrkKzk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_TrkKzk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_TrkKzk.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_TrkKzk.TRKKZKTSINDOUSITEIKBN)
