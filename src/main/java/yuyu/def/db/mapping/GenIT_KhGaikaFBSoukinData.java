...
import yuyu.def.db.id.PKIT_KhGaikaFBSoukinData;
import yuyu.def.db.meta.GenQIT_KhGaikaFBSoukinData;
...
/**
 * 契約保全外貨ＦＢ送金データテーブル テーブルのマッピング情報クラスで、 {@link IT_KhGaikaFBSoukinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhGaikaFBSoukinData}</td><td colspan="3">契約保全外貨ＦＢ送金データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getFbsoukindatasikibetukey fbsoukindatasikibetukey}</td><td>ＦＢ送金データ識別キー</td><td align="center">{@link PKIT_KhGaikaFBSoukinData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KhGaikaFBSoukinData
 * @see     PKIT_KhGaikaFBSoukinData
 * @see     QIT_KhGaikaFBSoukinData
 * @see     GenQIT_KhGaikaFBSoukinData
 */
@MappedSuperclass
@Table(name=GenIT_KhGaikaFBSoukinData.TABLE_NAME)
@IdClass(value=PKIT_KhGaikaFBSoukinData.class)
@TypeDefs({
...
public abstract class GenIT_KhGaikaFBSoukinData extends AbstractExDBEntity<IT_KhGaikaFBSoukinData, PKIT_KhGaikaFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhGaikaFBSoukinData";
    ...
    private final PKIT_KhGaikaFBSoukinData primaryKey;

    public GenIT_KhGaikaFBSoukinData() {
        primaryKey = new PKIT_KhGaikaFBSoukinData();
    }

    public GenIT_KhGaikaFBSoukinData(String pFbsoukindatasikibetukey) {
        primaryKey = new PKIT_KhGaikaFBSoukinData(pFbsoukindatasikibetukey);
    }

    @Transient
    @Override
    public PKIT_KhGaikaFBSoukinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhGaikaFBSoukinData> getMetaClass() {
        return QIT_KhGaikaFBSoukinData.class;
    }

    @Id
    @Column(name=GenIT_KhGaikaFBSoukinData.FBSOUKINDATASIKIBETUKEY)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.DENRENNO)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.EDANO)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.DENSYSKBN)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.GKGYOUMUCD)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.TANTOSITUCD)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SYORICD)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SYORISOSIKICD)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhGaikaFBSoukinData.DENYMD)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.BANKNMEJ)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SITENNMEJ)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.KZMEIGINMEI)
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SHRTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_KhGaikaFBSoukinData.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.SOUKINKWSRATE)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.IRNINNMEI)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhGaikaFBSoukinData.GYOUMUKOUSINTIME)
