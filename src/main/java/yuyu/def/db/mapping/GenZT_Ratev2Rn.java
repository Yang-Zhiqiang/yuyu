...
/**
 * Ｖレートテーブル２（連） テーブルのマッピング情報クラスで、 {@link ZT_Ratev2Rn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_Ratev2Rn}</td><td colspan="3">Ｖレートテーブル２（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnhknsyukigou zrnhknsyukigou}</td><td>（連携用）保険種類記号</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhknsyuruikigousedaikbn zrnhknsyuruikigousedaikbn}</td><td>（連携用）保険種類記号世代区分</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyoteiriritu zrnyoteiriritu}</td><td>（連携用）予定利率</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnpmenkbn zrnpmenkbn}</td><td>（連携用）Ｐ免区分</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhrkkaisuukbn zrnhrkkaisuukbn}</td><td>（連携用）払込回数区分</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhhknsei zrnhhknsei}</td><td>（連携用）被保険者性別</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkeiyakujihhknnen zrnkeiyakujihhknnen}</td><td>（連携用）契約時被保険者年令</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsaimnkkykhyj zrnsaimnkkykhyj}</td><td>（連携用）才満期契約表示</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhknkkn zrnhknkkn}</td><td>（連携用）保険期間</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnphrkkikn zrnphrkkikn}</td><td>（連携用）Ｐ払込期間</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnannaifuyouriyuukbn zrnannaifuyouriyuukbn}</td><td>（連携用）案内不要理由区分</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntuukasyukbn zrntuukasyukbn}</td><td>（連携用）通貨種類区分</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrndai1hknkkn zrndai1hknkkn}</td><td>（連携用）第１保険期間</td><td align="center">{@link PKZT_Ratev2Rn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_Ratev2Rn.TABLE_NAME)
@IdClass(value=PKZT_Ratev2Rn.class)
public abstract class GenZT_Ratev2Rn extends AbstractExDBEntityForZDB<ZT_Ratev2Rn, PKZT_Ratev2Rn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Ratev2Rn";
    ...
    private final PKZT_Ratev2Rn primaryKey;

    public GenZT_Ratev2Rn() {
        primaryKey = new PKZT_Ratev2Rn();
    }
    ...
    @Transient
    @Override
    public PKZT_Ratev2Rn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Ratev2Rn> getMetaClass() {
        return QZT_Ratev2Rn.class;
    }

    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNHKNSYUKIGOU)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNYOTEIRIRITU)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNPMENKBN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNHRKKAISUUKBN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNHHKNSEI)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNKEIYAKUJIHHKNNEN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNSAIMNKKYKHYJ)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNHKNKKN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNPHRKKIKN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNTUUKASYUKBN)
    ...
    @Id
    @Column(name=GenZT_Ratev2Rn.ZRNDAI1HKNKKN)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE00)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE01)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE02)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE03)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE04)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE05)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE06)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE07)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE08)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE09)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE10)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE11)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE12)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE13)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE14)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE15)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE16)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE17)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE18)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE19)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE20)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE21)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE22)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE23)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE24)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE25)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE26)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE27)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE28)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE29)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE30)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE31)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE32)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE33)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE34)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE35)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE36)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE37)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE38)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE39)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE40)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE41)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE42)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE43)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE44)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE45)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE46)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE47)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE48)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE49)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE50)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE51)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE52)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE53)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE54)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE55)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE56)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE57)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE58)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE59)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE60)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE61)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE62)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE63)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE64)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE65)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE66)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE67)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE68)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE69)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE70)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE71)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE72)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE73)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE74)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE75)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE76)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE77)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE78)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE79)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE80)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE81)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE82)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE83)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE84)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE85)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE86)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE87)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE88)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE89)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE90)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE91)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE92)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE93)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE94)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE95)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE96)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE97)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE98)
    ...
    @Column(name=GenZT_Ratev2Rn.ZRNVRATE99)
