...
import yuyu.def.db.id.PKIT_BAK_Azukarikin;
...
/**
 * 預り金バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_Azukarikin} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_Azukarikin}</td><td colspan="3">預り金バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_Azukarikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_Azukarikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_Azukarikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_Azukarikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTuukasyu tuukasyu}</td><td>通貨種類</td><td align="center">{@link PKIT_BAK_Azukarikin ○}</td><td align="center">V</td><td>{@link C_Tuukasyu}</td></tr>
 ...
 * @see     PKIT_BAK_Azukarikin
 * @see     QIT_BAK_Azukarikin
 * @see     GenQIT_BAK_Azukarikin
 */
@MappedSuperclass
@Table(name=GenIT_BAK_Azukarikin.TABLE_NAME)
@IdClass(value=PKIT_BAK_Azukarikin.class)
@TypeDefs({
...
public abstract class GenIT_BAK_Azukarikin extends AbstractExDBEntity<IT_BAK_Azukarikin, PKIT_BAK_Azukarikin> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_Azukarikin";
    ...
    private final PKIT_BAK_Azukarikin primaryKey;

    public GenIT_BAK_Azukarikin() {
        primaryKey = new PKIT_BAK_Azukarikin();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_Azukarikin getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_Azukarikin> getMetaClass() {
        return QIT_BAK_Azukarikin.class;
    }

    @Id
    @Column(name=GenIT_BAK_Azukarikin.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_Azukarikin.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_Azukarikin.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_Azukarikin.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_Azukarikin.TUUKASYU)
    ...
    @Column(name=GenIT_BAK_Azukarikin.AZUKARIKINSYURUIKBN)
    ...
    @Column(name=GenIT_BAK_Azukarikin.SHRYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Azukarikin.SHRSYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Azukarikin.AZUKARIKINHSIYMD)
    ...
    @Column(name=GenIT_BAK_Azukarikin.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_Azukarikin.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_Azukarikin.GYOUMUKOUSINTIME)
