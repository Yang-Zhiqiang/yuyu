...
/**
 * 年金統計Ｆ期中報告用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkToukeiKtyRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkToukeiKtyRn}</td><td colspan="3">年金統計Ｆ期中報告用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_NkToukeiKtyRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_NkToukeiKtyRn
 * @see     PKZT_NkToukeiKtyRn
 * @see     QZT_NkToukeiKtyRn
 * @see     GenQZT_NkToukeiKtyRn
 */
@MappedSuperclass
@Table(name=GenZT_NkToukeiKtyRn.TABLE_NAME)
@IdClass(value=PKZT_NkToukeiKtyRn.class)
public abstract class GenZT_NkToukeiKtyRn extends AbstractExDBEntityForZDB<ZT_NkToukeiKtyRn, PKZT_NkToukeiKtyRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkToukeiKtyRn";
    ...
    private final PKZT_NkToukeiKtyRn primaryKey;

    public GenZT_NkToukeiKtyRn() {
        primaryKey = new PKZT_NkToukeiKtyRn();
    }

    public GenZT_NkToukeiKtyRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_NkToukeiKtyRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_NkToukeiKtyRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkToukeiKtyRn> getMetaClass() {
        return QZT_NkToukeiKtyRn.class;
    }

    @Id
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYSTEMCD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNULFKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNIDOUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOUIN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINSYU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNCURRENTDAY)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNCURRENTTIME)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKASANNKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKKNSETYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTEIZOURITU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNDKIGETU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUNENDOD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSIHARAIUKETUKEBASYO)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSHIHARAIHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV8)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV1X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV8X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV8X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV59)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNYOBIV17)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINKKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINENKINSYURUIKIGOU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINKSHRKKN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINKHHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKIMSNKDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNSAISYUUNENKINKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZENNENDOKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZNZNNNDKAIMASINKZOUGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZNZNZNNNDKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUNENDOKAIMASINENKIND)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASITYUUSIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASIHUKKIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNKAIMASINKKIGOUSDKBN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMAEATUATOATUKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMAEATUATOATUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNMAEATUATOATUHENDOUGONKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNATOATUSAISYUUKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNATOATUKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNZNZNZNNNDATATKIMSNKGK)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNTOUNENDATOATUKAIMASINKD)
    ...
    @Column(name=GenZT_NkToukeiKtyRn.ZRNUWANOSEATOATUKAIMASINKGK)
