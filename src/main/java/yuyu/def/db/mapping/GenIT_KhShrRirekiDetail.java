...
import yuyu.def.db.id.PKIT_KhShrRirekiDetail;
import yuyu.def.db.meta.GenQIT_KhShrRirekiDetail;
import yuyu.def.db.meta.QIT_KhShrRirekiDetail;
import yuyu.infr.validation.constraints.SyoukenNo;

/**
 * 契約保全支払履歴明細テーブル テーブルのマッピング情報クラスで、 {@link IT_KhShrRirekiDetail} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhShrRirekiDetail}</td><td colspan="3">契約保全支払履歴明細テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_KhShrRirekiDetail ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_KhShrRirekiDetail
 * @see     PKIT_KhShrRirekiDetail
 * @see     QIT_KhShrRirekiDetail
 * @see     GenQIT_KhShrRirekiDetail
 */
@MappedSuperclass
@Table(name=GenIT_KhShrRirekiDetail.TABLE_NAME)
@IdClass(value=PKIT_KhShrRirekiDetail.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenIT_KhShrRirekiDetail extends AbstractExDBEntity<IT_KhShrRirekiDetail, PKIT_KhShrRirekiDetail> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhShrRirekiDetail";
    ...
    private final PKIT_KhShrRirekiDetail primaryKey;

    public GenIT_KhShrRirekiDetail() {
        primaryKey = new PKIT_KhShrRirekiDetail();
    }
    ...
    @Transient
    @Override
    public PKIT_KhShrRirekiDetail getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhShrRirekiDetail> getMetaClass() {
        return QIT_KhShrRirekiDetail.class;
    }

    @Id
    @Column(name=GenIT_KhShrRirekiDetail.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhShrRirekiDetail.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhShrRirekiDetail.HENKOUSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_KhShrRirekiDetail.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_KhShrRirekiDetail.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_KhShrRirekiDetail.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_KhShrRirekiDetail.KAIYAKUSJKKKTYOUSEIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhShrRirekiDetail.KAIYAKUSJKKKTYOUSEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhShrRirekiDetail.KAIYAKUKOUJYORITU)
    ...
    @Column(name=GenIT_KhShrRirekiDetail.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhShrRirekiDetail.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhShrRirekiDetail.GYOUMUKOUSINTIME)
