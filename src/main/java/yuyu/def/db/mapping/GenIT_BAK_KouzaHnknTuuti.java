...
import yuyu.def.db.id.PKIT_BAK_KouzaHnknTuuti;
...
/**
 * 口座返金通知バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KouzaHnknTuuti} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KouzaHnknTuuti}</td><td colspan="3">口座返金通知バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KouzaHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KouzaHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKIT_BAK_KouzaHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKIT_BAK_KouzaHnknTuuti ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KouzaHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_KouzaHnknTuuti
 * @see     QIT_BAK_KouzaHnknTuuti
 * @see     GenQIT_BAK_KouzaHnknTuuti
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KouzaHnknTuuti.TABLE_NAME)
@IdClass(value=PKIT_BAK_KouzaHnknTuuti.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KouzaHnknTuuti extends AbstractExDBEntity<IT_BAK_KouzaHnknTuuti, PKIT_BAK_KouzaHnknTuuti> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KouzaHnknTuuti";
    ...
    private final PKIT_BAK_KouzaHnknTuuti primaryKey;

    public GenIT_BAK_KouzaHnknTuuti() {
        primaryKey = new PKIT_BAK_KouzaHnknTuuti();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KouzaHnknTuuti getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KouzaHnknTuuti> getMetaClass() {
        return QIT_BAK_KouzaHnknTuuti.class;
    }

    @Id
    @Column(name=GenIT_BAK_KouzaHnknTuuti.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KouzaHnknTuuti.DENRENNO)
    ...
    @Id
    @Column(name=GenIT_BAK_KouzaHnknTuuti.EDANO)
    ...
    @Id
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.HASSOUKBN)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASEYNO)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASETELNO)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.TOIAWASETELNO2)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KouzaHnknTuuti.HURIKOMIYMD)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.KRKRIYUUKBN)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KouzaHnknTuuti.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KouzaHnknTuuti.GYOUMUKOUSINTIME)
