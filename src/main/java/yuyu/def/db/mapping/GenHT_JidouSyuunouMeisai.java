...
/**
 * 自動収納照合明細テーブル テーブルのマッピング情報クラスで、 {@link HT_JidouSyuunouMeisai} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_JidouSyuunouMeisai}</td><td colspan="3">自動収納照合明細テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKHT_JidouSyuunouMeisai ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getKessankbn kessankbn}</td><td>決算区分</td><td align="center">{@link PKHT_JidouSyuunouMeisai ○}</td><td align="center">V</td><td>{@link C_KessanKbn}</td></tr>
 *  <tr><td>{@link #getRstuukasyu rstuukasyu}</td><td>領収通貨種類</td><td align="center">{@link PKHT_JidouSyuunouMeisai ○}</td><td align="center">V</td><td>{@link C_Tuukasyu}</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenHT_JidouSyuunouMeisai.TABLE_NAME)
@IdClass(value=PKHT_JidouSyuunouMeisai.class)
@TypeDefs({
...
public abstract class GenHT_JidouSyuunouMeisai extends AbstractExDBEntity<HT_JidouSyuunouMeisai, PKHT_JidouSyuunouMeisai> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_JidouSyuunouMeisai";
    ...
    private final PKHT_JidouSyuunouMeisai primaryKey;

    public GenHT_JidouSyuunouMeisai() {
        primaryKey = new PKHT_JidouSyuunouMeisai();
    }
    ...
    @Transient
    @Override
    public PKHT_JidouSyuunouMeisai getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_JidouSyuunouMeisai> getMetaClass() {
        return QHT_JidouSyuunouMeisai.class;
    }

    @Id
    @Type(type="BizDateType")
    @Column(name=GenHT_JidouSyuunouMeisai.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.KESSANKBN)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.RSTUUKASYU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.SGITTIKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.SGHUITTIKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.MOSTRKSKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.YUUKOUKKNKEIKAKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.YOKUKURIKOSIKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.JNYKNTSGKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.TJKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.ZENJITUKURIKOSIKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.HRKMTSRYKENSUU)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_JidouSyuunouMeisai.GYOUMUKOUSINTIME)
