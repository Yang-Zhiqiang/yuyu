...
import yuyu.def.db.id.PKIT_BAK_HurikaeYousi;
import yuyu.def.db.meta.GenQIT_BAK_HurikaeYousi;
...
/**
 * 振替用紙バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_HurikaeYousi} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_HurikaeYousi}</td><td colspan="3">振替用紙バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_HurikaeYousi ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_HurikaeYousi ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_HurikaeYousi ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_HurikaeYousi ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_HurikaeYousi
 * @see     PKIT_BAK_HurikaeYousi
 * @see     QIT_BAK_HurikaeYousi
 * @see     GenQIT_BAK_HurikaeYousi
 */
@MappedSuperclass
@Table(name=GenIT_BAK_HurikaeYousi.TABLE_NAME)
@IdClass(value=PKIT_BAK_HurikaeYousi.class)
@TypeDefs({
...
public abstract class GenIT_BAK_HurikaeYousi extends AbstractExDBEntity<IT_BAK_HurikaeYousi, PKIT_BAK_HurikaeYousi> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_HurikaeYousi";
    ...
    private final PKIT_BAK_HurikaeYousi primaryKey;

    public GenIT_BAK_HurikaeYousi() {
        primaryKey = new PKIT_BAK_HurikaeYousi();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_HurikaeYousi getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_HurikaeYousi> getMetaClass() {
        return QIT_BAK_HurikaeYousi.class;
    }

    @Id
    @Column(name=GenIT_BAK_HurikaeYousi.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HurikaeYousi.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_HurikaeYousi.HENKOUSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HurikaeYousi.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SYORUICD)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASEYNO)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASETELNO)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.TOIAWASETELNO2)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.RHRKJYUUTOUYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_HurikaeYousi.HRKKIGEN)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.HASSOUKBN)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_HurikaeYousi.GYOUMUKOUSINTIME)
