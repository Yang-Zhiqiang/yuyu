...
/**
 * 備金異動明細Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_BikinIdouMeisaiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_BikinIdouMeisaiTy}</td><td colspan="3">備金異動明細Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_BikinIdouMeisaiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_BikinIdouMeisaiTy
 * @see     PKZT_BikinIdouMeisaiTy
 * @see     QZT_BikinIdouMeisaiTy
 * @see     GenQZT_BikinIdouMeisaiTy
 */
@MappedSuperclass
@Table(name=GenZT_BikinIdouMeisaiTy.TABLE_NAME)
@IdClass(value=PKZT_BikinIdouMeisaiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_BikinIdouMeisaiTy extends AbstractExDBEntity<ZT_BikinIdouMeisaiTy, PKZT_BikinIdouMeisaiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_BikinIdouMeisaiTy";
    ...
    private final PKZT_BikinIdouMeisaiTy primaryKey;

    public GenZT_BikinIdouMeisaiTy() {
        primaryKey = new PKZT_BikinIdouMeisaiTy();
    }

    public GenZT_BikinIdouMeisaiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_BikinIdouMeisaiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_BikinIdouMeisaiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_BikinIdouMeisaiTy> getMetaClass() {
        return QZT_BikinIdouMeisaiTy.class;
    }

    @Id
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKSYASKINMEINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEIKIHONS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEIGYOUSEKIHYJSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYALMYOUSIBOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEINENBARAIKANSANP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGYOUSEKIHYOUJISRANK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTEIKIBAIRITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANGODATAKANRINO)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAITEKYKDATAKANRINO1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAITEKYKDATAKANRINO2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNSYOKAIPCASHLESSHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYOKAIPANNAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZENNOUKAISIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYZENNOUKIKAN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEIZONKYUUHUKINSITEIY)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYALMYOUSEIZONKYHKNSITEIMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYJIKAIPJYUUTOUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADKEISANKBNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADKEISANKBNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADKEISANKBNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADKEISANKBNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV6X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIMATUVYOUTUMIMASIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKMTVYUSNHKNFUNDTMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEINENKANSANP3X1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEINENKANSANP3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEINENKANSANP3X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEINENKANSANP3X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKMTVYUHIJYNBRITMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIMATUVYOUITJBRTMTTKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X27)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X28)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X29)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X30)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X31)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X32)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X33)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHAITOUYOULOADINGKIJYUNS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUMITATED)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKARIWARIATED)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUZENSIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUZENTUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUGOSIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUGOTUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUGOKYUUHUTAISYOUS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTYOKUGOCBKINGAKU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYOKAISIHARAIKIJITU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYOKAITUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYCBNAYOSETUUSANHANTEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHITENKANKEIYAKUSUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYGOUKEIPBUBUNTENKANTEIKIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAIDAIHKTGTIKKIKKKN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSISYUTNKNHKTGKUJYGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X34)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKKYKYMDX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKNX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKKYKYMDX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKNX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKKYKYMDX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKNX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKKYKYMDX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHKTGTIKKIKKKNX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSWINGMINYUUPHRKEKNGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSWINGMINYUUPHRKEJYUTUYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFTOUNENDOITIJITOUNYUUP)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFKAIYAKUKUJYHKTGGK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAIYAKUKOUJYOTUKISUU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFKAIYAKUHENREIKIN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUUSEIS)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISYAKEISYOUSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISYAZAISEKIHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISYABOSYUUJIAGE)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISYABSYJISIKAKUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYAATUKAISYASIKAKUCD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYOKYKSMKUZTRHKKITIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHOYUUSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYOKANSISYACD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTANTOUSYAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTANTOUSYAKBNNEW)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYCLUBSUMISEIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTANTOUSYAJYOUTAIKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSONOTAYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIJIBARAIKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIJIBARAITEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYITIJIBARAISONOTAYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANKIHONYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTENKANTEIKIYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSZOUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVESTINGYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSIPPEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSEIJINBYOUTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYJYOSEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTUUINTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSAITEIHOSYOUI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVKISOITJBRKHNYOTEII)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYVKISORRTZEROIKAHYOUJI)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHOYUUSISYACD2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYDFTUJYUKUJYKISNKISIYM)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTIKIKKTBRIJYUTUTKSU)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSYUNYUMRTIKYKJTIGNGTKBN)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYHHKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIV10X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTRKZSGKAIYKKJYNSTMTKZNDK)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYPMENKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYSUURIYOUYOBIN13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X35)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X36)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYYOBIN11X37)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X2)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X3)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X4)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X5)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X6)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X7)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X8)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X9)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X10)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X11)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X12)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X13)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X14)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X15)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X16)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X17)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X18)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X19)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X20)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X21)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X22)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X23)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X24)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X25)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X26)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X27)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X28)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X29)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X30)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X31)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X32)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X33)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X34)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X35)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X36)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X37)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X38)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X39)
    ...
    @Column(name=GenZT_BikinIdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X40)
