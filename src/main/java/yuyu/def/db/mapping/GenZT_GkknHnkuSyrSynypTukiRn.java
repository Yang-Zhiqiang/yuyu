...
/**
 * 月間変更処理収入Ｐ統計Fテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_GkknHnkuSyrSynypTukiRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_GkknHnkuSyrSynypTukiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_GkknHnkuSyrSynypTukiRn.TABLE_NAME)
@IdClass(value=PKZT_GkknHnkuSyrSynypTukiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_GkknHnkuSyrSynypTukiRn extends AbstractExDBEntityForZDB<ZT_GkknHnkuSyrSynypTukiRn, PKZT_GkknHnkuSyrSynypTukiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_GkknHnkuSyrSynypTukiRn";
    ...
    private final PKZT_GkknHnkuSyrSynypTukiRn primaryKey;

    public GenZT_GkknHnkuSyrSynypTukiRn() {
        primaryKey = new PKZT_GkknHnkuSyrSynypTukiRn();
    }

    public GenZT_GkknHnkuSyrSynypTukiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_GkknHnkuSyrSynypTukiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_GkknHnkuSyrSynypTukiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_GkknHnkuSyrSynypTukiRn> getMetaClass() {
        return QZT_GkknHnkuSyrSynypTukiRn.class;
    }

    @Id
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRENDOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUUNOUKEIROKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUITOUSISYA)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUUKINYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNJYUUTOUYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNJYUUTOUKAISUU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNZENNOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSETKYKKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNBANKIKKATUHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTNKNMNOSJTIKBBNJYUTUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSETRENSEIMRTIKATAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUKEIYAKUPWARIBIKIKBNX2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYKYKTNKNYUGUKBNX2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSETKAIGOMARUTEIKATAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYONENDOSYOKAIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYONENDO2KAIMEIKOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNJINENDOIKOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHNGKNKSAITEIHOSYUKNGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUUNOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTKYKKUMKHNSYUKOSUU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSITIHSYURIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNNKGNSRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSINNYUUKINKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDFNYUUKINKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTORIKUZUSIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKBNKEIRIYOUSEGMENTCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYKIKYKJKYKYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDFKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNPHIREILKEISANYOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNCASHLESSHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNJIDOUKOUSINHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN10X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN10X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSYUKEIYAKUSYURUICDV3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSISUUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNNYKNJIKAWASERATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNNYKNJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSUURIYOUYOBIN10X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV9X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV10X16)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNNKGNS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSISUUBBNTOUNYUUGK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNSAISINYOTEIRIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNZENNOUJIIKKATUBARAIJYTGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X12)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X13)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X14)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X15)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X16)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X17)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X18)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X19)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X20)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X21)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X22)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X23)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X24)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X25)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X26)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X27)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X28)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X29)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X30)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X31)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X32)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X33)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X34)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X35)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X36)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X37)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X38)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X39)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X40)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X41)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X42)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X43)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X44)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X45)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X46)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X47)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X48)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X49)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiRn.ZRNTOKUYAKUKOUMOKUV160X50)
