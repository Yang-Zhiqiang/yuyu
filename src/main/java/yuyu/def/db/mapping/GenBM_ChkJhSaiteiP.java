...
/**
 * 最低Ｐ事方書チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkJhSaiteiP} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkJhSaiteiP}</td><td colspan="3">最低Ｐ事方書チェックマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHrkkaisuu hrkkaisuu}</td><td>払込回数</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">V</td><td>{@link C_Hrkkaisuu}</td></tr>
 *  <tr><td>{@link #getHrkkknfrom hrkkknfrom}</td><td>払込期間自</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHrkkknto hrkkknto}</td><td>払込期間至</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getChannelcd channelcd}</td><td>チャネルコード</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">V</td><td>{@link C_Channelcd}</td></tr>
 *  <tr><td>{@link #getTuukasyu tuukasyu}</td><td>通貨種類</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">V</td><td>{@link C_Tuukasyu}</td></tr>
 *  <tr><td>{@link #getSyouhinbetukey1 syouhinbetukey1}</td><td>商品別キー１</td><td align="center">{@link PKBM_ChkJhSaiteiP ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhSaiteiP.TABLE_NAME)
@IdClass(value=PKBM_ChkJhSaiteiP.class)
@TypeDefs({
...
public abstract class GenBM_ChkJhSaiteiP extends AbstractExDBEntity<BM_ChkJhSaiteiP, PKBM_ChkJhSaiteiP> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhSaiteiP";
    ...
    private final PKBM_ChkJhSaiteiP primaryKey;

    public GenBM_ChkJhSaiteiP() {
        primaryKey = new PKBM_ChkJhSaiteiP();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhSaiteiP getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhSaiteiP> getMetaClass() {
        return QBM_ChkJhSaiteiP.class;
    }

    @Id
    @Column(name=GenBM_ChkJhSaiteiP.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenBM_ChkJhSaiteiP.HRKKAISUU)
    ...
    @Column(name=GenBM_ChkJhSaiteiP.HRKKKNFROM)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhSaiteiP.HRKKKNTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiP.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiP.SYUSYOUHNSDNOTO)
    ...
    @Column(name=GenBM_ChkJhSaiteiP.CHANNELCD)
    ...
    @Column(name=GenBM_ChkJhSaiteiP.TUUKASYU)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiP.SYOUHINBETUKEY1)
