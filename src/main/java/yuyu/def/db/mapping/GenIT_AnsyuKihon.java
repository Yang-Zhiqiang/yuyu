...
import yuyu.def.db.id.PKIT_AnsyuKihon;
...
/**
 * 案内収納基本テーブル テーブルのマッピング情報クラスで、 {@link IT_AnsyuKihon} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_AnsyuKihon}</td><td colspan="3">案内収納基本テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_AnsyuKihon ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_AnsyuKihon ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_AnsyuKihon.TABLE_NAME)
@IdClass(value=PKIT_AnsyuKihon.class)
@TypeDefs({
...
public abstract class GenIT_AnsyuKihon extends AbstractExDBEntity<IT_AnsyuKihon, PKIT_AnsyuKihon> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_AnsyuKihon";
    ...
    private final PKIT_AnsyuKihon primaryKey;

    public GenIT_AnsyuKihon() {
        primaryKey = new PKIT_AnsyuKihon();
    }

    public GenIT_AnsyuKihon(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_AnsyuKihon(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_AnsyuKihon getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_AnsyuKihon> getMetaClass() {
        return QIT_AnsyuKihon.class;
    }

    @Id
    @Column(name=GenIT_AnsyuKihon.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_AnsyuKihon.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_AnsyuKihon.JKIPJYTYM)
    ...
    @Column(name=GenIT_AnsyuKihon.TKIKTANNAITUKISUU)
    ...
    @Column(name=GenIT_AnsyuKihon.KJSMHAKKOUZUMIFLG)
    ...
    @Column(name=GenIT_AnsyuKihon.SYUHARAIMANYMD)
    ...
    @Column(name=GenIT_AnsyuKihon.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_AnsyuKihon.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_AnsyuKihon.GYOUMUKOUSINTIME)
