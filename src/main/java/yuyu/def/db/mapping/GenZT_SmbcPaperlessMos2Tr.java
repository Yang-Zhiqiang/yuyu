...
/**
 * ＳＭＢＣペーパーレス申込情報２テーブル（取） テーブルのマッピング情報クラスで、 {@link ZT_SmbcPaperlessMos2Tr} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SmbcPaperlessMos2Tr}</td><td colspan="3">ＳＭＢＣペーパーレス申込情報２テーブル（取）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtrseihowebidkbn ztrseihowebidkbn}</td><td>（取込用）生保ＷｅｂＩＤ区分</td><td align="center">{@link PKZT_SmbcPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebkojincd ztrseihowebkojincd}</td><td>（取込用）生保Ｗｅｂ個人コード</td><td align="center">{@link PKZT_SmbcPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebitijihozonhyouji ztrseihowebitijihozonhyouji}</td><td>（取込用）生保Ｗｅｂ一時保存表示</td><td align="center">{@link PKZT_SmbcPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebseknoc ztrseihowebseknoc}</td><td>（取込用）生保Ｗｅｂ設計書番号Ｃ</td><td align="center">{@link PKZT_SmbcPaperlessMos2Tr ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_SmbcPaperlessMos2Tr
 * @see     PKZT_SmbcPaperlessMos2Tr
 * @see     QZT_SmbcPaperlessMos2Tr
 * @see     GenQZT_SmbcPaperlessMos2Tr
 */
@MappedSuperclass
@Table(name=GenZT_SmbcPaperlessMos2Tr.TABLE_NAME)
@IdClass(value=PKZT_SmbcPaperlessMos2Tr.class)
public abstract class GenZT_SmbcPaperlessMos2Tr extends AbstractExDBEntity<ZT_SmbcPaperlessMos2Tr, PKZT_SmbcPaperlessMos2Tr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SmbcPaperlessMos2Tr";
    ...
    private final PKZT_SmbcPaperlessMos2Tr primaryKey;

    public GenZT_SmbcPaperlessMos2Tr() {
        primaryKey = new PKZT_SmbcPaperlessMos2Tr();
    }
    ...
    @Transient
    @Override
    public PKZT_SmbcPaperlessMos2Tr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SmbcPaperlessMos2Tr> getMetaClass() {
        return QZT_SmbcPaperlessMos2Tr.class;
    }

    @Id
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBIDKBN)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKOJINCD)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBITIJIHOZONHYOUJI)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSEKNOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBCALCKIJYUNYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNKNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNSEIYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNSEIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKYKKNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKYKSYASEIYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKYKSYASEIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHKNSYURUINOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHKNKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBPHRKKIKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSDPDKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKIHONSC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBNKSYURUIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBLNTKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBNKSHRARIHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBMOSNOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSEKYKKIGENYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSKSJSITENCD)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBFSTMOSSKSYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHNSYUKYKTDKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHJNKYKHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD1)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD2)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD3)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD4)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD5)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTEIWKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKNHJNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKJHJNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKNDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKJDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBDAIHYOUKTGKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSYKIHRKP1C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBMOSP1C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBTKIYOUGYOUTAIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBZENNOUKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBPAPERLESSMOSHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBDATASOUSINZMHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBKYKOTTMSK)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNSYKGYCD)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNOTTMSK)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBHHKNNENSYUUKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos2Tr.ZTRSEIHOWEBSBUK