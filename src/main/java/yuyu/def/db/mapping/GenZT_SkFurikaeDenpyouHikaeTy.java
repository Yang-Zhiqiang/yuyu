...
/**
 * 新契約振替伝票（控）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_SkFurikaeDenpyouHikaeTy} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtytorihikinoc8 ztytorihikinoc8}</td><td>（中継用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinoedano ztytorihikinoedano}</td><td>（中継用）取引番号枝番号</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikiymdgengokbn ztytorihikiymdgengokbn}</td><td>（中継用）取引年月日元号区分</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinen ztytorihikinen}</td><td>（中継用）取引年</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikituki ztytorihikituki}</td><td>（中継用）取引月</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikibi ztytorihikibi}</td><td>（中継用）取引日</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_SkFurikaeDenpyouHikaeTy.TABLE_NAME)
@IdClass(value=PKZT_SkFurikaeDenpyouHikaeTy.class)
public abstract class GenZT_SkFurikaeDenpyouHikaeTy extends AbstractExDBEntity<ZT_SkFurikaeDenpyouHikaeTy, PKZT_SkFurikaeDenpyouHikaeTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkFurikaeDenpyouHikaeTy";
    ...
    private final PKZT_SkFurikaeDenpyouHikaeTy primaryKey;

    public GenZT_SkFurikaeDenpyouHikaeTy() {
        primaryKey = new PKZT_SkFurikaeDenpyouHikaeTy();
    }
    ...
    @Transient
    @Override
    public PKZT_SkFurikaeDenpyouHikaeTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkFurikaeDenpyouHikaeTy> getMetaClass() {
        return QZT_SkFurikaeDenpyouHikaeTy.class;
    }

    private String ztykytkmksyoruicd;

    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYTORIHIKIBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKANJYOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJTANTOUCD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM4)
