...
/**
 * 円建変更受付（任意請求）ワークテーブル テーブルのマッピング情報クラスで、 {@link IW_KhYendtHnkUktkNiniWk} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKouteikanriid kouteikanriid}</td><td>工程管理ＩＤ</td><td align="center">{@link PKIW_KhYendtHnkUktkNiniWk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIW_KhYendtHnkUktkNiniWk.TABLE_NAME)
@IdClass(value=PKIW_KhYendtHnkUktkNiniWk.class)
@TypeDefs({
...
public abstract class GenIW_KhYendtHnkUktkNiniWk extends AbstractExDBEntity<IW_KhYendtHnkUktkNiniWk, PKIW_KhYendtHnkUktkNiniWk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IW_KhYendtHnkUktkNiniWk";
    ...
    private final PKIW_KhYendtHnkUktkNiniWk primaryKey;

    public GenIW_KhYendtHnkUktkNiniWk() {
        primaryKey = new PKIW_KhYendtHnkUktkNiniWk();
    }

    public GenIW_KhYendtHnkUktkNiniWk(String pKouteikanriid) {
        primaryKey = new PKIW_KhYendtHnkUktkNiniWk(pKouteikanriid);
    }

    @Transient
    @Override
    public PKIW_KhYendtHnkUktkNiniWk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIW_KhYendtHnkUktkNiniWk> getMetaClass() {
        return QIW_KhYendtHnkUktkNiniWk.class;
    }

    @Id
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.KOUTEIKANRIID)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.SKSSAKUSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.SYORUIUKEYMD)
    @ValidDate
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.HONNINKAKNINKEKKAKBN)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.HASSOUKBN)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.ZENKAISYORIKEKKAKBN)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIW_KhYendtHnkUktkNiniWk.GYOUMUKOUSINTIME)
