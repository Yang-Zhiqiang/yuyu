...
import yuyu.def.db.id.PKHT_MosTrkKzk;
import yuyu.def.db.meta.GenQHT_MosTrkKzk;
...
/**
 * 申込登録家族テーブル テーブルのマッピング情報クラスで、 {@link HT_MosTrkKzk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_MosTrkKzk}</td><td colspan="3">申込登録家族テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_MosTrkKzk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkkzkkbn trkkzkkbn}</td><td>登録家族区分</td><td align="center">{@link PKHT_MosTrkKzk ○}</td><td align="center">V</td><td>{@link C_TrkKzkKbn}</td></tr>
 ...
 * @see     PKHT_MosTrkKzk
 * @see     QHT_MosTrkKzk
 * @see     GenQHT_MosTrkKzk
 */
@MappedSuperclass
@Table(name=GenHT_MosTrkKzk.TABLE_NAME)
@IdClass(value=PKHT_MosTrkKzk.class)
@TypeDefs({
...
public abstract class GenHT_MosTrkKzk extends AbstractExDBEntity<HT_MosTrkKzk, PKHT_MosTrkKzk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_MosTrkKzk";
    ...
    private final PKHT_MosTrkKzk primaryKey;

    public GenHT_MosTrkKzk() {
        primaryKey = new PKHT_MosTrkKzk();
    }

    public GenHT_MosTrkKzk(String pMosno, C_TrkKzkKbn pTrkkzkkbn) {
        primaryKey = new PKHT_MosTrkKzk(pMosno, pTrkkzkkbn);
    }

    @Transient
    @Override
    public PKHT_MosTrkKzk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_MosTrkKzk> getMetaClass() {
        return QHT_MosTrkKzk.class;
    }

    @Id
    @Column(name=GenHT_MosTrkKzk.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKKBN)
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKNMKJKHUKAKBN)
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKSEI)
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKTDK)
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKTSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosTrkKzk.TRKKZKTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_MosTrkKzk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_MosTrkKzk.GYOUMUKOUSINTIME)
