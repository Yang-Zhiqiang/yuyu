...
import yuyu.def.db.id.PKHT_MosKihon;
import yuyu.def.db.meta.GenQHT_MosKihon;
...
/**
 * 申込基本テーブル テーブルのマッピング情報クラスで、 {@link HT_MosKihon} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_MosKihon}</td><td colspan="3">申込基本テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_MosKihon ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenHT_MosKihon.TABLE_NAME)
@IdClass(value=PKHT_MosKihon.class)
@TypeDefs({
...
public abstract class GenHT_MosKihon extends AbstractExDBEntity<HT_MosKihon, PKHT_MosKihon> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_MosKihon";
    ...
    private final PKHT_MosKihon primaryKey;

    public GenHT_MosKihon() {
        primaryKey = new PKHT_MosKihon();
    }

    public GenHT_MosKihon(String pMosno) {
        primaryKey = new PKHT_MosKihon(pMosno);
    }

    @Transient
    @Override
    public PKHT_MosKihon getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_MosKihon> getMetaClass() {
        return QHT_MosKihon.class;
    }

    @Id
    @Column(name=GenHT_MosKihon.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_MosKihon.AITEMOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_MosKihon.DOUJIKAIYAKUSYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_MosKihon.SEKNO)
    @MaxLength(max=20)
    @AlphaDigit
    ...
    @Column(name=GenHT_MosKihon.PYKKIGENYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MOSYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MOSSAKUSEIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MOSCALCKIJYUNYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MOSUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MOSJIMOSUKTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.PPLESSMOSUKEYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.MOSYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.SSYUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.KKTYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.KYKYMD)
    ...
    @Column(name=GenHT_MosKihon.KYKYMDTKRUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.SKYKYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.SKNNKAISIYMD)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_MosKihon.BOSYUUYM)
    @ValidDateYm
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_MosKihon.SEISEKIYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_MosKihon.SKEIKEIJYOUYM)
    ...
    @Column(name=GenHT_MosKihon.KYKKBN)
    ...
    @Column(name=GenHT_MosKihon.HKNSYURUINO)
    ...
    @Column(name=GenHT_MosKihon.HKNSYURUINOSD)
    ...
    @Column(name=GenHT_MosKihon.AISYOUMEIKBN)
    ...
    @Column(name=GenHT_MosKihon.NKGNSHOSYOURITUKBN)
    ...
    @Column(name=GenHT_MosKihon.LIVHUKAUMU)
    ...
    @Column(name=GenHT_MosKihon.PMNJTKHUKAKBN)
    ...
    @Column(name=GenHT_MosKihon.PMNJTKKBN)
    ...
    @Column(name=GenHT_MosKihon.SKNNKAISIKITKHUKAKBN)
    ...
    @Column(name=GenHT_MosKihon.SKNNKAISIKITKKBN)
    ...
    @Column(name=GenHT_MosKihon.KZKTOUROKUSERVICETOUROKUKBN)
    ...
    @Column(name=GenHT_MosKihon.KYKDRTKYKHUKAKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.STDRSKTKYHKKBN)
    ...
    @Column(name=GenHT_MosKihon.SDPDKBN)
    ...
    @Column(name=GenHT_MosKihon.SNTKHOUKBN)
    ...
    @Column(name=GenHT_MosKihon.HAITOUKBN)
    ...
    @Column(name=GenHT_MosKihon.HAITOUKINUKETORIHOUKBN)
    ...
    @Column(name=GenHT_MosKihon.KYKTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenHT_MosKihon.HRKTUUKASYU)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.YENNYKNTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.GAIKANYKNTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.YENSHRTKHKKBN)
    ...
    @Column(name=GenHT_MosKihon.IKKATUBARAIKBN)
    ...
    @Column(name=GenHT_MosKihon.IKKATUBARAIKAISUU)
    ...
    @Column(name=GenHT_MosKihon.ZENNOUMOUSIDEUMU)
    ...
    @Column(name=GenHT_MosKihon.ZENKIZENNOUUMU)
    ...
    @Column(name=GenHT_MosKihon.ZNNKAI)
    @Range(min="0", max="999")
    ...
    @Column(name=GenHT_MosKihon.ZNNHRKKAI)
    ...
    @Column(name=GenHT_MosKihon.ZNNHRKKEIRO)
    ...
    @Column(name=GenHT_MosKihon.HRKKAISUU)
    ...
    @Column(name=GenHT_MosKihon.HRKKEIRO)
    ...
    @Column(name=GenHT_MosKihon.FSTPHRKKEIROKBN)
    ...
    @Column(name=GenHT_MosKihon.SKJPJYUUTOUKAISUU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.IKKATUYOUPUMUKBN)
    ...
    @Column(name=GenHT_MosKihon.IKKATUYOUPKAISUU)
    ...
    @Column(name=GenHT_MosKihon.PWARIBIKITEKIYOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.KEIZOKUPTKYKWSRATEKJYMD)
    ...
    @Column(name=GenHT_MosKihon.KEIZOKUPTKYKWSRATE)
    ...
    @Column(name=GenHT_MosKihon.DNTRYOURITUKBN)
    ...
    @Column(name=GenHT_MosKihon.APLKAHIKBN)
    ...
    @Column(name=GenHT_MosKihon.ITIPCLRIYOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.ITIPRSYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.DNTCD)
    @MaxLength(max=8)
    @AlphaDigit
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.MASSISEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenHT_MosKihon.HHKNSEI)
    ...
    @Column(name=GenHT_MosKihon.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNNENSYUUKBN)
    ...
    @Column(name=GenHT_MosKihon.TSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_MosKihon.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_MosKihon.HHKNADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_MosKihon.HHKNKINMUSAKINM)
    @MaxLength(max=50)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_KjkhukaKbn")
    @Column(name=GenHT_MosKihon.KYKNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.KYKNEN)
    ...
    @Column(name=GenHT_MosKihon.KYKSEI)
    ...
    @Column(name=GenHT_MosKihon.KYKTDK)
    ...
    @Type(type="UserType_C_NensyuuKbn")
    @Column(name=GenHT_MosKihon.KYKNENSYUUKBN)
    ...
    @Column(name=GenHT_MosKihon.KYKKINMUSAKINM)
    @MaxLength(max=50)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HJNDAIYKKBN)
    ...
    @Column(name=GenHT_MosKihon.HJNDAINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.HJNDAINMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.YAKKANJYURYOUHOUKBN)
    ...
    @Column(name=GenHT_MosKihon.YAKKANBUNSYONO)
    ...
    @Column(name=GenHT_MosKihon.SIORINO)
    ...
    @Column(name=GenHT_MosKihon.FATCASNSIKBN)
    ...
    @Column(name=GenHT_MosKihon.BIKKJNSSINFOKBN)
    ...
    @Column(name=GenHT_MosKihon.BIKKNZSYNO)
    @MaxLength(max=9)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_MosKihon.SYOMEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_MosKihon.AEOISNSIKBN)
    ...
    @Column(name=GenHT_MosKihon.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_MosKihon.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_MosKihon.DAI2TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_MosKihon.SYOSHADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.SYOSHADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.SYOSHADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.SYOSHTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    ...
    @Column(name=GenHT_MosKihon.SYOSHYNO)
    @Length(length=7)
    @Digit
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.TARGETTKHKKBN)
    ...
    @Column(name=GenHT_MosKihon.TARGETTKKBN)
    ...
    @Column(name=GenHT_MosKihon.TARGETTKMKHTKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.NSTKHKKBN)
    ...
    @Column(name=GenHT_MosKihon.NSTKMNKNSYU)
    ...
    @Column(name=GenHT_MosKihon.NSTKMNKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_MosKihon.NSTKSBNSYU)
    ...
    @Column(name=GenHT_MosKihon.NSTKSBNKKN)
    @Range(min="0", max="99")
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.SYKSBYENSITIHSYUTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.JYUDKAIGOMEHRTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.KJNNKPZEITEKITKHUKAKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.TEIKISIHARAITKYKHKKBN)
    ...
    @Column(name=GenHT_MosKihon.SAIHOCD)
    ...
    @Column(name=GenHT_MosKihon.STKNSETKBN)
    ...
    @Column(name=GenHT_MosKihon.SBUKTNIN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_MosKihon.KYKHONNINKAKNINSYORUIKBN)
    ...
    @Type(type="UserType_C_HonninkakuninSyoruiKbn")
    @Column(name=GenHT_MosKihon.SKSKKNHONNINKAKNINSYORUIKBN)
    ...
    @Column(name=GenHT_MosKihon.KOUREIKZKSETUMEIHOUKBN)
    ...
    @Column(name=GenHT_MosKihon.KOUREIMNDNHUKUSUUKAIKBN)
    ...
    @Column(name=GenHT_MosKihon.KOUREITRATKISYAIGIDSKKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.DAIHITUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.SYOTNSHUYOUPOSTUMUKBN)
    ...
    @Column(name=GenHT_MosKihon.UKTKID)
    @Length(length=11)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.BOSKYKJYOUTAI)
    ...
    @Column(name=GenHT_MosKihon.TKKINYUKKNTKRUMU)
    ...
    @Column(name=GenHT_MosKihon.DRCTSERVICEMOSKBN)
    ...
    @Column(name=GenHT_MosKihon.DSKOKNO)
    ...
    @Column(name=GenHT_MosKihon.DSMAILADDRESS)
    @MaxLength(max=100)
    @SingleByteStrings
    ...
    @Column(name=GenHT_MosKihon.YNKHRKMGKANNITUUTIKBN)
    ...
    @Column(name=GenHT_MosKihon.TOKUTEITRHKANSYONO)
    ...
    @Column(name=GenHT_MosKihon.PPLESSRENJIDSSYMENTTDKHYJ)
    ...
    @Column(name=GenHT_MosKihon.PPLSRENDOUKOUHURIKOUSOUKBN)
    ...
    @Column(name=GenHT_MosKihon.PPLESSRENDOUCREDITKOUSOUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.HNSSTJMMOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.KJMEIGIHKHUNOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.TSRYHSHRKYKUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.SYOSISYATODOKEUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.KAKUKISYOURYAKUKBUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.SEIYMDMOSSEITOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.IKOKAKNINSYOTOKKIJKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.TRTKHOUKOKUSYOTOKKIJKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.HNNKAKNINHSKJIKOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.HNNKAKNINHSKTKJIKOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_MosKihon.SKSKAKNINHSKTKJIKOUUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenHT_MosKihon.KOUSEIINKYKTKJKUMUKBN)
    ...
    @Column(name=GenHT_MosKihon.KOUKANKYKKINMUSAKINM)
    @MaxLength(max=35)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_MosKihon.KOUKANKYKSYOKUMUNAIYOU)
    @MaxLength(max=35)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenHT_MosKihon.KOUKANKYKTKJKUMUKBN)
    ...
    @Column(name=GenHT_MosKihon.KHNCHKCMNT)
    ...
    @Column(name=GenHT_MosKihon.MOBILEBOSYUUKBN)
    ...
    @Column(name=GenHT_MosKihon.JIMUYOUCD)
    @Length(length=3)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Column(name=GenHT_MosKihon.TEIRITUHAIBUNWARIKBN)
    ...
    @Column(name=GenHT_MosKihon.SISUUKBN)
    ...
    @Type(type="UserType_C_TumitatekinHaibunWariKbn")
    @Column(name=GenHT_MosKihon.SISUUHAIBUNWARIKBN)
    ...
    @Column(name=GenHT_MosKihon.TRHKJIKAKKBN)
    ...
    @Column(name=GenHT_MosKihon.KOUREITAIOUKBN)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenHT_MosKihon.KYKTUUKASYU2)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenHT_MosKihon.HRKTUUKASYU2)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_MosKihon.KJNNKPZEITEKITKHUKAKBN2)
    ...
    @Column(name=GenHT_MosKihon.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_MosKihon.GYOUMUKOUSINTIME)
