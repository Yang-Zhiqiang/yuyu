...
/**
 * ＲＡＹ異動ＶＦテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RayIdouVRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayIdouVRn}</td><td colspan="3">ＲＡＹ異動ＶＦテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_RayIdouVRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RayIdouVRn.TABLE_NAME)
@IdClass(value=PKZT_RayIdouVRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayIdouVRn extends AbstractExDBEntityForZDB<ZT_RayIdouVRn, PKZT_RayIdouVRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayIdouVRn";
    ...
    private final PKZT_RayIdouVRn primaryKey;

    public GenZT_RayIdouVRn() {
        primaryKey = new PKZT_RayIdouVRn();
    }

    public GenZT_RayIdouVRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_RayIdouVRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_RayIdouVRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayIdouVRn> getMetaClass() {
        return QZT_RayIdouVRn.class;
    }

    @Id
    @Column(name=GenZT_RayIdouVRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayIdouVRn.ZRNVYOURENDOURITU)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV15)
    ...
    @Column(name=GenZT_RayIdouVRn.ZRNYOBIV20)
