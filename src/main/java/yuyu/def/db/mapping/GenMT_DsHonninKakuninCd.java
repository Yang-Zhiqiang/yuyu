...
import yuyu.def.db.id.PKMT_DsHonninKakuninCd;
...
/**
 * ＤＳ本人確認コードテーブル テーブルのマッピング情報クラスで、 {@link MT_DsHonninKakuninCd} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link MT_DsHonninKakuninCd}</td><td colspan="3">ＤＳ本人確認コードテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDskokno dskokno}</td><td>ＤＳ顧客番号</td><td align="center">{@link PKMT_DsHonninKakuninCd ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKMT_DsHonninKakuninCd
 * @see     QMT_DsHonninKakuninCd
 * @see     GenQMT_DsHonninKakuninCd
 */
@MappedSuperclass
@Table(name=GenMT_DsHonninKakuninCd.TABLE_NAME)
@IdClass(value=PKMT_DsHonninKakuninCd.class)
@TypeDefs({
...
public abstract class GenMT_DsHonninKakuninCd extends AbstractExDBEntity<MT_DsHonninKakuninCd, PKMT_DsHonninKakuninCd> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MT_DsHonninKakuninCd";
    ...
    private final PKMT_DsHonninKakuninCd primaryKey;

    public GenMT_DsHonninKakuninCd() {
        primaryKey = new PKMT_DsHonninKakuninCd();
    }

    public GenMT_DsHonninKakuninCd(String pDskokno) {
        primaryKey = new PKMT_DsHonninKakuninCd(pDskokno);
    }

    @Transient
    @Override
    public PKMT_DsHonninKakuninCd getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMT_DsHonninKakuninCd> getMetaClass() {
        return QMT_DsHonninKakuninCd.class;
    }

    @Id
    @Column(name=GenMT_DsHonninKakuninCd.DSKOKNO)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCD)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDSETKBN)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDSETYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDYUUKOUYMD)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSHNNKAKCD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_DsHonninKakuninCd.DSHNNKAKCDSETYMD)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.ZENKAIDSKRHNNKAKCD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDTTSHJYHSYMD)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDTTYHKBN)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.DSKRHNNKAKCDTTTYDNJYKBN)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenMT_DsHonninKakuninCd.GYOUMUKOUSINSYAID)
