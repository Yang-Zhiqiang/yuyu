...
import yuyu.def.db.id.PKHT_BosUketoriKouzaJyouhou;
import yuyu.def.db.meta.GenQHT_BosUketoriKouzaJyouhou;
...
/**
 * 募集受取口座情報テーブル テーブルのマッピング情報クラスで、 {@link HT_BosUketoriKouzaJyouhou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BosUketoriKouzaJyouhou}</td><td colspan="3">募集受取口座情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_BosUketoriKouzaJyouhou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUktkzsyubetukbn uktkzsyubetukbn}</td><td>受取口座種別区分</td><td align="center">{@link PKHT_BosUketoriKouzaJyouhou ○}</td><td align="center">V</td><td>{@link C_UketorikouzasyubetuKbn}</td></tr>
 ...
 * </table>
 * @see     HT_BosUketoriKouzaJyouhou
 * @see     PKHT_BosUketoriKouzaJyouhou
 * @see     QHT_BosUketoriKouzaJyouhou
 * @see     GenQHT_BosUketoriKouzaJyouhou
 */
@MappedSuperclass
@Table(name=GenHT_BosUketoriKouzaJyouhou.TABLE_NAME)
@IdClass(value=PKHT_BosUketoriKouzaJyouhou.class)
@TypeDefs({
...
public abstract class GenHT_BosUketoriKouzaJyouhou extends AbstractExDBEntity<HT_BosUketoriKouzaJyouhou, PKHT_BosUketoriKouzaJyouhou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BosUketoriKouzaJyouhou";
    ...
    private final PKHT_BosUketoriKouzaJyouhou primaryKey;

    public GenHT_BosUketoriKouzaJyouhou() {
        primaryKey = new PKHT_BosUketoriKouzaJyouhou();
    }

    public GenHT_BosUketoriKouzaJyouhou(String pMosno, C_UketorikouzasyubetuKbn pUktkzsyubetukbn) {
        primaryKey = new PKHT_BosUketoriKouzaJyouhou(pMosno, pUktkzsyubetukbn);
    }

    @Transient
    @Override
    public PKHT_BosUketoriKouzaJyouhou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BosUketoriKouzaJyouhou> getMetaClass() {
        return QHT_BosUketoriKouzaJyouhou.class;
    }

    @Id
    @Column(name=GenHT_BosUketoriKouzaJyouhou.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.UKTKZSYUBETUKBN)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.KOUZAINFOINPUTHORYUUKBN)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.KZSYURUIKBN)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.YOKINKBN)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.KZKYKDOUKBN)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BosUketoriKouzaJyouhou.GYOUMUKOUSINTIME)
