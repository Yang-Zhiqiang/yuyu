...
/**
 * 年金配当所要額Ｆ期中報告用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkHitKtyTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkHitKtyTy}</td><td colspan="3">年金配当所要額Ｆ期中報告用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtynksyousyono ztynksyousyono}</td><td>（中継用）年金証書番号</td><td align="center">{@link PKZT_NkHitKtyTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkHitKtyTy.TABLE_NAME)
@IdClass(value=PKZT_NkHitKtyTy.class)
public abstract class GenZT_NkHitKtyTy extends AbstractExDBEntity<ZT_NkHitKtyTy, PKZT_NkHitKtyTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkHitKtyTy";
    ...
    private final PKZT_NkHitKtyTy primaryKey;

    public GenZT_NkHitKtyTy() {
        primaryKey = new PKZT_NkHitKtyTy();
    }

    public GenZT_NkHitKtyTy(String pZtynksyousyono) {
        primaryKey = new PKZT_NkHitKtyTy(pZtynksyousyono);
    }

    @Transient
    @Override
    public PKZT_NkHitKtyTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkHitKtyTy> getMetaClass() {
        return QZT_NkHitKtyTy.class;
    }

    @Id
    @Column(name=GenZT_NkHitKtyTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYNENKINTYPEKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYNENKINITIJISIHARAINENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYMANRYOUKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKEIYAKUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYSEIZONKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOTEIRIRITUN5)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTY5NNGT3NNGTOUTUBKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV7)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV15)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYGYOUSEKIHYOUJISIBOUS)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYUUKOUTYUUSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYSYOUMETUJISYOYOUGAKUYOU1)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYSYOUMETUJISYOYOUGAKUYOU2)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYRISADTAISYOUV)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYNKNENGK)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYSYUKEIYAKUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKAIMASINENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV38)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKEISANKIJYUNYMD)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTOUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOKUYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTOUNENDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYKNNDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYZNNNDSEISIKIWRATEHYJ)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTOUNENDODHANEIZUMIHYOUJI)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTOUNENDOOUTOUBIJITEND)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTUNNDOUTUBIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTUNNDMTIKUYKNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYKNNDOUTUBIKOUYKNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYZNNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKTYUMTIKUTUNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYTUNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYKTYUMTIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_NkHitKtyTy.ZTYYOBIV16)
