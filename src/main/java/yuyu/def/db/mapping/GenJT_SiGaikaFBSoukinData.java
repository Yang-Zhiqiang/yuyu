...
import yuyu.def.db.id.PKJT_SiGaikaFBSoukinData;
...
/**
 * 支払外貨ＦＢ送金データテーブル テーブルのマッピング情報クラスで、 {@link JT_SiGaikaFBSoukinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link JT_SiGaikaFBSoukinData}</td><td colspan="3">支払外貨ＦＢ送金データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getFbsoukindatasikibetukey fbsoukindatasikibetukey}</td><td>ＦＢ送金データ識別キー</td><td align="center">{@link PKJT_SiGaikaFBSoukinData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKJT_SiGaikaFBSoukinData
 * @see     QJT_SiGaikaFBSoukinData
 * @see     GenQJT_SiGaikaFBSoukinData
 */
@MappedSuperclass
@Table(name=GenJT_SiGaikaFBSoukinData.TABLE_NAME)
@IdClass(value=PKJT_SiGaikaFBSoukinData.class)
@TypeDefs({
...
public abstract class GenJT_SiGaikaFBSoukinData extends AbstractExDBEntity<JT_SiGaikaFBSoukinData, PKJT_SiGaikaFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "JT_SiGaikaFBSoukinData";
    ...
    private final PKJT_SiGaikaFBSoukinData primaryKey;

    public GenJT_SiGaikaFBSoukinData() {
        primaryKey = new PKJT_SiGaikaFBSoukinData();
    }

    public GenJT_SiGaikaFBSoukinData(String pFbsoukindatasikibetukey) {
        primaryKey = new PKJT_SiGaikaFBSoukinData(pFbsoukindatasikibetukey);
    }

    @Transient
    @Override
    public PKJT_SiGaikaFBSoukinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QJT_SiGaikaFBSoukinData> getMetaClass() {
        return QJT_SiGaikaFBSoukinData.class;
    }

    @Id
    @Column(name=GenJT_SiGaikaFBSoukinData.FBSOUKINDATASIKIBETUKEY)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.DENRENNO)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.EDANO)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.DENSYSKBN)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.GKGYOUMUCD)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.TANTOSITUCD)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SYORICD)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SYORISOSIKICD)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenJT_SiGaikaFBSoukinData.DENYMD)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SHRHOUSITEIKBN)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.BANKNMEJ)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SITENNMEJ)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.KZMEIGINMEI)
    @HostInvalidCharacter
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SHRTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenJT_SiGaikaFBSoukinData.KYKTUUKASYU)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.SOUKINKWSRATE)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.IRNINNMEI)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenJT_SiGaikaFBSoukinData.GYOUMUKOUSINTIME)
