...
import yuyu.def.db.id.PKIT_KhFBSoukinData;
...
/**
 * 契約保全ＦＢ送金データテーブル テーブルのマッピング情報クラスで、 {@link IT_KhFBSoukinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhFBSoukinData}</td><td colspan="3">契約保全ＦＢ送金データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getFbsoukindatasikibetukey fbsoukindatasikibetukey}</td><td>ＦＢ送金データ識別キー</td><td align="center">{@link PKIT_KhFBSoukinData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_KhFBSoukinData
 * @see     QIT_KhFBSoukinData
 * @see     GenQIT_KhFBSoukinData
 */
@MappedSuperclass
@Table(name=GenIT_KhFBSoukinData.TABLE_NAME)
@IdClass(value=PKIT_KhFBSoukinData.class)
@TypeDefs({
...
public abstract class GenIT_KhFBSoukinData extends AbstractExDBEntity<IT_KhFBSoukinData, PKIT_KhFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhFBSoukinData";
    ...
    private final PKIT_KhFBSoukinData primaryKey;

    public GenIT_KhFBSoukinData() {
        primaryKey = new PKIT_KhFBSoukinData();
    }

    public GenIT_KhFBSoukinData(String pFbsoukindatasikibetukey) {
        primaryKey = new PKIT_KhFBSoukinData(pFbsoukindatasikibetukey);
    }

    @Transient
    @Override
    public PKIT_KhFBSoukinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhFBSoukinData> getMetaClass() {
        return QIT_KhFBSoukinData.class;
    }

    @Id
    @Column(name=GenIT_KhFBSoukinData.FBSOUKINDATASIKIBETUKEY)
    ...
    @Column(name=GenIT_KhFBSoukinData.DENRENNO)
    ...
    @Column(name=GenIT_KhFBSoukinData.EDANO)
    ...
    @Column(name=GenIT_KhFBSoukinData.DENSYSKBN)
    ...
    @Column(name=GenIT_KhFBSoukinData.GYOUMUCD)
    ...
    @Column(name=GenIT_KhFBSoukinData.TANTOSITUCD)
    ...
    @Column(name=GenIT_KhFBSoukinData.SYORICD)
    ...
    @Column(name=GenIT_KhFBSoukinData.SYORISOSIKICD)
    ...
    @Column(name=GenIT_KhFBSoukinData.SYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhFBSoukinData.DENYMD)
    ...
    @Column(name=GenIT_KhFBSoukinData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhFBSoukinData.SHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhFBSoukinData.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_KhFBSoukinData.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhFBSoukinData.YOKINKBN)
    ...
    @Column(name=GenIT_KhFBSoukinData.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_KhFBSoukinData.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhFBSoukinData.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KhFBSoukinData.SOUKINKWSRATE)
    ...
    @Column(name=GenIT_KhFBSoukinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhFBSoukinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhFBSoukinData.GYOUMUKOUSINTIME)
