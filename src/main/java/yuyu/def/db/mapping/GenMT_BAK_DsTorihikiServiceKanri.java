...
import yuyu.def.db.id.PKMT_BAK_DsTorihikiServiceKanri;
...
/**
 * ＤＳ取引サービス管理バックアップテーブル テーブルのマッピング情報クラスで、 {@link MT_BAK_DsTorihikiServiceKanri} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getDskokno dskokno}</td><td>ＤＳ顧客番号</td><td align="center">{@link PKMT_BAK_DsTorihikiServiceKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKMT_BAK_DsTorihikiServiceKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKMT_BAK_DsTorihikiServiceKanri ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKMT_BAK_DsTorihikiServiceKanri
 * @see     QMT_BAK_DsTorihikiServiceKanri
 * @see     GenQMT_BAK_DsTorihikiServiceKanri
 */
@MappedSuperclass
@Table(name=GenMT_BAK_DsTorihikiServiceKanri.TABLE_NAME)
@IdClass(value=PKMT_BAK_DsTorihikiServiceKanri.class)
@TypeDefs({
...
public abstract class GenMT_BAK_DsTorihikiServiceKanri extends AbstractExDBEntity<MT_BAK_DsTorihikiServiceKanri, PKMT_BAK_DsTorihikiServiceKanri> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MT_BAK_DsTorihikiServiceKanri";
    ...
    private final PKMT_BAK_DsTorihikiServiceKanri primaryKey;

    public GenMT_BAK_DsTorihikiServiceKanri() {
        primaryKey = new PKMT_BAK_DsTorihikiServiceKanri();
    }
    ...
    @Transient
    @Override
    public PKMT_BAK_DsTorihikiServiceKanri getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMT_BAK_DsTorihikiServiceKanri> getMetaClass() {
        return QMT_BAK_DsTorihikiServiceKanri.class;
    }

    @Id
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSKOKNO)
    ...
    @Id
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSTRHKSERVICERIYOUJKKBN)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSTRHKSERVICETEISIRIYUUKBN)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSTRHKSERVICETOUROKUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSTRHKSERVICEMUKOUYMD)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.DSTRHKSERVICEKANYUKEIROKBN)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenMT_BAK_DsTorihikiServiceKanri.GYOUMUKOUSINTIME)
