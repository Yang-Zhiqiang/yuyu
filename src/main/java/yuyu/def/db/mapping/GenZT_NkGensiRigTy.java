...
/**
 * 年金原資Ｆ例月用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkGensiRigTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkGensiRigTy}</td><td colspan="3">年金原資Ｆ例月用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_NkGensiRigTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkGensiRigTy.TABLE_NAME)
@IdClass(value=PKZT_NkGensiRigTy.class)
public abstract class GenZT_NkGensiRigTy extends AbstractExDBEntity<ZT_NkGensiRigTy, PKZT_NkGensiRigTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkGensiRigTy";
    ...
    private final PKZT_NkGensiRigTy primaryKey;

    public GenZT_NkGensiRigTy() {
        primaryKey = new PKZT_NkGensiRigTy();
    }

    public GenZT_NkGensiRigTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_NkGensiRigTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_NkGensiRigTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkGensiRigTy> getMetaClass() {
        return QZT_NkGensiRigTy.class;
    }

    @Id
    @Column(name=GenZT_NkGensiRigTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSYSTEMCD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYULFKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYIDOUYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSYOUIN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINSYU)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYCURRENTDAY)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYCURRENTTIME)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINGENSINO)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINGENSINAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNKKIKINGK)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYGENSINAIYOUKIHONNKGK)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNEWMONEYGAKU)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYNENKINGENSIHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYDKEISANYOUNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiRigTy.ZTYKGYNKYOUZEISEITKKAKSJGNS)
