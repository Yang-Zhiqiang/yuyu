...
import yuyu.def.db.id.PKIT_KhHasseijiKazeiRireki;
import yuyu.def.db.meta.GenQIT_KhHasseijiKazeiRireki;
...
/**
 * 契約保全発生時課税履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_KhHasseijiKazeiRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhHasseijiKazeiRireki}</td><td colspan="3">契約保全発生時課税履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhHasseijiKazeiRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhHasseijiKazeiRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KhHasseijiKazeiRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KhHasseijiKazeiRireki
 * @see     PKIT_KhHasseijiKazeiRireki
 * @see     QIT_KhHasseijiKazeiRireki
 * @see     GenQIT_KhHasseijiKazeiRireki
 */
@MappedSuperclass
@Table(name=GenIT_KhHasseijiKazeiRireki.TABLE_NAME)
@IdClass(value=PKIT_KhHasseijiKazeiRireki.class)
@TypeDefs({
...
public abstract class GenIT_KhHasseijiKazeiRireki extends AbstractExDBEntity<IT_KhHasseijiKazeiRireki, PKIT_KhHasseijiKazeiRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhHasseijiKazeiRireki";
    ...
    private final PKIT_KhHasseijiKazeiRireki primaryKey;

    public GenIT_KhHasseijiKazeiRireki() {
        primaryKey = new PKIT_KhHasseijiKazeiRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_KhHasseijiKazeiRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhHasseijiKazeiRireki> getMetaClass() {
        return QIT_KhHasseijiKazeiRireki.class;
    }

    @Id
    @Column(name=GenIT_KhHasseijiKazeiRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhHasseijiKazeiRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhHasseijiKazeiRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.HASSEIJIKAZEISYORIKBN)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.TORIKESIFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHasseijiKazeiRireki.TORIKESIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHasseijiKazeiRireki.KOURYOKUHASSEIYMD)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.ZEITRATKIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KhHasseijiKazeiRireki.GSBUNRITAISYOU)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.HASSEIJIKNGKSYURUIKBN)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.NZTODOUHUKENCD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHasseijiKazeiRireki.ZEIMUKWSRATEKJNYMD)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.ZEIMUKWSRATE)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKYNO)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKADR1KJ)
    @MaxLength(max=62)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKADR2KJ)
    @MaxLength(max=62)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKADR3KJ)
    @MaxLength(max=62)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.UKTMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.SHRTYSYSYURUIKBN)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.KYKHNKKAISUU)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhHasseijiKazeiRireki.GYOUMUKOUSINTIME)
