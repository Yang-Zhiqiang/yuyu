...
/**
 * 年金統計Ｆ例月用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkToukeiRigTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkToukeiRigTy}</td><td colspan="3">年金統計Ｆ例月用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_NkToukeiRigTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkToukeiRigTy.TABLE_NAME)
@IdClass(value=PKZT_NkToukeiRigTy.class)
public abstract class GenZT_NkToukeiRigTy extends AbstractExDBEntity<ZT_NkToukeiRigTy, PKZT_NkToukeiRigTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkToukeiRigTy";
    ...
    private final PKZT_NkToukeiRigTy primaryKey;

    public GenZT_NkToukeiRigTy() {
        primaryKey = new PKZT_NkToukeiRigTy();
    }

    public GenZT_NkToukeiRigTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_NkToukeiRigTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_NkToukeiRigTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkToukeiRigTy> getMetaClass() {
        return QZT_NkToukeiRigTy.class;
    }

    @Id
    @Column(name=GenZT_NkToukeiRigTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYSTEMCD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYULFKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYIDOUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOUIN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINSYU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYCURRENTDAY)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYCURRENTTIME)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKASANNKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKKNSETYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTEIZOURITU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYDKIGETU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUNENDOD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSIHARAIUKETUKEBASYO)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSHIHARAIHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV1X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV1X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV1X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV8X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV8X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV59)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYYOBIV17)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINKKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINENKINSYURUIKIGOU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINKSHRKKN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINKHHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKIMSNKDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYSAISYUUNENKINKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZENNENDOKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZNZNNNDKAIMASINKZOUGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZNZNZNNNDKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUNENDOKAIMASINENKIND)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASITYUUSIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASIHUKKIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYKAIMASINKKIGOUSDKBN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMAEATUATOATUKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMAEATUATOATUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYMAEATUATOATUHENDOUGONKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYATOATUSAISYUUKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYATOATUKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYZNZNZNNNDATATKIMSNKGK)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYTOUNENDATOATUKAIMASINKD)
    ...
    @Column(name=GenZT_NkToukeiRigTy.ZTYUWANOSEATOATUKAIMASINKGK)
