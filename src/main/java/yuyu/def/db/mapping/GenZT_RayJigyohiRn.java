...
/**
 * ＲＡＹ事業費Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RayJigyohiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayJigyohiRn}</td><td colspan="3">ＲＡＹ事業費Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_RayJigyohiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RayJigyohiRn.TABLE_NAME)
@IdClass(value=PKZT_RayJigyohiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayJigyohiRn extends AbstractExDBEntityForZDB<ZT_RayJigyohiRn, PKZT_RayJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayJigyohiRn";
    ...
    private final PKZT_RayJigyohiRn primaryKey;

    public GenZT_RayJigyohiRn() {
        primaryKey = new PKZT_RayJigyohiRn();
    }

    public GenZT_RayJigyohiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_RayJigyohiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_RayJigyohiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayJigyohiRn> getMetaClass() {
        return QZT_RayJigyohiRn.class;
    }

    @Id
    @Column(name=GenZT_RayJigyohiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNLOADINGKEIJYOYM)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSIHANKIKSNYDATAHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNGMKIJYHYJ)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV20)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X18)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREILKISNYUKNGKX1)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREILKISNYUKNGKX2)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNRPKEISANYOUSIBOUS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIKENS)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREIALPHA)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREIBETA)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNKIKENP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNVHIREILRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayJigyohiRn.ZRNKIKENPRITU)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNTUMIMASIMAEW)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_RayJigyohiRn.ZRNYOBIV19)
