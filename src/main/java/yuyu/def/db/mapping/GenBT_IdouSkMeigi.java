...
import yuyu.def.db.id.PKBT_IdouSkMeigi;
...
/**
 * 異動新契約名義管理テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouSkMeigi} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_IdouSkMeigi}</td><td colspan="3">異動新契約名義管理テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKBT_IdouSkMeigi ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouSkMeigi ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     BT_IdouSkMeigi
 * @see     PKBT_IdouSkMeigi
 * @see     QBT_IdouSkMeigi
 * @see     GenQBT_IdouSkMeigi
 */
@MappedSuperclass
@Table(name=GenBT_IdouSkMeigi.TABLE_NAME)
@IdClass(value=PKBT_IdouSkMeigi.class)
@TypeDefs({
...
public abstract class GenBT_IdouSkMeigi extends AbstractExDBEntity<BT_IdouSkMeigi, PKBT_IdouSkMeigi> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouSkMeigi";
    ...
    private final PKBT_IdouSkMeigi primaryKey;

    public GenBT_IdouSkMeigi() {
        primaryKey = new PKBT_IdouSkMeigi();
    }

    public GenBT_IdouSkMeigi(String pMosno, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouSkMeigi(pMosno, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouSkMeigi getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouSkMeigi> getMetaClass() {
        return QBT_IdouSkMeigi.class;
    }

    @Id
    @Column(name=GenBT_IdouSkMeigi.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenBT_IdouSkMeigi.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNSEI)
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouSkMeigi.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouSkMeigi.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouSkMeigi.NENKINUKTNMKANA)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.NENKINUKTNMKANJI)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouSkMeigi.NENKINUKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouSkMeigi.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouSkMeigi.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKN3)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKJ3)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKN4)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.SBUKTNMKJ4)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.STDRSKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.STDRSKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KYKDAIRINMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KYKDAIRINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenBT_IdouSkMeigi.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBT_IdouSkMeigi.YOKINKBN)
    ...
    @Column(name=GenBT_IdouSkMeigi.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KZKYKDOUKBN)
    ...
    @Column(name=GenBT_IdouSkMeigi.KZKTOUROKUNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KZKTOUROKUNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KZKTOUROKUNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouSkMeigi.KZKTOUROKUNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
