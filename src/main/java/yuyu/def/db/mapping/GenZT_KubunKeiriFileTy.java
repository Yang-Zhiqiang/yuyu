...
/**
 * 区分経理ファイルテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KubunKeiriFileTy} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtytorihikiymd ztytorihikiymd}</td><td>（中継用）取引年月日</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinon7 ztytorihikinon7}</td><td>（中継用）取引番号Ｎ７</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytaisyakukbnn ztytaisyakukbnn}</td><td>（中継用）貸借区分（数値）</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtykanjyoukamokucdn ztykanjyoukamokucdn}</td><td>（中継用）勘定科目コード（数値）</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtyyobiv4 ztyyobiv4}</td><td>（中継用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysuitoubumoncd ztysuitoubumoncd}</td><td>（中継用）出納部門コード</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtykingaku ztykingaku}</td><td>（中継用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtykizokusegment ztykizokusegment}</td><td>（中継用）帰属セグメント</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtyaitesegment ztyaitesegment}</td><td>（中継用）相手セグメント</td><td align="center">{@link PKZT_KubunKeiriFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_KubunKeiriFileTy.TABLE_NAME)
@IdClass(value=PKZT_KubunKeiriFileTy.class)
public abstract class GenZT_KubunKeiriFileTy extends AbstractExDBEntity<ZT_KubunKeiriFileTy, PKZT_KubunKeiriFileTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KubunKeiriFileTy";
    ...
    private final PKZT_KubunKeiriFileTy primaryKey;

    public GenZT_KubunKeiriFileTy() {
        primaryKey = new PKZT_KubunKeiriFileTy();
    }
    ...
    @Transient
    @Override
    public PKZT_KubunKeiriFileTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KubunKeiriFileTy> getMetaClass() {
        return QZT_KubunKeiriFileTy.class;
    }

    private String ztykaikeitani;

    @Column(name=GenZT_KubunKeiriFileTy.ZTYKAIKEITANI)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYSYORICD)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYTORIHIKINON7)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYSYORIYMDN)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYKESSANKBN)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYONLINESYORIKBN)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYYOBIV28)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYYOBIV4)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYSUITOUBUMONCD)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYKINGAKU)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYKIZOKUSEGMENT)
    ...
    @Id
    @Column(name=GenZT_KubunKeiriFileTy.ZTYAITESEGMENT)
    ...
    @Column(name=GenZT_KubunKeiriFileTy.ZTYYOBIV23)
