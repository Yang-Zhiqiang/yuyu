...
import yuyu.def.db.id.PKIT_AnsyuCreditCard;
...
/**
 * 案内収納用クレジット払テーブル テーブルのマッピング情報クラスで、 {@link IT_AnsyuCreditCard} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_AnsyuCreditCard}</td><td colspan="3">案内収納用クレジット払テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_AnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_AnsyuCreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_AnsyuCreditCard
 * @see     QIT_AnsyuCreditCard
 * @see     GenQIT_AnsyuCreditCard
 */
@MappedSuperclass
@Table(name=GenIT_AnsyuCreditCard.TABLE_NAME)
@IdClass(value=PKIT_AnsyuCreditCard.class)
@TypeDefs({
...
public abstract class GenIT_AnsyuCreditCard extends AbstractExDBEntity<IT_AnsyuCreditCard, PKIT_AnsyuCreditCard> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_AnsyuCreditCard";
    ...
    private final PKIT_AnsyuCreditCard primaryKey;

    public GenIT_AnsyuCreditCard() {
        primaryKey = new PKIT_AnsyuCreditCard();
    }

    public GenIT_AnsyuCreditCard(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_AnsyuCreditCard(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_AnsyuCreditCard getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_AnsyuCreditCard> getMetaClass() {
        return QIT_AnsyuCreditCard.class;
    }

    @Id
    @Column(name=GenIT_AnsyuCreditCard.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_AnsyuCreditCard.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_AnsyuCreditCard.YUKOUKACHKYMD)
    ...
    @Column(name=GenIT_AnsyuCreditCard.YUUKOUKAKUJKKBN)
    ...
    @Column(name=GenIT_AnsyuCreditCard.AUTHORIJKKBN)
    ...
    @Column(name=GenIT_AnsyuCreditCard.AUTHORITRKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_AnsyuCreditCard.AUTHORIKANRYOYMD)
    @ValidDate
    ...
    @Column(name=GenIT_AnsyuCreditCard.SYOUNINNO)
    @MaxLength(max=6)
    @Digit
    ...
    @Column(name=GenIT_AnsyuCreditCard.TANMATUSYORINO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_AnsyuCreditCard.URIAGEYMD)
    ...
    @Column(name=GenIT_AnsyuCreditCard.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_AnsyuCreditCard.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_AnsyuCreditCard.GYOUMUKOUSINTIME)
