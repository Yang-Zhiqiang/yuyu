...
import yuyu.def.db.id.PKIT_BAK_KhLincSousinData;
import yuyu.def.db.meta.GenQIT_BAK_KhLincSousinData;
...
/**
 * 契約保全ＬＩＮＣ送信データバックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhLincSousinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhLincSousinData}</td><td colspan="3">契約保全ＬＩＮＣ送信データバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhLincSousinData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhLincSousinData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhLincSousinData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKIT_BAK_KhLincSousinData ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KhLincSousinData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KhLincSousinData
 * @see     PKIT_BAK_KhLincSousinData
 * @see     QIT_BAK_KhLincSousinData
 * @see     GenQIT_BAK_KhLincSousinData
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhLincSousinData.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhLincSousinData.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhLincSousinData extends AbstractExDBEntity<IT_BAK_KhLincSousinData, PKIT_BAK_KhLincSousinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhLincSousinData";
    ...
    private final PKIT_BAK_KhLincSousinData primaryKey;

    public GenIT_BAK_KhLincSousinData() {
        primaryKey = new PKIT_BAK_KhLincSousinData();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhLincSousinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhLincSousinData> getMetaClass() {
        return QIT_BAK_KhLincSousinData.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhLincSousinData.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinData.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinData.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.SYORIYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinData.RENNO)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCSOUSINKBN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCRECORDSYUBETU)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHENKOUTYPE)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKANYUUSYANO)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHHKNNMKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHHKNNMKJ)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHHKNSEIYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHHKNADRKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKEIHIDJNHYOUJI)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKNMKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKNMKJ)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKSEIYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKADRKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCTRKMOUSIDEYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKYTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHOZENYTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCHOZENYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCKAKUSYASIYOURAN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCMOUSIDEFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCMOUSIDEFLGSETYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhLincSousinData.LINCMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCJGYHKNFLG)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.LINCTENKANFLG)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhLincSousinData.GYOUMUKOUSINTIME)
