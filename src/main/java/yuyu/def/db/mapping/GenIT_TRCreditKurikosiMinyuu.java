...
import yuyu.def.db.id.PKIT_TRCreditKurikosiMinyuu;
import yuyu.def.db.meta.GenQIT_TRCreditKurikosiMinyuu;
...
/**
 * クレカ繰越未入ＴＲテーブル テーブルのマッピング情報クラスで、 {@link IT_TRCreditKurikosiMinyuu} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_TRCreditKurikosiMinyuu}</td><td colspan="3">クレカ繰越未入ＴＲテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_TRCreditKurikosiMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_TRCreditKurikosiMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKIT_TRCreditKurikosiMinyuu ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getMinyuutrrenno minyuutrrenno}</td><td>未入TR連番</td><td align="center">{@link PKIT_TRCreditKurikosiMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_TRCreditKurikosiMinyuu
 * @see     PKIT_TRCreditKurikosiMinyuu
 * @see     QIT_TRCreditKurikosiMinyuu
 * @see     GenQIT_TRCreditKurikosiMinyuu
 */
@MappedSuperclass
@Table(name=GenIT_TRCreditKurikosiMinyuu.TABLE_NAME)
@IdClass(value=PKIT_TRCreditKurikosiMinyuu.class)
@TypeDefs({
...
public abstract class GenIT_TRCreditKurikosiMinyuu extends AbstractExDBEntity<IT_TRCreditKurikosiMinyuu, PKIT_TRCreditKurikosiMinyuu> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_TRCreditKurikosiMinyuu";
    ...
    private final PKIT_TRCreditKurikosiMinyuu primaryKey;

    public GenIT_TRCreditKurikosiMinyuu() {
        primaryKey = new PKIT_TRCreditKurikosiMinyuu();
    }
    ...
    @Transient
    @Override
    public PKIT_TRCreditKurikosiMinyuu getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_TRCreditKurikosiMinyuu> getMetaClass() {
        return QIT_TRCreditKurikosiMinyuu.class;
    }

    @Id
    @Column(name=GenIT_TRCreditKurikosiMinyuu.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_TRCreditKurikosiMinyuu.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.SYORIYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_TRCreditKurikosiMinyuu.MINYUUTRRENNO)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.NYKKEIRO)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TRCreditKurikosiMinyuu.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.HURIHUNOKBN)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.YOKINKBN)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.DANTAIKOBETUKBN)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.HRKKAISUU)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.KZHURIKAETKBTANNAIHYJ)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.CREDITURIAGENGJIYUU)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_TRCreditKurikosiMinyuu.GYOUMUKOUSINTIME)
