...
import yuyu.def.db.id.PKIT_SyuunouHenknRireki;
...
/**
 * 収納返金履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_SyuunouHenknRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_SyuunouHenknRireki}</td><td colspan="3">収納返金履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_SyuunouHenknRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_SyuunouHenknRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKIT_SyuunouHenknRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKIT_SyuunouHenknRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_SyuunouHenknRireki
 * @see     QIT_SyuunouHenknRireki
 * @see     GenQIT_SyuunouHenknRireki
 */
@MappedSuperclass
@Table(name=GenIT_SyuunouHenknRireki.TABLE_NAME)
@IdClass(value=PKIT_SyuunouHenknRireki.class)
@TypeDefs({
...
public abstract class GenIT_SyuunouHenknRireki extends AbstractExDBEntity<IT_SyuunouHenknRireki, PKIT_SyuunouHenknRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_SyuunouHenknRireki";
    ...
    private final PKIT_SyuunouHenknRireki primaryKey;

    public GenIT_SyuunouHenknRireki() {
        primaryKey = new PKIT_SyuunouHenknRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_SyuunouHenknRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_SyuunouHenknRireki> getMetaClass() {
        return QIT_SyuunouHenknRireki.class;
    }

    @Id
    @Column(name=GenIT_SyuunouHenknRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_SyuunouHenknRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_SyuunouHenknRireki.DENRENNO)
    ...
    @Id
    @Column(name=GenIT_SyuunouHenknRireki.EDANO)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.DENKIHYOUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_SyuunouHenknRireki.SHRYMD)
    @ValidDate
    ...
    @Column(name=GenIT_SyuunouHenknRireki.KANJYOUKMKCD)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.SHRRIYUUKBN)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_SyuunouHenknRireki.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_SyuunouHenknRireki.YOKINKBN)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_SyuunouHenknRireki.CREDITCARDNO1)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.CREDITCARDNO2)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.CREDITCARDNO3)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.CREDITCARDNO4)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_SyuunouHenknRireki.CREDITKESSAIYOUNO)
