...
/**
 * 株価指数連動保険事業費Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KbkSsuRnduHknJigyohiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KbkSsuRnduHknJigyohiTy}</td><td colspan="3">株価指数連動保険事業費Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_KbkSsuRnduHknJigyohiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_KbkSsuRnduHknJigyohiTy
 * @see     PKZT_KbkSsuRnduHknJigyohiTy
 * @see     QZT_KbkSsuRnduHknJigyohiTy
 * @see     GenQZT_KbkSsuRnduHknJigyohiTy
 */
@MappedSuperclass
@Table(name=GenZT_KbkSsuRnduHknJigyohiTy.TABLE_NAME)
@IdClass(value=PKZT_KbkSsuRnduHknJigyohiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KbkSsuRnduHknJigyohiTy extends AbstractExDBEntity<ZT_KbkSsuRnduHknJigyohiTy, PKZT_KbkSsuRnduHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KbkSsuRnduHknJigyohiTy";
    ...
    private final PKZT_KbkSsuRnduHknJigyohiTy primaryKey;

    public GenZT_KbkSsuRnduHknJigyohiTy() {
        primaryKey = new PKZT_KbkSsuRnduHknJigyohiTy();
    }

    public GenZT_KbkSsuRnduHknJigyohiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_KbkSsuRnduHknJigyohiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_KbkSsuRnduHknJigyohiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KbkSsuRnduHknJigyohiTy> getMetaClass() {
        return QZT_KbkSsuRnduHknJigyohiTy.class;
    }

    @Id
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYLOADINGKEIJYOYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSIHANKIKSNYDATAHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYGMKIJYHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X18)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREILKISNYUKNGKX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X21)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREILKISNYUKNGKX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X23)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYRPKEISANYOUSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIKENS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREIALPHA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREIBETA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIKENP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYVHIREILRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYKIKENPRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYTUMIMASIMAEW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X27)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X28)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X29)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X30)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X31)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIN11X32)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiTy.ZTYYOBIV19)
