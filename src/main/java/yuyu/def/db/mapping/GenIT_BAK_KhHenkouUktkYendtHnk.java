...
import yuyu.def.db.id.PKIT_BAK_KhHenkouUktkYendtHnk;
...
/**
 * 契約保全変更受付内容（円建変更）バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhHenkouUktkYendtHnk} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhHenkouUktkYendtHnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhHenkouUktkYendtHnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhHenkouUktkYendtHnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHozenhenkouuktkrenno hozenhenkouuktkrenno}</td><td>保全変更受付連番</td><td align="center">{@link PKIT_BAK_KhHenkouUktkYendtHnk ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KhHenkouUktkYendtHnk
 * @see     QIT_BAK_KhHenkouUktkYendtHnk
 * @see     GenQIT_BAK_KhHenkouUktkYendtHnk
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhHenkouUktkYendtHnk.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhHenkouUktkYendtHnk.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhHenkouUktkYendtHnk extends AbstractExDBEntity<IT_BAK_KhHenkouUktkYendtHnk, PKIT_BAK_KhHenkouUktkYendtHnk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhHenkouUktkYendtHnk";
    ...
    private final PKIT_BAK_KhHenkouUktkYendtHnk primaryKey;

    public GenIT_BAK_KhHenkouUktkYendtHnk() {
        primaryKey = new PKIT_BAK_KhHenkouUktkYendtHnk();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhHenkouUktkYendtHnk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhHenkouUktkYendtHnk> getMetaClass() {
        return QIT_BAK_KhHenkouUktkYendtHnk.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.HOZENHENKOUUKTKRENNO)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.YENDTHNKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.MKHGKTTTYMD)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NYUURYOKUHASSOUKBN)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.HNSKARIYUU1)
    ...
    @Type(type="UserType_C_HnskariyuuKbn")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.HNSKARIYUU2)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.YENDTHNKJIKWSRATE)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWSYOUHNCD)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWSYOUHNSDNO)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWKYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWRYOURITUSDNO)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.SYORUIUKEYMD)
    @ValidDate
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.NEWYOTEIRIRITU)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.TARGETTKMOKUHYOUTI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.YENDTHNKJISJKKKTYOUSEIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.YENDTHNKJIKAIYAKUKOUJYORITU)
    ...
    @Column(name=GenIT_BAK_KhHenkouUktkYendtHnk.KAIYAKUKOUJYORITUTEKIUMU)
