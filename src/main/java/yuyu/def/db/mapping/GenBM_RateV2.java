...
/**
 * Ｖレートマスタ２ テーブルのマッピング情報クラスで、 {@link BM_RateV2} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_RateV2}</td><td colspan="3">Ｖレートマスタ２</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getPalhokensyuruikigou palhokensyuruikigou}</td><td>ＰＡＬ保険種類記号</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhokensyuruikigousdicode palhokensyuruikigousdicode}</td><td>ＰＡＬ保険種類記号世代コード</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalyoteiriritu palyoteiriritu}</td><td>ＰＡＬ予定利率</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalpmencode palpmencode}</td><td>ＰＡＬＰ免コード</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalharaikomikaisuu palharaikomikaisuu}</td><td>ＰＡＬ払込回数</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhhknsei palhhknsei}</td><td>ＰＡＬ被保険者性別</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalkeiyakujihhknnen palkeiyakujihhknnen}</td><td>ＰＡＬ契約時被保険者年令</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalsaimankihyouji palsaimankihyouji}</td><td>ＰＡＬ才満期契約表示</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhokenkikan palhokenkikan}</td><td>ＰＡＬ保険期間</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalpharaikomikikan palpharaikomikikan}</td><td>ＰＡＬＰ払込期間</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalannaihuyouriyuukbn palannaihuyouriyuukbn}</td><td>ＰＡＬ案内不要理由区分</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getRatetuukasyukbn ratetuukasyukbn}</td><td>レート用通貨種類区分</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getRatedai1hknkkn ratedai1hknkkn}</td><td>レート用第１保険期間</td><td align="center">{@link PKBM_RateV2 ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBM_RateV2.TABLE_NAME)
@IdClass(value=PKBM_RateV2.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBM_RateV2 extends AbstractExDBEntity<BM_RateV2, PKBM_RateV2> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_RateV2";
    ...
    private final PKBM_RateV2 primaryKey;

    public GenBM_RateV2() {
        primaryKey = new PKBM_RateV2();
    }
    ...
    @Transient
    @Override
    public PKBM_RateV2 getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_RateV2> getMetaClass() {
        return QBM_RateV2.class;
    }

    @Id
    @Column(name=GenBM_RateV2.PALHOKENSYURUIKIGOU)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALHOKENSYURUIKIGOUSDICODE)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALYOTEIRIRITU)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALPMENCODE)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALHARAIKOMIKAISUU)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALHHKNSEI)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALKEIYAKUJIHHKNNEN)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALSAIMANKIHYOUJI)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALHOKENKIKAN)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALPHARAIKOMIKIKAN)
    ...
    @Id
    @Column(name=GenBM_RateV2.PALANNAIHUYOURIYUUKBN)
    ...
    @Id
    @Column(name=GenBM_RateV2.RATETUUKASYUKBN)
    ...
    @Id
    @Column(name=GenBM_RateV2.RATEDAI1HKNKKN)
    ...
    @Column(name=GenBM_RateV2.VRATE00)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE01)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE02)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE03)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE04)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE05)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE06)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE07)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE08)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE09)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE16)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE18)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE19)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE20)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE21)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE22)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE23)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE24)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE25)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE26)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE27)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE28)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE29)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE30)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE31)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE32)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE33)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE34)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE35)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE36)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE37)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE38)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE39)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE40)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE41)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE42)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE43)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE44)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE45)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE46)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE47)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE48)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE49)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE50)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE51)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE52)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE53)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE54)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE55)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE56)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE57)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE58)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE59)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE60)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE61)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE62)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE63)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE64)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE65)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE66)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE67)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE68)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE69)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE70)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE71)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE72)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE73)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE74)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE75)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE76)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE77)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE78)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE79)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE80)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE81)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE82)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE83)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE84)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE85)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE86)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE87)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE88)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE89)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE90)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE91)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE92)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE93)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE94)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE95)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE96)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE97)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE98)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RateV2.VRATE99)
