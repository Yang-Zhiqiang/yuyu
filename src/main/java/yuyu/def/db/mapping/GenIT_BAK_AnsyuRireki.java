...
import yuyu.def.db.id.PKIT_BAK_AnsyuRireki;
import yuyu.def.db.meta.GenQIT_BAK_AnsyuRireki;
...
/**
 * 案内収納履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_AnsyuRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_AnsyuRireki}</td><td colspan="3">案内収納履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getNyknaiyoukbn nyknaiyoukbn}</td><td>入金内容区分</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">V</td><td>{@link C_NyknaiyouKbn}</td></tr>
 *  <tr><td>{@link #getJyuutouym jyuutouym}</td><td>充当年月</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">V</td><td>BizDateYM</td></tr>
 *  <tr><td>{@link #getAnnaino annaino}</td><td>案内番号</td><td align="center">{@link PKIT_BAK_AnsyuRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_AnsyuRireki
 * @see     PKIT_BAK_AnsyuRireki
 * @see     QIT_BAK_AnsyuRireki
 * @see     GenQIT_BAK_AnsyuRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_AnsyuRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_AnsyuRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_AnsyuRireki extends AbstractExDBEntity<IT_BAK_AnsyuRireki, PKIT_BAK_AnsyuRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_AnsyuRireki";
    ...
    private final PKIT_BAK_AnsyuRireki primaryKey;

    public GenIT_BAK_AnsyuRireki() {
        primaryKey = new PKIT_BAK_AnsyuRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_AnsyuRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_AnsyuRireki> getMetaClass() {
        return QIT_BAK_AnsyuRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_AnsyuRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_AnsyuRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_AnsyuRireki.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.JYUUTOUYM)
    @ValidDateYm
    ...
    @Id
    @Column(name=GenIT_BAK_AnsyuRireki.ANNAINO)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.NYKKEIRO)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.RSTUUKASYU)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.RYOSYUKWSRATEKJYMD)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.RYOSYUKWSRATE)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.ANNAIJKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.ANNAISAKUSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.NYKSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.MINYUSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.DATTAIUKTKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.HURIKAEYMD)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.HURIHUNOKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.URIAGEYMDKON)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.KRKKEIJYOFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.KRKKEIJYOYMD)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.KRKNO)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.HRKKEIRO)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.HRKKAISUU)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_AnsyuRireki.JKIPJYTYM)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.SYUUDAIKOCD)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.SINKEIZKKBN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.SYUYAKUKYOHIKBN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CARDKAISYACD)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITCARDNO1)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITCARDNO2)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITCARDNO3)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITCARDNO4)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.YUKOUKACHKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.AUTHORIKANRYOYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.URIAGEYMDZEN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_AnsyuRireki.HRKKIGEN)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.MINYUTUUTIZUMIFLG)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.CREDITURIAGENGJIYUU)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_AnsyuRireki.GYOUMUKOUSINTIME)
