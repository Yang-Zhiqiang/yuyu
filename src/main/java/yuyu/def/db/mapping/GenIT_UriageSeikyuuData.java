...
import yuyu.def.db.id.PKIT_UriageSeikyuuData;
...
/**
 * 売上請求データテーブル テーブルのマッピング情報クラスで、 {@link IT_UriageSeikyuuData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_UriageSeikyuuData}</td><td colspan="3">売上請求データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_UriageSeikyuuData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_UriageSeikyuuData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getCreditkessaiyouno creditkessaiyouno}</td><td>クレジットカード決済用番号</td><td align="center">{@link PKIT_UriageSeikyuuData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUriagenengappi uriagenengappi}</td><td>売上年月日</td><td align="center">{@link PKIT_UriageSeikyuuData ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKIT_UriageSeikyuuData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_UriageSeikyuuData
 * @see     QIT_UriageSeikyuuData
 * @see     GenQIT_UriageSeikyuuData
 */
@MappedSuperclass
@Table(name=GenIT_UriageSeikyuuData.TABLE_NAME)
@IdClass(value=PKIT_UriageSeikyuuData.class)
@TypeDefs({
...
public abstract class GenIT_UriageSeikyuuData extends AbstractExDBEntity<IT_UriageSeikyuuData, PKIT_UriageSeikyuuData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_UriageSeikyuuData";
    ...
    private final PKIT_UriageSeikyuuData primaryKey;

    public GenIT_UriageSeikyuuData() {
        primaryKey = new PKIT_UriageSeikyuuData();
    }
    ...
    @Transient
    @Override
    public PKIT_UriageSeikyuuData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_UriageSeikyuuData> getMetaClass() {
        return QIT_UriageSeikyuuData.class;
    }

    @Id
    @Column(name=GenIT_UriageSeikyuuData.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_UriageSeikyuuData.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_UriageSeikyuuData.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_UriageSeikyuuData.URIAGENENGAPPI)
    ...
    @Id
    @Column(name=GenIT_UriageSeikyuuData.RENNO3KETA)
    ...
    @Column(name=GenIT_UriageSeikyuuData.RECORDNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_UriageSeikyuuData.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_UriageSeikyuuData.CREDITURIAGESEIKYUUKBN)
    ...
    @Column(name=GenIT_UriageSeikyuuData.AUTHORIKBN)
    ...
    @Column(name=GenIT_UriageSeikyuuData.FUKUSUUKAMEITENNOKEY)
    ...
    @Column(name=GenIT_UriageSeikyuuData.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_UriageSeikyuuData.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_UriageSeikyuuData.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_UriageSeikyuuData.HRKKAISUU)
    ...
    @Column(name=GenIT_UriageSeikyuuData.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_UriageSeikyuuData.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_UriageSeikyuuData.ANNAINO)
    ...
    @Column(name=GenIT_UriageSeikyuuData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_UriageSeikyuuData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_UriageSeikyuuData.GYOUMUKOUSINTIME)
