...
/**
 * ＳＰ２連動用総成立Fテーブル３（中） テーブルのマッピング情報クラスで、 {@link ZT_Sp2RnduyuSouseiritu3Ty} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_Sp2RnduyuSouseiritu3Ty}</td><td colspan="3">ＳＰ２連動用総成立Fテーブル３（中）</td></tr>
 ...
 *  <tr><td>{@link #getZtyktgysyono ztyktgysyono}</td><td>（中継用）結合用証券番号</td><td align="center">{@link PKZT_Sp2RnduyuSouseiritu3Ty ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_Sp2RnduyuSouseiritu3Ty
 * @see     PKZT_Sp2RnduyuSouseiritu3Ty
 * @see     QZT_Sp2RnduyuSouseiritu3Ty
 * @see     GenQZT_Sp2RnduyuSouseiritu3Ty
 */
@MappedSuperclass
@Table(name=GenZT_Sp2RnduyuSouseiritu3Ty.TABLE_NAME)
@IdClass(value=PKZT_Sp2RnduyuSouseiritu3Ty.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Sp2RnduyuSouseiritu3Ty extends AbstractExDBEntity<ZT_Sp2RnduyuSouseiritu3Ty, PKZT_Sp2RnduyuSouseiritu3Ty> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Sp2RnduyuSouseiritu3Ty";
    ...
    private final PKZT_Sp2RnduyuSouseiritu3Ty primaryKey;

    public GenZT_Sp2RnduyuSouseiritu3Ty() {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu3Ty();
    }

    public GenZT_Sp2RnduyuSouseiritu3Ty(String pZtyktgysyono) {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu3Ty(pZtyktgysyono);
    }

    @Transient
    @Override
    public PKZT_Sp2RnduyuSouseiritu3Ty getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Sp2RnduyuSouseiritu3Ty> getMetaClass() {
        return QZT_Sp2RnduyuSouseiritu3Ty.class;
    }

    private String ztyktgysyrymd;

    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKTGYSYONO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKTGYFILERENNO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBOSYUUKEIROKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSYOKAIPCASHLESSNYUKINHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKIGKYHSITIHSYUTKYKARIHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSYOKAIPSWINGRIYOUKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBOSYUUDAIRITENGYOUSYUKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYCIFCD)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYTOKUSYUJIMUTORIATUKAIKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYPMENTKYKYUTKTBICDX1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYPMENTKYKYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYPMENTKYKYUTKTBICDX2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYPMENTKYKYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHSYUIKKTMNOSDFNYUKNHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYIKKTMNOSKIKIYUTKYKP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYIKKTMNOSKIKIYUFNDSISTP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKANYUJISYONO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKSNYUHSYUIKKTMINOSNNSKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYAATUKAISYADIRTNBSYNNHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBATKISYADIRTNBOSYUNINHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYDIRTNAATUKAISYAKOJINCD)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYDIRTNBATUKAISYAKOJINCD)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSYUUSEISYOUKEIKANENSUU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSYURUIHNKUTKBTTRTKHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKTKYKHKJYUTIKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYTNKNSYOKAIPCLESSRIYOUHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHRKTEISIKIBOUHYOUJI)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBUNKATUGOSONZOKUKEIYAKUS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYMOSKIZKPHRKEKNGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYKEIZOKUPHURIKAEJIJIKAIP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKSYONO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBUNKATUMAEKEIYAKUKIHONS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBUNKATUMAEKEIYAKUSIBOUS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKMODS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKSIGIWRMSTKYKS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKSYUGITKYKS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMKYKSIGINYINTKYKNTGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKKNKUTKYKNTGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKHNTIYUNBRIKNSNP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYDAI2NAIBUWARIMODOSIGAKU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYTNKNGKYKKSTKGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYBNKTMEKYKKSTKGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYSONZOKUKYKKASITUKEGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHNGKMNRYOUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX1X1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX2X1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX3X1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX4X1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX5X1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX1X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX2X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX3X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX4X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX5X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX1X3)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX2X3)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX3X3)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX4X3)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX5X3)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX1X4)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX2X4)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX3X4)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX4X4)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX5X4)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX1X5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX2X5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX3X5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYBX4X5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu3Ty.ZTYHTNKNKIGMRSYUKGUYB