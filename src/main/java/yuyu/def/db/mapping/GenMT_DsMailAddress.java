...
import yuyu.def.db.id.PKMT_DsMailAddress;
...
/**
 * ＤＳメールアドレステーブル テーブルのマッピング情報クラスで、 {@link MT_DsMailAddress} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link MT_DsMailAddress}</td><td colspan="3">ＤＳメールアドレステーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDskokno dskokno}</td><td>ＤＳ顧客番号</td><td align="center">{@link PKMT_DsMailAddress ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDsmailaddressrenban dsmailaddressrenban}</td><td>ＤＳメールアドレス連番</td><td align="center">{@link PKMT_DsMailAddress ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKMT_DsMailAddress
 * @see     QMT_DsMailAddress
 * @see     GenQMT_DsMailAddress
 */
@MappedSuperclass
@Table(name=GenMT_DsMailAddress.TABLE_NAME)
@IdClass(value=PKMT_DsMailAddress.class)
@TypeDefs({
...
public abstract class GenMT_DsMailAddress extends AbstractExDBEntity<MT_DsMailAddress, PKMT_DsMailAddress> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MT_DsMailAddress";
    ...
    private final PKMT_DsMailAddress primaryKey;

    public GenMT_DsMailAddress() {
        primaryKey = new PKMT_DsMailAddress();
    }

    public GenMT_DsMailAddress(String pDskokno, Integer pDsmailaddressrenban) {
        primaryKey = new PKMT_DsMailAddress(pDskokno, pDsmailaddressrenban);
    }

    @Transient
    @Override
    public PKMT_DsMailAddress getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMT_DsMailAddress> getMetaClass() {
        return QMT_DsMailAddress.class;
    }

    @Id
    @Column(name=GenMT_DsMailAddress.DSKOKNO)
    ...
    @Id
    @Column(name=GenMT_DsMailAddress.DSMAILADDRESSRENBAN)
    ...
    @Column(name=GenMT_DsMailAddress.DSMAILTOUROKUJYOUTAIKBN)
    ...
    @Column(name=GenMT_DsMailAddress.DSMAILADDRESS)
    @MaxLength(max=100)
    @SingleByteStrings
    ...
    @Column(name=GenMT_DsMailAddress.DSMAILSOUSINJYOUTAIKBN)
    ...
    @Column(name=GenMT_DsMailAddress.DSMAILSOUSINTISRYKBN)
    ...
    @Column(name=GenMT_DsMailAddress.DSTOUROKUYMDTIME)
    ...
    @Column(name=GenMT_DsMailAddress.DSKOUSINYMDTIME)
    ...
    @Column(name=GenMT_DsMailAddress.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMT_DsMailAddress.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenMT_DsMailAddress.GYOUMUKOUSINTIME)
