...
import yuyu.def.db.id.PKIT_BAK_KhHenkouRireki;
...
/**
 * 契約保全変更履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhHenkouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhHenkouRireki}</td><td colspan="3">契約保全変更履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_KhHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKIT_BAK_KhHenkouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KhHenkouRireki
 * @see     QIT_BAK_KhHenkouRireki
 * @see     GenQIT_BAK_KhHenkouRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhHenkouRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhHenkouRireki.class)
@TypeDefs({
    @TypeDef(name="UserType_C_HnkSyuruiKbn", typeClass=UserType_C_HnkSyuruiKbn.class)
})
public abstract class GenIT_BAK_KhHenkouRireki extends AbstractExDBEntity<IT_BAK_KhHenkouRireki, PKIT_BAK_KhHenkouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhHenkouRireki";
    ...
    private final PKIT_BAK_KhHenkouRireki primaryKey;

    public GenIT_BAK_KhHenkouRireki() {
        primaryKey = new PKIT_BAK_KhHenkouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhHenkouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhHenkouRireki> getMetaClass() {
        return QIT_BAK_KhHenkouRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhHenkouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouRireki.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouRireki.HENKOUSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHenkouRireki.RENNO3KETA)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.TABLENM)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.TABLEID)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.HNKSYURUIKBN)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.HANBETUKOUMOKUNM)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.HENKOUKOUMOKUID)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.HENKOUKOUMOKUNM)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.BFRNAIYOUORIGINAL)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.BFRNAIYOU)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.NEWNAIYOUORIGINAL)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.NEWNAIYOU)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhHenkouRireki.GYOUMUKOUSINTIME)
