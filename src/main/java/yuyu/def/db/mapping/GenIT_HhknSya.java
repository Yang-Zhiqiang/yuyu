...
import yuyu.def.db.id.PKIT_HhknSya;
import yuyu.def.db.meta.GenQIT_HhknSya;
...
/**
 * 被保険者テーブル テーブルのマッピング情報クラスで、 {@link IT_HhknSya} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_HhknSya}</td><td colspan="3">被保険者テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_HhknSya ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_HhknSya ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_HhknSya.TABLE_NAME)
@IdClass(value=PKIT_HhknSya.class)
@TypeDefs({
...
public abstract class GenIT_HhknSya extends AbstractExDBEntity<IT_HhknSya, PKIT_HhknSya> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_HhknSya";
    ...
    private final PKIT_HhknSya primaryKey;

    public GenIT_HhknSya() {
        primaryKey = new PKIT_HhknSya();
    }

    public GenIT_HhknSya(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_HhknSya(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_HhknSya getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_HhknSya> getMetaClass() {
        return QIT_HhknSya.class;
    }

    @Id
    @Column(name=GenIT_HhknSya.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_HhknSya.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_HhknSya.KOKNO)
    ...
    @Column(name=GenIT_HhknSya.HHKNSAKUINMEINO)
    ...
    @Column(name=GenIT_HhknSya.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNNMKJKHUKAKBN)
    ...
    @Column(name=GenIT_HhknSya.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_HhknSya.HHKNSEI)
    ...
    @Column(name=GenIT_HhknSya.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_HhknSya.HHKNADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HhknSya.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_HhknSya.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_HhknSya.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_HhknSya.GYOUMUKOUSINTIME)
