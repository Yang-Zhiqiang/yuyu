...
/**
 * ＳＰ２連動用総成立Fテーブル６（連） テーブルのマッピング情報クラスで、 {@link ZT_Sp2RnduyuSouseiritu6Rn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnktgysyono zrnktgysyono}</td><td>（連携用）結合用証券番号</td><td align="center">{@link PKZT_Sp2RnduyuSouseiritu6Rn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_Sp2RnduyuSouseiritu6Rn.TABLE_NAME)
@IdClass(value=PKZT_Sp2RnduyuSouseiritu6Rn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Sp2RnduyuSouseiritu6Rn extends AbstractExDBEntityForZDB<ZT_Sp2RnduyuSouseiritu6Rn, PKZT_Sp2RnduyuSouseiritu6Rn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Sp2RnduyuSouseiritu6Rn";
    ...
    private final PKZT_Sp2RnduyuSouseiritu6Rn primaryKey;

    public GenZT_Sp2RnduyuSouseiritu6Rn() {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu6Rn();
    }

    public GenZT_Sp2RnduyuSouseiritu6Rn(String pZrnktgysyono) {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu6Rn(pZrnktgysyono);
    }

    @Transient
    @Override
    public PKZT_Sp2RnduyuSouseiritu6Rn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Sp2RnduyuSouseiritu6Rn> getMetaClass() {
        return QZT_Sp2RnduyuSouseiritu6Rn.class;
    }

    private String zrnktgysyrymd;

    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKTGYSYONO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKTGYFILERENNO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNGAIKAKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSIBOUHYOUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNHTNKNKYKLIVEONEARHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNLIVEONEPACKAGESYOUHINKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNHTNKNGUKISISTTKKNSNP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSUURIYOUYOBIN10X3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKYKYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNRENDOURITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNYOBIN5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNYOBIN5X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNYOBIV10X6)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNTIRTTMTTTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNNKSJITIRTTMTTKN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNNENDOMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Rn.ZRNYOBIV16)
