...
/**
 * ＳＭＢＣペーパーレス申込情報１テーブル（取） テーブルのマッピング情報クラスで、 {@link ZT_SmbcPaperlessMos1Tr} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SmbcPaperlessMos1Tr}</td><td colspan="3">ＳＭＢＣペーパーレス申込情報１テーブル（取）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtrseihowebidkbn ztrseihowebidkbn}</td><td>（取込用）生保ＷｅｂＩＤ区分</td><td align="center">{@link PKZT_SmbcPaperlessMos1Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebkojincd ztrseihowebkojincd}</td><td>（取込用）生保Ｗｅｂ個人コード</td><td align="center">{@link PKZT_SmbcPaperlessMos1Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebitijihozonhyouji ztrseihowebitijihozonhyouji}</td><td>（取込用）生保Ｗｅｂ一時保存表示</td><td align="center">{@link PKZT_SmbcPaperlessMos1Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebseknoc ztrseihowebseknoc}</td><td>（取込用）生保Ｗｅｂ設計書番号Ｃ</td><td align="center">{@link PKZT_SmbcPaperlessMos1Tr ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_SmbcPaperlessMos1Tr
 * @see     PKZT_SmbcPaperlessMos1Tr
 * @see     QZT_SmbcPaperlessMos1Tr
 * @see     GenQZT_SmbcPaperlessMos1Tr
 */
@MappedSuperclass
@Table(name=GenZT_SmbcPaperlessMos1Tr.TABLE_NAME)
@IdClass(value=PKZT_SmbcPaperlessMos1Tr.class)
public abstract class GenZT_SmbcPaperlessMos1Tr extends AbstractExDBEntity<ZT_SmbcPaperlessMos1Tr, PKZT_SmbcPaperlessMos1Tr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SmbcPaperlessMos1Tr";
    ...
    private final PKZT_SmbcPaperlessMos1Tr primaryKey;

    public GenZT_SmbcPaperlessMos1Tr() {
        primaryKey = new PKZT_SmbcPaperlessMos1Tr();
    }
    ...
    @Transient
    @Override
    public PKZT_SmbcPaperlessMos1Tr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SmbcPaperlessMos1Tr> getMetaClass() {
        return QZT_SmbcPaperlessMos1Tr.class;
    }

    @Id
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBIDKBN)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKOJINCD)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBITIJIHOZONHYOUJI)
    ...
    @Id
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSEKNOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBCALCKIJYUNYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNKNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNSEIYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNSEIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKYKKNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKYKSYASEIYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKYKSYASEIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHKNSYURUINOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHKNKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBPHRKKIKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSDPDKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKIHONSC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBNKSYURUIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBLNTKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBNKSHRARIHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBMOSNOC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSEKYKKIGENYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSKSJSITENCD)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBFSTMOSSKSYMDC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHNSYUKYKTDKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHJNKYKHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKSYKMCD1)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKSYKMCD2)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKSYKMCD3)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKSYKMCD4)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKSYKMCD5)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTEIWKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKNHJNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKJHJNNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKNDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKJDAIHYOUNM)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBDAIHYOUKTGKKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSYKIHRKP1C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBMOSP1C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBTKIYOUGYOUTAIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBZENNOUKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBPAPERLESSMOSHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBDATASOUSINZMHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBKYKOTTMSK)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNSYKGYCD)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNOTTMSK)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBHHKNNENSYUUKBN)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTHKSUNINZUUC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTBNWARI1C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTTDKKBN2)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKNNM2)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKJNM2)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTSEIYMD2C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTBNWARI2C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTTDKKBN3)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKNNM3)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKJNM3)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTSEIYMD3C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTBNWARI3C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTTDKKBN4)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKNNM4)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTKJNM4)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTSEIYMD4C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBUKTBNWARI4C)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBNKUKTMRHHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBSBNKKKNC)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWEBIKOKAKKJARIHYJ)
    ...
    @Column(name=GenZT_SmbcPaperlessMos1Tr.ZTRSEIHOWE