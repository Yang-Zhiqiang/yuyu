...
/**
 * 決算計上用株価指数連動保険事業費Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KsnKbkSsuRnduHknJigyohiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KsnKbkSsuRnduHknJigyohiTy}</td><td colspan="3">決算計上用株価指数連動保険事業費Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_KsnKbkSsuRnduHknJigyohiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 *  <tr><td>{@link #getZtyloadingkeijyoym ztyloadingkeijyoym}</td><td>（中継用）ローディング計上年月</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysihankiksnydatahyj ztysihankiksnydatahyj}</td><td>（中継用）四半期決算用データ表示</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtygmkijyhyj ztygmkijyhyj}</td><td>（中継用）月末計上表示</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtyyobin11x18 ztyyobin11x18}</td><td>（中継用）予備項目Ｎ１１＿１８</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtyvhireilkisnyukngkx1 ztyvhireilkisnyukngkx1}</td><td>（中継用）Ｖ比例Ｌ計算用金額＿１</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZtyvhireilkisnyukngkx2 ztyvhireilkisnyukngkx2}</td><td>（中継用）Ｖ比例Ｌ計算用金額＿２</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZtyrpkeisanyousibous ztyrpkeisanyousibous}</td><td>（中継用）ＲＰ計算用死亡Ｓ</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtykikens ztykikens}</td><td>（中継用）危険保険金</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtyvhireialpha ztyvhireialpha}</td><td>（中継用）Ｖ比例α</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtyvhireibeta ztyvhireibeta}</td><td>（中継用）Ｖ比例β</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtykikenp ztykikenp}</td><td>（中継用）危険保険料</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZtykikenpritu ztykikenpritu}</td><td>（中継用）危険保険料率</td><td align="center">&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getZtytumimasimaew ztytumimasimaew}</td><td>（中継用）積増前Ｗ</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 * </table>
 * @see     ZT_KsnKbkSsuRnduHknJigyohiTy
 * @see     PKZT_KsnKbkSsuRnduHknJigyohiTy
 * @see     QZT_KsnKbkSsuRnduHknJigyohiTy
 * @see     GenQZT_KsnKbkSsuRnduHknJigyohiTy
 */
@MappedSuperclass
@Table(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.TABLE_NAME)
@IdClass(value=PKZT_KsnKbkSsuRnduHknJigyohiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KsnKbkSsuRnduHknJigyohiTy extends AbstractExDBEntity<ZT_KsnKbkSsuRnduHknJigyohiTy, PKZT_KsnKbkSsuRnduHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KsnKbkSsuRnduHknJigyohiTy";
    ...
    public static final String ZTYLOADINGKEIJYOYM       = "ztyloadingkeijyoym";
    public static final String ZTYSIHANKIKSNYDATAHYJ    = "ztysihankiksnydatahyj";
    public static final String ZTYGMKIJYHYJ             = "ztygmkijyhyj";
    public static final String ZTYSUURIYOUYOBIN12       = "ztysuuriyouyobin12";
    public static final String ZTYYOBIV20               = "ztyyobiv20";
    public static final String ZTYYOBIN11X18            = "ztyyobin11x18";
    public static final String ZTYVHIREILKISNYUKNGKX1   = "ztyvhireilkisnyukngkx1";
    ...
    public static final String ZTYVHIREILKISNYUKNGKX2   = "ztyvhireilkisnyukngkx2";
    public static final String ZTYYOBIN11X22            = "ztyyobin11x22";
    public static final String ZTYYOBIN11X23            = "ztyyobin11x23";
    public static final String ZTYRPKEISANYOUSIBOUS     = "ztyrpkeisanyousibous";
    public static final String ZTYKIKENS                = "ztykikens";
    public static final String ZTYVHIREIALPHA           = "ztyvhireialpha";
    public static final String ZTYVHIREIBETA            = "ztyvhireibeta";
    public static final String ZTYKIKENP                = "ztykikenp";
    public static final String ZTYVHIREILRITU           = "ztyvhireilritu";
    public static final String ZTYKIKENPRITU            = "ztykikenpritu";
    public static final String ZTYTUMIMASIMAEW          = "ztytumimasimaew";
    ...
    private final PKZT_KsnKbkSsuRnduHknJigyohiTy primaryKey;

    public GenZT_KsnKbkSsuRnduHknJigyohiTy() {
        primaryKey = new PKZT_KsnKbkSsuRnduHknJigyohiTy();
    }

    public GenZT_KsnKbkSsuRnduHknJigyohiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_KsnKbkSsuRnduHknJigyohiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_KsnKbkSsuRnduHknJigyohiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KsnKbkSsuRnduHknJigyohiTy> getMetaClass() {
        return QZT_KsnKbkSsuRnduHknJigyohiTy.class;
    }

    @Id
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV14)
    ...
    private String ztyloadingkeijyoym;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYLOADINGKEIJYOYM)
    public String getZtyloadingkeijyoym() {
        return ztyloadingkeijyoym;
    }

    public void setZtyloadingkeijyoym(String pZtyloadingkeijyoym) {
        ztyloadingkeijyoym = pZtyloadingkeijyoym;
    }

    private String ztysihankiksnydatahyj;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSIHANKIKSNYDATAHYJ)
    public String getZtysihankiksnydatahyj() {
        return ztysihankiksnydatahyj;
    }

    public void setZtysihankiksnydatahyj(String pZtysihankiksnydatahyj) {
        ztysihankiksnydatahyj = pZtysihankiksnydatahyj;
    }

    private String ztygmkijyhyj;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYGMKIJYHYJ)
    public String getZtygmkijyhyj() {
        return ztygmkijyhyj;
    }

    public void setZtygmkijyhyj(String pZtygmkijyhyj) {
        ztygmkijyhyj = pZtygmkijyhyj;
    }

    private String ztysuuriyouyobin12;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV20)
    ...
    private Long ztyyobin11x18;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X18)
    public Long getZtyyobin11x18() {
        return ztyyobin11x18;
    }

    public void setZtyyobin11x18(Long pZtyyobin11x18) {
        ztyyobin11x18 = pZtyyobin11x18;
    }

    private Long ztyvhireilkisnyukngkx1;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREILKISNYUKNGKX1)
    public Long getZtyvhireilkisnyukngkx1() {
        return ztyvhireilkisnyukngkx1;
    }

    public void setZtyvhireilkisnyukngkx1(Long pZtyvhireilkisnyukngkx1) {
        ztyvhireilkisnyukngkx1 = pZtyvhireilkisnyukngkx1;
    }

    private Long ztyyobin11x19;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X21)
    ...
    private Long ztyvhireilkisnyukngkx2;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREILKISNYUKNGKX2)
    public Long getZtyvhireilkisnyukngkx2() {
        return ztyvhireilkisnyukngkx2;
    }

    public void setZtyvhireilkisnyukngkx2(Long pZtyvhireilkisnyukngkx2) {
        ztyvhireilkisnyukngkx2 = pZtyvhireilkisnyukngkx2;
    }

    private Long ztyyobin11x22;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X23)
    ...
    private Long ztyrpkeisanyousibous;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYRPKEISANYOUSIBOUS)
    public Long getZtyrpkeisanyousibous() {
        return ztyrpkeisanyousibous;
    }

    public void setZtyrpkeisanyousibous(Long pZtyrpkeisanyousibous) {
        ztyrpkeisanyousibous = pZtyrpkeisanyousibous;
    }

    private Long ztykikens;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIKENS)
    public Long getZtykikens() {
        return ztykikens;
    }

    public void setZtykikens(Long pZtykikens) {
        ztykikens = pZtykikens;
    }

    private Long ztyvhireialpha;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREIALPHA)
    public Long getZtyvhireialpha() {
        return ztyvhireialpha;
    }

    public void setZtyvhireialpha(Long pZtyvhireialpha) {
        ztyvhireialpha = pZtyvhireialpha;
    }

    private Long ztyvhireibeta;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREIBETA)
    public Long getZtyvhireibeta() {
        return ztyvhireibeta;
    }

    public void setZtyvhireibeta(Long pZtyvhireibeta) {
        ztyvhireibeta = pZtyvhireibeta;
    }

    private Long ztykikenp;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIKENP)
    public Long getZtykikenp() {
        return ztykikenp;
    }

    public void setZtykikenp(Long pZtykikenp) {
        ztykikenp = pZtykikenp;
    }

    private BizNumber ztyvhireilritu;

    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYVHIREILRITU)
    ...
    private BizNumber ztykikenpritu;

    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYKIKENPRITU)
    public BizNumber getZtykikenpritu() {
        return ztykikenpritu;
    }

    public void setZtykikenpritu(BizNumber pZtykikenpritu) {
        ztykikenpritu = pZtykikenpritu;
    }

    private Long ztytumimasimaew;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYTUMIMASIMAEW)
    public Long getZtytumimasimaew() {
        return ztytumimasimaew;
    }

    public void setZtytumimasimaew(Long pZtytumimasimaew) {
        ztytumimasimaew = pZtytumimasimaew;
    }

    private Long ztyyobin11x25;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X27)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X28)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X29)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X30)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X31)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIN11X32)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiTy.ZTYYOBIV19)
