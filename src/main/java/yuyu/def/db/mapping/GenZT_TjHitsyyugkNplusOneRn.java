...
/**
 * 通常配当所要額Ｆ（Ｎ＋１）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusOneRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusOneRn}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋１）テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusOneRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusOneRn
 * @see     PKZT_TjHitsyyugkNplusOneRn
 * @see     QZT_TjHitsyyugkNplusOneRn
 * @see     GenQZT_TjHitsyyugkNplusOneRn
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusOneRn.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusOneRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusOneRn extends AbstractExDBEntityForZDB<ZT_TjHitsyyugkNplusOneRn, PKZT_TjHitsyyugkNplusOneRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusOneRn";
    ...
    private final PKZT_TjHitsyyugkNplusOneRn primaryKey;

    public GenZT_TjHitsyyugkNplusOneRn() {
        primaryKey = new PKZT_TjHitsyyugkNplusOneRn();
    }

    public GenZT_TjHitsyyugkNplusOneRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusOneRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusOneRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusOneRn> getMetaClass() {
        return QZT_TjHitsyyugkNplusOneRn.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusOneRn.ZRNTOKUYAKUKOUMOKUV180X50)
