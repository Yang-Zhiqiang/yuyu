...
/**
 * ＤＳ値動き判定結果ワークテーブル テーブルのマッピング情報クラスで、 {@link MW_DsNeugokiHanteiKekkaWk} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getDsdatasakuseiymd dsdatasakuseiymd}</td><td>ＤＳデータ作成日</td><td align="center">{@link PKMW_DsNeugokiHanteiKekkaWk ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKMW_DsNeugokiHanteiKekkaWk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenMW_DsNeugokiHanteiKekkaWk.TABLE_NAME)
@IdClass(value=PKMW_DsNeugokiHanteiKekkaWk.class)
@TypeDefs({
...
public abstract class GenMW_DsNeugokiHanteiKekkaWk extends AbstractExDBEntity<MW_DsNeugokiHanteiKekkaWk, PKMW_DsNeugokiHanteiKekkaWk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MW_DsNeugokiHanteiKekkaWk";
    ...
    private final PKMW_DsNeugokiHanteiKekkaWk primaryKey;

    public GenMW_DsNeugokiHanteiKekkaWk() {
        primaryKey = new PKMW_DsNeugokiHanteiKekkaWk();
    }

    public GenMW_DsNeugokiHanteiKekkaWk(BizDate pDsdatasakuseiymd, String pSyono) {
        primaryKey = new PKMW_DsNeugokiHanteiKekkaWk(pDsdatasakuseiymd, pSyono);
    }

    @Transient
    @Override
    public PKMW_DsNeugokiHanteiKekkaWk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMW_DsNeugokiHanteiKekkaWk> getMetaClass() {
        return QMW_DsNeugokiHanteiKekkaWk.class;
    }

    @Id
    @Type(type="BizDateType")
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.DSDATASAKUSEIYMD)
    ...
    @Id
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.DSKOKNO)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.DSMAILADDRESSRENBAN)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.KYKYMD)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.BOSYUUJIAATUKAIDRTENCD)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.BOSYUUJIBATUKAIDRTENCD)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.AISYOUMEIKBN)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.KYKTUUKASYU)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.NEUGOKIWARI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.NEUGOKITOUTATULINEFILE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.NEUGOKITOUTATULINEMAIL)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.NEUGOKIHANTEIUMUKBN)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.MAILSOUSINYHKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.MAILADDRESSTOUROKUUMUKBN)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.DSSOUSINNO)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenMW_DsNeugokiHanteiKekkaWk.GYOUMUKOUSINSYAID)
