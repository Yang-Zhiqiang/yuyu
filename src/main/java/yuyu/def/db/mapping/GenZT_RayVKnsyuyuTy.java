...
/**
 * ＲＡＹＶ検証用Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RayVKnsyuyuTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayVKnsyuyuTy}</td><td colspan="3">ＲＡＹＶ検証用Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RayVKnsyuyuTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_RayVKnsyuyuTy
 * @see     PKZT_RayVKnsyuyuTy
 * @see     QZT_RayVKnsyuyuTy
 * @see     GenQZT_RayVKnsyuyuTy
 */
@MappedSuperclass
@Table(name=GenZT_RayVKnsyuyuTy.TABLE_NAME)
@IdClass(value=PKZT_RayVKnsyuyuTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayVKnsyuyuTy extends AbstractExDBEntity<ZT_RayVKnsyuyuTy, PKZT_RayVKnsyuyuTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayVKnsyuyuTy";
    ...
    private final PKZT_RayVKnsyuyuTy primaryKey;

    public GenZT_RayVKnsyuyuTy() {
        primaryKey = new PKZT_RayVKnsyuyuTy();
    }

    public GenZT_RayVKnsyuyuTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RayVKnsyuyuTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RayVKnsyuyuTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayVKnsyuyuTy> getMetaClass() {
        return QZT_RayVKnsyuyuTy.class;
    }

    @Id
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURIYOUYOBIN4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURIYOUYOBIN6X2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURIYOUYOBIN6X3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKIMATUKAWASERATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSKNNKAISIYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYRENDOURITU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKMTSISUURENTUMITATEKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKMTTIRTTMTTTUMITATEKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYKMTSISUURENTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMD)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITU)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKIN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX4)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX4)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX4)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX5)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX5)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX5)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX6)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX6)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX6)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX8)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX8)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX8)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX9)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX9)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX9)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNCALCKIJYUNYMDX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSISUUBBNTUMITATEKINX15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKISISUUKIJYUNYMDX15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYZENKISISUUKIJYUNYMDX15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTMTTKNZOUKARITUX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTOUKITUMIMASIKINX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV9X15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMD)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKIN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X2)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X3)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X4)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X5)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X11)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X12)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X13)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUCALCKIJYUNYMDX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYTEIRITUTUMITATEKINX15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV16X15)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYGENGAKUJICALCKIJYUNYMD)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYGENGAKUJISISUUTMTTKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYGENGAKUJITEIRITUTMTTKN)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayVKnsyuyuTy.ZTYYOBIV20)
