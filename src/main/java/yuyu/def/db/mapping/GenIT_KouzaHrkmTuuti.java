...
import yuyu.def.db.id.PKIT_KouzaHrkmTuuti;
import yuyu.def.db.meta.GenQIT_KouzaHrkmTuuti;
...
/**
 * 口座振込通知テーブル テーブルのマッピング情報クラスで、 {@link IT_KouzaHrkmTuuti} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KouzaHrkmTuuti}</td><td colspan="3">口座振込通知テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KouzaHrkmTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KouzaHrkmTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getKrkno krkno}</td><td>仮受番号</td><td align="center">{@link PKIT_KouzaHrkmTuuti ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_KouzaHrkmTuuti
 * @see     PKIT_KouzaHrkmTuuti
 * @see     QIT_KouzaHrkmTuuti
 * @see     GenQIT_KouzaHrkmTuuti
 */
@MappedSuperclass
@Table(name=GenIT_KouzaHrkmTuuti.TABLE_NAME)
@IdClass(value=PKIT_KouzaHrkmTuuti.class)
@TypeDefs({
...
public abstract class GenIT_KouzaHrkmTuuti extends AbstractExDBEntity<IT_KouzaHrkmTuuti, PKIT_KouzaHrkmTuuti> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KouzaHrkmTuuti";
    ...
    private final PKIT_KouzaHrkmTuuti primaryKey;

    public GenIT_KouzaHrkmTuuti() {
        primaryKey = new PKIT_KouzaHrkmTuuti();
    }
    ...
    @Transient
    @Override
    public PKIT_KouzaHrkmTuuti getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KouzaHrkmTuuti> getMetaClass() {
        return QIT_KouzaHrkmTuuti.class;
    }

    @Id
    @Column(name=GenIT_KouzaHrkmTuuti.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KouzaHrkmTuuti.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KouzaHrkmTuuti.KRKNO)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASEYNO)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASETELNO)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.TOIAWASETELNO2)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SYORUICD)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.HASSOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KouzaHrkmTuuti.HURIKOMIYMD)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHRIRIYUU1)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHRIRIYUU2)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SHRIRIYUU3)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SITEIKOUZA1)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SITEIKOUZA2)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SITEIKOUZA3)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SITEIKOUZA4)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.SITEIKOUZA5)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KouzaHrkmTuuti.GYOUMUKOUSINTIME)
