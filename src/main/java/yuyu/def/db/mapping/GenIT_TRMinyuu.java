...
import yuyu.def.db.id.PKIT_TRMinyuu;
import yuyu.def.db.meta.GenQIT_TRMinyuu;
...
/**
 * 未入ＴＲテーブル テーブルのマッピング情報クラスで、 {@link IT_TRMinyuu} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_TRMinyuu}</td><td colspan="3">未入ＴＲテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_TRMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_TRMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKIT_TRMinyuu ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getMinyuutrrenno minyuutrrenno}</td><td>未入TR連番</td><td align="center">{@link PKIT_TRMinyuu ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_TRMinyuu.TABLE_NAME)
@IdClass(value=PKIT_TRMinyuu.class)
@TypeDefs({
...
public abstract class GenIT_TRMinyuu extends AbstractExDBEntity<IT_TRMinyuu, PKIT_TRMinyuu> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_TRMinyuu";
    ...
    private final PKIT_TRMinyuu primaryKey;

    public GenIT_TRMinyuu() {
        primaryKey = new PKIT_TRMinyuu();
    }
    ...
    @Transient
    @Override
    public PKIT_TRMinyuu getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_TRMinyuu> getMetaClass() {
        return QIT_TRMinyuu.class;
    }

    @Id
    @Column(name=GenIT_TRMinyuu.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_TRMinyuu.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_TRMinyuu.SYORIYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_TRMinyuu.MINYUUTRRENNO)
    ...
    @Column(name=GenIT_TRMinyuu.NYKKEIRO)
    ...
    @Column(name=GenIT_TRMinyuu.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_TRMinyuu.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_TRMinyuu.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_TRMinyuu.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_TRMinyuu.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_TRMinyuu.HURIHUNOKBN)
    ...
    @Column(name=GenIT_TRMinyuu.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_TRMinyuu.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_TRMinyuu.YOKINKBN)
    ...
    @Column(name=GenIT_TRMinyuu.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_TRMinyuu.DANTAIKOBETUKBN)
    ...
    @Column(name=GenIT_TRMinyuu.HRKKAISUU)
    ...
    @Column(name=GenIT_TRMinyuu.KZHURIKAETKBTANNAIHYJ)
    ...
    @Column(name=GenIT_TRMinyuu.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_TRMinyuu.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_TRMinyuu.CREDITURIAGENGJIYUU)
    ...
    @Column(name=GenIT_TRMinyuu.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_TRMinyuu.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_TRMinyuu.GYOUMUKOUSINTIME)
