...
import yuyu.def.db.id.PKIT_BAK_Zennou;
import yuyu.def.db.meta.GenQIT_BAK_Zennou;
...
/**
 * 前納バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_Zennou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_Zennou}</td><td colspan="3">前納バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_Zennou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_Zennou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_Zennou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZennoukaisiymd zennoukaisiymd}</td><td>前納開始年月日</td><td align="center">{@link PKIT_BAK_Zennou ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_Zennou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_Zennou
 * @see     QIT_BAK_Zennou
 * @see     GenQIT_BAK_Zennou
 */
@MappedSuperclass
@Table(name=GenIT_BAK_Zennou.TABLE_NAME)
@IdClass(value=PKIT_BAK_Zennou.class)
@TypeDefs({
...
public abstract class GenIT_BAK_Zennou extends AbstractExDBEntity<IT_BAK_Zennou, PKIT_BAK_Zennou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_Zennou";
    ...
    private final PKIT_BAK_Zennou primaryKey;

    public GenIT_BAK_Zennou() {
        primaryKey = new PKIT_BAK_Zennou();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_Zennou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_Zennou> getMetaClass() {
        return QIT_BAK_Zennou.class;
    }

    @Id
    @Column(name=GenIT_BAK_Zennou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_Zennou.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_Zennou.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_Zennou.ZENNOUKAISIYMD)
    ...
    @Id
    @Column(name=GenIT_BAK_Zennou.RENNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.ZENNOUNYUUKINSYORIYMD)
    ...
    @Column(name=GenIT_BAK_Zennou.ZENNOUNYUUKINDENNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.ZENNOUNYUUKINDENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.RYOSYUYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.TYAKKINYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_Zennou.ZENNOUKIKAN)
    ...
    @Column(name=GenIT_BAK_Zennou.RSTUUKASYU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.RYOSYUKWSRATEKJYMD)
    ...
    @Column(name=GenIT_BAK_Zennou.RYOSYUKWSRATE)
    ...
    @Column(name=GenIT_BAK_Zennou.ZENNOUSEISANKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.ZENNOUSEISANSYORIYMD)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_BAK_Zennou.SHRTUUKASYU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.SHRKWSRATEKJNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Zennou.SHRKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.ZENNOUSEISANKIJYUNYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.ZENNOUSEISANDENYMD)
    ...
    @Column(name=GenIT_BAK_Zennou.ANNAISAIKAIYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.YENKANSANTKYKWSRATEYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Zennou.YENKANSANTKYKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.KJSMYOUZENNOUKAISIYMD)
    ...
    @Column(name=GenIT_BAK_Zennou.KJSMYOUZENNOUKIKANM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Zennou.KJSMYOUYENKANSANRATEYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Zennou.KJSMYOUYENKANSANKWSRATE)
    ...
    @Column(name=GenIT_BAK_Zennou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_Zennou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_Zennou.GYOUMUKOUSINTIME)
