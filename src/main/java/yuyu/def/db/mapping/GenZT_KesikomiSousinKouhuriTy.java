...
/**
 * 消込送信Ｆ（口振）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KesikomiSousinKouhuriTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KesikomiSousinKouhuriTy}</td><td colspan="3">消込送信Ｆ（口振）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtykskmsousinrenno ztykskmsousinrenno}</td><td>（中継用）消込送信連番</td><td align="center">{@link PKZT_KesikomiSousinKouhuriTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtykskmfsyoriymd ztykskmfsyoriymd}</td><td>（中継用）（消込Ｆ）処理年月日</td><td align="center">{@link PKZT_KesikomiSousinKouhuriTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_KesikomiSousinKouhuriTy
 * @see     PKZT_KesikomiSousinKouhuriTy
 * @see     QZT_KesikomiSousinKouhuriTy
 * @see     GenQZT_KesikomiSousinKouhuriTy
 */
@MappedSuperclass
@Table(name=GenZT_KesikomiSousinKouhuriTy.TABLE_NAME)
@IdClass(value=PKZT_KesikomiSousinKouhuriTy.class)
public abstract class GenZT_KesikomiSousinKouhuriTy extends AbstractExDBEntity<ZT_KesikomiSousinKouhuriTy, PKZT_KesikomiSousinKouhuriTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KesikomiSousinKouhuriTy";
    ...
    private final PKZT_KesikomiSousinKouhuriTy primaryKey;

    public GenZT_KesikomiSousinKouhuriTy() {
        primaryKey = new PKZT_KesikomiSousinKouhuriTy();
    }

    public GenZT_KesikomiSousinKouhuriTy(String pZtykskmsousinrenno, String pZtykskmfsyoriymd) {
        primaryKey = new PKZT_KesikomiSousinKouhuriTy(pZtykskmsousinrenno, pZtykskmfsyoriymd);
    }

    @Transient
    @Override
    public PKZT_KesikomiSousinKouhuriTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KesikomiSousinKouhuriTy> getMetaClass() {
        return QZT_KesikomiSousinKouhuriTy.class;
    }

    @Id
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMSOUSINRENNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMKAMOKUCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYSUITOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYSUITOUSOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHASSEIDENYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKARIKANJYONO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKKAKUSYOUNYUURYOKUYMD1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYIKTANNAIDANTAIZAIKEIKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFANNISKCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDANTAIANNAIJYUUTOUYM1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYANNAINO1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYBONUSHARAIHYOUJI1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFKZHURIKAEBANKCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFHURIKAEYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDAIRITENUKETUKENO1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYZAIKEIHRKKAISUUKBN1)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNOUKINHYOUNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFCREDITKAISYACD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKINYUUKIKANKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYYOBIV18)
    ...
    @Id
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFSYORIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFDENYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDENATESAKICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFTAISYAKUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHUTUUHOKENKAMOKUCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDENGK)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYTABAKARIKNJYKSKMDATAKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFRYOUSYUUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYRYOUSYUUHM)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKKAKUSYOUNYUURYOKUYMD2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFSYONO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKHOUKOKUHYOUTANTOUKA)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKHOUKOKUHYOUKIHYOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKHOUKOKUHYOUBUNKAINO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNKKAKUSYOUNYUURYOKUNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFDANTAICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDANTAIANNAIJYUUTOUYM2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYBONUSHARAIHYOUJI2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYANNAINO2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDANTAIPKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDANTAINYUUKINYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFJYUUTOUYM)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYSUITOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYNYUURYOKUHOUHOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFNYKNAIYOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKZHURIKAEKYKHNDNKHYOUJI)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFDAIRITENCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYDAIRITENUKETUKENO2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYIKKATUDANTAICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYIKKATUANNAIHIKISARIYM)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYIKKATUANNAINO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYZAIKEIHRKKAISUUKBN2)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYZAIKEIKYKSYANO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHASSEISOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYTEIKEISAKIKAISYACD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMFBANKCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYSUITOUSYORISOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYAITEKANJYOUYOMIKAEKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYCREDITCARDHRKSKMKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYLASTTEISEIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMKANRYOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMTEISEINO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYKSKMKANRYOUSIJIHYOUJI)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYUKETUKETENCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYCVSCD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHURIKOMIYOUSINYUUKINKBN)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHURIKOMIYOUSIOKYKSMNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYHURIKOMIYOUSIKAKUNINNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYEGSYOKUINHURIKOMIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYVITKAIINNO)
    ...
    @Column(name=GenZT_KesikomiSousinKouhuriTy.ZTYYOBIV74)
