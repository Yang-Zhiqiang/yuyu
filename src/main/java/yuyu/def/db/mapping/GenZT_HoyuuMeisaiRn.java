...
/**
 * 保有明細Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_HoyuuMeisaiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_HoyuuMeisaiRn}</td><td colspan="3">保有明細Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_HoyuuMeisaiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_HoyuuMeisaiRn
 * @see     PKZT_HoyuuMeisaiRn
 * @see     QZT_HoyuuMeisaiRn
 * @see     GenQZT_HoyuuMeisaiRn
 */
@MappedSuperclass
@Table(name=GenZT_HoyuuMeisaiRn.TABLE_NAME)
@IdClass(value=PKZT_HoyuuMeisaiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_HoyuuMeisaiRn extends AbstractExDBEntityForZDB<ZT_HoyuuMeisaiRn, PKZT_HoyuuMeisaiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_HoyuuMeisaiRn";
    ...
    private final PKZT_HoyuuMeisaiRn primaryKey;

    public GenZT_HoyuuMeisaiRn() {
        primaryKey = new PKZT_HoyuuMeisaiRn();
    }

    public GenZT_HoyuuMeisaiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_HoyuuMeisaiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_HoyuuMeisaiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_HoyuuMeisaiRn> getMetaClass() {
        return QZT_HoyuuMeisaiRn.class;
    }

    @Id
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKSYASKINMEINO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEIKIHONS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEIGYOUSEKIHYJSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNALMYOUSIBOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHARAIKOMIP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEINENBARAIKANSANP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGYOUSEKIHYOUJISRANK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTEIKIBAIRITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANGODATAKANRINO)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAITEKYKDATAKANRINO1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAITEKYKDATAKANRINO2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNSYOKAIPCASHLESSHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYOKAIPANNAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZENNOUKAISIYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNZENNOUKIKAN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEIZONKYUUHUKINSITEIY)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNALMYOUSEIZONKYHKNSITEIMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNJIKAIPJYUUTOUYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADKEISANKBNX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADKEISANKBNX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADKEISANKBNX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADKEISANKBNX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV6X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIMATUVYOUTUMIMASIKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKMTVYUSNHKNFUNDTMTTKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEINENKANSANP3X1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEINENKANSANP3X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEINENKANSANP3X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEINENKANSANP3X4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKMTVYUHIJYNBRITMTTKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIMATUVYOUITJBRTMTTKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X33)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHAITOUYOULOADINGKIJYUNS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUMITATED)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKARIWARIATED)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUZENSIHARAIKIJITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUZENTUUSANHANTEIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUGOSIHARAIKIJITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUGOTUUSANHANTEIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUGOKYUUHUTAISYOUS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTYOKUGOCBKINGAKU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYOKAISIHARAIKIJITU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYOKAITUUSANHANTEIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNCBNAYOSETUUSANHANTEIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHITENKANKEIYAKUSUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNGOUKEIPBUBUNTENKANTEIKIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAIDAIHKTGTIKKIKKKN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSISYUTNKNHKTGKUJYGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X34)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKKYKYMDX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTKBTDKISNYUSX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYGKX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIHYOUJIX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKNENKNSNPX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKNX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKKYKYMDX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTKBTDKISNYUSX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYGKX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIHYOUJIX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKNENKNSNPX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKNX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKKYKYMDX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTKBTDKISNYUSX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYGKX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIHYOUJIX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKNENKNSNPX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKNX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKKYKYMDX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNTKBTDKISNYUSX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYTKSUX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTNKNKAIYKKUJYGKX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIHYOUJIX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHTNKNKYKNENKNSNPX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHKTGTIKKIKKKNX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSWINGMINYUUPHRKEKNGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSWINGMINYUUPHRKEJYUTUYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFTOUNENDOITIJITOUNYUUP)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFKAIYAKUKUJYHKTGGK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAIYAKUKOUJYOTUKISUU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFKAIYAKUHENREIKIN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUUSEIS)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISYAKEISYOUSISYACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISYAZAISEKIHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISYABOSYUUJIAGE)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISYABSYJISIKAKUCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNAATUKAISYASIKAKUCD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNOKYKSMKUZTRHKKITIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHOYUUSISYACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYOKANSISYACD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTANTOUSYAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTANTOUSYAKBNNEW)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNCLUBSUMISEIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTANTOUSYAJYOUTAIKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKIHONYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTEIKIYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSONOTAYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIJIBARAIKIHONYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIJIBARAITEIKIYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNITIJIBARAISONOTAYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANKIHONYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTENKANTEIKIYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSZOUYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVESTINGYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSIPPEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSEIJINBYOUTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNJYOSEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTUUINTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSAITEIHOSYOUI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVKISOITJBRKHNYOTEII)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNVKISORRTZEROIKAHYOUJI)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHOYUUSISYACD2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNDFTUJYUKUJYKISNKISIYM)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTIKIKKTBRIJYUTUTKSU)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSYUNYUMRTIKYKJTIGNGTKBN)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNHHKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIV10X14)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTRKZSGKAIYKKJYNSTMTKZNDK)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNPMENKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNSUURIYOUYOBIN13)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X35)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X36)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNYOBIN11X37)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X2)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X3)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X4)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X5)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X6)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X7)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X8)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X9)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X10)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X11)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X12)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X13)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X14)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X15)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X16)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X17)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X18)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X19)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X20)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X21)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X22)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X23)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X24)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X25)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X26)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X27)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X28)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X29)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X30)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X31)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X32)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X33)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X34)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X35)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X36)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X37)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X38)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X39)
    ...
    @Column(name=GenZT_HoyuuMeisaiRn.ZRNTOKUYAKUKOUMOKUV200X40)
