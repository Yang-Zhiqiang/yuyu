...
/**
 * 利差配当商品用Ｄレートマスタ テーブルのマッピング情報クラスで、 {@link BM_RisaHitSyouhnyouRateD} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_RisaHitSyouhnyouRateD}</td><td colspan="3">利差配当商品用Ｄレートマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getPalhokensyuruikigou palhokensyuruikigou}</td><td>ＰＡＬ保険種類記号</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhokensyuruikigousdicode palhokensyuruikigousdicode}</td><td>ＰＡＬ保険種類記号世代コード</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalyoteiriritu palyoteiriritu}</td><td>ＰＡＬ予定利率</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalpmencode palpmencode}</td><td>ＰＡＬＰ免コード</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalharaikomikaisuu palharaikomikaisuu}</td><td>ＰＡＬ払込回数</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhhknsei palhhknsei}</td><td>ＰＡＬ被保険者性別</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalkeiyakujihhknnen palkeiyakujihhknnen}</td><td>ＰＡＬ契約時被保険者年令</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalsaimankihyouji palsaimankihyouji}</td><td>ＰＡＬ才満期契約表示</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalhokenkikan palhokenkikan}</td><td>ＰＡＬ保険期間</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPalpharaikomikikan palpharaikomikikan}</td><td>ＰＡＬＰ払込期間</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPaldnendo paldnendo}</td><td>ＰＡＬＤ年度</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getPaldratenaikakucode paldratenaikakucode}</td><td>ＰＡＬＤレート内定確定コード</td><td align="center">{@link PKBM_RisaHitSyouhnyouRateD ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     BM_RisaHitSyouhnyouRateD
 * @see     PKBM_RisaHitSyouhnyouRateD
 * @see     QBM_RisaHitSyouhnyouRateD
 * @see     GenQBM_RisaHitSyouhnyouRateD
 */
@MappedSuperclass
@Table(name=GenBM_RisaHitSyouhnyouRateD.TABLE_NAME)
@IdClass(value=PKBM_RisaHitSyouhnyouRateD.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBM_RisaHitSyouhnyouRateD extends AbstractExDBEntity<BM_RisaHitSyouhnyouRateD, PKBM_RisaHitSyouhnyouRateD> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_RisaHitSyouhnyouRateD";
    ...
    private final PKBM_RisaHitSyouhnyouRateD primaryKey;

    public GenBM_RisaHitSyouhnyouRateD() {
        primaryKey = new PKBM_RisaHitSyouhnyouRateD();
    }
    ...
    @Transient
    @Override
    public PKBM_RisaHitSyouhnyouRateD getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_RisaHitSyouhnyouRateD> getMetaClass() {
        return QBM_RisaHitSyouhnyouRateD.class;
    }

    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALHOKENSYURUIKIGOU)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALHOKENSYURUIKIGOUSDICODE)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALYOTEIRIRITU)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALPMENCODE)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALHARAIKOMIKAISUU)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALHHKNSEI)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALKEIYAKUJIHHKNNEN)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALSAIMANKIHYOUJI)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALHOKENKIKAN)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALPHARAIKOMIKIKAN)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALDNENDO)
    ...
    @Id
    @Column(name=GenBM_RisaHitSyouhnyouRateD.PALDRATENAIKAKUCODE)
    ...
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE00)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE01)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE02)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE03)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE04)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE05)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE06)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE07)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE08)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE09)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE16)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE18)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE19)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE20)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE21)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE22)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE23)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE24)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE25)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE26)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE27)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE28)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE29)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE30)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE31)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE32)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE33)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE34)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE35)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE36)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE37)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE38)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE39)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE40)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE41)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE42)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE43)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE44)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE45)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE46)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE47)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE48)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE49)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE50)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE51)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE52)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE53)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE54)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE55)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE56)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE57)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE58)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE59)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE60)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE61)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE62)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE63)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE64)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE65)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE66)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE67)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE68)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE69)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE70)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE71)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE72)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE73)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE74)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE75)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE76)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE77)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE78)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE79)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE80)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE81)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE82)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE83)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE84)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE85)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE86)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE87)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE88)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE89)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE90)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE91)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE92)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE93)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE94)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE95)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE96)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE97)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE98)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DRATE99)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE00)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE01)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE02)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE03)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE04)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE05)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE06)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE07)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE08)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE09)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE10)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE12)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE14)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE15)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE16)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE18)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE19)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE20)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE21)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE22)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE23)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE24)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE25)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE26)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE27)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE28)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE29)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE30)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE31)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE32)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE33)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE34)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE35)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE36)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE37)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE38)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE39)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE40)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE41)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE42)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE43)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE44)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE45)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE46)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE47)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE48)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE49)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE50)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE51)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE52)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE53)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE54)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE55)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE56)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE57)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE58)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE59)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE60)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE61)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE62)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE63)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE64)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE65)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE66)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE67)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE68)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE69)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE70)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE71)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE72)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE73)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE74)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE75)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE76)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE77)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE78)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE79)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE80)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE81)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE82)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE83)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE84)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE85)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE86)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE87)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE88)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE89)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE90)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE91)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE92)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE93)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE94)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE95)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE96)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE97)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE98)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_RisaHitSyouhnyouRateD.DYOUVRATE99)
