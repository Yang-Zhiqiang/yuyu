...
import yuyu.def.db.id.PKIT_HokenSyoukenHukaInfo;
import yuyu.def.db.meta.GenQIT_HokenSyoukenHukaInfo;
...
/**
 * 保険証券付加情報データテーブル テーブルのマッピング情報クラスで、 {@link IT_HokenSyoukenHukaInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_HokenSyoukenHukaInfo}</td><td colspan="3">保険証券付加情報データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_HokenSyoukenHukaInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_HokenSyoukenHukaInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_HokenSyoukenHukaInfo ○}</td><td align="center">V</td><td>BizDate</td></tr>
 ...
 * </table>
 * @see     IT_HokenSyoukenHukaInfo
 * @see     PKIT_HokenSyoukenHukaInfo
 * @see     QIT_HokenSyoukenHukaInfo
 * @see     GenQIT_HokenSyoukenHukaInfo
 */
@MappedSuperclass
@Table(name=GenIT_HokenSyoukenHukaInfo.TABLE_NAME)
@IdClass(value=PKIT_HokenSyoukenHukaInfo.class)
@TypeDefs({
...
public abstract class GenIT_HokenSyoukenHukaInfo extends AbstractExDBEntity<IT_HokenSyoukenHukaInfo, PKIT_HokenSyoukenHukaInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_HokenSyoukenHukaInfo";
    ...
    private final PKIT_HokenSyoukenHukaInfo primaryKey;

    public GenIT_HokenSyoukenHukaInfo() {
        primaryKey = new PKIT_HokenSyoukenHukaInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_HokenSyoukenHukaInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_HokenSyoukenHukaInfo> getMetaClass() {
        return QIT_HokenSyoukenHukaInfo.class;
    }

    @Id
    @Column(name=GenIT_HokenSyoukenHukaInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_HokenSyoukenHukaInfo.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.NKSYURUINMSYOUKEN)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TEIKIIKKATUBARAITUKISUU)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.ZNNTIKIKTBRIYHRKGKTUKTYPE)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.ZNNKAI2)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.HUTANHIYUSTMKYAKKJRTMIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyoukenHukaInfo.HUTANHIYUSTMKYAKKJRTMAX)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.FSTPZNNKNGKTUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DSKJNKNGKKTUKTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.TIKIKTBRIYHRKGKTUKTYPE)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTIRASIDOUHUUKBN1)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTIRASIDOUHUUKBN2)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyoukenHukaInfo.KYKDAIRITIRASIDOUHUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_HokenSyoukenHukaInfo.SKHTIRASIDOUHUUKBN)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.YAKKANNEWOLDKBN)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG1)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG2)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG3)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG4)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG5)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG6)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG7)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KZKTOUROKUSERVICEMSG8)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKNMKJ118)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKSEI1)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKSEIYMD1)
    @ValidDate
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKYNO1)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR1KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR2KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR3KJ1)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKTELNO1)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Type(type="UserType_C_Seibetu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKSEI2)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKNMKJ218)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKSEIYMD2)
    @ValidDate
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKYNO2)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR1KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR2KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKADR3KJ2)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.TRKKZKTELNO2)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.KYKDAIRINM18)
    ...
    @Column(name=GenIT_HokenSyoukenHukaInfo.HHKNDAIRINM)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_HokenSyoukenHukaInfo.RENDOURITU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKYENTYPE)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE01)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE01)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE02)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE02)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE03)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE03)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE04)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE04)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE05)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE05)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1ZENNOUZNDKTYPE06)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_HokenSyoukenHukaInfo.DAI1SBJIUKTGKTYPE06)
