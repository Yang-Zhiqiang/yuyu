...
import yuyu.def.db.id.PKHT_ImusateiSyouhnTokujyou;
...
/**
 * 医務査定商品別特条条件付テーブル テーブルのマッピング情報クラスで、 {@link HT_ImusateiSyouhnTokujyou} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_ImusateiSyouhnTokujyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKHT_ImusateiSyouhnTokujyou ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKHT_ImusateiSyouhnTokujyou ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKHT_ImusateiSyouhnTokujyou
 * @see     QHT_ImusateiSyouhnTokujyou
 * @see     GenQHT_ImusateiSyouhnTokujyou
 */
@MappedSuperclass
@Table(name=GenHT_ImusateiSyouhnTokujyou.TABLE_NAME)
@IdClass(value=PKHT_ImusateiSyouhnTokujyou.class)
@TypeDefs({
...
public abstract class GenHT_ImusateiSyouhnTokujyou extends AbstractExDBEntity<HT_ImusateiSyouhnTokujyou, PKHT_ImusateiSyouhnTokujyou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_ImusateiSyouhnTokujyou";
    ...
    private final PKHT_ImusateiSyouhnTokujyou primaryKey;

    public GenHT_ImusateiSyouhnTokujyou() {
        primaryKey = new PKHT_ImusateiSyouhnTokujyou();
    }
    ...
    @Transient
    @Override
    public PKHT_ImusateiSyouhnTokujyou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_ImusateiSyouhnTokujyou> getMetaClass() {
        return QHT_ImusateiSyouhnTokujyou.class;
    }

    @Id
    @Column(name=GenHT_ImusateiSyouhnTokujyou.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_ImusateiSyouhnTokujyou.RENNO)
    ...
    @Id
    @Column(name=GenHT_ImusateiSyouhnTokujyou.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.SYOUHNSDNO)
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.TKNZKKBN)
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.TUMAHTNPKBN)
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.KOHTNPKBN)
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_ImusateiSyouhnTokujyou.GYOUMUKOUSINTIME)
