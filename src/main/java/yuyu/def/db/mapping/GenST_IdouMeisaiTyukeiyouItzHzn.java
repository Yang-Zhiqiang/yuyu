...
/**
 * 異動明細中継用一時保存テーブル テーブルのマッピング情報クラスで、 {@link ST_IdouMeisaiTyukeiyouItzHzn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ST_IdouMeisaiTyukeiyouItzHzn}</td><td colspan="3">異動明細中継用一時保存テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysrkijyunym ztysrkijyunym}</td><td>（中継用）数理用基準年月</td><td align="center">{@link PKST_IdouMeisaiTyukeiyouItzHzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysrkakutyoujobcd ztysrkakutyoujobcd}</td><td>（中継用）数理用拡張ジョブコード</td><td align="center">{@link PKST_IdouMeisaiTyukeiyouItzHzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKST_IdouMeisaiTyukeiyouItzHzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 *  <tr><td>{@link #getZtysrkouryokuhasseiymd ztysrkouryokuhasseiymd}</td><td>（中継用）数理用効力発生年月日</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysrhenkousikibetukey ztysrhenkousikibetukey}</td><td>（中継用）数理用変更識別キー</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysrhoseirecordhanbetukbn ztysrhoseirecordhanbetukbn}</td><td>（中継用）数理用補正用レコード判別区分</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysrhoseihenkousikibetukey ztysrhoseihenkousikibetukey}</td><td>（中継用）数理用補正用変更識別キー</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ST_IdouMeisaiTyukeiyouItzHzn
 * @see     PKST_IdouMeisaiTyukeiyouItzHzn
 * @see     QST_IdouMeisaiTyukeiyouItzHzn
 * @see     GenQST_IdouMeisaiTyukeiyouItzHzn
 */
@MappedSuperclass
@Table(name=GenST_IdouMeisaiTyukeiyouItzHzn.TABLE_NAME)
@IdClass(value=PKST_IdouMeisaiTyukeiyouItzHzn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenST_IdouMeisaiTyukeiyouItzHzn extends AbstractExDBEntity<ST_IdouMeisaiTyukeiyouItzHzn, PKST_IdouMeisaiTyukeiyouItzHzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ST_IdouMeisaiTyukeiyouItzHzn";
    ...
    public static final String ZTYSRKOURYOKUHASSEIYMD   = "ztysrkouryokuhasseiymd";
    public static final String ZTYSRHENKOUSIKIBETUKEY   = "ztysrhenkousikibetukey";
    public static final String ZTYSRHOSEIRECORDHANBETUKBN = "ztysrhoseirecordhanbetukbn";
    public static final String ZTYSRHOSEIHENKOUSIKIBETUKEY = "ztysrhoseihenkousikibetukey";
    public static final String ZTYSRTEIKISHRTKYKHUKAUMU = "ztysrteikishrtkykhukaumu";

    private final PKST_IdouMeisaiTyukeiyouItzHzn primaryKey;

    public GenST_IdouMeisaiTyukeiyouItzHzn() {
        primaryKey = new PKST_IdouMeisaiTyukeiyouItzHzn();
    }
    ...
    @Transient
    @Override
    public PKST_IdouMeisaiTyukeiyouItzHzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QST_IdouMeisaiTyukeiyouItzHzn> getMetaClass() {
        return QST_IdouMeisaiTyukeiyouItzHzn.class;
    }

    @Id
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRKIJYUNYM)
    ...
    @Id
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRKAKUTYOUJOBCD)
    ...
    @Id
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSEQUENCENO)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYRDWAREA)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYRECORDKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKEIJYOUYM)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYZOUGENKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYRECORDCTR)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYDENYMD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYBSYYM)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYORICD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYDATAKANRINO)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURISYURUICD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYDAIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTYUUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYOUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSEDAIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKYKYMD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHKNKKN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYPHRKKIKN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSDPDKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYRYOURITUKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKYKSYANEN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOK

    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYAATUKAISYABSYJISIKAKUCD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYAATUKAISYASIKAKUCD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYOKYKSMKUZTRHKKITIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHOYUUSISYACD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYOKANSISYACD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTANTOUSYAKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTANTOUSYAKBNNEW)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYCLUBSUMISEIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTANTOUSYAJYOUTAIKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKIHONYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTEIKIYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSONOTAYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYITIJIBARAIKIHONYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYITIJIBARAITEIKIYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYITIJIBARAISONOTAYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTENKANKIHONYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTENKANTEIKIYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSZOUYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYVESTINGYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSIPPEITOKUYAKUYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSEIJINBYOUTOKUYAKUYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYJYOSEITOKUYAKUYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTUUINTOKUYAKUYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSAITEIHOSYOUI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYVKISOITJBRKHNYOTEII)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYVKISORRTZEROIKAHYOUJI)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHOYUUSISYACD2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYDFTUJYUKUJYKISNKISIYM)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTIKIKKTBRIJYUTUTKSU)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSYUNYUMRTIKYKJTIGNGTKBN)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYHHKDRTKYKARIHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYOBIV10X14)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTRKZSGKAIYKKJYNSTMTKZNDK)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYPMENKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN5)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSUURIYOUYOBIN13)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYOBIN11X35)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYOBIN11X36)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYYOBIN11X37)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X2)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X3)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X4)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X5)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X6)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X7)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X8)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X9)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X10)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X11)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X12)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X13)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X14)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X15)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X16)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X17)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X18)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X19)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X20)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X21)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X22)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X23)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X24)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X25)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X26)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X27)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X28)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X29)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X30)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X31)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X32)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X33)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X34)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X35)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X36)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X37)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X38)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X39)
    ...
    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYTOKUYAKUKOUMOKUV200X40)
    ...
    private String ztysrkouryokuhasseiymd;

    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRKOURYOKUHASSEIYMD)
    public String getZtysrkouryokuhasseiymd() {
        return ztysrkouryokuhasseiymd;
    }

    public void setZtysrkouryokuhasseiymd(String pZtysrkouryokuhasseiymd) {
        ztysrkouryokuhasseiymd = pZtysrkouryokuhasseiymd;
    }

    private String ztysrhenkousikibetukey;

    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRHENKOUSIKIBETUKEY)
    public String getZtysrhenkousikibetukey() {
        return ztysrhenkousikibetukey;
    }

    public void setZtysrhenkousikibetukey(String pZtysrhenkousikibetukey) {
        ztysrhenkousikibetukey = pZtysrhenkousikibetukey;
    }

    private String ztysrhoseirecordhanbetukbn;

    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRHOSEIRECORDHANBETUKBN)
    public String getZtysrhoseirecordhanbetukbn() {
        return ztysrhoseirecordhanbetukbn;
    }

    @Padding(mode = "left", padChar = '0', length = 1)
    public void setZtysrhoseirecordhanbetukbn(String pZtysrhoseirecordhanbetukbn) {
        ztysrhoseirecordhanbetukbn = pZtysrhoseirecordhanbetukbn;
    }

    private String ztysrhoseihenkousikibetukey;

    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRHOSEIHENKOUSIKIBETUKEY)
    public String getZtysrhoseihenkousikibetukey() {
        return ztysrhoseihenkousikibetukey;
    }

    public void setZtysrhoseihenkousikibetukey(String pZtysrhoseihenkousikibetukey) {
        ztysrhoseihenkousikibetukey = pZtysrhoseihenkousikibetukey;
    }

    private String ztysrteikishrtkykhukaumu;

    @Column(name=GenST_IdouMeisaiTyukeiyouItzHzn.ZTYSRTEIKISHRTKYKHUKAUMU)
