...
/**
 * ＲＡＹ期末ＶＦテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RayKimatuVTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayKimatuVTy}</td><td colspan="3">ＲＡＹ期末ＶＦテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RayKimatuVTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RayKimatuVTy.TABLE_NAME)
@IdClass(value=PKZT_RayKimatuVTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayKimatuVTy extends AbstractExDBEntity<ZT_RayKimatuVTy, PKZT_RayKimatuVTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayKimatuVTy";
    ...
    private final PKZT_RayKimatuVTy primaryKey;

    public GenZT_RayKimatuVTy() {
        primaryKey = new PKZT_RayKimatuVTy();
    }

    public GenZT_RayKimatuVTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RayKimatuVTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RayKimatuVTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayKimatuVTy> getMetaClass() {
        return QZT_RayKimatuVTy.class;
    }

    @Id
    @Column(name=GenZT_RayKimatuVTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVTy.ZTYVYOURENDOURITU)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X21)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X23)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV15)
    ...
    @Column(name=GenZT_RayKimatuVTy.ZTYYOBIV20)
