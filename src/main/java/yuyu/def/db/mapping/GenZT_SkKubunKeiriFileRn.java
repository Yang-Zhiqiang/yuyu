...
/**
 * 新契約区分経理ファイルテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkKubunKeiriFileRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKubunKeiriFileRn}</td><td colspan="3">新契約区分経理ファイルテーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymd zrntorihikiymd}</td><td>（連携用）取引年月日</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinon7 zrntorihikinon7}</td><td>（連携用）取引番号Ｎ７</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntaisyakukbnn zrntaisyakukbnn}</td><td>（連携用）貸借区分（数値）</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkanjyoukamokucdn zrnkanjyoukamokucdn}</td><td>（連携用）勘定科目コード（数値）</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyobiv4 zrnyobiv4}</td><td>（連携用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsuitoubumoncd zrnsuitoubumoncd}</td><td>（連携用）出納部門コード</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkingaku zrnkingaku}</td><td>（連携用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnkizokusegment zrnkizokusegment}</td><td>（連携用）帰属セグメント</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnaitesegment zrnaitesegment}</td><td>（連携用）相手セグメント</td><td align="center">{@link PKZT_SkKubunKeiriFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyobiv23 zrnyobiv23}</td><td>（連携用）予備項目Ｖ２３</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 * </table>
 * @see     ZT_SkKubunKeiriFileRn
 * @see     PKZT_SkKubunKeiriFileRn
 * @see     QZT_SkKubunKeiriFileRn
 * @see     GenQZT_SkKubunKeiriFileRn
 */
@MappedSuperclass
@Table(name=GenZT_SkKubunKeiriFileRn.TABLE_NAME)
@IdClass(value=PKZT_SkKubunKeiriFileRn.class)
public abstract class GenZT_SkKubunKeiriFileRn extends AbstractExDBEntityForZDB<ZT_SkKubunKeiriFileRn, PKZT_SkKubunKeiriFileRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKubunKeiriFileRn";
    ...
    private final PKZT_SkKubunKeiriFileRn primaryKey;

    public GenZT_SkKubunKeiriFileRn() {
        primaryKey = new PKZT_SkKubunKeiriFileRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKubunKeiriFileRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKubunKeiriFileRn> getMetaClass() {
        return QZT_SkKubunKeiriFileRn.class;
    }

    private String zrnkaikeitani;

    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKAIKEITANI)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNSYORICD)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNTORIHIKINON7)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNSYORIYMDN)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKESSANKBN)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNONLINESYORIKBN)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNYOBIV28)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNYOBIV4)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNSUITOUBUMONCD)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKINGAKU)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNKIZOKUSEGMENT)
    ...
    @Id
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNAITESEGMENT)
    ...
    @Column(name=GenZT_SkKubunKeiriFileRn.ZRNYOBIV23)
