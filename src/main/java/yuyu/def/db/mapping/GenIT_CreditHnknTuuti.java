...
import yuyu.def.db.id.PKIT_CreditHnknTuuti;
import yuyu.def.db.meta.GenQIT_CreditHnknTuuti;
...
/**
 * クレカ返金通知テーブル テーブルのマッピング情報クラスで、 {@link IT_CreditHnknTuuti} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_CreditHnknTuuti}</td><td colspan="3">クレカ返金通知テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_CreditHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_CreditHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKIT_CreditHnknTuuti ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKIT_CreditHnknTuuti ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_CreditHnknTuuti
 * @see     PKIT_CreditHnknTuuti
 * @see     QIT_CreditHnknTuuti
 * @see     GenQIT_CreditHnknTuuti
 */
@MappedSuperclass
@Table(name=GenIT_CreditHnknTuuti.TABLE_NAME)
@IdClass(value=PKIT_CreditHnknTuuti.class)
@TypeDefs({
...
public abstract class GenIT_CreditHnknTuuti extends AbstractExDBEntity<IT_CreditHnknTuuti, PKIT_CreditHnknTuuti> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_CreditHnknTuuti";
    ...
    private final PKIT_CreditHnknTuuti primaryKey;

    public GenIT_CreditHnknTuuti() {
        primaryKey = new PKIT_CreditHnknTuuti();
    }
    ...
    @Transient
    @Override
    public PKIT_CreditHnknTuuti getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_CreditHnknTuuti> getMetaClass() {
        return QIT_CreditHnknTuuti.class;
    }

    @Id
    @Column(name=GenIT_CreditHnknTuuti.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_CreditHnknTuuti.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_CreditHnknTuuti.DENRENNO)
    ...
    @Id
    @Column(name=GenIT_CreditHnknTuuti.EDANO)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_CreditHnknTuuti.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_CreditHnknTuuti.HASSOUKBN)
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASEYNO)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASETELNO)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_CreditHnknTuuti.TOIAWASETELNO2)
    ...
    @Column(name=GenIT_CreditHnknTuuti.SHRRIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_CreditHnknTuuti.URIAGESEIKYUUYMD)
    ...
    @Column(name=GenIT_CreditHnknTuuti.KRKRIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_CreditHnknTuuti.URIAGEYMD)
    ...
    @Column(name=GenIT_CreditHnknTuuti.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_CreditHnknTuuti.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_CreditHnknTuuti.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_CreditHnknTuuti.HNKNTAISYOUINJIFLG)
    ...
    @Column(name=GenIT_CreditHnknTuuti.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_CreditHnknTuuti.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_CreditHnknTuuti.GYOUMUKOUSINTIME)
