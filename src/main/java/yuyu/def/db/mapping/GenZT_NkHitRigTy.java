...
/**
 * 年金配当所要額Ｆ例月報告用テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkHitRigTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkHitRigTy}</td><td colspan="3">年金配当所要額Ｆ例月報告用テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtynksyousyono ztynksyousyono}</td><td>（中継用）年金証書番号</td><td align="center">{@link PKZT_NkHitRigTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkHitRigTy.TABLE_NAME)
@IdClass(value=PKZT_NkHitRigTy.class)
public abstract class GenZT_NkHitRigTy extends AbstractExDBEntity<ZT_NkHitRigTy, PKZT_NkHitRigTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkHitRigTy";
    ...
    private final PKZT_NkHitRigTy primaryKey;

    public GenZT_NkHitRigTy() {
        primaryKey = new PKZT_NkHitRigTy();
    }

    public GenZT_NkHitRigTy(String pZtynksyousyono) {
        primaryKey = new PKZT_NkHitRigTy(pZtynksyousyono);
    }

    @Transient
    @Override
    public PKZT_NkHitRigTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkHitRigTy> getMetaClass() {
        return QZT_NkHitRigTy.class;
    }

    @Id
    @Column(name=GenZT_NkHitRigTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYNENKINTYPEKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYNENKINITIJISIHARAINENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYMANRYOUKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKEIYAKUNENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYSEIZONKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOTEIRIRITUN5)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTY5NNGT3NNGTOUTUBKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV7)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV15)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYGYOUSEKIHYOUJISIBOUS)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYUUKOUTYUUSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYSYOUMETUJISYOYOUGAKUYOU1)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYSYOUMETUJISYOYOUGAKUYOU2)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYRISADTAISYOUV)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYNKNENGK)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYSYUKEIYAKUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKAIMASINENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV38)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKEISANKIJYUNYMD)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTOUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOKUYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTOUNENDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYKNNDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYZNNNDSEISIKIWRATEHYJ)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTOUNENDODHANEIZUMIHYOUJI)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTOUNENDOOUTOUBIJITEND)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTUNNDOUTUBIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTUNNDMTIKUYKNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYKNNDOUTUBIKOUYKNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYZNNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKTYUMTIKUTUNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYTUNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYKTYUMTIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_NkHitRigTy.ZTYYOBIV16)
