...
import yuyu.def.db.id.PKBM_ChkJhNenreiNensyuuTuusanS;
import yuyu.def.db.meta.GenQBM_ChkJhNenreiNensyuuTuusanS;
import yuyu.def.db.meta.QBM_ChkJhNenreiNensyuuTuusanS;

/**
 * 年齢年収制限通算限度Ｓ事方書チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkJhNenreiNensyuuTuusanS} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getHhknfromnen hhknfromnen}</td><td>被保険者年齢自</td><td align="center">{@link PKBM_ChkJhNenreiNensyuuTuusanS ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHhkntonen hhkntonen}</td><td>被保険者年齢至</td><td align="center">{@link PKBM_ChkJhNenreiNensyuuTuusanS ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHhknfromnensyuu hhknfromnensyuu}</td><td>被保険者年収区分自</td><td align="center">{@link PKBM_ChkJhNenreiNensyuuTuusanS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHhkntonensyuu hhkntonensyuu}</td><td>被保険者年収区分至</td><td align="center">{@link PKBM_ChkJhNenreiNensyuuTuusanS ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKBM_ChkJhNenreiNensyuuTuusanS
 * @see     QBM_ChkJhNenreiNensyuuTuusanS
 * @see     GenQBM_ChkJhNenreiNensyuuTuusanS
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhNenreiNensyuuTuusanS.TABLE_NAME)
@IdClass(value=PKBM_ChkJhNenreiNensyuuTuusanS.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBM_ChkJhNenreiNensyuuTuusanS extends AbstractExDBEntity<BM_ChkJhNenreiNensyuuTuusanS, PKBM_ChkJhNenreiNensyuuTuusanS> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhNenreiNensyuuTuusanS";
    ...
    private final PKBM_ChkJhNenreiNensyuuTuusanS primaryKey;

    public GenBM_ChkJhNenreiNensyuuTuusanS() {
        primaryKey = new PKBM_ChkJhNenreiNensyuuTuusanS();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhNenreiNensyuuTuusanS getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhNenreiNensyuuTuusanS> getMetaClass() {
        return QBM_ChkJhNenreiNensyuuTuusanS.class;
    }

    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiNensyuuTuusanS.HHKNFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiNensyuuTuusanS.HHKNTONEN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiNensyuuTuusanS.HHKNFROMNENSYUU)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiNensyuuTuusanS.HHKNTONENSYUU)
