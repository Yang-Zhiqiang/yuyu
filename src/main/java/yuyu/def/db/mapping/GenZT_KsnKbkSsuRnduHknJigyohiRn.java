...
/**
 * 決算計上用株価指数連動保険事業費Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_KsnKbkSsuRnduHknJigyohiRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KsnKbkSsuRnduHknJigyohiRn}</td><td colspan="3">決算計上用株価指数連動保険事業費Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_KsnKbkSsuRnduHknJigyohiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 *  <tr><td>{@link #getZrnloadingkeijyoym zrnloadingkeijyoym}</td><td>（連携用）ローディング計上年月</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsihankiksnydatahyj zrnsihankiksnydatahyj}</td><td>（連携用）四半期決算用データ表示</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrngmkijyhyj zrngmkijyhyj}</td><td>（連携用）月末計上表示</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnyobin11x18 zrnyobin11x18}</td><td>（連携用）予備項目Ｎ１１＿１８</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnvhireilkisnyukngkx1 zrnvhireilkisnyukngkx1}</td><td>（連携用）Ｖ比例Ｌ計算用金額＿１</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZrnvhireilkisnyukngkx2 zrnvhireilkisnyukngkx2}</td><td>（連携用）Ｖ比例Ｌ計算用金額＿２</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZrnrpkeisanyousibous zrnrpkeisanyousibous}</td><td>（連携用）ＲＰ計算用死亡Ｓ</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnkikens zrnkikens}</td><td>（連携用）危険保険金</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnvhireialpha zrnvhireialpha}</td><td>（連携用）Ｖ比例α</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnvhireibeta zrnvhireibeta}</td><td>（連携用）Ｖ比例β</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnkikenp zrnkikenp}</td><td>（連携用）危険保険料</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>{@link #getZrnkikenpritu zrnkikenpritu}</td><td>（連携用）危険保険料率</td><td align="center">&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getZrntumimasimaew zrntumimasimaew}</td><td>（連携用）積増前Ｗ</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 * </table>
 * @see     ZT_KsnKbkSsuRnduHknJigyohiRn
 * @see     PKZT_KsnKbkSsuRnduHknJigyohiRn
 * @see     QZT_KsnKbkSsuRnduHknJigyohiRn
 * @see     GenQZT_KsnKbkSsuRnduHknJigyohiRn
 */
@MappedSuperclass
@Table(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.TABLE_NAME)
@IdClass(value=PKZT_KsnKbkSsuRnduHknJigyohiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KsnKbkSsuRnduHknJigyohiRn extends AbstractExDBEntityForZDB<ZT_KsnKbkSsuRnduHknJigyohiRn, PKZT_KsnKbkSsuRnduHknJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KsnKbkSsuRnduHknJigyohiRn";
    ...
    public static final String ZRNLOADINGKEIJYOYM       = "zrnloadingkeijyoym";
    public static final String ZRNSIHANKIKSNYDATAHYJ    = "zrnsihankiksnydatahyj";
    public static final String ZRNGMKIJYHYJ             = "zrngmkijyhyj";
    public static final String ZRNSUURIYOUYOBIN12       = "zrnsuuriyouyobin12";
    public static final String ZRNYOBIV20               = "zrnyobiv20";
    public static final String ZRNYOBIN11X18            = "zrnyobin11x18";
    public static final String ZRNVHIREILKISNYUKNGKX1   = "zrnvhireilkisnyukngkx1";
    ...
    public static final String ZRNVHIREILKISNYUKNGKX2   = "zrnvhireilkisnyukngkx2";
    public static final String ZRNYOBIN11X22            = "zrnyobin11x22";
    public static final String ZRNYOBIN11X23            = "zrnyobin11x23";
    public static final String ZRNRPKEISANYOUSIBOUS     = "zrnrpkeisanyousibous";
    public static final String ZRNKIKENS                = "zrnkikens";
    public static final String ZRNVHIREIALPHA           = "zrnvhireialpha";
    public static final String ZRNVHIREIBETA            = "zrnvhireibeta";
    public static final String ZRNKIKENP                = "zrnkikenp";
    public static final String ZRNVHIREILRITU           = "zrnvhireilritu";
    public static final String ZRNKIKENPRITU            = "zrnkikenpritu";
    public static final String ZRNTUMIMASIMAEW          = "zrntumimasimaew";
    ...
    private final PKZT_KsnKbkSsuRnduHknJigyohiRn primaryKey;

    public GenZT_KsnKbkSsuRnduHknJigyohiRn() {
        primaryKey = new PKZT_KsnKbkSsuRnduHknJigyohiRn();
    }

    public GenZT_KsnKbkSsuRnduHknJigyohiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_KsnKbkSsuRnduHknJigyohiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_KsnKbkSsuRnduHknJigyohiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KsnKbkSsuRnduHknJigyohiRn> getMetaClass() {
        return QZT_KsnKbkSsuRnduHknJigyohiRn.class;
    }

    @Id
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV14)
    ...
    private String zrnloadingkeijyoym;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNLOADINGKEIJYOYM)
    public String getZrnloadingkeijyoym() {
        return zrnloadingkeijyoym;
    }

    @Padding(mode = "left", padChar = '0', length = 6)
    public void setZrnloadingkeijyoym(String pZrnloadingkeijyoym) {
        zrnloadingkeijyoym = pZrnloadingkeijyoym;
    }

    private String zrnsihankiksnydatahyj;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSIHANKIKSNYDATAHYJ)
    public String getZrnsihankiksnydatahyj() {
        return zrnsihankiksnydatahyj;
    }

    @Padding(mode = "left", padChar = '0', length = 1)
    public void setZrnsihankiksnydatahyj(String pZrnsihankiksnydatahyj) {
        zrnsihankiksnydatahyj = pZrnsihankiksnydatahyj;
    }

    private String zrngmkijyhyj;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNGMKIJYHYJ)
    public String getZrngmkijyhyj() {
        return zrngmkijyhyj;
    }

    @Padding(mode = "left", padChar = '0', length = 1)
    public void setZrngmkijyhyj(String pZrngmkijyhyj) {
        zrngmkijyhyj = pZrngmkijyhyj;
    }

    private String zrnsuuriyouyobin12;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV20)
    ...
    private Long zrnyobin11x18;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X18)
    public Long getZrnyobin11x18() {
        return zrnyobin11x18;
    }

    public void setZrnyobin11x18(Long pZrnyobin11x18) {
        zrnyobin11x18 = pZrnyobin11x18;
    }

    private Long zrnvhireilkisnyukngkx1;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREILKISNYUKNGKX1)
    public Long getZrnvhireilkisnyukngkx1() {
        return zrnvhireilkisnyukngkx1;
    }

    public void setZrnvhireilkisnyukngkx1(Long pZrnvhireilkisnyukngkx1) {
        zrnvhireilkisnyukngkx1 = pZrnvhireilkisnyukngkx1;
    }

    private Long zrnyobin11x19;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X21)
    ...
    private Long zrnvhireilkisnyukngkx2;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREILKISNYUKNGKX2)
    public Long getZrnvhireilkisnyukngkx2() {
        return zrnvhireilkisnyukngkx2;
    }

    public void setZrnvhireilkisnyukngkx2(Long pZrnvhireilkisnyukngkx2) {
        zrnvhireilkisnyukngkx2 = pZrnvhireilkisnyukngkx2;
    }

    private Long zrnyobin11x22;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X23)
    ...
    private Long zrnrpkeisanyousibous;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNRPKEISANYOUSIBOUS)
    public Long getZrnrpkeisanyousibous() {
        return zrnrpkeisanyousibous;
    }

    public void setZrnrpkeisanyousibous(Long pZrnrpkeisanyousibous) {
        zrnrpkeisanyousibous = pZrnrpkeisanyousibous;
    }

    private Long zrnkikens;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIKENS)
    public Long getZrnkikens() {
        return zrnkikens;
    }

    public void setZrnkikens(Long pZrnkikens) {
        zrnkikens = pZrnkikens;
    }

    private Long zrnvhireialpha;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREIALPHA)
    public Long getZrnvhireialpha() {
        return zrnvhireialpha;
    }

    public void setZrnvhireialpha(Long pZrnvhireialpha) {
        zrnvhireialpha = pZrnvhireialpha;
    }

    private Long zrnvhireibeta;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREIBETA)
    public Long getZrnvhireibeta() {
        return zrnvhireibeta;
    }

    public void setZrnvhireibeta(Long pZrnvhireibeta) {
        zrnvhireibeta = pZrnvhireibeta;
    }

    private Long zrnkikenp;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIKENP)
    public Long getZrnkikenp() {
        return zrnkikenp;
    }

    public void setZrnkikenp(Long pZrnkikenp) {
        zrnkikenp = pZrnkikenp;
    }

    private BizNumber zrnvhireilritu;

    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNVHIREILRITU)
    ...
    private BizNumber zrnkikenpritu;

    @Type(type="BizNumberType")
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNKIKENPRITU)
    public BizNumber getZrnkikenpritu() {
        return zrnkikenpritu;
    }

    public void setZrnkikenpritu(BizNumber pZrnkikenpritu) {
        zrnkikenpritu = pZrnkikenpritu;
    }

    private Long zrntumimasimaew;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNTUMIMASIMAEW)
    public Long getZrntumimasimaew() {
        return zrntumimasimaew;
    }

    public void setZrntumimasimaew(Long pZrntumimasimaew) {
        zrntumimasimaew = pZrntumimasimaew;
    }

    private Long zrnyobin11x25;

    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KsnKbkSsuRnduHknJigyohiRn.ZRNYOBIV19)
