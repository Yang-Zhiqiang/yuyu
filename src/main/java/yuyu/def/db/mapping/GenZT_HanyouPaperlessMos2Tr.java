...
/**
 * 汎用ペーパーレス申込情報２テーブル（取） テーブルのマッピング情報クラスで、 {@link ZT_HanyouPaperlessMos2Tr} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_HanyouPaperlessMos2Tr}</td><td colspan="3">汎用ペーパーレス申込情報２テーブル（取）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtrseihowebidkbn ztrseihowebidkbn}</td><td>（取込用）生保ＷｅｂＩＤ区分</td><td align="center">{@link PKZT_HanyouPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebkojincd ztrseihowebkojincd}</td><td>（取込用）生保Ｗｅｂ個人コード</td><td align="center">{@link PKZT_HanyouPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebitijihozonhyouji ztrseihowebitijihozonhyouji}</td><td>（取込用）生保Ｗｅｂ一時保存表示</td><td align="center">{@link PKZT_HanyouPaperlessMos2Tr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrseihowebseknoc ztrseihowebseknoc}</td><td>（取込用）生保Ｗｅｂ設計書番号Ｃ</td><td align="center">{@link PKZT_HanyouPaperlessMos2Tr ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_HanyouPaperlessMos2Tr
 * @see     PKZT_HanyouPaperlessMos2Tr
 * @see     QZT_HanyouPaperlessMos2Tr
 * @see     GenQZT_HanyouPaperlessMos2Tr
 */
@MappedSuperclass
@Table(name=GenZT_HanyouPaperlessMos2Tr.TABLE_NAME)
@IdClass(value=PKZT_HanyouPaperlessMos2Tr.class)
public abstract class GenZT_HanyouPaperlessMos2Tr extends AbstractExDBEntity<ZT_HanyouPaperlessMos2Tr, PKZT_HanyouPaperlessMos2Tr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_HanyouPaperlessMos2Tr";
    ...
    private final PKZT_HanyouPaperlessMos2Tr primaryKey;

    public GenZT_HanyouPaperlessMos2Tr() {
        primaryKey = new PKZT_HanyouPaperlessMos2Tr();
    }
    ...
    @Transient
    @Override
    public PKZT_HanyouPaperlessMos2Tr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_HanyouPaperlessMos2Tr> getMetaClass() {
        return QZT_HanyouPaperlessMos2Tr.class;
    }

    @Id
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBIDKBN)
    ...
    @Id
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKOJINCD)
    ...
    @Id
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBITIJIHOZONHYOUJI)
    ...
    @Id
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSEKNOC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBCALCKIJYUNYMDC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNKNNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNSEIYMDC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNSEIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKYKKNNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKYKSYASEIYMDC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKYKSYASEIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHKNSYURUINOC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHKNKKNC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBPHRKKIKNC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHRKKAISUUKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSDPDKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKIHONSC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBNKSYURUIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBLNTKKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBNKSHRARIHYJ)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBMOSNOC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSEKYKKIGENYMDC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSKSJSITENCD)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBFSTMOSSKSYMDC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHNSYUKYKTDKKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHJNKITIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHJNKYKHYJ)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD1)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD2)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD3)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD4)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKSYKMCD5)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTEIWKKNC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKNHJNNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKJHJNNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKNDAIHYOUNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKJDAIHYOUNM)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBDAIHYOUKTGKKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSYKIHRKP1C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBMOSP1C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBTKIYOUGYOUTAIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBZENNOUKKNC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBPAPERLESSMOSHYJ)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBDATASOUSINZMHYJ)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBKYKOTTMSK)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNSYKGYCD)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHKNMSKHJNKITIKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNOTTMSK)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBHHKNNENSYUUKBN)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTHKSUNINZUUC)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTBNWARI1C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTTDKKBN2)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKNNM2)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKJNM2)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTSEIYMD2C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTBNWARI2C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTTDKKBN3)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKNNM3)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKJNM3)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTSEIYMD3C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTBNWARI3C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTTDKKBN4)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKNNM4)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTKJNM4)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBSBUKTSEIYMD4C)
    ...
    @Column(name=GenZT_HanyouPaperlessMos2Tr.ZTRSEIHOWEBS