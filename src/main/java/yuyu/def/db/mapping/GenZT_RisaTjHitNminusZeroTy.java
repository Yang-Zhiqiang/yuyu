...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ－０）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RisaTjHitNminusZeroTy} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RisaTjHitNminusZeroTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RisaTjHitNminusZeroTy.TABLE_NAME)
@IdClass(value=PKZT_RisaTjHitNminusZeroTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RisaTjHitNminusZeroTy extends AbstractExDBEntity<ZT_RisaTjHitNminusZeroTy, PKZT_RisaTjHitNminusZeroTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RisaTjHitNminusZeroTy";
    ...
    private final PKZT_RisaTjHitNminusZeroTy primaryKey;

    public GenZT_RisaTjHitNminusZeroTy() {
        primaryKey = new PKZT_RisaTjHitNminusZeroTy();
    }

    public GenZT_RisaTjHitNminusZeroTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RisaTjHitNminusZeroTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RisaTjHitNminusZeroTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RisaTjHitNminusZeroTy> getMetaClass() {
        return QZT_RisaTjHitNminusZeroTy.class;
    }

    @Id
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYERRKBNV1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYRATEKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKEIYAKUNENDO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKEIYAKUM)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTY5NENMEOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSAISITUTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYUUKOUTYUUSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSYOUMETUYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSYOUMETUYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTENKANYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTENKANYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTUUJYOUDSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTUUJYOUDSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUHRKBBNKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUHRKBBNKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUHRKBBNKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUHRKBBNKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTNKNHKTGKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTNKNHKTGKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTNKNHKTGKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUTNKNHKTGKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSAISITUKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSAISITUKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSAISITUKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSAISITUKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHRKBBNKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHRKBBNKDTISYUNNKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUSANGOHRKBBNKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNHKTGKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNHKTGKDTISYUNENKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUSANGOTNKNHKTGKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUUSANGOHUTUUSIBOUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSAISITUKAPPADSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUUSANGOSAISITUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSISTKAPPADTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUUSANGOGOUKEIKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYDTAISYOUV)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSYUSISTKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSYUSISTKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSYUSISTKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTNKNYUSYUSISTKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSYUSISTKAPPADSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSYUSISTKDTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSAIMNKKYKHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYGKDTYKNNDSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYGKDTYKYKNNDSYOYOUGAKUYOU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYDKEISANJIKWSRATE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYDKEISANJIKWSRATETKYYMD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV6X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X12)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X13)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X14)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X15)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X16)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X17)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X18)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X19)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X20)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X21)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X22)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X23)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X24)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X25)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X26)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X27)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X28)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X29)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X30)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X31)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X32)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X33)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X34)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X35)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X36)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X37)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X38)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X39)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroTy.ZTYTOKUYAKUKOUMOKUV120X40)
