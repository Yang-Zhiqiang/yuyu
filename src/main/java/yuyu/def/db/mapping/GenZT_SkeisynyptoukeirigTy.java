...
/**
 * 新契約収入Ｐ統計例月Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_SkeisynyptoukeirigTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkeisynyptoukeirigTy}</td><td colspan="3">新契約収入Ｐ統計例月Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_SkeisynyptoukeirigTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_SkeisynyptoukeirigTy
 * @see     PKZT_SkeisynyptoukeirigTy
 * @see     QZT_SkeisynyptoukeirigTy
 * @see     GenQZT_SkeisynyptoukeirigTy
 */
@MappedSuperclass
@Table(name=GenZT_SkeisynyptoukeirigTy.TABLE_NAME)
@IdClass(value=PKZT_SkeisynyptoukeirigTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_SkeisynyptoukeirigTy extends AbstractExDBEntity<ZT_SkeisynyptoukeirigTy, PKZT_SkeisynyptoukeirigTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkeisynyptoukeirigTy";
    ...
    private final PKZT_SkeisynyptoukeirigTy primaryKey;

    public GenZT_SkeisynyptoukeirigTy() {
        primaryKey = new PKZT_SkeisynyptoukeirigTy();
    }

    public GenZT_SkeisynyptoukeirigTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_SkeisynyptoukeirigTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_SkeisynyptoukeirigTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkeisynyptoukeirigTy> getMetaClass() {
        return QZT_SkeisynyptoukeirigTy.class;
    }

    @Id
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRENDOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUUNOUKEIROKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUITOUSISYA)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUUKINYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYJYUUTOUYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYJYUUTOUKAISUU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYZENNOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSETKYKKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYBANKIKKATUHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTNKNMNOSJTIKBBNJYUTUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSETRENSEIMRTIKATAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUKEIYAKUPWARIBIKIKBNX2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYKYKTNKNYUGUKBNX2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSETKAIGOMARUTEIKATAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYONENDOSYOKAIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYONENDO2KAIMEIKOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYJINENDOIKOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV1X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHNGKNKSAITEIHOSYUKNGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUUNOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTKYKKUMKHNSYUKOSUU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSITIHSYURIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYNKGNSRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSINNYUUKINKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDFNYUUKINKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTORIKUZUSIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKBNKEIRIYOUSEGMENTCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYKIKYKJKYKYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDFKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYPHIREILKEISANYOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYCASHLESSHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYJIDOUKOUSINHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN10X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN10X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSYUKEIYAKUSYURUICDV3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSISUUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYNYKNJIKAWASERATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYNYKNJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSUURIYOUYOBIN10X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV9X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV10X16)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYNKGNS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSISUUBBNTOUNYUUGK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYSAISINYOTEIRIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYZENNOUJIIKKATUBARAIJYTGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYYOBIV1X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X12)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X13)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X14)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X15)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X16)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X17)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X18)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X19)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X20)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X21)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X22)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X23)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X24)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X25)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X26)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X27)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X28)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X29)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X30)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X31)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X32)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X33)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X34)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X35)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X36)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X37)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X38)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X39)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X40)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X41)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X42)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X43)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X44)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X45)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X46)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X47)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X48)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X49)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigTy.ZTYTOKUYAKUKOUMOKUV160X50)
