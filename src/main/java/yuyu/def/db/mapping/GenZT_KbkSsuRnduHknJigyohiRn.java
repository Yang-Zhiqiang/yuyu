...
/**
 * 株価指数連動保険事業費Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_KbkSsuRnduHknJigyohiRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_KbkSsuRnduHknJigyohiRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_KbkSsuRnduHknJigyohiRn.TABLE_NAME)
@IdClass(value=PKZT_KbkSsuRnduHknJigyohiRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KbkSsuRnduHknJigyohiRn extends AbstractExDBEntityForZDB<ZT_KbkSsuRnduHknJigyohiRn, PKZT_KbkSsuRnduHknJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KbkSsuRnduHknJigyohiRn";
    ...
    private final PKZT_KbkSsuRnduHknJigyohiRn primaryKey;

    public GenZT_KbkSsuRnduHknJigyohiRn() {
        primaryKey = new PKZT_KbkSsuRnduHknJigyohiRn();
    }

    public GenZT_KbkSsuRnduHknJigyohiRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_KbkSsuRnduHknJigyohiRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_KbkSsuRnduHknJigyohiRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KbkSsuRnduHknJigyohiRn> getMetaClass() {
        return QZT_KbkSsuRnduHknJigyohiRn.class;
    }

    @Id
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNLOADINGKEIJYOYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSIHANKIKSNYDATAHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNGMKIJYHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X18)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREILKISNYUKNGKX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREILKISNYUKNGKX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNRPKEISANYOUSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIKENS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREIALPHA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREIBETA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIKENP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNVHIREILRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNKIKENPRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNTUMIMASIMAEW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X27)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X28)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X29)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X30)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X31)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIN11X32)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknJigyohiRn.ZRNYOBIV19)
