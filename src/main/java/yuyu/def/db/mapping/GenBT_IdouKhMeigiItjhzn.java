...
import yuyu.def.db.id.PKBT_IdouKhMeigiItjhzn;
import yuyu.def.db.meta.GenQBT_IdouKhMeigiItjhzn;
...
/**
 * 異動契約保全名義管理一時保存テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouKhMeigiItjhzn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_IdouKhMeigiItjhzn}</td><td colspan="3">異動契約保全名義管理一時保存テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKBT_IdouKhMeigiItjhzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouKhMeigiItjhzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     BT_IdouKhMeigiItjhzn
 * @see     PKBT_IdouKhMeigiItjhzn
 * @see     QBT_IdouKhMeigiItjhzn
 * @see     GenQBT_IdouKhMeigiItjhzn
 */
@MappedSuperclass
@Table(name=GenBT_IdouKhMeigiItjhzn.TABLE_NAME)
@IdClass(value=PKBT_IdouKhMeigiItjhzn.class)
@TypeDefs({
...
public abstract class GenBT_IdouKhMeigiItjhzn extends AbstractExDBEntity<BT_IdouKhMeigiItjhzn, PKBT_IdouKhMeigiItjhzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouKhMeigiItjhzn";
    ...
    private final PKBT_IdouKhMeigiItjhzn primaryKey;

    public GenBT_IdouKhMeigiItjhzn() {
        primaryKey = new PKBT_IdouKhMeigiItjhzn();
    }

    public GenBT_IdouKhMeigiItjhzn(String pSyono, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouKhMeigiItjhzn(pSyono, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouKhMeigiItjhzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouKhMeigiItjhzn> getMetaClass() {
        return QBT_IdouKhMeigiItjhzn.class;
    }

    @Id
    @Column(name=GenBT_IdouKhMeigiItjhzn.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenBT_IdouKhMeigiItjhzn.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNSEI)
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouKhMeigiItjhzn.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.NENKINUKTNMKANA)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.NENKINUKTNMKANJI)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouKhMeigiItjhzn.NENKINUKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKN3)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKJ3)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKN4)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SBUKTNMKJ4)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.STDRSKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.STDRSKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KYKDAIRINMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KYKDAIRINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.YOKINKBN)
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZKYKDOUKBN)
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZKTOUROKUNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZKTOUROKUNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZKTOUROKUNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigiItjhzn.KZKTOUROKUNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
