...
import yuyu.def.db.id.PKIT_BAK_SyouhnTokujou;
...
/**
 * 商品特条バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_SyouhnTokujou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_SyouhnTokujou}</td><td colspan="3">商品特条バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_SyouhnTokujou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_SyouhnTokujou
 * @see     QIT_BAK_SyouhnTokujou
 * @see     GenQIT_BAK_SyouhnTokujou
 */
@MappedSuperclass
@Table(name=GenIT_BAK_SyouhnTokujou.TABLE_NAME)
@IdClass(value=PKIT_BAK_SyouhnTokujou.class)
@TypeDefs({
...
public abstract class GenIT_BAK_SyouhnTokujou extends AbstractExDBEntity<IT_BAK_SyouhnTokujou, PKIT_BAK_SyouhnTokujou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_SyouhnTokujou";
    ...
    private final PKIT_BAK_SyouhnTokujou primaryKey;

    public GenIT_BAK_SyouhnTokujou() {
        primaryKey = new PKIT_BAK_SyouhnTokujou();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_SyouhnTokujou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_SyouhnTokujou> getMetaClass() {
        return QIT_BAK_SyouhnTokujou.class;
    }

    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujou.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.TKJYHYOUTEN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.TKJYSKGNKKN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPBUICD1)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPKKN1)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPBUICD2)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPKKN2)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPBUICD3)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPKKN3)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPBUICD4)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujou.HTNPKKN4)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.TOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujou.GYOUMUKOUSINTIME)
