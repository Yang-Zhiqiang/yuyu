...
/**
 * 最高ＳＳ単位事方書チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkJhSaikouSSTani} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkJhSaikouSSTani}</td><td colspan="3">最高ＳＳ単位事方書チェックマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHhknfromnen hhknfromnen}</td><td>被保険者年齢自</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHhkntonen hhkntonen}</td><td>被保険者年齢至</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getMoskbnfrom moskbnfrom}</td><td>申込区分自</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getMoskbnto moskbnto}</td><td>申込区分至</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTuukasyu tuukasyu}</td><td>通貨種類</td><td align="center">{@link PKBM_ChkJhSaikouSSTani ○}</td><td align="center">V</td><td>{@link C_Tuukasyu}</td></tr>
 ...
 * </table>
 * @see     BM_ChkJhSaikouSSTani
 * @see     PKBM_ChkJhSaikouSSTani
 * @see     QBM_ChkJhSaikouSSTani
 * @see     GenQBM_ChkJhSaikouSSTani
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhSaikouSSTani.TABLE_NAME)
@IdClass(value=PKBM_ChkJhSaikouSSTani.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class),
    @TypeDef(name="UserType_C_Tuukasyu", typeClass=UserType_C_Tuukasyu.class)
})
public abstract class GenBM_ChkJhSaikouSSTani extends AbstractExDBEntity<BM_ChkJhSaikouSSTani, PKBM_ChkJhSaikouSSTani> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhSaikouSSTani";
    ...
    private final PKBM_ChkJhSaikouSSTani primaryKey;

    public GenBM_ChkJhSaikouSSTani() {
        primaryKey = new PKBM_ChkJhSaikouSSTani();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhSaikouSSTani getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhSaikouSSTani> getMetaClass() {
        return QBM_ChkJhSaikouSSTani.class;
    }

    @Id
    @Column(name=GenBM_ChkJhSaikouSSTani.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenBM_ChkJhSaikouSSTani.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaikouSSTani.SYUSYOUHNSDNOTO)
    ...
    @Column(name=GenBM_ChkJhSaikouSSTani.HHKNFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhSaikouSSTani.HHKNTONEN)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaikouSSTani.MOSKBNFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaikouSSTani.MOSKBNTO)
    ...
    @Column(name=GenBM_ChkJhSaikouSSTani.TUUKASYU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhSaikouSSTani.BAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhSaikouSSTani.BAIRITU2)
