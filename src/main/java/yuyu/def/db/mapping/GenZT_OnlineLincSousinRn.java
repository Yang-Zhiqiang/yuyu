...
/**
 * オンラインＬＩＮＣ送信ファイルテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_OnlineLincSousinRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnrecordsyubetukbn zrnrecordsyubetukbn}</td><td>（連携用）レコード種別区分</td><td align="center">{@link PKZT_OnlineLincSousinRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnkykkanrino zrnkykkanrino}</td><td>（連携用）契約管理番号</td><td align="center">{@link PKZT_OnlineLincSousinRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_OnlineLincSousinRn.TABLE_NAME)
@IdClass(value=PKZT_OnlineLincSousinRn.class)
public abstract class GenZT_OnlineLincSousinRn extends AbstractExDBEntityForZDB<ZT_OnlineLincSousinRn, PKZT_OnlineLincSousinRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_OnlineLincSousinRn";
    ...
    private final PKZT_OnlineLincSousinRn primaryKey;

    public GenZT_OnlineLincSousinRn() {
        primaryKey = new PKZT_OnlineLincSousinRn();
    }

    public GenZT_OnlineLincSousinRn(String pZrnrecordsyubetukbn, String pZrnkykkanrino) {
        primaryKey = new PKZT_OnlineLincSousinRn(pZrnrecordsyubetukbn, pZrnkykkanrino);
    }

    @Transient
    @Override
    public PKZT_OnlineLincSousinRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_OnlineLincSousinRn> getMetaClass() {
        return QZT_OnlineLincSousinRn.class;
    }

    private String zrndatakbn;

    @Column(name=GenZT_OnlineLincSousinRn.ZRNDATAKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineLincSousinRn.ZRNRECORDSYUBETUKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHENKOUTYPE)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSYORIKEKKACD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSYORIKEKKAERRJIYUU)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSYORIKEKKAERRNO)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNNAYOSERECORDSUU)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKANYUUSYANO)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYOUKAISIYOUKNNM)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHHKNSEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSOUSINMOTOKAISYACD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHHKNADRKN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSIGINYUINTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSPPINYUINTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSIJNBYUTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSONOTATOKUYAKUNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNTRKMOUSIDEYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNLINCSYORIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNYUYUSIYOUKNNM)
    ...
    @Id
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKKANRINO)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHOZENYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKKNNM)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHUTUUSBSSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNSGSBSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKAKUSYASIYOURAN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNMOUSIDEFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNMOUSIDEFLGSETYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNJGYHKNFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNTNKNFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKSYASEIKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKSYASEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKADRKN)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNYOBIV17)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKNJHHKNMEI30)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKJKYKNM30)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRN15SAI1000MANFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKJHNGFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNKYKYTYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNHOZENYTYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRN15MIMANTKHUKAYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRN15MIMANTKHUKAYOTEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinRn.ZRNYOBIV46)
