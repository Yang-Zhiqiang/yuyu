...
/**
 * ＡＥＯＩ情報テーブル テーブルのマッピング情報クラスで、 {@link IT_AeoiInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_AeoiInfo}</td><td colspan="3">ＡＥＯＩ情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_AeoiInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_AeoiInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_AeoiInfo ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_AeoiInfo.TABLE_NAME)
@IdClass(value=PKIT_AeoiInfo.class)
@TypeDefs({
...
public abstract class GenIT_AeoiInfo extends AbstractExDBEntity<IT_AeoiInfo, PKIT_AeoiInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_AeoiInfo";
    ...
    private final PKIT_AeoiInfo primaryKey;

    public GenIT_AeoiInfo() {
        primaryKey = new PKIT_AeoiInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_AeoiInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_AeoiInfo> getMetaClass() {
        return QIT_AeoiInfo.class;
    }

    @Id
    @Column(name=GenIT_AeoiInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_AeoiInfo.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_AeoiInfo.RENNO)
    ...
    @Column(name=GenIT_AeoiInfo.AEOISYORIYMD)
    ...
    @Column(name=GenIT_AeoiInfo.AEOISYORIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_AeoiInfo.AEOIKOURYOKUSTTYMD)
    ...
    @Column(name=GenIT_AeoiInfo.AEOISYORISOSIKICD)
    ...
    @Column(name=GenIT_AeoiInfo.AEOITAISYOUSYAKBN)
    ...
    @Column(name=GenIT_AeoiInfo.AEOIKEKKAKBN)
    ...
    @Column(name=GenIT_AeoiInfo.AEOIHOUJINSYURUIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_AeoiInfo.AEOIKOURYOKUENDYMD)
    ...
    @Column(name=GenIT_AeoiInfo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_AeoiInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_AeoiInfo.GYOUMUKOUSINTIME)
