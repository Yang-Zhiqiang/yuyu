...
/**
 * 配当管理バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhHaitouKanri} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhHaitouKanri}</td><td colspan="3">配当管理バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHaitounendo haitounendo}</td><td>配当年度</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>BizDateY</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHaitoukinskskbn haitoukinskskbn}</td><td>配当金作成区分</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>{@link C_HaitoukinsksKbn}</td></tr>
 *  <tr><td>{@link #getHaitoumeisaikbn haitoumeisaikbn}</td><td>配当明細区分</td><td align="center">{@link PKIT_BAK_KhHaitouKanri ○}</td><td align="center">V</td><td>{@link C_HaitoumeisaiKbn}</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhHaitouKanri.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhHaitouKanri.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhHaitouKanri extends AbstractExDBEntity<IT_BAK_KhHaitouKanri, PKIT_BAK_KhHaitouKanri> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhHaitouKanri";
    ...
    private final PKIT_BAK_KhHaitouKanri primaryKey;

    public GenIT_BAK_KhHaitouKanri() {
        primaryKey = new PKIT_BAK_KhHaitouKanri();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhHaitouKanri getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhHaitouKanri> getMetaClass() {
        return QIT_BAK_KhHaitouKanri.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhHaitouKanri.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHaitouKanri.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhHaitouKanri.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.HAITOUNENDO)
    ...
    @Id
    @Column(name=GenIT_BAK_KhHaitouKanri.RENNO)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.HAITOUKINSKSKBN)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.HAITOUMEISAIKBN)
    ...
    @Type(type="BizDateYType")
    @Column(name=GenIT_BAK_KhHaitouKanri.FSTKARIWARIATEDNENDO)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.NAITEIKAKUTEIKBN)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.KARIWARIATEDSHRYMD)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhHaitouKanri.GYOUMUKOUSINTIME)
