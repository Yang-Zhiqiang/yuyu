...
/**
 * 年金原資本件チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkNkgnsHonken} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkNkgnsHonken}</td><td colspan="3">年金原資本件チェックマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKBM_ChkNkgnsHonken ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkNkgnsHonken ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkNkgnsHonken ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHhknfromnen hhknfromnen}</td><td>被保険者年齢自</td><td align="center">{@link PKBM_ChkNkgnsHonken ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHhkntonen hhkntonen}</td><td>被保険者年齢至</td><td align="center">{@link PKBM_ChkNkgnsHonken ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBM_ChkNkgnsHonken.TABLE_NAME)
@IdClass(value=PKBM_ChkNkgnsHonken.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenBM_ChkNkgnsHonken extends AbstractExDBEntity<BM_ChkNkgnsHonken, PKBM_ChkNkgnsHonken> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkNkgnsHonken";
    ...
    private final PKBM_ChkNkgnsHonken primaryKey;

    public GenBM_ChkNkgnsHonken() {
        primaryKey = new PKBM_ChkNkgnsHonken();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkNkgnsHonken getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkNkgnsHonken> getMetaClass() {
        return QBM_ChkNkgnsHonken.class;
    }

    @Id
    @Column(name=GenBM_ChkNkgnsHonken.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenBM_ChkNkgnsHonken.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkNkgnsHonken.SYUSYOUHNSDNOTO)
    ...
    @Column(name=GenBM_ChkNkgnsHonken.HHKNFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkNkgnsHonken.HHKNTONEN)
