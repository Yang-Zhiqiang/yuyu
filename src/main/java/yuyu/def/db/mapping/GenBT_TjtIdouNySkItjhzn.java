...
import yuyu.def.db.id.PKBT_TjtIdouNySkItjhzn;
...
/**
 * 当日異動内容新契約一時保存テーブル テーブルのマッピング情報クラスで、 {@link BT_TjtIdouNySkItjhzn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_TjtIdouNySkItjhzn}</td><td colspan="3">当日異動内容新契約一時保存テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKBT_TjtIdouNySkItjhzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_TjtIdouNySkItjhzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKBT_TjtIdouNySkItjhzn
 * @see     QBT_TjtIdouNySkItjhzn
 * @see     GenQBT_TjtIdouNySkItjhzn
 */
@MappedSuperclass
@Table(name=GenBT_TjtIdouNySkItjhzn.TABLE_NAME)
@IdClass(value=PKBT_TjtIdouNySkItjhzn.class)
@TypeDefs({
...
public abstract class GenBT_TjtIdouNySkItjhzn extends AbstractExDBEntity<BT_TjtIdouNySkItjhzn, PKBT_TjtIdouNySkItjhzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_TjtIdouNySkItjhzn";
    ...
    private final PKBT_TjtIdouNySkItjhzn primaryKey;

    public GenBT_TjtIdouNySkItjhzn() {
        primaryKey = new PKBT_TjtIdouNySkItjhzn();
    }

    public GenBT_TjtIdouNySkItjhzn(String pMosno, Integer pRenno3keta) {
        primaryKey = new PKBT_TjtIdouNySkItjhzn(pMosno, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_TjtIdouNySkItjhzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_TjtIdouNySkItjhzn> getMetaClass() {
        return QBT_TjtIdouNySkItjhzn.class;
    }

    @Id
    @Column(name=GenBT_TjtIdouNySkItjhzn.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenBT_TjtIdouNySkItjhzn.RENNO3KETA)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.RECORDSAKUJYOHYOUJI)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.YOUKYUUNO)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.MOSYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_TjtIdouNySkItjhzn.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_TjtIdouNySkItjhzn.SKNNKAISIYMD)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.SEIRITUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_TjtIdouNySkItjhzn.SRSYORIYMD)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.MFRENFLG)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.KYKTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenBT_TjtIdouNySkItjhzn.TSNTUUKASYU)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.SNTKHOUKBN)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.BOSYUUYM)
    @ValidDateYm
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.KYKHHKNDOUHYOUJI)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.MOSSYOUMETUKBN)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.SYOUHNSDNO)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.KAIGOMAEHRTKYKUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenBT_TjtIdouNySkItjhzn.PYENNYKNTKYKUMUKBN)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.HRKKEIRO)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenBT_TjtIdouNySkItjhzn.GYOUMUKOUSINTIME)
