...
import yuyu.def.db.id.PKIT_BAK_Suiihyou;
...
/**
 * 推移表バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_Suiihyou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_Suiihyou}</td><td colspan="3">推移表バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_Suiihyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_Suiihyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_Suiihyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_BAK_Suiihyou ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getKeikanensuu keikanensuu}</td><td>経過年数</td><td align="center">{@link PKIT_BAK_Suiihyou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_Suiihyou
 * @see     PKIT_BAK_Suiihyou
 * @see     QIT_BAK_Suiihyou
 * @see     GenQIT_BAK_Suiihyou
 */
@MappedSuperclass
@Table(name=GenIT_BAK_Suiihyou.TABLE_NAME)
@IdClass(value=PKIT_BAK_Suiihyou.class)
@TypeDefs({
...
public abstract class GenIT_BAK_Suiihyou extends AbstractExDBEntity<IT_BAK_Suiihyou, PKIT_BAK_Suiihyou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_Suiihyou";
    ...
    private final PKIT_BAK_Suiihyou primaryKey;

    public GenIT_BAK_Suiihyou() {
        primaryKey = new PKIT_BAK_Suiihyou();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_Suiihyou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_Suiihyou> getMetaClass() {
        return QIT_BAK_Suiihyou.class;
    }

    @Id
    @Column(name=GenIT_BAK_Suiihyou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_Suiihyou.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_Suiihyou.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_Suiihyou.TYOUHYOUYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_BAK_Suiihyou.KEIKANENSUU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_Suiihyou.CALCKIJYUNYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_Suiihyou.CALCYM)
    ...
    @Column(name=GenIT_BAK_Suiihyou.MVATEKIJYOUTAIKBN)
    ...
    @Column(name=GenIT_BAK_Suiihyou.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTUP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTSAME)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTDOWN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUUP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUDOWN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENDAKA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENKIJYUN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENYASU)
    ...
    @Column(name=GenIT_BAK_Suiihyou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_Suiihyou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_Suiihyou.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.TMTTKNZOUKARITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.TMTTKNZOUKARITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.TMTTKNZOUKARITU3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTUP2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTSAME2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTDOWN2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUUP2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUDOWN2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENDAKA2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENKIJYUN2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENYASU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTUP3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTSAME3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTDOWN3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUUP3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SJKKKTUSIRRTHENDOUDOWN3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENDAKA3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENKIJYUN3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YENKNSNKWSRATEYENYASU3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SISUUUPRITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SISUUUPRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.SISUUUPRITU3)
    ...
    @Column(name=GenIT_BAK_Suiihyou.SUIIHYOUSYUBETU)
    ...
    @Column(name=GenIT_BAK_Suiihyou.HRKKKNMNRYUMUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YTIRRTCALCKIJYUNRRT1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YTIRRTCALCKIJYUNRRT2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_Suiihyou.YTIRRTCALCKIJYUNRRT3)
