...
/**
 * 年齢範囲事方書チェックマスタ２ テーブルのマッピング情報クラスで、 {@link BM_ChkJhNenreiHani2} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkJhNenreiHani2}</td><td colspan="3">年齢範囲事方書チェックマスタ２</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getChannelcd channelcd}</td><td>チャネルコード</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_Channelcd}</td></tr>
 *  <tr><td>{@link #getSyusyouhncd syusyouhncd}</td><td>主契約商品コード</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHhknseifrom hhknseifrom}</td><td>被保険者性別自</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHhknseito hhknseito}</td><td>被保険者性別至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyukatakbn syukatakbn}</td><td>主契約型区分</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_KataKbn}</td></tr>
 *  <tr><td>{@link #getSyuhknkkn syuhknkkn}</td><td>主契約保険期間</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhknkknto syuhknkknto}</td><td>主契約保険期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhknkknsmnkbn syuhknkknsmnkbn}</td><td>主契約保険期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_HknkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getSyuhrkkkn syuhrkkkn}</td><td>主契約払込期間</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhrkkknto syuhrkkknto}</td><td>主契約払込期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhrkkknsmnkbn syuhrkkknsmnkbn}</td><td>主契約払込期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_HrkkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getSyufromnen syufromnen}</td><td>主契約年齢自</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyutonen syutonen}</td><td>主契約年齢至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyuyoteiriritufrom syuyoteiriritufrom}</td><td>主契約予定利率自</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyuyoteirirituto syuyoteirirituto}</td><td>主契約予定利率至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyudai1hknkkn syudai1hknkkn}</td><td>主契約第１保険期間</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTokusyuchkno tokusyuchkno}</td><td>特殊チェック番号</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTksyouhncd tksyouhncd}</td><td>特約商品コード</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTkhknkkn tkhknkkn}</td><td>特約保険期間</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTkhknkknto tkhknkknto}</td><td>特約保険期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTkhknkknsmnkbn tkhknkknsmnkbn}</td><td>特約保険期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_HknkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getTkhrkkkn tkhrkkkn}</td><td>特約払込期間</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTkhrkkknto tkhrkkknto}</td><td>特約払込期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTkhrkkknsmnkbn tkhrkkknsmnkbn}</td><td>特約払込期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">V</td><td>{@link C_HrkkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getTkfromnen tkfromnen}</td><td>特約年齢自</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTktonen tktonen}</td><td>特約年齢至</td><td align="center">{@link PKBM_ChkJhNenreiHani2 ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 * </table>
 * @see     BM_ChkJhNenreiHani2
 * @see     PKBM_ChkJhNenreiHani2
 * @see     QBM_ChkJhNenreiHani2
 * @see     GenQBM_ChkJhNenreiHani2
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhNenreiHani2.TABLE_NAME)
@IdClass(value=PKBM_ChkJhNenreiHani2.class)
@TypeDefs({
...
public abstract class GenBM_ChkJhNenreiHani2 extends AbstractExDBEntity<BM_ChkJhNenreiHani2, PKBM_ChkJhNenreiHani2> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhNenreiHani2";
    ...
    private final PKBM_ChkJhNenreiHani2 primaryKey;

    public GenBM_ChkJhNenreiHani2() {
        primaryKey = new PKBM_ChkJhNenreiHani2();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhNenreiHani2 getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhNenreiHani2> getMetaClass() {
        return QBM_ChkJhNenreiHani2.class;
    }

    @Id
    @Type(type="UserType_C_Channelcd")
    @Column(name=GenBM_ChkJhNenreiHani2.CHANNELCD)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUSYOUHNCD)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUSYOUHNSDNOTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.HHKNSEIFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.HHKNSEITO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani2.SYUKATAKBN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHKNKKN)
    @Range(min="0", max="99")
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHKNKKNTO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHKNKKNSMNKBN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHRKKKN)
    @Range(min="0", max="99")
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHRKKKNTO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani2.SYUHRKKKNSMNKBN)
    ...
    @Column(name=GenBM_ChkJhNenreiHani2.SYUFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.SYUTONEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.SYUYOTEIRIRITUFROM)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.SYUYOTEIRIRITUTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.SYUDAI1HKNKKN)
    @Range(min="0", max="99")
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.TOKUSYUCHKNO)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.TKSYOUHNCD)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.TKHKNKKN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.TKHKNKKNTO)
    ...
    @Id
    @Type(type="UserType_C_HknkknsmnKbn")
    @Column(name=GenBM_ChkJhNenreiHani2.TKHKNKKNSMNKBN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.TKHRKKKN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani2.TKHRKKKNTO)
    ...
    @Id
    @Type(type="UserType_C_HrkkknsmnKbn")
    @Column(name=GenBM_ChkJhNenreiHani2.TKHRKKKNSMNKBN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.TKFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani2.TKTONEN)
