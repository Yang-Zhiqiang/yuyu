...
/**
 * 株価指数連動保険期末ＶＦテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KbkSsuRnduHknKimatuVTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KbkSsuRnduHknKimatuVTy}</td><td colspan="3">株価指数連動保険期末ＶＦテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_KbkSsuRnduHknKimatuVTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_KbkSsuRnduHknKimatuVTy
 * @see     PKZT_KbkSsuRnduHknKimatuVTy
 * @see     QZT_KbkSsuRnduHknKimatuVTy
 * @see     GenQZT_KbkSsuRnduHknKimatuVTy
 */
@MappedSuperclass
@Table(name=GenZT_KbkSsuRnduHknKimatuVTy.TABLE_NAME)
@IdClass(value=PKZT_KbkSsuRnduHknKimatuVTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_KbkSsuRnduHknKimatuVTy extends AbstractExDBEntity<ZT_KbkSsuRnduHknKimatuVTy, PKZT_KbkSsuRnduHknKimatuVTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KbkSsuRnduHknKimatuVTy";
    ...
    private final PKZT_KbkSsuRnduHknKimatuVTy primaryKey;

    public GenZT_KbkSsuRnduHknKimatuVTy() {
        primaryKey = new PKZT_KbkSsuRnduHknKimatuVTy();
    }

    public GenZT_KbkSsuRnduHknKimatuVTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_KbkSsuRnduHknKimatuVTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_KbkSsuRnduHknKimatuVTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KbkSsuRnduHknKimatuVTy> getMetaClass() {
        return QZT_KbkSsuRnduHknKimatuVTy.class;
    }

    @Id
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN2X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYVYOURENDOURITU)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X19)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X20)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X21)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X22)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X23)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X25)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV15)
    ...
    @Column(name=GenZT_KbkSsuRnduHknKimatuVTy.ZTYYOBIV20)
