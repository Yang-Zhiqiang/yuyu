...
import yuyu.def.db.id.PKIT_BAK_KhAuthoriData;
...
/**
 * オーソリデータバックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhAuthoriData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhAuthoriData}</td><td colspan="3">オーソリデータバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getAnsyuusyskbn ansyuusyskbn}</td><td>案内収納用システム区分</td><td align="center">{@link PKIT_BAK_KhAuthoriData ○}</td><td align="center">V</td><td>{@link C_AnsyuusysKbn}</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhAuthoriData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKIT_BAK_KhAuthoriData ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhAuthoriData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getAuthorikaisuu authorikaisuu}</td><td>オーソリ回数</td><td align="center">{@link PKIT_BAK_KhAuthoriData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KhAuthoriData
 * @see     QIT_BAK_KhAuthoriData
 * @see     GenQIT_BAK_KhAuthoriData
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhAuthoriData.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhAuthoriData.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhAuthoriData extends AbstractExDBEntity<IT_BAK_KhAuthoriData, PKIT_BAK_KhAuthoriData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhAuthoriData";
    ...
    private final PKIT_BAK_KhAuthoriData primaryKey;

    public GenIT_BAK_KhAuthoriData() {
        primaryKey = new PKIT_BAK_KhAuthoriData();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhAuthoriData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhAuthoriData> getMetaClass() {
        return QIT_BAK_KhAuthoriData.class;
    }

    @Id
    @Type(type="UserType_C_AnsyuusysKbn")
    @Column(name=GenIT_BAK_KhAuthoriData.ANSYUUSYSKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_KhAuthoriData.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.SYORIYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_BAK_KhAuthoriData.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhAuthoriData.AUTHORIKAISUU)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.CREDITCARDNO1)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.CREDITCARDNO2)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.CREDITCARDNO3)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.CREDITCARDNO4)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.CREDITCARDYKKIGEN)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.JKIPJYTYM)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.GAIBURENKEIKAKUJKKBN)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.HRKKAISUU)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhAuthoriData.GYOUMUKOUSINTIME)
