...
import yuyu.def.db.id.PKJT_SiDenpyoData;
...
/**
 * 支払伝票データテーブル テーブルのマッピング情報クラスで、 {@link JT_SiDenpyoData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link JT_SiDenpyoData}</td><td colspan="3">支払伝票データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKJT_SiDenpyoData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKJT_SiDenpyoData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     JT_SiDenpyoData
 * @see     PKJT_SiDenpyoData
 * @see     QJT_SiDenpyoData
 * @see     GenQJT_SiDenpyoData
 */
@MappedSuperclass
@Table(name=GenJT_SiDenpyoData.TABLE_NAME)
@IdClass(value=PKJT_SiDenpyoData.class)
@TypeDefs({
...
public abstract class GenJT_SiDenpyoData extends AbstractExDBEntity<JT_SiDenpyoData, PKJT_SiDenpyoData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "JT_SiDenpyoData";
    ...
    private final PKJT_SiDenpyoData primaryKey;

    public GenJT_SiDenpyoData() {
        primaryKey = new PKJT_SiDenpyoData();
    }

    public GenJT_SiDenpyoData(String pDenrenno, Integer pEdano) {
        primaryKey = new PKJT_SiDenpyoData(pDenrenno, pEdano);
    }

    @Transient
    @Override
    public PKJT_SiDenpyoData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QJT_SiDenpyoData> getMetaClass() {
        return QJT_SiDenpyoData.class;
    }

    @Id
    @Column(name=GenJT_SiDenpyoData.DENRENNO)
    ...
    @Id
    @Column(name=GenJT_SiDenpyoData.EDANO)
    ...
    @Column(name=GenJT_SiDenpyoData.DENSYSKBN)
    ...
    @Column(name=GenJT_SiDenpyoData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenJT_SiDenpyoData.HURIDENATESAKICD)
    ...
    @Column(name=GenJT_SiDenpyoData.TANTOCD)
    ...
    @Column(name=GenJT_SiDenpyoData.DENYMD)
    ...
    @Column(name=GenJT_SiDenpyoData.TAISYAKUKBN)
    ...
    @Column(name=GenJT_SiDenpyoData.KANJYOUKMKCD)
    ...
    @Column(name=GenJT_SiDenpyoData.SUITOUBUMONCD)
    ...
    @Column(name=GenJT_SiDenpyoData.TUUKASYU)
    ...
    @Column(name=GenJT_SiDenpyoData.DENKAWASERATE)
    ...
    @Column(name=GenJT_SiDenpyoData.HURIDENSKSKBN)
    ...
    @Column(name=GenJT_SiDenpyoData.DENHNKNHOUKBN)
    ...
    @Column(name=GenJT_SiDenpyoData.DENSHRHOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenJT_SiDenpyoData.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenJT_SiDenpyoData.SYORICD)
    ...
    @Column(name=GenJT_SiDenpyoData.SYORISOSIKICD)
    ...
    @Column(name=GenJT_SiDenpyoData.SEG1CD)
    ...
    @Type(type="UserType_C_Segcd")
    @Column(name=GenJT_SiDenpyoData.SEG2CD)
    ...
    @Column(name=GenJT_SiDenpyoData.KAKOKAWASERATESHITEIFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenJT_SiDenpyoData.KAKOKAWASERATESHITEIYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenJT_SiDenpyoData.KYKTUUKASYU)
    ...
    @Column(name=GenJT_SiDenpyoData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenJT_SiDenpyoData.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenJT_SiDenpyoData.DENGYOUMUCD)
    ...
    @Column(name=GenJT_SiDenpyoData.SYUSYOUHNCD)
    ...
    @Column(name=GenJT_SiDenpyoData.SYOUHNSDNO)
    ...
    @Column(name=GenJT_SiDenpyoData.KAWASETEKIYOKBN)
    ...
    @Column(name=GenJT_SiDenpyoData.DENKARIKANJYONO)
    @Length(length=5)
    @Digit
    ...
    @Type(type="BooleanType")
    @Column(name=GenJT_SiDenpyoData.TAISYAKUTYOUSEIFLG)
    ...
    @Column(name=GenJT_SiDenpyoData.DENSYORISYOUSAIKBN)
