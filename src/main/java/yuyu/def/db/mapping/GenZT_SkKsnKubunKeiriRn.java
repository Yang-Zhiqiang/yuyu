...
/**
 * 新契約決算用区分経理Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkKsnKubunKeiriRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrntorihikiymd zrntorihikiymd}</td><td>（連携用）取引年月日</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinon7 zrntorihikinon7}</td><td>（連携用）取引番号Ｎ７</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntaisyakukbnn zrntaisyakukbnn}</td><td>（連携用）貸借区分（数値）</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkanjyoukamokucdn zrnkanjyoukamokucdn}</td><td>（連携用）勘定科目コード（数値）</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyobiv4 zrnyobiv4}</td><td>（連携用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsuitoubumoncd zrnsuitoubumoncd}</td><td>（連携用）出納部門コード</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkingaku zrnkingaku}</td><td>（連携用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrnkizokusegment zrnkizokusegment}</td><td>（連携用）帰属セグメント</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnaitesegment zrnaitesegment}</td><td>（連携用）相手セグメント</td><td align="center">{@link PKZT_SkKsnKubunKeiriRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_SkKsnKubunKeiriRn.TABLE_NAME)
@IdClass(value=PKZT_SkKsnKubunKeiriRn.class)
public abstract class GenZT_SkKsnKubunKeiriRn extends AbstractExDBEntityForZDB<ZT_SkKsnKubunKeiriRn, PKZT_SkKsnKubunKeiriRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKsnKubunKeiriRn";
    ...
    private final PKZT_SkKsnKubunKeiriRn primaryKey;

    public GenZT_SkKsnKubunKeiriRn() {
        primaryKey = new PKZT_SkKsnKubunKeiriRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKsnKubunKeiriRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKsnKubunKeiriRn> getMetaClass() {
        return QZT_SkKsnKubunKeiriRn.class;
    }

    private String zrnkaikeitani;

    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKAIKEITANI)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNSYORICD)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNTORIHIKINON7)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNSYORIYMDN)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKESSANKBN)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNONLINESYORIKBN)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNYOBIV28)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNYOBIV4)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNSUITOUBUMONCD)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKINGAKU)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNKIZOKUSEGMENT)
    ...
    @Id
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNAITESEGMENT)
    ...
    @Column(name=GenZT_SkKsnKubunKeiriRn.ZRNYOBIV23)
