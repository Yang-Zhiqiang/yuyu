...
import yuyu.def.db.id.PKHT_MosSyouhnVrf;
import yuyu.def.db.meta.GenQHT_MosSyouhnVrf;
...
/**
 * 申込商品ベリファイテーブル テーブルのマッピング情報クラスで、 {@link HT_MosSyouhnVrf} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_MosSyouhnVrf}</td><td colspan="3">申込商品ベリファイテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_MosSyouhnVrf ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKHT_MosSyouhnVrf ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     HT_MosSyouhnVrf
 * @see     PKHT_MosSyouhnVrf
 * @see     QHT_MosSyouhnVrf
 * @see     GenQHT_MosSyouhnVrf
 */
@MappedSuperclass
@Table(name=GenHT_MosSyouhnVrf.TABLE_NAME)
@IdClass(value=PKHT_MosSyouhnVrf.class)
@TypeDefs({
...
public abstract class GenHT_MosSyouhnVrf extends AbstractExDBEntity<HT_MosSyouhnVrf, PKHT_MosSyouhnVrf> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_MosSyouhnVrf";
    ...
    private final PKHT_MosSyouhnVrf primaryKey;

    public GenHT_MosSyouhnVrf() {
        primaryKey = new PKHT_MosSyouhnVrf();
    }

    public GenHT_MosSyouhnVrf(String pMosno, String pSyouhncd) {
        primaryKey = new PKHT_MosSyouhnVrf(pMosno, pSyouhncd);
    }

    @Transient
    @Override
    public PKHT_MosSyouhnVrf getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_MosSyouhnVrf> getMetaClass() {
        return QHT_MosSyouhnVrf.class;
    }

    @Id
    @Column(name=GenHT_MosSyouhnVrf.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_MosSyouhnVrf.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenHT_MosSyouhnVrf.SYOUHNSDNO)
    ...
    @Column(name=GenHT_MosSyouhnVrf.RYOURITUSDNO)
    ...
    @Column(name=GenHT_MosSyouhnVrf.SYUTKKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.YOTEIRIRITU)
    ...
    @Column(name=GenHT_MosSyouhnVrf.SKNENKINSYU)
    ...
    @Column(name=GenHT_MosSyouhnVrf.KATAKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.KYHKATAKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.ROKUDAILDKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_MosSyouhnVrf.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_MosSyouhnVrf.HKNKKNSMNKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.HRKKKNSMNKBN)
    ...
    @Column(name=GenHT_MosSyouhnVrf.DAI1HKNKKN)
    @Range(min="0", max="99")
    ...
    @Type(type="BizNumberType")
    @Column(name=GenHT_MosSyouhnVrf.TUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenHT_MosSyouhnVrf.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenHT_MosSyouhnVrf.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenHT_MosSyouhnVrf.RENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenHT_MosSyouhnVrf.LOADINGHNKGTUMITATERIRITU)
    ...
    @Column(name=GenHT_MosSyouhnVrf.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_MosSyouhnVrf.GYOUMUKOUSINTIME)
