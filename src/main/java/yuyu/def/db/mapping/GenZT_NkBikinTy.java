...
/**
 * 年金備金テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_NkBikinTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkBikinTy}</td><td colspan="3">年金備金テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtynksyousyono ztynksyousyono}</td><td>（中継用）年金証書番号</td><td align="center">{@link PKZT_NkBikinTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtyshiharaihasseiymd ztyshiharaihasseiymd}</td><td>（中継用）支払発生日</td><td align="center">{@link PKZT_NkBikinTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkBikinTy.TABLE_NAME)
@IdClass(value=PKZT_NkBikinTy.class)
public abstract class GenZT_NkBikinTy extends AbstractExDBEntity<ZT_NkBikinTy, PKZT_NkBikinTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkBikinTy";
    ...
    private final PKZT_NkBikinTy primaryKey;

    public GenZT_NkBikinTy() {
        primaryKey = new PKZT_NkBikinTy();
    }

    public GenZT_NkBikinTy(String pZtynksyousyono, String pZtyshiharaihasseiymd) {
        primaryKey = new PKZT_NkBikinTy(pZtynksyousyono, pZtyshiharaihasseiymd);
    }

    @Transient
    @Override
    public PKZT_NkBikinTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkBikinTy> getMetaClass() {
        return QZT_NkBikinTy.class;
    }

    @Id
    @Column(name=GenZT_NkBikinTy.ZTYNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYIDOUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOUIN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINSYU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKHNNKGK)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYCURRENTDAY)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYCURRENTTIME)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKASANNKGK)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKKNSETYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTEIZOURITU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYDKIGETU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUNENDOD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSIHARAIUKETUKEBASYO)
    ...
    @Id
    @Column(name=GenZT_NkBikinTy.ZTYSHIHARAIHASSEIYMD)
    public String getZtyshiharaihasseiymd() {
        return getPrimaryKey().getZtyshiharaihasseiymd();
    }

    public void setZtyshiharaihasseiymd(String pZtyshiharaihasseiymd) {
        getPrimaryKey().setZtyshiharaihasseiymd(pZtyshiharaihasseiymd);
    }

    private String ztyhhknseikbn;

    @Column(name=GenZT_NkBikinTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV1X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV8)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV8X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV1X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV1X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV8X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV8X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV59)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkBikinTy.ZTYYOBIV17)
