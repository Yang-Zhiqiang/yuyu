...
import yuyu.def.db.id.PKIT_KykSyaHenkouRireki;
import yuyu.def.db.meta.GenQIT_KykSyaHenkouRireki;
...
/**
 * 契約者変更履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_KykSyaHenkouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykSyaHenkouRireki}</td><td colspan="3">契約者変更履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykSyaHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykSyaHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KykSyaHenkouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KykSyaHenkouRireki
 * @see     PKIT_KykSyaHenkouRireki
 * @see     QIT_KykSyaHenkouRireki
 * @see     GenQIT_KykSyaHenkouRireki
 */
@MappedSuperclass
@Table(name=GenIT_KykSyaHenkouRireki.TABLE_NAME)
@IdClass(value=PKIT_KykSyaHenkouRireki.class)
@TypeDefs({
...
public abstract class GenIT_KykSyaHenkouRireki extends AbstractExDBEntity<IT_KykSyaHenkouRireki, PKIT_KykSyaHenkouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykSyaHenkouRireki";
    ...
    private final PKIT_KykSyaHenkouRireki primaryKey;

    public GenIT_KykSyaHenkouRireki() {
        primaryKey = new PKIT_KykSyaHenkouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_KykSyaHenkouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykSyaHenkouRireki> getMetaClass() {
        return QIT_KykSyaHenkouRireki.class;
    }

    @Id
    @Column(name=GenIT_KykSyaHenkouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykSyaHenkouRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KykSyaHenkouRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.MEIGHNKSYORIYMD)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.MEIGIHNKJIYUU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyaHenkouRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKSIBOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKYKSEI)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDKKKYKTDK)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDTSINYNO)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDTSINADR1KJ)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDTSINADR2KJ)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDTSINADR3KJ)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDTSINTELNO)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.OLDDAI2TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.DAI2TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.YENKANSANTKYKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyaHenkouRireki.YENKANSANTKYKWSRATEYMD)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykSyaHenkouRireki.GYOUMUKOUSINTIME)
