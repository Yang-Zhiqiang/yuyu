...
import yuyu.def.db.id.PKIT_BAK_Kouza;
import yuyu.def.db.meta.GenQIT_BAK_Kouza;
...
/**
 * 口座バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_Kouza} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_Kouza}</td><td colspan="3">口座バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_Kouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_Kouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_Kouza ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_BAK_Kouza
 * @see     QIT_BAK_Kouza
 * @see     GenQIT_BAK_Kouza
 */
@MappedSuperclass
@Table(name=GenIT_BAK_Kouza.TABLE_NAME)
@IdClass(value=PKIT_BAK_Kouza.class)
@TypeDefs({
...
public abstract class GenIT_BAK_Kouza extends AbstractExDBEntity<IT_BAK_Kouza, PKIT_BAK_Kouza> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_Kouza";
    ...
    private final PKIT_BAK_Kouza primaryKey;

    public GenIT_BAK_Kouza() {
        primaryKey = new PKIT_BAK_Kouza();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_Kouza getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_Kouza> getMetaClass() {
        return QIT_BAK_Kouza.class;
    }

    @Id
    @Column(name=GenIT_BAK_Kouza.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_Kouza.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_Kouza.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_Kouza.KOKNO)
    ...
    @Column(name=GenIT_BAK_Kouza.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_Kouza.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_Kouza.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_Kouza.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_Kouza.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_Kouza.SINKEIZKKBN)
    ...
    @Column(name=GenIT_BAK_Kouza.SYUUDAIKOCD)
    ...
    @Column(name=GenIT_BAK_Kouza.KZKYKDOUKBN)
    ...
    @Column(name=GenIT_BAK_Kouza.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_Kouza.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_Kouza.GYOUMUKOUSINTIME)
