...
/**
 * 異動明細Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_IdouMeisaiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_IdouMeisaiTy}</td><td colspan="3">異動明細Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_IdouMeisaiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_IdouMeisaiTy.TABLE_NAME)
@IdClass(value=PKZT_IdouMeisaiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_IdouMeisaiTy extends AbstractExDBEntity<ZT_IdouMeisaiTy, PKZT_IdouMeisaiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_IdouMeisaiTy";
    ...
    private final PKZT_IdouMeisaiTy primaryKey;

    public GenZT_IdouMeisaiTy() {
        primaryKey = new PKZT_IdouMeisaiTy();
    }

    public GenZT_IdouMeisaiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_IdouMeisaiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_IdouMeisaiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_IdouMeisaiTy> getMetaClass() {
        return QZT_IdouMeisaiTy.class;
    }

    @Id
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYIDOJIYUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZOUGENKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYIDOURECORDKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKMFKSNCTR)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRECORDCTR)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYIDOUJIYUUCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENKOUYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYENTYOUKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAKUGENKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNPKKN1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNPKKN2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEICV)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMINASICV)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYLOANFUND)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIINKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAIMASIYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAIMASIKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKIKANX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZOUKASX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUKIKANX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZOUKASX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMISYUUSTARTYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMISYUUKAISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJYOUTAI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKOUSINKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVKEISANHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV13)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYBNKTTNKNKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYBSYDRTENCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYCIFCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSINSAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMRARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYKGYCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHJNKYKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHJNCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAIHOKENNO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPMENKBNV2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKITUENKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKITUENHONSUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYLNSHRGENINCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGNSPSHRHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV3X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDATAKANRINO2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDATAKANRINO3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X12)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X13)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X14)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X15)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X16)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X17)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV15X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV15X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV15X4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAWASERATE1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAWASERATE2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIMATUSISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYENKADATEKIHONS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOBIN9)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X39)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X41)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X42)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X43)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X44)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X45)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV14)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKSYASKINMEINO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEIKIHONS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEIGYOUSEKIHYJSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYALMYOUSIBOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHARAIKOMIP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEINENBARAIKANSANP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGYOUSEKIHYOUJISRANK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_IdouMeisaiTy.ZTYTEIKIBAIRITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANGODATAKANRINO)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAITEKYKDATAKANRINO1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAITEKYKDATAKANRINO2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNSYOKAIPCASHLESSHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYOKAIPANNAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZENNOUKAISIYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYZENNOUKIKAN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEIZONKYUUHUKINSITEIY)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYALMYOUSEIZONKYHKNSITEIMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYJIKAIPJYUUTOUYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADKEISANKBNX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADKEISANKBNX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADKEISANKBNX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADKEISANKBNX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV6X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIMATUVYOUTUMIMASIKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKMTVYUSNHKNFUNDTMTTKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEINENKANSANP3X1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEINENKANSANP3X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEINENKANSANP3X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEINENKANSANP3X4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKMTVYUHIJYNBRITMTTKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIMATUVYOUITJBRTMTTKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X26)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X27)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X28)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X29)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X30)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X31)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X32)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X33)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHAITOUYOULOADINGKIJYUNS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUMITATED)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKARIWARIATED)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUZENSIHARAIKIJITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUZENTUUSANHANTEIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUGOSIHARAIKIJITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUGOTUUSANHANTEIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUGOKYUUHUTAISYOUS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTYOKUGOCBKINGAKU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYOKAISIHARAIKIJITU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYOKAITUUSANHANTEIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYCBNAYOSETUUSANHANTEIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHITENKANKEIYAKUSUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYGOUKEIPBUBUNTENKANTEIKIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAIDAIHKTGTIKKIKKKN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSISYUTNKNHKTGKUJYGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X34)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKKYKYMDX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKNX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKKYKYMDX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKNX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKKYKYMDX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKNX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKKYKYMDX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNTKBTDKISNYUSX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYTKSUX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTNKNKAIYKKUJYGKX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIHYOUJIX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHTNKNKYKNENKNSNPX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHKTGTIKKIKKKNX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSKNJYUTUTKYKKYKKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSWINGMINYUUPHRKEKNGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSWINGMINYUUPHRKEJYUTUYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFTOUNENDOITIJITOUNYUUP)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFKAIYAKUKUJYHKTGGK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAIYAKUKOUJYOTUKISUU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFKAIYAKUHENREIKIN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUUSEIS)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISYAKEISYOUSISYACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISYAZAISEKIHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISYABOSYUUJIAGE)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISYABSYJISIKAKUCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYAATUKAISYASIKAKUCD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYOKYKSMKUZTRHKKITIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHOYUUSISYACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYOKANSISYACD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTANTOUSYAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTANTOUSYAKBNNEW)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYCLUBSUMISEIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYFOLLOWTANTOUSYAKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTANTOUSYAJYOUTAIKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKIHONYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTEIKIYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSONOTAYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIJIBARAIKIHONYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIJIBARAITEIKIYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYITIJIBARAISONOTAYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANKIHONYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTENKANTEIKIYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSZOUYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVESTINGYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSIPPEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSEIJINBYOUTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYJYOSEITOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTUUINTOKUYAKUYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSAITEIHOSYOUI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVKISOITJBRKHNYOTEII)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYVKISORRTZEROIKAHYOUJI)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHOYUUSISYACD2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYDFTUJYUKUJYKISNKISIYM)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTIKIKKTBRIJYUTUTKSU)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSYUNYUMRTIKYKJTIGNGTKBN)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYHHKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKYKDRTKYKARIHYJ)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIV10X14)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTRKZSGKAIYKKJYNSTMTKZNDK)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYPMENKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYSUURIYOUYOBIN13)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X35)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X36)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYYOBIN11X37)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X2)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X3)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X4)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X5)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X6)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X7)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X8)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X9)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X10)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X11)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X12)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X13)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X14)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X15)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X16)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X17)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X18)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X19)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X20)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X21)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X22)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X23)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X24)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X25)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X26)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X27)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X28)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X29)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X30)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X31)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X32)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X33)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X34)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X35)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X36)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X37)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X38)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X39)
    ...
    @Column(name=GenZT_IdouMeisaiTy.ZTYTOKUYAKUKOUMOKUV200X40)
