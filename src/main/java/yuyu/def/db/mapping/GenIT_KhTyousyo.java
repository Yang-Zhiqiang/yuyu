...
import yuyu.def.db.id.PKIT_KhTyousyo;
import yuyu.def.db.meta.GenQIT_KhTyousyo;
...
/**
 * 契約保全支払調書テーブル テーブルのマッピング情報クラスで、 {@link IT_KhTyousyo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhTyousyo}</td><td colspan="3">契約保全支払調書テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhTyousyo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_KhTyousyo ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getShrtysyrenno shrtysyrenno}</td><td>支払調書連番</td><td align="center">{@link PKIT_KhTyousyo ○}</td><td align="center">N</td><td>Long</td></tr>
 ...
 * @see     PKIT_KhTyousyo
 * @see     QIT_KhTyousyo
 * @see     GenQIT_KhTyousyo
 */
@MappedSuperclass
@Table(name=GenIT_KhTyousyo.TABLE_NAME)
@IdClass(value=PKIT_KhTyousyo.class)
@TypeDefs({
...
public abstract class GenIT_KhTyousyo extends AbstractExDBEntity<IT_KhTyousyo, PKIT_KhTyousyo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhTyousyo";
    ...
    private final PKIT_KhTyousyo primaryKey;

    public GenIT_KhTyousyo() {
        primaryKey = new PKIT_KhTyousyo();
    }
    ...
    @Transient
    @Override
    public PKIT_KhTyousyo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhTyousyo> getMetaClass() {
        return QIT_KhTyousyo.class;
    }

    @Id
    @Column(name=GenIT_KhTyousyo.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhTyousyo.TYOUHYOUYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_KhTyousyo.SHRTYSYRENNO)
    ...
    @Column(name=GenIT_KhTyousyo.KACD)
    ...
    @Column(name=GenIT_KhTyousyo.TANTOCD)
    ...
    @Column(name=GenIT_KhTyousyo.HKNSYUKIGOU)
    ...
    @Column(name=GenIT_KhTyousyo.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KhTyousyo.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KhTyousyo.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenIT_KhTyousyo.KYKNEN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTyousyo.KYKYMD)
    ...
    @Column(name=GenIT_KhTyousyo.HHKNSEI)
    ...
    @Column(name=GenIT_KhTyousyo.HRKKAISUU)
    ...
    @Column(name=GenIT_KhTyousyo.HRKKEIRO)
    ...
    @Column(name=GenIT_KhTyousyo.ANNAIHUYOURIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTyousyo.KOURYOKUHASSEIYMD)
    ...
    @Column(name=GenIT_KhTyousyo.MFADRSIYOUHYOUJI)
    ...
    @Column(name=GenIT_KhTyousyo.KIHRPDMISEIBIDISP)
    ...
    @Column(name=GenIT_KhTyousyo.KIHRPSEIBIYOUDISP)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTyousyo.SHRYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KhTyousyo.SYORISOSIKICD)
    ...
    @Column(name=GenIT_KhTyousyo.SYORITAISYOUKBN)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYTSINYNO)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYADR1KJ)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYADR2KJ)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYADR3KJ)
    ...
    @Column(name=GenIT_KhTyousyo.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.KJDAIHYOUUKTNM)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYSYURUICD)
    ...
    @Column(name=GenIT_KhTyousyo.TEKNJIKIHRPSEIBIDISP)
    ...
    @Column(name=GenIT_KhTyousyo.ONLINECENTERCUTKBN)
    ...
    @Column(name=GenIT_KhTyousyo.SHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhTyousyo.HTYKEIHIHNSYUKBN)
    ...
    @Column(name=GenIT_KhTyousyo.TOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenIT_KhTyousyo.NENKINKKN)
    ...
    @Column(name=GenIT_KhTyousyo.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_KhTyousyo.BANKNMKN)
    @MaxLength(max=25)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhTyousyo.SITENNMKN)
    @MaxLength(max=25)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.YOKINKBN)
    ...
    @Column(name=GenIT_KhTyousyo.YOKINKNMKN)
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTyousyo.SAKUSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KhTyousyo.KYKMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhTyousyo.UKTMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhTyousyo.JIGYOUKYKMNDANTAICD)
    ...
    @Column(name=GenIT_KhTyousyo.MNSAIANNAIHNSKAKBN)
    ...
    @Column(name=GenIT_KhTyousyo.HUHO2KYKDISP)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYHKNSYUKBN)
    ...
    @Column(name=GenIT_KhTyousyo.SHRTYSYKURIKOSIDISP)
    ...
    @Column(name=GenIT_KhTyousyo.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_KhTyousyo.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.SYNYHSJYKYKNDISP)
    ...
    @Column(name=GenIT_KhTyousyo.TBLSAKUSEIHUNODISP)
    ...
    @Column(name=GenIT_KhTyousyo.DAIHYOUKTKBN)
    ...
    @Column(name=GenIT_KhTyousyo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhTyousyo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhTyousyo.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_KhTyousyo.OLDTSINYNO)
    ...
    @Column(name=GenIT_KhTyousyo.OLDTSINADR1KJ)
    ...
    @Column(name=GenIT_KhTyousyo.OLDTSINADR2KJ)
    ...
    @Column(name=GenIT_KhTyousyo.OLDTSINADR3KJ)
    ...
    @Column(name=GenIT_KhTyousyo.OLDKYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTyousyo.KYKHNKKAISUU)
    ...
    @Column(name=GenIT_KhTyousyo.SHRKYKHTYKEIHIYOUHYJ)
