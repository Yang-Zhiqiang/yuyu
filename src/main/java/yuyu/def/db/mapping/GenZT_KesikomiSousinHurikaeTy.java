...
/**
 * 消込送信Ｆ（振替）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KesikomiSousinHurikaeTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KesikomiSousinHurikaeTy}</td><td colspan="3">消込送信Ｆ（振替）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtykskmsousinrenno ztykskmsousinrenno}</td><td>（中継用）消込送信連番</td><td align="center">{@link PKZT_KesikomiSousinHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtykskmfsyoriymd ztykskmfsyoriymd}</td><td>（中継用）（消込Ｆ）処理年月日</td><td align="center">{@link PKZT_KesikomiSousinHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_KesikomiSousinHurikaeTy
 * @see     PKZT_KesikomiSousinHurikaeTy
 * @see     QZT_KesikomiSousinHurikaeTy
 * @see     GenQZT_KesikomiSousinHurikaeTy
 */
@MappedSuperclass
@Table(name=GenZT_KesikomiSousinHurikaeTy.TABLE_NAME)
@IdClass(value=PKZT_KesikomiSousinHurikaeTy.class)
public abstract class GenZT_KesikomiSousinHurikaeTy extends AbstractExDBEntity<ZT_KesikomiSousinHurikaeTy, PKZT_KesikomiSousinHurikaeTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KesikomiSousinHurikaeTy";
    ...
    private final PKZT_KesikomiSousinHurikaeTy primaryKey;

    public GenZT_KesikomiSousinHurikaeTy() {
        primaryKey = new PKZT_KesikomiSousinHurikaeTy();
    }

    public GenZT_KesikomiSousinHurikaeTy(String pZtykskmsousinrenno, String pZtykskmfsyoriymd) {
        primaryKey = new PKZT_KesikomiSousinHurikaeTy(pZtykskmsousinrenno, pZtykskmfsyoriymd);
    }

    @Transient
    @Override
    public PKZT_KesikomiSousinHurikaeTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KesikomiSousinHurikaeTy> getMetaClass() {
        return QZT_KesikomiSousinHurikaeTy.class;
    }

    @Id
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMSOUSINRENNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMKAMOKUCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYSUITOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYSUITOUSOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHASSEIDENYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKARIKANJYONO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKKAKUSYOUNYUURYOKUYMD1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYIKTANNAIDANTAIZAIKEIKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFANNISKCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDANTAIANNAIJYUUTOUYM1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYANNAINO1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYBONUSHARAIHYOUJI1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFKZHURIKAEBANKCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFHURIKAEYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDAIRITENUKETUKENO1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYZAIKEIHRKKAISUUKBN1)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNOUKINHYOUNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFCREDITKAISYACD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKINYUUKIKANKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYYOBIV18)
    ...
    @Id
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFSYORIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFDENYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDENATESAKICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFTAISYAKUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHUTUUHOKENKAMOKUCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDENGK)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYTABAKARIKNJYKSKMDATAKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFRYOUSYUUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYRYOUSYUUHM)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKKAKUSYOUNYUURYOKUYMD2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFSYONO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKHOUKOKUHYOUTANTOUKA)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKHOUKOKUHYOUKIHYOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKHOUKOKUHYOUBUNKAINO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNKKAKUSYOUNYUURYOKUNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFDANTAICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDANTAIANNAIJYUUTOUYM2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYBONUSHARAIHYOUJI2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYANNAINO2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDANTAIPKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDANTAINYUUKINYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFJYUUTOUYM)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYSUITOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYNYUURYOKUHOUHOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFNYKNAIYOUKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKZHURIKAEKYKHNDNKHYOUJI)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFDAIRITENCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYDAIRITENUKETUKENO2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYIKKATUDANTAICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYIKKATUANNAIHIKISARIYM)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYIKKATUANNAINO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYZAIKEIHRKKAISUUKBN2)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYZAIKEIKYKSYANO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHASSEISOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYTEIKEISAKIKAISYACD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMFBANKCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYSUITOUSYORISOSIKICD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYAITEKANJYOUYOMIKAEKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYCREDITCARDHRKSKMKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYLASTTEISEIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMKANRYOUYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMTEISEINO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYKSKMKANRYOUSIJIHYOUJI)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYUKETUKETENCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYCVSCD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHURIKOMIYOUSINYUUKINKBN)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHURIKOMIYOUSIOKYKSMNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYHURIKOMIYOUSIKAKUNINNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYEGSYOKUINHURIKOMIYMD)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYVITKAIINNO)
    ...
    @Column(name=GenZT_KesikomiSousinHurikaeTy.ZTYYOBIV74)
