...
import yuyu.def.db.id.PKHT_UketorininVrf;
import yuyu.def.db.meta.GenQHT_UketorininVrf;
...
/**
 * 受取人ベリファイテーブル テーブルのマッピング情報クラスで、 {@link HT_UketorininVrf} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_UketorininVrf}</td><td colspan="3">受取人ベリファイテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_UketorininVrf ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUktsyukbn uktsyukbn}</td><td>受取人種類区分</td><td align="center">{@link PKHT_UketorininVrf ○}</td><td align="center">V</td><td>{@link C_UktsyuKbn}</td></tr>
 *  <tr><td>{@link #getUktsyurenno uktsyurenno}</td><td>受取人種類別連番</td><td align="center">{@link PKHT_UketorininVrf ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     HT_UketorininVrf
 * @see     PKHT_UketorininVrf
 * @see     QHT_UketorininVrf
 * @see     GenQHT_UketorininVrf
 */
@MappedSuperclass
@Table(name=GenHT_UketorininVrf.TABLE_NAME)
@IdClass(value=PKHT_UketorininVrf.class)
@TypeDefs({
...
public abstract class GenHT_UketorininVrf extends AbstractExDBEntity<HT_UketorininVrf, PKHT_UketorininVrf> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_UketorininVrf";
    ...
    private final PKHT_UketorininVrf primaryKey;

    public GenHT_UketorininVrf() {
        primaryKey = new PKHT_UketorininVrf();
    }
    ...
    @Transient
    @Override
    public PKHT_UketorininVrf getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_UketorininVrf> getMetaClass() {
        return QHT_UketorininVrf.class;
    }

    @Id
    @Column(name=GenHT_UketorininVrf.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_UketorininVrf.UKTSYUKBN)
    ...
    @Id
    @Column(name=GenHT_UketorininVrf.UKTSYURENNO)
    ...
    @Column(name=GenHT_UketorininVrf.UKTKBN)
    ...
    @Column(name=GenHT_UketorininVrf.UKTNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_UketorininVrf.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_UketorininVrf.UKTNMKJKHUKAKBN)
    ...
    @Column(name=GenHT_UketorininVrf.UKTTDK)
    ...
    @Column(name=GenHT_UketorininVrf.UKTBNWARI)
    ...
    @Column(name=GenHT_UketorininVrf.UKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_UketorininVrf.UKTTSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_UketorininVrf.UKTYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_UketorininVrf.UKTADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_UketorininVrf.UKTADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_UketorininVrf.UKTADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_UketorininVrf.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_UketorininVrf.GYOUMUKOUSINTIME)
