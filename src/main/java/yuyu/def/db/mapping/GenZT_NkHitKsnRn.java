...
/**
 * 年金配当所要額Ｆ決算報告用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkHitKsnRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkHitKsnRn}</td><td colspan="3">年金配当所要額Ｆ決算報告用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnnksyousyono zrnnksyousyono}</td><td>（連携用）年金証書番号</td><td align="center">{@link PKZT_NkHitKsnRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkHitKsnRn.TABLE_NAME)
@IdClass(value=PKZT_NkHitKsnRn.class)
public abstract class GenZT_NkHitKsnRn extends AbstractExDBEntityForZDB<ZT_NkHitKsnRn, PKZT_NkHitKsnRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkHitKsnRn";
    ...
    private final PKZT_NkHitKsnRn primaryKey;

    public GenZT_NkHitKsnRn() {
        primaryKey = new PKZT_NkHitKsnRn();
    }

    public GenZT_NkHitKsnRn(String pZrnnksyousyono) {
        primaryKey = new PKZT_NkHitKsnRn(pZrnnksyousyono);
    }

    @Transient
    @Override
    public PKZT_NkHitKsnRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkHitKsnRn> getMetaClass() {
        return QZT_NkHitKsnRn.class;
    }

    @Id
    @Column(name=GenZT_NkHitKsnRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNNENKINTYPEKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNNENKINITIJISIHARAINENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNMANRYOUKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKEIYAKUNENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNSEIZONKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOTEIRIRITUN5)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRN5NNGT3NNGTOUTUBKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV7)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV15)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNGYOUSEKIHYOUJISIBOUS)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYUUKOUTYUUSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNSYOUMETUJISYOYOUGAKUYOU1)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNSYOUMETUJISYOYOUGAKUYOU2)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNRISADTAISYOUV)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNNKNENGK)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNSYUKEIYAKUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKAIMASINENKINNENGAKU)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV8)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV38)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKEISANKIJYUNYMD)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTOUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOKUYOKUJIGYOUNENDO)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTOUNENDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYKNNDSEISIKIWARIATEHYJ)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNZNNNDSEISIKIWRATEHYJ)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTOUNENDODHANEIZUMIHYOUJI)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTOUNENDOOUTOUBIJITEND)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTUNNDOUTUBIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTUNNDMTIKUYKNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYKNNDOUTUBIKOUYKNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNZNNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKTYUMTIKUTUNNDOUTUBRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNTUNNDOUTUBIKUKTYUMTRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNKTYUMTIKUTUNNDMTRRT)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_NkHitKsnRn.ZRNYOBIV16)
