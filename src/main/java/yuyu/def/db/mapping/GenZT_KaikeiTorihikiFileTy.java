...
/**
 * 会計取引ファイルテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_KaikeiTorihikiFileTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_KaikeiTorihikiFileTy}</td><td colspan="3">会計取引ファイルテーブル（中）</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikiymd ztytorihikiymd}</td><td>（中継用）取引年月日</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinon7 ztytorihikinon7}</td><td>（中継用）取引番号Ｎ７</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytaisyakukbnn ztytaisyakukbnn}</td><td>（中継用）貸借区分（数値）</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtykanjyoukamokucdn ztykanjyoukamokucdn}</td><td>（中継用）勘定科目コード（数値）</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtyyobiv4 ztyyobiv4}</td><td>（中継用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysuitoubumon ztysuitoubumon}</td><td>（中継用）出納部門</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtykingaku ztykingaku}</td><td>（中継用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZtytekiyoucd ztytekiyoucd}</td><td>（中継用）摘要コード</td><td align="center">{@link PKZT_KaikeiTorihikiFileTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_KaikeiTorihikiFileTy
 * @see     PKZT_KaikeiTorihikiFileTy
 * @see     QZT_KaikeiTorihikiFileTy
 * @see     GenQZT_KaikeiTorihikiFileTy
 */
@MappedSuperclass
@Table(name=GenZT_KaikeiTorihikiFileTy.TABLE_NAME)
@IdClass(value=PKZT_KaikeiTorihikiFileTy.class)
public abstract class GenZT_KaikeiTorihikiFileTy extends AbstractExDBEntity<ZT_KaikeiTorihikiFileTy, PKZT_KaikeiTorihikiFileTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_KaikeiTorihikiFileTy";
    ...
    private final PKZT_KaikeiTorihikiFileTy primaryKey;

    public GenZT_KaikeiTorihikiFileTy() {
        primaryKey = new PKZT_KaikeiTorihikiFileTy();
    }
    ...
    @Transient
    @Override
    public PKZT_KaikeiTorihikiFileTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_KaikeiTorihikiFileTy> getMetaClass() {
        return QZT_KaikeiTorihikiFileTy.class;
    }

    private String ztylen;

    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYLEN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKAIKEITANI)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYSYORICD)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTORIHIKINON7)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYSYORIYMDN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYSIMEKIRIKBN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKESSANKBN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYYOBIV20)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKAISYAKANTORIHIKIKBN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTUKEKAEKBN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTABLEKOSUU)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYYOBIV4)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYSUITOUBUMON)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYKINGAKU)
    ...
    @Id
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYTEKIYOUCD)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_KaikeiTorihikiFileTy.ZTYMEISAIKANRYOUKBN)
