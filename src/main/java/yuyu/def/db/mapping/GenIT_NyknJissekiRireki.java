...
import yuyu.def.db.id.PKIT_NyknJissekiRireki;
import yuyu.def.db.meta.GenQIT_NyknJissekiRireki;
...
/**
 * 入金実績履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_NyknJissekiRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_NyknJissekiRireki}</td><td colspan="3">入金実績履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_NyknJissekiRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_NyknJissekiRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getJyutoustartym jyutoustartym}</td><td>充当開始年月</td><td align="center">{@link PKIT_NyknJissekiRireki ○}</td><td align="center">V</td><td>BizDateYM</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_NyknJissekiRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_NyknJissekiRireki
 * @see     PKIT_NyknJissekiRireki
 * @see     QIT_NyknJissekiRireki
 * @see     GenQIT_NyknJissekiRireki
 */
@MappedSuperclass
@Table(name=GenIT_NyknJissekiRireki.TABLE_NAME)
@IdClass(value=PKIT_NyknJissekiRireki.class)
@TypeDefs({
...
public abstract class GenIT_NyknJissekiRireki extends AbstractExDBEntity<IT_NyknJissekiRireki, PKIT_NyknJissekiRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_NyknJissekiRireki";
    ...
    private final PKIT_NyknJissekiRireki primaryKey;

    public GenIT_NyknJissekiRireki() {
        primaryKey = new PKIT_NyknJissekiRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_NyknJissekiRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_NyknJissekiRireki> getMetaClass() {
        return QIT_NyknJissekiRireki.class;
    }

    @Id
    @Column(name=GenIT_NyknJissekiRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_NyknJissekiRireki.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_NyknJissekiRireki.JYUTOUSTARTYM)
    ...
    @Id
    @Column(name=GenIT_NyknJissekiRireki.RENNO)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_NyknJissekiRireki.JYUTOUENDYM)
    ...
    @Column(name=GenIT_NyknJissekiRireki.RSTUUKASYU)
    ...
    @Column(name=GenIT_NyknJissekiRireki.RYOSYUKWSRATEKJYMD)
    ...
    @Column(name=GenIT_NyknJissekiRireki.RYOSYUKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.NYKSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_NyknJissekiRireki.NYKDENNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.NYKDENYMD)
    ...
    @Column(name=GenIT_NyknJissekiRireki.NYKKEIRO)
    ...
    @Column(name=GenIT_NyknJissekiRireki.HRKKAISUU)
    ...
    @Column(name=GenIT_NyknJissekiRireki.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_NyknJissekiRireki.IKKATUYOUPKAISUU)
    ...
    @Column(name=GenIT_NyknJissekiRireki.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_NyknJissekiRireki.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Column(name=GenIT_NyknJissekiRireki.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_NyknJissekiRireki.IKTNYUUKINNUMU)
    ...
    @Column(name=GenIT_NyknJissekiRireki.NYKTRKSFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.NYKTRKSYMD)
    ...
    @Column(name=GenIT_NyknJissekiRireki.NYKTRKSDENNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.NYKTRKSDENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_NyknJissekiRireki.YENKANSANTKYKWSRATEYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_NyknJissekiRireki.YENKANSANTKYKWSRATE)
    ...
    @Column(name=GenIT_NyknJissekiRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_NyknJissekiRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_NyknJissekiRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_NyknJissekiRireki.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_NyknJissekiRireki.CREDITKESSAIYOUNO)
