...
import yuyu.def.db.id.PKHT_SkLincSousinInfo;
...
/**
 * 新契約ＬＩＮＣ送信情報テーブル テーブルのマッピング情報クラスで、 {@link HT_SkLincSousinInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_SkLincSousinInfo}</td><td colspan="3">新契約ＬＩＮＣ送信情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getLincsoujyusinsyskbn lincsoujyusinsyskbn}</td><td>ＬＩＮＣ送受信用システム区分</td><td align="center">{@link PKHT_SkLincSousinInfo ○}</td><td align="center">V</td><td>{@link C_LincsoujyusinsysKbn}</td></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_SkLincSousinInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKHT_SkLincSousinInfo ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKHT_SkLincSousinInfo
 * @see     QHT_SkLincSousinInfo
 * @see     GenQHT_SkLincSousinInfo
 */
@MappedSuperclass
@Table(name=GenHT_SkLincSousinInfo.TABLE_NAME)
@IdClass(value=PKHT_SkLincSousinInfo.class)
@TypeDefs({
...
public abstract class GenHT_SkLincSousinInfo extends AbstractExDBEntity<HT_SkLincSousinInfo, PKHT_SkLincSousinInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_SkLincSousinInfo";
    ...
    private final PKHT_SkLincSousinInfo primaryKey;

    public GenHT_SkLincSousinInfo() {
        primaryKey = new PKHT_SkLincSousinInfo();
    }
    ...
    @Transient
    @Override
    public PKHT_SkLincSousinInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_SkLincSousinInfo> getMetaClass() {
        return QHT_SkLincSousinInfo.class;
    }

    @Id
    @Type(type="UserType_C_LincsoujyusinsysKbn")
    @Column(name=GenHT_SkLincSousinInfo.LINCSOUJYUSINSYSKBN)
    ...
    @Id
    @Column(name=GenHT_SkLincSousinInfo.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_SkLincSousinInfo.RENNO)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCSOUSINKBN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCRECORDSYUBETU)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHENKOUTYPE)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKANYUUSYANO)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHHKNNMKN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHHKNNMKJ)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHHKNSEI)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHHKNSEIYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHHKNADRKN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKEIHIDJNHYOUJI)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKNMKN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKNMKJ)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKSEI)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKSEIYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKADRKN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCTRKMOUSIDEYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKYTYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKYKYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHOZENYTYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCHOZENYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCKAKUSYASIYOURAN)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCMOUSIDEFLG)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCMOUSIDEFLGSETYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCJGYHKNFLG)
    ...
    @Column(name=GenHT_SkLincSousinInfo.LINCTENKANFLG)
    ...
    @Column(name=GenHT_SkLincSousinInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_SkLincSousinInfo.GYOUMUKOUSINTIME)
