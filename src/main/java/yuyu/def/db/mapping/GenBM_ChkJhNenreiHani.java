...
import yuyu.def.db.id.PKBM_ChkJhNenreiHani;
...
/**
 * 年齢範囲事方書チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkJhNenreiHani} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkJhNenreiHani}</td><td colspan="3">年齢範囲事方書チェックマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getChannelcd channelcd}</td><td>チャネルコード</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_Channelcd}</td></tr>
 *  <tr><td>{@link #getSyusyouhncd syusyouhncd}</td><td>主契約商品コード</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 *  <tr><td>{@link #getSyukatakbn syukatakbn}</td><td>主契約型区分</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_KataKbn}</td></tr>
 *  <tr><td>{@link #getSyuhknkkn syuhknkkn}</td><td>主契約保険期間</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhknkknto syuhknkknto}</td><td>主契約保険期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhknkknsmnkbn syuhknkknsmnkbn}</td><td>主契約保険期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_HknkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getSyuhrkkkn syuhrkkkn}</td><td>主契約払込期間</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhrkkknto syuhrkkknto}</td><td>主契約払込期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyuhrkkknsmnkbn syuhrkkknsmnkbn}</td><td>主契約払込期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_HrkkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getSyufromnen syufromnen}</td><td>主契約年齢自</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyutonen syutonen}</td><td>主契約年齢至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyuyoteiriritufrom syuyoteiriritufrom}</td><td>主契約予定利率自</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSyuyoteirirituto syuyoteirirituto}</td><td>主契約予定利率至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTokusyuchkno tokusyuchkno}</td><td>特殊チェック番号</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTksyouhncd tksyouhncd}</td><td>特約商品コード</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTkhknkkn tkhknkkn}</td><td>特約保険期間</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTkhknkknto tkhknkknto}</td><td>特約保険期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTkhknkknsmnkbn tkhknkknsmnkbn}</td><td>特約保険期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_HknkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getTkhrkkkn tkhrkkkn}</td><td>特約払込期間</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTkhrkkknto tkhrkkknto}</td><td>特約払込期間至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTkhrkkknsmnkbn tkhrkkknsmnkbn}</td><td>特約払込期間歳満期区分</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">V</td><td>{@link C_HrkkknsmnKbn}</td></tr>
 *  <tr><td>{@link #getTkfromnen tkfromnen}</td><td>特約年齢自</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getTktonen tktonen}</td><td>特約年齢至</td><td align="center">{@link PKBM_ChkJhNenreiHani ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 * </table>
 * @see     BM_ChkJhNenreiHani
 * @see     PKBM_ChkJhNenreiHani
 * @see     QBM_ChkJhNenreiHani
 * @see     GenQBM_ChkJhNenreiHani
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhNenreiHani.TABLE_NAME)
@IdClass(value=PKBM_ChkJhNenreiHani.class)
@TypeDefs({
...
public abstract class GenBM_ChkJhNenreiHani extends AbstractExDBEntity<BM_ChkJhNenreiHani, PKBM_ChkJhNenreiHani> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhNenreiHani";
    ...
    private final PKBM_ChkJhNenreiHani primaryKey;

    public GenBM_ChkJhNenreiHani() {
        primaryKey = new PKBM_ChkJhNenreiHani();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhNenreiHani getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhNenreiHani> getMetaClass() {
        return QBM_ChkJhNenreiHani.class;
    }

    @Id
    @Type(type="UserType_C_Channelcd")
    @Column(name=GenBM_ChkJhNenreiHani.CHANNELCD)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUSYOUHNCD)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUSYOUHNSDNOTO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.HHKNSEIFROM)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.HHKNSEITO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.SYUKATAKBN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUHKNKKN)
    @Range(min="0", max="99")
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUHKNKKNTO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.SYUHKNKKNSMNKBN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUHRKKKN)
    @Range(min="0", max="99")
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.SYUHRKKKNTO)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.SYUHRKKKNSMNKBN)
    ...
    @Column(name=GenBM_ChkJhNenreiHani.SYUFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.SYUTONEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.SYUYOTEIRIRITUFROM)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.SYUYOTEIRIRITUTO)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.TOKUSYUCHKNO)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.TKSYOUHNCD)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.TKHKNKKN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.TKHKNKKNTO)
    ...
    @Id
    @Type(type="UserType_C_HknkknsmnKbn")
    @Column(name=GenBM_ChkJhNenreiHani.TKHKNKKNSMNKBN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.TKHRKKKN)
    ...
    @Id
    @Column(name=GenBM_ChkJhNenreiHani.TKHRKKKNTO)
    ...
    @Id
    @Type(type="UserType_C_HrkkknsmnKbn")
    @Column(name=GenBM_ChkJhNenreiHani.TKHRKKKNSMNKBN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.TKFROMNEN)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhNenreiHani.TKTONEN)
