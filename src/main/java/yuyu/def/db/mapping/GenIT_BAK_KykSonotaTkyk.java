...
import yuyu.def.db.id.PKIT_BAK_KykSonotaTkyk;
import yuyu.def.db.meta.GenQIT_BAK_KykSonotaTkyk;
...
/**
 * 契約その他特約バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KykSonotaTkyk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KykSonotaTkyk}</td><td colspan="3">契約その他特約バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KykSonotaTkyk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KykSonotaTkyk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KykSonotaTkyk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KykSonotaTkyk
 * @see     PKIT_BAK_KykSonotaTkyk
 * @see     QIT_BAK_KykSonotaTkyk
 * @see     GenQIT_BAK_KykSonotaTkyk
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KykSonotaTkyk.TABLE_NAME)
@IdClass(value=PKIT_BAK_KykSonotaTkyk.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KykSonotaTkyk extends AbstractExDBEntity<IT_BAK_KykSonotaTkyk, PKIT_BAK_KykSonotaTkyk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KykSonotaTkyk";
    ...
    private final PKIT_BAK_KykSonotaTkyk primaryKey;

    public GenIT_BAK_KykSonotaTkyk() {
        primaryKey = new PKIT_BAK_KykSonotaTkyk();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KykSonotaTkyk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KykSonotaTkyk> getMetaClass() {
        return QIT_BAK_KykSonotaTkyk.class;
    }

    @Id
    @Column(name=GenIT_BAK_KykSonotaTkyk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSonotaTkyk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KykSonotaTkyk.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.LIVINGNEEDSHUKAUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.STDRSKTKYHKUMU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.STDRSKTKYHKYMD)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.YENNYKNTKHKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.GAIKANYKNTKHKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.YENSHRTKHKUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.YENSHRKYKKYKHENKOYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKGKKATEITKUMU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKSGKHOSYUWARI)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.SKJBRNKTSUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NENKINGAKU8WARITKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NENKINGAKU9WARITKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKYENTKHUKAUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.KWSTTKHUKAUMU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.KWSTARGETRATE)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.TARGETTKHKUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.TARGETTKYKKYKHENKOYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.TARGETTKKBN)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.TARGETTKMOKUHYOUTI)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.YSKNKSHTKUMU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKKYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKGANSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMHKTSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJHKTGANSKNNKAISIYMD)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPBUICD1)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPKKN1)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPBUICD2)
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPKKN2)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPBUICD3)
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPKKN3)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPBUICD4)
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTKHTNPKKN4)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.PMNJTOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.SKNNKAISIKITKKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NSTKHKUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKSHRTKYKHENKOYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKSHRTKYKNKSYUKBN)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.NKSHRTKYKNKSYUKKN)
    @Range(min="0", max="99")
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.INITSBJIYENSITIHSYTKHUKAUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.JYUDKAIGOMEHARAITKHUKAUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.JYUDKAIGOMEHARAITKHUKAYMD)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.TARGETTKYKHKYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.ZEISEITKKKTKYKHUKAUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.ZEISEITKKKTKYKHUKAYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.ZEISEITKKKTKYKSYOUMETUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.YENNYKNSYURUIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.KYKDRTKYKHUKAUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.KYKDRTKYKHUKAYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSonotaTkyk.KYKDRTKYKKAIYAKUYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSonotaTkyk.TEIKISHRTKYKHUKAUMU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.TEIKISHRKINSHRTUUKASYU)
    ...
    @Column(name=GenIT_BAK_KykSonotaTkyk.TEIKISHRKINSHRMD)
