...
/**
 * 配当金支払ワークテーブル テーブルのマッピング情報クラスで、 {@link IW_KhDShrWk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IW_KhDShrWk}</td><td colspan="3">配当金支払ワークテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKouteikanriid kouteikanriid}</td><td>工程管理ＩＤ</td><td align="center">{@link PKIW_KhDShrWk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getHaitoukinskkbn haitoukinskkbn}</td><td>配当金請求区分</td><td align="center">&nbsp;</td><td align="center">V</td><td>{@link C_TumitateDSakuseiKbn}</td></tr>
 *  <tr><td>{@link #getHaitoukinskkngk haitoukinskkngk}</td><td>配当金請求金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIW_KhDShrWk.TABLE_NAME)
@IdClass(value=PKIW_KhDShrWk.class)
@TypeDefs({
...
public abstract class GenIW_KhDShrWk extends AbstractExDBEntity<IW_KhDShrWk, PKIW_KhDShrWk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IW_KhDShrWk";
    ...
    public static final String HAITOUKINSKKBN           = "haitoukinskkbn";
    public static final String HAITOUKINSKKNGK          = "haitoukinskkngk";
    ...
    private final PKIW_KhDShrWk primaryKey;

    public GenIW_KhDShrWk() {
        primaryKey = new PKIW_KhDShrWk();
    }

    public GenIW_KhDShrWk(String pKouteikanriid) {
        primaryKey = new PKIW_KhDShrWk(pKouteikanriid);
    }

    @Transient
    @Override
    public PKIW_KhDShrWk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIW_KhDShrWk> getMetaClass() {
        return QIW_KhDShrWk.class;
    }

    @Id
    @Column(name=GenIW_KhDShrWk.KOUTEIKANRIID)
    ...
    @Column(name=GenIW_KhDShrWk.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIW_KhDShrWk.SKSSAKUSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIW_KhDShrWk.SYORUIUKEYMD)
    @ValidDate
    ...
    private C_TumitateDSakuseiKbn haitoukinskkbn;

    @Type(type="UserType_C_TumitateDSakuseiKbn")
    @Column(name=GenIW_KhDShrWk.HAITOUKINSKKBN)
    public C_TumitateDSakuseiKbn getHaitoukinskkbn() {
        return haitoukinskkbn;
    }

    public void setHaitoukinskkbn(C_TumitateDSakuseiKbn pHaitoukinskkbn) {
        haitoukinskkbn = pHaitoukinskkbn;
    }

    private BizCurrency haitoukinskkngk;

    @Type(type="BizCurrencyType")
    @Transient
    public BizCurrency getHaitoukinskkngk() {
        return haitoukinskkngk;
    }

    public void setHaitoukinskkngk(BizCurrency pHaitoukinskkngk) {
        haitoukinskkngk = pHaitoukinskkngk;
        haitoukinskkngkValue = null;
        haitoukinskkngkType  = null;
    }

    transient private BigDecimal haitoukinskkngkValue = null;

    @SuppressWarnings("deprecation")
    @Column(name=HAITOUKINSKKNGK, nullable=true)
    protected BigDecimal getHaitoukinskkngkValue() {
        if (haitoukinskkngkValue == null && haitoukinskkngk != null) {
            if (haitoukinskkngk.isOptional()) return null;
            return haitoukinskkngk.absolute();
        }
        return haitoukinskkngkValue;
    }

    protected void setHaitoukinskkngkValue(BigDecimal value) {
        haitoukinskkngkValue = value;
        haitoukinskkngk = Optional.fromNullable(toCurrencyType(haitoukinskkngkType))
            .transform(bizCurrencyTransformer(getHaitoukinskkngkValue()))
            .orNull();
    }

    transient private String haitoukinskkngkType = null;

    @Column(name=HAITOUKINSKKNGK + "$", nullable=true)
    protected String getHaitoukinskkngkType() {
        if (haitoukinskkngkType == null && haitoukinskkngk != null) return haitoukinskkngk.getType().toString();
        if (haitoukinskkngkType == null && getHaitoukinskkngkValue() != null) {
            throw new RuntimeException(new SQLException("BizCurrency field 'haitoukinskkngk$' should not be NULL."));
        }
        return haitoukinskkngkType;
    }

    protected void setHaitoukinskkngkType(String type) {
        haitoukinskkngkType = type;
        haitoukinskkngk = Optional.fromNullable(toCurrencyType(haitoukinskkngkType))
            .transform(bizCurrencyTransformer(getHaitoukinskkngkValue()))
            .orNull();
    }
    ...
    @Column(name=GenIW_KhDShrWk.INPUTSHRHOUSITEIKBN)
    ...
    @Column(name=GenIW_KhDShrWk.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIW_KhDShrWk.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIW_KhDShrWk.YOKINKBN)
    ...
    @Column(name=GenIW_KhDShrWk.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIW_KhDShrWk.KZDOUKBN)
    ...
    @Column(name=GenIW_KhDShrWk.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIW_KhDShrWk.HONNINKAKNINKEKKAKBN)
    ...
    @Column(name=GenIW_KhDShrWk.ZENKAISYORIKEKKAKBN)
    ...
    @Column(name=GenIW_KhDShrWk.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIW_KhDShrWk.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIW_KhDShrWk.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIW_KhDShrWk.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIW_KhDShrWk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIW_KhDShrWk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIW_KhDShrWk.GYOUMUKOUSINTIME)
