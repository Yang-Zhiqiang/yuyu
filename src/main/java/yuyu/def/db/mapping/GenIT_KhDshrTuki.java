...
/**
 * 契約保全Ｄ支払統計テーブル テーブルのマッピング情報クラスで、 {@link IT_KhDshrTuki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhDshrTuki}</td><td colspan="3">契約保全Ｄ支払統計テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDshrtoukeisikibetukey dshrtoukeisikibetukey}</td><td>Ｄ支払統計識別キー</td><td align="center">{@link PKIT_KhDshrTuki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhDshrTuki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KhDshrTuki.TABLE_NAME)
@IdClass(value=PKIT_KhDshrTuki.class)
@TypeDefs({
...
public abstract class GenIT_KhDshrTuki extends AbstractExDBEntity<IT_KhDshrTuki, PKIT_KhDshrTuki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhDshrTuki";
    ...
    private final PKIT_KhDshrTuki primaryKey;

    public GenIT_KhDshrTuki() {
        primaryKey = new PKIT_KhDshrTuki();
    }

    public GenIT_KhDshrTuki(String pDshrtoukeisikibetukey, String pSyono) {
        primaryKey = new PKIT_KhDshrTuki(pDshrtoukeisikibetukey, pSyono);
    }

    @Transient
    @Override
    public PKIT_KhDshrTuki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhDshrTuki> getMetaClass() {
        return QIT_KhDshrTuki.class;
    }

    @Id
    @Column(name=GenIT_KhDshrTuki.DSHRTOUKEISIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_KhDshrTuki.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhDshrTuki.RENNO)
    ...
    @Column(name=GenIT_KhDshrTuki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KhDshrTuki.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KhDshrTuki.SYORIKBN)
    ...
    @Column(name=GenIT_KhDshrTuki.HRKKEIRO)
    ...
    @Column(name=GenIT_KhDshrTuki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenIT_KhDshrTuki.SYOUHNSDNO)
    ...
    @Column(name=GenIT_KhDshrTuki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_KhDshrTuki.SYOUMETUJIYUU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.YENDTHNKYMD)
    ...
    @Column(name=GenIT_KhDshrTuki.YOTEIRIRITU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.DENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.CALCKIJYUNYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.SYORIYMD2)
    ...
    @Column(name=GenIT_KhDshrTuki.JKIPJYTYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.KINOUBETUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhDshrTuki.GENGKWARI)
    ...
    @Column(name=GenIT_KhDshrTuki.DKEISANNAITEIKAKUTEIKBN)
    ...
    @Column(name=GenIT_KhDshrTuki.HAITOUNENDO)
    ...
    @Type(type="BizDateYType")
    @Column(name=GenIT_KhDshrTuki.HAITOUNENDO2)
    ...
    @Column(name=GenIT_KhDshrTuki.HAITOUKINSKSKBN)
    ...
    @Column(name=GenIT_KhDshrTuki.HAITOUMEISAIKBN)
    ...
    @Type(type="BizDateYType")
    @Column(name=GenIT_KhDshrTuki.FSTKARIWARIATEDNENDO)
    ...
    @Type(type="UserType_C_NaiteiKakuteiKbn")
    @Column(name=GenIT_KhDshrTuki.NAITEIKAKUTEIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.KARIWARIATEDSHRYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.TUMITATEDTUMITATEYMD)
    ...
    @Column(name=GenIT_KhDshrTuki.TUMITATEDSKSKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhDshrTuki.TUMITATEDSHRKRKYMD)
    ...
    @Type(type="UserType_C_NaiteiKakuteiKbn")
    @Column(name=GenIT_KhDshrTuki.NAITEIKAKUTEIKBN2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhDshrTuki.KARIWARIATEDRIRITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhDshrTuki.KARIWARIATEDRIRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhDshrTuki.TUMITATEDRIRITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhDshrTuki.TUMITATEDRIRITU2)
    ...
    @Column(name=GenIT_KhDshrTuki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhDshrTuki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhDshrTuki.GYOUMUKOUSINTIME)
