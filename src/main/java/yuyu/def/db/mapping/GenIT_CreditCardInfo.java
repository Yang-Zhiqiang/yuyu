...
import yuyu.def.db.id.PKIT_CreditCardInfo;
...
/**
 * クレカ情報テーブル テーブルのマッピング情報クラスで、 {@link IT_CreditCardInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_CreditCardInfo}</td><td colspan="3">クレカ情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_CreditCardInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_CreditCardInfo ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKIT_CreditCardInfo
 * @see     QIT_CreditCardInfo
 * @see     GenQIT_CreditCardInfo
 */
@MappedSuperclass
@Table(name=GenIT_CreditCardInfo.TABLE_NAME)
@IdClass(value=PKIT_CreditCardInfo.class)
@TypeDefs({
    @TypeDef(name="BizDateYMType", typeClass=BizDateYMType.class),
    @TypeDef(name="UserType_C_Yuukoukakkekka", typeClass=UserType_C_Yuukoukakkekka.class)
})
public abstract class GenIT_CreditCardInfo extends AbstractExDBEntity<IT_CreditCardInfo, PKIT_CreditCardInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_CreditCardInfo";
    ...
    private final PKIT_CreditCardInfo primaryKey;

    public GenIT_CreditCardInfo() {
        primaryKey = new PKIT_CreditCardInfo();
    }

    public GenIT_CreditCardInfo(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_CreditCardInfo(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_CreditCardInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_CreditCardInfo> getMetaClass() {
        return QIT_CreditCardInfo.class;
    }

    @Id
    @Column(name=GenIT_CreditCardInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_CreditCardInfo.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_CreditCardInfo.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_CreditCardInfo.CREDITYUUKOUKAKYM)
    ...
    @Column(name=GenIT_CreditCardInfo.CREDITYUUKOUKAKKEKKA)
    ...
    @Column(name=GenIT_CreditCardInfo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_CreditCardInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_CreditCardInfo.GYOUMUKOUSINTIME)
