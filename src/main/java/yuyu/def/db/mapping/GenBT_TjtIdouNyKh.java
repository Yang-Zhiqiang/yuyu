...
import yuyu.def.db.id.PKBT_TjtIdouNyKh;
import yuyu.def.db.meta.GenQBT_TjtIdouNyKh;
...
/**
 * 当日異動内容契約保全テーブル テーブルのマッピング情報クラスで、 {@link BT_TjtIdouNyKh} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_TjtIdouNyKh}</td><td colspan="3">当日異動内容契約保全テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKBT_TjtIdouNyKh ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_TjtIdouNyKh ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     BT_TjtIdouNyKh
 * @see     PKBT_TjtIdouNyKh
 * @see     QBT_TjtIdouNyKh
 * @see     GenQBT_TjtIdouNyKh
 */
@MappedSuperclass
@Table(name=GenBT_TjtIdouNyKh.TABLE_NAME)
@IdClass(value=PKBT_TjtIdouNyKh.class)
@TypeDefs({
...
public abstract class GenBT_TjtIdouNyKh extends AbstractExDBEntity<BT_TjtIdouNyKh, PKBT_TjtIdouNyKh> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_TjtIdouNyKh";
    ...
    private final PKBT_TjtIdouNyKh primaryKey;

    public GenBT_TjtIdouNyKh() {
        primaryKey = new PKBT_TjtIdouNyKh();
    }

    public GenBT_TjtIdouNyKh(String pSyono, Integer pRenno3keta) {
        primaryKey = new PKBT_TjtIdouNyKh(pSyono, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_TjtIdouNyKh getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_TjtIdouNyKh> getMetaClass() {
        return QBT_TjtIdouNyKh.class;
    }

    @Id
    @Column(name=GenBT_TjtIdouNyKh.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenBT_TjtIdouNyKh.RENNO3KETA)
    ...
    @Column(name=GenBT_TjtIdouNyKh.RECORDSAKUJYOHYOUJI)
    ...
    @Column(name=GenBT_TjtIdouNyKh.YOUKYUUNO)
    ...
    @Column(name=GenBT_TjtIdouNyKh.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenBT_TjtIdouNyKh.KYKJYOUTAI)
    ...
    @Column(name=GenBT_TjtIdouNyKh.KYKYMD)
    ...
    @Column(name=GenBT_TjtIdouNyKh.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenBT_TjtIdouNyKh.SYOUMETUJIYUU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_TjtIdouNyKh.SYOUMETUYMD)
    ...
    @Column(name=GenBT_TjtIdouNyKh.KYKTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenBT_TjtIdouNyKh.TSNTUUKASYU)
    ...
    @Column(name=GenBT_TjtIdouNyKh.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenBT_TjtIdouNyKh.SNTKHOUKBN)
    ...
    @Column(name=GenBT_TjtIdouNyKh.BOSYUUYM)
    @ValidDateYm
    ...
    @Column(name=GenBT_TjtIdouNyKh.KYKHHKNDOUHYOUJI)
    ...
    @Column(name=GenBT_TjtIdouNyKh.TTDKTYUUIKBN1)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenBT_TjtIdouNyKh.TTDKTYUUIKBN2)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenBT_TjtIdouNyKh.TTDKTYUUIKBN3)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenBT_TjtIdouNyKh.TTDKTYUUIKBN4)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenBT_TjtIdouNyKh.TTDKTYUUIKBN5)
    ...
    @Column(name=GenBT_TjtIdouNyKh.SYOUHNSDNO)
    ...
    @Column(name=GenBT_TjtIdouNyKh.KAIGOMAEHRTKYKUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenBT_TjtIdouNyKh.PYENNYKNTKYKUMUKBN)
    ...
    @Column(name=GenBT_TjtIdouNyKh.SKJMOSNO)
    ...
    @Column(name=GenBT_TjtIdouNyKh.HOUTEITYOTKSEISYOUHNHYJ)
    ...
    @Column(name=GenBT_TjtIdouNyKh.SEIRITUJITRHKJIKAKKBN)
    ...
    @Column(name=GenBT_TjtIdouNyKh.HRKKEIRO)
    ...
    @Column(name=GenBT_TjtIdouNyKh.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenBT_TjtIdouNyKh.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenBT_TjtIdouNyKh.GYOUMUKOUSINTIME)
