...
import yuyu.def.db.id.PKIT_KhLincSousinData;
import yuyu.def.db.meta.GenQIT_KhLincSousinData;
...
/**
 * 契約保全ＬＩＮＣ送信データテーブル テーブルのマッピング情報クラスで、 {@link IT_KhLincSousinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhLincSousinData}</td><td colspan="3">契約保全ＬＩＮＣ送信データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhLincSousinData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhLincSousinData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyoriYmd syoriYmd}</td><td>処理年月日</td><td align="center">{@link PKIT_KhLincSousinData ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_KhLincSousinData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_KhLincSousinData
 * @see     PKIT_KhLincSousinData
 * @see     QIT_KhLincSousinData
 * @see     GenQIT_KhLincSousinData
 */
@MappedSuperclass
@Table(name=GenIT_KhLincSousinData.TABLE_NAME)
@IdClass(value=PKIT_KhLincSousinData.class)
@TypeDefs({
...
public abstract class GenIT_KhLincSousinData extends AbstractExDBEntity<IT_KhLincSousinData, PKIT_KhLincSousinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhLincSousinData";
    ...
    private final PKIT_KhLincSousinData primaryKey;

    public GenIT_KhLincSousinData() {
        primaryKey = new PKIT_KhLincSousinData();
    }
    ...
    @Transient
    @Override
    public PKIT_KhLincSousinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhLincSousinData> getMetaClass() {
        return QIT_KhLincSousinData.class;
    }

    @Id
    @Column(name=GenIT_KhLincSousinData.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhLincSousinData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhLincSousinData.SYORIYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_KhLincSousinData.RENNO)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCSOUSINKBN)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCRECORDSYUBETU)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCHENKOUTYPE)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKANYUUSYANO)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCHHKNNMKN)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCHHKNNMKJ)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCHHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCHHKNSEIYMD)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCHHKNADRKN)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKEIHIDJNHYOUJI)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKYKNMKN)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKYKNMKJ)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKYKSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCKYKSEIYMD)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKYKADRKN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCTRKMOUSIDEYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCKYKYTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCKYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCHOZENYTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCHOZENYMD)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCKAKUSYASIYOURAN)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCMOUSIDEFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCMOUSIDEFLGSETYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhLincSousinData.LINCMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCJGYHKNFLG)
    ...
    @Column(name=GenIT_KhLincSousinData.LINCTENKANFLG)
    ...
    @Column(name=GenIT_KhLincSousinData.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenIT_KhLincSousinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhLincSousinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhLincSousinData.GYOUMUKOUSINTIME)
