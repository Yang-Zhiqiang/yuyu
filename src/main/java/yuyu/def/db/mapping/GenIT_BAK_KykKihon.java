...
import yuyu.def.db.id.PKIT_BAK_KykKihon;
...
/**
 * 契約基本バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KykKihon} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KykKihon}</td><td colspan="3">契約基本バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KykKihon ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KykKihon ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KykKihon ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KykKihon
 * @see     PKIT_BAK_KykKihon
 * @see     QIT_BAK_KykKihon
 * @see     GenQIT_BAK_KykKihon
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KykKihon.TABLE_NAME)
@IdClass(value=PKIT_BAK_KykKihon.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KykKihon extends AbstractExDBEntity<IT_BAK_KykKihon, PKIT_BAK_KykKihon> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KykKihon";
    ...
    private final PKIT_BAK_KykKihon primaryKey;

    public GenIT_BAK_KykKihon() {
        primaryKey = new PKIT_BAK_KykKihon();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KykKihon getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KykKihon> getMetaClass() {
        return QIT_BAK_KykKihon.class;
    }

    @Id
    @Column(name=GenIT_BAK_KykKihon.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KykKihon.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KykKihon.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykKihon.AITESYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_BAK_KykKihon.HAITOUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.HRKKAISUU)
    ...
    @Column(name=GenIT_BAK_KykKihon.HRKKEIRO)
    ...
    @Column(name=GenIT_BAK_KykKihon.SDPDKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.DNTRYOURITUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.DNTCD)
    @MaxLength(max=8)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_KykKihon.SNTKHOUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.SINSAKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.MOSYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.KKTYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.FSTPNYKNYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.MOSUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.MOSJIMOSUKTYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.SEIRITUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.ITIPRSYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykKihon.BOSYUUYM)
    @ValidDateYm
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_KykKihon.SEISEKIYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_KykKihon.SKEIKEIJYOUYM)
    ...
    @Column(name=GenIT_BAK_KykKihon.PLANCD)
    @MaxLength(max=10)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_KykKihon.PLANRENNO)
    ...
    @Column(name=GenIT_BAK_KykKihon.AISYOUMEIKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.SYUSAIUMU)
    ...
    @Column(name=GenIT_BAK_KykKihon.STKNSETKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykKihon.KYKKSYKJYUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykKihon.KYKKSUMU)
    ...
    @Column(name=GenIT_BAK_KykKihon.APLKAHIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykKihon.APLUMU)
    ...
    @Column(name=GenIT_BAK_KykKihon.FSTPHRKKEIROKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.HAITOUNENDO)
    ...
    @Column(name=GenIT_BAK_KykKihon.HAITOUKINUKETORIHOUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykKihon.TRATKITYUIUMU)
    ...
    @Column(name=GenIT_BAK_KykKihon.TRATKITYUIUNY)
    ...
    @Column(name=GenIT_BAK_KykKihon.SBUKTNIN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KykKihon.GANSINDANKAKUTEIYMD)
    ...
    @Column(name=GenIT_BAK_KykKihon.MOSUKETUKEKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.KIJIKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_KykKihon.HHKNNENSYUUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.DRTENKANRITODOUFUKENCD)
    ...
    @Column(name=GenIT_BAK_KykKihon.CIFCD)
    @MaxLength(max=15)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_KykKihon.SMBCKANRIID)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykKihon.TSRYHSHRKYKUMUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.KYKHONNINKAKNINSYORUIKBN)
    ...
    @Type(type="UserType_C_HonninkakuninSyoruiKbn")
    @Column(name=GenIT_BAK_KykKihon.SKSKKNHONNINKAKNINSYORUIKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.BOSKYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KykKihon.KANYUUSYANO)
    ...
    @Column(name=GenIT_BAK_KykKihon.DRCTSERVICEMOSKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.SKSYOUKENSKSKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.SINKYKSYOKENSAKUSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.SYOYOUSINKYKSYOHAKKOUYMD)
    ...
    @Column(name=GenIT_BAK_KykKihon.SKJMOSNO)
    ...
    @Column(name=GenIT_BAK_KykKihon.NKUIKOSUMIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.SYHENKOUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTSYOSAIHKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTMEIHENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTKYKMEIGHNKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTSBUKTHENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTKYKNMSEIYMDHENKOUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTKYKNMKANAKJTEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTTSINYNOHENKOUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykKihon.LASTJYUUHENYMD)
    ...
    @Column(name=GenIT_BAK_KykKihon.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KykKihon.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KykKihon.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_KykKihon.SEIRITUJITRHKJIKAKKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.YAKKANJYURYOUHOUKBN)
    ...
    @Column(name=GenIT_BAK_KykKihon.YAKKANBUNSYONO)
    ...
    @Column(name=GenIT_BAK_KykKihon.SIORINO)
    ...
    @Column(name=GenIT_BAK_KykKihon.YNKHRKMGKANNITUUTIKBN)
