...
import yuyu.def.db.id.PKIT_KhTumitateDKanri;
...
/**
 * 積立Ｄ管理テーブル テーブルのマッピング情報クラスで、 {@link IT_KhTumitateDKanri} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhTumitateDKanri}</td><td colspan="3">積立Ｄ管理テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhTumitateDKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhTumitateDKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTumitatedtumitateymd tumitatedtumitateymd}</td><td>積立Ｄ積立年月日</td><td align="center">{@link PKIT_KhTumitateDKanri ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_KhTumitateDKanri ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_KhTumitateDKanri
 * @see     QIT_KhTumitateDKanri
 * @see     GenQIT_KhTumitateDKanri
 */
@MappedSuperclass
@Table(name=GenIT_KhTumitateDKanri.TABLE_NAME)
@IdClass(value=PKIT_KhTumitateDKanri.class)
@TypeDefs({
...
public abstract class GenIT_KhTumitateDKanri extends AbstractExDBEntity<IT_KhTumitateDKanri, PKIT_KhTumitateDKanri> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhTumitateDKanri";
    ...
    private final PKIT_KhTumitateDKanri primaryKey;

    public GenIT_KhTumitateDKanri() {
        primaryKey = new PKIT_KhTumitateDKanri();
    }
    ...
    @Transient
    @Override
    public PKIT_KhTumitateDKanri getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhTumitateDKanri> getMetaClass() {
        return QIT_KhTumitateDKanri.class;
    }

    @Id
    @Column(name=GenIT_KhTumitateDKanri.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhTumitateDKanri.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhTumitateDKanri.TUMITATEDTUMITATEYMD)
    ...
    @Id
    @Column(name=GenIT_KhTumitateDKanri.RENNO)
    ...
    @Column(name=GenIT_KhTumitateDKanri.TUMITATEDSKSKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTumitateDKanri.TUMITATEDSHRKRKYMD)
    ...
    @Column(name=GenIT_KhTumitateDKanri.NAITEIKAKUTEIKBN)
    ...
    @Column(name=GenIT_KhTumitateDKanri.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhTumitateDKanri.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhTumitateDKanri.GYOUMUKOUSINTIME)
