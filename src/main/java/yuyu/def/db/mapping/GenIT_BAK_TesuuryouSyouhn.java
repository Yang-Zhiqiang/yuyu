...
import yuyu.def.db.id.PKIT_BAK_TesuuryouSyouhn;
import yuyu.def.db.meta.GenQIT_BAK_TesuuryouSyouhn;
...
/**
 * 手数料情報商品バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_TesuuryouSyouhn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_TesuuryouSyouhn}</td><td colspan="3">手数料情報商品バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTsrysyorikbn tsrysyorikbn}</td><td>手数料処理区分</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>{@link C_TsrysyoriKbn}</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_TesuuryouSyouhn
 * @see     PKIT_BAK_TesuuryouSyouhn
 * @see     QIT_BAK_TesuuryouSyouhn
 * @see     GenQIT_BAK_TesuuryouSyouhn
 */
@MappedSuperclass
@Table(name=GenIT_BAK_TesuuryouSyouhn.TABLE_NAME)
@IdClass(value=PKIT_BAK_TesuuryouSyouhn.class)
@TypeDefs({
...
public abstract class GenIT_BAK_TesuuryouSyouhn extends AbstractExDBEntity<IT_BAK_TesuuryouSyouhn, PKIT_BAK_TesuuryouSyouhn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_TesuuryouSyouhn";
    ...
    private final PKIT_BAK_TesuuryouSyouhn primaryKey;

    public GenIT_BAK_TesuuryouSyouhn() {
        primaryKey = new PKIT_BAK_TesuuryouSyouhn();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_TesuuryouSyouhn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_TesuuryouSyouhn> getMetaClass() {
        return QIT_BAK_TesuuryouSyouhn.class;
    }

    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.TSRYSYORIKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.RENNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.GANSKNNKAISIYMD)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKNEN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.PMNJTKKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.RYOURITUSDNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_TesuuryouSyouhn.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.NKSYUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.NENKINKKN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhn.GYOUMUKOUSINTIME)
