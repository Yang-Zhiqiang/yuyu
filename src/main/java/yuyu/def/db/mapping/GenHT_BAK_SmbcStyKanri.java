...
import yuyu.def.db.id.PKHT_BAK_SmbcStyKanri;
import yuyu.def.db.meta.GenQHT_BAK_SmbcStyKanri;
...
/**
 * ＳＭＢＣ進捗管理バックアップテーブル テーブルのマッピング情報クラスで、 {@link HT_BAK_SmbcStyKanri} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BAK_SmbcStyKanri}</td><td colspan="3">ＳＭＢＣ進捗管理バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDatarenymd datarenymd}</td><td>データ連動日</td><td align="center">{@link PKHT_BAK_SmbcStyKanri ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKHT_BAK_SmbcStyKanri ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDatasakuseirenno datasakuseirenno}</td><td>データ作成連番</td><td align="center">{@link PKHT_BAK_SmbcStyKanri ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 ...
 * </table>
 * @see     HT_BAK_SmbcStyKanri
 * @see     PKHT_BAK_SmbcStyKanri
 * @see     QHT_BAK_SmbcStyKanri
 * @see     GenQHT_BAK_SmbcStyKanri
 */
@MappedSuperclass
@Table(name=GenHT_BAK_SmbcStyKanri.TABLE_NAME)
@IdClass(value=PKHT_BAK_SmbcStyKanri.class)
@TypeDefs({
    @TypeDef(name="BizDateType", typeClass=BizDateType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class),
    @TypeDef(name="UserType_C_Rendouflg", typeClass=UserType_C_Rendouflg.class)
})
public abstract class GenHT_BAK_SmbcStyKanri extends AbstractExDBEntity<HT_BAK_SmbcStyKanri, PKHT_BAK_SmbcStyKanri> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BAK_SmbcStyKanri";
    ...
    private final PKHT_BAK_SmbcStyKanri primaryKey;

    public GenHT_BAK_SmbcStyKanri() {
        primaryKey = new PKHT_BAK_SmbcStyKanri();
    }
    ...
    @Transient
    @Override
    public PKHT_BAK_SmbcStyKanri getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BAK_SmbcStyKanri> getMetaClass() {
        return QHT_BAK_SmbcStyKanri.class;
    }

    @Id
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SmbcStyKanri.DATARENYMD)
    ...
    @Id
    @Column(name=GenHT_BAK_SmbcStyKanri.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.DATASAKUSEIRENNO)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.RENDOUFLG)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCDATAKBN)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCDATASAKUSEIYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCHKNKAISYACD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCUKTKKANRIID)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOUKTKZMYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOHBYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCBANKHNKYKFLG)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOHBKSYYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOHJYTTYKYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHONYKNZMYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOSNSZMYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOSYKNHKKZMYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOSYUMOKU)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOSYURUI)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSYONO)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSYONOEDABAN)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCJKTKFLG)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOTRKSYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCSEIHOHKTYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCKYKSEIYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCKYKNMKN)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCMOSUKTYMD)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCMOSSYORIFLG)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.SMBCKOSYAAREASTYKNR)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BAK_SmbcStyKanri.GYOUMUKOUSINTIME)
