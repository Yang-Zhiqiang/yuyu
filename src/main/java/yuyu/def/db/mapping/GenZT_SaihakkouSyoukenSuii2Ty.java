...
/**
 * 再発行保険証券推移表Ｆテーブル２（中） テーブルのマッピング情報クラスで、 {@link ZT_SaihakkouSyoukenSuii2Ty} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SaihakkouSyoukenSuii2Ty}</td><td colspan="3">再発行保険証券推移表Ｆテーブル２（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysyono ztysyono}</td><td>（中継用）証券番号</td><td align="center">{@link PKZT_SaihakkouSyoukenSuii2Ty ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytyouhyouymd ztytyouhyouymd}</td><td>（中継用）帳票作成日</td><td align="center">{@link PKZT_SaihakkouSyoukenSuii2Ty ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtysuiihyouptn ztysuiihyouptn}</td><td>（中継用）推移表パターン</td><td align="center">{@link PKZT_SaihakkouSyoukenSuii2Ty ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym01 ztynenoutouym01}</td><td>（中継用）年単位応当年月０１</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym02 ztynenoutouym02}</td><td>（中継用）年単位応当年月０２</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym03 ztynenoutouym03}</td><td>（中継用）年単位応当年月０３</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym04 ztynenoutouym04}</td><td>（中継用）年単位応当年月０４</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym05 ztynenoutouym05}</td><td>（中継用）年単位応当年月０５</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym06 ztynenoutouym06}</td><td>（中継用）年単位応当年月０６</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym07 ztynenoutouym07}</td><td>（中継用）年単位応当年月０７</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym08 ztynenoutouym08}</td><td>（中継用）年単位応当年月０８</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym09 ztynenoutouym09}</td><td>（中継用）年単位応当年月０９</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym10 ztynenoutouym10}</td><td>（中継用）年単位応当年月１０</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym11 ztynenoutouym11}</td><td>（中継用）年単位応当年月１１</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym12 ztynenoutouym12}</td><td>（中継用）年単位応当年月１２</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym13 ztynenoutouym13}</td><td>（中継用）年単位応当年月１３</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym14 ztynenoutouym14}</td><td>（中継用）年単位応当年月１４</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym15 ztynenoutouym15}</td><td>（中継用）年単位応当年月１５</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym16 ztynenoutouym16}</td><td>（中継用）年単位応当年月１６</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym17 ztynenoutouym17}</td><td>（中継用）年単位応当年月１７</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym18 ztynenoutouym18}</td><td>（中継用）年単位応当年月１８</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym19 ztynenoutouym19}</td><td>（中継用）年単位応当年月１９</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym20 ztynenoutouym20}</td><td>（中継用）年単位応当年月２０</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym21 ztynenoutouym21}</td><td>（中継用）年単位応当年月２１</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtynenoutouym22 ztynenoutouym22}</td><td>（中継用）年単位応当年月２２</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SaihakkouSyoukenSuii2Ty
 * @see     PKZT_SaihakkouSyoukenSuii2Ty
 * @see     QZT_SaihakkouSyoukenSuii2Ty
 * @see     GenQZT_SaihakkouSyoukenSuii2Ty
 */
@MappedSuperclass
@Table(name=GenZT_SaihakkouSyoukenSuii2Ty.TABLE_NAME)
@IdClass(value=PKZT_SaihakkouSyoukenSuii2Ty.class)
public abstract class GenZT_SaihakkouSyoukenSuii2Ty extends AbstractExDBEntity<ZT_SaihakkouSyoukenSuii2Ty, PKZT_SaihakkouSyoukenSuii2Ty> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SaihakkouSyoukenSuii2Ty";
    ...
    public static final String ZTYNENOUTOUYM01          = "ztynenoutouym01";
    ...
    public static final String ZTYNENOUTOUYM02          = "ztynenoutouym02";
    ...
    public static final String ZTYNENOUTOUYM03          = "ztynenoutouym03";
    ...
    public static final String ZTYNENOUTOUYM04          = "ztynenoutouym04";
    ...
    public static final String ZTYNENOUTOUYM05          = "ztynenoutouym05";
    ...
    public static final String ZTYNENOUTOUYM06          = "ztynenoutouym06";
    ...
    public static final String ZTYNENOUTOUYM07          = "ztynenoutouym07";
    ...
    public static final String ZTYNENOUTOUYM08          = "ztynenoutouym08";
    ...
    public static final String ZTYNENOUTOUYM09          = "ztynenoutouym09";
    ...
    public static final String ZTYNENOUTOUYM10          = "ztynenoutouym10";
    ...
    public static final String ZTYNENOUTOUYM11          = "ztynenoutouym11";
    ...
    public static final String ZTYNENOUTOUYM12          = "ztynenoutouym12";
    ...
    public static final String ZTYNENOUTOUYM13          = "ztynenoutouym13";
    ...
    public static final String ZTYNENOUTOUYM14          = "ztynenoutouym14";
    ...
    public static final String ZTYNENOUTOUYM15          = "ztynenoutouym15";
    ...
    public static final String ZTYNENOUTOUYM16          = "ztynenoutouym16";
    ...
    public static final String ZTYNENOUTOUYM17          = "ztynenoutouym17";
    ...
    public static final String ZTYNENOUTOUYM18          = "ztynenoutouym18";
    ...
    public static final String ZTYNENOUTOUYM19          = "ztynenoutouym19";
    ...
    public static final String ZTYNENOUTOUYM20          = "ztynenoutouym20";
    ...
    public static final String ZTYNENOUTOUYM21          = "ztynenoutouym21";
    ...
    public static final String ZTYNENOUTOUYM22          = "ztynenoutouym22";
    ...
    private final PKZT_SaihakkouSyoukenSuii2Ty primaryKey;

    public GenZT_SaihakkouSyoukenSuii2Ty() {
        primaryKey = new PKZT_SaihakkouSyoukenSuii2Ty();
    }
    ...
    @Transient
    @Override
    public PKZT_SaihakkouSyoukenSuii2Ty getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SaihakkouSyoukenSuii2Ty> getMetaClass() {
        return QZT_SaihakkouSyoukenSuii2Ty.class;
    }

    @Id
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYSYONO)
    ...
    @Id
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYTYOUHYOUYMD)
    ...
    @Id
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYSUIIHYOUPTN)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYSUIIHYOUSYKBN)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYSUIIHYOUSYONO)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYTIRRTCALCKIJYUNRRT)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWKWSRATEYENDAKA)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWKWSRATEYENKIJYUN)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWKWSRATEYENYASU)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKYKTUUKATYPE)
    ...
    private String ztynenoutouym01;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM01)
    public String getZtynenoutouym01() {
        return ztynenoutouym01;
    }

    public void setZtynenoutouym01(String pZtynenoutouym01) {
        ztynenoutouym01 = pZtynenoutouym01;
    }

    private String ztyhrkkknmnryumukbn01;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN01)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU01)
    ...
    private String ztynenoutouym02;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM02)
    public String getZtynenoutouym02() {
        return ztynenoutouym02;
    }

    public void setZtynenoutouym02(String pZtynenoutouym02) {
        ztynenoutouym02 = pZtynenoutouym02;
    }

    private String ztyhrkkknmnryumukbn02;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN02)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU02)
    ...
    private String ztynenoutouym03;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM03)
    public String getZtynenoutouym03() {
        return ztynenoutouym03;
    }

    public void setZtynenoutouym03(String pZtynenoutouym03) {
        ztynenoutouym03 = pZtynenoutouym03;
    }

    private String ztyhrkkknmnryumukbn03;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN03)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU03)
    ...
    private String ztynenoutouym04;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM04)
    public String getZtynenoutouym04() {
        return ztynenoutouym04;
    }

    public void setZtynenoutouym04(String pZtynenoutouym04) {
        ztynenoutouym04 = pZtynenoutouym04;
    }

    private String ztyhrkkknmnryumukbn04;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN04)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU04)
    ...
    private String ztynenoutouym05;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM05)
    public String getZtynenoutouym05() {
        return ztynenoutouym05;
    }

    public void setZtynenoutouym05(String pZtynenoutouym05) {
        ztynenoutouym05 = pZtynenoutouym05;
    }

    private String ztyhrkkknmnryumukbn05;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN05)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU05)
    ...
    private String ztynenoutouym06;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM06)
    public String getZtynenoutouym06() {
        return ztynenoutouym06;
    }

    public void setZtynenoutouym06(String pZtynenoutouym06) {
        ztynenoutouym06 = pZtynenoutouym06;
    }

    private String ztyhrkkknmnryumukbn06;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN06)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU06)
    ...
    private String ztynenoutouym07;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM07)
    public String getZtynenoutouym07() {
        return ztynenoutouym07;
    }

    public void setZtynenoutouym07(String pZtynenoutouym07) {
        ztynenoutouym07 = pZtynenoutouym07;
    }

    private String ztyhrkkknmnryumukbn07;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN07)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU07)
    ...
    private String ztynenoutouym08;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM08)
    public String getZtynenoutouym08() {
        return ztynenoutouym08;
    }

    public void setZtynenoutouym08(String pZtynenoutouym08) {
        ztynenoutouym08 = pZtynenoutouym08;
    }

    private String ztyhrkkknmnryumukbn08;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN08)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU08)
    ...
    private String ztynenoutouym09;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM09)
    public String getZtynenoutouym09() {
        return ztynenoutouym09;
    }

    public void setZtynenoutouym09(String pZtynenoutouym09) {
        ztynenoutouym09 = pZtynenoutouym09;
    }

    private String ztyhrkkknmnryumukbn09;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN09)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU09)
    ...
    private String ztynenoutouym10;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM10)
    public String getZtynenoutouym10() {
        return ztynenoutouym10;
    }

    public void setZtynenoutouym10(String pZtynenoutouym10) {
        ztynenoutouym10 = pZtynenoutouym10;
    }

    private String ztyhrkkknmnryumukbn10;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN10)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU10)
    ...
    private String ztynenoutouym11;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM11)
    public String getZtynenoutouym11() {
        return ztynenoutouym11;
    }

    public void setZtynenoutouym11(String pZtynenoutouym11) {
        ztynenoutouym11 = pZtynenoutouym11;
    }

    private String ztyhrkkknmnryumukbn11;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN11)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU11)
    ...
    private String ztynenoutouym12;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM12)
    public String getZtynenoutouym12() {
        return ztynenoutouym12;
    }

    public void setZtynenoutouym12(String pZtynenoutouym12) {
        ztynenoutouym12 = pZtynenoutouym12;
    }

    private String ztyhrkkknmnryumukbn12;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN12)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU12)
    ...
    private String ztynenoutouym13;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM13)
    public String getZtynenoutouym13() {
        return ztynenoutouym13;
    }

    public void setZtynenoutouym13(String pZtynenoutouym13) {
        ztynenoutouym13 = pZtynenoutouym13;
    }

    private String ztyhrkkknmnryumukbn13;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN13)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU13)
    ...
    private String ztynenoutouym14;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM14)
    public String getZtynenoutouym14() {
        return ztynenoutouym14;
    }

    public void setZtynenoutouym14(String pZtynenoutouym14) {
        ztynenoutouym14 = pZtynenoutouym14;
    }

    private String ztyhrkkknmnryumukbn14;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN14)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU14)
    ...
    private String ztynenoutouym15;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM15)
    public String getZtynenoutouym15() {
        return ztynenoutouym15;
    }

    public void setZtynenoutouym15(String pZtynenoutouym15) {
        ztynenoutouym15 = pZtynenoutouym15;
    }

    private String ztyhrkkknmnryumukbn15;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN15)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU15)
    ...
    private String ztynenoutouym16;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM16)
    public String getZtynenoutouym16() {
        return ztynenoutouym16;
    }

    public void setZtynenoutouym16(String pZtynenoutouym16) {
        ztynenoutouym16 = pZtynenoutouym16;
    }

    private String ztyhrkkknmnryumukbn16;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN16)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU16)
    ...
    private String ztynenoutouym17;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM17)
    public String getZtynenoutouym17() {
        return ztynenoutouym17;
    }

    public void setZtynenoutouym17(String pZtynenoutouym17) {
        ztynenoutouym17 = pZtynenoutouym17;
    }

    private String ztyhrkkknmnryumukbn17;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN17)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU17)
    ...
    private String ztynenoutouym18;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM18)
    public String getZtynenoutouym18() {
        return ztynenoutouym18;
    }

    public void setZtynenoutouym18(String pZtynenoutouym18) {
        ztynenoutouym18 = pZtynenoutouym18;
    }

    private String ztyhrkkknmnryumukbn18;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN18)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU18)
    ...
    private String ztynenoutouym19;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM19)
    public String getZtynenoutouym19() {
        return ztynenoutouym19;
    }

    public void setZtynenoutouym19(String pZtynenoutouym19) {
        ztynenoutouym19 = pZtynenoutouym19;
    }

    private String ztyhrkkknmnryumukbn19;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN19)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU19)
    ...
    private String ztynenoutouym20;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM20)
    public String getZtynenoutouym20() {
        return ztynenoutouym20;
    }

    public void setZtynenoutouym20(String pZtynenoutouym20) {
        ztynenoutouym20 = pZtynenoutouym20;
    }

    private String ztyhrkkknmnryumukbn20;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN20)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU20)
    ...
    private String ztynenoutouym21;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM21)
    public String getZtynenoutouym21() {
        return ztynenoutouym21;
    }

    public void setZtynenoutouym21(String pZtynenoutouym21) {
        ztynenoutouym21 = pZtynenoutouym21;
    }

    private String ztyhrkkknmnryumukbn21;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN21)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU21)
    ...
    private String ztynenoutouym22;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYNENOUTOUYM22)
    public String getZtynenoutouym22() {
        return ztynenoutouym22;
    }

    public void setZtynenoutouym22(String pZtynenoutouym22) {
        ztynenoutouym22 = pZtynenoutouym22;
    }

    private String ztyhrkkknmnryumukbn22;

    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYHRKKKNMNRYUMUKBN22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKYEN22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYZENNOUZNDKGAIKA22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYENHRKGKGOUKEI22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKIHRKMP22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYW22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENDAKA22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENKIJUN22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYWYENYENYASU22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGK22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENDAKA22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENKIJUN22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYKAIYKUKTGKYENYENYASU22)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYOBIV210)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYOBIV98)
    ...
    @Column(name=GenZT_SaihakkouSyoukenSuii2Ty.ZTYYOBIV14)
