...
import yuyu.def.db.id.PKHT_BosUketorinin;
...
/**
 * 募集受取人テーブル テーブルのマッピング情報クラスで、 {@link HT_BosUketorinin} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BosUketorinin}</td><td colspan="3">募集受取人テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_BosUketorinin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUktsyukbn uktsyukbn}</td><td>受取人種類区分</td><td align="center">{@link PKHT_BosUketorinin ○}</td><td align="center">V</td><td>{@link C_UktsyuKbn}</td></tr>
 *  <tr><td>{@link #getUktsyurenno uktsyurenno}</td><td>受取人種類別連番</td><td align="center">{@link PKHT_BosUketorinin ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKHT_BosUketorinin
 * @see     QHT_BosUketorinin
 * @see     GenQHT_BosUketorinin
 */
@MappedSuperclass
@Table(name=GenHT_BosUketorinin.TABLE_NAME)
@IdClass(value=PKHT_BosUketorinin.class)
@TypeDefs({
...
public abstract class GenHT_BosUketorinin extends AbstractExDBEntity<HT_BosUketorinin, PKHT_BosUketorinin> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BosUketorinin";
    ...
    private final PKHT_BosUketorinin primaryKey;

    public GenHT_BosUketorinin() {
        primaryKey = new PKHT_BosUketorinin();
    }
    ...
    @Transient
    @Override
    public PKHT_BosUketorinin getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BosUketorinin> getMetaClass() {
        return QHT_BosUketorinin.class;
    }

    @Id
    @Column(name=GenHT_BosUketorinin.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BosUketorinin.UKTSYUKBN)
    ...
    @Id
    @Column(name=GenHT_BosUketorinin.UKTSYURENNO)
    ...
    @Column(name=GenHT_BosUketorinin.UKTKBN)
    ...
    @Column(name=GenHT_BosUketorinin.UKTNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosUketorinin.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosUketorinin.UKTNMKJKHUKAKBN)
    ...
    @Column(name=GenHT_BosUketorinin.UKTTDK)
    ...
    @Column(name=GenHT_BosUketorinin.UKTBNWARI)
    ...
    @Column(name=GenHT_BosUketorinin.UKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_BosUketorinin.UKTTSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_BosUketorinin.UKTYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_BosUketorinin.UKTADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosUketorinin.UKTADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosUketorinin.UKTADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosUketorinin.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BosUketorinin.GYOUMUKOUSINTIME)
