...
/**
 * 初回保険料売上請求結果テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_FstpUriageSeikyuuKekkaRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnuriageymd6keta zrnuriageymd6keta}</td><td>（連携用）売上年月日（６桁）</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrncreditkessaiyouno zrncreditkessaiyouno}</td><td>（連携用）クレジットカード決済用番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsyono zrnsyono}</td><td>（連携用）証券番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnrecordno zrnrecordno}</td><td>（連携用）レコード番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnseikyuukngk zrnseikyuukngk}</td><td>（連携用）請求金額</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaRn ○}</td><td align="center">N</td><td>Long</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_FstpUriageSeikyuuKekkaRn.TABLE_NAME)
@IdClass(value=PKZT_FstpUriageSeikyuuKekkaRn.class)
public abstract class GenZT_FstpUriageSeikyuuKekkaRn extends AbstractExDBEntityForZDB<ZT_FstpUriageSeikyuuKekkaRn, PKZT_FstpUriageSeikyuuKekkaRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_FstpUriageSeikyuuKekkaRn";
    ...
    private final PKZT_FstpUriageSeikyuuKekkaRn primaryKey;

    public GenZT_FstpUriageSeikyuuKekkaRn() {
        primaryKey = new PKZT_FstpUriageSeikyuuKekkaRn();
    }
    ...
    @Transient
    @Override
    public PKZT_FstpUriageSeikyuuKekkaRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_FstpUriageSeikyuuKekkaRn> getMetaClass() {
        return QZT_FstpUriageSeikyuuKekkaRn.class;
    }

    private String zrnrecordkbn;

    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNAUTHORIKBN)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNURIAGESEIKYUUTORIHIKICD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNURIAGETAISYOUYM)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNURIAGEYMD6KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNCREDITKIGYOUCD)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNCREDITKESSAIYOUNO)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNSYONO)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNRECORDNO)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNYOBIV3)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNCARDYUUKOUKIGEN)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNSEIKYUUKNGK)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNCREDITKAIINNOKAMI6KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNCREDITKAIINNOSIMO4KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNURIAGESEIKYUUERRORCD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNHURIKAEKEKKACD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNFUKUSUUKAMEITENNOKEY)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaRn.ZRNYOBIV1)
