...
/**
 * 最低Ｓ事方書チェックマスタ テーブルのマッピング情報クラスで、 {@link BM_ChkJhSaiteiS} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BM_ChkJhSaiteiS}</td><td colspan="3">最低Ｓ事方書チェックマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnofrom syusyouhnsdnofrom}</td><td>（主契約）商品世代番号自</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyusyouhnsdnoto syusyouhnsdnoto}</td><td>（主契約）商品世代番号至</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getDntsdnumufrom dntsdnumufrom}</td><td>団体集団有無自</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getDntsdnumuto dntsdnumuto}</td><td>団体集団有無至</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHrkkknsmnkbnfrom hrkkknsmnkbnfrom}</td><td>払込期間歳満期区分自</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHrkkknsmnkbnto hrkkknsmnkbnto}</td><td>払込期間歳満期区分至</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHknkknfrom hknkknfrom}</td><td>保険期間自</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getHknkknto hknkknto}</td><td>保険期間至</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>{@link #getSaiteisknwtkumufrom saiteisknwtkumufrom}</td><td>最低Ｓ緩和特約有無自</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSaiteisknwtkumuto saiteisknwtkumuto}</td><td>最低Ｓ緩和特約有無至</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getTuukasyu tuukasyu}</td><td>通貨種類</td><td align="center">{@link PKBM_ChkJhSaiteiS ○}</td><td align="center">V</td><td>{@link C_Tuukasyu}</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBM_ChkJhSaiteiS.TABLE_NAME)
@IdClass(value=PKBM_ChkJhSaiteiS.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class),
    @TypeDef(name="UserType_C_Tuukasyu", typeClass=UserType_C_Tuukasyu.class)
})
public abstract class GenBM_ChkJhSaiteiS extends AbstractExDBEntity<BM_ChkJhSaiteiS, PKBM_ChkJhSaiteiS> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BM_ChkJhSaiteiS";
    ...
    private final PKBM_ChkJhSaiteiS primaryKey;

    public GenBM_ChkJhSaiteiS() {
        primaryKey = new PKBM_ChkJhSaiteiS();
    }
    ...
    @Transient
    @Override
    public PKBM_ChkJhSaiteiS getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBM_ChkJhSaiteiS> getMetaClass() {
        return QBM_ChkJhSaiteiS.class;
    }

    @Id
    @Column(name=GenBM_ChkJhSaiteiS.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.SYUSYOUHNSDNOFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.SYUSYOUHNSDNOTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.DNTSDNUMUFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.DNTSDNUMUTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.HRKKKNSMNKBNFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.HRKKKNSMNKBNTO)
    ...
    @Column(name=GenBM_ChkJhSaiteiS.HKNKKNFROM)
    ...
    @Id
    @Type(type="BizNumberType")
    @Column(name=GenBM_ChkJhSaiteiS.HKNKKNTO)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.SAITEISKNWTKUMUFROM)
    ...
    @Id
    @Column(name=GenBM_ChkJhSaiteiS.SAITEISKNWTKUMUTO)
    ...
    @Column(name=GenBM_ChkJhSaiteiS.TUUKASYU)
