...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RisaTjHitNplusQuartTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RisaTjHitNplusQuartTy}</td><td colspan="3">利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RisaTjHitNplusQuartTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_RisaTjHitNplusQuartTy
 * @see     PKZT_RisaTjHitNplusQuartTy
 * @see     QZT_RisaTjHitNplusQuartTy
 * @see     GenQZT_RisaTjHitNplusQuartTy
 */
@MappedSuperclass
@Table(name=GenZT_RisaTjHitNplusQuartTy.TABLE_NAME)
@IdClass(value=PKZT_RisaTjHitNplusQuartTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RisaTjHitNplusQuartTy extends AbstractExDBEntity<ZT_RisaTjHitNplusQuartTy, PKZT_RisaTjHitNplusQuartTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RisaTjHitNplusQuartTy";
    ...
    private final PKZT_RisaTjHitNplusQuartTy primaryKey;

    public GenZT_RisaTjHitNplusQuartTy() {
        primaryKey = new PKZT_RisaTjHitNplusQuartTy();
    }

    public GenZT_RisaTjHitNplusQuartTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RisaTjHitNplusQuartTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RisaTjHitNplusQuartTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RisaTjHitNplusQuartTy> getMetaClass() {
        return QZT_RisaTjHitNplusQuartTy.class;
    }

    @Id
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYERRKBNV1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYRATEKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKEIYAKUNENDO)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKEIYAKUM)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTY5NENMEOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSAISITUTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSIBOUS)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYUUKOUTYUUSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSYOUMETUYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSYOUMETUYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTENKANYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTENKANYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTUUJYOUDSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTUUJYOUDSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUHRKBBNKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUHRKBBNKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUHRKBBNKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUHRKBBNKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTNKNHKTGKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTNKNHKTGKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTNKNHKTGKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUTNKNHKTGKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSAISITUKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSAISITUKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSAISITUKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSAISITUKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHRKBBNKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHRKBBNKDTISYUNNKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUSANGOHRKBBNKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNHKTGKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNHKTGKDTISYUNENKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUSANGOTNKNHKTGKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUUSANGOHUTUUSIBOUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSAISITUKAPPADSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUUSANGOSAISITUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSISTKAPPADTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUUSANGOGOUKEIKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYDTAISYOUV)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSYUSISTKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSYUSISTKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSYUSISTKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTNKNYUSYUSISTKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSYUSISTKAPPADSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSYUSISTKDTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIN11X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSAIMNKKYKHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOTEIRIRITURIRONBASE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYGKDTYKNNDSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYGKDTYKYKNNDSYOYOUGAKUYOU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYDKEISANJIKWSRATE)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYDKEISANJIKWSRATETKYYMD)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV6X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV6X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYYOBIV5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X2)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X3)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X4)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X5)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X6)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X7)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X8)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X9)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X10)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X11)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X12)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X13)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X14)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X15)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X16)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X17)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X18)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X19)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X20)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X21)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X22)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X23)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X24)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X25)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X26)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X27)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X28)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X29)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X30)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X31)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X32)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X33)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X34)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X35)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X36)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X37)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X38)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X39)
    ...
    @Column(name=GenZT_RisaTjHitNplusQuartTy.ZTYTOKUYAKUKOUMOKUV120X40)
