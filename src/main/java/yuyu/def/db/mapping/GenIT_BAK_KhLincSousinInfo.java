...
import yuyu.def.db.id.PKIT_BAK_KhLincSousinInfo;
...
/**
 * 契約保全ＬＩＮＣ送信情報バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhLincSousinInfo} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KhLincSousinInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getLincsoujyusinsyskbn lincsoujyusinsyskbn}</td><td>ＬＩＮＣ送受信用システム区分</td><td align="center">{@link PKIT_BAK_KhLincSousinInfo ○}</td><td align="center">V</td><td>{@link C_LincsoujyusinsysKbn}</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhLincSousinInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhLincSousinInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KhLincSousinInfo ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KhLincSousinInfo
 * @see     QIT_BAK_KhLincSousinInfo
 * @see     GenQIT_BAK_KhLincSousinInfo
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhLincSousinInfo.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhLincSousinInfo.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhLincSousinInfo extends AbstractExDBEntity<IT_BAK_KhLincSousinInfo, PKIT_BAK_KhLincSousinInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhLincSousinInfo";
    ...
    private final PKIT_BAK_KhLincSousinInfo primaryKey;

    public GenIT_BAK_KhLincSousinInfo() {
        primaryKey = new PKIT_BAK_KhLincSousinInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhLincSousinInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhLincSousinInfo> getMetaClass() {
        return QIT_BAK_KhLincSousinInfo.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhLincSousinInfo.KBNKEY)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCSOUJYUSINSYSKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinInfo.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinInfo.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhLincSousinInfo.RENNO)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCSOUSINKBN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCRECORDSYUBETU)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHENKOUTYPE)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKANYUUSYANO)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHHKNNMKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHHKNNMKJ)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHHKNSEI)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHHKNSEIYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHHKNADRKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKEIHIDJNHYOUJI)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKNMKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKNMKJ)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKSEI)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKSEIYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKADRKN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCTRKMOUSIDEYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKYTYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKYKYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHOZENYTYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCHOZENYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCKAKUSYASIYOURAN)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCMOUSIDEFLG)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCMOUSIDEFLGSETYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCJGYHKNFLG)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.LINCTENKANFLG)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhLincSousinInfo.GYOUMUKOUSINTIME)
