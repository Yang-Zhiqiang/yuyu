...
import yuyu.def.db.id.PKIT_BAK_YykIdouNaiyoHrhnk;
import yuyu.def.db.meta.GenQIT_BAK_YykIdouNaiyoHrhnk;
...
/**
 * 予約異動受付内容（払方変更）バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_YykIdouNaiyoHrhnk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_YykIdouNaiyoHrhnk}</td><td colspan="3">予約異動受付内容（払方変更）バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_YykIdouNaiyoHrhnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_YykIdouNaiyoHrhnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_YykIdouNaiyoHrhnk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_YykIdouNaiyoHrhnk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_YykIdouNaiyoHrhnk
 * @see     PKIT_BAK_YykIdouNaiyoHrhnk
 * @see     QIT_BAK_YykIdouNaiyoHrhnk
 * @see     GenQIT_BAK_YykIdouNaiyoHrhnk
 */
@MappedSuperclass
@Table(name=GenIT_BAK_YykIdouNaiyoHrhnk.TABLE_NAME)
@IdClass(value=PKIT_BAK_YykIdouNaiyoHrhnk.class)
@TypeDefs({
...
public abstract class GenIT_BAK_YykIdouNaiyoHrhnk extends AbstractExDBEntity<IT_BAK_YykIdouNaiyoHrhnk, PKIT_BAK_YykIdouNaiyoHrhnk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_YykIdouNaiyoHrhnk";
    ...
    private final PKIT_BAK_YykIdouNaiyoHrhnk primaryKey;

    public GenIT_BAK_YykIdouNaiyoHrhnk() {
        primaryKey = new PKIT_BAK_YykIdouNaiyoHrhnk();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_YykIdouNaiyoHrhnk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_YykIdouNaiyoHrhnk> getMetaClass() {
        return QIT_BAK_YykIdouNaiyoHrhnk.class;
    }

    @Id
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.KOURYOKUHASSEIYMD)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.NEWHRKKEIRO)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.NEWHRKKAISUU)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.NEWTIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.HRKKEIROHNKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.HRKKAISUUHNKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.TIKIKTBRISYURUIHNKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.HARAIKATAHNKUMU)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.HARAIKATAHNKUKTKNAIYOUKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.SINKEIZKKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.SYUUDAIKOCD)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CARDKAISYACD)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITCARDNO1)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITCARDNO2)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITCARDNO3)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITCARDNO4)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITCARDYKKIGEN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITMEIGINMKN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.KZKYKDOUKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITKESSAIYOUNO)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CARDBRANDKBN)
    ...
    @Column(name=GenIT_BAK_YykIdouNaiyoHrhnk.CREDITKAIINNOSIMO4KETA)
