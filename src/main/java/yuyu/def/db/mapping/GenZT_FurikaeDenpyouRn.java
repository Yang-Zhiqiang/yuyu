...
/**
 * 振替伝票テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_FurikaeDenpyouRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrntorihikinoc8 zrntorihikinoc8}</td><td>（連携用）取引番号Ｃ８</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinoedano zrntorihikinoedano}</td><td>（連携用）取引番号枝番号</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymdgengokbn zrntorihikiymdgengokbn}</td><td>（連携用）取引年月日元号区分</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinen zrntorihikinen}</td><td>（連携用）取引年</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikituki zrntorihikituki}</td><td>（連携用）取引月</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikibi zrntorihikibi}</td><td>（連携用）取引日</td><td align="center">{@link PKZT_FurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_FurikaeDenpyouRn.TABLE_NAME)
@IdClass(value=PKZT_FurikaeDenpyouRn.class)
public abstract class GenZT_FurikaeDenpyouRn extends AbstractExDBEntityForZDB<ZT_FurikaeDenpyouRn, PKZT_FurikaeDenpyouRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_FurikaeDenpyouRn";
    ...
    private final PKZT_FurikaeDenpyouRn primaryKey;

    public GenZT_FurikaeDenpyouRn() {
        primaryKey = new PKZT_FurikaeDenpyouRn();
    }
    ...
    @Transient
    @Override
    public PKZT_FurikaeDenpyouRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_FurikaeDenpyouRn> getMetaClass() {
        return QZT_FurikaeDenpyouRn.class;
    }

    private String zrnkytkmksyoruicd;

    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKYTKMKYOBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNTORIHIKIBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKANJYOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKANJYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJTANTOUKANM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJTANTOUCD)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJSYSTEMNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNDENPYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJTEKIYOU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJTEKIYOU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJTEKIYOU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKARIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKASIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouRn.ZRNKJKASITEKIYOUKM4)
