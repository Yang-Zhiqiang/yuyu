...
import yuyu.def.db.id.PKIM_KhTyouhyoumsg;
...
/**
 * 契約保全帳票メッセージマスタ テーブルのマッピング情報クラスで、 {@link IM_KhTyouhyoumsg} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IM_KhTyouhyoumsg}</td><td colspan="3">契約保全帳票メッセージマスタ</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyoruiCd syoruiCd}</td><td>書類コード</td><td align="center">{@link PKIM_KhTyouhyoumsg ○}</td><td align="center">V</td><td>{@link C_SyoruiCdKbn}</td></tr>
 *  <tr><td>{@link #getMeigihnkjiyuu meigihnkjiyuu}</td><td>名義変更事由</td><td align="center">{@link PKIM_KhTyouhyoumsg ○}</td><td align="center">V</td><td>{@link C_Meigihnkjiyuu}</td></tr>
 *  <tr><td>{@link #getKyksbumu kyksbumu}</td><td>契約者死亡有無</td><td align="center">{@link PKIM_KhTyouhyoumsg ○}</td><td align="center">V</td><td>{@link C_KyksyaSibouUmuKbn}</td></tr>
 *  <tr><td>{@link #getShrumu shrumu}</td><td>支払有無区分</td><td align="center">{@link PKIM_KhTyouhyoumsg ○}</td><td align="center">V</td><td>{@link C_UmuKbn}</td></tr>
 *  <tr><td>{@link #getTuityouumu tuityouumu}</td><td>追徴有無区分</td><td align="center">{@link PKIM_KhTyouhyoumsg ○}</td><td align="center">V</td><td>{@link C_UmuKbn}</td></tr>
 ...
 * @see     PKIM_KhTyouhyoumsg
 * @see     QIM_KhTyouhyoumsg
 * @see     GenQIM_KhTyouhyoumsg
 */
@MappedSuperclass
@Table(name=GenIM_KhTyouhyoumsg.TABLE_NAME)
@IdClass(value=PKIM_KhTyouhyoumsg.class)
@TypeDefs({
...
public abstract class GenIM_KhTyouhyoumsg extends AbstractExDBEntity<IM_KhTyouhyoumsg, PKIM_KhTyouhyoumsg> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IM_KhTyouhyoumsg";
    ...
    private final PKIM_KhTyouhyoumsg primaryKey;

    public GenIM_KhTyouhyoumsg() {
        primaryKey = new PKIM_KhTyouhyoumsg();
    }
    ...
    @Transient
    @Override
    public PKIM_KhTyouhyoumsg getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIM_KhTyouhyoumsg> getMetaClass() {
        return QIM_KhTyouhyoumsg.class;
    }

    @Id
    @Type(type="UserType_C_SyoruiCdKbn")
    @Column(name=GenIM_KhTyouhyoumsg.SYORUICD)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.MEIGIHNKJIYUU)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.KYKSBUMU)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.SHRUMU)
    ...
    @Id
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIM_KhTyouhyoumsg.TUITYOUUMU)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.TYOUHYOUTITLE)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG1)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG2)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG3)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG4)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG5)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG6)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG7)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG8)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG9)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RSOUHUANNAIMSG10)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG1)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG2)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG3)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG4)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG5)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG6)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG7)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG8)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG9)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG10)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG11)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG12)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG13)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG14)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG15)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG16)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG17)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG18)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG19)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG20)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG21)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG22)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG23)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG24)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG25)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG26)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG27)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG28)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG29)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.RANNAINAIYOUMSG30)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIM_KhTyouhyoumsg.GYOUMUKOUSINTIME)
