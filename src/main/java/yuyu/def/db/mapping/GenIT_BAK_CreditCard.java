...
import yuyu.def.db.id.PKIT_BAK_CreditCard;
import yuyu.def.db.meta.GenQIT_BAK_CreditCard;
import yuyu.def.db.meta.QIT_BAK_CreditCard;
import yuyu.infr.validation.constraints.SyoukenNo;

/**
 * クレジットカードバックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_CreditCard} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_CreditCard}</td><td colspan="3">クレジットカードバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_CreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_CreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_CreditCard ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_CreditCard
 * @see     PKIT_BAK_CreditCard
 * @see     QIT_BAK_CreditCard
 * @see     GenQIT_BAK_CreditCard
 */
@MappedSuperclass
@Table(name=GenIT_BAK_CreditCard.TABLE_NAME)
@IdClass(value=PKIT_BAK_CreditCard.class)
public abstract class GenIT_BAK_CreditCard extends AbstractExDBEntity<IT_BAK_CreditCard, PKIT_BAK_CreditCard> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_CreditCard";
    ...
    private final PKIT_BAK_CreditCard primaryKey;

    public GenIT_BAK_CreditCard() {
        primaryKey = new PKIT_BAK_CreditCard();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_CreditCard getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_CreditCard> getMetaClass() {
        return QIT_BAK_CreditCard.class;
    }

    @Id
    @Column(name=GenIT_BAK_CreditCard.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_CreditCard.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_CreditCard.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_CreditCard.KOKNO)
    ...
    @Column(name=GenIT_BAK_CreditCard.CARDKAISYACD)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITCARDNO1)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITCARDNO2)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITCARDNO3)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITCARDNO4)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITCARDYKKIGEN)
    ...
    @Column(name=GenIT_BAK_CreditCard.CREDITMEIGINMKN)
    ...
    @Column(name=GenIT_BAK_CreditCard.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_CreditCard.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_CreditCard.GYOUMUKOUSINTIME)
