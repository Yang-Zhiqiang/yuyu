...
import yuyu.def.db.id.PKIT_BAK_UketoriKouza;
...
/**
 * 受取口座バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_UketoriKouza} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_UketoriKouza}</td><td colspan="3">受取口座バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_UketoriKouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_UketoriKouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_UketoriKouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUktsyukbn uktsyukbn}</td><td>受取人種類区分</td><td align="center">{@link PKIT_BAK_UketoriKouza ○}</td><td align="center">V</td><td>{@link C_UktsyuKbn}</td></tr>
 *  <tr><td>{@link #getUktsyurenno uktsyurenno}</td><td>受取人種類別連番</td><td align="center">{@link PKIT_BAK_UketoriKouza ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_UketoriKouza
 * @see     QIT_BAK_UketoriKouza
 * @see     GenQIT_BAK_UketoriKouza
 */
@MappedSuperclass
@Table(name=GenIT_BAK_UketoriKouza.TABLE_NAME)
@IdClass(value=PKIT_BAK_UketoriKouza.class)
@TypeDefs({
...
public abstract class GenIT_BAK_UketoriKouza extends AbstractExDBEntity<IT_BAK_UketoriKouza, PKIT_BAK_UketoriKouza> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_UketoriKouza";
    ...
    private final PKIT_BAK_UketoriKouza primaryKey;

    public GenIT_BAK_UketoriKouza() {
        primaryKey = new PKIT_BAK_UketoriKouza();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_UketoriKouza getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_UketoriKouza> getMetaClass() {
        return QIT_BAK_UketoriKouza.class;
    }

    @Id
    @Column(name=GenIT_BAK_UketoriKouza.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_UketoriKouza.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_UketoriKouza.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.UKTSYUKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_UketoriKouza.UKTSYURENNO)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.KZSYURUIKBN)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_UketoriKouza.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_UketoriKouza.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_UketoriKouza.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_UketoriKouza.GYOUMUKOUSINTIME)
