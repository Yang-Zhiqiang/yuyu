...
import yuyu.def.db.id.PKIT_KykSyouhn;
import yuyu.def.db.meta.GenQIT_KykSyouhn;
...
/**
 * 契約商品テーブル テーブルのマッピング情報クラスで、 {@link IT_KykSyouhn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykSyouhn}</td><td colspan="3">契約商品テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_KykSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_KykSyouhn
 * @see     QIT_KykSyouhn
 * @see     GenQIT_KykSyouhn
 */
@MappedSuperclass
@Table(name=GenIT_KykSyouhn.TABLE_NAME)
@IdClass(value=PKIT_KykSyouhn.class)
@TypeDefs({
...
public abstract class GenIT_KykSyouhn extends AbstractExDBEntity<IT_KykSyouhn, PKIT_KykSyouhn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykSyouhn";
    ...
    private final PKIT_KykSyouhn primaryKey;

    public GenIT_KykSyouhn() {
        primaryKey = new PKIT_KykSyouhn();
    }
    ...
    @Transient
    @Override
    public PKIT_KykSyouhn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykSyouhn> getMetaClass() {
        return QIT_KykSyouhn.class;
    }

    @Id
    @Column(name=GenIT_KykSyouhn.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykSyouhn.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KykSyouhn.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_KykSyouhn.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_KykSyouhn.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_KykSyouhn.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_KykSyouhn.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KykSyouhn.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_KykSyouhn.KYKJYOUTAI)
    ...
    @Column(name=GenIT_KykSyouhn.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_KykSyouhn.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.KYKYMD)
    ...
    @Column(name=GenIT_KykSyouhn.KYKYMDSITEIUMUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.GANSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.HKSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.HKGANSKNNKAISIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyouhn.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_KykSyouhn.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KykSyouhn.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_KykSyouhn.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_KykSyouhn.KYKNEN)
    ...
    @Column(name=GenIT_KykSyouhn.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykSyouhn.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_KykSyouhn.KATAKBN)
    ...
    @Column(name=GenIT_KykSyouhn.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_KykSyouhn.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_KykSyouhn.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_KykSyouhn.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_KykSyouhn.PMNJTKKBN)
    ...
    @Column(name=GenIT_KykSyouhn.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KykSyouhn.RYOURITUSDNO)
    ...
    @Column(name=GenIT_KykSyouhn.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_KykSyouhn.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_KykSyouhn.NKSYUKBN)
    ...
    @Column(name=GenIT_KykSyouhn.NENKINKKN)
    ...
    @Column(name=GenIT_KykSyouhn.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_KykSyouhn.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykSyouhn.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykSyouhn.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.YENDTHNKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.KYKJISISUURENDOURATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.TUMITATERIRITU)
    ...
    @Column(name=GenIT_KykSyouhn.TMTTKNHAIBUNJYOUTAI)
    ...
    @Column(name=GenIT_KykSyouhn.SISUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KykSyouhn.GSBUNRIKZKAKUNINUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KykSyouhn.GSBUNRITAISYOU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KykSyouhn.TMTTKNITENYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.LOADINGHNKGTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.RENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KykSyouhn.TEIKISHRRITU)
    ...
    @Column(name=GenIT_KykSyouhn.DAI1HKNKKN)
    @Range(min="0", max="99")
