...
/**
 * 新契約決算用振替伝票テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_SkKsnHurikaeTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKsnHurikaeTy}</td><td colspan="3">新契約決算用振替伝票テーブル（中）</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikinoc8 ztytorihikinoc8}</td><td>（中継用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinoedano ztytorihikinoedano}</td><td>（中継用）取引番号枝番号</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikiymdgengokbn ztytorihikiymdgengokbn}</td><td>（中継用）取引年月日元号区分</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinen ztytorihikinen}</td><td>（中継用）取引年</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikituki ztytorihikituki}</td><td>（中継用）取引月</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikibi ztytorihikibi}</td><td>（中継用）取引日</td><td align="center">{@link PKZT_SkKsnHurikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkKsnHurikaeTy
 * @see     PKZT_SkKsnHurikaeTy
 * @see     QZT_SkKsnHurikaeTy
 * @see     GenQZT_SkKsnHurikaeTy
 */
@MappedSuperclass
@Table(name=GenZT_SkKsnHurikaeTy.TABLE_NAME)
@IdClass(value=PKZT_SkKsnHurikaeTy.class)
public abstract class GenZT_SkKsnHurikaeTy extends AbstractExDBEntity<ZT_SkKsnHurikaeTy, PKZT_SkKsnHurikaeTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKsnHurikaeTy";
    ...
    private final PKZT_SkKsnHurikaeTy primaryKey;

    public GenZT_SkKsnHurikaeTy() {
        primaryKey = new PKZT_SkKsnHurikaeTy();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKsnHurikaeTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKsnHurikaeTy> getMetaClass() {
        return QZT_SkKsnHurikaeTy.class;
    }

    private String ztykytkmksyoruicd;

    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYTORIHIKIBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKANJYOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJTANTOUCD)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeTy.ZTYKJKASITEKIYOUKM4)
