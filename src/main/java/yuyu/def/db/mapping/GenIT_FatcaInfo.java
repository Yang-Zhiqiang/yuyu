...
import yuyu.def.db.id.PKIT_FatcaInfo;
import yuyu.def.db.meta.GenQIT_FatcaInfo;
...
/**
 * ＦＡＴＣＡ情報テーブル テーブルのマッピング情報クラスで、 {@link IT_FatcaInfo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_FatcaInfo}</td><td colspan="3">ＦＡＴＣＡ情報テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_FatcaInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_FatcaInfo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_FatcaInfo ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_FatcaInfo
 * @see     QIT_FatcaInfo
 * @see     GenQIT_FatcaInfo
 */
@MappedSuperclass
@Table(name=GenIT_FatcaInfo.TABLE_NAME)
@IdClass(value=PKIT_FatcaInfo.class)
@TypeDefs({
...
public abstract class GenIT_FatcaInfo extends AbstractExDBEntity<IT_FatcaInfo, PKIT_FatcaInfo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_FatcaInfo";
    ...
    private final PKIT_FatcaInfo primaryKey;

    public GenIT_FatcaInfo() {
        primaryKey = new PKIT_FatcaInfo();
    }
    ...
    @Transient
    @Override
    public PKIT_FatcaInfo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_FatcaInfo> getMetaClass() {
        return QIT_FatcaInfo.class;
    }

    @Id
    @Column(name=GenIT_FatcaInfo.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_FatcaInfo.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_FatcaInfo.RENNO)
    ...
    @Column(name=GenIT_FatcaInfo.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_FatcaInfo.SYORISOSIKICD)
    ...
    @Column(name=GenIT_FatcaInfo.FATCASNSIKBN)
    ...
    @Column(name=GenIT_FatcaInfo.BIKKJNSSINFOKBN)
    ...
    @Column(name=GenIT_FatcaInfo.FATCAKEKKBN)
    ...
    @Column(name=GenIT_FatcaInfo.FATCAHANKEIIKBN)
    ...
    @Column(name=GenIT_FatcaInfo.BIKKNZSYNO)
    @MaxLength(max=9)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_FatcaInfo.SYOMEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_FatcaInfo.KOKNO)
    ...
    @Column(name=GenIT_FatcaInfo.FATCATGKBN)
    ...
    @Column(name=GenIT_FatcaInfo.SEIONNMKN)
    ...
    @Column(name=GenIT_FatcaInfo.NMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_FatcaInfo.NMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_FatcaInfo.SEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_FatcaInfo.SEIBETU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_FatcaInfo.KOURYOKUENDYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_FatcaInfo.TRKYMD)
    @ValidDate
    ...
    @Column(name=GenIT_FatcaInfo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_FatcaInfo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_FatcaInfo.GYOUMUKOUSINTIME)
