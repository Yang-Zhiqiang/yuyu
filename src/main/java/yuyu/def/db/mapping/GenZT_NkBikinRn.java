...
/**
 * 年金備金テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkBikinRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkBikinRn}</td><td colspan="3">年金備金テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnnksyousyono zrnnksyousyono}</td><td>（連携用）年金証書番号</td><td align="center">{@link PKZT_NkBikinRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrnshiharaihasseiymd zrnshiharaihasseiymd}</td><td>（連携用）支払発生日</td><td align="center">{@link PKZT_NkBikinRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkBikinRn.TABLE_NAME)
@IdClass(value=PKZT_NkBikinRn.class)
public abstract class GenZT_NkBikinRn extends AbstractExDBEntityForZDB<ZT_NkBikinRn, PKZT_NkBikinRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkBikinRn";
    ...
    private final PKZT_NkBikinRn primaryKey;

    public GenZT_NkBikinRn() {
        primaryKey = new PKZT_NkBikinRn();
    }

    public GenZT_NkBikinRn(String pZrnnksyousyono, String pZrnshiharaihasseiymd) {
        primaryKey = new PKZT_NkBikinRn(pZrnnksyousyono, pZrnshiharaihasseiymd);
    }

    @Transient
    @Override
    public PKZT_NkBikinRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkBikinRn> getMetaClass() {
        return QZT_NkBikinRn.class;
    }

    @Id
    @Column(name=GenZT_NkBikinRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNIDOUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOUIN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINSYU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNCURRENTDAY)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNCURRENTTIME)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKASANNKGK)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKKNSETYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTEIZOURITU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNDKIGETU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUNENDOD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSIHARAIUKETUKEBASYO)
    ...
    @Id
    @Column(name=GenZT_NkBikinRn.ZRNSHIHARAIHASSEIYMD)
    public String getZrnshiharaihasseiymd() {
        return getPrimaryKey().getZrnshiharaihasseiymd();
    }

    public void setZrnshiharaihasseiymd(String pZrnshiharaihasseiymd) {
        getPrimaryKey().setZrnshiharaihasseiymd(pZrnshiharaihasseiymd);
    }

    private String zrnhhknseikbn;

    @Column(name=GenZT_NkBikinRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV8)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV1X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV8X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV8X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV59)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkBikinRn.ZRNYOBIV17)
