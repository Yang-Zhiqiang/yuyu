...
import yuyu.def.db.id.PKHT_BosTrkKzk;
import yuyu.def.db.meta.GenQHT_BosTrkKzk;
...
/**
 * 募集登録家族テーブル テーブルのマッピング情報クラスで、 {@link HT_BosTrkKzk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BosTrkKzk}</td><td colspan="3">募集登録家族テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_BosTrkKzk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkkzkkbn trkkzkkbn}</td><td>登録家族区分</td><td align="center">{@link PKHT_BosTrkKzk ○}</td><td align="center">V</td><td>{@link C_TrkKzkKbn}</td></tr>
 ...
 * @see     PKHT_BosTrkKzk
 * @see     QHT_BosTrkKzk
 * @see     GenQHT_BosTrkKzk
 */
@MappedSuperclass
@Table(name=GenHT_BosTrkKzk.TABLE_NAME)
@IdClass(value=PKHT_BosTrkKzk.class)
@TypeDefs({
...
public abstract class GenHT_BosTrkKzk extends AbstractExDBEntity<HT_BosTrkKzk, PKHT_BosTrkKzk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BosTrkKzk";
    ...
    private final PKHT_BosTrkKzk primaryKey;

    public GenHT_BosTrkKzk() {
        primaryKey = new PKHT_BosTrkKzk();
    }

    public GenHT_BosTrkKzk(String pMosno, C_TrkKzkKbn pTrkkzkkbn) {
        primaryKey = new PKHT_BosTrkKzk(pMosno, pTrkkzkkbn);
    }

    @Transient
    @Override
    public PKHT_BosTrkKzk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BosTrkKzk> getMetaClass() {
        return QHT_BosTrkKzk.class;
    }

    @Id
    @Column(name=GenHT_BosTrkKzk.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKKBN)
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKNMKJKHUKAKBN)
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKSEI)
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKTDK)
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKTSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_BosTrkKzk.TRKKZKTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_BosTrkKzk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BosTrkKzk.GYOUMUKOUSINTIME)
