...
import yuyu.def.db.id.PKHT_TokujyouRireki;
...
/**
 * 特条履歴テーブル テーブルのマッピング情報クラスで、 {@link HT_TokujyouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_TokujyouRireki}</td><td colspan="3">特条履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_TokujyouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDakuhiktrenno dakuhiktrenno}</td><td>諾否決定連番</td><td align="center">{@link PKHT_TokujyouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKHT_TokujyouRireki
 * @see     QHT_TokujyouRireki
 * @see     GenQHT_TokujyouRireki
 */
@MappedSuperclass
@Table(name=GenHT_TokujyouRireki.TABLE_NAME)
@IdClass(value=PKHT_TokujyouRireki.class)
@TypeDefs({
...
public abstract class GenHT_TokujyouRireki extends AbstractExDBEntity<HT_TokujyouRireki, PKHT_TokujyouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_TokujyouRireki";
    ...
    private final PKHT_TokujyouRireki primaryKey;

    public GenHT_TokujyouRireki() {
        primaryKey = new PKHT_TokujyouRireki();
    }

    public GenHT_TokujyouRireki(String pMosno, Integer pDakuhiktrenno) {
        primaryKey = new PKHT_TokujyouRireki(pMosno, pDakuhiktrenno);
    }

    @Transient
    @Override
    public PKHT_TokujyouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_TokujyouRireki> getMetaClass() {
        return QHT_TokujyouRireki.class;
    }

    @Id
    @Column(name=GenHT_TokujyouRireki.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_TokujyouRireki.DAKUHIKTRENNO)
    ...
    @Column(name=GenHT_TokujyouRireki.TKJYHYOUTEN)
    ...
    @Column(name=GenHT_TokujyouRireki.TKJYSKGNKKN)
    ...
    @Column(name=GenHT_TokujyouRireki.HTNPBUICD1)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenHT_TokujyouRireki.HTNPKKN1)
    ...
    @Column(name=GenHT_TokujyouRireki.HTNPBUICD2)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_TokujyouRireki.HTNPKKN2)
    ...
    @Column(name=GenHT_TokujyouRireki.HTNPBUICD3)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_TokujyouRireki.HTNPKKN3)
    ...
    @Column(name=GenHT_TokujyouRireki.HTNPBUICD4)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenHT_TokujyouRireki.HTNPKKN4)
    ...
    @Column(name=GenHT_TokujyouRireki.TOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenHT_TokujyouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_TokujyouRireki.GYOUMUKOUSINTIME)
