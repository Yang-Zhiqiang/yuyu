...
/**
 * 新契約収入Ｐ統計例月Ｆテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkeisynyptoukeirigRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkeisynyptoukeirigRn}</td><td colspan="3">新契約収入Ｐ統計例月Ｆテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_SkeisynyptoukeirigRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_SkeisynyptoukeirigRn
 * @see     PKZT_SkeisynyptoukeirigRn
 * @see     QZT_SkeisynyptoukeirigRn
 * @see     GenQZT_SkeisynyptoukeirigRn
 */
@MappedSuperclass
@Table(name=GenZT_SkeisynyptoukeirigRn.TABLE_NAME)
@IdClass(value=PKZT_SkeisynyptoukeirigRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_SkeisynyptoukeirigRn extends AbstractExDBEntityForZDB<ZT_SkeisynyptoukeirigRn, PKZT_SkeisynyptoukeirigRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkeisynyptoukeirigRn";
    ...
    private final PKZT_SkeisynyptoukeirigRn primaryKey;

    public GenZT_SkeisynyptoukeirigRn() {
        primaryKey = new PKZT_SkeisynyptoukeirigRn();
    }

    public GenZT_SkeisynyptoukeirigRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_SkeisynyptoukeirigRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_SkeisynyptoukeirigRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkeisynyptoukeirigRn> getMetaClass() {
        return QZT_SkeisynyptoukeirigRn.class;
    }

    @Id
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRENDOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUUNOUKEIROKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUITOUSISYA)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUUKINYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNJYUUTOUYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNJYUUTOUKAISUU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNZENNOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSETKYKKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNBANKIKKATUHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTNKNMNOSJTIKBBNJYUTUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSETRENSEIMRTIKATAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUKEIYAKUPWARIBIKIKBNX2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYKYKTNKNYUGUKBNX2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSETKAIGOMARUTEIKATAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYONENDOSYOKAIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYONENDO2KAIMEIKOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNJINENDOIKOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHNGKNKSAITEIHOSYUKNGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUUNOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTKYKKUMKHNSYUKOSUU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSITIHSYURIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNNKGNSRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSINNYUUKINKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDFNYUUKINKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTORIKUZUSIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKBNKEIRIYOUSEGMENTCD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYKIKYKJKYKYM)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDFKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNPHIREILKEISANYOUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNCASHLESSHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNJIDOUKOUSINHYOUJI)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN10X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN10X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSYUKEIYAKUSYURUICDV3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSISUUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNNYKNJIKAWASERATE)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNNYKNJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSUURIYOUYOBIN10X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV9X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV10X16)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNNKGNS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSISUUBBNTOUNYUUGK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNSAISINYOTEIRIRITU)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNZENNOUJIIKKATUBARAIJYTGK)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X2)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X3)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X4)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X5)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X6)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X7)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X8)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X9)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X10)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X11)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X12)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X13)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X14)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X15)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X16)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X17)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X18)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X19)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X20)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X21)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X22)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X23)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X24)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X25)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X26)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X27)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X28)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X29)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X30)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X31)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X32)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X33)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X34)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X35)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X36)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X37)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X38)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X39)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X40)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X41)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X42)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X43)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X44)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X45)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X46)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X47)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X48)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X49)
    ...
    @Column(name=GenZT_SkeisynyptoukeirigRn.ZRNTOKUYAKUKOUMOKUV160X50)
