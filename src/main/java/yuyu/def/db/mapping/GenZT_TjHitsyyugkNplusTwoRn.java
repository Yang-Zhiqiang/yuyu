...
/**
 * 通常配当所要額Ｆ（Ｎ＋２）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusTwoRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusTwoRn}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋２）テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusTwoRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusTwoRn
 * @see     PKZT_TjHitsyyugkNplusTwoRn
 * @see     QZT_TjHitsyyugkNplusTwoRn
 * @see     GenQZT_TjHitsyyugkNplusTwoRn
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusTwoRn.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusTwoRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusTwoRn extends AbstractExDBEntityForZDB<ZT_TjHitsyyugkNplusTwoRn, PKZT_TjHitsyyugkNplusTwoRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusTwoRn";
    ...
    private final PKZT_TjHitsyyugkNplusTwoRn primaryKey;

    public GenZT_TjHitsyyugkNplusTwoRn() {
        primaryKey = new PKZT_TjHitsyyugkNplusTwoRn();
    }

    public GenZT_TjHitsyyugkNplusTwoRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusTwoRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusTwoRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusTwoRn> getMetaClass() {
        return QZT_TjHitsyyugkNplusTwoRn.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusTwoRn.ZRNTOKUYAKUKOUMOKUV180X50)
