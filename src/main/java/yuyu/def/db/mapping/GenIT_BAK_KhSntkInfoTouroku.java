...
import yuyu.def.db.id.PKIT_BAK_KhSntkInfoTouroku;
import yuyu.def.db.meta.GenQIT_BAK_KhSntkInfoTouroku;
...
/**
 * 契約保全選択情報登録バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhSntkInfoTouroku} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhSntkInfoTouroku}</td><td colspan="3">契約保全選択情報登録バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhSntkInfoTouroku ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhSntkInfoTouroku ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_KhSntkInfoTouroku ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KhSntkInfoTouroku
 * @see     PKIT_BAK_KhSntkInfoTouroku
 * @see     QIT_BAK_KhSntkInfoTouroku
 * @see     GenQIT_BAK_KhSntkInfoTouroku
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhSntkInfoTouroku.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhSntkInfoTouroku.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhSntkInfoTouroku extends AbstractExDBEntity<IT_BAK_KhSntkInfoTouroku, PKIT_BAK_KhSntkInfoTouroku> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhSntkInfoTouroku";
    ...
    private final PKIT_BAK_KhSntkInfoTouroku primaryKey;

    public GenIT_BAK_KhSntkInfoTouroku() {
        primaryKey = new PKIT_BAK_KhSntkInfoTouroku();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhSntkInfoTouroku getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhSntkInfoTouroku> getMetaClass() {
        return QIT_BAK_KhSntkInfoTouroku.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.RENNO)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.HUHO2KYKNO)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.HUHO2KYKNOKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SNTKINFOKANKEISYAKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TAISYOUNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TAISYOUNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TAISYOUSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TAISYOUSEIBETU)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.DAKUHIKETNAIYOUUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KKTNAIYOUUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KIJINAIYOUUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.MRUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KOUDOSYOUGAIUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TORIKAIJOUMUKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SEIRITUKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.DECKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETKEKKACD)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETRIYUUCD1)
    ...
    @Type(type="UserType_C_Ketriyuucd")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETRIYUUCD2)
    ...
    @Type(type="UserType_C_Ketriyuucd")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETRIYUUCD3)
    ...
    @Type(type="UserType_C_Ketriyuucd")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETRIYUUCD4)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KETSYACD)
    @MaxLength(max=15)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.PALKETSYACD)
    @Length(length=2)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SINTYOU)
    @Range(min="0", max="999")
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.TAIJYUU)
    @Range(min="0", max="999")
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KKTYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYOUBYOUCD1)
    @MaxLength(max=6)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYOUBYOUJYOUTAIKBN1)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KANTIYM1)
    @ValidDateYm
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYOUBYOUCD2)
    @MaxLength(max=6)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Type(type="UserType_C_SyoubyoujyoutaiKbn")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYOUBYOUJYOUTAIKBN2)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.KANTIYM2)
    @ValidDateYm
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.MRRIYUUCDKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SNTKINFOKYKTORIKESIKBN)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.SYORIZUMIFLG)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhSntkInfoTouroku.GYOUMUKOUSINTIME)
