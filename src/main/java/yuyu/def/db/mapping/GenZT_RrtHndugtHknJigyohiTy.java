...
/**
 * 利率変動型保険事業費Ｆテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_RrtHndugtHknJigyohiTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RrtHndugtHknJigyohiTy}</td><td colspan="3">利率変動型保険事業費Ｆテーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_RrtHndugtHknJigyohiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_RrtHndugtHknJigyohiTy
 * @see     PKZT_RrtHndugtHknJigyohiTy
 * @see     QZT_RrtHndugtHknJigyohiTy
 * @see     GenQZT_RrtHndugtHknJigyohiTy
 */
@MappedSuperclass
@Table(name=GenZT_RrtHndugtHknJigyohiTy.TABLE_NAME)
@IdClass(value=PKZT_RrtHndugtHknJigyohiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RrtHndugtHknJigyohiTy extends AbstractExDBEntity<ZT_RrtHndugtHknJigyohiTy, PKZT_RrtHndugtHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RrtHndugtHknJigyohiTy";
    ...
    private final PKZT_RrtHndugtHknJigyohiTy primaryKey;

    public GenZT_RrtHndugtHknJigyohiTy() {
        primaryKey = new PKZT_RrtHndugtHknJigyohiTy();
    }

    public GenZT_RrtHndugtHknJigyohiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_RrtHndugtHknJigyohiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_RrtHndugtHknJigyohiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RrtHndugtHknJigyohiTy> getMetaClass() {
        return QZT_RrtHndugtHknJigyohiTy.class;
    }

    @Id
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURIYOUPJYTOUYM)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKYKYMDMAEKYKHYJ)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKARIKASIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIV7)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSTDSSNSKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKYKSYOUMETUZUMIHYOUJI)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIV3)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURISYURUICD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYDAIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYTYUUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSYOUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSEDAIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHRKKEIROKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIV10)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYNENKINGATAKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYNKNSHRY)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYGAIKAKBN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIV6)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPJUUTOUJIKAWASERATE)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPJUUTOUJIKAWASEKIJYUNYMD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYGESSITUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOTEIRIRITUN5)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYTUMITATERIRITU)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKEISANHANTEIYOUTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYVHIREILRITU)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIN13)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPHIREILWRBKRITU)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYGETUMATUTUMITATEKIN)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYZENNOUJIIKKATUBARAIJYTGK)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYGAIKADATENKGNS)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RrtHndugtHknJigyohiTy.ZTYYOBIV11)
