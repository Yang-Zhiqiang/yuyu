...
import yuyu.def.db.id.PKIT_BAK_HokenKykIdouRireki;
import yuyu.def.db.meta.GenQIT_BAK_HokenKykIdouRireki;
...
/**
 * 保険契約異動情報履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_HokenKykIdouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_HokenKykIdouRireki}</td><td colspan="3">保険契約異動情報履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_HokenKykIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_HokenKykIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_HokenKykIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_HokenKykIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZougenkbn zougenkbn}</td><td>増減区分</td><td align="center">{@link PKIT_BAK_HokenKykIdouRireki ○}</td><td align="center">V</td><td>{@link C_ZougenKbn}</td></tr>
 ...
 * </table>
 * @see     IT_BAK_HokenKykIdouRireki
 * @see     PKIT_BAK_HokenKykIdouRireki
 * @see     QIT_BAK_HokenKykIdouRireki
 * @see     GenQIT_BAK_HokenKykIdouRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_HokenKykIdouRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_HokenKykIdouRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_HokenKykIdouRireki extends AbstractExDBEntity<IT_BAK_HokenKykIdouRireki, PKIT_BAK_HokenKykIdouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_HokenKykIdouRireki";
    ...
    private final PKIT_BAK_HokenKykIdouRireki primaryKey;

    public GenIT_BAK_HokenKykIdouRireki() {
        primaryKey = new PKIT_BAK_HokenKykIdouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_HokenKykIdouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_HokenKykIdouRireki> getMetaClass() {
        return QIT_BAK_HokenKykIdouRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_HokenKykIdouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HokenKykIdouRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_HokenKykIdouRireki.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HokenKykIdouRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.IDOUYMD)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.IDOUJIYUUKBN)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.TTDKRENNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_HokenKykIdouRireki.KYKYMD)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.HHKNSEI)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.HKNSYUKIGOU)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.AISYOUMEIKBN)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.ZOUGENKBN)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.YOTEIRIRITU)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.TUMITATEKINKBN)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.KYKIDOUHARAIKATAKBN)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_HokenKykIdouRireki.GYOUMUKOUSINTIME)
