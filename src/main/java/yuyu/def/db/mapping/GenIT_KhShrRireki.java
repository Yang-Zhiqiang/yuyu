...
import yuyu.def.db.id.PKIT_KhShrRireki;
import yuyu.def.db.meta.GenQIT_KhShrRireki;
...
/**
 * 契約保全支払履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_KhShrRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhShrRireki}</td><td colspan="3">契約保全支払履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhShrRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhShrRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KhShrRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KhShrRireki
 * @see     PKIT_KhShrRireki
 * @see     QIT_KhShrRireki
 * @see     GenQIT_KhShrRireki
 */
@MappedSuperclass
@Table(name=GenIT_KhShrRireki.TABLE_NAME)
@IdClass(value=PKIT_KhShrRireki.class)
@TypeDefs({
...
public abstract class GenIT_KhShrRireki extends AbstractExDBEntity<IT_KhShrRireki, PKIT_KhShrRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhShrRireki";
    ...
    private final PKIT_KhShrRireki primaryKey;

    public GenIT_KhShrRireki() {
        primaryKey = new PKIT_KhShrRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_KhShrRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhShrRireki> getMetaClass() {
        return QIT_KhShrRireki.class;
    }

    @Id
    @Column(name=GenIT_KhShrRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhShrRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhShrRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KhShrRireki.SHRYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.SHRSYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KhShrRireki.SHRSYORIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.TORIKESIFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.TORIKESIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.SYORUIUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.SHRTIENRSKKISANYMD)
    ...
    @Column(name=GenIT_KhShrRireki.TIENRSKNISSUU)
    ...
    @Column(name=GenIT_KhShrRireki.SINSAGENDOKKNKBN)
    ...
    @Column(name=GenIT_KhShrRireki.RIKOUKITYUUTUUDANNISSUU)
    @Range(min="0", max="999")
    ...
    @Column(name=GenIT_KhShrRireki.ZEITRATKIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KhShrRireki.GSBUNRITAISYOU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KhShrRireki.YENSHRTKUMU)
    ...
    @Column(name=GenIT_KhShrRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_KhShrRireki.SYUSHRGKKEISYUKBN)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_KhShrRireki.SHRTUUKASYU)
    ...
    @Column(name=GenIT_KhShrRireki.NZTODOUHUKENCD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.SHRKWSRATEKJNYMD)
    ...
    @Column(name=GenIT_KhShrRireki.SHRKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.ZEIMUKWSRATEKJNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhShrRireki.ZEIMUKWSRATE)
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKISITEIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKINMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKIYNO)
    @Digit
    @Length(length=7)
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKIADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKIADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SOUKINSAKIADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKYNO)
    @Digit
    @Length(length=7)
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKSYASZKADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SAIKENNMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SAIKENNYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_KhShrRireki.SAIKENADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SAIKENADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.SAIKENADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.INPUTSHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.SHRHOUSITEIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.KZSYURUIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_KhShrRireki.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhShrRireki.YOKINKBN)
    ...
    @Column(name=GenIT_KhShrRireki.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KZDOUKBN)
    ...
    @Column(name=GenIT_KhShrRireki.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KhShrRireki.KYKMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhShrRireki.UKTMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_KhShrRireki.SHRTYSYSYURUIKBN)
    ...
    @Column(name=GenIT_KhShrRireki.DENRENNO)
    ...
    @Column(name=GenIT_KhShrRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhShrRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhShrRireki.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_KhShrRireki.KYKHNKKAISUU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_KhShrRireki.ZEITEKIAZUKARIKINKJUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhShrRireki.GAIKASHRKWSRATEKJNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KhShrRireki.GAIKASHRKWSRATE)
    ...
    @Column(name=GenIT_KhShrRireki.SHRTYSYKURIKOSIYOUHI)
