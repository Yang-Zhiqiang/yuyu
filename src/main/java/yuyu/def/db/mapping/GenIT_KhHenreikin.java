...
/**
 * 契約保全返戻金テーブル テーブルのマッピング情報クラスで、 {@link IT_KhHenreikin} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhHenreikin}</td><td colspan="3">契約保全返戻金テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhHenreikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhHenreikin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_KhHenreikin ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KhHenreikin.TABLE_NAME)
@IdClass(value=PKIT_KhHenreikin.class)
@TypeDefs({
...
public abstract class GenIT_KhHenreikin extends AbstractExDBEntity<IT_KhHenreikin, PKIT_KhHenreikin> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhHenreikin";
    ...
    private final PKIT_KhHenreikin primaryKey;

    public GenIT_KhHenreikin() {
        primaryKey = new PKIT_KhHenreikin();
    }
    ...
    @Transient
    @Override
    public PKIT_KhHenreikin getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhHenreikin> getMetaClass() {
        return QIT_KhHenreikin.class;
    }

    @Id
    @Column(name=GenIT_KhHenreikin.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhHenreikin.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhHenreikin.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KhHenreikin.HRSYURUIKBN)
    ...
    @Column(name=GenIT_KhHenreikin.SHRYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHenreikin.SHRSYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHenreikin.HRHSISYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHenreikin.HRHSIYMD)
    ...
    @Column(name=GenIT_KhHenreikin.HRSIHARAIJYOUTAIKBN)
    ...
    @Column(name=GenIT_KhHenreikin.SEG1CD)
    ...
    @Type(type="UserType_C_Segcd")
    @Column(name=GenIT_KhHenreikin.SEG2CD)
    ...
    @Column(name=GenIT_KhHenreikin.TANTOCD)
    ...
    @Column(name=GenIT_KhHenreikin.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhHenreikin.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhHenreikin.GYOUMUKOUSINTIME)
