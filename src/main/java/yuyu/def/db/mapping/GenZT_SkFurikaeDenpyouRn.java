...
/**
 * 新契約振替伝票テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkFurikaeDenpyouRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkFurikaeDenpyouRn}</td><td colspan="3">新契約振替伝票テーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikinoc8 zrntorihikinoc8}</td><td>（連携用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinoedano zrntorihikinoedano}</td><td>（連携用）取引番号枝番号</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymdgengokbn zrntorihikiymdgengokbn}</td><td>（連携用）取引年月日元号区分</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinen zrntorihikinen}</td><td>（連携用）取引年</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikituki zrntorihikituki}</td><td>（連携用）取引月</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikibi zrntorihikibi}</td><td>（連携用）取引日</td><td align="center">{@link PKZT_SkFurikaeDenpyouRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkFurikaeDenpyouRn
 * @see     PKZT_SkFurikaeDenpyouRn
 * @see     QZT_SkFurikaeDenpyouRn
 * @see     GenQZT_SkFurikaeDenpyouRn
 */
@MappedSuperclass
@Table(name=GenZT_SkFurikaeDenpyouRn.TABLE_NAME)
@IdClass(value=PKZT_SkFurikaeDenpyouRn.class)
public abstract class GenZT_SkFurikaeDenpyouRn extends AbstractExDBEntityForZDB<ZT_SkFurikaeDenpyouRn, PKZT_SkFurikaeDenpyouRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkFurikaeDenpyouRn";
    ...
    private final PKZT_SkFurikaeDenpyouRn primaryKey;

    public GenZT_SkFurikaeDenpyouRn() {
        primaryKey = new PKZT_SkFurikaeDenpyouRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkFurikaeDenpyouRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkFurikaeDenpyouRn> getMetaClass() {
        return QZT_SkFurikaeDenpyouRn.class;
    }

    private String zrnkytkmksyoruicd;

    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNTORIHIKIBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKANJYOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJTANTOUCD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouRn.ZRNKJKASITEKIYOUKM4)
