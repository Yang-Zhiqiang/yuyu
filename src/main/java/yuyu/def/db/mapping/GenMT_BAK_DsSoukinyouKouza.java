...
import yuyu.def.db.id.PKMT_BAK_DsSoukinyouKouza;
...
/**
 * ＤＳ送金用口座バックアップテーブル テーブルのマッピング情報クラスで、 {@link MT_BAK_DsSoukinyouKouza} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getDskokno dskokno}</td><td>ＤＳ顧客番号</td><td align="center">{@link PKMT_BAK_DsSoukinyouKouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKMT_BAK_DsSoukinyouKouza ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getKzsyuruikbn kzsyuruikbn}</td><td>口座種類区分</td><td align="center">{@link PKMT_BAK_DsSoukinyouKouza ○}</td><td align="center">V</td><td>{@link C_KouzasyuruiKbn}</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKMT_BAK_DsSoukinyouKouza ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKMT_BAK_DsSoukinyouKouza
 * @see     QMT_BAK_DsSoukinyouKouza
 * @see     GenQMT_BAK_DsSoukinyouKouza
 */
@MappedSuperclass
@Table(name=GenMT_BAK_DsSoukinyouKouza.TABLE_NAME)
@IdClass(value=PKMT_BAK_DsSoukinyouKouza.class)
@TypeDefs({
...
public abstract class GenMT_BAK_DsSoukinyouKouza extends AbstractExDBEntity<MT_BAK_DsSoukinyouKouza, PKMT_BAK_DsSoukinyouKouza> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MT_BAK_DsSoukinyouKouza";
    ...
    private final PKMT_BAK_DsSoukinyouKouza primaryKey;

    public GenMT_BAK_DsSoukinyouKouza() {
        primaryKey = new PKMT_BAK_DsSoukinyouKouza();
    }
    ...
    @Transient
    @Override
    public PKMT_BAK_DsSoukinyouKouza getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMT_BAK_DsSoukinyouKouza> getMetaClass() {
        return QMT_BAK_DsSoukinyouKouza.class;
    }

    @Id
    @Column(name=GenMT_BAK_DsSoukinyouKouza.DSKOKNO)
    ...
    @Id
    @Column(name=GenMT_BAK_DsSoukinyouKouza.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.KZSYURUIKBN)
    ...
    @Id
    @Column(name=GenMT_BAK_DsSoukinyouKouza.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.YOKINKBN)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.KZDOUKBN)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenMT_BAK_DsSoukinyouKouza.GYOUMUKOUSINTIME)
