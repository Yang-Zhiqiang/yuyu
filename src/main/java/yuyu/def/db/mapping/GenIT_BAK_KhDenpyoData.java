...
import yuyu.def.db.id.PKIT_BAK_KhDenpyoData;
import yuyu.def.db.meta.GenQIT_BAK_KhDenpyoData;
...
/**
 * 契約保全伝票データバックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhDenpyoData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhDenpyoData}</td><td colspan="3">契約保全伝票データバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKIT_BAK_KhDenpyoData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhDenpyoData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKIT_BAK_KhDenpyoData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KhDenpyoData
 * @see     PKIT_BAK_KhDenpyoData
 * @see     QIT_BAK_KhDenpyoData
 * @see     GenQIT_BAK_KhDenpyoData
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhDenpyoData.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhDenpyoData.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhDenpyoData extends AbstractExDBEntity<IT_BAK_KhDenpyoData, PKIT_BAK_KhDenpyoData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhDenpyoData";
    ...
    private final PKIT_BAK_KhDenpyoData primaryKey;

    public GenIT_BAK_KhDenpyoData() {
        primaryKey = new PKIT_BAK_KhDenpyoData();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhDenpyoData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhDenpyoData> getMetaClass() {
        return QIT_BAK_KhDenpyoData.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhDenpyoData.DENRENNO)
    ...
    @Id
    @Column(name=GenIT_BAK_KhDenpyoData.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhDenpyoData.EDANO)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENSYSKBN)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.HURIDENATESAKICD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.TANTOCD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENYMD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.TAISYAKUKBN)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.KANJYOUKMKCD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SUITOUBUMONCD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.TUUKASYU)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENKAWASERATE)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.HURIDENSKSKBN)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENHNKNHOUKBN)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENSHRHOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDenpyoData.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SYORICD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SYORISOSIKICD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SEG1CD)
    ...
    @Type(type="UserType_C_Segcd")
    @Column(name=GenIT_BAK_KhDenpyoData.SEG2CD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.KAKOKAWASERATESHITEIFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDenpyoData.KAKOKAWASERATESHITEIYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenIT_BAK_KhDenpyoData.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENGYOUMUCD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SYUSYOUHNCD)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.SYOUHNSDNO)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.KAWASETEKIYOKBN)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENKARIKANJYONO)
    @Length(length=5)
    @Digit
    ...
    @Type(type="BooleanType")
    @Column(name=GenIT_BAK_KhDenpyoData.TAISYAKUTYOUSEIFLG)
    ...
    @Column(name=GenIT_BAK_KhDenpyoData.DENSYORISYOUSAIKBN)
