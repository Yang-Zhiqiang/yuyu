...
import yuyu.def.db.id.PKIT_BAK_KykSyouhn;
...
/**
 * 契約商品バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KykSyouhn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KykSyouhn}</td><td colspan="3">契約商品バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_KykSyouhn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_KykSyouhn
 * @see     QIT_BAK_KykSyouhn
 * @see     GenQIT_BAK_KykSyouhn
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KykSyouhn.TABLE_NAME)
@IdClass(value=PKIT_BAK_KykSyouhn.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KykSyouhn extends AbstractExDBEntity<IT_BAK_KykSyouhn, PKIT_BAK_KykSyouhn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KykSyouhn";
    ...
    private final PKIT_BAK_KykSyouhn primaryKey;

    public GenIT_BAK_KykSyouhn() {
        primaryKey = new PKIT_BAK_KykSyouhn();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KykSyouhn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KykSyouhn> getMetaClass() {
        return QIT_BAK_KykSyouhn.class;
    }

    @Id
    @Column(name=GenIT_BAK_KykSyouhn.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhn.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhn.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhn.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhn.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_KykSyouhn.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.KYKYMD)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KYKYMDSITEIUMUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.GANSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.HKSKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.HKGANSKNNKAISIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KYKNEN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KykSyouhn.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.PMNJTKKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.RYOURITUSDNO)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.NKSYUKBN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.NENKINKKN)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.YENDTHNKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.SETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.KYKJISISUURENDOURATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.TMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.TUMITATERIRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.TMTTKNHAIBUNJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.SISUUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSyouhn.GSBUNRIKZKAKUNINUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenIT_BAK_KykSyouhn.GSBUNRITAISYOU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KykSyouhn.TMTTKNITENYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.LOADINGHNKGTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.RENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KykSyouhn.TEIKISHRRITU)
    ...
    @Column(name=GenIT_BAK_KykSyouhn.DAI1HKNKKN)
    @Range(min="0", max="99")
