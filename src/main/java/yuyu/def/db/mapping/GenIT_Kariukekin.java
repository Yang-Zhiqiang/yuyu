...
import yuyu.def.db.id.PKIT_Kariukekin;
...
/**
 * 仮受金テーブル テーブルのマッピング情報クラスで、 {@link IT_Kariukekin} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_Kariukekin}</td><td colspan="3">仮受金テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_Kariukekin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_Kariukekin ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getKrkno krkno}</td><td>仮受番号</td><td align="center">{@link PKIT_Kariukekin ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_Kariukekin.TABLE_NAME)
@IdClass(value=PKIT_Kariukekin.class)
@TypeDefs({
...
public abstract class GenIT_Kariukekin extends AbstractExDBEntity<IT_Kariukekin, PKIT_Kariukekin> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_Kariukekin";
    ...
    private final PKIT_Kariukekin primaryKey;

    public GenIT_Kariukekin() {
        primaryKey = new PKIT_Kariukekin();
    }
    ...
    @Transient
    @Override
    public PKIT_Kariukekin getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_Kariukekin> getMetaClass() {
        return QIT_Kariukekin.class;
    }

    @Id
    @Column(name=GenIT_Kariukekin.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_Kariukekin.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_Kariukekin.KRKNO)
    ...
    @Column(name=GenIT_Kariukekin.KRKKEIJYOYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_Kariukekin.HASSEIDENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_Kariukekin.SEISANDENYMD)
    ...
    @Column(name=GenIT_Kariukekin.KRKSEISANZUMIFLG)
    ...
    @Column(name=GenIT_Kariukekin.KRKRIYUUKBN)
    ...
    @Column(name=GenIT_Kariukekin.NYKNAIYOUKBN)
    ...
    @Column(name=GenIT_Kariukekin.NYKKEIRO)
    ...
    @Column(name=GenIT_Kariukekin.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_Kariukekin.JYUTOUKAISUUY)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_Kariukekin.JYUTOUKAISUUM)
    @Range(min="0", max="12")
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_Kariukekin.RYOSYUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_Kariukekin.HRKKAISUU)
    ...
    @Column(name=GenIT_Kariukekin.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_Kariukekin.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_Kariukekin.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_Kariukekin.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_Kariukekin.CREDITKESSAIYOUNO)
