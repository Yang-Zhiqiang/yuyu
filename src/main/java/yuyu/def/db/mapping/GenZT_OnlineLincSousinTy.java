...
/**
 * オンラインＬＩＮＣ送信ファイルテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_OnlineLincSousinTy} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtyrecordsyubetukbn ztyrecordsyubetukbn}</td><td>（中継用）レコード種別区分</td><td align="center">{@link PKZT_OnlineLincSousinTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtykykkanrino ztykykkanrino}</td><td>（中継用）契約管理番号</td><td align="center">{@link PKZT_OnlineLincSousinTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_OnlineLincSousinTy.TABLE_NAME)
@IdClass(value=PKZT_OnlineLincSousinTy.class)
public abstract class GenZT_OnlineLincSousinTy extends AbstractExDBEntity<ZT_OnlineLincSousinTy, PKZT_OnlineLincSousinTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_OnlineLincSousinTy";
    ...
    private final PKZT_OnlineLincSousinTy primaryKey;

    public GenZT_OnlineLincSousinTy() {
        primaryKey = new PKZT_OnlineLincSousinTy();
    }

    public GenZT_OnlineLincSousinTy(String pZtyrecordsyubetukbn, String pZtykykkanrino) {
        primaryKey = new PKZT_OnlineLincSousinTy(pZtyrecordsyubetukbn, pZtykykkanrino);
    }

    @Transient
    @Override
    public PKZT_OnlineLincSousinTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_OnlineLincSousinTy> getMetaClass() {
        return QZT_OnlineLincSousinTy.class;
    }

    private String ztydatakbn;

    @Column(name=GenZT_OnlineLincSousinTy.ZTYDATAKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineLincSousinTy.ZTYRECORDSYUBETUKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHENKOUTYPE)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSYORIKEKKACD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSYORIKEKKAERRJIYUU)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSYORIKEKKAERRNO)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYNAYOSERECORDSUU)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKANYUUSYANO)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYOUKAISIYOUKNNM)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHHKNSEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKSYHHKNSYDOUITUHYOUJI)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSOUSINMOTOKAISYACD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHHKNADRKN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSIGINYUINTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSPPINYUINTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSIJNBYUTKYKNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSONOTATOKUYAKUNTGKSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYTRKMOUSIDEYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYLINCSYORIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYYUYUSIYOUKNNM)
    ...
    @Id
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKKANRINO)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHOZENYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKKNNM)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHUTUUSBSSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYSGSBSTR)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKAKUSYASIYOURAN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYMOUSIDEFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYMOUSIDEFLGSETYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYMOUSIDEFLGKAIJYOYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYJGYHKNFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYTNKNFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKSYASEIKBN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKSYASEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKADRKN)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYYOBIV17)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKNJHHKNMEI30)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKJKYKNM30)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTY15SAI1000MANFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKJHNGFLG)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYKYKYTYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYHOZENYTYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTY15MIMANTKHUKAYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTY15MIMANTKHUKAYOTEIYMD)
    ...
    @Column(name=GenZT_OnlineLincSousinTy.ZTYYOBIV46)
