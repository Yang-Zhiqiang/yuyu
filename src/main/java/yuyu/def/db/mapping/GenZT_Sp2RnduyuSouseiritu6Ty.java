...
/**
 * ＳＰ２連動用総成立Fテーブル６（中） テーブルのマッピング情報クラスで、 {@link ZT_Sp2RnduyuSouseiritu6Ty} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtyktgysyono ztyktgysyono}</td><td>（中継用）結合用証券番号</td><td align="center">{@link PKZT_Sp2RnduyuSouseiritu6Ty ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_Sp2RnduyuSouseiritu6Ty.TABLE_NAME)
@IdClass(value=PKZT_Sp2RnduyuSouseiritu6Ty.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Sp2RnduyuSouseiritu6Ty extends AbstractExDBEntity<ZT_Sp2RnduyuSouseiritu6Ty, PKZT_Sp2RnduyuSouseiritu6Ty> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Sp2RnduyuSouseiritu6Ty";
    ...
    private final PKZT_Sp2RnduyuSouseiritu6Ty primaryKey;

    public GenZT_Sp2RnduyuSouseiritu6Ty() {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu6Ty();
    }

    public GenZT_Sp2RnduyuSouseiritu6Ty(String pZtyktgysyono) {
        primaryKey = new PKZT_Sp2RnduyuSouseiritu6Ty(pZtyktgysyono);
    }

    @Transient
    @Override
    public PKZT_Sp2RnduyuSouseiritu6Ty getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Sp2RnduyuSouseiritu6Ty> getMetaClass() {
        return QZT_Sp2RnduyuSouseiritu6Ty.class;
    }

    private String ztyktgysyrymd;

    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKTGYSYONO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKTGYFILERENNO)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYGAIKAKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSIBOUHYOUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYHTNKNKYKLIVEONEARHYJ)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYLIVEONEPACKAGESYOUHINKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYHTNKNGUKISISTTKKNSNP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSISUUKBN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSUURIYOUYOBIN10X3)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKYKYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYRENDOURITU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYYOBIN5)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYYOBIN5X2)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYYOBIV10X6)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYTIRTTMTTTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYNKSJITIRTTMTTKN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYNENDOMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_Sp2RnduyuSouseiritu6Ty.ZTYYOBIV16)
