...
import yuyu.def.db.id.PKHT_BAK_SkDenpyoData;
import yuyu.def.db.meta.GenQHT_BAK_SkDenpyoData;
...
/**
 * 新契約伝票データバックアップテーブル テーブルのマッピング情報クラスで、 {@link HT_BAK_SkDenpyoData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BAK_SkDenpyoData}</td><td colspan="3">新契約伝票データバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDenrenno denrenno}</td><td>伝票データ連番</td><td align="center">{@link PKHT_BAK_SkDenpyoData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKHT_BAK_SkDenpyoData ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getEdano edano}</td><td>枝番号</td><td align="center">{@link PKHT_BAK_SkDenpyoData ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     HT_BAK_SkDenpyoData
 * @see     PKHT_BAK_SkDenpyoData
 * @see     QHT_BAK_SkDenpyoData
 * @see     GenQHT_BAK_SkDenpyoData
 */
@MappedSuperclass
@Table(name=GenHT_BAK_SkDenpyoData.TABLE_NAME)
@IdClass(value=PKHT_BAK_SkDenpyoData.class)
@TypeDefs({
...
public abstract class GenHT_BAK_SkDenpyoData extends AbstractExDBEntity<HT_BAK_SkDenpyoData, PKHT_BAK_SkDenpyoData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BAK_SkDenpyoData";
    ...
    private final PKHT_BAK_SkDenpyoData primaryKey;

    public GenHT_BAK_SkDenpyoData() {
        primaryKey = new PKHT_BAK_SkDenpyoData();
    }
    ...
    @Transient
    @Override
    public PKHT_BAK_SkDenpyoData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BAK_SkDenpyoData> getMetaClass() {
        return QHT_BAK_SkDenpyoData.class;
    }

    @Id
    @Column(name=GenHT_BAK_SkDenpyoData.DENRENNO)
    ...
    @Id
    @Column(name=GenHT_BAK_SkDenpyoData.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenHT_BAK_SkDenpyoData.EDANO)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENSYSKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.HURIDENATESAKICD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.TANTOCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENYMD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.TAISYAKUKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.KANJYOUKMKCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SUITOUBUMONCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.TUUKASYU)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENKAWASERATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SYORICD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SYORISOSIKICD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SEG1CD)
    ...
    @Type(type="UserType_C_Segcd")
    @Column(name=GenHT_BAK_SkDenpyoData.SEG2CD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.KESSANTYOUSEIKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.NAIBUKEIYAKUKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.TEKIYOUKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENSYORIKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.AATSUKAISHASUITOSOSHIKICD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.HNKNRIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.FSTPRYOSYUYMD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.BOSYUUYM)
    @ValidDateYm
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.MOSYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.SKNNKAISIYMD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SYUSYOUHNCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.RYOURITUSDNO)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.HRKKAISUU)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.HRKKEIRO)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SDPDKBN)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.AATSUKAISHASOSHIKICD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.AATKISYADAIBOSYUUCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.AATKISYABOSYUUCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.KAKOKAWASERATESHITEIFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SkDenpyoData.KAKOKAWASERATESHITEIYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenHT_BAK_SkDenpyoData.KYKTUUKASYU)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENGYOUMUCD)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.SYOUHNSDNO)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.DENKARIKANJYONO)
    @Length(length=5)
    @Digit
    ...
    @Type(type="BooleanType")
    @Column(name=GenHT_BAK_SkDenpyoData.TAISYAKUTYOUSEIFLG)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BAK_SkDenpyoData.GYOUMUKOUSINTIME)
