...
/**
 * 利差配当商品用Ｄレートテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RisaHitSyouhnyouRatedRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnhknsyukigou zrnhknsyukigou}</td><td>（連携用）保険種類記号</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhknsyuruikigousedaikbn zrnhknsyuruikigousedaikbn}</td><td>（連携用）保険種類記号世代区分</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyoteiriritu zrnyoteiriritu}</td><td>（連携用）予定利率</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnpmenkbn zrnpmenkbn}</td><td>（連携用）Ｐ免区分</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhrkkaisuukbn zrnhrkkaisuukbn}</td><td>（連携用）払込回数区分</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhhknsei zrnhhknsei}</td><td>（連携用）被保険者性別</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkeiyakujihhknnen zrnkeiyakujihhknnen}</td><td>（連携用）契約時被保険者年令</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsaimnkkykhyj zrnsaimnkkykhyj}</td><td>（連携用）才満期契約表示</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnhknkkn zrnhknkkn}</td><td>（連携用）保険期間</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnphrkkikn zrnphrkkikn}</td><td>（連携用）Ｐ払込期間</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrndnendo zrndnendo}</td><td>（連携用）Ｄ年度</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnnaiteikakuteikbn zrnnaiteikakuteikbn}</td><td>（連携用）Ｄレート内定確定区分</td><td align="center">{@link PKZT_RisaHitSyouhnyouRatedRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RisaHitSyouhnyouRatedRn.TABLE_NAME)
@IdClass(value=PKZT_RisaHitSyouhnyouRatedRn.class)
public abstract class GenZT_RisaHitSyouhnyouRatedRn extends AbstractExDBEntityForZDB<ZT_RisaHitSyouhnyouRatedRn, PKZT_RisaHitSyouhnyouRatedRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RisaHitSyouhnyouRatedRn";
    ...
    private final PKZT_RisaHitSyouhnyouRatedRn primaryKey;

    public GenZT_RisaHitSyouhnyouRatedRn() {
        primaryKey = new PKZT_RisaHitSyouhnyouRatedRn();
    }
    ...
    @Transient
    @Override
    public PKZT_RisaHitSyouhnyouRatedRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RisaHitSyouhnyouRatedRn> getMetaClass() {
        return QZT_RisaHitSyouhnyouRatedRn.class;
    }

    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNHKNSYUKIGOU)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNYOTEIRIRITU)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNPMENKBN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNHRKKAISUUKBN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNHHKNSEI)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNKEIYAKUJIHHKNNEN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNSAIMNKKYKHYJ)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNHKNKKN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNPHRKKIKN)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDNENDO)
    ...
    @Id
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNNAITEIKAKUTEIKBN)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE00)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE01)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE02)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE03)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE04)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE05)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE06)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE07)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE08)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE09)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE10)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE11)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE12)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE13)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE14)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE15)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE16)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE17)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE18)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE19)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE20)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE21)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE22)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE23)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE24)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE25)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE26)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE27)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE28)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE29)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE30)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE31)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE32)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE33)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE34)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE35)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE36)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE37)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE38)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE39)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE40)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE41)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE42)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE43)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE44)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE45)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE46)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE47)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE48)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE49)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE50)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE51)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE52)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE53)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE54)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE55)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE56)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE57)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE58)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE59)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE60)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE61)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE62)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE63)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE64)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE65)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE66)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE67)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE68)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE69)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE70)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE71)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE72)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE73)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE74)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE75)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE76)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE77)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE78)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE79)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE80)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE81)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE82)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE83)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE84)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE85)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE86)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE87)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE88)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE89)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE90)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE91)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE92)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE93)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE94)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE95)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE96)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE97)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE98)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDRATE99)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE00)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE01)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE02)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE03)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE04)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE05)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE06)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE07)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE08)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE09)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE10)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE11)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE12)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE13)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE14)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE15)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE16)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE17)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE18)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE19)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE20)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE21)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE22)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE23)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE24)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE25)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE26)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE27)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE28)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE29)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE30)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE31)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE32)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE33)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE34)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE35)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE36)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE37)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE38)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE39)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE40)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE41)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE42)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE43)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE44)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE45)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE46)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE47)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE48)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE49)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE50)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE51)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE52)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE53)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE54)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE55)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE56)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE57)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE58)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE59)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE60)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE61)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE62)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE63)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE64)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE65)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE66)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE67)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE68)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE69)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE70)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE71)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE72)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE73)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE74)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE75)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE76)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE77)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE78)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE79)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE80)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE81)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE82)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE83)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE84)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE85)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE86)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE87)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE88)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE89)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE90)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE91)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE92)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE93)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE94)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE95)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE96)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE97)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE98)
    ...
    @Column(name=GenZT_RisaHitSyouhnyouRatedRn.ZRNDYOUVRATE99)
