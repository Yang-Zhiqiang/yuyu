...
/**
 * 通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusQuartTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_TjHitsyyugkNplusQuartTy}</td><td colspan="3">通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusQuartTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_TjHitsyyugkNplusQuartTy
 * @see     PKZT_TjHitsyyugkNplusQuartTy
 * @see     QZT_TjHitsyyugkNplusQuartTy
 * @see     GenQZT_TjHitsyyugkNplusQuartTy
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusQuartTy.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusQuartTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusQuartTy extends AbstractExDBEntity<ZT_TjHitsyyugkNplusQuartTy, PKZT_TjHitsyyugkNplusQuartTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusQuartTy";
    ...
    private final PKZT_TjHitsyyugkNplusQuartTy primaryKey;

    public GenZT_TjHitsyyugkNplusQuartTy() {
        primaryKey = new PKZT_TjHitsyyugkNplusQuartTy();
    }

    public GenZT_TjHitsyyugkNplusQuartTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusQuartTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusQuartTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusQuartTy> getMetaClass() {
        return QZT_TjHitsyyugkNplusQuartTy.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusQuartTy.ZTYTOKUYAKUKOUMOKUV180X50)
