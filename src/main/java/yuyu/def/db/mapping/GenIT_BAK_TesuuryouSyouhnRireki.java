...
import yuyu.def.db.id.PKIT_BAK_TesuuryouSyouhnRireki;
...
/**
 * 手数料情報商品履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_TesuuryouSyouhnRireki} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTsrysyorikbn tsrysyorikbn}</td><td>手数料処理区分</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_TsrysyoriKbn}</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_TesuuryouSyouhnRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_BAK_TesuuryouSyouhnRireki
 * @see     QIT_BAK_TesuuryouSyouhnRireki
 * @see     GenQIT_BAK_TesuuryouSyouhnRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_TesuuryouSyouhnRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_TesuuryouSyouhnRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_TesuuryouSyouhnRireki extends AbstractExDBEntity<IT_BAK_TesuuryouSyouhnRireki, PKIT_BAK_TesuuryouSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_TesuuryouSyouhnRireki";
    ...
    private final PKIT_BAK_TesuuryouSyouhnRireki primaryKey;

    public GenIT_BAK_TesuuryouSyouhnRireki() {
        primaryKey = new PKIT_BAK_TesuuryouSyouhnRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_TesuuryouSyouhnRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_TesuuryouSyouhnRireki> getMetaClass() {
        return QIT_BAK_TesuuryouSyouhnRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.TSRYSYORIKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.RENNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKSYOUHNRENNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.YUUKOUSYOUMETUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYOUMETUJIYUU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYOUMETUYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SKNNKAISIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.GANSKNNKAISIYMD)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HKNKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HRKKKNSMNKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKNEN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HHKNNEN)
    @NaturalNumber
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HHKNSEI)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HARAIMANYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.HKNKKNMANRYOUYMD)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYHGNDKATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.SYUKYHKINKATAKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KHNKYHKGBAIRITUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.ROKUDAILDKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.PMNJTKKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKTUUKASYU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.RYOURITUSDNO)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.YOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.YOTEIRRTHENDOHOSYURRT)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.YTIRRTHNDMNSKAISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.KYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.NKSYUKBN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.NENKINKKN)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.NKGNSHOSYOURITU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_TesuuryouSyouhnRireki.GYOUMUKOUSINTIME)
