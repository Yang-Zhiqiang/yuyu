...
/**
 * 契約保全Ｄ支払統計バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_KhDshrTuki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_KhDshrTuki}</td><td colspan="3">契約保全Ｄ支払統計バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDshrtoukeisikibetukey dshrtoukeisikibetukey}</td><td>Ｄ支払統計識別キー</td><td align="center">{@link PKIT_BAK_KhDshrTuki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_KhDshrTuki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_KhDshrTuki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_KhDshrTuki
 * @see     PKIT_BAK_KhDshrTuki
 * @see     QIT_BAK_KhDshrTuki
 * @see     GenQIT_BAK_KhDshrTuki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_KhDshrTuki.TABLE_NAME)
@IdClass(value=PKIT_BAK_KhDshrTuki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_KhDshrTuki extends AbstractExDBEntity<IT_BAK_KhDshrTuki, PKIT_BAK_KhDshrTuki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_KhDshrTuki";
    ...
    private final PKIT_BAK_KhDshrTuki primaryKey;

    public GenIT_BAK_KhDshrTuki() {
        primaryKey = new PKIT_BAK_KhDshrTuki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_KhDshrTuki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_KhDshrTuki> getMetaClass() {
        return QIT_BAK_KhDshrTuki.class;
    }

    @Id
    @Column(name=GenIT_BAK_KhDshrTuki.DSHRTOUKEISIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_KhDshrTuki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_KhDshrTuki.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.RENNO)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.SYORIKBN)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.HRKKEIRO)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.SYOUHNSDNO)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.KYKJYOUTAI)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.SYOUMETUJIYUU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.KYKYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.YENDTHNKYMD)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.YOTEIRIRITU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.DENYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.CALCKIJYUNYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.SYORIYMD2)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.JKIPJYTYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.KINOUBETUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhDshrTuki.GENGKWARI)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.DKEISANNAITEIKAKUTEIKBN)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.HAITOUNENDO)
    ...
    @Type(type="BizDateYType")
    @Column(name=GenIT_BAK_KhDshrTuki.HAITOUNENDO2)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.HAITOUKINSKSKBN)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.HAITOUMEISAIKBN)
    ...
    @Type(type="BizDateYType")
    @Column(name=GenIT_BAK_KhDshrTuki.FSTKARIWARIATEDNENDO)
    ...
    @Type(type="UserType_C_NaiteiKakuteiKbn")
    @Column(name=GenIT_BAK_KhDshrTuki.NAITEIKAKUTEIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.KARIWARIATEDSHRYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.TUMITATEDTUMITATEYMD)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.TUMITATEDSKSKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_KhDshrTuki.TUMITATEDSHRKRKYMD)
    ...
    @Type(type="UserType_C_NaiteiKakuteiKbn")
    @Column(name=GenIT_BAK_KhDshrTuki.NAITEIKAKUTEIKBN2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhDshrTuki.KARIWARIATEDRIRITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhDshrTuki.KARIWARIATEDRIRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhDshrTuki.TUMITATEDRIRITU1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_BAK_KhDshrTuki.TUMITATEDRIRITU2)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_KhDshrTuki.GYOUMUKOUSINTIME)
