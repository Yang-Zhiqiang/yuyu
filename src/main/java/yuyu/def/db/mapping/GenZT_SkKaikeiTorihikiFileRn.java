...
/**
 * 新契約会計取引ファイルテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkKaikeiTorihikiFileRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKaikeiTorihikiFileRn}</td><td colspan="3">新契約会計取引ファイルテーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymd zrntorihikiymd}</td><td>（連携用）取引年月日</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinon7 zrntorihikinon7}</td><td>（連携用）取引番号Ｎ７</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntaisyakukbnn zrntaisyakukbnn}</td><td>（連携用）貸借区分（数値）</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkanjyoukamokucdn zrnkanjyoukamokucdn}</td><td>（連携用）勘定科目コード（数値）</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnyobiv4 zrnyobiv4}</td><td>（連携用）予備項目Ｖ４</td><td align="center">&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnsuitoubumon zrnsuitoubumon}</td><td>（連携用）出納部門</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrnkingaku zrnkingaku}</td><td>（連携用）金額</td><td align="center">&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>{@link #getZrntekiyoucd zrntekiyoucd}</td><td>（連携用）摘要コード</td><td align="center">{@link PKZT_SkKaikeiTorihikiFileRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkKaikeiTorihikiFileRn
 * @see     PKZT_SkKaikeiTorihikiFileRn
 * @see     QZT_SkKaikeiTorihikiFileRn
 * @see     GenQZT_SkKaikeiTorihikiFileRn
 */
@MappedSuperclass
@Table(name=GenZT_SkKaikeiTorihikiFileRn.TABLE_NAME)
@IdClass(value=PKZT_SkKaikeiTorihikiFileRn.class)
public abstract class GenZT_SkKaikeiTorihikiFileRn extends AbstractExDBEntityForZDB<ZT_SkKaikeiTorihikiFileRn, PKZT_SkKaikeiTorihikiFileRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKaikeiTorihikiFileRn";
    ...
    private final PKZT_SkKaikeiTorihikiFileRn primaryKey;

    public GenZT_SkKaikeiTorihikiFileRn() {
        primaryKey = new PKZT_SkKaikeiTorihikiFileRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKaikeiTorihikiFileRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKaikeiTorihikiFileRn> getMetaClass() {
        return QZT_SkKaikeiTorihikiFileRn.class;
    }

    private String zrnlen;

    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNLEN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKAIKEITANI)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNSYSTEMKBNNUM)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNSYORICD)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTORIHIKIYMD)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTORIHIKINON7)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNNYUURYOKUBASYO)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNNYUURYOKUSYACD)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNSYORIYMDN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNSIMEKIRIKBN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKESSANKBN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNYOBIV20)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKAISYAKANTORIHIKIKBN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTUKEKAEKBN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTABLEKOSUU)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKANJYOUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTAISYAKUKBNN)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKANJYOUKAMOKUCDN)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNYOBIV4)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNSUITOUBUMON)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNKINGAKU)
    ...
    @Id
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNTEKIYOUCD)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_SkKaikeiTorihikiFileRn.ZRNMEISAIKANRYOUKBN)
