...
/**
 * 支払調書ビュー テーブルのマッピング情報クラスで、 {@link BV_SiharaiTyousyo} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BV_SiharaiTyousyo}</td><td colspan="3">支払調書ビュー</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSubSystemId subSystemId}</td><td>サブシステムＩＤ</td><td align="center">{@link PKBV_SiharaiTyousyo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKBV_SiharaiTyousyo ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKBV_SiharaiTyousyo ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getShrtysyrenno shrtysyrenno}</td><td>支払調書連番</td><td align="center">{@link PKBV_SiharaiTyousyo ○}</td><td align="center">N</td><td>Long</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenBV_SiharaiTyousyo.TABLE_NAME)
@IdClass(value=PKBV_SiharaiTyousyo.class)
@TypeDefs({
...
public abstract class GenBV_SiharaiTyousyo extends AbstractExDBEntity<BV_SiharaiTyousyo, PKBV_SiharaiTyousyo> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BV_SiharaiTyousyo";
    ...
    private final PKBV_SiharaiTyousyo primaryKey;

    public GenBV_SiharaiTyousyo() {
        primaryKey = new PKBV_SiharaiTyousyo();
    }
    ...
    @Transient
    @Override
    public PKBV_SiharaiTyousyo getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBV_SiharaiTyousyo> getMetaClass() {
        return QBV_SiharaiTyousyo.class;
    }

    @Id
    @Column(name=GenBV_SiharaiTyousyo.SUBSYSTEMID)
    ...
    @Id
    @Column(name=GenBV_SiharaiTyousyo.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenBV_SiharaiTyousyo.TYOUHYOUYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYRENNO)
    ...
    @Column(name=GenBV_SiharaiTyousyo.KACD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.TANTOCD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HKNSYUKIGOU)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenBV_SiharaiTyousyo.HRKKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenBV_SiharaiTyousyo.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenBV_SiharaiTyousyo.KYKNEN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBV_SiharaiTyousyo.KYKYMD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HHKNSEI)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HRKKAISUU)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HRKKEIRO)
    ...
    @Column(name=GenBV_SiharaiTyousyo.ANNAIHUYOURIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBV_SiharaiTyousyo.KOURYOKUHASSEIYMD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.MFADRSIYOUHYOUJI)
    ...
    @Column(name=GenBV_SiharaiTyousyo.KIHRPDMISEIBIDISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.KIHRPSEIBIYOUDISP)
    ...
    @Type(type="BizDateType")
    @Column(name=GenBV_SiharaiTyousyo.SHRYMD)
    @ValidDate
    ...
    @Column(name=GenBV_SiharaiTyousyo.SYORISOSIKICD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SYORITAISYOUKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYTSINYNO)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYADR1KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYADR2KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYADR3KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.KJDAIHYOUUKTNM)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYSYURUICD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.TEKNJIKIHRPSEIBIDISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.ONLINECENTERCUTKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRHOUSITEIKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HTYKEIHIHNSYUKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.TOUDUKETORIHOUHOUKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.NENKINKKN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenBV_SiharaiTyousyo.BANKNMKN)
    @MaxLength(max=25)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBV_SiharaiTyousyo.SITENNMKN)
    @MaxLength(max=25)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.YOKINKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.YOKINKNMKN)
    @HostInvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBV_SiharaiTyousyo.SAKUSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBV_SiharaiTyousyo.KYKMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBV_SiharaiTyousyo.UKTMNMEIGIBANGOU)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBV_SiharaiTyousyo.JIGYOUKYKMNDANTAICD)
    ...
    @Column(name=GenBV_SiharaiTyousyo.MNSAIANNAIHNSKAKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.HUHO2KYKDISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYHKNSYUKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRTYSYKURIKOSIDISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBV_SiharaiTyousyo.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.SYNYHSJYKYKNDISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.TBLSAKUSEIHUNODISP)
    ...
    @Column(name=GenBV_SiharaiTyousyo.DAIHYOUKTKBN)
    ...
    @Column(name=GenBV_SiharaiTyousyo.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenBV_SiharaiTyousyo.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenBV_SiharaiTyousyo.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenBV_SiharaiTyousyo.OLDTSINYNO)
    ...
    @Column(name=GenBV_SiharaiTyousyo.OLDTSINADR1KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.OLDTSINADR2KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.OLDTSINADR3KJ)
    ...
    @Column(name=GenBV_SiharaiTyousyo.OLDKYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBV_SiharaiTyousyo.KYKHNKKAISUU)
    ...
    @Column(name=GenBV_SiharaiTyousyo.SHRKYKHTYKEIHIYOUHYJ)
