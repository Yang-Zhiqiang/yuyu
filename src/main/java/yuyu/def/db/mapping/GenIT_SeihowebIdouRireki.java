...
import yuyu.def.db.id.PKIT_SeihowebIdouRireki;
import yuyu.def.db.meta.GenQIT_SeihowebIdouRireki;
...
/**
 * 生保Ｗｅｂ用異動履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_SeihowebIdouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_SeihowebIdouRireki}</td><td colspan="3">生保Ｗｅｂ用異動履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_SeihowebIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_SeihowebIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_SeihowebIdouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_SeihowebIdouRireki
 * @see     PKIT_SeihowebIdouRireki
 * @see     QIT_SeihowebIdouRireki
 * @see     GenQIT_SeihowebIdouRireki
 */
@MappedSuperclass
@Table(name=GenIT_SeihowebIdouRireki.TABLE_NAME)
@IdClass(value=PKIT_SeihowebIdouRireki.class)
@TypeDefs({
...
public abstract class GenIT_SeihowebIdouRireki extends AbstractExDBEntity<IT_SeihowebIdouRireki, PKIT_SeihowebIdouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_SeihowebIdouRireki";
    ...
    private final PKIT_SeihowebIdouRireki primaryKey;

    public GenIT_SeihowebIdouRireki() {
        primaryKey = new PKIT_SeihowebIdouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_SeihowebIdouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_SeihowebIdouRireki> getMetaClass() {
        return QIT_SeihowebIdouRireki.class;
    }

    @Id
    @Column(name=GenIT_SeihowebIdouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_SeihowebIdouRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_SeihowebIdouRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.IDOUHASSEIYM)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.IDOUHASSEIYMD)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.SEIHOWEBIDOUKBNNAIYOU1)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.SEIHOWEBIDOUKBNNAIYOU2)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.DAIRITENCD1)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_SeihowebIdouRireki.BOSYUUCD1)
    @MaxLength(max=6)
    @AlphaDigit
    ...
    @Column(name=GenIT_SeihowebIdouRireki.DRTENBUNUMU)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.DAIRITENCD2)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_SeihowebIdouRireki.BOSYUUCD2)
    @MaxLength(max=6)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_SeihowebIdouRireki.HRKKAISUU)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.TIKIKTBRISYURUIKBN)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.HRKKEIRO)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_SeihowebIdouRireki.BOSYUUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_SeihowebIdouRireki.CIFCD)
    @MaxLength(max=15)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_SeihowebIdouRireki.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_SeihowebIdouRireki.JKIPJYTYM)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_SeihowebIdouRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Column(name=GenIT_SeihowebIdouRireki.SYOUHNSDNO)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_SeihowebIdouRireki.KYKYMD)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.TUUKASYU)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_SeihowebIdouRireki.GYOUMUKOUSINTIME)
