...
import yuyu.def.db.id.PKHT_SouseirituKihon;
...
/**
 * 総成立基本テーブル テーブルのマッピング情報クラスで、 {@link HT_SouseirituKihon} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_SouseirituKihon}</td><td colspan="3">総成立基本テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKHT_SouseirituKihon ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getKzktrkservicekbn kzktrkservicekbn}</td><td>ご家族登録サービス区分</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKHT_SouseirituKihon
 * @see     QHT_SouseirituKihon
 * @see     GenQHT_SouseirituKihon
 */
@MappedSuperclass
@Table(name=GenHT_SouseirituKihon.TABLE_NAME)
@IdClass(value=PKHT_SouseirituKihon.class)
@TypeDefs({
...
public abstract class GenHT_SouseirituKihon extends AbstractExDBEntity<HT_SouseirituKihon, PKHT_SouseirituKihon> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_SouseirituKihon";
    ...
    public static final String KZKTRKSERVICEKBN         = "kzktrkservicekbn";
    ...
    private final PKHT_SouseirituKihon primaryKey;

    public GenHT_SouseirituKihon() {
        primaryKey = new PKHT_SouseirituKihon();
    }

    public GenHT_SouseirituKihon(String pSyono) {
        primaryKey = new PKHT_SouseirituKihon(pSyono);
    }

    @Transient
    @Override
    public PKHT_SouseirituKihon getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_SouseirituKihon> getMetaClass() {
        return QHT_SouseirituKihon.class;
    }

    @Id
    @Column(name=GenHT_SouseirituKihon.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_SouseirituKihon.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_SouseirituKihon.AITEMOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_SouseirituKihon.DOUJIKAIYAKUSYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_SouseirituKihon.SEKNO)
    @MaxLength(max=20)
    @AlphaDigit
    ...
    @Column(name=GenHT_SouseirituKihon.PYKKIGENYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.SRSYORIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.RYOSYUYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MOSYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MOSSAKUSEIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MOSCALCKIJYUNYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MOSUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MOSJIMOSUKTYMD)
    ...
    @Column(name=GenHT_SouseirituKihon.MOSYM)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.SSYUKEYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.KKTYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.KYKYMD)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKYMDTKRUMU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.SKYKYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.SKNNKAISIYMD)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_SouseirituKihon.BOSYUUYM)
    @ValidDateYm
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_SouseirituKihon.SEISEKIYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenHT_SouseirituKihon.SKEIKEIJYOUYM)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.HKNSYURUINO)
    ...
    @Column(name=GenHT_SouseirituKihon.HKNSYURUINOSD)
    ...
    @Column(name=GenHT_SouseirituKihon.AISYOUMEIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.NKGNSHOSYOURITUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.LIVHUKAUMU)
    ...
    @Column(name=GenHT_SouseirituKihon.PMNJTKHUKAKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.PMNJTKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SKNNKAISIKITKHUKAKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SKNNKAISIKITKKBN)
    ...
    private String kzktrkservicekbn;

    @Column(name=GenHT_SouseirituKihon.KZKTRKSERVICEKBN)
    public String getKzktrkservicekbn() {
        return kzktrkservicekbn;
    }

    public void setKzktrkservicekbn(String pKzktrkservicekbn) {
        kzktrkservicekbn = pKzktrkservicekbn;
    }

    private C_Tkhukaumu kykdrtkykhukakbn;

    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.KYKDRTKYKHUKAKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.STDRSKTKYHKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SDPDKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SNTKHOUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.HAITOUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.HAITOUKINUKETORIHOUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKTUUKASYU)
    ...
    @Type(type="UserType_C_Tuukasyu")
    @Column(name=GenHT_SouseirituKihon.HRKTUUKASYU)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.YENNYKNTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.GAIKANYKNTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.YENSHRTKHKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.IKKATUBARAIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.IKKATUBARAIKAISUU)
    ...
    @Column(name=GenHT_SouseirituKihon.ZENNOUMOUSIDEUMU)
    ...
    @Column(name=GenHT_SouseirituKihon.ZENKIZENNOUUMU)
    ...
    @Column(name=GenHT_SouseirituKihon.ZNNKAI)
    @Range(min="0", max="999")
    ...
    @Column(name=GenHT_SouseirituKihon.ZNNHRKKAI)
    ...
    @Column(name=GenHT_SouseirituKihon.ZNNHRKKEIRO)
    ...
    @Column(name=GenHT_SouseirituKihon.HRKKAISUU)
    ...
    @Column(name=GenHT_SouseirituKihon.HRKKEIRO)
    ...
    @Column(name=GenHT_SouseirituKihon.FSTPHRKKEIROKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SKJPJYUUTOUKAISUU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.IKKATUYOUPUMUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.IKKATUYOUPKAISUU)
    ...
    @Column(name=GenHT_SouseirituKihon.PWARIBIKITEKIYOUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.DNTRYOURITUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.APLKAHIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.ITIPCLRIYOUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.ITIPRSYMD)
    @ValidDate
    ...
    @Column(name=GenHT_SouseirituKihon.DNTCD)
    @MaxLength(max=8)
    @AlphaDigit
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.MASSISEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNNEN)
    @NaturalNumber
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNSEI)
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNNENSYUUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.TSINDOUSITEIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_SouseirituKihon.HHKNKINMUSAKINM)
    @MaxLength(max=50)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_KjkhukaKbn")
    @Column(name=GenHT_SouseirituKihon.KYKNMKJKHUKAKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_SouseirituKihon.KYKNEN)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKSEI)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKTDK)
    ...
    @Type(type="UserType_C_NensyuuKbn")
    @Column(name=GenHT_SouseirituKihon.KYKNENSYUUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.KYKKINMUSAKINM)
    @MaxLength(max=50)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HJNDAIYKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.HJNDAINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.HJNDAINMKJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.FATCASNSIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.BIKKJNSSINFOKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.BIKKNZSYNO)
    @MaxLength(max=9)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SouseirituKihon.SYOMEIYMD)
    @ValidDate
    ...
    @Column(name=GenHT_SouseirituKihon.AEOISNSIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR1KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR2KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINADR3KN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_SouseirituKihon.DAI2TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenHT_SouseirituKihon.SYOSHADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.SYOSHADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.SYOSHADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.SYOSHTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    ...
    @Column(name=GenHT_SouseirituKihon.SYOSHYNO)
    @Length(length=7)
    @Digit
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.TARGETTKHKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.TARGETTKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.TARGETTKMKHTKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.NSTKHKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.NSTKMNKNSYU)
    ...
    @Column(name=GenHT_SouseirituKihon.NSTKMNKNKKN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_SouseirituKihon.NSTKSBNSYU)
    ...
    @Column(name=GenHT_SouseirituKihon.NSTKSBNKKN)
    @Range(min="0", max="99")
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.SYKSBYENSITIHSYUTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.JYUDKAIGOMEHRTKHKKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.KJNNKPZEITEKITKHUKAKBN)
    ...
    @Type(type="UserType_C_Tkhukaumu")
    @Column(name=GenHT_SouseirituKihon.TEIKISIHARAITKYKHKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SAIHOCD)
    ...
    @Column(name=GenHT_SouseirituKihon.STKNSETKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SBUKTNIN)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_SouseirituKihon.KYKHONNINKAKNINSYORUIKBN)
    ...
    @Type(type="UserType_C_HonninkakuninSyoruiKbn")
    @Column(name=GenHT_SouseirituKihon.SKSKKNHONNINKAKNINSYORUIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.SYOTNSHUYOUPOSTUMUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.UKTKID)
    @Length(length=11)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.BOSKYKJYOUTAI)
    ...
    @Column(name=GenHT_SouseirituKihon.TKKINYUKKNTKRUMU)
    ...
    @Column(name=GenHT_SouseirituKihon.DRCTSERVICEMOSKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.HNSSTJMMOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.KJMEIGIHKHUNOUUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.TSRYHSHRKYKUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.SYOSISYATODOKEUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.KAKUKISYOURYAKUKBUMUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_SouseirituKihon.SEIYMDMOSSEITOUUMUKBN)
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenHT_SouseirituKihon.KOUSEIINKYKTKJKUMUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.KOUKANKYKKINMUSAKINM)
    @MaxLength(max=35)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_SouseirituKihon.KOUKANKYKSYOKUMUNAIYOU)
    @MaxLength(max=35)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="UserType_C_BlnktkumuKbn")
    @Column(name=GenHT_SouseirituKihon.KOUKANKYKTKJKUMUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.KHNCHKCMNT)
    ...
    @Column(name=GenHT_SouseirituKihon.JIMUYOUCD)
    @Length(length=3)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Column(name=GenHT_SouseirituKihon.TEIRITUHAIBUNWARIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.SISUUKBN)
    ...
    @Type(type="UserType_C_TumitatekinHaibunWariKbn")
    @Column(name=GenHT_SouseirituKihon.SISUUHAIBUNWARIKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.TRHKJIKAKKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.KOUREITAIOUKBN)
    ...
    @Column(name=GenHT_SouseirituKihon.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_SouseirituKihon.GYOUMUKOUSINTIME)
