...
import yuyu.def.db.id.PKIT_KhTtdkTyuui;
import yuyu.def.db.meta.GenQIT_KhTtdkTyuui;
...
/**
 * 契約保全手続注意テーブル テーブルのマッピング情報クラスで、 {@link IT_KhTtdkTyuui} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhTtdkTyuui}</td><td colspan="3">契約保全手続注意テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhTtdkTyuui ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhTtdkTyuui ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_KhTtdkTyuui
 * @see     PKIT_KhTtdkTyuui
 * @see     QIT_KhTtdkTyuui
 * @see     GenQIT_KhTtdkTyuui
 */
@MappedSuperclass
@Table(name=GenIT_KhTtdkTyuui.TABLE_NAME)
@IdClass(value=PKIT_KhTtdkTyuui.class)
@TypeDefs({
...
public abstract class GenIT_KhTtdkTyuui extends AbstractExDBEntity<IT_KhTtdkTyuui, PKIT_KhTtdkTyuui> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhTtdkTyuui";
    ...
    private final PKIT_KhTtdkTyuui primaryKey;

    public GenIT_KhTtdkTyuui() {
        primaryKey = new PKIT_KhTtdkTyuui();
    }

    public GenIT_KhTtdkTyuui(String pKbnkey, String pSyono) {
        primaryKey = new PKIT_KhTtdkTyuui(pKbnkey, pSyono);
    }

    @Transient
    @Override
    public PKIT_KhTtdkTyuui getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhTtdkTyuui> getMetaClass() {
        return QIT_KhTtdkTyuui.class;
    }

    @Id
    @Column(name=GenIT_KhTtdkTyuui.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhTtdkTyuui.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUISETYMD)
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUISETNM)
    @MaxLength(max=20)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.KKTYUITAKBN)
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUINAIYOU1)
    @MaxLength(max=40)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUINAIYOU2)
    @MaxLength(max=40)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUINAIYOU3)
    @MaxLength(max=40)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBN1)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBN2)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBN3)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBN4)
    ...
    @Type(type="UserType_C_TtdktyuuiKbn")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBN5)
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNHSKNAIYOU1)
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNHSKNAIYOU2)
    @ValidTextArea(length=30, rows=3)
    @MultiByteStringsReturnable
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNHSKNAIYOU3)
    @ValidTextArea(length=30, rows=3)
    @MultiByteStringsReturnable
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNHSKNAIYOU4)
    @ValidTextArea(length=30, rows=3)
    @MultiByteStringsReturnable
    @InvalidCharacter
    ...
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNHSKNAIYOU5)
    @ValidTextArea(length=30, rows=3)
    @MultiByteStringsReturnable
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNSETYMD1)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNSETYMD2)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNSETYMD3)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNSETYMD4)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhTtdkTyuui.TTDKTYUUIKBNSETYMD5)
    @ValidDate
    ...
    @Column(name=GenIT_KhTtdkTyuui.SETSOSIKICD1)
    ...
    @Column(name=GenIT_KhTtdkTyuui.SETSOSIKICD2)
    ...
    @Column(name=GenIT_KhTtdkTyuui.SETSOSIKICD3)
    ...
    @Column(name=GenIT_KhTtdkTyuui.SETSOSIKICD4)
    ...
    @Column(name=GenIT_KhTtdkTyuui.SETSOSIKICD5)
    ...
    @Column(name=GenIT_KhTtdkTyuui.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhTtdkTyuui.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhTtdkTyuui.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_KhTtdkTyuui.KYKDRKNHATUDOUJYOUTAI)
    ...
    @Column(name=GenIT_KhTtdkTyuui.KYKDRDOUIYOUHI)
