...
import yuyu.def.db.id.PKIT_KykUkt;
...
/**
 * 契約受取人テーブル テーブルのマッピング情報クラスで、 {@link IT_KykUkt} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykUkt}</td><td colspan="3">契約受取人テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykUkt ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykUkt ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getUktsyukbn uktsyukbn}</td><td>受取人種類区分</td><td align="center">{@link PKIT_KykUkt ○}</td><td align="center">V</td><td>{@link C_UktsyuKbn}</td></tr>
 *  <tr><td>{@link #getUktsyurenno uktsyurenno}</td><td>受取人種類別連番</td><td align="center">{@link PKIT_KykUkt ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KykUkt.TABLE_NAME)
@IdClass(value=PKIT_KykUkt.class)
@TypeDefs({
...
public abstract class GenIT_KykUkt extends AbstractExDBEntity<IT_KykUkt, PKIT_KykUkt> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykUkt";
    ...
    private final PKIT_KykUkt primaryKey;

    public GenIT_KykUkt() {
        primaryKey = new PKIT_KykUkt();
    }
    ...
    @Transient
    @Override
    public PKIT_KykUkt getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykUkt> getMetaClass() {
        return QIT_KykUkt.class;
    }

    @Id
    @Column(name=GenIT_KykUkt.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykUkt.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIT_KykUkt.UKTSYUKBN)
    ...
    @Id
    @Column(name=GenIT_KykUkt.UKTSYURENNO)
    ...
    @Column(name=GenIT_KykUkt.KOKNO)
    ...
    @Column(name=GenIT_KykUkt.UKTKBN)
    ...
    @Column(name=GenIT_KykUkt.UKTNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykUkt.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykUkt.UKTNMKJKHUKAKBN)
    ...
    @Column(name=GenIT_KykUkt.UKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykUkt.UKTTDK)
    ...
    @Column(name=GenIT_KykUkt.UKTBNWARI)
    ...
    @Column(name=GenIT_KykUkt.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykUkt.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykUkt.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_KykUkt.UKTYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenIT_KykUkt.UKTADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykUkt.UKTADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KykUkt.UKTADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
