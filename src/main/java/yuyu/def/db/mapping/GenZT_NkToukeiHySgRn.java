...
/**
 * 年金統計Ｆ保有照合用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkToukeiHySgRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkToukeiHySgRn}</td><td colspan="3">年金統計Ｆ保有照合用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_NkToukeiHySgRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_NkToukeiHySgRn
 * @see     PKZT_NkToukeiHySgRn
 * @see     QZT_NkToukeiHySgRn
 * @see     GenQZT_NkToukeiHySgRn
 */
@MappedSuperclass
@Table(name=GenZT_NkToukeiHySgRn.TABLE_NAME)
@IdClass(value=PKZT_NkToukeiHySgRn.class)
public abstract class GenZT_NkToukeiHySgRn extends AbstractExDBEntityForZDB<ZT_NkToukeiHySgRn, PKZT_NkToukeiHySgRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkToukeiHySgRn";
    ...
    private final PKZT_NkToukeiHySgRn primaryKey;

    public GenZT_NkToukeiHySgRn() {
        primaryKey = new PKZT_NkToukeiHySgRn();
    }

    public GenZT_NkToukeiHySgRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_NkToukeiHySgRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_NkToukeiHySgRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkToukeiHySgRn> getMetaClass() {
        return QZT_NkToukeiHySgRn.class;
    }

    @Id
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYSTEMCD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNULFKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNIDOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOUIN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINSYU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNCURRENTDAY)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNCURRENTTIME)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAISIHARAIJITOKUBETUD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAISIHARAIJIKAIMASIS)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAISIHARAIJISONOTAD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYOKAISIHARAIJIMISYUUP)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNIDOUNENKINNENGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSETTEIJIKIKINSOUGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTENKANITIJIBARAINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKASANNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNUWANOSENENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSYUKEIYAKUNENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINSIHARAINAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNITIJIKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKKNSETYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKKAISIGOYOTEIRIRITUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSGOYOTEISIBOURITUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINJIMUTESUURYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTEIZOURITU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMAEATUATOATUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOKUSYUNENKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSIHARAIKAISUUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKGYUNKYUSYKISHRTUKISUU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTEIZOUNKSIBOUJIHKNNENDO)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNDKIGETU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUNENDOD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNENKINYOUSIHARAID)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSIHARAINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSIHARAISYORUIUKETUKEYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSIHARAIUKETUKEBASYO)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSHIHARAIHASSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNHIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNDAI2HIHOKENSYASEIBETUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSJIDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNDAI2HIHOKENSYASIBOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNHHKNSEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNDAI2HIHOKENSYASEIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKHKNHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV1X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV8)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTUUSINSAKIYUUBINNO)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTUUSINSAKITIKUCD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV1X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV1X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV8X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV8X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV59)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X1)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X5)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X6)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X7)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X8)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X9)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X10)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X11)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X12)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X13)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X14)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI1X15)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X1)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X5)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X6)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X7)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X8)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X9)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI2X10)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X1)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X2)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X3)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X4)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X5)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X6)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X7)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X8)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X9)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNNKSYURUIKGUYOBI3X10)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEISYUUSEISYORIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEIMODKURYKHSSIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEIMODDENPYOUYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEIMODBIKINMODKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEIMODBIKINSHRYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUKEIMODBIKINKIJYUGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNBIKINNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNBIKINKEIYAKUJYOUKYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINENKINARIHYOUJI)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMAEATUATOATUSEGARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZAIKEIYUATATKIMSNKARIHYJ)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTYOUHYOUSAKUSEITANIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSHRNKGKNAIYOUKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNUTIKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNPITIJIBARAIKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOUKIGSYAYOTISBOURTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYUKIGSYAYOTEIHASSEIRTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYUKIGSYAYOTEISYTGNRTKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNYOBIV17)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINKKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINENKINKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINENKINSYURUIKIGOU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINKSHRKKN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINKHHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKIMSNKDAI2HHKNSYAAGE)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNSAISYUUNENKINKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZENNENDOKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZNZNNNDKAIMASINKZOUGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZNZNZNNNDKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUNENDOKAIMASINENKIND)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASITYUUSIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASIHUKKIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNKAIMASINKKIGOUSDKBN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMAEATUATOATUKOURYOKUSYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMAEATUATOATUKIKAN)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNMAEATUATOATUHENDOUGONKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNATOATUSAISYUUKAIMASIYMD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNATOATUKAIMASINENKINGAKU)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZNZNNNDATOATUKAIMASINKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNZNZNZNNNDATATKIMSNKGK)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNTOUNENDATOATUKAIMASINKD)
    ...
    @Column(name=GenZT_NkToukeiHySgRn.ZRNUWANOSEATOATUKAIMASINKGK)
