...
import yuyu.def.db.id.PKHT_BAK_SyoriCTL;
import yuyu.def.db.meta.GenQHT_BAK_SyoriCTL;
...
/**
 * 処理コントロールバックアップテーブル テーブルのマッピング情報クラスで、 {@link HT_BAK_SyoriCTL} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BAK_SyoriCTL}</td><td colspan="3">処理コントロールバックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_BAK_SyoriCTL ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKHT_BAK_SyoriCTL ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     HT_BAK_SyoriCTL
 * @see     PKHT_BAK_SyoriCTL
 * @see     QHT_BAK_SyoriCTL
 * @see     GenQHT_BAK_SyoriCTL
 */
@MappedSuperclass
@Table(name=GenHT_BAK_SyoriCTL.TABLE_NAME)
@IdClass(value=PKHT_BAK_SyoriCTL.class)
@TypeDefs({
...
public abstract class GenHT_BAK_SyoriCTL extends AbstractExDBEntity<HT_BAK_SyoriCTL, PKHT_BAK_SyoriCTL> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BAK_SyoriCTL";
    ...
    private final PKHT_BAK_SyoriCTL primaryKey;

    public GenHT_BAK_SyoriCTL() {
        primaryKey = new PKHT_BAK_SyoriCTL();
    }

    public GenHT_BAK_SyoriCTL(String pMosno, String pTrkssikibetukey) {
        primaryKey = new PKHT_BAK_SyoriCTL(pMosno, pTrkssikibetukey);
    }

    @Transient
    @Override
    public PKHT_BAK_SyoriCTL getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BAK_SyoriCTL> getMetaClass() {
        return QHT_BAK_SyoriCTL.class;
    }

    @Id
    @Column(name=GenHT_BAK_SyoriCTL.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_BAK_SyoriCTL.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KAISYACD)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSUKETUKEKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSUKTKERRKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.SKEIJIMUKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSNRKUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSNRKVRFJKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSNRKYMD)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KZNRKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KZNRKHBUMU)
    ...
    @Type(type="UserType_C_VrfjkKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KZNRKVRFJKKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.DNTNRKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.SDNNRKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KKTNRKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KKTNRKHBUMU)
    ...
    @Type(type="UserType_C_VrfjkKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KKTNRKVRFJKKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.KKTYMD)
    @ValidDate
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.HJYNRKUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.HJYNRKHBUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.NYKNNRKUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.NYUUKINJOUTAIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.RYOSYUYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.NYKNKWSRATEKIJYUNYMD)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.NYKNKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.AUTHORIKAKYMD)
    @ValidDate
    ...
    @Column(name=GenHT_BAK_SyoriCTL.URIAGESOUSINKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.CREDITTRKJKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.CREDITYUUKOUKAKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSTENKEN1JIYHKBN)
    ...
    @Type(type="UserType_C_MostenkenyhKbn")
    @Column(name=GenHT_BAK_SyoriCTL.MOSTENKEN2JIYHKBN)
    ...
    @Type(type="UserType_C_MostenkenyhKbn")
    @Column(name=GenHT_BAK_SyoriCTL.MOSTENKEN3JIYHKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.MOSTENKENRRKUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MOSTENKENJOUKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KNKYSATEI1JIYHKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KNKYSATEI2JIYHKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KNKYSATEIRRKUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KNKYSATEIJYOUKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.IMUSATEIKANIYHKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.IMUSATEIRRKUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.IMUSATEIJYOUKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.MIHASSINHUBIUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.HUBIKAISYOUJOUTAIKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KTHHBKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.SRHHBKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KHNHBKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KYKKAKJKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KETTEIKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.SATEIJTKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.SATEIZUMIYMD)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.DOUJIMOSUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.PALDOUJIMOSUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.RAYDOUJIMOSUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LINCGTHTKEKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LINCJKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LINCSOUSINFLG)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LINCKKNNJKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LINCDATASOUSINKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.UKTKAKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.TKHJNKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.TKTKHJNKAKUNINYOUHIKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KOUSEIINKYKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KOUKANKYKKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.FATCAKAKKEKKAKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.AEOIKEKKAKBN)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.TKHSYOURYAKUUMUKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.KYKKSKTKANKBN)
    ...
    @Type(type="UserType_C_KsktkanKbn")
    @Column(name=GenHT_BAK_SyoriCTL.HHKNKSKTKANKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.SEIRITUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.SRSYORIYMD)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.MINYKNKURIKOSIUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KETTIENKURIKOSIUMU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.SRHKURIKOSIUMU)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.DAIMOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_BAK_SyoriCTL.MFRENFLG)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.MFRENYMD)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.JIMUSRHKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.SYSSRHKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.ANNAISAKUSEIKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.ANNAIKAISUU)
    ...
    @Type(type="UserType_C_UmuKbn")
    @Column(name=GenHT_BAK_SyoriCTL.TKBTKKTUMU)
    ...
    @Type(type="UserType_C_YouhiKbn")
    @Column(name=GenHT_BAK_SyoriCTL.KANSYOUTUUTIYHKBN)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.LASTKOSSYORICD)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BAK_SyoriCTL.GYOUMUKOUSINTIME)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_BAK_SyoriCTL.YOTEIRIRITUHENKOURENRAKUYMD)
    @ValidDate
