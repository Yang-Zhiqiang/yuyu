...
import yuyu.def.db.id.PKHT_KokutisyoVrf;
...
/**
 * 告知書ベリファイテーブル テーブルのマッピング情報クラスで、 {@link HT_KokutisyoVrf} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_KokutisyoVrf}</td><td colspan="3">告知書ベリファイテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_KokutisyoVrf ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     HT_KokutisyoVrf
 * @see     PKHT_KokutisyoVrf
 * @see     QHT_KokutisyoVrf
 * @see     GenQHT_KokutisyoVrf
 */
@MappedSuperclass
@Table(name=GenHT_KokutisyoVrf.TABLE_NAME)
@IdClass(value=PKHT_KokutisyoVrf.class)
@TypeDefs({
...
public abstract class GenHT_KokutisyoVrf extends AbstractExDBEntity<HT_KokutisyoVrf, PKHT_KokutisyoVrf> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_KokutisyoVrf";
    ...
    private final PKHT_KokutisyoVrf primaryKey;

    public GenHT_KokutisyoVrf() {
        primaryKey = new PKHT_KokutisyoVrf();
    }

    public GenHT_KokutisyoVrf(String pMosno) {
        primaryKey = new PKHT_KokutisyoVrf(pMosno);
    }

    @Transient
    @Override
    public PKHT_KokutisyoVrf getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_KokutisyoVrf> getMetaClass() {
        return QHT_KokutisyoVrf.class;
    }

    @Id
    @Column(name=GenHT_KokutisyoVrf.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_KokutisyoVrf.KKTYMD)
    @ValidDate
    ...
    @Column(name=GenHT_KokutisyoVrf.SINTYOU)
    @Range(min="0", max="999")
    ...
    @Column(name=GenHT_KokutisyoVrf.TAIJYUU)
    @Range(min="0", max="999")
    ...
    @Column(name=GenHT_KokutisyoVrf.KITUENKBN)
    ...
    @Column(name=GenHT_KokutisyoVrf.KITUENHON)
    @Range(min="0", max="99")
    ...
    @Column(name=GenHT_KokutisyoVrf.KIJIKBN)
    ...
    @Column(name=GenHT_KokutisyoVrf.KZKKIJIKBN)
    ...
    @Column(name=GenHT_KokutisyoVrf.HBCMNT)
    ...
    @Column(name=GenHT_KokutisyoVrf.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_KokutisyoVrf.GYOUMUKOUSINTIME)
