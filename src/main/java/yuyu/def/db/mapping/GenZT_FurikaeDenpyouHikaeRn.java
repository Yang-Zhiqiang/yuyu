...
/**
 * 振替伝票（控）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_FurikaeDenpyouHikaeRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_FurikaeDenpyouHikaeRn}</td><td colspan="3">振替伝票（控）テーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikinoc8 zrntorihikinoc8}</td><td>（連携用）取引番号Ｃ８</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinoedano zrntorihikinoedano}</td><td>（連携用）取引番号枝番号</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymdgengokbn zrntorihikiymdgengokbn}</td><td>（連携用）取引年月日元号区分</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinen zrntorihikinen}</td><td>（連携用）取引年</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikituki zrntorihikituki}</td><td>（連携用）取引月</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikibi zrntorihikibi}</td><td>（連携用）取引日</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_FurikaeDenpyouHikaeRn
 * @see     PKZT_FurikaeDenpyouHikaeRn
 * @see     QZT_FurikaeDenpyouHikaeRn
 * @see     GenQZT_FurikaeDenpyouHikaeRn
 */
@MappedSuperclass
@Table(name=GenZT_FurikaeDenpyouHikaeRn.TABLE_NAME)
@IdClass(value=PKZT_FurikaeDenpyouHikaeRn.class)
public abstract class GenZT_FurikaeDenpyouHikaeRn extends AbstractExDBEntityForZDB<ZT_FurikaeDenpyouHikaeRn, PKZT_FurikaeDenpyouHikaeRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_FurikaeDenpyouHikaeRn";
    ...
    private final PKZT_FurikaeDenpyouHikaeRn primaryKey;

    public GenZT_FurikaeDenpyouHikaeRn() {
        primaryKey = new PKZT_FurikaeDenpyouHikaeRn();
    }
    ...
    @Transient
    @Override
    public PKZT_FurikaeDenpyouHikaeRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_FurikaeDenpyouHikaeRn> getMetaClass() {
        return QZT_FurikaeDenpyouHikaeRn.class;
    }

    private String zrnkytkmksyoruicd;

    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKYTKMKYOBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNTORIHIKIBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKANJYOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKANJYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJTANTOUKANM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJTANTOUCD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJSYSTEMNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNDENPYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJTEKIYOU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJTEKIYOU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJTEKIYOU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKARIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKASIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM4)
