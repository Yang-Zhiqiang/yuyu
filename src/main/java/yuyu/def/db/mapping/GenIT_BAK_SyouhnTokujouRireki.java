...
import yuyu.def.db.id.PKIT_BAK_SyouhnTokujouRireki;
import yuyu.def.db.meta.GenQIT_BAK_SyouhnTokujouRireki;
...
/**
 * 商品特条履歴バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_SyouhnTokujouRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_SyouhnTokujouRireki}</td><td colspan="3">商品特条履歴バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyutkkbn syutkkbn}</td><td>主契約特約区分</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>{@link C_SyutkKbn}</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhnsdno syouhnsdno}</td><td>商品世代番号</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getKyksyouhnrenno kyksyouhnrenno}</td><td>契約商品連番</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_SyouhnTokujouRireki ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_SyouhnTokujouRireki
 * @see     PKIT_BAK_SyouhnTokujouRireki
 * @see     QIT_BAK_SyouhnTokujouRireki
 * @see     GenQIT_BAK_SyouhnTokujouRireki
 */
@MappedSuperclass
@Table(name=GenIT_BAK_SyouhnTokujouRireki.TABLE_NAME)
@IdClass(value=PKIT_BAK_SyouhnTokujouRireki.class)
@TypeDefs({
...
public abstract class GenIT_BAK_SyouhnTokujouRireki extends AbstractExDBEntity<IT_BAK_SyouhnTokujouRireki, PKIT_BAK_SyouhnTokujouRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_SyouhnTokujouRireki";
    ...
    private final PKIT_BAK_SyouhnTokujouRireki primaryKey;

    public GenIT_BAK_SyouhnTokujouRireki() {
        primaryKey = new PKIT_BAK_SyouhnTokujouRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_SyouhnTokujouRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_SyouhnTokujouRireki> getMetaClass() {
        return QIT_BAK_SyouhnTokujouRireki.class;
    }

    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.SYUTKKBN)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.SYOUHNSDNO)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.KYKSYOUHNRENNO)
    ...
    @Id
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.TKJYHYOUTEN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.TKJYSKGNKKN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPBUICD1)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPKKN1)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPBUICD2)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPKKN2)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPBUICD3)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPKKN3)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPBUICD4)
    @MaxLength(max=3)
    @AlphaDigit
    ...
    @Type(type="UserType_C_Htnpkkn")
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.HTNPKKN4)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.TOKKOUDOSGHTNPKBN)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_SyouhnTokujouRireki.GYOUMUKOUSINTIME)
