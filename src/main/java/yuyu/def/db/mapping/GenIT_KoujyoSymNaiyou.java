...
import yuyu.def.db.id.PKIT_KoujyoSymNaiyou;
...
/**
 * 控除証明内容テーブル テーブルのマッピング情報クラスで、 {@link IT_KoujyoSymNaiyou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KoujyoSymNaiyou}</td><td colspan="3">控除証明内容テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KoujyoSymNaiyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KoujyoSymNaiyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyouhncd syouhncd}</td><td>商品コード</td><td align="center">{@link PKIT_KoujyoSymNaiyou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKIT_KoujyoSymNaiyou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_KoujyoSymNaiyou
 * @see     QIT_KoujyoSymNaiyou
 * @see     GenQIT_KoujyoSymNaiyou
 */
@MappedSuperclass
@Table(name=GenIT_KoujyoSymNaiyou.TABLE_NAME)
@IdClass(value=PKIT_KoujyoSymNaiyou.class)
@TypeDefs({
...
public abstract class GenIT_KoujyoSymNaiyou extends AbstractExDBEntity<IT_KoujyoSymNaiyou, PKIT_KoujyoSymNaiyou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KoujyoSymNaiyou";
    ...
    private final PKIT_KoujyoSymNaiyou primaryKey;

    public GenIT_KoujyoSymNaiyou() {
        primaryKey = new PKIT_KoujyoSymNaiyou();
    }
    ...
    @Transient
    @Override
    public PKIT_KoujyoSymNaiyou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KoujyoSymNaiyou> getMetaClass() {
        return QIT_KoujyoSymNaiyou.class;
    }

    @Id
    @Column(name=GenIT_KoujyoSymNaiyou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyou.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyou.SYOUHNCD)
    @MaxLength(max=4)
    @SingleByteStrings
    ...
    @Id
    @Column(name=GenIT_KoujyoSymNaiyou.RENNO3KETA)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KOUJYOSYOUMEINND)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.SYOUMEISTARTYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_KoujyoSymNaiyou.SYOUMEIENDYM)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KOUJYOSYOUMEIPKBN)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.TEKIYOUSEIDOKBN)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KOUJYOSYMNAIYOURECKBN)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_KoujyoSymNaiyou.JYUTOUSTARTYM)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.NYKNJSKRRKRENNO)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KIHRKPSSRRKRENNO)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KJSMHAKKOUZUMIFLG)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.SAKUJYOFLG)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.ZENNOUKAISIYMD)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.ZENNOURENNO)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KEISANHUKAHYOUJIKBN)
    ...
    @Column(name=GenIT_KoujyoSymNaiyou.KEISANHUKARIYUUCD)
