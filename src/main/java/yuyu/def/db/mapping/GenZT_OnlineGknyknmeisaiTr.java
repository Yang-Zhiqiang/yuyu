...
/**
 * オンライン外貨入出金明細テーブル（取） テーブルのマッピング情報クラスで、 {@link ZT_OnlineGknyknmeisaiTr} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_OnlineGknyknmeisaiTr}</td><td colspan="3">オンライン外貨入出金明細テーブル（取）</td></tr>
 ...
 *  <tr><td>{@link #getZtrsakuseiymd ztrsakuseiymd}</td><td>（取込用）作成日</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrrenrakuymd ztrrenrakuymd}</td><td>（取込用）連絡日</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrrenrakukaisuu ztrrenrakukaisuu}</td><td>（取込用）連絡回数</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtrbankcd ztrbankcd}</td><td>（取込用）銀行番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtrshitencd ztrshitencd}</td><td>（取込用）支店番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrsitennmej ztrsitennmej}</td><td>（取込用）支店名（英字）</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtryokinkbn ztryokinkbn}</td><td>（取込用）預金種目区分</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrkouzano ztrkouzano}</td><td>（取込用）口座番号</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrkznmej ztrkznmej}</td><td>（取込用）口座名（英字）</td><td align="center">&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrzndktuukasyu ztrzndktuukasyu}</td><td>（取込用）残高通貨種類</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtrsyorino1 ztrsyorino1}</td><td>（取込用）処理通番１</td><td align="center">{@link PKZT_OnlineGknyknmeisaiTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_OnlineGknyknmeisaiTr
 * @see     PKZT_OnlineGknyknmeisaiTr
 * @see     QZT_OnlineGknyknmeisaiTr
 * @see     GenQZT_OnlineGknyknmeisaiTr
 */
@MappedSuperclass
@Table(name=GenZT_OnlineGknyknmeisaiTr.TABLE_NAME)
@IdClass(value=PKZT_OnlineGknyknmeisaiTr.class)
public abstract class GenZT_OnlineGknyknmeisaiTr extends AbstractExDBEntity<ZT_OnlineGknyknmeisaiTr, PKZT_OnlineGknyknmeisaiTr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_OnlineGknyknmeisaiTr";
    ...
    private final PKZT_OnlineGknyknmeisaiTr primaryKey;

    public GenZT_OnlineGknyknmeisaiTr() {
        primaryKey = new PKZT_OnlineGknyknmeisaiTr();
    }
    ...
    @Transient
    @Override
    public PKZT_OnlineGknyknmeisaiTr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_OnlineGknyknmeisaiTr> getMetaClass() {
        return QZT_OnlineGknyknmeisaiTr.class;
    }

    private String ztrdatakbn1;

    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSYUBETUCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRCDKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSAKUSEIYMD)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRRENRAKUYMD)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRRENRAKUKAISUU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKNJYYMDFROM)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKNJYYMDTO)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRBANKCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRBANKNMEJ)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSITENCDTORI)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSITENNMEJTORI)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSHITENCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSITENNMEJ)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRYOKINKBN)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKOUZANO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKZNMEJ)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRZNDKTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRZNDKSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRGKTRHKMAEZNDK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKASIKOSIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRYOBIV86)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKBN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKOUSEI)
    ...
    @Id
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSYORINO1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKNJYYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKSNYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRIRIBARAIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTRHKKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTRHKTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTRHKSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRGKTRHKGK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRBANKSYOUKAINO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTRHKSYOUKAINO)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTEKIYOUNAIYOUEJ)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRYOBIV103)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKBN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTKOUSEIKBN)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRTRKSCD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSYORINO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRBANKSYOUKAINO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSIMUKEYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSETUJYUYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSOUKINSYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRVALUEYMD)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSKNTUUKASYU)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRSKNSSKETA)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRGKSOUKINGK)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRIRNINNM)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRYOBIV40)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN4)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKBN3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDSUU1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDNO1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENSUU1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENKETA1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHEN1)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN5)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKBN4)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDSUU2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDNO2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENSUU2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENKETA2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHEN2)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDATAKBN6)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDTRECORDKBN5)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDSUU3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRDOURECORDNO3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENSUU3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHENKETA3)
    ...
    @Column(name=GenZT_OnlineGknyknmeisaiTr.ZTRKAHEN3)
