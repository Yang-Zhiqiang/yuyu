...
import yuyu.def.db.id.PKBT_IdouKhMeigi;
import yuyu.def.db.meta.GenQBT_IdouKhMeigi;
...
/**
 * 異動契約保全名義管理テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouKhMeigi} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_IdouKhMeigi}</td><td colspan="3">異動契約保全名義管理テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKBT_IdouKhMeigi ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouKhMeigi ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     BT_IdouKhMeigi
 * @see     PKBT_IdouKhMeigi
 * @see     QBT_IdouKhMeigi
 * @see     GenQBT_IdouKhMeigi
 */
@MappedSuperclass
@Table(name=GenBT_IdouKhMeigi.TABLE_NAME)
@IdClass(value=PKBT_IdouKhMeigi.class)
@TypeDefs({
...
public abstract class GenBT_IdouKhMeigi extends AbstractExDBEntity<BT_IdouKhMeigi, PKBT_IdouKhMeigi> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouKhMeigi";
    ...
    private final PKBT_IdouKhMeigi primaryKey;

    public GenBT_IdouKhMeigi() {
        primaryKey = new PKBT_IdouKhMeigi();
    }

    public GenBT_IdouKhMeigi(String pSyono, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouKhMeigi(pSyono, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouKhMeigi getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouKhMeigi> getMetaClass() {
        return QBT_IdouKhMeigi.class;
    }

    @Id
    @Column(name=GenBT_IdouKhMeigi.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenBT_IdouKhMeigi.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNSEI)
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouKhMeigi.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KYKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouKhMeigi.KYKSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigi.NENKINUKTNMKANA)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.NENKINUKTNMKANJI)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouKhMeigi.NENKINUKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouKhMeigi.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigi.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKN3)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKJ3)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKN4)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.SBUKTNMKJ4)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.STDRSKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.STDRSKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KYKDAIRINMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KYKDAIRINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigi.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenBT_IdouKhMeigi.YOKINKBN)
    ...
    @Column(name=GenBT_IdouKhMeigi.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KZKYKDOUKBN)
    ...
    @Column(name=GenBT_IdouKhMeigi.KZKTOUROKUNMKN1)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KZKTOUROKUNMKJ1)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KZKTOUROKUNMKN2)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouKhMeigi.KZKTOUROKUNMKJ2)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
