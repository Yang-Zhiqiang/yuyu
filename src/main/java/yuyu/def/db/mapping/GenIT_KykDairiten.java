...
import yuyu.def.db.id.PKIT_KykDairiten;
...
/**
 * 契約代理店テーブル テーブルのマッピング情報クラスで、 {@link IT_KykDairiten} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KykDairiten}</td><td colspan="3">契約代理店テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KykDairiten ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KykDairiten ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getDrtenrenno drtenrenno}</td><td>代理店連番</td><td align="center">{@link PKIT_KykDairiten ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     IT_KykDairiten
 * @see     PKIT_KykDairiten
 * @see     QIT_KykDairiten
 * @see     GenQIT_KykDairiten
 */
@MappedSuperclass
@Table(name=GenIT_KykDairiten.TABLE_NAME)
@IdClass(value=PKIT_KykDairiten.class)
@TypeDefs({
...
public abstract class GenIT_KykDairiten extends AbstractExDBEntity<IT_KykDairiten, PKIT_KykDairiten> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KykDairiten";
    ...
    private final PKIT_KykDairiten primaryKey;

    public GenIT_KykDairiten() {
        primaryKey = new PKIT_KykDairiten();
    }
    ...
    @Transient
    @Override
    public PKIT_KykDairiten getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KykDairiten> getMetaClass() {
        return QIT_KykDairiten.class;
    }

    @Id
    @Column(name=GenIT_KykDairiten.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KykDairiten.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KykDairiten.DRTENRENNO)
    ...
    @Column(name=GenIT_KykDairiten.DRTENCD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_KykDairiten.DRTENKANRISOSIKICD)
    ...
    @Column(name=GenIT_KykDairiten.GYOUSEKIKEIJYOUSAKISOSIKICD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenIT_KykDairiten.OYADRTENCD)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Column(name=GenIT_KykDairiten.BOSYUUCD)
    @MaxLength(max=6)
    @AlphaDigit
    ...
    @Column(name=GenIT_KykDairiten.DAIBOSYUUCD)
    @HostInvalidCharacter
    ...
    @Column(name=GenIT_KykDairiten.DRTENBUNUMU)
    ...
    @Column(name=GenIT_KykDairiten.KANJIDRTFLG)
    ...
    @Column(name=GenIT_KykDairiten.BUNWARI)
    ...
    @Column(name=GenIT_KykDairiten.IKANYMD)
    @ValidDate
    ...
    @Column(name=GenIT_KykDairiten.BSYUJOYADRTENCD)
    ...
    @Column(name=GenIT_KykDairiten.BSYUJDRTENCD)
    ...
    @Column(name=GenIT_KykDairiten.BSYUJBOSYUUTRKNO)
    ...
    @Column(name=GenIT_KykDairiten.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KykDairiten.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KykDairiten.GYOUMUKOUSINTIME)
