...
/**
 * 新契約決算ベース月次成立Ｆテーブル５（連） テーブルのマッピング情報クラスで、 {@link ZT_Skeiksnbsgetujisr5Rn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_Skeiksnbsgetujisr5Rn}</td><td colspan="3">新契約決算ベース月次成立Ｆテーブル５（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrnktgysyono zrnktgysyono}</td><td>（連携用）結合用証券番号</td><td align="center">{@link PKZT_Skeiksnbsgetujisr5Rn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_Skeiksnbsgetujisr5Rn
 * @see     PKZT_Skeiksnbsgetujisr5Rn
 * @see     QZT_Skeiksnbsgetujisr5Rn
 * @see     GenQZT_Skeiksnbsgetujisr5Rn
 */
@MappedSuperclass
@Table(name=GenZT_Skeiksnbsgetujisr5Rn.TABLE_NAME)
@IdClass(value=PKZT_Skeiksnbsgetujisr5Rn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Skeiksnbsgetujisr5Rn extends AbstractExDBEntityForZDB<ZT_Skeiksnbsgetujisr5Rn, PKZT_Skeiksnbsgetujisr5Rn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Skeiksnbsgetujisr5Rn";
    ...
    private final PKZT_Skeiksnbsgetujisr5Rn primaryKey;

    public GenZT_Skeiksnbsgetujisr5Rn() {
        primaryKey = new PKZT_Skeiksnbsgetujisr5Rn();
    }

    public GenZT_Skeiksnbsgetujisr5Rn(String pZrnktgysyono) {
        primaryKey = new PKZT_Skeiksnbsgetujisr5Rn(pZrnktgysyono);
    }

    @Transient
    @Override
    public PKZT_Skeiksnbsgetujisr5Rn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Skeiksnbsgetujisr5Rn> getMetaClass() {
        return QZT_Skeiksnbsgetujisr5Rn.class;
    }

    private String zrnktgysyrymd;

    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKTGYSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKTGYFILERENNO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNAATUKAISYABOSYUUDIRTNCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNBATUKAISYABOSYUUDIRTNCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKESSANKEIJYOUYM)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHTNKNTMTTSYUSNHKNARIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNGOUKEINENBARAIKANSANP3X6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHKTGTIKKIKKKN3X6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKAPPADHKTGKUJYGKX6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHUTIHNNNKKNNZMKYKSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNMUSYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNMOSNYUURYOKUYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNMOSSYOSAKUSEIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKOKUTIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDAI2KOKUTIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNJYUURYOUSYOURYAKUKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKSYURUIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSENSINIRYOUTOKUYAKUKIKAN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSENSINIRYOUTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSENSINIRYOUTOKUYAKUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSENSINIRYOUTOKUYAKUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSENSINIRYOUTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNSNSNIRYUTKYKKUSNMNRYOAGE)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNYOBIV4X17)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKSYRIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDAI2SNSNIRYUTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDAI2SENSINIRYOUTOKUYAKUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDAI2SENSINIRYOUTOKUYAKUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2SNSNIRYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNYOBIV6X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNHSYUMNOSJDFTMTTZNDK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKSYRIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYINHSYJYJTTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKYKS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKYKP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYINHSYJYJTTKJYRYMSHYTN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKYKTKJYUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYUJTHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYINHSYJYJTTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYINHSYJYJTTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYUINHSYUJYJTTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNNYINHSYJYJTKYKKSNMNRYAGE)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNYOBIV5X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2NYINHSYJYJTTKYKSYRIKG)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2NYUINHSYUJYUJTTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2NYUINHSYUJYJTPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Rn.ZRNDI2NYUINHSY