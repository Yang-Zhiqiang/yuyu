...
/**
 * 年金原資Ｆ期中報告用テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_NkGensiKtyRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_NkGensiKtyRn}</td><td colspan="3">年金原資Ｆ期中報告用テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_NkGensiKtyRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_NkGensiKtyRn.TABLE_NAME)
@IdClass(value=PKZT_NkGensiKtyRn.class)
public abstract class GenZT_NkGensiKtyRn extends AbstractExDBEntityForZDB<ZT_NkGensiKtyRn, PKZT_NkGensiKtyRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_NkGensiKtyRn";
    ...
    private final PKZT_NkGensiKtyRn primaryKey;

    public GenZT_NkGensiKtyRn() {
        primaryKey = new PKZT_NkGensiKtyRn();
    }

    public GenZT_NkGensiKtyRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_NkGensiKtyRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_NkGensiKtyRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_NkGensiKtyRn> getMetaClass() {
        return QZT_NkGensiKtyRn.class;
    }

    @Id
    @Column(name=GenZT_NkGensiKtyRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSYSTEMCD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNULFKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNRECORDKIHONKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKSYOUSYONO)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNIDOUYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSYOUIN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKSYURUIKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINSYU)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINKAISIKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKEIYAKUYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSYOKAINENKINSIHARAIYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINHOSYOUKIKAN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKHNNKGK)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSAISYUUKOUSINYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSAISYUUKOUSINSYORICD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINKIHONCTR)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNCURRENTDAY)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNCURRENTTIME)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKESSANJIBIKINKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKSYOUMETUCD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKSYOUMETUYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKOURYOKUHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKINGAKUZOUKANAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNMOTOKEIYAKUSYOUHINKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNRRTHENDOUNKYOTEIRRT)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNRRTHENDOUNKSITIHSYURRT)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNHENKOUMAEKIHONNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINGENSINO)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINGENSINAIYOUKBN)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNKKIKINGK)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNGENSINAIYOUKIHONNKGK)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNEWMONEYGAKU)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNNENKINGENSIHASSEIYMD)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNDKEISANYOUNENKINGAKU)
    ...
    @Column(name=GenZT_NkGensiKtyRn.ZRNKGYNKYOUZEISEITKKAKSJGNS)
