...
/**
 * 月間変更処理収入Ｐ統計Fテーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_GkknHnkuSyrSynypTukiTy} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtysequenceno ztysequenceno}</td><td>（中継用）シーケンス番号</td><td align="center">{@link PKZT_GkknHnkuSyrSynypTukiTy ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_GkknHnkuSyrSynypTukiTy.TABLE_NAME)
@IdClass(value=PKZT_GkknHnkuSyrSynypTukiTy.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_GkknHnkuSyrSynypTukiTy extends AbstractExDBEntity<ZT_GkknHnkuSyrSynypTukiTy, PKZT_GkknHnkuSyrSynypTukiTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_GkknHnkuSyrSynypTukiTy";
    ...
    private final PKZT_GkknHnkuSyrSynypTukiTy primaryKey;

    public GenZT_GkknHnkuSyrSynypTukiTy() {
        primaryKey = new PKZT_GkknHnkuSyrSynypTukiTy();
    }

    public GenZT_GkknHnkuSyrSynypTukiTy(Integer pZtysequenceno) {
        primaryKey = new PKZT_GkknHnkuSyrSynypTukiTy(pZtysequenceno);
    }

    @Transient
    @Override
    public PKZT_GkknHnkuSyrSynypTukiTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_GkknHnkuSyrSynypTukiTy> getMetaClass() {
        return QZT_GkknHnkuSyrSynypTukiTy.class;
    }

    @Id
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSEQUENCENO)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRDWAREA)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDATAKANRINO)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYORICD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRENDOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUUNOUKEIROKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUITOUSISYA)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUUKINYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYJYUUTOUYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYJYUUTOUKAISUU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYZENNOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSETKYKKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYBANKIKKATUHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRECORDKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTNKNMNOSJTIKBBNJYUTUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSETRENSEIMRTIKATAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHAITOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUKEIYAKUPWARIBIKIKBNX2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYKYKTNKNYUGUKBNX2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSETKAIGOMARUTEIKATAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDENYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYONENDOSYOKAIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYONENDO2KAIMEIKOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYJINENDOIKOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHKNSYUKIGOU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHKNKKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPHRKKIKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKSYANEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHHKNSEIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHRKKAISUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSDPDKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRYOURITUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDAI2HHKNNEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPMENHUKAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHOSYOUIKKATUMNOSHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV1X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKIHONS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYGOUKEITENKANS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHNGKNKSAITEIHOSYUKNGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYBSYYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUJYOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUUNOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTKYKKUMKHNSYUKOSUU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSITEIZUKIHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSAISYUUSITEIMHRKP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYANNISKCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTUMITATERIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSITIHSYURIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYNKGNSRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSINNYUUKINKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDFNYUUKINKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTORIKUZUSIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKBNKEIRIYOUSEGMENTCD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYKIKYKJKYKYM)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDFKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSTDSSYTIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYPHIREILKEISANYOUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYCASHLESSHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKJIQPACKHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYJIDOUKOUSINHYOUJI)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTKJYKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN10X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN10X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN10X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSYUKEIYAKUSYURUICDV3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKYKJIKAWASERATETKYUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSISUURENDOURATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSISUUKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYNYKNJIKAWASERATE)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYNYKNJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSUURIYOUYOBIN10X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTUUKASYUKBN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV9X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV10X16)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYNKGNS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSISUUBBNTOUNYUUGK)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYSAISINYOTEIRIRITU)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIN11X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYKIHARAIKOMIP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTUMITATEKIN)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYZENNOUJIIKKATUBARAIJYTGK)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYGAIKADATENKGNS)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYYOBIV1X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X2)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X3)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X4)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X5)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X6)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X7)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X8)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X9)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X10)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X11)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X12)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X13)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X14)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X15)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X16)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X17)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X18)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X19)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X20)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X21)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X22)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X23)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X24)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X25)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X26)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X27)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X28)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X29)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X30)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X31)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X32)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X33)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X34)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X35)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X36)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X37)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X38)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X39)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X40)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X41)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X42)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X43)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X44)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X45)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X46)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X47)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X48)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X49)
    ...
    @Column(name=GenZT_GkknHnkuSyrSynypTukiTy.ZTYTOKUYAKUKOUMOKUV160X50)
