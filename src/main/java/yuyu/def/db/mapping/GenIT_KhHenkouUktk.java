...
import yuyu.def.db.id.PKIT_KhHenkouUktk;
import yuyu.def.db.meta.GenQIT_KhHenkouUktk;
...
/**
 * 契約保全変更受付テーブル テーブルのマッピング情報クラスで、 {@link IT_KhHenkouUktk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KhHenkouUktk}</td><td colspan="3">契約保全変更受付テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KhHenkouUktk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KhHenkouUktk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHozenhenkouuktkrenno hozenhenkouuktkrenno}</td><td>保全変更受付連番</td><td align="center">{@link PKIT_KhHenkouUktk ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenIT_KhHenkouUktk.TABLE_NAME)
@IdClass(value=PKIT_KhHenkouUktk.class)
@TypeDefs({
...
public abstract class GenIT_KhHenkouUktk extends AbstractExDBEntity<IT_KhHenkouUktk, PKIT_KhHenkouUktk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KhHenkouUktk";
    ...
    private final PKIT_KhHenkouUktk primaryKey;

    public GenIT_KhHenkouUktk() {
        primaryKey = new PKIT_KhHenkouUktk();
    }
    ...
    @Transient
    @Override
    public PKIT_KhHenkouUktk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KhHenkouUktk> getMetaClass() {
        return QIT_KhHenkouUktk.class;
    }

    @Id
    @Column(name=GenIT_KhHenkouUktk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KhHenkouUktk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KhHenkouUktk.HOZENHENKOUUKTKRENNO)
    ...
    @Column(name=GenIT_KhHenkouUktk.UKTKYMD)
    ...
    @Column(name=GenIT_KhHenkouUktk.TOUROKUROUTE)
    ...
    @Column(name=GenIT_KhHenkouUktk.UKTKSYORIKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHenkouUktk.KOURYOKUHASSEIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KhHenkouUktk.SYORIYOTEIYMD)
    ...
    @Column(name=GenIT_KhHenkouUktk.UKTKJYOUTAIKBN)
    ...
    @Column(name=GenIT_KhHenkouUktk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KhHenkouUktk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KhHenkouUktk.GYOUMUKOUSINTIME)
