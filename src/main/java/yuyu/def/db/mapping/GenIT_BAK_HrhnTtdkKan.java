...
import yuyu.def.db.id.PKIT_BAK_HrhnTtdkKan;
import yuyu.def.db.meta.GenQIT_BAK_HrhnTtdkKan;
...
/**
 * 手続完了（払方変更）バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_HrhnTtdkKan} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_HrhnTtdkKan}</td><td colspan="3">手続完了（払方変更）バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_HrhnTtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_HrhnTtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_HrhnTtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getHenkousikibetukey henkousikibetukey}</td><td>変更識別キー</td><td align="center">{@link PKIT_BAK_HrhnTtdkKan ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_HrhnTtdkKan
 * @see     PKIT_BAK_HrhnTtdkKan
 * @see     QIT_BAK_HrhnTtdkKan
 * @see     GenQIT_BAK_HrhnTtdkKan
 */
@MappedSuperclass
@Table(name=GenIT_BAK_HrhnTtdkKan.TABLE_NAME)
@IdClass(value=PKIT_BAK_HrhnTtdkKan.class)
@TypeDefs({
...
public abstract class GenIT_BAK_HrhnTtdkKan extends AbstractExDBEntity<IT_BAK_HrhnTtdkKan, PKIT_BAK_HrhnTtdkKan> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_HrhnTtdkKan";
    ...
    private final PKIT_BAK_HrhnTtdkKan primaryKey;

    public GenIT_BAK_HrhnTtdkKan() {
        primaryKey = new PKIT_BAK_HrhnTtdkKan();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_HrhnTtdkKan getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_HrhnTtdkKan> getMetaClass() {
        return QIT_BAK_HrhnTtdkKan.class;
    }

    @Id
    @Column(name=GenIT_BAK_HrhnTtdkKan.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HrhnTtdkKan.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_HrhnTtdkKan.TRKSSIKIBETUKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_HrhnTtdkKan.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SYORUICD)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TYOUHYOUYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SHSKYNO)
    @Length(length=7)
    @Digit
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SHSADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SHSADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SHSADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.SHSNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASESOSIKINMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASEYNO)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASEADR1KJ)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASEADR2KJ)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASEADR3KJ)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASEKAISYANMKJ)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASETELNO)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASETELUKTKKANOU1)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASETELUKTKKANOU2)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASESOSIKINMKJ2)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.TOIAWASETELNO2)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.KOUZAMASKINGMSG)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKKAISUUTKIKTBRISYU)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKKEIRO)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.KOURYOKUHASSEIYM)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA1)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA2)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA3)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA4)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA5)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA6)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.MSGAREA34KETA7)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA1)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA2)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA3)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA4)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA5)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA6)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA7)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA8)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA9)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA10)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA11)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA12)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA13)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA14)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA15)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA16)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA17)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA18)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA19)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA20)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA21)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA22)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA23)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA24)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA25)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA26)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA27)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HRKYKKMSG34KETA28)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.HASSOUKBN)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_HrhnTtdkKan.GYOUMUKOUSINTIME)
