...
import yuyu.def.db.id.PKIT_BAK_DattaiUktk;
import yuyu.def.db.meta.GenQIT_BAK_DattaiUktk;
...
/**
 * 脱退受付バックアップテーブル テーブルのマッピング情報クラスで、 {@link IT_BAK_DattaiUktk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_BAK_DattaiUktk}</td><td colspan="3">脱退受付バックアップテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_BAK_DattaiUktk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_BAK_DattaiUktk ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getTrkssikibetukey trkssikibetukey}</td><td>取消識別キー</td><td align="center">{@link PKIT_BAK_DattaiUktk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IT_BAK_DattaiUktk
 * @see     PKIT_BAK_DattaiUktk
 * @see     QIT_BAK_DattaiUktk
 * @see     GenQIT_BAK_DattaiUktk
 */
@MappedSuperclass
@Table(name=GenIT_BAK_DattaiUktk.TABLE_NAME)
@IdClass(value=PKIT_BAK_DattaiUktk.class)
@TypeDefs({
...
public abstract class GenIT_BAK_DattaiUktk extends AbstractExDBEntity<IT_BAK_DattaiUktk, PKIT_BAK_DattaiUktk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_BAK_DattaiUktk";
    ...
    private final PKIT_BAK_DattaiUktk primaryKey;

    public GenIT_BAK_DattaiUktk() {
        primaryKey = new PKIT_BAK_DattaiUktk();
    }
    ...
    @Transient
    @Override
    public PKIT_BAK_DattaiUktk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_BAK_DattaiUktk> getMetaClass() {
        return QIT_BAK_DattaiUktk.class;
    }

    @Id
    @Column(name=GenIT_BAK_DattaiUktk.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_BAK_DattaiUktk.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_BAK_DattaiUktk.TRKSSIKIBETUKEY)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.SYORIYMD)
    @ValidDate
    ...
    @Column(name=GenIT_BAK_DattaiUktk.SYORISOSIKICD)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.DATTAIKEIRO)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.DATTAIRIYUUKBN)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.DATTAIYM)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIT_BAK_DattaiUktk.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIT_BAK_DattaiUktk.YOKINKBN)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.HURIHUNOKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_BAK_DattaiUktk.HURIKAEYMD)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITDATAKBN)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITCARDNO1)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITCARDNO2)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITCARDNO3)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITCARDNO4)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITBRERRORCD)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_BAK_DattaiUktk.JKIPJYTYM)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.COMMENT124KETA)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenIT_BAK_DattaiUktk.CREDITKESSAIYOUNO)
