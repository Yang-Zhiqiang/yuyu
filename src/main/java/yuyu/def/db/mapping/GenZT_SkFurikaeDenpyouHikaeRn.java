...
/**
 * 新契約振替伝票（控）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_SkFurikaeDenpyouHikaeRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkFurikaeDenpyouHikaeRn}</td><td colspan="3">新契約振替伝票（控）テーブル（連）</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikinoc8 zrntorihikinoc8}</td><td>（連携用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinoedano zrntorihikinoedano}</td><td>（連携用）取引番号枝番号</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZrntorihikiymdgengokbn zrntorihikiymdgengokbn}</td><td>（連携用）取引年月日元号区分</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikinen zrntorihikinen}</td><td>（連携用）取引年</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikituki zrntorihikituki}</td><td>（連携用）取引月</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>{@link #getZrntorihikibi zrntorihikibi}</td><td>（連携用）取引日</td><td align="center">{@link PKZT_SkFurikaeDenpyouHikaeRn ○}</td><td align="center">C</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkFurikaeDenpyouHikaeRn
 * @see     PKZT_SkFurikaeDenpyouHikaeRn
 * @see     QZT_SkFurikaeDenpyouHikaeRn
 * @see     GenQZT_SkFurikaeDenpyouHikaeRn
 */
@MappedSuperclass
@Table(name=GenZT_SkFurikaeDenpyouHikaeRn.TABLE_NAME)
@IdClass(value=PKZT_SkFurikaeDenpyouHikaeRn.class)
public abstract class GenZT_SkFurikaeDenpyouHikaeRn extends AbstractExDBEntityForZDB<ZT_SkFurikaeDenpyouHikaeRn, PKZT_SkFurikaeDenpyouHikaeRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkFurikaeDenpyouHikaeRn";
    ...
    private final PKZT_SkFurikaeDenpyouHikaeRn primaryKey;

    public GenZT_SkFurikaeDenpyouHikaeRn() {
        primaryKey = new PKZT_SkFurikaeDenpyouHikaeRn();
    }
    ...
    @Transient
    @Override
    public PKZT_SkFurikaeDenpyouHikaeRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkFurikaeDenpyouHikaeRn> getMetaClass() {
        return QZT_SkFurikaeDenpyouHikaeRn.class;
    }

    private String zrnkytkmksyoruicd;

    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNTORIHIKIBI)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKANJYOUKBN)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJTANTOUCD)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkFurikaeDenpyouHikaeRn.ZRNKJKASITEKIYOUKM4)
