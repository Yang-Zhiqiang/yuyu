...
/**
 * 新契約決算用振替伝票（控）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_SkKsnHurikaeHikaeTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_SkKsnHurikaeHikaeTy}</td><td colspan="3">新契約決算用振替伝票（控）テーブル（中）</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikinoc8 ztytorihikinoc8}</td><td>（中継用）取引番号Ｃ８</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinoedano ztytorihikinoedano}</td><td>（中継用）取引番号枝番号</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikiymdgengokbn ztytorihikiymdgengokbn}</td><td>（中継用）取引年月日元号区分</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinen ztytorihikinen}</td><td>（中継用）取引年</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikituki ztytorihikituki}</td><td>（中継用）取引月</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikibi ztytorihikibi}</td><td>（中継用）取引日</td><td align="center">{@link PKZT_SkKsnHurikaeHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_SkKsnHurikaeHikaeTy
 * @see     PKZT_SkKsnHurikaeHikaeTy
 * @see     QZT_SkKsnHurikaeHikaeTy
 * @see     GenQZT_SkKsnHurikaeHikaeTy
 */
@MappedSuperclass
@Table(name=GenZT_SkKsnHurikaeHikaeTy.TABLE_NAME)
@IdClass(value=PKZT_SkKsnHurikaeHikaeTy.class)
public abstract class GenZT_SkKsnHurikaeHikaeTy extends AbstractExDBEntity<ZT_SkKsnHurikaeHikaeTy, PKZT_SkKsnHurikaeHikaeTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_SkKsnHurikaeHikaeTy";
    ...
    private final PKZT_SkKsnHurikaeHikaeTy primaryKey;

    public GenZT_SkKsnHurikaeHikaeTy() {
        primaryKey = new PKZT_SkKsnHurikaeHikaeTy();
    }
    ...
    @Transient
    @Override
    public PKZT_SkKsnHurikaeHikaeTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_SkKsnHurikaeHikaeTy> getMetaClass() {
        return QZT_SkKsnHurikaeHikaeTy.class;
    }

    private String ztykytkmksyoruicd;

    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKYTKMKYOBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYTORIHIKIBI)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKANJYOUKBN)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKANJYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJTANTOUKANM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJTANTOUCD)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJSYSTEMNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYDENPYOUKBNNM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJTEKIYOU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJTEKIYOU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJTEKIYOU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKINGAKU1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKINGAKU2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKINGAKU3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKARIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKASIKINGAKU4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_SkKsnHurikaeHikaeTy.ZTYKJKASITEKIYOUKM4)
