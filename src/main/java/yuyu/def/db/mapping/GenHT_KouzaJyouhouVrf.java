...
import yuyu.def.db.id.PKHT_KouzaJyouhouVrf;
...
/**
 * 口座情報ベリファイテーブル テーブルのマッピング情報クラスで、 {@link HT_KouzaJyouhouVrf} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_KouzaJyouhouVrf}</td><td colspan="3">口座情報ベリファイテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_KouzaJyouhouVrf ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKHT_KouzaJyouhouVrf
 * @see     QHT_KouzaJyouhouVrf
 * @see     GenQHT_KouzaJyouhouVrf
 */
@MappedSuperclass
@Table(name=GenHT_KouzaJyouhouVrf.TABLE_NAME)
@IdClass(value=PKHT_KouzaJyouhouVrf.class)
@TypeDefs({
...
public abstract class GenHT_KouzaJyouhouVrf extends AbstractExDBEntity<HT_KouzaJyouhouVrf, PKHT_KouzaJyouhouVrf> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_KouzaJyouhouVrf";
    ...
    private final PKHT_KouzaJyouhouVrf primaryKey;

    public GenHT_KouzaJyouhouVrf() {
        primaryKey = new PKHT_KouzaJyouhouVrf();
    }

    public GenHT_KouzaJyouhouVrf(String pMosno) {
        primaryKey = new PKHT_KouzaJyouhouVrf(pMosno);
    }

    @Transient
    @Override
    public PKHT_KouzaJyouhouVrf getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_KouzaJyouhouVrf> getMetaClass() {
        return QHT_KouzaJyouhouVrf.class;
    }

    @Id
    @Column(name=GenHT_KouzaJyouhouVrf.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KZKYKDOUKBN)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.YOKINKBN)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KOUZANO)
    @MaxLength(max=12)
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.SINKEIZKKBN)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.HBCMNT)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.SYUUDAIKOCD)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KOUZAKAKUNINIRAIKBN)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KOUZAKAKUNINIRAIYMD)
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_KouzaJyouhouVrf.KOUZAJYOUHOUNYUURYOKUYMD)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.KZHURITOUROKUHOUKBN)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_KouzaJyouhouVrf.GYOUMUKOUSINTIME)
