...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ－０）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RisaTjHitNminusZeroRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RisaTjHitNminusZeroRn}</td><td colspan="3">利差のみ通常配当所要額Ｆ（Ｎ－０）テーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_RisaTjHitNminusZeroRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     ZT_RisaTjHitNminusZeroRn
 * @see     PKZT_RisaTjHitNminusZeroRn
 * @see     QZT_RisaTjHitNminusZeroRn
 * @see     GenQZT_RisaTjHitNminusZeroRn
 */
@MappedSuperclass
@Table(name=GenZT_RisaTjHitNminusZeroRn.TABLE_NAME)
@IdClass(value=PKZT_RisaTjHitNminusZeroRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RisaTjHitNminusZeroRn extends AbstractExDBEntityForZDB<ZT_RisaTjHitNminusZeroRn, PKZT_RisaTjHitNminusZeroRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RisaTjHitNminusZeroRn";
    ...
    private final PKZT_RisaTjHitNminusZeroRn primaryKey;

    public GenZT_RisaTjHitNminusZeroRn() {
        primaryKey = new PKZT_RisaTjHitNminusZeroRn();
    }

    public GenZT_RisaTjHitNminusZeroRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_RisaTjHitNminusZeroRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_RisaTjHitNminusZeroRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RisaTjHitNminusZeroRn> getMetaClass() {
        return QZT_RisaTjHitNminusZeroRn.class;
    }

    @Id
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNERRKBNV1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKEIYAKUNENDO)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKEIYAKUM)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRN5NENMEOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSUURIYOUYOBIN1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSAISITUTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOUNENDMTWRHRGKRUIKEIGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNWARIHURIGAKURISOKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNWARIHURIGAKURISOKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOKUNENDOSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOKUYOKUNENDOSYOYOUGKYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYUUKOUTYUUSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSYOUMETUYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSYOUMETUYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTENKANYOUSYOYOUGAKU1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTENKANYOUSYOYOUGAKU2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTUUJYOUDSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTUUJYOUDSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUHRKBBNKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUHRKBBNKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUHRKBBNKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUHRKBBNKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTNKNHKTGKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTNKNHKTGKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTNKNHKTGKNNKNSNP1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUTNKNHKTGKNNKNSNP2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSAISITUKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSAISITUKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSAISITUKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSAISITUKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHRKBBNKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHRKBBNKDTISYUNNKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUSANGOHRKBBNKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNHKTGKDSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNHKTGKDTISYUNENKNSNP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUSANGOTNKNHKTGKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUUSANGOHUTUUSIBOUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSAISITUKAPPADSYOYOUGAKU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUUSANGOSAISITUKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSISTKAPPADTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUUSANGOGOUKEIKAPPAD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNDTAISYOUV)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSYUSISTKSYOYOUGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSYUSISTKSYOYOUGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSYUSISTKKYHNTGK1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTNKNYUSYUSISTKKYHNTGK2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSYUSISTKAPPADSYOYOUGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSYUSISTKDTISYUKYHNTGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV1)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSAIMNKKYKHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNGKDTYKNNDSYOYOUGAKUYOU)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNGKDTYKYKNNDSYOYOUGAKUYOU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNDKEISANJIKWSRATE)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNDKEISANJIKWSRATETKYYMD)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV6X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X2)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X3)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X4)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X5)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X6)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X7)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X8)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X9)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X10)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X11)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X12)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X13)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X14)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X15)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X16)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X17)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X18)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X19)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X20)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X21)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X22)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X23)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X24)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X25)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X26)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X27)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X28)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X29)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X30)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X31)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X32)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X33)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X34)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X35)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X36)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X37)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X38)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X39)
    ...
    @Column(name=GenZT_RisaTjHitNminusZeroRn.ZRNTOKUYAKUKOUMOKUV120X40)
