...
/**
 * ＲＡＹ期末ＶＦテーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_RayKimatuVRn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_RayKimatuVRn}</td><td colspan="3">ＲＡＹ期末ＶＦテーブル（連）</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_RayKimatuVRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_RayKimatuVRn.TABLE_NAME)
@IdClass(value=PKZT_RayKimatuVRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_RayKimatuVRn extends AbstractExDBEntityForZDB<ZT_RayKimatuVRn, PKZT_RayKimatuVRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_RayKimatuVRn";
    ...
    private final PKZT_RayKimatuVRn primaryKey;

    public GenZT_RayKimatuVRn() {
        primaryKey = new PKZT_RayKimatuVRn();
    }

    public GenZT_RayKimatuVRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_RayKimatuVRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_RayKimatuVRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_RayKimatuVRn> getMetaClass() {
        return QZT_RayKimatuVRn.class;
    }

    @Id
    @Column(name=GenZT_RayKimatuVRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRECORDKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNKSGOKURIKOSIDHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNIDOJIYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZOUGENKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNIDOURECORDKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKEIJYOUCTRLKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENKOUSYORIYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKMFKSNCTR)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRECORDCTR)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDENYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNBLUEKEIZOKUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN1X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOUKEIKEIJYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZENKIIDOUTEISEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNBSYYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANGOKEIYAKUBOSYUUYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNIDOUJIYUUCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYORICD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSEKININTEISEIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN8)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIHANKIBIKINKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN1X3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOTODASIPMENKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSTDSSYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSTDSSNSKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOTODASIMANAGEHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOTODASIPHKBNMNOSHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSTDSSTKJYTKYUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURISYURUICD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHOSYOUKINOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTYUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTKSYUANNAIKYKKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRKKEIROKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSDPDKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRYOURITUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKSYANEN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2HHKNNEN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUKEIYAKUPWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANWARIBIKIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYUUHITUTNKNYUGURYURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUJYOUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSITEIZUKISYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENKOUGOKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENKOUGOSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENKOUYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNENTYOUKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSEIZONKYUUHUKINSITEIMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUKEIYAKUSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNATUKAISISYATODOUHUKENCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDI2HKNKKNIKOUJIHISYAAGE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIMNENTYOUMAEPHRKKKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKOUSINMANRYOUAGE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKNKUZUSNZYRTTEKITKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKURIAGEKURISAGEKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIZMJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKRSGJHKNSYUKIGOUSDKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOTODASISYOUHINKAITEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTIKSOTODASIKUSNKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTIKSTDSPMENKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANTEIKIKIGOUYOBI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANSIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTIKSHRKNGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNKHNBBNJYUTURT)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNWNASIGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTEIKIKOUSINMNRYOUAGE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV5)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKANYUJIDATAKANRINO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKANYUJIKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKANYUUJIHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKANYUUJITENKANHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHSYUIKKTMINAOSIKAISU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSKNNJYNBKNSISNRT)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTKJYKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKTKJYURYUMSRATEHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKTKJYURYUMSRATE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2TOKUJYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2SAKUGENKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2RYOUMASIHYOUTEN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUTEIBUIJYOUKENHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUTEIBUINO1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHTNPKKN1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUTEIBUINO2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHTNPKKN2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMHITUIRYUYUTKTBIJYKNHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUHAITOUIRYOUYOUTKTBINO1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUHAITOUIRYOUYOUTKTBINO2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUHAITOUIRYOUYOUHTNPKKN2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSITEIZUKIPWARIMASIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPWARIMASISITEIM1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPWARIMASISITEIM2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSITEIMSYKYKPBAIRITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAISYUUSITEIYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKKITMTTVKEISANYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKKITMTTSKNNJYNBKNGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDFTUMITATEKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDFTUMIMASIKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNVBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDPBUBUNDFTENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDFTMTTKNGKITJBRBBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHENGAKUJIGYOUNENDOMATUCV)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNITIBUITIJIBARAIP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNITIBITJBRSHRKNGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGOUKEICV)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMINASICV)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNLOANFUND)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAITEIHOSYOUGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHNGKSITIHSYUYUSYKYKP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHIJYNBRIVASBUJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHIJYNBRIVAMNKJSITIHSYUGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIINKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUDKAIMASIKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKAIMASIYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKAIMASIKIKAN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHIKITUGIKAIMASIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUDKAIMASISIHARAIKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKOURYOKUKAISIYMDX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUHOKENSYURUIKIGOUX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKIGOUSEDAIKBNX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKIKANX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUHIHOKENSYAAGEX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUDAI2HIHKNSYAAGEX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZOUKASX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZENNENDOZOUKASX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUSIHARAIKINGAKUX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKOURYOKUKAISIYMDX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUHOKENSYURUIKIGOUX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKIGOUSEDAIKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUKIKANX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUHIHOKENSYAAGEX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUDAI2HIHKNSYAAGEX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZOUKASX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZENNENDOZOUKASX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUSIHARAIKINGAKUX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN1X5)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN1X6)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIMNGKIZKTKYKPMENHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMISYUUSTARTYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMISYUUKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNITJBRTKYKKOUSNUKTKARHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNTEIKIGYOUSEKIHYJS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNDPBBNGYUSKHYJS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKJYOUTAI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPMENHUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKOUSINKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKTIKMNKYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNSYKYKKHNMNKYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNSYKYKTIKMNKYTIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANTEIKIMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUMANKIYOTEIKBNX1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSZOUMANKIYOTEIKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNVESTINGMANKIYOTEIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNVKEISANHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOUKISINKEIYAKUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKYKHOKENHOUTEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUTEIJYOUTAIHUSHRHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYTIRRTHNDSYSNMNSKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN11)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNWNASIGOUKEITENKANKAKAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUKIBARAIKANSANTOKUJYOUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTNKNGKYKKSSNKIJYUYM)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAITEIHOSYOUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN8X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN14)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIMNGTKYKPHRKKAISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIMNGTKYKPHRKKIRKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHRIMNGTKYKPRYURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV13)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNIDOUJISAITEIHOSYOUKNGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNIDOUJISAITEIHOSYOUCOST)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSINHOKENFUNDTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMSYUPTUSSHKGKAIYKHNRIKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUGTNKGETUMATUV)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDNKSAITEIHOSYONKGNS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHENDOUGATANKSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNALMYOUSOHUTOMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSNKYKSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOFTMEISYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKJITOKUJYOUARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNBNKTTNKNKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANMINAOSIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSOUJIKEITENKANKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNENKINKAISINENDO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNENKINGATAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNKNSHRY)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHEIYOUBARAIKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNENKINMARUTEIHUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSINSEIZONMRTIARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSNKYKYOUIBOKIJYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOKUSITUJYUUSITUSETKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIKTSYUKNBYUGNHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPMENSUGUGTGANHSYUNSHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTKYKGYOUSEKIHYJSZEROHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN7)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUSSAIKEITAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV6)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNAATUKAISOSIKICD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNAATUKAIKOJINCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNBSYDRTENCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNCIFCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIV8)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2HIHOKENSYASINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2TOUKEIYOUSINSAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKETTEIKIJYUNKANWAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIHONSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTEIKISIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSONOTASIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMRARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSENTAKUJYOUHOUARIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDUGKTNKNSNTKHUHUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGENGAKUTENKANKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYKGYCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJIDOUKOUSINKYKKANYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAIKOHTNKNKYKKYKYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKOUSINMAESYKYKSBURTKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHJNKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNANNISKCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHJNCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHJNJIGYOSYOCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAIHOKENNO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAKUHIKETTIKEKKACD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2DAKUHIKETTEIKEKKACD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPMENKBNV2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIBOUKYUUHUKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJYUDTHUMEHARAITKYKHKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHAITOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKITUENKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKITUENHONSUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMUSENTAKUKEIYAKUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV6X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNLIVINGNEEDSTKYKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNLIVINGNEEDSSIHARAIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNLNSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNLNSHRGENINCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAKUHIKETTISYACD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDAI2DAKUHIKETTEISYACD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGANSAPOTOKUYAKUARIHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGNSPSHRHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGANSAPOSEIKYUUYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGNSPSHRGENINCD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV3X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNAUTOSWITCHMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUMITATEKINITENARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUMITATEKINITENKAISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDATAKANRINO2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNDATAKANRINO3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKNKUZUSNZYRTTEKINENDO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKNKUZUSNZYRTX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKNKUZUSNZYRTX3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSINKEIYAKUJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTENKANJIKNKUZUSNZYRT)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSINKEIYAKUJIVITHKHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKJIVITHUKUSUUKYKHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN9X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNPWRBKSIDHITEKIYOUHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN9)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN10X7)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN10X8)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN10X9)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUMITATEKINITENBUBUN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSAGAKUSKNNJYNBKNZNDK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X5)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X6)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X7)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X8)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X9)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X10)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X11)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X12)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X13)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X14)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X15)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X16)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X17)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZYRTHNTIYUSTATUSKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZYRTHNTIYUSTATUSKBNX2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZYRTHNTIYUSTATUSKBNX3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZYRTHNTIYUSTATUSKBNX4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNZYRTHNTIYUSTATUSKBNX5)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV10)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV15X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV15X3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV15X4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKAWASERATE1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKAWASERATETEKIYOUYMD1)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKAWASERATE2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKAWASERATETEKIYOUYMD2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKJIKAWASERATE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKJIKAWASERATETKYUYMD)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMVAKEISANJISKNNJYNBKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKAIYAKUKOUJYORITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNRENDOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSRKAIYAKUSJKKKTYOUSEIRRT)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSRKYKSJKKKTYOUSEIRIRITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNMVAKEISANKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNMVATYOUSEIKOU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNENKDTSBUJSITIHSYUCOST)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNENKDTSBUJSITIHSYUARIHYJ)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKEIYAKUJIYOTEIRIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNTUMITATERIRITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKAIGOMAEBARAITKYKARIHYJ)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIBOUHYOUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNYUUKINTUUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSIHARAITUUKAKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNWYENDTTARGETMOKUHYOURITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSISUURENDOURATE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSISUUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTEIRITUIKOUHYOUJI)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSRDAI1HKNKKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN10X11)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNTYKZENOUTOUYMDSISUU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNKIMATUSISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUUKASYUKBN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYENKADATEKIHONS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSITIHSYUMEGKDTSIBOUS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNENKDTSSRENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSISUURENTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNNKSJITIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGAIKADATEJYUUTOUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYENDTTARGETKIJYUNKINGAKU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV7)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSITIVKISNYUKYKJIKWSRATE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSISUURENTYOKUGOTMTTKN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNYOTEIRIRITURIRONBASE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNYOTEIRIRITUJTNYKNBASE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIHRKMPJTNYKNBASE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUPTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSYUPTUMITATEKINGSC)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGAIKADATENKGNS)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJIKAIPJYUUTOUYM2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOBIN9)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGESSITUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGAIKADATETOUGETUJUUTOUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIHRKMPMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKEISANHANTEIYOUTMTTKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGTMTV)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNZETTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSOUTAISIBOURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNSOUTAIKAIYAKURITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVHIREILRITU2)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNPHIREIALPHA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNPHIREIBETA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNPHIREIGANMA)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNPHIREILWRBKRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNYOTEIRIRITUMSUKISYMBASE)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUHKNVKISOVKISNYU1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUHKNVKISOVKISNYU2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUHKNVKISOVKISNYU3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUHKNVKISOVKISNYU4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNRRTHNDUHKNVKISO)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIHARAIKOMIP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNGAIKADATESYUKEIYAKUP)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKYKKJMMVATYOUSEIGOW)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X39)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X41)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X42)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X43)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X44)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X45)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15X3)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15X4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15X5)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15X6)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV14)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNVKIMATUTIRTTUMITATEKIN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIMATUSISUUTUMITATEKIN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVYOUTYKZENOUTOUYMDSISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNTYKZENSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVYOUKIMATUSISUU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKMTSISUUKIJYUNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVYOUTMTTKNZOUKARITUJYGN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVYOUSETTEIBAIRITU)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_RayKimatuVRn.ZRNVYOURENDOURITU)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN3X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV8X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNKIMATUSISUUTYOKUGOTMTTKN)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X19)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X20)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTTIRTTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTTIRTTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTTIRTTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTSSUTUMITATEKINNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTSSUTUMITATEKINNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTSSUTUMITATEKINNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVATYOUSEIGOWNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVAKEISANJIWNPLUS0)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVATYOUSEIGOWNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVAKEISANJIWNPLUS1)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVATYOUSEIGOWNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNJMTMVAKEISANJIWNPLUS2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X21)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X22)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X23)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X4)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X25)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIN11X26)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNSUURIYOUYOBIN15X2)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV15)
    ...
    @Column(name=GenZT_RayKimatuVRn.ZRNYOBIV20)
