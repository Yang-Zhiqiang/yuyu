...
/**
 * 通常配当所要額Ｆ（Ｎ＋０）テーブル（連） テーブルのマッピング情報クラスで、 {@link ZT_TjHitsyyugkNplusZeroRn} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZrnsequenceno zrnsequenceno}</td><td>（連携用）シーケンス番号</td><td align="center">{@link PKZT_TjHitsyyugkNplusZeroRn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_TjHitsyyugkNplusZeroRn.TABLE_NAME)
@IdClass(value=PKZT_TjHitsyyugkNplusZeroRn.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_TjHitsyyugkNplusZeroRn extends AbstractExDBEntityForZDB<ZT_TjHitsyyugkNplusZeroRn, PKZT_TjHitsyyugkNplusZeroRn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_TjHitsyyugkNplusZeroRn";
    ...
    private final PKZT_TjHitsyyugkNplusZeroRn primaryKey;

    public GenZT_TjHitsyyugkNplusZeroRn() {
        primaryKey = new PKZT_TjHitsyyugkNplusZeroRn();
    }

    public GenZT_TjHitsyyugkNplusZeroRn(Integer pZrnsequenceno) {
        primaryKey = new PKZT_TjHitsyyugkNplusZeroRn(pZrnsequenceno);
    }

    @Transient
    @Override
    public PKZT_TjHitsyyugkNplusZeroRn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_TjHitsyyugkNplusZeroRn> getMetaClass() {
        return QZT_TjHitsyyugkNplusZeroRn.class;
    }

    @Id
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSEQUENCENO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYUUKOURECORDLENGTH)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNRDWAREA)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNERRKBNV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNRATEKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKEISANDNENDO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKEIJYOUYM)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYOUINKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKBNKEIRIYOUSEGMENTKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKBNKEIRIYOURGNBNSKKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUSYURUICDV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNDAIHYOUYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHARAIKATAKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNENKINKAISIGOHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKYKJYOUTAI)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUTEIKIYOTEIRIRITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEIGYOUSEKIHYOUJIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYKYKGYUSEKIHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTNKNITJBRSYKYKGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNDATAKANRINO)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHKNSYUKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNANNAIFUYOURIYUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTKBTHSYUMNRYUHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKYKYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHHKNSEIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHIHOKENSYAAGEV2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHKNKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNPHRKKIKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSAIMNKKYKHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHRKKAISUUKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNANNAIKIGETU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNAO3TYOU3SIBOUSDATEHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKIHONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHARAIZUMIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHARAIZUMIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNENTYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSEIZONS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNPMENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKISYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTNKNTEIKINKSHRKKN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEITENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEITENKANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEIPBUBUNTENKANS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKAISUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNDGOUKEI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJSRANKBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNBAIRITUBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTIKBAIRTBETUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYKYKKHNHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUKEIYAKUTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYKYKTIKHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANKIHONHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIRAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIHISADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTYUSIYUTNKNTIKGUKD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTYUSIYUTNKNTIKSISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTYUSIYUTNKNTIKRISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTYUSIYUTNKNTIKHISD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTNKNTIKDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTNKNTIKDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSYUMTJTNKNTIKDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHENDOUDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAISISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBUITIJIBARAIDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBITJBRHISADTISYUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSZOUKOURYOKUKAISIYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSZOUHOKENSYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSZOUKIKAN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSZOUHIHOKENSYAAGE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKAGOUKEID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKASISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKARISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKARAMUDAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKAHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKADTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKADYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNZOUKADKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSASYURUIKGU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAMANRYOUJID)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSASYURUIKIGOU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNSISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNRISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNHISAD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNDTAISYOUS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNDYOUV)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANPBUBUNDKIKENS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUGATATEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUGATANENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNVHKTGBBNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHIKITUGITENKANPHIREIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNITIBITJBRGYUSKHYJS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKARIWARIATE4NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKARIWARIATE3NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKARIWARIATE2NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKARIWARIATE1NENMAE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGUKISISNTNKNTIKMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEISEISANTEIKIS)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGUKISISNTNKNNENKNSNP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTNKNTIKHTNKNKYKYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANGOPHIREIMURITU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEITENKANNENKANSANP)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEITENKANTEIKIMUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTYOUKIKEIZOKUTOKUBETUD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTYOUSEIMAED)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTUUTOKUHITUUSAND)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHKNSYURUIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSZOUKIGOUSEDAIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNMANKIHYOUJI)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKEIYAKUOUTOUBIKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSUURIYOUYOBIN2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUHUKASUU)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI1X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI2X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHOKENSYURUIKIGOUYOBI3X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTENKANTEIKIKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUYBX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUYBX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUYBX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUYBX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAKUTEIKAKUSAKGUYBX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUMARUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKGUSDKBN)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKIGOUYOBIX1)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKIGOUYOBIX2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKIGOUYOBIX3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKIGOUYOBIX4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNNAIZOUKAKUSAKIGOUYOBIX5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYOBIV92)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNRAYSYSTEMHYJ)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGAIKAKBN)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAWASERATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKAWASERATETEKIYOUYMD)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNENKDTSBUJSITIHSYUKNGK)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSUURIYOUYOBIN10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYOBIV10X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYOBIN11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYOBIN11X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNYOBIV17)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNSISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNRISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNHISADRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNDYOUVRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNKIKENSRATE)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNGOUKEIDRATE)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X2)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X3)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X4)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X5)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X6)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X7)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X8)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X9)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X10)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X11)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X12)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X13)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X14)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X15)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X16)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X17)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X18)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X19)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X20)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X21)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X22)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X23)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X24)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X25)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X26)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X27)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X28)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X29)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X30)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X31)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X32)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X33)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X34)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X35)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X36)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X37)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X38)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X39)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X40)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X41)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X42)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X43)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X44)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X45)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X46)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X47)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X48)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X49)
    ...
    @Column(name=GenZT_TjHitsyyugkNplusZeroRn.ZRNTOKUYAKUKOUMOKUV180X50)
