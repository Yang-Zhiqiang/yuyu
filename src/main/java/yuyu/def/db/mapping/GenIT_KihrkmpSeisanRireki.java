...
import yuyu.def.db.id.PKIT_KihrkmpSeisanRireki;
...
/**
 * 既払込Ｐ精算履歴テーブル テーブルのマッピング情報クラスで、 {@link IT_KihrkmpSeisanRireki} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KihrkmpSeisanRireki}</td><td colspan="3">既払込Ｐ精算履歴テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KihrkmpSeisanRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KihrkmpSeisanRireki ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_KihrkmpSeisanRireki ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * @see     PKIT_KihrkmpSeisanRireki
 * @see     QIT_KihrkmpSeisanRireki
 * @see     GenQIT_KihrkmpSeisanRireki
 */
@MappedSuperclass
@Table(name=GenIT_KihrkmpSeisanRireki.TABLE_NAME)
@IdClass(value=PKIT_KihrkmpSeisanRireki.class)
@TypeDefs({
...
public abstract class GenIT_KihrkmpSeisanRireki extends AbstractExDBEntity<IT_KihrkmpSeisanRireki, PKIT_KihrkmpSeisanRireki> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KihrkmpSeisanRireki";
    ...
    private final PKIT_KihrkmpSeisanRireki primaryKey;

    public GenIT_KihrkmpSeisanRireki() {
        primaryKey = new PKIT_KihrkmpSeisanRireki();
    }
    ...
    @Transient
    @Override
    public PKIT_KihrkmpSeisanRireki getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KihrkmpSeisanRireki> getMetaClass() {
        return QIT_KihrkmpSeisanRireki.class;
    }

    @Id
    @Column(name=GenIT_KihrkmpSeisanRireki.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KihrkmpSeisanRireki.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KihrkmpSeisanRireki.RENNO)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.HENKOUSIKIBETUKEY)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.KOURYOKUHASSEIYMD)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.KIHRKPSSNAIYOUKBN)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.JYUUTOUYM)
    @ValidDateYm
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.SEIJYUTOUKAISUUM)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.SEIJYUTOUKAISUUY)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.MISYUUMIKEIKAKBN)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.RSTUUKASYU)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KihrkmpSeisanRireki.YENKANSANTKYKWSRATEYMD)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.YENKANSANTKYKWSRATE)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KihrkmpSeisanRireki.ZEIMUKWSRATEKJNYMD)
    ...
    @Type(type="BizNumberType")
    @Column(name=GenIT_KihrkmpSeisanRireki.ZEIMUKWSRATE)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KihrkmpSeisanRireki.GYOUMUKOUSINTIME)
