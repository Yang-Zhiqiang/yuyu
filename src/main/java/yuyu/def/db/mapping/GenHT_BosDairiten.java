...
import yuyu.def.db.id.PKHT_BosDairiten;
...
/**
 * 募集代理店テーブル テーブルのマッピング情報クラスで、 {@link HT_BosDairiten} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_BosDairiten}</td><td colspan="3">募集代理店テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getMosno mosno}</td><td>申込番号</td><td align="center">{@link PKHT_BosDairiten ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKHT_BosDairiten ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     HT_BosDairiten
 * @see     PKHT_BosDairiten
 * @see     QHT_BosDairiten
 * @see     GenQHT_BosDairiten
 */
@MappedSuperclass
@Table(name=GenHT_BosDairiten.TABLE_NAME)
@IdClass(value=PKHT_BosDairiten.class)
@TypeDefs({
...
public abstract class GenHT_BosDairiten extends AbstractExDBEntity<HT_BosDairiten, PKHT_BosDairiten> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_BosDairiten";
    ...
    private final PKHT_BosDairiten primaryKey;

    public GenHT_BosDairiten() {
        primaryKey = new PKHT_BosDairiten();
    }

    public GenHT_BosDairiten(String pMosno, Integer pRenno) {
        primaryKey = new PKHT_BosDairiten(pMosno, pRenno);
    }

    @Transient
    @Override
    public PKHT_BosDairiten getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_BosDairiten> getMetaClass() {
        return QHT_BosDairiten.class;
    }

    @Id
    @Column(name=GenHT_BosDairiten.MOSNO)
    @MousikomiNo
    ...
    @Id
    @Column(name=GenHT_BosDairiten.RENNO)
    ...
    @Column(name=GenHT_BosDairiten.BSYUJOYADRTENCD)
    ...
    @Column(name=GenHT_BosDairiten.DRTENSYKBN)
    ...
    @Column(name=GenHT_BosDairiten.KINYUUCD)
    ...
    @Column(name=GenHT_BosDairiten.KINYUUSITENCD)
    ...
    @Column(name=GenHT_BosDairiten.TRATKIAGCD)
    ...
    @Column(name=GenHT_BosDairiten.OYADRTENCD)
    @SingleByteStrings
    @AlphaDigit
    ...
    @Column(name=GenHT_BosDairiten.JIMUSYOCD)
    @Length(length=4)
    @AlphaDigit
    ...
    @Column(name=GenHT_BosDairiten.BOSYUUTRKNO)
    ...
    @Column(name=GenHT_BosDairiten.CIFCD)
    @MaxLength(max=15)
    @AlphaDigit
    ...
    @Column(name=GenHT_BosDairiten.DRTENCD)
    @MaxLength(max=7)
    @AlphaDigit
    ...
    @Column(name=GenHT_BosDairiten.BOSYUUCD)
    @MaxLength(max=6)
    @AlphaDigit
    ...
    @Column(name=GenHT_BosDairiten.INPUTBOSYUUCD)
    @Length(length=7)
    @Digit
    @Modulus10w21
    ...
    @Column(name=GenHT_BosDairiten.DAIBOSYUUCD)
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_BosDairiten.TRATKIKOUINNCD)
    ...
    @Column(name=GenHT_BosDairiten.YUUSEIKBN)
    ...
    @Column(name=GenHT_BosDairiten.KYOKUSYOCD)
    ...
    @Column(name=GenHT_BosDairiten.YUUSEISYAINNO)
    ...
    @Column(name=GenHT_BosDairiten.BUNWARI)
    ...
    @Column(name=GenHT_BosDairiten.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_BosDairiten.GYOUMUKOUSINTIME)
