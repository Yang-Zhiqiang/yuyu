...
import yuyu.def.db.id.PKIT_KoujyoSymSougou;
...
/**
 * 控除証明書（総合通知用）テーブル テーブルのマッピング情報クラスで、 {@link IT_KoujyoSymSougou} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IT_KoujyoSymSougou}</td><td colspan="3">控除証明書（総合通知用）テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKbnkey kbnkey}</td><td>区分キー</td><td align="center">{@link PKIT_KoujyoSymSougou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getSyono syono}</td><td>証券番号</td><td align="center">{@link PKIT_KoujyoSymSougou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getNendo nendo}</td><td>年度</td><td align="center">{@link PKIT_KoujyoSymSougou ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getKktyhysksitisykbn kktyhysksitisykbn}</td><td>契約管理帳票作成対象区分</td><td align="center">&nbsp;</td><td align="center">V</td><td>{@link C_Kktyhysksitisy}</td></tr>
 *  <tr><td>{@link #getTyouhyouymd tyouhyouymd}</td><td>帳票作成日</td><td align="center">{@link PKIT_KoujyoSymSougou ○}</td><td align="center">V</td><td>BizDate</td></tr>
 *  <tr><td>{@link #getRenno renno}</td><td>連番</td><td align="center">{@link PKIT_KoujyoSymSougou ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 *  <tr><td>{@link #getHaitouhoukbn haitouhoukbn}</td><td>配当方法区分</td><td align="center">&nbsp;</td><td align="center">V</td><td>{@link C_HaitouhouKbn}</td></tr>
 ...
 * @see     PKIT_KoujyoSymSougou
 * @see     QIT_KoujyoSymSougou
 * @see     GenQIT_KoujyoSymSougou
 */
@MappedSuperclass
@Table(name=GenIT_KoujyoSymSougou.TABLE_NAME)
@IdClass(value=PKIT_KoujyoSymSougou.class)
@TypeDefs({
    @TypeDef(name="BizCurrencyType", typeClass=BizCurrencyType.class),
    @TypeDef(name="BizDateType", typeClass=BizDateType.class),
    @TypeDef(name="BizDateYMType", typeClass=BizDateYMType.class),
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class),
    @TypeDef(name="UserType_C_HaitouhouKbn", typeClass=UserType_C_HaitouhouKbn.class),
    ...
    @TypeDef(name="UserType_C_Kktyhysksitisy", typeClass=UserType_C_Kktyhysksitisy.class),
...
public abstract class GenIT_KoujyoSymSougou extends AbstractExDBEntity<IT_KoujyoSymSougou, PKIT_KoujyoSymSougou> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IT_KoujyoSymSougou";
    public static final String KBNKEY                   = "kbnkey";
    public static final String SYONO                    = "syono";
    public static final String NENDO                    = "nendo";
    public static final String KKTYHYSKSITISYKBN        = "kktyhysksitisykbn";
    ...
    public static final String HAITOUHOUKBN             = "haitouhoukbn";
    ...
    private final PKIT_KoujyoSymSougou primaryKey;

    public GenIT_KoujyoSymSougou() {
        primaryKey = new PKIT_KoujyoSymSougou();
    }
    ...
    @Transient
    @Override
    public PKIT_KoujyoSymSougou getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIT_KoujyoSymSougou> getMetaClass() {
        return QIT_KoujyoSymSougou.class;
    }

    @Id
    @Column(name=GenIT_KoujyoSymSougou.KBNKEY)
    ...
    @Id
    @Column(name=GenIT_KoujyoSymSougou.SYONO)
    @SyoukenNo
    ...
    @Id
    @Column(name=GenIT_KoujyoSymSougou.NENDO)
    ...
    private C_Kktyhysksitisy kktyhysksitisykbn;

    @Type(type="UserType_C_Kktyhysksitisy")
    @Column(name=GenIT_KoujyoSymSougou.KKTYHYSKSITISYKBN)
    public C_Kktyhysksitisy getKktyhysksitisykbn() {
        return kktyhysksitisykbn;
    }

    public void setKktyhysksitisykbn(C_Kktyhysksitisy pKktyhysksitisykbn) {
        kktyhysksitisykbn = pKktyhysksitisykbn;
    }

    @Id
    @Type(type="BizDateType")
    @Column(name=GenIT_KoujyoSymSougou.TYOUHYOUYMD)
    @ValidDate
    ...
    @Id
    @Column(name=GenIT_KoujyoSymSougou.RENNO)
    ...
    @Column(name=GenIT_KoujyoSymSougou.TEKIYOUSEIDOKBN)
    ...
    @Column(name=GenIT_KoujyoSymSougou.SYOUMEIYMD)
    ...
    @Column(name=GenIT_KoujyoSymSougou.SYOUMEISTARTYM)
    ...
    @Type(type="BizDateYMType")
    @Column(name=GenIT_KoujyoSymSougou.SYOUMEIENDYM)
    ...
    @Column(name=GenIT_KoujyoSymSougou.SYOUMEIKKNTUKISUU)
    ...
    @Column(name=GenIT_KoujyoSymSougou.KYKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KoujyoSymSougou.UKTNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenIT_KoujyoSymSougou.HKNSYURUINMRYKKJ)
    ...
    @Type(type="BizDateType")
    @Column(name=GenIT_KoujyoSymSougou.KYKYMD)
    ...
    @Column(name=GenIT_KoujyoSymSougou.HKNKKNSMNKBNSYU)
    ...
    @Column(name=GenIT_KoujyoSymSougou.HKNKKNSYU)
    ...
    @Column(name=GenIT_KoujyoSymSougou.NENKANHRKKAISUU)
    ...
    @Column(name=GenIT_KoujyoSymSougou.KYKJYOUTAI)
    ...
    @Column(name=GenIT_KoujyoSymSougou.YUUKOUSYOUMETUKBN)
    ...
    private C_HaitouhouKbn haitouhoukbn;

    @Type(type="UserType_C_HaitouhouKbn")
    @Column(name=GenIT_KoujyoSymSougou.HAITOUHOUKBN)
    public C_HaitouhouKbn getHaitouhoukbn() {
        return haitouhoukbn;
    }

    public void setHaitouhoukbn(C_HaitouhouKbn pHaitouhoukbn) {
        haitouhoukbn = pHaitouhoukbn;
    }

    private C_HaitoukinuketorihouKbn haitoukinuketorihoukbn;

    @Type(type="UserType_C_HaitoukinuketorihouKbn")
    @Column(name=GenIT_KoujyoSymSougou.HAITOUKINUKETORIHOUKBN)
    ...
    @Column(name=GenIT_KoujyoSymSougou.RTRATKICD)
    ...
    @Column(name=GenIT_KoujyoSymSougou.RTYOUHYOUCD)
    ...
    @Column(name=GenIT_KoujyoSymSougou.TYHYRENRAKUSIKIBETUKBN)
    ...
    @Column(name=GenIT_KoujyoSymSougou.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIT_KoujyoSymSougou.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIT_KoujyoSymSougou.GYOUMUKOUSINTIME)
