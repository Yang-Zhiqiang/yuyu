...
import yuyu.def.db.id.PKMT_DsKokyakuKanri;
...
/**
 * ＤＳ顧客管理テーブル テーブルのマッピング情報クラスで、 {@link MT_DsKokyakuKanri} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link MT_DsKokyakuKanri}</td><td colspan="3">ＤＳ顧客管理テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getDskokno dskokno}</td><td>ＤＳ顧客番号</td><td align="center">{@link PKMT_DsKokyakuKanri ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKMT_DsKokyakuKanri
 * @see     QMT_DsKokyakuKanri
 * @see     GenQMT_DsKokyakuKanri
 */
@MappedSuperclass
@Table(name=GenMT_DsKokyakuKanri.TABLE_NAME)
@IdClass(value=PKMT_DsKokyakuKanri.class)
@TypeDefs({
...
public abstract class GenMT_DsKokyakuKanri extends AbstractExDBEntity<MT_DsKokyakuKanri, PKMT_DsKokyakuKanri> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "MT_DsKokyakuKanri";
    ...
    private final PKMT_DsKokyakuKanri primaryKey;

    public GenMT_DsKokyakuKanri() {
        primaryKey = new PKMT_DsKokyakuKanri();
    }

    public GenMT_DsKokyakuKanri(String pDskokno) {
        primaryKey = new PKMT_DsKokyakuKanri(pDskokno);
    }

    @Transient
    @Override
    public PKMT_DsKokyakuKanri getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QMT_DsKokyakuKanri> getMetaClass() {
        return QMT_DsKokyakuKanri.class;
    }

    @Id
    @Column(name=GenMT_DsKokyakuKanri.DSKOKNO)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUJTKBN)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUSAKUSEIYMD)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSTEISIRIYUUKBN)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUMUKOUYMD)
    ...
    @Column(name=GenMT_DsKokyakuKanri.SEISAHUYOUHYJ)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUNMKN)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUNMKJ)
    ...
    @Type(type="BizDateType")
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUSEIYMD)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKOKYAKUYNO)
    ...
    @Column(name=GenMT_DsKokyakuKanri.DSKANYUUKEIROKBN)
    ...
    @Column(name=GenMT_DsKokyakuKanri.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenMT_DsKokyakuKanri.GYOUMUKOUSINTIME)
    ...
    @Column(name=GenMT_DsKokyakuKanri.GYOUMUKOUSINSYAID)
