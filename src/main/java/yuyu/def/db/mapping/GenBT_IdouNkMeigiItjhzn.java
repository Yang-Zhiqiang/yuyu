...
import yuyu.def.db.id.PKBT_IdouNkMeigiItjhzn;
import yuyu.def.db.meta.GenQBT_IdouNkMeigiItjhzn;
...
/**
 * 異動年金支払名義管理一時保存テーブル テーブルのマッピング情報クラスで、 {@link BT_IdouNkMeigiItjhzn} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link BT_IdouNkMeigiItjhzn}</td><td colspan="3">異動年金支払名義管理一時保存テーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getNksysyno nksysyno}</td><td>年金証書番号</td><td align="center">{@link PKBT_IdouNkMeigiItjhzn ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getRenno3keta renno3keta}</td><td>連番（３桁）</td><td align="center">{@link PKBT_IdouNkMeigiItjhzn ○}</td><td align="center">N</td><td>Integer</td></tr>
 ...
 * </table>
 * @see     BT_IdouNkMeigiItjhzn
 * @see     PKBT_IdouNkMeigiItjhzn
 * @see     QBT_IdouNkMeigiItjhzn
 * @see     GenQBT_IdouNkMeigiItjhzn
 */
@MappedSuperclass
@Table(name=GenBT_IdouNkMeigiItjhzn.TABLE_NAME)
@IdClass(value=PKBT_IdouNkMeigiItjhzn.class)
@TypeDefs({
    @TypeDef(name="BizDateType", typeClass=BizDateType.class),
    @TypeDef(name="UserType_C_Hhknsei", typeClass=UserType_C_Hhknsei.class)
})
public abstract class GenBT_IdouNkMeigiItjhzn extends AbstractExDBEntity<BT_IdouNkMeigiItjhzn, PKBT_IdouNkMeigiItjhzn> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "BT_IdouNkMeigiItjhzn";
    ...
    private final PKBT_IdouNkMeigiItjhzn primaryKey;

    public GenBT_IdouNkMeigiItjhzn() {
        primaryKey = new PKBT_IdouNkMeigiItjhzn();
    }

    public GenBT_IdouNkMeigiItjhzn(String pNksysyno, Integer pRenno3keta) {
        primaryKey = new PKBT_IdouNkMeigiItjhzn(pNksysyno, pRenno3keta);
    }

    @Transient
    @Override
    public PKBT_IdouNkMeigiItjhzn getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QBT_IdouNkMeigiItjhzn> getMetaClass() {
        return QBT_IdouNkMeigiItjhzn.class;
    }

    @Id
    @Column(name=GenBT_IdouNkMeigiItjhzn.NKSYSYNO)
    @NenkinSyousyoNo
    ...
    @Id
    @Column(name=GenBT_IdouNkMeigiItjhzn.RENNO3KETA)
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNSEI)
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.HHKNSYKGYCD)
    @MaxLength(max=3)
    @AlphaDigit
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.NENKINUKTNMKANA)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.NENKINUKTNMKANJI)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Type(type="BizDateType")
    @Column(name=GenBT_IdouNkMeigiItjhzn.NENKINUKTSEIYMD)
    @ValidDate
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.TSINYNO)
    @Length(length=7)
    @SingleByteStrings
    @Digit
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.TSINADR1KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.TSINADR2KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.TSINADR3KJ)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.TSINTELNO)
    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.STDRSKNMKN)
    @MaxLength(max=18)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenBT_IdouNkMeigiItjhzn.STDRSKNMKJ)
    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
