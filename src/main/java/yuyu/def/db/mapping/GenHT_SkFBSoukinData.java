...
import yuyu.def.db.id.PKHT_SkFBSoukinData;
...
/**
 * 新契約ＦＢ送金データテーブル テーブルのマッピング情報クラスで、 {@link HT_SkFBSoukinData} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link HT_SkFBSoukinData}</td><td colspan="3">新契約ＦＢ送金データテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getFbsoukindatasikibetukey fbsoukindatasikibetukey}</td><td>ＦＢ送金データ識別キー</td><td align="center">{@link PKHT_SkFBSoukinData ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     PKHT_SkFBSoukinData
 * @see     QHT_SkFBSoukinData
 * @see     GenQHT_SkFBSoukinData
 */
@MappedSuperclass
@Table(name=GenHT_SkFBSoukinData.TABLE_NAME)
@IdClass(value=PKHT_SkFBSoukinData.class)
@TypeDefs({
...
public abstract class GenHT_SkFBSoukinData extends AbstractExDBEntity<HT_SkFBSoukinData, PKHT_SkFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "HT_SkFBSoukinData";
    ...
    private final PKHT_SkFBSoukinData primaryKey;

    public GenHT_SkFBSoukinData() {
        primaryKey = new PKHT_SkFBSoukinData();
    }

    public GenHT_SkFBSoukinData(String pFbsoukindatasikibetukey) {
        primaryKey = new PKHT_SkFBSoukinData(pFbsoukindatasikibetukey);
    }

    @Transient
    @Override
    public PKHT_SkFBSoukinData getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QHT_SkFBSoukinData> getMetaClass() {
        return QHT_SkFBSoukinData.class;
    }

    @Id
    @Column(name=GenHT_SkFBSoukinData.FBSOUKINDATASIKIBETUKEY)
    ...
    @Column(name=GenHT_SkFBSoukinData.DENRENNO)
    ...
    @Column(name=GenHT_SkFBSoukinData.EDANO)
    ...
    @Column(name=GenHT_SkFBSoukinData.DENSYSKBN)
    ...
    @Column(name=GenHT_SkFBSoukinData.GYOUMUCD)
    ...
    @Column(name=GenHT_SkFBSoukinData.TANTOSITUCD)
    ...
    @Column(name=GenHT_SkFBSoukinData.SYORICD)
    ...
    @Column(name=GenHT_SkFBSoukinData.SYORISOSIKICD)
    ...
    @Column(name=GenHT_SkFBSoukinData.SYORIYMD)
    @ValidDate
    ...
    @Type(type="BizDateType")
    @Column(name=GenHT_SkFBSoukinData.DENYMD)
    ...
    @Column(name=GenHT_SkFBSoukinData.MOSNO)
    @MousikomiNo
    ...
    @Column(name=GenHT_SkFBSoukinData.SHRHOUSITEIKBN)
    ...
    @Column(name=GenHT_SkFBSoukinData.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenHT_SkFBSoukinData.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenHT_SkFBSoukinData.YOKINKBN)
    ...
    @Column(name=GenHT_SkFBSoukinData.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenHT_SkFBSoukinData.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenHT_SkFBSoukinData.KYKTUUKASYU)
    ...
    @Column(name=GenHT_SkFBSoukinData.SOUKINKWSRATE)
    ...
    @Column(name=GenHT_SkFBSoukinData.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenHT_SkFBSoukinData.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenHT_SkFBSoukinData.GYOUMUKOUSINTIME)
