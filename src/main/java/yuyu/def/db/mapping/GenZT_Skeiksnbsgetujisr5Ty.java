...
/**
 * 新契約決算ベース月次成立Ｆテーブル５（中） テーブルのマッピング情報クラスで、 {@link ZT_Skeiksnbsgetujisr5Ty} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtyktgysyono ztyktgysyono}</td><td>（中継用）結合用証券番号</td><td align="center">{@link PKZT_Skeiksnbsgetujisr5Ty ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_Skeiksnbsgetujisr5Ty.TABLE_NAME)
@IdClass(value=PKZT_Skeiksnbsgetujisr5Ty.class)
@TypeDefs({
    @TypeDef(name="BizNumberType", typeClass=BizNumberType.class)
})
public abstract class GenZT_Skeiksnbsgetujisr5Ty extends AbstractExDBEntity<ZT_Skeiksnbsgetujisr5Ty, PKZT_Skeiksnbsgetujisr5Ty> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_Skeiksnbsgetujisr5Ty";
    ...
    private final PKZT_Skeiksnbsgetujisr5Ty primaryKey;

    public GenZT_Skeiksnbsgetujisr5Ty() {
        primaryKey = new PKZT_Skeiksnbsgetujisr5Ty();
    }

    public GenZT_Skeiksnbsgetujisr5Ty(String pZtyktgysyono) {
        primaryKey = new PKZT_Skeiksnbsgetujisr5Ty(pZtyktgysyono);
    }

    @Transient
    @Override
    public PKZT_Skeiksnbsgetujisr5Ty getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_Skeiksnbsgetujisr5Ty> getMetaClass() {
        return QZT_Skeiksnbsgetujisr5Ty.class;
    }

    private String ztyktgysyrymd;

    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKTGYSYRYMD)
    ...
    @Id
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKTGYSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKTGYFILERENNO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYAATUKAISYABOSYUUDIRTNCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYBATUKAISYABOSYUUDIRTNCD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYBOSYUUKEITAIKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKESSANKEIJYOUYM)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHTNKNTMTTSYUSNHKNARIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYTOKUBETUHOSYOUKIKAN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYGOUKEINENBARAIKANSANP3X6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHKTGTIKKIKKKN3X6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKAPPADHKTGKUJYGKX6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHUTIHNNNKKNNZMKYKSYONO)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYMUSYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYMOSNYUURYOKUYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYMOSSYOSAKUSEIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKOKUTIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDAI2KOKUTIYMD)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYJYUURYOUSYOURYAKUKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKSYURUIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSENSINIRYOUTOKUYAKUKIKAN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSENSINIRYOUTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSENSINIRYOUTOKUYAKUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSENSINIRYOUTOKUYAKUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSENSINIRYOUTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYSNSNIRYUTKYKKUSNMNRYOAGE)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYYOBIV4X17)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKSYRIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDAI2SNSNIRYUTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDAI2SENSINIRYOUTOKUYAKUS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDAI2SENSINIRYOUTOKUYAKUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2SNSNIRYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYYOBIV6X3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYKYKSYAAGETYOUSEIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDAI2HHKNNENTYSIHYJ)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYHSYUMNOSJDFTMTTZNDK)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKSYRIKGU)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYINHSYJYJTTKYKPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKYKS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKYKP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYINHSYJYJTTKJYRYMSHYTN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKYKTKJYUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYUJTHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYINHSYJYJTTKYKKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYINHSYJYJTTKYKPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKKGUYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKKGUYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKKGUYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKKGUYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYUINHSYUJYJTTKYKKGUYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYNYINHSYJYJTKYKKSNMNRYAGE)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYYOBIV5X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKSYRIKG)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYUJTTKYKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYJTPHRKKKN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYUJTTKYKS)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYUJTTKYKP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYHSYJYJTTKJYRYMSHYTN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYUJTTKJYUP)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUTKTBICDX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUHTNPKKNX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUTKTBICDX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUHTNPKKNX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYUJYJTKGUSDKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYUINHSYUJYJTPWRBKKBN)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKKGYBX1)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKKGYBX2)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKKGYBX3)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKKGYBX4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYDI2NYINHSYJYJTTKYKKGYBX5)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYYOBIV7X6)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZTYYOBIV1X4)
    ...
    @Column(name=GenZT_Skeiksnbsgetujisr5Ty.ZT