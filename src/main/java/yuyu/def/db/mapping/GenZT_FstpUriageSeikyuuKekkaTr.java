...
/**
 * 初回保険料売上請求結果テーブル（取） テーブルのマッピング情報クラスで、 {@link ZT_FstpUriageSeikyuuKekkaTr} のスーパークラスです。<br />
 ...
 *  <tr><td>{@link #getZtruriageymd6keta ztruriageymd6keta}</td><td>（取込用）売上年月日（６桁）</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtrcreditkessaiyouno ztrcreditkessaiyouno}</td><td>（取込用）クレジットカード決済用番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrsyono ztrsyono}</td><td>（取込用）証券番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaTr ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtrrecordno ztrrecordno}</td><td>（取込用）レコード番号</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaTr ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtrseikyuukngk ztrseikyuukngk}</td><td>（取込用）請求金額</td><td align="center">{@link PKZT_FstpUriageSeikyuuKekkaTr ○}</td><td align="center">N</td><td>Long</td></tr>
 ...
 */
@MappedSuperclass
@Table(name=GenZT_FstpUriageSeikyuuKekkaTr.TABLE_NAME)
@IdClass(value=PKZT_FstpUriageSeikyuuKekkaTr.class)
public abstract class GenZT_FstpUriageSeikyuuKekkaTr extends AbstractExDBEntity<ZT_FstpUriageSeikyuuKekkaTr, PKZT_FstpUriageSeikyuuKekkaTr> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_FstpUriageSeikyuuKekkaTr";
    ...
    private final PKZT_FstpUriageSeikyuuKekkaTr primaryKey;

    public GenZT_FstpUriageSeikyuuKekkaTr() {
        primaryKey = new PKZT_FstpUriageSeikyuuKekkaTr();
    }
    ...
    @Transient
    @Override
    public PKZT_FstpUriageSeikyuuKekkaTr getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_FstpUriageSeikyuuKekkaTr> getMetaClass() {
        return QZT_FstpUriageSeikyuuKekkaTr.class;
    }

    private String ztrrecordkbn;

    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRRECORDKBN)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRAUTHORIKBN)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRURIAGESEIKYUUTORIHIKICD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRYOBIV14)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRURIAGETAISYOUYM)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRURIAGEYMD6KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRCREDITKIGYOUCD)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRCREDITKESSAIYOUNO)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRSYONO)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRRECORDNO)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRYOBIV3)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRCARDYUUKOUKIGEN)
    ...
    @Id
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRSEIKYUUKNGK)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRYOBIV5)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRCREDITKAIINNOKAMI6KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRYOBIV6)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRCREDITKAIINNOSIMO4KETA)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRURIAGESEIKYUUERRORCD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRHURIKAEKEKKACD)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRFUKUSUUKAMEITENNOKEY)
    ...
    @Column(name=GenZT_FstpUriageSeikyuuKekkaTr.ZTRYOBIV1)
