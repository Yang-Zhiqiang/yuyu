...
import yuyu.def.db.id.PKIW_KhSiharaiKouzaHenkouWk;
import yuyu.def.db.meta.GenQIW_KhSiharaiKouzaHenkouWk;
...
/**
 * 支払口座情報変更ワークテーブル テーブルのマッピング情報クラスで、 {@link IW_KhSiharaiKouzaHenkouWk} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link IW_KhSiharaiKouzaHenkouWk}</td><td colspan="3">支払口座情報変更ワークテーブル</td></tr>
 *  <tr bgcolor="whitesmoke"><th>フィールドID</th><th>フィールド名</th><th>PKey</th><th>DB型</th><th>Java型</th></tr>
 *  <tr><td>{@link #getKouteikanriid kouteikanriid}</td><td>工程管理ＩＤ</td><td align="center">{@link PKIW_KhSiharaiKouzaHenkouWk ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     IW_KhSiharaiKouzaHenkouWk
 * @see     PKIW_KhSiharaiKouzaHenkouWk
 * @see     QIW_KhSiharaiKouzaHenkouWk
 * @see     GenQIW_KhSiharaiKouzaHenkouWk
 */
@MappedSuperclass
@Table(name=GenIW_KhSiharaiKouzaHenkouWk.TABLE_NAME)
@IdClass(value=PKIW_KhSiharaiKouzaHenkouWk.class)
@TypeDefs({
...
public abstract class GenIW_KhSiharaiKouzaHenkouWk extends AbstractExDBEntity<IW_KhSiharaiKouzaHenkouWk, PKIW_KhSiharaiKouzaHenkouWk> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "IW_KhSiharaiKouzaHenkouWk";
    ...
    private final PKIW_KhSiharaiKouzaHenkouWk primaryKey;

    public GenIW_KhSiharaiKouzaHenkouWk() {
        primaryKey = new PKIW_KhSiharaiKouzaHenkouWk();
    }

    public GenIW_KhSiharaiKouzaHenkouWk(String pKouteikanriid) {
        primaryKey = new PKIW_KhSiharaiKouzaHenkouWk(pKouteikanriid);
    }

    @Transient
    @Override
    public PKIW_KhSiharaiKouzaHenkouWk getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QIW_KhSiharaiKouzaHenkouWk> getMetaClass() {
        return QIW_KhSiharaiKouzaHenkouWk.class;
    }

    @Id
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.KOUTEIKANRIID)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.SYONO)
    @SyoukenNo
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.SKSSAKUSEIYMD)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.KZSYURUIKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.BANKCD)
    @Length(length=4)
    @Digit
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.SITENCD)
    @Length(length=3)
    @Digit
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.YOKINKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.KOUZANO)
    @MaxLength(max=12)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.KZDOUKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.KZMEIGINMKN)
    @MaxLength(max=30)
    @MultiByteStrings
    @InvalidCharacter
    @HostInvalidCharacter
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.HONNINKAKNINKEKKAKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.HASSOUKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.ZENKAISYORIKEKKAKBN)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.GYOUMUKOUSINKINOU)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.GYOUMUKOUSINSYAID)
    ...
    @Column(name=GenIW_KhSiharaiKouzaHenkouWk.GYOUMUKOUSINTIME)
