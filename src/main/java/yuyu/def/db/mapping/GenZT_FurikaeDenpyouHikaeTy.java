...
/**
 * 振替伝票（控）テーブル（中） テーブルのマッピング情報クラスで、 {@link ZT_FurikaeDenpyouHikaeTy} のスーパークラスです。<br />
 * <table border="1" cellspacing="0" cellpadding="0">
 *  <tr bgcolor="whitesmoke"><th colspan="2">テーブルID</th><th colspan="3">名称</th></tr>
 *  <tr><td colspan="2">{@link ZT_FurikaeDenpyouHikaeTy}</td><td colspan="3">振替伝票（控）テーブル（中）</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikinoc8 ztytorihikinoc8}</td><td>（中継用）取引番号Ｃ８</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinoedano ztytorihikinoedano}</td><td>（中継用）取引番号枝番号</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>{@link #getZtytorihikiymdgengokbn ztytorihikiymdgengokbn}</td><td>（中継用）取引年月日元号区分</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikinen ztytorihikinen}</td><td>（中継用）取引年</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikituki ztytorihikituki}</td><td>（中継用）取引月</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>{@link #getZtytorihikibi ztytorihikibi}</td><td>（中継用）取引日</td><td align="center">{@link PKZT_FurikaeDenpyouHikaeTy ○}</td><td align="center">V</td><td>String</td></tr>
 ...
 * </table>
 * @see     ZT_FurikaeDenpyouHikaeTy
 * @see     PKZT_FurikaeDenpyouHikaeTy
 * @see     QZT_FurikaeDenpyouHikaeTy
 * @see     GenQZT_FurikaeDenpyouHikaeTy
 */
@MappedSuperclass
@Table(name=GenZT_FurikaeDenpyouHikaeTy.TABLE_NAME)
@IdClass(value=PKZT_FurikaeDenpyouHikaeTy.class)
public abstract class GenZT_FurikaeDenpyouHikaeTy extends AbstractExDBEntity<ZT_FurikaeDenpyouHikaeTy, PKZT_FurikaeDenpyouHikaeTy> {

    private static final long serialVersionUID = 1L;

    public static final String TABLE_NAME               = "ZT_FurikaeDenpyouHikaeTy";
    ...
    private final PKZT_FurikaeDenpyouHikaeTy primaryKey;

    public GenZT_FurikaeDenpyouHikaeTy() {
        primaryKey = new PKZT_FurikaeDenpyouHikaeTy();
    }
    ...
    @Transient
    @Override
    public PKZT_FurikaeDenpyouHikaeTy getPrimaryKey() {
        return primaryKey;
    }

    @Transient
    @Override
    public Class<QZT_FurikaeDenpyouHikaeTy> getMetaClass() {
        return QZT_FurikaeDenpyouHikaeTy.class;
    }

    private String ztykytkmksyoruicd;

    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKSYORUICD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKTYOUHYOUSKSYMD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKSYSTEMKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKTORIHIKINO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKSEIFUKUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKFURIDENHASSOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKYTKMKYOBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYSYSTEMKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKINOC8)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKINOEDANO)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJHIKAEINJIKM)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKIYMDGENGOKBN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKINEN)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKITUKI)
    ...
    @Id
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYTORIHIKIBI)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKANJYOUKBN)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKANJYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJTANTOUKANM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJTANTOUCD)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJSYSTEMNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKURIKOSIKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYDENPYOUKBNNM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASIKURIKOSIGKHYJKM)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKURIKOSIGKKINGAKU)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJTEKIYOU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJTEKIYOU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJTEKIYOU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKINGAKU1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM1)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKINGAKU2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM2)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKINGAKU3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM3)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASIKANJYOUKAMOKUNM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKARIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKASIKINGAKU4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKARITEKIYOUKM4)
    ...
    @Column(name=GenZT_FurikaeDenpyouHikaeTy.ZTYKJKASITEKIYOUKM4)
