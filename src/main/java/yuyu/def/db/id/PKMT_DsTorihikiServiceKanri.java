...
/**
 * ＤＳ取引サービス管理テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenMT_DsTorihikiServiceKanri
 * @see     QMT_DsTorihikiServiceKanri
 * @see     GenQMT_DsTorihikiServiceKanri
 */
public class PKMT_DsTorihikiServiceKanri extends AbstractExDBPrimaryKey<MT_DsTorihikiServiceKanri, PKMT_DsTorihikiServiceKanri> {

    private static final long serialVersionUID = 1L;

    public PKMT_DsTorihikiServiceKanri() {
    }

    public PKMT_DsTorihikiServiceKanri(String pDskokno, String pSyono) {
        dskokno = pDskokno;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<MT_DsTorihikiServiceKanri> getEntityClass() {
        return MT_DsTorihikiServiceKanri.class;
    }
