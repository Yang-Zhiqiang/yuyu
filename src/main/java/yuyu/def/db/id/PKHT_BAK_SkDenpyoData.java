...
/**
 * 新契約伝票データバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenHT_BAK_SkDenpyoData
 * @see     QHT_BAK_SkDenpyoData
 * @see     GenQHT_BAK_SkDenpyoData
 */
public class PKHT_BAK_SkDenpyoData extends AbstractExDBPrimaryKey<HT_BAK_SkDenpyoData, PKHT_BAK_SkDenpyoData> {

    private static final long serialVersionUID = 1L;

    public PKHT_BAK_SkDenpyoData() {
    }
    ...
    @Transient
    @Override
    public Class<HT_BAK_SkDenpyoData> getEntityClass() {
        return HT_BAK_SkDenpyoData.class;
    }
