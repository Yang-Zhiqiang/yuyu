...
/**
 * 支払ＦＢ送金データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenJT_SiFBSoukinData
 * @see     QJT_SiFBSoukinData
 * @see     GenQJT_SiFBSoukinData
 */
public class PKJT_SiFBSoukinData extends AbstractExDBPrimaryKey<JT_SiFBSoukinData, PKJT_SiFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKJT_SiFBSoukinData() {
    }

    public PKJT_SiFBSoukinData(String pFbsoukindatasikibetukey) {
        fbsoukindatasikibetukey = pFbsoukindatasikibetukey;
    }

    @Transient
    @Override
    public Class<JT_SiFBSoukinData> getEntityClass() {
        return JT_SiFBSoukinData.class;
    }
