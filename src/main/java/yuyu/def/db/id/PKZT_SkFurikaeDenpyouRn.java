...
/**
 * 新契約振替伝票テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkFurikaeDenpyouRn extends AbstractExDBPrimaryKey<ZT_SkFurikaeDenpyouRn, PKZT_SkFurikaeDenpyouRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkFurikaeDenpyouRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkFurikaeDenpyouRn> getEntityClass() {
        return ZT_SkFurikaeDenpyouRn.class;
    }
