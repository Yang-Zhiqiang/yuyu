 ...
 * </table>
 * @see     IT_KhTtdkRireki
 * @see     GenIT_KhTtdkRireki
 * @see     QIT_KhTtdkRireki
 * @see     GenQIT_KhTtdkRireki
 */
public class PKIT_KhTtdkRireki extends AbstractExDBPrimaryKey<IT_KhTtdkRireki, PKIT_KhTtdkRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhTtdkRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhTtdkRireki> getEntityClass() {
        return IT_KhTtdkRireki.class;
    }
