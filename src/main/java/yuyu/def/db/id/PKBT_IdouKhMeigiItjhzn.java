...
/**
 * 異動契約保全名義管理一時保存テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenBT_IdouKhMeigiItjhzn
 * @see     QBT_IdouKhMeigiItjhzn
 * @see     GenQBT_IdouKhMeigiItjhzn
 */
public class PKBT_IdouKhMeigiItjhzn extends AbstractExDBPrimaryKey<BT_IdouKhMeigiItjhzn, PKBT_IdouKhMeigiItjhzn> {

    private static final long serialVersionUID = 1L;

    public PKBT_IdouKhMeigiItjhzn() {
    }

    public PKBT_IdouKhMeigiItjhzn(String pSyono, Integer pRenno3keta) {
        syono = pSyono;
    ...
    @Transient
    @Override
    public Class<BT_IdouKhMeigiItjhzn> getEntityClass() {
        return BT_IdouKhMeigiItjhzn.class;
    }
