 ...
 */
public class PKBM_ZennouTumitateRitu2 extends AbstractExDBPrimaryKey<BM_ZennouTumitateRitu2, PKBM_ZennouTumitateRitu2> {

    private static final long serialVersionUID = 1L;

    public PKBM_ZennouTumitateRitu2() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ZennouTumitateRitu2> getEntityClass() {
        return BM_ZennouTumitateRitu2.class;
    }
