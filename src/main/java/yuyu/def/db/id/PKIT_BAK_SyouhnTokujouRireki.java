...
/**
 * 商品特条履歴バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_SyouhnTokujouRireki
 * @see     QIT_BAK_SyouhnTokujouRireki
 * @see     GenQIT_BAK_SyouhnTokujouRireki
 */
public class PKIT_BAK_SyouhnTokujouRireki extends AbstractExDBPrimaryKey<IT_BAK_SyouhnTokujouRireki, PKIT_BAK_SyouhnTokujouRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_SyouhnTokujouRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_SyouhnTokujouRireki> getEntityClass() {
        return IT_BAK_SyouhnTokujouRireki.class;
    }
