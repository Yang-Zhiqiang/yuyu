...
/**
 * 新契約決算用振替伝票テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnHurikaeTy extends AbstractExDBPrimaryKey<ZT_SkKsnHurikaeTy, PKZT_SkKsnHurikaeTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnHurikaeTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnHurikaeTy> getEntityClass() {
        return ZT_SkKsnHurikaeTy.class;
    }
