...
/**
 * 決算計上用株価指数連動保険事業費Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KsnKbkSsuRnduHknJigyohiRn extends AbstractExDBPrimaryKey<ZT_KsnKbkSsuRnduHknJigyohiRn, PKZT_KsnKbkSsuRnduHknJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KsnKbkSsuRnduHknJigyohiRn() {
    }

    public PKZT_KsnKbkSsuRnduHknJigyohiRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KsnKbkSsuRnduHknJigyohiRn> getEntityClass() {
        return ZT_KsnKbkSsuRnduHknJigyohiRn.class;
    }
