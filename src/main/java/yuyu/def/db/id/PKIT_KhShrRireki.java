 ...
 * </table>
 * @see     IT_KhShrRireki
 * @see     GenIT_KhShrRireki
 * @see     QIT_KhShrRireki
 * @see     GenQIT_KhShrRireki
 */
public class PKIT_KhShrRireki extends AbstractExDBPrimaryKey<IT_KhShrRireki, PKIT_KhShrRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhShrRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhShrRireki> getEntityClass() {
        return IT_KhShrRireki.class;
    }
