 ...
 */
public class PKZT_DshrToukeiTy extends AbstractExDBPrimaryKey<ZT_DshrToukeiTy, PKZT_DshrToukeiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_DshrToukeiTy() {
    }

    public PKZT_DshrToukeiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_DshrToukeiTy> getEntityClass() {
        return ZT_DshrToukeiTy.class;
    }
