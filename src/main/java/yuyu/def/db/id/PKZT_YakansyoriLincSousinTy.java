...
/**
 * 夜間処理ＬＩＮＣ送信ファイルテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_YakansyoriLincSousinTy extends AbstractExDBPrimaryKey<ZT_YakansyoriLincSousinTy, PKZT_YakansyoriLincSousinTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_YakansyoriLincSousinTy() {
    }

    public PKZT_YakansyoriLincSousinTy(String pZtyrecordsyubetukbn, String pZtykykkanrino) {
    ...
    @Transient
    @Override
    public Class<ZT_YakansyoriLincSousinTy> getEntityClass() {
        return ZT_YakansyoriLincSousinTy.class;
    }
