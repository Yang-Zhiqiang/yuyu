...
/**
 * 年金原資Ｆ例月用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkGensiRigTy extends AbstractExDBPrimaryKey<ZT_NkGensiRigTy, PKZT_NkGensiRigTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkGensiRigTy() {
    }

    public PKZT_NkGensiRigTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkGensiRigTy> getEntityClass() {
        return ZT_NkGensiRigTy.class;
    }
