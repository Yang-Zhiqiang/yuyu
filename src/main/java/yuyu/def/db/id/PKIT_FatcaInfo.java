 ...
 */
public class PKIT_FatcaInfo extends AbstractExDBPrimaryKey<IT_FatcaInfo, PKIT_FatcaInfo> {

    private static final long serialVersionUID = 1L;

    public PKIT_FatcaInfo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_FatcaInfo> getEntityClass() {
        return IT_FatcaInfo.class;
    }
