 ...
 */
public class PKBM_ChkSaiteiS extends AbstractExDBPrimaryKey<BM_ChkSaiteiS, PKBM_ChkSaiteiS> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkSaiteiS() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkSaiteiS> getEntityClass() {
        return BM_ChkSaiteiS.class;
    }
