...
/**
 * 収納返金履歴バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_SyuunouHenknRireki
 * @see     QIT_BAK_SyuunouHenknRireki
 * @see     GenQIT_BAK_SyuunouHenknRireki
 */
public class PKIT_BAK_SyuunouHenknRireki extends AbstractExDBPrimaryKey<IT_BAK_SyuunouHenknRireki, PKIT_BAK_SyuunouHenknRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_SyuunouHenknRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_SyuunouHenknRireki> getEntityClass() {
        return IT_BAK_SyuunouHenknRireki.class;
    }
