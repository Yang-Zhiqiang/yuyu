...
/**
 * 契約保全外貨ＦＢ送金データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhGaikaFBSoukinData
 * @see     QIT_KhGaikaFBSoukinData
 * @see     GenQIT_KhGaikaFBSoukinData
 */
public class PKIT_KhGaikaFBSoukinData extends AbstractExDBPrimaryKey<IT_KhGaikaFBSoukinData, PKIT_KhGaikaFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhGaikaFBSoukinData() {
    }

    public PKIT_KhGaikaFBSoukinData(String pFbsoukindatasikibetukey) {
        fbsoukindatasikibetukey = pFbsoukindatasikibetukey;
    }

    @Transient
    @Override
    public Class<IT_KhGaikaFBSoukinData> getEntityClass() {
        return IT_KhGaikaFBSoukinData.class;
    }
