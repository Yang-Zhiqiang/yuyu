...
/**
 * 年金統計Ｆ期中報告用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkToukeiKtyTy extends AbstractExDBPrimaryKey<ZT_NkToukeiKtyTy, PKZT_NkToukeiKtyTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkToukeiKtyTy() {
    }

    public PKZT_NkToukeiKtyTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkToukeiKtyTy> getEntityClass() {
        return ZT_NkToukeiKtyTy.class;
    }
