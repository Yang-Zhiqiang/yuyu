 ...
 * @see     GenIT_SyouhnTokujouRireki
 * @see     QIT_SyouhnTokujouRireki
 * @see     GenQIT_SyouhnTokujouRireki
 */
public class PKIT_SyouhnTokujouRireki extends AbstractExDBPrimaryKey<IT_SyouhnTokujouRireki, PKIT_SyouhnTokujouRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_SyouhnTokujouRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_SyouhnTokujouRireki> getEntityClass() {
        return IT_SyouhnTokujouRireki.class;
    }
