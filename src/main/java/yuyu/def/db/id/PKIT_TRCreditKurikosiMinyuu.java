...
/**
 * クレカ繰越未入ＴＲテーブル のプライマリキークラスです。<br />
 ...
 *  <tr bgcolor="pink"><td>{@link #getMinyuutrrenno minyuutrrenno}</td><td>未入TR連番</td><td align="center">○</td><td align="center">V</td><td>String</td></tr>
 ...
 * @see     GenIT_TRCreditKurikosiMinyuu
 * @see     QIT_TRCreditKurikosiMinyuu
 * @see     GenQIT_TRCreditKurikosiMinyuu
 */
public class PKIT_TRCreditKurikosiMinyuu extends AbstractExDBPrimaryKey<IT_TRCreditKurikosiMinyuu, PKIT_TRCreditKurikosiMinyuu> {

    private static final long serialVersionUID = 1L;

    public PKIT_TRCreditKurikosiMinyuu() {
    }
    ...
    @Transient
    @Override
    public Class<IT_TRCreditKurikosiMinyuu> getEntityClass() {
        return IT_TRCreditKurikosiMinyuu.class;
    }
