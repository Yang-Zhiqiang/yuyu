 ...
 * @see     GenBM_ChkNenreiHani
 * @see     QBM_ChkNenreiHani
 * @see     GenQBM_ChkNenreiHani
 */
public class PKBM_ChkNenreiHani extends AbstractExDBPrimaryKey<BM_ChkNenreiHani, PKBM_ChkNenreiHani> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkNenreiHani() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkNenreiHani> getEntityClass() {
        return BM_ChkNenreiHani.class;
    }
