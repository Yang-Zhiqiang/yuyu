...
/**
 * 新契約決算用会計取引Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnKaikeiTorihikiTy extends AbstractExDBPrimaryKey<ZT_SkKsnKaikeiTorihikiTy, PKZT_SkKsnKaikeiTorihikiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnKaikeiTorihikiTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnKaikeiTorihikiTy> getEntityClass() {
        return ZT_SkKsnKaikeiTorihikiTy.class;
    }
