 ...
 * @see     GenQZT_Ratev2Rn
 */
public class PKZT_Ratev2Rn extends AbstractExDBPrimaryKey<ZT_Ratev2Rn, PKZT_Ratev2Rn> {

    private static final long serialVersionUID = 1L;

    public PKZT_Ratev2Rn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_Ratev2Rn> getEntityClass() {
        return ZT_Ratev2Rn.class;
    }
