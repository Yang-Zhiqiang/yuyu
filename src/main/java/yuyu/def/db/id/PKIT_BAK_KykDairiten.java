...
/**
 * 契約代理店バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KykDairiten
 * @see     QIT_BAK_KykDairiten
 * @see     GenQIT_BAK_KykDairiten
 */
public class PKIT_BAK_KykDairiten extends AbstractExDBPrimaryKey<IT_BAK_KykDairiten, PKIT_BAK_KykDairiten> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KykDairiten() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KykDairiten> getEntityClass() {
        return IT_BAK_KykDairiten.class;
    }
