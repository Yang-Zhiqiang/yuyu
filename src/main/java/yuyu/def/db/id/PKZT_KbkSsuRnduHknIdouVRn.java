...
/**
 * 株価指数連動保険異動ＶＦテーブル（連） のプライマリキークラスです。<br />
 ...
 *  <tr><td>zrnvkimatutirttumitatekin</td><td>（連携用）Ｖ用期末定率部分積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnkimatusisuutumitatekin</td><td>（連携用）期末指数部分積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnvyoutykzenoutouymdsisuu</td><td>（連携用）Ｖ用直前応当日指数</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>zrntykzensisuukijyunymd</td><td>（連携用）直前指数基準年月日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>zrnvyoukimatusisuu</td><td>（連携用）Ｖ用期末指数</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>zrnkmtsisuukijyunymd</td><td>（連携用）期末指数基準年月日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>zrnvyoutmttknzoukaritujygn</td><td>（連携用）Ｖ用積立金増加率上限</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>zrnvyousetteibairitu</td><td>（連携用）Ｖ用設定倍率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>zrnvyourendouritu</td><td>（連携用）Ｖ用連動率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 ...
 *  <tr><td>zrnkimatusisuutyokugotmttkn</td><td>（連携用）期末指数部分直後積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>zrnjmttirttumitatekinnplus0</td><td>（連携用）事末定率部分積立金（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmttirttumitatekinnplus1</td><td>（連携用）事末定率部分積立金（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmttirttumitatekinnplus2</td><td>（連携用）事末定率部分積立金（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtssutumitatekinnplus0</td><td>（連携用）事末指数部分積立金（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtssutumitatekinnplus1</td><td>（連携用）事末指数部分積立金（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtssutumitatekinnplus2</td><td>（連携用）事末指数部分積立金（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvatyouseigownplus0</td><td>（連携用）事末ＭＶＡ調整後Ｗ（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvakeisanjiwnplus0</td><td>（連携用）事末ＭＶＡ計算時Ｖ（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvatyouseigownplus1</td><td>（連携用）事末ＭＶＡ調整後Ｗ（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvakeisanjiwnplus1</td><td>（連携用）事末ＭＶＡ計算時Ｖ（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvatyouseigownplus2</td><td>（連携用）事末ＭＶＡ調整後Ｗ（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnjmtmvakeisanjiwnplus2</td><td>（連携用）事末ＭＶＡ計算時Ｖ（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>zrnsuuriyouyobin15x2</td><td>（連携用）数理用予備項目Ｎ１５＿２</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 ...
 */
public class PKZT_KbkSsuRnduHknIdouVRn extends AbstractExDBPrimaryKey<ZT_KbkSsuRnduHknIdouVRn, PKZT_KbkSsuRnduHknIdouVRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KbkSsuRnduHknIdouVRn() {
    }

    public PKZT_KbkSsuRnduHknIdouVRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KbkSsuRnduHknIdouVRn> getEntityClass() {
        return ZT_KbkSsuRnduHknIdouVRn.class;
    }
