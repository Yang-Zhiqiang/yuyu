...
/**
 * 申込商品ベリファイテーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     HT_MosSyouhnVrf
 * @see     GenHT_MosSyouhnVrf
 * @see     QHT_MosSyouhnVrf
 * @see     GenQHT_MosSyouhnVrf
 */
public class PKHT_MosSyouhnVrf extends AbstractExDBPrimaryKey<HT_MosSyouhnVrf, PKHT_MosSyouhnVrf> {

    private static final long serialVersionUID = 1L;

    public PKHT_MosSyouhnVrf() {
    }

    public PKHT_MosSyouhnVrf(String pMosno, String pSyouhncd) {
        mosno = pMosno;
        syouhncd = pSyouhncd;
    }
    ...
    @Transient
    @Override
    public Class<HT_MosSyouhnVrf> getEntityClass() {
        return HT_MosSyouhnVrf.class;
    }
