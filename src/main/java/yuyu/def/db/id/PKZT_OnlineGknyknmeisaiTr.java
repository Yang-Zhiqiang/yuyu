...
/**
 * オンライン外貨入出金明細テーブル（取） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_OnlineGknyknmeisaiTr extends AbstractExDBPrimaryKey<ZT_OnlineGknyknmeisaiTr, PKZT_OnlineGknyknmeisaiTr> {

    private static final long serialVersionUID = 1L;

    public PKZT_OnlineGknyknmeisaiTr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_OnlineGknyknmeisaiTr> getEntityClass() {
        return ZT_OnlineGknyknmeisaiTr.class;
    }
