...
/**
 * 保有純増増減Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_HoyuuJyunzouZougenFTy extends AbstractExDBPrimaryKey<ZT_HoyuuJyunzouZougenFTy, PKZT_HoyuuJyunzouZougenFTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_HoyuuJyunzouZougenFTy() {
    }

    public PKZT_HoyuuJyunzouZougenFTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_HoyuuJyunzouZougenFTy> getEntityClass() {
        return ZT_HoyuuJyunzouZougenFTy.class;
    }
