...
/**
 * 最高ＳＳ単位事方書チェックマスタ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_ChkJhSaikouSSTani extends AbstractExDBPrimaryKey<BM_ChkJhSaikouSSTani, PKBM_ChkJhSaikouSSTani> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkJhSaikouSSTani() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkJhSaikouSSTani> getEntityClass() {
        return BM_ChkJhSaikouSSTani.class;
    }
