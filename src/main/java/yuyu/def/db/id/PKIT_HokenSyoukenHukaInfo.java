...
/**
 * 保険証券付加情報データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_HokenSyoukenHukaInfo
 * @see     QIT_HokenSyoukenHukaInfo
 * @see     GenQIT_HokenSyoukenHukaInfo
 */
public class PKIT_HokenSyoukenHukaInfo extends AbstractExDBPrimaryKey<IT_HokenSyoukenHukaInfo, PKIT_HokenSyoukenHukaInfo> {

    private static final long serialVersionUID = 1L;

    public PKIT_HokenSyoukenHukaInfo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_HokenSyoukenHukaInfo> getEntityClass() {
        return IT_HokenSyoukenHukaInfo.class;
    }
