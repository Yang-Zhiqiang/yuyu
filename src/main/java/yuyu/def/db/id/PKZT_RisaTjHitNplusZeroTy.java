 ...
 */
public class PKZT_RisaTjHitNplusZeroTy extends AbstractExDBPrimaryKey<ZT_RisaTjHitNplusZeroTy, PKZT_RisaTjHitNplusZeroTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RisaTjHitNplusZeroTy() {
    }

    public PKZT_RisaTjHitNplusZeroTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RisaTjHitNplusZeroTy> getEntityClass() {
        return ZT_RisaTjHitNplusZeroTy.class;
    }
