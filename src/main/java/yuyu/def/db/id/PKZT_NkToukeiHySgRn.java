...
/**
 * 年金統計Ｆ保有照合用テーブル（連） のプライマリキークラスです。<br />
 ...
 *  <tr><td>zrnshiharaihasseiymd</td><td>（連携用）支払発生日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>zrnsaisyuunenkinkaimasiymd</td><td>（連携用）最終年金買増日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>zrnznznnndkaimasinkzougk</td><td>（連携用）前々年度買増年金増額</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnznznznnndkaimasinkgk</td><td>（連携用）前々々年度買増年金額</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrntounendokaimasinenkind</td><td>（連携用）当年度買増年金Ｄ</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnkaimasityuusiymd</td><td>（連携用）買増中止日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>zrnkaimasihukkiymd</td><td>（連携用）買増復帰日</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 ...
 *  <tr><td>zrnznznnndatoatukaimasinkgk</td><td>（連携用）前々年度後厚買増年金額</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>zrnznznznnndatatkimsnkgk</td><td>（連携用）前々々年度後厚買増年金額</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 */
public class PKZT_NkToukeiHySgRn extends AbstractExDBPrimaryKey<ZT_NkToukeiHySgRn, PKZT_NkToukeiHySgRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkToukeiHySgRn() {
    }

    public PKZT_NkToukeiHySgRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkToukeiHySgRn> getEntityClass() {
        return ZT_NkToukeiHySgRn.class;
    }
