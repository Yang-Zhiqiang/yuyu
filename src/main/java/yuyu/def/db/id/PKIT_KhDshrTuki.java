...
/**
 * 契約保全Ｄ支払統計テーブル のプライマリキークラスです。<br />
 ...
 */
public class PKIT_KhDshrTuki extends AbstractExDBPrimaryKey<IT_KhDshrTuki, PKIT_KhDshrTuki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhDshrTuki() {
    }

    public PKIT_KhDshrTuki(String pDshrtoukeisikibetukey, String pSyono) {
    ...
    @Transient
    @Override
    public Class<IT_KhDshrTuki> getEntityClass() {
        return IT_KhDshrTuki.class;
    }
