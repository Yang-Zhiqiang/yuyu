 ...
 * @see     GenSV_KiykSyuhnData
 * @see     QSV_KiykSyuhnData
 * @see     GenQSV_KiykSyuhnData
 */
public class PKSV_KiykSyuhnData extends AbstractExDBPrimaryKey<SV_KiykSyuhnData, PKSV_KiykSyuhnData> {

    private static final long serialVersionUID = 1L;

    public PKSV_KiykSyuhnData() {
    }
    ...
    @Transient
    @Override
    public Class<SV_KiykSyuhnData> getEntityClass() {
        return SV_KiykSyuhnData.class;
    }
