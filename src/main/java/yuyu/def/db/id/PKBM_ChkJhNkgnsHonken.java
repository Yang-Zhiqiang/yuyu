...
/**
 * 年金原資本件事方書チェックマスタ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_ChkJhNkgnsHonken extends AbstractExDBPrimaryKey<BM_ChkJhNkgnsHonken, PKBM_ChkJhNkgnsHonken> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkJhNkgnsHonken() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkJhNkgnsHonken> getEntityClass() {
        return BM_ChkJhNkgnsHonken.class;
    }
