 ...
 * @see     GenIT_CreditHnknTuuti
 * @see     QIT_CreditHnknTuuti
 * @see     GenQIT_CreditHnknTuuti
 */
public class PKIT_CreditHnknTuuti extends AbstractExDBPrimaryKey<IT_CreditHnknTuuti, PKIT_CreditHnknTuuti> {

    private static final long serialVersionUID = 1L;

    public PKIT_CreditHnknTuuti() {
    }
    ...
    @Transient
    @Override
    public Class<IT_CreditHnknTuuti> getEntityClass() {
        return IT_CreditHnknTuuti.class;
    }
