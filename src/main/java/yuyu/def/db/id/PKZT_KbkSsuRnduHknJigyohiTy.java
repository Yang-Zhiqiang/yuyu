...
/**
 * 株価指数連動保険事業費Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KbkSsuRnduHknJigyohiTy extends AbstractExDBPrimaryKey<ZT_KbkSsuRnduHknJigyohiTy, PKZT_KbkSsuRnduHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KbkSsuRnduHknJigyohiTy() {
    }

    public PKZT_KbkSsuRnduHknJigyohiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KbkSsuRnduHknJigyohiTy> getEntityClass() {
        return ZT_KbkSsuRnduHknJigyohiTy.class;
    }
