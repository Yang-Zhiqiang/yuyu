...
/**
 * 振込入金データ（保全用）テーブル のプライマリキークラスです。<br />
 ...
 */
public class PKIT_HrkmNyknDataHzn extends AbstractExDBPrimaryKey<IT_HrkmNyknDataHzn, PKIT_HrkmNyknDataHzn> {

    private static final long serialVersionUID = 1L;

    public PKIT_HrkmNyknDataHzn() {
    }
    ...
    @Transient
    @Override
    public Class<IT_HrkmNyknDataHzn> getEntityClass() {
        return IT_HrkmNyknDataHzn.class;
    }
