...
/**
 * クレジットカードバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_CreditCard
 * @see     QIT_BAK_CreditCard
 * @see     GenQIT_BAK_CreditCard
 */
public class PKIT_BAK_CreditCard extends AbstractExDBPrimaryKey<IT_BAK_CreditCard, PKIT_BAK_CreditCard> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_CreditCard() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_CreditCard> getEntityClass() {
        return IT_BAK_CreditCard.class;
    }
