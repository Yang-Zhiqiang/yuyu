...
/**
 * 当日異動内容新契約テーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     BT_TjtIdouNySk
 * @see     GenBT_TjtIdouNySk
 * @see     QBT_TjtIdouNySk
 * @see     GenQBT_TjtIdouNySk
 */
public class PKBT_TjtIdouNySk extends AbstractExDBPrimaryKey<BT_TjtIdouNySk, PKBT_TjtIdouNySk> {

    private static final long serialVersionUID = 1L;

    public PKBT_TjtIdouNySk() {
    }

    public PKBT_TjtIdouNySk(String pMosno, Integer pRenno3keta) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<BT_TjtIdouNySk> getEntityClass() {
        return BT_TjtIdouNySk.class;
    }
