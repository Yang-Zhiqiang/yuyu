 ...
 * </table>
 * @see     IT_HrkeIraiInfo
 * @see     GenIT_HrkeIraiInfo
 * @see     QIT_HrkeIraiInfo
 * @see     GenQIT_HrkeIraiInfo
 */
public class PKIT_HrkeIraiInfo extends AbstractExDBPrimaryKey<IT_HrkeIraiInfo, PKIT_HrkeIraiInfo> {

    private static final long serialVersionUID = 1L;

    public PKIT_HrkeIraiInfo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_HrkeIraiInfo> getEntityClass() {
        return IT_HrkeIraiInfo.class;
    }
