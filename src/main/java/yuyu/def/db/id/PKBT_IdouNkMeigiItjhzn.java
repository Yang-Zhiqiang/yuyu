...
/**
 * 異動年金支払名義管理一時保存テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenBT_IdouNkMeigiItjhzn
 * @see     QBT_IdouNkMeigiItjhzn
 * @see     GenQBT_IdouNkMeigiItjhzn
 */
public class PKBT_IdouNkMeigiItjhzn extends AbstractExDBPrimaryKey<BT_IdouNkMeigiItjhzn, PKBT_IdouNkMeigiItjhzn> {

    private static final long serialVersionUID = 1L;

    public PKBT_IdouNkMeigiItjhzn() {
    }

    public PKBT_IdouNkMeigiItjhzn(String pNksysyno, Integer pRenno3keta) {
        nksysyno = pNksysyno;
    ...
    @Transient
    @Override
    public Class<BT_IdouNkMeigiItjhzn> getEntityClass() {
        return BT_IdouNkMeigiItjhzn.class;
    }
