...
/**
 * 控除証明書バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KoujyoSym
 * @see     QIT_BAK_KoujyoSym
 * @see     GenQIT_BAK_KoujyoSym
 */
public class PKIT_BAK_KoujyoSym extends AbstractExDBPrimaryKey<IT_BAK_KoujyoSym, PKIT_BAK_KoujyoSym> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KoujyoSym() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KoujyoSym> getEntityClass() {
        return IT_BAK_KoujyoSym.class;
    }
