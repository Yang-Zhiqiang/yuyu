...
/**
 * 新契約収入Ｐ統計例月Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkeisynyptoukeirigTy extends AbstractExDBPrimaryKey<ZT_SkeisynyptoukeirigTy, PKZT_SkeisynyptoukeirigTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkeisynyptoukeirigTy() {
    }

    public PKZT_SkeisynyptoukeirigTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_SkeisynyptoukeirigTy> getEntityClass() {
        return ZT_SkeisynyptoukeirigTy.class;
    }
