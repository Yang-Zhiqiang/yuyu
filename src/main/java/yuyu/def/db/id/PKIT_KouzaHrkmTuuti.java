 ...
 * @see     GenIT_KouzaHrkmTuuti
 * @see     QIT_KouzaHrkmTuuti
 * @see     GenQIT_KouzaHrkmTuuti
 */
public class PKIT_KouzaHrkmTuuti extends AbstractExDBPrimaryKey<IT_KouzaHrkmTuuti, PKIT_KouzaHrkmTuuti> {

    private static final long serialVersionUID = 1L;

    public PKIT_KouzaHrkmTuuti() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KouzaHrkmTuuti> getEntityClass() {
        return IT_KouzaHrkmTuuti.class;
    }
