...
/**
 * 年金統計Ｆ保有照合用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkToukeiHySgTy extends AbstractExDBPrimaryKey<ZT_NkToukeiHySgTy, PKZT_NkToukeiHySgTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkToukeiHySgTy() {
    }

    public PKZT_NkToukeiHySgTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkToukeiHySgTy> getEntityClass() {
        return ZT_NkToukeiHySgTy.class;
    }
