...
/**
 * ＲＡＹ異動ＶＦテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayIdouVRn extends AbstractExDBPrimaryKey<ZT_RayIdouVRn, PKZT_RayIdouVRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayIdouVRn() {
    }

    public PKZT_RayIdouVRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayIdouVRn> getEntityClass() {
        return ZT_RayIdouVRn.class;
    }
