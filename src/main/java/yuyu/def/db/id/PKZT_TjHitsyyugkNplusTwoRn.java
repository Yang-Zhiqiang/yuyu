...
/**
 * 通常配当所要額Ｆ（Ｎ＋２）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusTwoRn extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusTwoRn, PKZT_TjHitsyyugkNplusTwoRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusTwoRn() {
    }

    public PKZT_TjHitsyyugkNplusTwoRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusTwoRn> getEntityClass() {
        return ZT_TjHitsyyugkNplusTwoRn.class;
    }
