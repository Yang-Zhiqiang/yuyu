 ...
 * @see     GenQIT_TrkKzk
 */
public class PKIT_TrkKzk extends AbstractExDBPrimaryKey<IT_TrkKzk, PKIT_TrkKzk> {
    ...
    @Transient
    @Override
    public Class<IT_TrkKzk> getEntityClass() {
        return IT_TrkKzk.class;
    }
