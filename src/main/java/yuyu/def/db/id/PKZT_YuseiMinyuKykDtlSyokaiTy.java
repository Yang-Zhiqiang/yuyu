...
/**
 * 郵政未入契約明細照会用Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_YuseiMinyuKykDtlSyokaiTy extends AbstractExDBPrimaryKey<ZT_YuseiMinyuKykDtlSyokaiTy, PKZT_YuseiMinyuKykDtlSyokaiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_YuseiMinyuKykDtlSyokaiTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_YuseiMinyuKykDtlSyokaiTy> getEntityClass() {
        return ZT_YuseiMinyuKykDtlSyokaiTy.class;
    }
