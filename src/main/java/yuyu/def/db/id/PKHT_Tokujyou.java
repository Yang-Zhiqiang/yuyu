 ...
 * @see     GenQHT_Tokujyou
 */
public class PKHT_Tokujyou extends AbstractExDBPrimaryKey<HT_Tokujyou, PKHT_Tokujyou> {

    private static final long serialVersionUID = 1L;

    public PKHT_Tokujyou() {
    }

    public PKHT_Tokujyou(String pMosno) {
        mosno = pMosno;
    }

    @Transient
    @Override
    public Class<HT_Tokujyou> getEntityClass() {
        return HT_Tokujyou.class;
    }
