...
/**
 * 予約異動案内収納用クレジット払テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_YykIdouAnsyuCreditCard
 * @see     QIT_YykIdouAnsyuCreditCard
 * @see     GenQIT_YykIdouAnsyuCreditCard
 */
public class PKIT_YykIdouAnsyuCreditCard extends AbstractExDBPrimaryKey<IT_YykIdouAnsyuCreditCard, PKIT_YykIdouAnsyuCreditCard> {

    private static final long serialVersionUID = 1L;

    public PKIT_YykIdouAnsyuCreditCard() {
    }
    ...
    @Transient
    @Override
    public Class<IT_YykIdouAnsyuCreditCard> getEntityClass() {
        return IT_YykIdouAnsyuCreditCard.class;
    }
