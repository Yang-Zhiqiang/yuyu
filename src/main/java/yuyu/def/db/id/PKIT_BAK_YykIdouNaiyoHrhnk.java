...
/**
 * 予約異動受付内容（払方変更）バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_YykIdouNaiyoHrhnk
 * @see     QIT_BAK_YykIdouNaiyoHrhnk
 * @see     GenQIT_BAK_YykIdouNaiyoHrhnk
 */
public class PKIT_BAK_YykIdouNaiyoHrhnk extends AbstractExDBPrimaryKey<IT_BAK_YykIdouNaiyoHrhnk, PKIT_BAK_YykIdouNaiyoHrhnk> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_YykIdouNaiyoHrhnk() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_YykIdouNaiyoHrhnk> getEntityClass() {
        return IT_BAK_YykIdouNaiyoHrhnk.class;
    }
