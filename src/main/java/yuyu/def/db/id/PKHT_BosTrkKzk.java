 ...
 */
public class PKHT_BosTrkKzk extends AbstractExDBPrimaryKey<HT_BosTrkKzk, PKHT_BosTrkKzk> {

    private static final long serialVersionUID = 1L;

    public PKHT_BosTrkKzk() {
    }

    public PKHT_BosTrkKzk(String pMosno, C_TrkKzkKbn pTrkkzkkbn) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<HT_BosTrkKzk> getEntityClass() {
        return HT_BosTrkKzk.class;
    }
