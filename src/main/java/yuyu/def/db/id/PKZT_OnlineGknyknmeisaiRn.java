...
/**
 * オンライン外貨入出金明細テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_OnlineGknyknmeisaiRn extends AbstractExDBPrimaryKey<ZT_OnlineGknyknmeisaiRn, PKZT_OnlineGknyknmeisaiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_OnlineGknyknmeisaiRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_OnlineGknyknmeisaiRn> getEntityClass() {
        return ZT_OnlineGknyknmeisaiRn.class;
    }
