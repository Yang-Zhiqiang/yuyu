...
/**
 * 手数料情報商品履歴テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_TesuuryouSyouhnRireki
 * @see     QIT_TesuuryouSyouhnRireki
 * @see     GenQIT_TesuuryouSyouhnRireki
 */
public class PKIT_TesuuryouSyouhnRireki extends AbstractExDBPrimaryKey<IT_TesuuryouSyouhnRireki, PKIT_TesuuryouSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_TesuuryouSyouhnRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_TesuuryouSyouhnRireki> getEntityClass() {
        return IT_TesuuryouSyouhnRireki.class;
    }
