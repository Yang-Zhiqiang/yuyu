...
/**
 * 通常配当所要額Ｆ（Ｎ＋１）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusOneRn extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusOneRn, PKZT_TjHitsyyugkNplusOneRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusOneRn() {
    }

    public PKZT_TjHitsyyugkNplusOneRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusOneRn> getEntityClass() {
        return ZT_TjHitsyyugkNplusOneRn.class;
    }
