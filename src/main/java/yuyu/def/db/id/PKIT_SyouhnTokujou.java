 ...
 * @see     GenIT_SyouhnTokujou
 * @see     QIT_SyouhnTokujou
 * @see     GenQIT_SyouhnTokujou
 */
public class PKIT_SyouhnTokujou extends AbstractExDBPrimaryKey<IT_SyouhnTokujou, PKIT_SyouhnTokujou> {

    private static final long serialVersionUID = 1L;

    public PKIT_SyouhnTokujou() {
    }
    ...
    @Transient
    @Override
    public Class<IT_SyouhnTokujou> getEntityClass() {
        return IT_SyouhnTokujou.class;
    }
