 ...
 * @see     GenHT_SouseirituDairiten
 * @see     QHT_SouseirituDairiten
 * @see     GenQHT_SouseirituDairiten
 */
public class PKHT_SouseirituDairiten extends AbstractExDBPrimaryKey<HT_SouseirituDairiten, PKHT_SouseirituDairiten> {

    private static final long serialVersionUID = 1L;

    public PKHT_SouseirituDairiten() {
    }

    public PKHT_SouseirituDairiten(String pSyono, Integer pRenno) {
        syono = pSyono;
        renno = pRenno;
    }
    ...
    @Transient
    @Override
    public Class<HT_SouseirituDairiten> getEntityClass() {
        return HT_SouseirituDairiten.class;
    }
