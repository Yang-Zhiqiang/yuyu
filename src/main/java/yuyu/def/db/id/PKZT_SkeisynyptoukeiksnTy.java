...
/**
 * 新契約収入Ｐ統計決算Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkeisynyptoukeiksnTy extends AbstractExDBPrimaryKey<ZT_SkeisynyptoukeiksnTy, PKZT_SkeisynyptoukeiksnTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkeisynyptoukeiksnTy() {
    }

    public PKZT_SkeisynyptoukeiksnTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_SkeisynyptoukeiksnTy> getEntityClass() {
        return ZT_SkeisynyptoukeiksnTy.class;
    }
