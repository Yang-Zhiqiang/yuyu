...
/**
 * 保険金給付金支払調書テーブル のプライマリキークラスです。<br />
 ...
 */
public class PKJT_SiTyousyo extends AbstractExDBPrimaryKey<JT_SiTyousyo, PKJT_SiTyousyo> {

    private static final long serialVersionUID = 1L;

    public PKJT_SiTyousyo() {
    }
    ...
    @Transient
    @Override
    public Class<JT_SiTyousyo> getEntityClass() {
        return JT_SiTyousyo.class;
    }
