...
/**
 * 円建変更時返戻金支払ワークテーブル のプライマリキークラスです。<br />
 ...
 *  <tr><td>khhrshrjiyuu</td><td>契約保全返戻金支払事由</td><td>&nbsp;</td><td align="center">V</td><td>{@link yuyu.def.classification.C_Khhrshrjiyuu C_Khhrshrjiyuu}</td></tr>
 ...
 *  <tr><td>khskssakuseijiyuu</td><td>契約保全請求書作成事由</td><td>&nbsp;</td><td align="center">V</td><td>{@link yuyu.def.classification.C_Khskssakuseijiyuu C_Khskssakuseijiyuu}</td></tr>
 ...
 */
public class PKIW_KhYendtHnkHrShrWk extends AbstractExDBPrimaryKey<IW_KhYendtHnkHrShrWk, PKIW_KhYendtHnkHrShrWk> {

    private static final long serialVersionUID = 1L;

    public PKIW_KhYendtHnkHrShrWk() {
    }

    public PKIW_KhYendtHnkHrShrWk(String pKouteikanriid) {
        kouteikanriid = pKouteikanriid;
    }

    @Transient
    @Override
    public Class<IW_KhYendtHnkHrShrWk> getEntityClass() {
        return IW_KhYendtHnkHrShrWk.class;
    }
