...
/**
 * 代理店未入契約明細対象テーブル のプライマリキークラスです。<br />
 ...
 *  <tr><td>jkijyutoukaisuuy</td><td>次回案内充当回数（年）</td><td>&nbsp;</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>jkijyutoukaisuum</td><td>次回案内充当回数（月）</td><td>&nbsp;</td><td align="center">N</td><td>Integer</td></tr>
 *  <tr><td>gyoumuKousinKinou</td><td>業務用更新機能ＩＤ</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>gyoumuKousinsyaId</td><td>業務用更新者ＩＤ</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>gyoumuKousinTime</td><td>業務用更新時間</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 * </table>
 * @see     IT_DrtenMinyuKykTaisyo
 * @see     GenIT_DrtenMinyuKykTaisyo
 * @see     QIT_DrtenMinyuKykTaisyo
 * @see     GenQIT_DrtenMinyuKykTaisyo
 */
public class PKIT_DrtenMinyuKykTaisyo extends AbstractExDBPrimaryKey<IT_DrtenMinyuKykTaisyo, PKIT_DrtenMinyuKykTaisyo> {

    private static final long serialVersionUID = 1L;

    public PKIT_DrtenMinyuKykTaisyo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_DrtenMinyuKykTaisyo> getEntityClass() {
        return IT_DrtenMinyuKykTaisyo.class;
    }
