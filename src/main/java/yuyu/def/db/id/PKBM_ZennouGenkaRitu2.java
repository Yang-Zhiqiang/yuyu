 ...
 */
public class PKBM_ZennouGenkaRitu2 extends AbstractExDBPrimaryKey<BM_ZennouGenkaRitu2, PKBM_ZennouGenkaRitu2> {

    private static final long serialVersionUID = 1L;

    public PKBM_ZennouGenkaRitu2() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ZennouGenkaRitu2> getEntityClass() {
        return BM_ZennouGenkaRitu2.class;
    }
