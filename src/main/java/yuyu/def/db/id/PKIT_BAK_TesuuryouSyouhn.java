...
/**
 * 手数料情報商品バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_TesuuryouSyouhn
 * @see     QIT_BAK_TesuuryouSyouhn
 * @see     GenQIT_BAK_TesuuryouSyouhn
 */
public class PKIT_BAK_TesuuryouSyouhn extends AbstractExDBPrimaryKey<IT_BAK_TesuuryouSyouhn, PKIT_BAK_TesuuryouSyouhn> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_TesuuryouSyouhn() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_TesuuryouSyouhn> getEntityClass() {
        return IT_BAK_TesuuryouSyouhn.class;
    }
