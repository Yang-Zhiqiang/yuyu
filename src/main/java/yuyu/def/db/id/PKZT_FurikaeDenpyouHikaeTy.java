...
/**
 * 振替伝票（控）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_FurikaeDenpyouHikaeTy extends AbstractExDBPrimaryKey<ZT_FurikaeDenpyouHikaeTy, PKZT_FurikaeDenpyouHikaeTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_FurikaeDenpyouHikaeTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_FurikaeDenpyouHikaeTy> getEntityClass() {
        return ZT_FurikaeDenpyouHikaeTy.class;
    }
