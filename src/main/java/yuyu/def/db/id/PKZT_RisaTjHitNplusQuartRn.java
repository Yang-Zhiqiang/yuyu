...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RisaTjHitNplusQuartRn extends AbstractExDBPrimaryKey<ZT_RisaTjHitNplusQuartRn, PKZT_RisaTjHitNplusQuartRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RisaTjHitNplusQuartRn() {
    }

    public PKZT_RisaTjHitNplusQuartRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RisaTjHitNplusQuartRn> getEntityClass() {
        return ZT_RisaTjHitNplusQuartRn.class;
    }
