 ...
 *  <tr><td>zrnhrkymdmdkj</td><td>（連携用）払込日（月日漢字）</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 *  <tr><td>zrnsyono2</td><td>（連携用）証券番号２</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>zrnnyknaiyoumidasi</td><td>（連携用）入金内容見出し</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 *  <tr><td>zrnymdmidasi</td><td>（連携用）日付見出し</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 *  <tr><td>zrnkingakumidasi</td><td>（連携用）金額見出し</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 *  <tr><td>zrnnyknymdseirekikj</td><td>（連携用）入金日（西暦漢字）</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 *  <tr><td>zrnnyuukinngaku</td><td>（連携用）入金額</td><td>&nbsp;</td><td align="center">C</td><td>String</td></tr>
 *  <tr><td>zrnpjyuutouym</td><td>（連携用）保険料充当年月</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 ...
 *  <tr><td>zrntyusyaku</td><td>（連携用）注釈</td><td>&nbsp;</td><td align="center">G</td><td>String</td></tr>
 ...
 */
public class PKZT_KouzaHnknTuutiRn extends AbstractExDBPrimaryKey<ZT_KouzaHnknTuutiRn, PKZT_KouzaHnknTuutiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KouzaHnknTuutiRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_KouzaHnknTuutiRn> getEntityClass() {
        return ZT_KouzaHnknTuutiRn.class;
    }
