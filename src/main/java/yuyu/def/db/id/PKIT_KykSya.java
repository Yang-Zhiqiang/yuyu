 ...
 * @see     GenQIT_KykSya
 */
public class PKIT_KykSya extends AbstractExDBPrimaryKey<IT_KykSya, PKIT_KykSya> {
    ...
    public PKIT_KykSya(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_KykSya> getEntityClass() {
        return IT_KykSya.class;
    }
