...
/**
 * 決算計上用ＲＡＹ事業費Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KsnRayJigyohiRn extends AbstractExDBPrimaryKey<ZT_KsnRayJigyohiRn, PKZT_KsnRayJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KsnRayJigyohiRn() {
    }

    public PKZT_KsnRayJigyohiRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KsnRayJigyohiRn> getEntityClass() {
        return ZT_KsnRayJigyohiRn.class;
    }
