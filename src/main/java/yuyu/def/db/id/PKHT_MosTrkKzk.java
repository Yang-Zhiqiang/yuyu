 ...
 */
public class PKHT_MosTrkKzk extends AbstractExDBPrimaryKey<HT_MosTrkKzk, PKHT_MosTrkKzk> {

    private static final long serialVersionUID = 1L;

    public PKHT_MosTrkKzk() {
    }

    public PKHT_MosTrkKzk(String pMosno, C_TrkKzkKbn pTrkkzkkbn) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<HT_MosTrkKzk> getEntityClass() {
        return HT_MosTrkKzk.class;
    }
