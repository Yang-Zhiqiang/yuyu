...
/**
 * 契約保全伝票データテーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     IT_KhDenpyoData
 * @see     GenIT_KhDenpyoData
 * @see     QIT_KhDenpyoData
 * @see     GenQIT_KhDenpyoData
 */
public class PKIT_KhDenpyoData extends AbstractExDBPrimaryKey<IT_KhDenpyoData, PKIT_KhDenpyoData> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhDenpyoData() {
    }

    public PKIT_KhDenpyoData(String pDenrenno, Integer pEdano) {
        denrenno = pDenrenno;
        edano = pEdano;
    }
    ...
    @Transient
    @Override
    public Class<IT_KhDenpyoData> getEntityClass() {
        return IT_KhDenpyoData.class;
    }
