...
/**
 * 新契約決算用振替伝票テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnHurikaeRn extends AbstractExDBPrimaryKey<ZT_SkKsnHurikaeRn, PKZT_SkKsnHurikaeRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnHurikaeRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnHurikaeRn> getEntityClass() {
        return ZT_SkKsnHurikaeRn.class;
    }
