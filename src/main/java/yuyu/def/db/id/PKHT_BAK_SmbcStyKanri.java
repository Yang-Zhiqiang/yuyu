...
/**
 * ＳＭＢＣ進捗管理バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenHT_BAK_SmbcStyKanri
 * @see     QHT_BAK_SmbcStyKanri
 * @see     GenQHT_BAK_SmbcStyKanri
 */
public class PKHT_BAK_SmbcStyKanri extends AbstractExDBPrimaryKey<HT_BAK_SmbcStyKanri, PKHT_BAK_SmbcStyKanri> {

    private static final long serialVersionUID = 1L;

    public PKHT_BAK_SmbcStyKanri() {
    }
    ...
    @Transient
    @Override
    public Class<HT_BAK_SmbcStyKanri> getEntityClass() {
        return HT_BAK_SmbcStyKanri.class;
    }
