 ...
 *  <tr><td>fbsoukinbatchkbn</td><td>ＦＢ送金バッチ区分</td><td>&nbsp;</td><td align="center">V</td><td>{@link yuyu.def.classification.C_FbSoukinBatchKbn C_FbSoukinBatchKbn}</td></tr>
 * </table>
 * @see     BT_FBSoukinData
 * @see     GenBT_FBSoukinData
 * @see     QBT_FBSoukinData
 * @see     GenQBT_FBSoukinData
 */
public class PKBT_FBSoukinData extends AbstractExDBPrimaryKey<BT_FBSoukinData, PKBT_FBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKBT_FBSoukinData() {
    }

    public PKBT_FBSoukinData(String pFbsoukindatasikibetukey) {
        fbsoukindatasikibetukey = pFbsoukindatasikibetukey;
    }

    @Transient
    @Override
    public Class<BT_FBSoukinData> getEntityClass() {
        return BT_FBSoukinData.class;
    }
