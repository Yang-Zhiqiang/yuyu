...
/**
 * 夜間処理ＬＩＮＣ送信ファイルテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_YakansyoriLincSousinRn extends AbstractExDBPrimaryKey<ZT_YakansyoriLincSousinRn, PKZT_YakansyoriLincSousinRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_YakansyoriLincSousinRn() {
    }

    public PKZT_YakansyoriLincSousinRn(String pZrnrecordsyubetukbn, String pZrnkykkanrino) {
    ...
    @Transient
    @Override
    public Class<ZT_YakansyoriLincSousinRn> getEntityClass() {
        return ZT_YakansyoriLincSousinRn.class;
    }
