 ...
 * @see     GenHT_BosUketoriKouzaJyouhou
 * @see     QHT_BosUketoriKouzaJyouhou
 * @see     GenQHT_BosUketoriKouzaJyouhou
 */
public class PKHT_BosUketoriKouzaJyouhou extends AbstractExDBPrimaryKey<HT_BosUketoriKouzaJyouhou, PKHT_BosUketoriKouzaJyouhou> {

    private static final long serialVersionUID = 1L;

    public PKHT_BosUketoriKouzaJyouhou() {
    }

    public PKHT_BosUketoriKouzaJyouhou(String pMosno, C_UketorikouzasyubetuKbn pUktkzsyubetukbn) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<HT_BosUketoriKouzaJyouhou> getEntityClass() {
        return HT_BosUketoriKouzaJyouhou.class;
    }
