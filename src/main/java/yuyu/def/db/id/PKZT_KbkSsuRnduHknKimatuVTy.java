...
/**
 * 株価指数連動保険期末ＶＦテーブル（中） のプライマリキークラスです。<br />
 ...
 *  <tr><td>ztyvkimatutirttumitatekin</td><td>（中継用）Ｖ用期末定率部分積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztykimatusisuutumitatekin</td><td>（中継用）期末指数部分積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyvyoutykzenoutouymdsisuu</td><td>（中継用）Ｖ用直前応当日指数</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztytykzensisuukijyunymd</td><td>（中継用）直前指数基準年月日</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>ztyvyoukimatusisuu</td><td>（中継用）Ｖ用期末指数</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztykmtsisuukijyunymd</td><td>（中継用）期末指数基準年月日</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>ztyvyoutmttknzoukaritujygn</td><td>（中継用）Ｖ用積立金増加率上限</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztyvyousetteibairitu</td><td>（中継用）Ｖ用設定倍率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztyvyourendouritu</td><td>（中継用）Ｖ用連動率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 ...
 *  <tr><td>ztykimatusisuutyokugotmttkn</td><td>（中継用）期末指数部分直後積立金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x19</td><td>（中継用）予備項目Ｎ１１＿１９</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x20</td><td>（中継用）予備項目Ｎ１１＿２０</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmttirttumitatekinnplus0</td><td>（中継用）事末定率部分積立金（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmttirttumitatekinnplus1</td><td>（中継用）事末定率部分積立金（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmttirttumitatekinnplus2</td><td>（中継用）事末定率部分積立金（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtssutumitatekinnplus0</td><td>（中継用）事末指数部分積立金（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtssutumitatekinnplus1</td><td>（中継用）事末指数部分積立金（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtssutumitatekinnplus2</td><td>（中継用）事末指数部分積立金（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvatyouseigownplus0</td><td>（中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvakeisanjiwnplus0</td><td>（中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋０）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvatyouseigownplus1</td><td>（中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvakeisanjiwnplus1</td><td>（中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋１）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvatyouseigownplus2</td><td>（中継用）事末ＭＶＡ調整後Ｗ（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyjmtmvakeisanjiwnplus2</td><td>（中継用）事末ＭＶＡ計算時Ｖ（Ｎ＋２）</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x21</td><td>（中継用）予備項目Ｎ１１＿２１</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x22</td><td>（中継用）予備項目Ｎ１１＿２２</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x23</td><td>（中継用）予備項目Ｎ１１＿２３</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x4</td><td>（中継用）予備項目Ｎ１１＿４</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x25</td><td>（中継用）予備項目Ｎ１１＿２５</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyyobin11x26</td><td>（中継用）予備項目Ｎ１１＿２６</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztysuuriyouyobin15</td><td>（中継用）数理用予備項目Ｎ１５</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>ztysuuriyouyobin15x2</td><td>（中継用）数理用予備項目Ｎ１５＿２</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 */
public class PKZT_KbkSsuRnduHknKimatuVTy extends AbstractExDBPrimaryKey<ZT_KbkSsuRnduHknKimatuVTy, PKZT_KbkSsuRnduHknKimatuVTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KbkSsuRnduHknKimatuVTy() {
    }

    public PKZT_KbkSsuRnduHknKimatuVTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KbkSsuRnduHknKimatuVTy> getEntityClass() {
        return ZT_KbkSsuRnduHknKimatuVTy.class;
    }
