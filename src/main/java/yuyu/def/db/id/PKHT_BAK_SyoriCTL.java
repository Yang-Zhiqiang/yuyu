...
/**
 * 処理コントロールバックアップテーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     HT_BAK_SyoriCTL
 * @see     GenHT_BAK_SyoriCTL
 * @see     QHT_BAK_SyoriCTL
 * @see     GenQHT_BAK_SyoriCTL
 */
public class PKHT_BAK_SyoriCTL extends AbstractExDBPrimaryKey<HT_BAK_SyoriCTL, PKHT_BAK_SyoriCTL> {

    private static final long serialVersionUID = 1L;

    public PKHT_BAK_SyoriCTL() {
    }

    public PKHT_BAK_SyoriCTL(String pMosno, String pTrkssikibetukey) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<HT_BAK_SyoriCTL> getEntityClass() {
        return HT_BAK_SyoriCTL.class;
    }
