...
/**
 * 告知扱通算限度Ｓ事方書チェックマスタ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_ChkJhKokutiTuusanS extends AbstractExDBPrimaryKey<BM_ChkJhKokutiTuusanS, PKBM_ChkJhKokutiTuusanS> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkJhKokutiTuusanS() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkJhKokutiTuusanS> getEntityClass() {
        return BM_ChkJhKokutiTuusanS.class;
    }
