 ...
 */
public class PKZT_SmbcBosRn extends AbstractExDBPrimaryKey<ZT_SmbcBosRn, PKZT_SmbcBosRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SmbcBosRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SmbcBosRn> getEntityClass() {
        return ZT_SmbcBosRn.class;
    }
