...
/**
 * 申込代理店ベリファイテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenHT_MosDairitenVrf
 * @see     QHT_MosDairitenVrf
 * @see     GenQHT_MosDairitenVrf
 */
public class PKHT_MosDairitenVrf extends AbstractExDBPrimaryKey<HT_MosDairitenVrf, PKHT_MosDairitenVrf> {

    private static final long serialVersionUID = 1L;

    public PKHT_MosDairitenVrf() {
    }

    public PKHT_MosDairitenVrf(String pMosno, Integer pRenno) {
        mosno = pMosno;
        renno = pRenno;
    }
    ...
    @Transient
    @Override
    public Class<HT_MosDairitenVrf> getEntityClass() {
        return HT_MosDairitenVrf.class;
    }
