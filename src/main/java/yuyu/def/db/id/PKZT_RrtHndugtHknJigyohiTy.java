...
/**
 * 利率変動型保険事業費Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RrtHndugtHknJigyohiTy extends AbstractExDBPrimaryKey<ZT_RrtHndugtHknJigyohiTy, PKZT_RrtHndugtHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RrtHndugtHknJigyohiTy() {
    }

    public PKZT_RrtHndugtHknJigyohiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RrtHndugtHknJigyohiTy> getEntityClass() {
        return ZT_RrtHndugtHknJigyohiTy.class;
    }
