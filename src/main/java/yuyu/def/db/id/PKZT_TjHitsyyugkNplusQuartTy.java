...
/**
 * 通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusQuartTy extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusQuartTy, PKZT_TjHitsyyugkNplusQuartTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusQuartTy() {
    }

    public PKZT_TjHitsyyugkNplusQuartTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusQuartTy> getEntityClass() {
        return ZT_TjHitsyyugkNplusQuartTy.class;
    }
