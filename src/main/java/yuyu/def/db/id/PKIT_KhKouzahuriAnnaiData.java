...
/**
 * 口座振替案内データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhKouzahuriAnnaiData
 * @see     QIT_KhKouzahuriAnnaiData
 * @see     GenQIT_KhKouzahuriAnnaiData
 */
public class PKIT_KhKouzahuriAnnaiData extends AbstractExDBPrimaryKey<IT_KhKouzahuriAnnaiData, PKIT_KhKouzahuriAnnaiData> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhKouzahuriAnnaiData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhKouzahuriAnnaiData> getEntityClass() {
        return IT_KhKouzahuriAnnaiData.class;
    }
