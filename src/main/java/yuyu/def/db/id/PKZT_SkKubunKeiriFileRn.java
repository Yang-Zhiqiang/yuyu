...
/**
 * 新契約区分経理ファイルテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKubunKeiriFileRn extends AbstractExDBPrimaryKey<ZT_SkKubunKeiriFileRn, PKZT_SkKubunKeiriFileRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKubunKeiriFileRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKubunKeiriFileRn> getEntityClass() {
        return ZT_SkKubunKeiriFileRn.class;
    }
