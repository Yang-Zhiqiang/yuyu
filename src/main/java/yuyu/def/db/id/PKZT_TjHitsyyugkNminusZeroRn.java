 ...
 */
public class PKZT_TjHitsyyugkNminusZeroRn extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNminusZeroRn, PKZT_TjHitsyyugkNminusZeroRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNminusZeroRn() {
    }

    public PKZT_TjHitsyyugkNminusZeroRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNminusZeroRn> getEntityClass() {
        return ZT_TjHitsyyugkNminusZeroRn.class;
    }
