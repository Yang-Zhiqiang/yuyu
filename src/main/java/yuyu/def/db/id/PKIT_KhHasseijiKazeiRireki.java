...
/**
 * 契約保全発生時課税履歴テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhHasseijiKazeiRireki
 * @see     QIT_KhHasseijiKazeiRireki
 * @see     GenQIT_KhHasseijiKazeiRireki
 */
public class PKIT_KhHasseijiKazeiRireki extends AbstractExDBPrimaryKey<IT_KhHasseijiKazeiRireki, PKIT_KhHasseijiKazeiRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhHasseijiKazeiRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhHasseijiKazeiRireki> getEntityClass() {
        return IT_KhHasseijiKazeiRireki.class;
    }
