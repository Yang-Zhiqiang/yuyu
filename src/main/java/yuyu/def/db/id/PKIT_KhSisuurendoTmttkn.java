...
/**
 * 指数連動積増型年金積立金テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhSisuurendoTmttkn
 * @see     QIT_KhSisuurendoTmttkn
 * @see     GenQIT_KhSisuurendoTmttkn
 */
public class PKIT_KhSisuurendoTmttkn extends AbstractExDBPrimaryKey<IT_KhSisuurendoTmttkn, PKIT_KhSisuurendoTmttkn> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhSisuurendoTmttkn() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhSisuurendoTmttkn> getEntityClass() {
        return IT_KhSisuurendoTmttkn.class;
    }
