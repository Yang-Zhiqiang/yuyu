...
/**
 * 利差配当商品用Ｄレートテーブル２（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RisaHitSyouhnyouRated2Rn extends AbstractExDBPrimaryKey<ZT_RisaHitSyouhnyouRated2Rn, PKZT_RisaHitSyouhnyouRated2Rn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RisaHitSyouhnyouRated2Rn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_RisaHitSyouhnyouRated2Rn> getEntityClass() {
        return ZT_RisaHitSyouhnyouRated2Rn.class;
    }
