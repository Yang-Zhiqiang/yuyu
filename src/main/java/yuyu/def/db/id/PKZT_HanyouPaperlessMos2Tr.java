...
/**
 * 汎用ペーパーレス申込情報２テーブル（取） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_HanyouPaperlessMos2Tr extends AbstractExDBPrimaryKey<ZT_HanyouPaperlessMos2Tr, PKZT_HanyouPaperlessMos2Tr> {

    private static final long serialVersionUID = 1L;

    public PKZT_HanyouPaperlessMos2Tr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_HanyouPaperlessMos2Tr> getEntityClass() {
        return ZT_HanyouPaperlessMos2Tr.class;
    }
