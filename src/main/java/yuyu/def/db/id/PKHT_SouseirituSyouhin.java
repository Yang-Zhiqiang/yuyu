 ...
 * @see     GenHT_SouseirituSyouhin
 * @see     QHT_SouseirituSyouhin
 * @see     GenQHT_SouseirituSyouhin
 */
public class PKHT_SouseirituSyouhin extends AbstractExDBPrimaryKey<HT_SouseirituSyouhin, PKHT_SouseirituSyouhin> {

    private static final long serialVersionUID = 1L;

    public PKHT_SouseirituSyouhin() {
    }

    public PKHT_SouseirituSyouhin(String pSyono, String pSyouhncd) {
        syono = pSyono;
        syouhncd = pSyouhncd;
    }
    ...
    @Transient
    @Override
    public Class<HT_SouseirituSyouhin> getEntityClass() {
        return HT_SouseirituSyouhin.class;
    }
