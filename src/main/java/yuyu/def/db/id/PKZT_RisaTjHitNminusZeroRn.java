 ...
 */
public class PKZT_RisaTjHitNminusZeroRn extends AbstractExDBPrimaryKey<ZT_RisaTjHitNminusZeroRn, PKZT_RisaTjHitNminusZeroRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RisaTjHitNminusZeroRn() {
    }

    public PKZT_RisaTjHitNminusZeroRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RisaTjHitNminusZeroRn> getEntityClass() {
        return ZT_RisaTjHitNminusZeroRn.class;
    }
