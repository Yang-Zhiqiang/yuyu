...
/**
 * 契約保全ＬＩＮＣ送信情報テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhLincSousinInfo
 * @see     QIT_KhLincSousinInfo
 * @see     GenQIT_KhLincSousinInfo
 */
public class PKIT_KhLincSousinInfo extends AbstractExDBPrimaryKey<IT_KhLincSousinInfo, PKIT_KhLincSousinInfo> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhLincSousinInfo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhLincSousinInfo> getEntityClass() {
        return IT_KhLincSousinInfo.class;
    }
