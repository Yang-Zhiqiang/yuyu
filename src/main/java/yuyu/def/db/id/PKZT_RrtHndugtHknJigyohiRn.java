...
/**
 * 利率変動型保険事業費Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RrtHndugtHknJigyohiRn extends AbstractExDBPrimaryKey<ZT_RrtHndugtHknJigyohiRn, PKZT_RrtHndugtHknJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RrtHndugtHknJigyohiRn() {
    }

    public PKZT_RrtHndugtHknJigyohiRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RrtHndugtHknJigyohiRn> getEntityClass() {
        return ZT_RrtHndugtHknJigyohiRn.class;
    }
