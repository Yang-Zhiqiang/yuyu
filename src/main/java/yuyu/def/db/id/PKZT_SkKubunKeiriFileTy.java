...
/**
 * 新契約区分経理ファイルテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKubunKeiriFileTy extends AbstractExDBPrimaryKey<ZT_SkKubunKeiriFileTy, PKZT_SkKubunKeiriFileTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKubunKeiriFileTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKubunKeiriFileTy> getEntityClass() {
        return ZT_SkKubunKeiriFileTy.class;
    }
