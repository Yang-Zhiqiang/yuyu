...
/**
 * ＲＡＹ期末ＶＦテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayKimatuVRn extends AbstractExDBPrimaryKey<ZT_RayKimatuVRn, PKZT_RayKimatuVRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayKimatuVRn() {
    }

    public PKZT_RayKimatuVRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayKimatuVRn> getEntityClass() {
        return ZT_RayKimatuVRn.class;
    }
