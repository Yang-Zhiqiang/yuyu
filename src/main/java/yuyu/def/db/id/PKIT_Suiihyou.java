 ...
 * @see     GenQIT_Suiihyou
 */
public class PKIT_Suiihyou extends AbstractExDBPrimaryKey<IT_Suiihyou, PKIT_Suiihyou> {

    private static final long serialVersionUID = 1L;

    public PKIT_Suiihyou() {
    }
    ...
    @Transient
    @Override
    public Class<IT_Suiihyou> getEntityClass() {
        return IT_Suiihyou.class;
    }
