...
/**
 * 契約保全変更受付内容（解約）バックアップテーブル のプライマリキークラスです。<br />
 ...
 */
public class PKIT_BAK_KhHenkouUktkKaiyaku extends AbstractExDBPrimaryKey<IT_BAK_KhHenkouUktkKaiyaku, PKIT_BAK_KhHenkouUktkKaiyaku> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhHenkouUktkKaiyaku() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhHenkouUktkKaiyaku> getEntityClass() {
        return IT_BAK_KhHenkouUktkKaiyaku.class;
    }
