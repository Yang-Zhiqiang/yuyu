...
/**
 * 振替伝票（控）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_FurikaeDenpyouHikaeRn extends AbstractExDBPrimaryKey<ZT_FurikaeDenpyouHikaeRn, PKZT_FurikaeDenpyouHikaeRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_FurikaeDenpyouHikaeRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_FurikaeDenpyouHikaeRn> getEntityClass() {
        return ZT_FurikaeDenpyouHikaeRn.class;
    }
