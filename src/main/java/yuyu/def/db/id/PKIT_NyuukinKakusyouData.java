 ...
 * @see     GenIT_NyuukinKakusyouData
 * @see     QIT_NyuukinKakusyouData
 * @see     GenQIT_NyuukinKakusyouData
 */
public class PKIT_NyuukinKakusyouData extends AbstractExDBPrimaryKey<IT_NyuukinKakusyouData, PKIT_NyuukinKakusyouData> {

    private static final long serialVersionUID = 1L;

    public PKIT_NyuukinKakusyouData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_NyuukinKakusyouData> getEntityClass() {
        return IT_NyuukinKakusyouData.class;
    }
