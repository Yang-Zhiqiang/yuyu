...
/**
 * 当日異動内容年金支払テーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     BT_TjtIdouNyNk
 * @see     GenBT_TjtIdouNyNk
 * @see     QBT_TjtIdouNyNk
 * @see     GenQBT_TjtIdouNyNk
 */
public class PKBT_TjtIdouNyNk extends AbstractExDBPrimaryKey<BT_TjtIdouNyNk, PKBT_TjtIdouNyNk> {

    private static final long serialVersionUID = 1L;

    public PKBT_TjtIdouNyNk() {
    }

    public PKBT_TjtIdouNyNk(String pNksysyno, Integer pRenno3keta) {
        nksysyno = pNksysyno;
    ...
    @Transient
    @Override
    public Class<BT_TjtIdouNyNk> getEntityClass() {
        return BT_TjtIdouNyNk.class;
    }
