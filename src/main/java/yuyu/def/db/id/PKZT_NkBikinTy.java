 ...
 *  <tr bgcolor="pink"><td>{@link #getZtyshiharaihasseiymd ztyshiharaihasseiymd}</td><td>（中継用）支払発生日</td><td align="center">○</td><td align="center">V</td><td>String</td></tr>
 ...
 */
public class PKZT_NkBikinTy extends AbstractExDBPrimaryKey<ZT_NkBikinTy, PKZT_NkBikinTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkBikinTy() {
    }

    public PKZT_NkBikinTy(String pZtynksyousyono, String pZtyshiharaihasseiymd) {
    ...
    @Transient
    @Override
    public Class<ZT_NkBikinTy> getEntityClass() {
        return ZT_NkBikinTy.class;
    }
