...
/**
 * 消込送信Ｆ（口振）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KesikomiSousinKouhuriTy extends AbstractExDBPrimaryKey<ZT_KesikomiSousinKouhuriTy, PKZT_KesikomiSousinKouhuriTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KesikomiSousinKouhuriTy() {
    }

    public PKZT_KesikomiSousinKouhuriTy(String pZtykskmsousinrenno, String pZtykskmfsyoriymd) {
    ...
    @Transient
    @Override
    public Class<ZT_KesikomiSousinKouhuriTy> getEntityClass() {
        return ZT_KesikomiSousinKouhuriTy.class;
    }
