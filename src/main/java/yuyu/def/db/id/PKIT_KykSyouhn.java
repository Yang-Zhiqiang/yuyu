 ...
 */
public class PKIT_KykSyouhn extends AbstractExDBPrimaryKey<IT_KykSyouhn, PKIT_KykSyouhn> {

    private static final long serialVersionUID = 1L;

    public PKIT_KykSyouhn() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KykSyouhn> getEntityClass() {
        return IT_KykSyouhn.class;
    }
