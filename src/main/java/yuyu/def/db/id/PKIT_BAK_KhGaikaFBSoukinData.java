...
/**
 * 契約保全外貨ＦＢ送金データバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KhGaikaFBSoukinData
 * @see     QIT_BAK_KhGaikaFBSoukinData
 * @see     GenQIT_BAK_KhGaikaFBSoukinData
 */
public class PKIT_BAK_KhGaikaFBSoukinData extends AbstractExDBPrimaryKey<IT_BAK_KhGaikaFBSoukinData, PKIT_BAK_KhGaikaFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhGaikaFBSoukinData() {
    }

    public PKIT_BAK_KhGaikaFBSoukinData(String pFbsoukindatasikibetukey, String pTrkssikibetukey) {
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhGaikaFBSoukinData> getEntityClass() {
        return IT_BAK_KhGaikaFBSoukinData.class;
    }
