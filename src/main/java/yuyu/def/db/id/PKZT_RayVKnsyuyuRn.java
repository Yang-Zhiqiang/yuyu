...
/**
 * ＲＡＹＶ検証用Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayVKnsyuyuRn extends AbstractExDBPrimaryKey<ZT_RayVKnsyuyuRn, PKZT_RayVKnsyuyuRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayVKnsyuyuRn() {
    }

    public PKZT_RayVKnsyuyuRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayVKnsyuyuRn> getEntityClass() {
        return ZT_RayVKnsyuyuRn.class;
    }
