 ...
 * @see     GenQHT_MosKihon
 */
public class PKHT_MosKihon extends AbstractExDBPrimaryKey<HT_MosKihon, PKHT_MosKihon> {

    private static final long serialVersionUID = 1L;

    public PKHT_MosKihon() {
    }

    public PKHT_MosKihon(String pMosno) {
        mosno = pMosno;
    }

    @Transient
    @Override
    public Class<HT_MosKihon> getEntityClass() {
        return HT_MosKihon.class;
    }
