...
/**
 * 契約保全ＬＩＮＣ送信データバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KhLincSousinData
 * @see     QIT_BAK_KhLincSousinData
 * @see     GenQIT_BAK_KhLincSousinData
 */
public class PKIT_BAK_KhLincSousinData extends AbstractExDBPrimaryKey<IT_BAK_KhLincSousinData, PKIT_BAK_KhLincSousinData> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhLincSousinData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhLincSousinData> getEntityClass() {
        return IT_BAK_KhLincSousinData.class;
    }
