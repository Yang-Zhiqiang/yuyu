...
/**
 * 控除証明内容Ｄバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KoujyoSymNaiyouD
 * @see     QIT_BAK_KoujyoSymNaiyouD
 * @see     GenQIT_BAK_KoujyoSymNaiyouD
 */
public class PKIT_BAK_KoujyoSymNaiyouD extends AbstractExDBPrimaryKey<IT_BAK_KoujyoSymNaiyouD, PKIT_BAK_KoujyoSymNaiyouD> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KoujyoSymNaiyouD() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KoujyoSymNaiyouD> getEntityClass() {
        return IT_BAK_KoujyoSymNaiyouD.class;
    }
