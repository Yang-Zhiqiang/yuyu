 ...
 */
public class PKZT_SinkimatuHoyuuFRn extends AbstractExDBPrimaryKey<ZT_SinkimatuHoyuuFRn, PKZT_SinkimatuHoyuuFRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SinkimatuHoyuuFRn() {
    }

    public PKZT_SinkimatuHoyuuFRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_SinkimatuHoyuuFRn> getEntityClass() {
        return ZT_SinkimatuHoyuuFRn.class;
    }
