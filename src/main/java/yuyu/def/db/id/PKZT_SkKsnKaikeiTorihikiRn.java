...
/**
 * 新契約決算用会計取引Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnKaikeiTorihikiRn extends AbstractExDBPrimaryKey<ZT_SkKsnKaikeiTorihikiRn, PKZT_SkKsnKaikeiTorihikiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnKaikeiTorihikiRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnKaikeiTorihikiRn> getEntityClass() {
        return ZT_SkKsnKaikeiTorihikiRn.class;
    }
