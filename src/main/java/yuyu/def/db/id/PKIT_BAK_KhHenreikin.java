...
/**
 * 契約保全返戻金バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KhHenreikin
 * @see     QIT_BAK_KhHenreikin
 * @see     GenQIT_BAK_KhHenreikin
 */
public class PKIT_BAK_KhHenreikin extends AbstractExDBPrimaryKey<IT_BAK_KhHenreikin, PKIT_BAK_KhHenreikin> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhHenreikin() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhHenreikin> getEntityClass() {
        return IT_BAK_KhHenreikin.class;
    }
