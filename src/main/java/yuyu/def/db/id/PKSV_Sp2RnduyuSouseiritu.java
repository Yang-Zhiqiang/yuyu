...
/**
 * ＳＰ２連動用総成立情報ビュー のプライマリキークラスです。<br />
 ...
 */
public class PKSV_Sp2RnduyuSouseiritu extends AbstractExDBPrimaryKey<SV_Sp2RnduyuSouseiritu, PKSV_Sp2RnduyuSouseiritu> {

    private static final long serialVersionUID = 1L;

    public PKSV_Sp2RnduyuSouseiritu() {
    }

    public PKSV_Sp2RnduyuSouseiritu(String pMosno) {
        mosno = pMosno;
    }

    @Transient
    @Override
    public Class<SV_Sp2RnduyuSouseiritu> getEntityClass() {
        return SV_Sp2RnduyuSouseiritu.class;
    }
