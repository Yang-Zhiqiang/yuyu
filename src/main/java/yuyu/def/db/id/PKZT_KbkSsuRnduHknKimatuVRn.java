...
/**
 * 株価指数連動保険期末ＶＦテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KbkSsuRnduHknKimatuVRn extends AbstractExDBPrimaryKey<ZT_KbkSsuRnduHknKimatuVRn, PKZT_KbkSsuRnduHknKimatuVRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KbkSsuRnduHknKimatuVRn() {
    }

    public PKZT_KbkSsuRnduHknKimatuVRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KbkSsuRnduHknKimatuVRn> getEntityClass() {
        return ZT_KbkSsuRnduHknKimatuVRn.class;
    }
