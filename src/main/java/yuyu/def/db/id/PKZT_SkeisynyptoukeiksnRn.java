...
/**
 * 新契約収入Ｐ統計決算Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkeisynyptoukeiksnRn extends AbstractExDBPrimaryKey<ZT_SkeisynyptoukeiksnRn, PKZT_SkeisynyptoukeiksnRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkeisynyptoukeiksnRn() {
    }

    public PKZT_SkeisynyptoukeiksnRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_SkeisynyptoukeiksnRn> getEntityClass() {
        return ZT_SkeisynyptoukeiksnRn.class;
    }
