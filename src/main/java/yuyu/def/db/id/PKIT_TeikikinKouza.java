 ...
 * @see     GenIT_TeikikinKouza
 * @see     QIT_TeikikinKouza
 * @see     GenQIT_TeikikinKouza
 */
public class PKIT_TeikikinKouza extends AbstractExDBPrimaryKey<IT_TeikikinKouza, PKIT_TeikikinKouza> {

    private static final long serialVersionUID = 1L;

    public PKIT_TeikikinKouza() {
    }

    public PKIT_TeikikinKouza(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_TeikikinKouza> getEntityClass() {
        return IT_TeikikinKouza.class;
    }
