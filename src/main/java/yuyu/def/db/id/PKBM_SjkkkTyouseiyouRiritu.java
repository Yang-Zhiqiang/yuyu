 ...
 */
public class PKBM_SjkkkTyouseiyouRiritu extends AbstractExDBPrimaryKey<BM_SjkkkTyouseiyouRiritu, PKBM_SjkkkTyouseiyouRiritu> {

    private static final long serialVersionUID = 1L;

    public PKBM_SjkkkTyouseiyouRiritu() {
    }
    ...
    @Transient
    @Override
    public Class<BM_SjkkkTyouseiyouRiritu> getEntityClass() {
        return BM_SjkkkTyouseiyouRiritu.class;
    }
