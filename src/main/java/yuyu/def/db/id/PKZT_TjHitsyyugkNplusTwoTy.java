...
/**
 * 通常配当所要額Ｆ（Ｎ＋２）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusTwoTy extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusTwoTy, PKZT_TjHitsyyugkNplusTwoTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusTwoTy() {
    }

    public PKZT_TjHitsyyugkNplusTwoTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusTwoTy> getEntityClass() {
        return ZT_TjHitsyyugkNplusTwoTy.class;
    }
