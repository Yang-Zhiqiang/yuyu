...
/**
 * 新契約振替伝票テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkFurikaeDenpyouTy extends AbstractExDBPrimaryKey<ZT_SkFurikaeDenpyouTy, PKZT_SkFurikaeDenpyouTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkFurikaeDenpyouTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkFurikaeDenpyouTy> getEntityClass() {
        return ZT_SkFurikaeDenpyouTy.class;
    }
