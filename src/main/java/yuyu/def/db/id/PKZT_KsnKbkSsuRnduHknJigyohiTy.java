...
/**
 * 決算計上用株価指数連動保険事業費Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 *  <tr><td>ztyloadingkeijyoym</td><td>（中継用）ローディング計上年月</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>ztysihankiksnydatahyj</td><td>（中継用）四半期決算用データ表示</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>ztygmkijyhyj</td><td>（中継用）月末計上表示</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 *  <tr><td>ztyyobin11x18</td><td>（中継用）予備項目Ｎ１１＿１８</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyvhireilkisnyukngkx1</td><td>（中継用）Ｖ比例Ｌ計算用金額＿１</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>ztyvhireilkisnyukngkx2</td><td>（中継用）Ｖ比例Ｌ計算用金額＿２</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 *  <tr><td>ztyrpkeisanyousibous</td><td>（中継用）ＲＰ計算用死亡Ｓ</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztykikens</td><td>（中継用）危険保険金</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyvhireialpha</td><td>（中継用）Ｖ比例α</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyvhireibeta</td><td>（中継用）Ｖ比例β</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztykikenp</td><td>（中継用）危険保険料</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 *  <tr><td>ztyvhireilritu</td><td>（中継用）Ｖ比例Ｌ率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztykikenpritu</td><td>（中継用）危険保険料率</td><td>&nbsp;</td><td align="center">N</td><td>BizNumber</td></tr>
 *  <tr><td>ztytumimasimaew</td><td>（中継用）積増前Ｗ</td><td>&nbsp;</td><td align="center">N</td><td>Long</td></tr>
 ...
 */
public class PKZT_KsnKbkSsuRnduHknJigyohiTy extends AbstractExDBPrimaryKey<ZT_KsnKbkSsuRnduHknJigyohiTy, PKZT_KsnKbkSsuRnduHknJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KsnKbkSsuRnduHknJigyohiTy() {
    }

    public PKZT_KsnKbkSsuRnduHknJigyohiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KsnKbkSsuRnduHknJigyohiTy> getEntityClass() {
        return ZT_KsnKbkSsuRnduHknJigyohiTy.class;
    }
