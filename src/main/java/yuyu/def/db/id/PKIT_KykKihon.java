 ...
 * @see     GenQIT_KykKihon
 */
public class PKIT_KykKihon extends AbstractExDBPrimaryKey<IT_KykKihon, PKIT_KykKihon> {

    private static final long serialVersionUID = 1L;

    public PKIT_KykKihon() {
    }

    public PKIT_KykKihon(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_KykKihon> getEntityClass() {
        return IT_KykKihon.class;
    }
