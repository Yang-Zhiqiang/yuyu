...
/**
 * ＳＭＢＣペーパーレス申込情報２テーブル（取） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SmbcPaperlessMos2Tr extends AbstractExDBPrimaryKey<ZT_SmbcPaperlessMos2Tr, PKZT_SmbcPaperlessMos2Tr> {

    private static final long serialVersionUID = 1L;

    public PKZT_SmbcPaperlessMos2Tr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SmbcPaperlessMos2Tr> getEntityClass() {
        return ZT_SmbcPaperlessMos2Tr.class;
    }
