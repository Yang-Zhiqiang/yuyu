 ...
 */
public class PKHT_Kokutisyo extends AbstractExDBPrimaryKey<HT_Kokutisyo, PKHT_Kokutisyo> {

    private static final long serialVersionUID = 1L;

    public PKHT_Kokutisyo() {
    }

    public PKHT_Kokutisyo(String pMosno) {
        mosno = pMosno;
    }

    @Transient
    @Override
    public Class<HT_Kokutisyo> getEntityClass() {
        return HT_Kokutisyo.class;
    }
