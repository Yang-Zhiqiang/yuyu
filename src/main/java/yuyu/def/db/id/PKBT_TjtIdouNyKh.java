...
/**
 * 当日異動内容契約保全テーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     BT_TjtIdouNyKh
 * @see     GenBT_TjtIdouNyKh
 * @see     QBT_TjtIdouNyKh
 * @see     GenQBT_TjtIdouNyKh
 */
public class PKBT_TjtIdouNyKh extends AbstractExDBPrimaryKey<BT_TjtIdouNyKh, PKBT_TjtIdouNyKh> {

    private static final long serialVersionUID = 1L;

    public PKBT_TjtIdouNyKh() {
    }

    public PKBT_TjtIdouNyKh(String pSyono, Integer pRenno3keta) {
        syono = pSyono;
    ...
    @Transient
    @Override
    public Class<BT_TjtIdouNyKh> getEntityClass() {
        return BT_TjtIdouNyKh.class;
    }
