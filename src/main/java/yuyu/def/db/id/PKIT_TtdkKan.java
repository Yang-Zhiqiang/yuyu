 ...
 * @see     GenQIT_TtdkKan
 */
public class PKIT_TtdkKan extends AbstractExDBPrimaryKey<IT_TtdkKan, PKIT_TtdkKan> {
    ...
    @Transient
    @Override
    public Class<IT_TtdkKan> getEntityClass() {
        return IT_TtdkKan.class;
    }
