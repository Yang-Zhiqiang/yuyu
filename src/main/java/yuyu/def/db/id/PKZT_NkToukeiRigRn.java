...
/**
 * 年金統計Ｆ例月用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkToukeiRigRn extends AbstractExDBPrimaryKey<ZT_NkToukeiRigRn, PKZT_NkToukeiRigRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkToukeiRigRn() {
    }

    public PKZT_NkToukeiRigRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkToukeiRigRn> getEntityClass() {
        return ZT_NkToukeiRigRn.class;
    }
