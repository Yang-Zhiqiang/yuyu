 ...
 * @see     GenIT_KykSyaHenkouRireki
 * @see     QIT_KykSyaHenkouRireki
 * @see     GenQIT_KykSyaHenkouRireki
 */
public class PKIT_KykSyaHenkouRireki extends AbstractExDBPrimaryKey<IT_KykSyaHenkouRireki, PKIT_KykSyaHenkouRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KykSyaHenkouRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KykSyaHenkouRireki> getEntityClass() {
        return IT_KykSyaHenkouRireki.class;
    }
