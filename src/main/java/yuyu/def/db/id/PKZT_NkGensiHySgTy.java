...
/**
 * 年金原資Ｆ保有照合用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkGensiHySgTy extends AbstractExDBPrimaryKey<ZT_NkGensiHySgTy, PKZT_NkGensiHySgTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkGensiHySgTy() {
    }

    public PKZT_NkGensiHySgTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkGensiHySgTy> getEntityClass() {
        return ZT_NkGensiHySgTy.class;
    }
