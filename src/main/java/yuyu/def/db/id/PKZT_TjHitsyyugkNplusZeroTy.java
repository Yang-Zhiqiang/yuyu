 ...
 */
public class PKZT_TjHitsyyugkNplusZeroTy extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusZeroTy, PKZT_TjHitsyyugkNplusZeroTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusZeroTy() {
    }

    public PKZT_TjHitsyyugkNplusZeroTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusZeroTy> getEntityClass() {
        return ZT_TjHitsyyugkNplusZeroTy.class;
    }
