...
/**
 * 消込送信Ｆ（クレ払）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KesikomiSousinCreditRn extends AbstractExDBPrimaryKey<ZT_KesikomiSousinCreditRn, PKZT_KesikomiSousinCreditRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KesikomiSousinCreditRn() {
    }

    public PKZT_KesikomiSousinCreditRn(String pZrnkskmsousinrenno, String pZrnkskmfsyoriymd) {
    ...
    @Transient
    @Override
    public Class<ZT_KesikomiSousinCreditRn> getEntityClass() {
        return ZT_KesikomiSousinCreditRn.class;
    }
