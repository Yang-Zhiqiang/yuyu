 ...
 */
public class PKIT_KhHaitouKanri extends AbstractExDBPrimaryKey<IT_KhHaitouKanri, PKIT_KhHaitouKanri> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhHaitouKanri() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhHaitouKanri> getEntityClass() {
        return IT_KhHaitouKanri.class;
    }
