 ...
 */
public class PKIT_BAK_Kouza extends AbstractExDBPrimaryKey<IT_BAK_Kouza, PKIT_BAK_Kouza> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_Kouza() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_Kouza> getEntityClass() {
        return IT_BAK_Kouza.class;
    }
