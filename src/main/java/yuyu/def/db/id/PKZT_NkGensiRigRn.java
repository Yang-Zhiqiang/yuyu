...
/**
 * 年金原資Ｆ例月用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkGensiRigRn extends AbstractExDBPrimaryKey<ZT_NkGensiRigRn, PKZT_NkGensiRigRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkGensiRigRn() {
    }

    public PKZT_NkGensiRigRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkGensiRigRn> getEntityClass() {
        return ZT_NkGensiRigRn.class;
    }
