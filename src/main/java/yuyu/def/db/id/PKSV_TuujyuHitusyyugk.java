 ...
 * @see     GenSV_TuujyuHitusyyugk
 * @see     QSV_TuujyuHitusyyugk
 * @see     GenQSV_TuujyuHitusyyugk
 */
public class PKSV_TuujyuHitusyyugk extends AbstractExDBPrimaryKey<SV_TuujyuHitusyyugk, PKSV_TuujyuHitusyyugk> {

    private static final long serialVersionUID = 1L;

    public PKSV_TuujyuHitusyyugk() {
    }
    ...
    @Transient
    @Override
    public Class<SV_TuujyuHitusyyugk> getEntityClass() {
        return SV_TuujyuHitusyyugk.class;
    }
