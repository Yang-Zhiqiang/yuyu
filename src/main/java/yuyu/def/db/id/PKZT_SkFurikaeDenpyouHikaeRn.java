...
/**
 * 新契約振替伝票（控）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkFurikaeDenpyouHikaeRn extends AbstractExDBPrimaryKey<ZT_SkFurikaeDenpyouHikaeRn, PKZT_SkFurikaeDenpyouHikaeRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkFurikaeDenpyouHikaeRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkFurikaeDenpyouHikaeRn> getEntityClass() {
        return ZT_SkFurikaeDenpyouHikaeRn.class;
    }
