...
/**
 * 消込送信Ｆ（振替）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KesikomiSousinHurikaeRn extends AbstractExDBPrimaryKey<ZT_KesikomiSousinHurikaeRn, PKZT_KesikomiSousinHurikaeRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KesikomiSousinHurikaeRn() {
    }

    public PKZT_KesikomiSousinHurikaeRn(String pZrnkskmsousinrenno, String pZrnkskmfsyoriymd) {
    ...
    @Transient
    @Override
    public Class<ZT_KesikomiSousinHurikaeRn> getEntityClass() {
        return ZT_KesikomiSousinHurikaeRn.class;
    }
