 ...
 */
public class PKZT_UriageKekkaTr extends AbstractExDBPrimaryKey<ZT_UriageKekkaTr, PKZT_UriageKekkaTr> {

    private static final long serialVersionUID = 1L;

    public PKZT_UriageKekkaTr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_UriageKekkaTr> getEntityClass() {
        return ZT_UriageKekkaTr.class;
    }
