...
/**
 * 口座振替繰越未入ＴＲテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_TRKzhuriKurikosiMinyuu
 * @see     QIT_TRKzhuriKurikosiMinyuu
 * @see     GenQIT_TRKzhuriKurikosiMinyuu
 */
public class PKIT_TRKzhuriKurikosiMinyuu extends AbstractExDBPrimaryKey<IT_TRKzhuriKurikosiMinyuu, PKIT_TRKzhuriKurikosiMinyuu> {

    private static final long serialVersionUID = 1L;

    public PKIT_TRKzhuriKurikosiMinyuu() {
    }
    ...
    @Transient
    @Override
    public Class<IT_TRKzhuriKurikosiMinyuu> getEntityClass() {
        return IT_TRKzhuriKurikosiMinyuu.class;
    }
