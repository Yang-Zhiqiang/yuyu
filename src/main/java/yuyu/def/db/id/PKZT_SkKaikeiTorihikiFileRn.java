...
/**
 * 新契約会計取引ファイルテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKaikeiTorihikiFileRn extends AbstractExDBPrimaryKey<ZT_SkKaikeiTorihikiFileRn, PKZT_SkKaikeiTorihikiFileRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKaikeiTorihikiFileRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKaikeiTorihikiFileRn> getEntityClass() {
        return ZT_SkKaikeiTorihikiFileRn.class;
    }
