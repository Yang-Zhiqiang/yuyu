...
/**
 * 外貨ＦＢ送金データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenBT_GkFBSoukinData
 * @see     QBT_GkFBSoukinData
 * @see     GenQBT_GkFBSoukinData
 */
public class PKBT_GkFBSoukinData extends AbstractExDBPrimaryKey<BT_GkFBSoukinData, PKBT_GkFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKBT_GkFBSoukinData() {
    }

    public PKBT_GkFBSoukinData(String pFbsoukindatasikibetukey) {
        fbsoukindatasikibetukey = pFbsoukindatasikibetukey;
    }

    @Transient
    @Override
    public Class<BT_GkFBSoukinData> getEntityClass() {
        return BT_GkFBSoukinData.class;
    }
