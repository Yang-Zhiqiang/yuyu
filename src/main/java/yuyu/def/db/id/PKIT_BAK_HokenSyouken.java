...
/**
 * 保険証券バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_HokenSyouken
 * @see     QIT_BAK_HokenSyouken
 * @see     GenQIT_BAK_HokenSyouken
 */
public class PKIT_BAK_HokenSyouken extends AbstractExDBPrimaryKey<IT_BAK_HokenSyouken, PKIT_BAK_HokenSyouken> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_HokenSyouken() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_HokenSyouken> getEntityClass() {
        return IT_BAK_HokenSyouken.class;
    }
