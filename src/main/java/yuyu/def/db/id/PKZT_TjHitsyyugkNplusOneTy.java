...
/**
 * 通常配当所要額Ｆ（Ｎ＋１）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusOneTy extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusOneTy, PKZT_TjHitsyyugkNplusOneTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusOneTy() {
    }

    public PKZT_TjHitsyyugkNplusOneTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusOneTy> getEntityClass() {
        return ZT_TjHitsyyugkNplusOneTy.class;
    }
