...
/**
 * 株価指数連動保険異動ＶＦテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KbkSsuRnduHknIdouVTy extends AbstractExDBPrimaryKey<ZT_KbkSsuRnduHknIdouVTy, PKZT_KbkSsuRnduHknIdouVTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KbkSsuRnduHknIdouVTy() {
    }

    public PKZT_KbkSsuRnduHknIdouVTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KbkSsuRnduHknIdouVTy> getEntityClass() {
        return ZT_KbkSsuRnduHknIdouVTy.class;
    }
