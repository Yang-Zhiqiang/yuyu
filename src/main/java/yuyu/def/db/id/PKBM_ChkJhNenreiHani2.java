...
/**
 * 年齢範囲事方書チェックマスタ２ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_ChkJhNenreiHani2 extends AbstractExDBPrimaryKey<BM_ChkJhNenreiHani2, PKBM_ChkJhNenreiHani2> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkJhNenreiHani2() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkJhNenreiHani2> getEntityClass() {
        return BM_ChkJhNenreiHani2.class;
    }
