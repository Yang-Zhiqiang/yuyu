...
/**
 * ＲＡＹＶ検証用Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayVKnsyuyuTy extends AbstractExDBPrimaryKey<ZT_RayVKnsyuyuTy, PKZT_RayVKnsyuyuTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayVKnsyuyuTy() {
    }

    public PKZT_RayVKnsyuyuTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayVKnsyuyuTy> getEntityClass() {
        return ZT_RayVKnsyuyuTy.class;
    }
