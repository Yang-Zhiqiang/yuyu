 ...
 * @see     GenMT_DsSoukinyouKouza
 * @see     QMT_DsSoukinyouKouza
 * @see     GenQMT_DsSoukinyouKouza
 */
public class PKMT_DsSoukinyouKouza extends AbstractExDBPrimaryKey<MT_DsSoukinyouKouza, PKMT_DsSoukinyouKouza> {

    private static final long serialVersionUID = 1L;

    public PKMT_DsSoukinyouKouza() {
    }
    ...
    @Transient
    @Override
    public Class<MT_DsSoukinyouKouza> getEntityClass() {
        return MT_DsSoukinyouKouza.class;
    }
