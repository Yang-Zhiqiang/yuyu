...
/**
 * 通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_TjHitsyyugkNplusQuartRn extends AbstractExDBPrimaryKey<ZT_TjHitsyyugkNplusQuartRn, PKZT_TjHitsyyugkNplusQuartRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_TjHitsyyugkNplusQuartRn() {
    }

    public PKZT_TjHitsyyugkNplusQuartRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_TjHitsyyugkNplusQuartRn> getEntityClass() {
        return ZT_TjHitsyyugkNplusQuartRn.class;
    }
