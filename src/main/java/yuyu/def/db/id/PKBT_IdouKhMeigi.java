...
/**
 * 異動契約保全名義管理テーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     BT_IdouKhMeigi
 * @see     GenBT_IdouKhMeigi
 * @see     QBT_IdouKhMeigi
 * @see     GenQBT_IdouKhMeigi
 */
public class PKBT_IdouKhMeigi extends AbstractExDBPrimaryKey<BT_IdouKhMeigi, PKBT_IdouKhMeigi> {

    private static final long serialVersionUID = 1L;

    public PKBT_IdouKhMeigi() {
    }

    public PKBT_IdouKhMeigi(String pSyono, Integer pRenno3keta) {
        syono = pSyono;
    ...
    @Transient
    @Override
    public Class<BT_IdouKhMeigi> getEntityClass() {
        return BT_IdouKhMeigi.class;
    }
