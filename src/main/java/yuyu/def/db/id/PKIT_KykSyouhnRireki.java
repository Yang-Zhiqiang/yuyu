 ...
 * @see     GenIT_KykSyouhnRireki
 * @see     QIT_KykSyouhnRireki
 * @see     GenQIT_KykSyouhnRireki
 */
public class PKIT_KykSyouhnRireki extends AbstractExDBPrimaryKey<IT_KykSyouhnRireki, PKIT_KykSyouhnRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_KykSyouhnRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KykSyouhnRireki> getEntityClass() {
        return IT_KykSyouhnRireki.class;
    }
