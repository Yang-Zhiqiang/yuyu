 ...
 * @see     GenIT_KhAuthoriData
 * @see     QIT_KhAuthoriData
 * @see     GenQIT_KhAuthoriData
 */
public class PKIT_KhAuthoriData extends AbstractExDBPrimaryKey<IT_KhAuthoriData, PKIT_KhAuthoriData> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhAuthoriData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhAuthoriData> getEntityClass() {
        return IT_KhAuthoriData.class;
    }
