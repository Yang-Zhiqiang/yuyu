...
/**
 * 利差のみ通常配当所要額Ｆ（Ｎ＋Ｑ）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RisaTjHitNplusQuartTy extends AbstractExDBPrimaryKey<ZT_RisaTjHitNplusQuartTy, PKZT_RisaTjHitNplusQuartTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RisaTjHitNplusQuartTy() {
    }

    public PKZT_RisaTjHitNplusQuartTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RisaTjHitNplusQuartTy> getEntityClass() {
        return ZT_RisaTjHitNplusQuartTy.class;
    }
