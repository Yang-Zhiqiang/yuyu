...
/**
 * ＲＡＹ異動ＶＦテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayIdouVTy extends AbstractExDBPrimaryKey<ZT_RayIdouVTy, PKZT_RayIdouVTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayIdouVTy() {
    }

    public PKZT_RayIdouVTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayIdouVTy> getEntityClass() {
        return ZT_RayIdouVTy.class;
    }
