 ...
 * @see     GenQBM_RateV2
 */
public class PKBM_RateV2 extends AbstractExDBPrimaryKey<BM_RateV2, PKBM_RateV2> {
    ...
    @Transient
    @Override
    public Class<BM_RateV2> getEntityClass() {
        return BM_RateV2.class;
    }
