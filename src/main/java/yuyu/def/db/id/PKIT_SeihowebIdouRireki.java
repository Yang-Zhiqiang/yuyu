...
/**
 * 生保Ｗｅｂ用異動履歴テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_SeihowebIdouRireki
 * @see     QIT_SeihowebIdouRireki
 * @see     GenQIT_SeihowebIdouRireki
 */
public class PKIT_SeihowebIdouRireki extends AbstractExDBPrimaryKey<IT_SeihowebIdouRireki, PKIT_SeihowebIdouRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_SeihowebIdouRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_SeihowebIdouRireki> getEntityClass() {
        return IT_SeihowebIdouRireki.class;
    }
