...
/**
 * 新契約決算ベース月次成立Ｆテーブル５（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_Skeiksnbsgetujisr5Rn extends AbstractExDBPrimaryKey<ZT_Skeiksnbsgetujisr5Rn, PKZT_Skeiksnbsgetujisr5Rn> {

    private static final long serialVersionUID = 1L;

    public PKZT_Skeiksnbsgetujisr5Rn() {
    }

    public PKZT_Skeiksnbsgetujisr5Rn(String pZrnktgysyono) {
        zrnktgysyono = pZrnktgysyono;
    }

    @Transient
    @Override
    public Class<ZT_Skeiksnbsgetujisr5Rn> getEntityClass() {
        return ZT_Skeiksnbsgetujisr5Rn.class;
    }
