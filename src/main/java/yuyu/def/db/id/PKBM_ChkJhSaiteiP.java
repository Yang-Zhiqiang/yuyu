...
/**
 * 最低Ｐ事方書チェックマスタ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_ChkJhSaiteiP extends AbstractExDBPrimaryKey<BM_ChkJhSaiteiP, PKBM_ChkJhSaiteiP> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkJhSaiteiP() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkJhSaiteiP> getEntityClass() {
        return BM_ChkJhSaiteiP.class;
    }
