...
/**
 * オンライン外貨入出金明細テーブル のプライマリキークラスです。<br />
 ...
 */
public class PKBT_OnlineGknyknmeisai extends AbstractExDBPrimaryKey<BT_OnlineGknyknmeisai, PKBT_OnlineGknyknmeisai> {

    private static final long serialVersionUID = 1L;

    public PKBT_OnlineGknyknmeisai() {
    }
    ...
    @Transient
    @Override
    public Class<BT_OnlineGknyknmeisai> getEntityClass() {
        return BT_OnlineGknyknmeisai.class;
    }
