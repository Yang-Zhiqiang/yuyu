 ...
 *  <tr><td>drtentsinadrkj</td><td>代理店通信先住所（漢字）</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 ...
 */
public class PKIT_MinyuList extends AbstractExDBPrimaryKey<IT_MinyuList, PKIT_MinyuList> {

    private static final long serialVersionUID = 1L;

    public PKIT_MinyuList() {
    }
    ...
    @Transient
    @Override
    public Class<IT_MinyuList> getEntityClass() {
        return IT_MinyuList.class;
    }
