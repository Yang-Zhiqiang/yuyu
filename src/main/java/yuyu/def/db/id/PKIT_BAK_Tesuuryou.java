...
/**
 * 手数料情報バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_Tesuuryou
 * @see     QIT_BAK_Tesuuryou
 * @see     GenQIT_BAK_Tesuuryou
 */
public class PKIT_BAK_Tesuuryou extends AbstractExDBPrimaryKey<IT_BAK_Tesuuryou, PKIT_BAK_Tesuuryou> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_Tesuuryou() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_Tesuuryou> getEntityClass() {
        return IT_BAK_Tesuuryou.class;
    }
