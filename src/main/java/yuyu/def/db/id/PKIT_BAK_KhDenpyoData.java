...
/**
 * 契約保全伝票データバックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KhDenpyoData
 * @see     QIT_BAK_KhDenpyoData
 * @see     GenQIT_BAK_KhDenpyoData
 */
public class PKIT_BAK_KhDenpyoData extends AbstractExDBPrimaryKey<IT_BAK_KhDenpyoData, PKIT_BAK_KhDenpyoData> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhDenpyoData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhDenpyoData> getEntityClass() {
        return IT_BAK_KhDenpyoData.class;
    }
