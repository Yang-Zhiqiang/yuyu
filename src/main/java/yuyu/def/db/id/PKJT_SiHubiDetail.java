 ...
 * </table>
 * @see     JT_SiHubiDetail
 * @see     GenJT_SiHubiDetail
 * @see     QJT_SiHubiDetail
 * @see     GenQJT_SiHubiDetail
 */
public class PKJT_SiHubiDetail extends AbstractExDBPrimaryKey<JT_SiHubiDetail, PKJT_SiHubiDetail> {

    private static final long serialVersionUID = 1L;

    public PKJT_SiHubiDetail() {
    }

    public PKJT_SiHubiDetail(String pHubisikibetukey, Integer pRenno3keta) {
    ...
    @Transient
    @Override
    public Class<JT_SiHubiDetail> getEntityClass() {
        return JT_SiHubiDetail.class;
    }
