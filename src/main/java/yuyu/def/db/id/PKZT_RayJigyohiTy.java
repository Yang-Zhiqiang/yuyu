...
/**
 * ＲＡＹ事業費Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayJigyohiTy extends AbstractExDBPrimaryKey<ZT_RayJigyohiTy, PKZT_RayJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayJigyohiTy() {
    }

    public PKZT_RayJigyohiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayJigyohiTy> getEntityClass() {
        return ZT_RayJigyohiTy.class;
    }
