...
/**
 * 手続完了（払方変更）バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_HrhnTtdkKan
 * @see     QIT_BAK_HrhnTtdkKan
 * @see     GenQIT_BAK_HrhnTtdkKan
 */
public class PKIT_BAK_HrhnTtdkKan extends AbstractExDBPrimaryKey<IT_BAK_HrhnTtdkKan, PKIT_BAK_HrhnTtdkKan> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_HrhnTtdkKan() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_HrhnTtdkKan> getEntityClass() {
        return IT_BAK_HrhnTtdkKan.class;
    }
