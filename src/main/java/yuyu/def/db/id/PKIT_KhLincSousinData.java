...
/**
 * 契約保全ＬＩＮＣ送信データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhLincSousinData
 * @see     QIT_KhLincSousinData
 * @see     GenQIT_KhLincSousinData
 */
public class PKIT_KhLincSousinData extends AbstractExDBPrimaryKey<IT_KhLincSousinData, PKIT_KhLincSousinData> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhLincSousinData() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhLincSousinData> getEntityClass() {
        return IT_KhLincSousinData.class;
    }
