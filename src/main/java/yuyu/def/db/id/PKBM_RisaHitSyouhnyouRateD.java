...
/**
 * 利差配当商品用Ｄレートマスタ のプライマリキークラスです。<br />
 ...
 */
public class PKBM_RisaHitSyouhnyouRateD extends AbstractExDBPrimaryKey<BM_RisaHitSyouhnyouRateD, PKBM_RisaHitSyouhnyouRateD> {

    private static final long serialVersionUID = 1L;

    public PKBM_RisaHitSyouhnyouRateD() {
    }
    ...
    @Transient
    @Override
    public Class<BM_RisaHitSyouhnyouRateD> getEntityClass() {
        return BM_RisaHitSyouhnyouRateD.class;
    }
