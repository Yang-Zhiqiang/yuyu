...
/**
 * 新契約決算用区分経理Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnKubunKeiriTy extends AbstractExDBPrimaryKey<ZT_SkKsnKubunKeiriTy, PKZT_SkKsnKubunKeiriTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnKubunKeiriTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnKubunKeiriTy> getEntityClass() {
        return ZT_SkKsnKubunKeiriTy.class;
    }
