 ...
 * @see     GenHT_UketorininVrf
 * @see     QHT_UketorininVrf
 * @see     GenQHT_UketorininVrf
 */
public class PKHT_UketorininVrf extends AbstractExDBPrimaryKey<HT_UketorininVrf, PKHT_UketorininVrf> {

    private static final long serialVersionUID = 1L;

    public PKHT_UketorininVrf() {
    }
    ...
    @Transient
    @Override
    public Class<HT_UketorininVrf> getEntityClass() {
        return HT_UketorininVrf.class;
    }
