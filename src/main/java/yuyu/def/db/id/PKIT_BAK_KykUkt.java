...
/**
 * 契約受取人バックアップテーブル のプライマリキークラスです。<br />
 ...
 * </table>
 * @see     IT_BAK_KykUkt
 * @see     GenIT_BAK_KykUkt
 * @see     QIT_BAK_KykUkt
 * @see     GenQIT_BAK_KykUkt
 */
public class PKIT_BAK_KykUkt extends AbstractExDBPrimaryKey<IT_BAK_KykUkt, PKIT_BAK_KykUkt> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KykUkt() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KykUkt> getEntityClass() {
        return IT_BAK_KykUkt.class;
    }
