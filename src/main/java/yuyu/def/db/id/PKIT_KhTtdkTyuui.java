 ...
 * </table>
 * @see     IT_KhTtdkTyuui
 * @see     GenIT_KhTtdkTyuui
 * @see     QIT_KhTtdkTyuui
 * @see     GenQIT_KhTtdkTyuui
 */
public class PKIT_KhTtdkTyuui extends AbstractExDBPrimaryKey<IT_KhTtdkTyuui, PKIT_KhTtdkTyuui> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhTtdkTyuui() {
    }

    public PKIT_KhTtdkTyuui(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_KhTtdkTyuui> getEntityClass() {
        return IT_KhTtdkTyuui.class;
    }
