 ...
 */
public class PKZT_SmbcBosTr extends AbstractExDBPrimaryKey<ZT_SmbcBosTr, PKZT_SmbcBosTr> {

    private static final long serialVersionUID = 1L;

    public PKZT_SmbcBosTr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SmbcBosTr> getEntityClass() {
        return ZT_SmbcBosTr.class;
    }
