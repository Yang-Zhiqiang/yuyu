...
/**
 * 定期金支払口座バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_TeikikinKouza
 * @see     QIT_BAK_TeikikinKouza
 * @see     GenQIT_BAK_TeikikinKouza
 */
public class PKIT_BAK_TeikikinKouza extends AbstractExDBPrimaryKey<IT_BAK_TeikikinKouza, PKIT_BAK_TeikikinKouza> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_TeikikinKouza() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_TeikikinKouza> getEntityClass() {
        return IT_BAK_TeikikinKouza.class;
    }
