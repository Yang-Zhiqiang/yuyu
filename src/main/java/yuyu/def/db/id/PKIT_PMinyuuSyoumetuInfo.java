 ...
 * @see     GenIT_PMinyuuSyoumetuInfo
 * @see     QIT_PMinyuuSyoumetuInfo
 * @see     GenQIT_PMinyuuSyoumetuInfo
 */
public class PKIT_PMinyuuSyoumetuInfo extends AbstractExDBPrimaryKey<IT_PMinyuuSyoumetuInfo, PKIT_PMinyuuSyoumetuInfo> {

    private static final long serialVersionUID = 1L;

    public PKIT_PMinyuuSyoumetuInfo() {
    }

    public PKIT_PMinyuuSyoumetuInfo(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_PMinyuuSyoumetuInfo> getEntityClass() {
        return IT_PMinyuuSyoumetuInfo.class;
    }
