...
/**
 * 年金原資Ｆ期中報告用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkGensiKtyRn extends AbstractExDBPrimaryKey<ZT_NkGensiKtyRn, PKZT_NkGensiKtyRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkGensiKtyRn() {
    }

    public PKZT_NkGensiKtyRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkGensiKtyRn> getEntityClass() {
        return ZT_NkGensiKtyRn.class;
    }
