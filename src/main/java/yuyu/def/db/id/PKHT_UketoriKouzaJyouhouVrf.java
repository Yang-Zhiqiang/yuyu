...
/**
 * 受取口座情報ベリファイテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenHT_UketoriKouzaJyouhouVrf
 * @see     QHT_UketoriKouzaJyouhouVrf
 * @see     GenQHT_UketoriKouzaJyouhouVrf
 */
public class PKHT_UketoriKouzaJyouhouVrf extends AbstractExDBPrimaryKey<HT_UketoriKouzaJyouhouVrf, PKHT_UketoriKouzaJyouhouVrf> {

    private static final long serialVersionUID = 1L;

    public PKHT_UketoriKouzaJyouhouVrf() {
    }

    public PKHT_UketoriKouzaJyouhouVrf(String pMosno, C_UketorikouzasyubetuKbn pUktkzsyubetukbn) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<HT_UketoriKouzaJyouhouVrf> getEntityClass() {
        return HT_UketoriKouzaJyouhouVrf.class;
    }
