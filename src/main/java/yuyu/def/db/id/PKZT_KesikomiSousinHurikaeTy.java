...
/**
 * 消込送信Ｆ（振替）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KesikomiSousinHurikaeTy extends AbstractExDBPrimaryKey<ZT_KesikomiSousinHurikaeTy, PKZT_KesikomiSousinHurikaeTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KesikomiSousinHurikaeTy() {
    }

    public PKZT_KesikomiSousinHurikaeTy(String pZtykskmsousinrenno, String pZtykskmfsyoriymd) {
    ...
    @Transient
    @Override
    public Class<ZT_KesikomiSousinHurikaeTy> getEntityClass() {
        return ZT_KesikomiSousinHurikaeTy.class;
    }
