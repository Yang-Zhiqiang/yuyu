 ...
 */
public class PKIT_KhHenkouUktk extends AbstractExDBPrimaryKey<IT_KhHenkouUktk, PKIT_KhHenkouUktk> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhHenkouUktk() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhHenkouUktk> getEntityClass() {
        return IT_KhHenkouUktk.class;
    }
