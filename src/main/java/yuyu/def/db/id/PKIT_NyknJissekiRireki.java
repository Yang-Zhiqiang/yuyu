 ...
 * @see     GenIT_NyknJissekiRireki
 * @see     QIT_NyknJissekiRireki
 * @see     GenQIT_NyknJissekiRireki
 */
public class PKIT_NyknJissekiRireki extends AbstractExDBPrimaryKey<IT_NyknJissekiRireki, PKIT_NyknJissekiRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_NyknJissekiRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_NyknJissekiRireki> getEntityClass() {
        return IT_NyknJissekiRireki.class;
    }
