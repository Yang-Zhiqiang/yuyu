...
/**
 * 契約その他特約バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KykSonotaTkyk
 * @see     QIT_BAK_KykSonotaTkyk
 * @see     GenQIT_BAK_KykSonotaTkyk
 */
public class PKIT_BAK_KykSonotaTkyk extends AbstractExDBPrimaryKey<IT_BAK_KykSonotaTkyk, PKIT_BAK_KykSonotaTkyk> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KykSonotaTkyk() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KykSonotaTkyk> getEntityClass() {
        return IT_BAK_KykSonotaTkyk.class;
    }
