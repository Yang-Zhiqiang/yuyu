...
/**
 * 年金配当所要額Ｆ例月報告用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkHitRigTy extends AbstractExDBPrimaryKey<ZT_NkHitRigTy, PKZT_NkHitRigTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkHitRigTy() {
    }

    public PKZT_NkHitRigTy(String pZtynksyousyono) {
        ztynksyousyono = pZtynksyousyono;
    }

    @Transient
    @Override
    public Class<ZT_NkHitRigTy> getEntityClass() {
        return ZT_NkHitRigTy.class;
    }
