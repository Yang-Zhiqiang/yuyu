 ...
 * @see     GenQIT_HhknSya
 */
public class PKIT_HhknSya extends AbstractExDBPrimaryKey<IT_HhknSya, PKIT_HhknSya> {
    ...
    public PKIT_HhknSya(String pKbnkey, String pSyono) {
        kbnkey = pKbnkey;
        syono = pSyono;
    }
    ...
    @Transient
    @Override
    public Class<IT_HhknSya> getEntityClass() {
        return IT_HhknSya.class;
    }
