...
/**
 * 案内収納履歴バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_AnsyuRireki
 * @see     QIT_BAK_AnsyuRireki
 * @see     GenQIT_BAK_AnsyuRireki
 */
public class PKIT_BAK_AnsyuRireki extends AbstractExDBPrimaryKey<IT_BAK_AnsyuRireki, PKIT_BAK_AnsyuRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_AnsyuRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_AnsyuRireki> getEntityClass() {
        return IT_BAK_AnsyuRireki.class;
    }
