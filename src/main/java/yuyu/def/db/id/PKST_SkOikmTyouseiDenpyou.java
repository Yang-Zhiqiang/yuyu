...
/**
 * 新契約追込調整伝票データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenST_SkOikmTyouseiDenpyou
 * @see     QST_SkOikmTyouseiDenpyou
 * @see     GenQST_SkOikmTyouseiDenpyou
 */
public class PKST_SkOikmTyouseiDenpyou extends AbstractExDBPrimaryKey<ST_SkOikmTyouseiDenpyou, PKST_SkOikmTyouseiDenpyou> {

    private static final long serialVersionUID = 1L;

    public PKST_SkOikmTyouseiDenpyou() {
    }
    ...
    @Transient
    @Override
    public Class<ST_SkOikmTyouseiDenpyou> getEntityClass() {
        return ST_SkOikmTyouseiDenpyou.class;
    }
