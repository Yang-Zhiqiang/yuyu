...
/**
 * 年金配当所要額Ｆ例月報告用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkHitRigRn extends AbstractExDBPrimaryKey<ZT_NkHitRigRn, PKZT_NkHitRigRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkHitRigRn() {
    }

    public PKZT_NkHitRigRn(String pZrnnksyousyono) {
        zrnnksyousyono = pZrnnksyousyono;
    }

    @Transient
    @Override
    public Class<ZT_NkHitRigRn> getEntityClass() {
        return ZT_NkHitRigRn.class;
    }
