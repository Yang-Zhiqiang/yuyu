...
/**
 * 会計取引ファイルテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KaikeiTorihikiFileTy extends AbstractExDBPrimaryKey<ZT_KaikeiTorihikiFileTy, PKZT_KaikeiTorihikiFileTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KaikeiTorihikiFileTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_KaikeiTorihikiFileTy> getEntityClass() {
        return ZT_KaikeiTorihikiFileTy.class;
    }
