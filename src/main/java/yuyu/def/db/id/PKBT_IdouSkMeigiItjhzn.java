...
/**
 * 異動新契約名義管理一時保存テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenBT_IdouSkMeigiItjhzn
 * @see     QBT_IdouSkMeigiItjhzn
 * @see     GenQBT_IdouSkMeigiItjhzn
 */
public class PKBT_IdouSkMeigiItjhzn extends AbstractExDBPrimaryKey<BT_IdouSkMeigiItjhzn, PKBT_IdouSkMeigiItjhzn> {

    private static final long serialVersionUID = 1L;

    public PKBT_IdouSkMeigiItjhzn() {
    }

    public PKBT_IdouSkMeigiItjhzn(String pMosno, Integer pRenno3keta) {
        mosno = pMosno;
    ...
    @Transient
    @Override
    public Class<BT_IdouSkMeigiItjhzn> getEntityClass() {
        return BT_IdouSkMeigiItjhzn.class;
    }
