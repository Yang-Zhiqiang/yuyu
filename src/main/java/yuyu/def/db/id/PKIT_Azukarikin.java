 ...
 * </table>
 * @see     IT_Azukarikin
 * @see     GenIT_Azukarikin
 * @see     QIT_Azukarikin
 * @see     GenQIT_Azukarikin
 */
public class PKIT_Azukarikin extends AbstractExDBPrimaryKey<IT_Azukarikin, PKIT_Azukarikin> {

    private static final long serialVersionUID = 1L;

    public PKIT_Azukarikin() {
    }
    ...
    @Transient
    @Override
    public Class<IT_Azukarikin> getEntityClass() {
        return IT_Azukarikin.class;
    }
