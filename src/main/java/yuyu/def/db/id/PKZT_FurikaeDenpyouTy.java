 ...
 */
public class PKZT_FurikaeDenpyouTy extends AbstractExDBPrimaryKey<ZT_FurikaeDenpyouTy, PKZT_FurikaeDenpyouTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_FurikaeDenpyouTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_FurikaeDenpyouTy> getEntityClass() {
        return ZT_FurikaeDenpyouTy.class;
    }
