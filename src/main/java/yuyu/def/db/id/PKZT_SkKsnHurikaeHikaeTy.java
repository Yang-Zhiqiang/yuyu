...
/**
 * 新契約決算用振替伝票（控）テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnHurikaeHikaeTy extends AbstractExDBPrimaryKey<ZT_SkKsnHurikaeHikaeTy, PKZT_SkKsnHurikaeHikaeTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnHurikaeHikaeTy() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnHurikaeHikaeTy> getEntityClass() {
        return ZT_SkKsnHurikaeHikaeTy.class;
    }
