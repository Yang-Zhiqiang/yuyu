 ...
 * </table>
 * @see     HT_Uketorinin
 * @see     GenHT_Uketorinin
 * @see     QHT_Uketorinin
 * @see     GenQHT_Uketorinin
 */
public class PKHT_Uketorinin extends AbstractExDBPrimaryKey<HT_Uketorinin, PKHT_Uketorinin> {

    private static final long serialVersionUID = 1L;

    public PKHT_Uketorinin() {
    }
    ...
    @Transient
    @Override
    public Class<HT_Uketorinin> getEntityClass() {
        return HT_Uketorinin.class;
    }
