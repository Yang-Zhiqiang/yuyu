...
/**
 * 新契約決算用振替伝票（控）テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkKsnHurikaeHikaeRn extends AbstractExDBPrimaryKey<ZT_SkKsnHurikaeHikaeRn, PKZT_SkKsnHurikaeHikaeRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkKsnHurikaeHikaeRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SkKsnHurikaeHikaeRn> getEntityClass() {
        return ZT_SkKsnHurikaeHikaeRn.class;
    }
