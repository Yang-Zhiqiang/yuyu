...
/**
 * 控除証明書管理バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KoujyoSymKanri
 * @see     QIT_BAK_KoujyoSymKanri
 * @see     GenQIT_BAK_KoujyoSymKanri
 */
public class PKIT_BAK_KoujyoSymKanri extends AbstractExDBPrimaryKey<IT_BAK_KoujyoSymKanri, PKIT_BAK_KoujyoSymKanri> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KoujyoSymKanri() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KoujyoSymKanri> getEntityClass() {
        return IT_BAK_KoujyoSymKanri.class;
    }
