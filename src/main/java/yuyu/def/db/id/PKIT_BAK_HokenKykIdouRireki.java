...
/**
 * 保険契約異動情報履歴バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_HokenKykIdouRireki
 * @see     QIT_BAK_HokenKykIdouRireki
 * @see     GenQIT_BAK_HokenKykIdouRireki
 */
public class PKIT_BAK_HokenKykIdouRireki extends AbstractExDBPrimaryKey<IT_BAK_HokenKykIdouRireki, PKIT_BAK_HokenKykIdouRireki> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_HokenKykIdouRireki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_HokenKykIdouRireki> getEntityClass() {
        return IT_BAK_HokenKykIdouRireki.class;
    }
