...
/**
 * 年金配当所要額Ｆ期中報告用テーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkHitKtyTy extends AbstractExDBPrimaryKey<ZT_NkHitKtyTy, PKZT_NkHitKtyTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkHitKtyTy() {
    }

    public PKZT_NkHitKtyTy(String pZtynksyousyono) {
        ztynksyousyono = pZtynksyousyono;
    }

    @Transient
    @Override
    public Class<ZT_NkHitKtyTy> getEntityClass() {
        return ZT_NkHitKtyTy.class;
    }
