 ...
 * </table>
 * @see     IT_BAK_Zennou
 * @see     GenIT_BAK_Zennou
 * @see     QIT_BAK_Zennou
 * @see     GenQIT_BAK_Zennou
 */
public class PKIT_BAK_Zennou extends AbstractExDBPrimaryKey<IT_BAK_Zennou, PKIT_BAK_Zennou> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_Zennou() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_Zennou> getEntityClass() {
        return IT_BAK_Zennou.class;
    }
