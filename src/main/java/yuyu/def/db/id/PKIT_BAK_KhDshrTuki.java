...
/**
 * 契約保全Ｄ支払統計バックアップテーブル のプライマリキークラスです。<br />
 ...
 */
public class PKIT_BAK_KhDshrTuki extends AbstractExDBPrimaryKey<IT_BAK_KhDshrTuki, PKIT_BAK_KhDshrTuki> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhDshrTuki() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhDshrTuki> getEntityClass() {
        return IT_BAK_KhDshrTuki.class;
    }
