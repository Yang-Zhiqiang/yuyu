...
/**
 * 契約保全支払履歴明細テーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_KhShrRirekiDetail
 * @see     QIT_KhShrRirekiDetail
 * @see     GenQIT_KhShrRirekiDetail
 */
public class PKIT_KhShrRirekiDetail extends AbstractExDBPrimaryKey<IT_KhShrRirekiDetail, PKIT_KhShrRirekiDetail> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhShrRirekiDetail() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhShrRirekiDetail> getEntityClass() {
        return IT_KhShrRirekiDetail.class;
    }
