...
/**
 * 振替用紙バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_HurikaeYousi
 * @see     QIT_BAK_HurikaeYousi
 * @see     GenQIT_BAK_HurikaeYousi
 */
public class PKIT_BAK_HurikaeYousi extends AbstractExDBPrimaryKey<IT_BAK_HurikaeYousi, PKIT_BAK_HurikaeYousi> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_HurikaeYousi() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_HurikaeYousi> getEntityClass() {
        return IT_BAK_HurikaeYousi.class;
    }
