 ...
 *  <tr><td>warimsishrgkbizc</td><td>割増支払金額（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 *  <tr><td>znnphrbizc</td><td>前納Ｐ等返戻金（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 *  <tr><td>ttkekstkganribizc</td><td>立替貸付元利金（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 *  <tr><td>sshkdbizc</td><td>差引Ｄ（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 *  <tr><td>sshkshrgk</td><td>差引支払金額</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 *  <tr><td>mihrkmpbizc</td><td>未払込Ｐ（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 ...
 *  <tr><td>syuseijtshrdbizc</td><td>修正後実支払Ｄ（業務通貨型）</td><td>&nbsp;</td><td align="center">N</td><td>BizCurrency</td></tr>
 ...
 */
public class PKIT_KhTyousyo extends AbstractExDBPrimaryKey<IT_KhTyousyo, PKIT_KhTyousyo> {

    private static final long serialVersionUID = 1L;

    public PKIT_KhTyousyo() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KhTyousyo> getEntityClass() {
        return IT_KhTyousyo.class;
    }
