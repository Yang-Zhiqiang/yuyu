...
/**
 * 年金配当所要額Ｆ期中報告用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkHitKtyRn extends AbstractExDBPrimaryKey<ZT_NkHitKtyRn, PKZT_NkHitKtyRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkHitKtyRn() {
    }

    public PKZT_NkHitKtyRn(String pZrnnksyousyono) {
        zrnnksyousyono = pZrnnksyousyono;
    }

    @Transient
    @Override
    public Class<ZT_NkHitKtyRn> getEntityClass() {
        return ZT_NkHitKtyRn.class;
    }
