...
/**
 * クレカ返金通知バックアップテーブル のプライマリキークラスです。<br />
 ...
 *  <tr><td>uriageseikyuuymd</td><td>売上請求日</td><td>&nbsp;</td><td align="center">V</td><td>BizDate</td></tr>
 ...
 *  <tr><td>hnkntaisyouinjiflg</td><td>返金対象印字フラグ</td><td>&nbsp;</td><td align="center">V</td><td>{@link yuyu.def.classification.C_UmuKbn C_UmuKbn}</td></tr>
 *  <tr><td>gyoumuKousinKinou</td><td>業務用更新機能ＩＤ</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>gyoumuKousinsyaId</td><td>業務用更新者ＩＤ</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 *  <tr><td>gyoumuKousinTime</td><td>業務用更新時間</td><td>&nbsp;</td><td align="center">V</td><td>String</td></tr>
 * </table>
 * @see     IT_BAK_CreditHnknTuuti
 * @see     GenIT_BAK_CreditHnknTuuti
 * @see     QIT_BAK_CreditHnknTuuti
 * @see     GenQIT_BAK_CreditHnknTuuti
 */
public class PKIT_BAK_CreditHnknTuuti extends AbstractExDBPrimaryKey<IT_BAK_CreditHnknTuuti, PKIT_BAK_CreditHnknTuuti> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_CreditHnknTuuti() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_CreditHnknTuuti> getEntityClass() {
        return IT_BAK_CreditHnknTuuti.class;
    }
