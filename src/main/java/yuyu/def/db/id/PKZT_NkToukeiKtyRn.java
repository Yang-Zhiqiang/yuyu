...
/**
 * 年金統計Ｆ期中報告用テーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_NkToukeiKtyRn extends AbstractExDBPrimaryKey<ZT_NkToukeiKtyRn, PKZT_NkToukeiKtyRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_NkToukeiKtyRn() {
    }

    public PKZT_NkToukeiKtyRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_NkToukeiKtyRn> getEntityClass() {
        return ZT_NkToukeiKtyRn.class;
    }
