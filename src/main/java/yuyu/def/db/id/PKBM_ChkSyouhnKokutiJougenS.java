...
/**
 * 商品単位告知上限Ｓチェックマスタ のプライマリキークラスです。<br />
 ...
 * @see     GenBM_ChkSyouhnKokutiJougenS
 * @see     QBM_ChkSyouhnKokutiJougenS
 * @see     GenQBM_ChkSyouhnKokutiJougenS
 */
public class PKBM_ChkSyouhnKokutiJougenS extends AbstractExDBPrimaryKey<BM_ChkSyouhnKokutiJougenS, PKBM_ChkSyouhnKokutiJougenS> {

    private static final long serialVersionUID = 1L;

    public PKBM_ChkSyouhnKokutiJougenS() {
    }
    ...
    @Transient
    @Override
    public Class<BM_ChkSyouhnKokutiJougenS> getEntityClass() {
        return BM_ChkSyouhnKokutiJougenS.class;
    }
