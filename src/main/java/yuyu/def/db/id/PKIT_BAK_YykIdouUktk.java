...
/**
 * 予約異動受付バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_YykIdouUktk
 * @see     QIT_BAK_YykIdouUktk
 * @see     GenQIT_BAK_YykIdouUktk
 */
public class PKIT_BAK_YykIdouUktk extends AbstractExDBPrimaryKey<IT_BAK_YykIdouUktk, PKIT_BAK_YykIdouUktk> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_YykIdouUktk() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_YykIdouUktk> getEntityClass() {
        return IT_BAK_YykIdouUktk.class;
    }
