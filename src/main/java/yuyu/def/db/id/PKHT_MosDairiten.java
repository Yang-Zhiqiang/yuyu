 ...
 * </table>
 * @see     HT_MosDairiten
 * @see     GenHT_MosDairiten
 * @see     QHT_MosDairiten
 * @see     GenQHT_MosDairiten
 */
public class PKHT_MosDairiten extends AbstractExDBPrimaryKey<HT_MosDairiten, PKHT_MosDairiten> {

    private static final long serialVersionUID = 1L;

    public PKHT_MosDairiten() {
    }

    public PKHT_MosDairiten(String pMosno, Integer pRenno) {
        mosno = pMosno;
        renno = pRenno;
    }
    ...
    @Transient
    @Override
    public Class<HT_MosDairiten> getEntityClass() {
        return HT_MosDairiten.class;
    }
