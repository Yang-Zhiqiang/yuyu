...
/**
 * ＲＡＹ期末ＶＦテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayKimatuVTy extends AbstractExDBPrimaryKey<ZT_RayKimatuVTy, PKZT_RayKimatuVTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayKimatuVTy() {
    }

    public PKZT_RayKimatuVTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayKimatuVTy> getEntityClass() {
        return ZT_RayKimatuVTy.class;
    }
