...
/**
 * ＳＭＢＣペーパーレス申込情報１テーブル（取） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SmbcPaperlessMos1Tr extends AbstractExDBPrimaryKey<ZT_SmbcPaperlessMos1Tr, PKZT_SmbcPaperlessMos1Tr> {

    private static final long serialVersionUID = 1L;

    public PKZT_SmbcPaperlessMos1Tr() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_SmbcPaperlessMos1Tr> getEntityClass() {
        return ZT_SmbcPaperlessMos1Tr.class;
    }
