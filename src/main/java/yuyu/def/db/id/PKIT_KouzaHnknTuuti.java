 ...
 * @see     GenIT_KouzaHnknTuuti
 * @see     QIT_KouzaHnknTuuti
 * @see     GenQIT_KouzaHnknTuuti
 */
public class PKIT_KouzaHnknTuuti extends AbstractExDBPrimaryKey<IT_KouzaHnknTuuti, PKIT_KouzaHnknTuuti> {

    private static final long serialVersionUID = 1L;

    public PKIT_KouzaHnknTuuti() {
    }
    ...
    @Transient
    @Override
    public Class<IT_KouzaHnknTuuti> getEntityClass() {
        return IT_KouzaHnknTuuti.class;
    }
