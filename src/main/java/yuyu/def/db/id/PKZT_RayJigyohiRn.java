...
/**
 * ＲＡＹ事業費Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_RayJigyohiRn extends AbstractExDBPrimaryKey<ZT_RayJigyohiRn, PKZT_RayJigyohiRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_RayJigyohiRn() {
    }

    public PKZT_RayJigyohiRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_RayJigyohiRn> getEntityClass() {
        return ZT_RayJigyohiRn.class;
    }
