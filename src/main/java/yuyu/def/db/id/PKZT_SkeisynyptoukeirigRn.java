...
/**
 * 新契約収入Ｐ統計例月Ｆテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_SkeisynyptoukeirigRn extends AbstractExDBPrimaryKey<ZT_SkeisynyptoukeirigRn, PKZT_SkeisynyptoukeirigRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_SkeisynyptoukeirigRn() {
    }

    public PKZT_SkeisynyptoukeirigRn(Integer pZrnsequenceno) {
        zrnsequenceno = pZrnsequenceno;
    }

    @Transient
    @Override
    public Class<ZT_SkeisynyptoukeirigRn> getEntityClass() {
        return ZT_SkeisynyptoukeirigRn.class;
    }
