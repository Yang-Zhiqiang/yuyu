...
/**
 * 契約保全選択情報登録バックアップテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenIT_BAK_KhSntkInfoTouroku
 * @see     QIT_BAK_KhSntkInfoTouroku
 * @see     GenQIT_BAK_KhSntkInfoTouroku
 */
public class PKIT_BAK_KhSntkInfoTouroku extends AbstractExDBPrimaryKey<IT_BAK_KhSntkInfoTouroku, PKIT_BAK_KhSntkInfoTouroku> {

    private static final long serialVersionUID = 1L;

    public PKIT_BAK_KhSntkInfoTouroku() {
    }
    ...
    @Transient
    @Override
    public Class<IT_BAK_KhSntkInfoTouroku> getEntityClass() {
        return IT_BAK_KhSntkInfoTouroku.class;
    }
