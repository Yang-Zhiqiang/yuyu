 ...
 * @see     GenQZT_RatepRn
 */
public class PKZT_RatepRn extends AbstractExDBPrimaryKey<ZT_RatepRn, PKZT_RatepRn> {
    ...
    @Transient
    @Override
    public Class<ZT_RatepRn> getEntityClass() {
        return ZT_RatepRn.class;
    }
