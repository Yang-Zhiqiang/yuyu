...
/**
 * 新契約外貨ＦＢ送金データテーブル のプライマリキークラスです。<br />
 ...
 * @see     GenHT_SkGaikaFBSoukinData
 * @see     QHT_SkGaikaFBSoukinData
 * @see     GenQHT_SkGaikaFBSoukinData
 */
public class PKHT_SkGaikaFBSoukinData extends AbstractExDBPrimaryKey<HT_SkGaikaFBSoukinData, PKHT_SkGaikaFBSoukinData> {

    private static final long serialVersionUID = 1L;

    public PKHT_SkGaikaFBSoukinData() {
    }

    public PKHT_SkGaikaFBSoukinData(String pFbsoukindatasikibetukey) {
        fbsoukindatasikibetukey = pFbsoukindatasikibetukey;
    }

    @Transient
    @Override
    public Class<HT_SkGaikaFBSoukinData> getEntityClass() {
        return HT_SkGaikaFBSoukinData.class;
    }
