...
/**
 * 区分経理ファイルテーブル（連） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KubunKeiriFileRn extends AbstractExDBPrimaryKey<ZT_KubunKeiriFileRn, PKZT_KubunKeiriFileRn> {

    private static final long serialVersionUID = 1L;

    public PKZT_KubunKeiriFileRn() {
    }
    ...
    @Transient
    @Override
    public Class<ZT_KubunKeiriFileRn> getEntityClass() {
        return ZT_KubunKeiriFileRn.class;
    }
