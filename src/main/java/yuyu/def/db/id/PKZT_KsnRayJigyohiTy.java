...
/**
 * 決算計上用ＲＡＹ事業費Ｆテーブル（中） のプライマリキークラスです。<br />
 ...
 */
public class PKZT_KsnRayJigyohiTy extends AbstractExDBPrimaryKey<ZT_KsnRayJigyohiTy, PKZT_KsnRayJigyohiTy> {

    private static final long serialVersionUID = 1L;

    public PKZT_KsnRayJigyohiTy() {
    }

    public PKZT_KsnRayJigyohiTy(Integer pZtysequenceno) {
        ztysequenceno = pZtysequenceno;
    }

    @Transient
    @Override
    public Class<ZT_KsnRayJigyohiTy> getEntityClass() {
        return ZT_KsnRayJigyohiTy.class;
    }
