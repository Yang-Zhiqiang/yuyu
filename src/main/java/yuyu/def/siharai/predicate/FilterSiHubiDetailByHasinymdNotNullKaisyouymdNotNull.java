 ...
 * 発信日（非空）、解消日（非空）<br />
 */
public class FilterSiHubiDetailByHasinymdNotNullKaisyouymdNotNull implements Predicate<JT_SiHubiDetail> {

    public FilterSiHubiDetailByHasinymdNotNullKaisyouymdNotNull() {
