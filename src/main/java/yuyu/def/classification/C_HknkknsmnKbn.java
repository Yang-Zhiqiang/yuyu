 ...
 *  <tr><td colspan="2">C_HknkknsmnKbn</td><td colspan="3">保険期間歳満期区分</td></tr>
 ...
 * </table>
 */
public class C_HknkknsmnKbn extends Classification<C_HknkknsmnKbn> {

    private static final long serialVersionUID = 1L;


    public static final C_HknkknsmnKbn BLNK = new C_HknkknsmnKbn("0");

    public static final C_HknkknsmnKbn SAIMANKI = new C_HknkknsmnKbn("1");

    public static final C_HknkknsmnKbn NENMANKI = new C_HknkknsmnKbn("2");
    ...
    static {
        ...
        lock(C_HknkknsmnKbn.class);
    }

    private C_HknkknsmnKbn(String value) {
        super(value);
    }

    public static C_HknkknsmnKbn valueOf(String value) {
        return valueOf(C_HknkknsmnKbn.class, value);
    }

    public static String getContentByValue(String value) {
        return getContentByValue(C_HknkknsmnKbn.class, value);
    }

    public static String getContentByValue(String patternId, String value) {
        return getContentByValue(C_HknkknsmnKbn.class, patternId, value);
    }
}
