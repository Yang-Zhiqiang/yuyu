...
/**
 * （ＤＳＷｅｂ）ＤＳご契約内容のお知らせ出力出力ＢＥＡＮ データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenWsDwKykNaiyouOsiraseOutOutputBean implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenWsDwKykNaiyouOsiraseOutOutputBean() {
    }
