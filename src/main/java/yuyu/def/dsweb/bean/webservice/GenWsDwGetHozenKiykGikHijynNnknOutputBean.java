...
/**
 * （ＤＳＷｅｂ）保全契約詳細取得（外貨建平準払年金）出力BEAN データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenWsDwGetHozenKiykGikHijynNnknOutputBean implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenWsDwGetHozenKiykGikHijynNnknOutputBean() {
    }
    ...
    private String iwsTikiktbrisyuruikbn;

    public String getIwsTikiktbrisyuruikbn() {
        return iwsTikiktbrisyuruikbn;
    }

    public void setIwsTikiktbrisyuruikbn(String pIwsTikiktbrisyuruikbn) {
        iwsTikiktbrisyuruikbn = pIwsTikiktbrisyuruikbn;
    }

    private String iwsRsgakuyentikiktbri;

    public String getIwsRsgakuyentikiktbri() {
        return iwsRsgakuyentikiktbri;
    }

    public void setIwsRsgakuyentikiktbri(String pIwsRsgakuyentikiktbri) {
        iwsRsgakuyentikiktbri = pIwsRsgakuyentikiktbri;
    }

    private String iwsZennoutikiktbriyenhrkgk;

    public String getIwsZennoutikiktbriyenhrkgk() {
        return iwsZennoutikiktbriyenhrkgk;
    }

    public void setIwsZennoutikiktbriyenhrkgk(String pIwsZennoutikiktbriyenhrkgk) {
        iwsZennoutikiktbriyenhrkgk = pIwsZennoutikiktbriyenhrkgk;
    }
    ...
    private String iwsGenzainohrritu;

    public String getIwsGenzainohrritu() {
        return iwsGenzainohrritu;
    }

    public void setIwsGenzainohrritu(String pIwsGenzainohrritu) {
        iwsGenzainohrritu = pIwsGenzainohrritu;
    }

    private String iwsSyourainkgnsyen;

    public String getIwsSyourainkgnsyen() {
        return iwsSyourainkgnsyen;
    }

    public void setIwsSyourainkgnsyen(String pIwsSyourainkgnsyen) {
        iwsSyourainkgnsyen = pIwsSyourainkgnsyen;
    }
    ...
    private String iwsSyouraihrkmpstgkyen;

    public String getIwsSyouraihrkmpstgkyen() {
        return iwsSyouraihrkmpstgkyen;
    }

    public void setIwsSyouraihrkmpstgkyen(String pIwsSyouraihrkmpstgkyen) {
        iwsSyouraihrkmpstgkyen = pIwsSyouraihrkmpstgkyen;
    }

    private String iwsSyourainohrritu;

    public String getIwsSyourainohrritu() {
        return iwsSyourainohrritu;
    }

    public void setIwsSyourainohrritu(String pIwsSyourainohrritu) {
        iwsSyourainohrritu = pIwsSyourainohrritu;
    }

    private String iwsTeikiikkatubaraiumu;

    public String getIwsTeikiikkatubaraiumu() {
        return iwsTeikiikkatubaraiumu;
    }

    public void setIwsTeikiikkatubaraiumu(String pIwsTeikiikkatubaraiumu) {
        iwsTeikiikkatubaraiumu = pIwsTeikiikkatubaraiumu;
    }
