...
/**
 * （ＤＳＷｅｂ）保全契約詳細取得（円建一時払年金）出力BEAN データレイアウトのベースBeanクラスです。<br />
 * このソースはツールにより自動生成されたものです。データレイアウト定義に変更があると上書きされてしまいます。
 */
public class GenWsDwGetHozenKykEnItijiNnknOutputBean implements Serializable {

    private static final long serialVersionUID = 1L;

    public GenWsDwGetHozenKykEnItijiNnknOutputBean() {
    }
    ...
    private String iwsYendtitijibrnkhkhnkymd;

    public String getIwsYendtitijibrnkhkhnkymd() {
        return iwsYendtitijibrnkhkhnkymd;
    }

    public void setIwsYendtitijibrnkhkhnkymd(String pIwsYendtitijibrnkhkhnkymd) {
        iwsYendtitijibrnkhkhnkymd = pIwsYendtitijibrnkhkhnkymd;
    }
