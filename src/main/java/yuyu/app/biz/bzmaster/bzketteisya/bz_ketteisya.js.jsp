<%--
    bz_ketteisya.js.jsp - 決定者登録 JavaScript(JSP)
--%>
...
<%@page
	import="static yuyu.app.biz.bzmaster.bzketteisya.BzKetteisyaConstants.*"%>
<%@page
	import="static yuyu.app.biz.bzmaster.bzketteisya.BzKetteisyaSelector.*"%>
<%@page import="jp.co.slcs.swak.core.inject.SWAKInjector"%>
<%@page import="yuyu.app.biz.bzmaster.bzketteisya.BzKetteisyaUiBean"%>
<% BzKetteisyaUiBean uiBean = SWAKInjector.getInstance(BzKetteisyaUiBean.class); %>
