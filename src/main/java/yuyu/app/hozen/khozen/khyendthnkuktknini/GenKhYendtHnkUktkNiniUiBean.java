...
/**
 * 円建変更受付（任意請求） : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhYendtHnkUktkNiniUiBean extends AbstractUiBean {
    ...
    private String yendthnktkhukainfo;

    public String getYendthnktkhukainfo() {
        return yendthnktkhukainfo;
    }

    public void setYendthnktkhukainfo(String pYendthnktkhukainfo) {
        yendthnktkhukainfo = pYendthnktkhukainfo;
    }
    ...
    private BizCurrency yendthnkkjnkngk;

    public BizCurrency getYendthnkkjnkngk() {
        return yendthnkkjnkngk;
    }

    public void setYendthnkkjnkngk(BizCurrency pYendthnkkjnkngk) {
        yendthnkkjnkngk = pYendthnkkjnkngk;
    }
    ...
    private BizCurrency yendthnksbhokenkngk;

    public BizCurrency getYendthnksbhokenkngk() {
        return yendthnksbhokenkngk;
    }

    public void setYendthnksbhokenkngk(BizCurrency pYendthnksbhokenkngk) {
        yendthnksbhokenkngk = pYendthnksbhokenkngk;
    }

    private BizCurrency yendthnkkaiyakuhrgk;

    public BizCurrency getYendthnkkaiyakuhrgk() {
        return yendthnkkaiyakuhrgk;
    }

    public void setYendthnkkaiyakuhrgk(BizCurrency pYendthnkkaiyakuhrgk) {
        yendthnkkaiyakuhrgk = pYendthnkkaiyakuhrgk;
    }
