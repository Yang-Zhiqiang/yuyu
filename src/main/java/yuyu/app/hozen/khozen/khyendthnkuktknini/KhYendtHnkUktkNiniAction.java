...
/**
 * 円建変更受付（任意請求） 機能のアクションクラスです。
 */
@Forwards
({
    @Forward(name=FORWARDNAME_INIT,           page=PAGENO_INIT,          path="/hozen/khozen/khyendthnkuktknini/KhYendtHnkUktkNini.do", redirect=true),
    @Forward(name=FORWARDNAME_INPUTKEY,       page=PAGENO_INPUTKEY,      path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_INPUTCONTENTS,  page=PAGENO_INPUTCONTENTS, path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_REFERENCE,      page=PAGENO_REFERENCE,     path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_CONFIRM,        page=PAGENO_CONFIRM,       path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_RESULT,         page=PAGENO_RESULT,        path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_SKSCONFIRM,     page=PAGENO_SKSCONFIRM,    path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_SKSRESULT,      page=PAGENO_SKSRESULT,     path="/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp"),
    @Forward(name=FORWARDNAME_BACKTOWORKLIST,                            path="/workflow/processkanri/hozenworklist/HozenWorkList.do?_eventHandler=fromKhYendtHnkUktkNini", redirect=true),
})
@Input("/hozen/khozen/khyendthnkuktknini/kh_yendt_hnk_uktk_nini.jsp")
@UIBean(beanClass=KhYendtHnkUktkNiniUiBean.class)
public class KhYendtHnkUktkNiniAction {

    @Inject
    private KhYendtHnkUktkNiniBizLogic bizLogic;
