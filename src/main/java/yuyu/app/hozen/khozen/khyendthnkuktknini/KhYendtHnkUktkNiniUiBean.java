...
/**
 * 円建変更受付（任意請求） の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhYendtHnkUktkNiniUiBean extends GenKhYendtHnkUktkNiniUiBean implements ViewKihonUiBeanParam,
ViewKeiyakusyaUiBeanParam, ViewTuusinsakiUiBeanParam, ViewHituyouSyoruiUiBeanParam,
ViewKouteiInfoUiBeanParam, ViewProgressHistoryUiBeanParam, ViewTetudukityuuiUiBeanParam,
...
SetToriatukaiTyuuiExecUiBeanParam, SetKeiyakusyaExecUiBeanParam, SetTetudukityuuiExecUiBeanParam,
...
SetTrkKazokuExecUiBeanParam, ViewKyksyadairiUiBeanParam, SetKyksyadairiExecUiBeanParam {
    ...
    private C_UmuKbn yendtHnkUmu;

    private C_KahiKbn syoruiukeKahiFlg;
    ...
    private int yendthnkSyouhnsdno;

    private BizCurrency yendthnkKihons;

    private String yendthnkRyouritusdno;

    private BizNumber yendthnkTumitateRiritu;

    private BizNumber yendthnkYoteiRiritu;

    private String yendthnkmaeSyouhncd;
    ...
    public KhYendtHnkUktkNiniUiBean() {
    }
    ...
    public C_UmuKbn getYendtHnkUmu() {
        return yendtHnkUmu;
    }

    public void setYendtHnkUmu(C_UmuKbn pYendtHnkUmu) {
        this.yendtHnkUmu = pYendtHnkUmu;
    }

    public C_KahiKbn getSyoruiukeKahiFlg() {
        return syoruiukeKahiFlg;
    }

    public void setSyoruiukeKahiFlg(C_KahiKbn pSyoruiukeKahiFlg) {
        this.syoruiukeKahiFlg = pSyoruiukeKahiFlg;
    }
    ...
    public void setMkhgktttKaiyakuhr(BizCurrency pMkhgktttKaiyakuhr) {
        this.mkhgktttKaiyakuhr = pMkhgktttKaiyakuhr;
    }
    ...
    public void setYendthnkKaiyakuhrGaika(BizCurrency pYendthnkKaiyakuhrGaika) {
        this.yendthnkKaiyakuhrGaika = pYendthnkKaiyakuhrGaika;
    }
    ...
    public void setYendthnkKaiyakuhrYen(BizCurrency pYendthnkKaiyakuhrYen) {
        this.yendthnkKaiyakuhrYen = pYendthnkKaiyakuhrYen;
    }
    ...
    public void setYendthnkSyouhncd(String pYendthnkSyouhncd) {
        this.yendthnkSyouhncd = pYendthnkSyouhncd;
    }

    public int getYendthnkSyouhnsdno() {
        return yendthnkSyouhnsdno;
    }

    public void setYendthnkSyouhnsdno(int pYendthnkSyouhnsdno) {
        this.yendthnkSyouhnsdno = pYendthnkSyouhnsdno;
    }
    ...
    public void setYendthnkKihons(BizCurrency pYendthnkKihons) {
        this.yendthnkKihons = pYendthnkKihons;
    }

    public String getYendthnkRyouritusdno() {
        return yendthnkRyouritusdno;
    }

    public void setYendthnkRyouritusdno(String pYendthnkRyouritusdno) {
        this.yendthnkRyouritusdno = pYendthnkRyouritusdno;
    }

    public BizNumber getYendthnkTumitateRiritu() {
        return yendthnkTumitateRiritu;
    }

    public void setYendthnkTumitateRiritu(BizNumber pYendthnkTumitateRiritu) {
        this.yendthnkTumitateRiritu = pYendthnkTumitateRiritu;
    }
    ...
    public void setYendthnkYoteiRiritu(BizNumber pYendthnkYoteiRiritu) {
        this.yendthnkYoteiRiritu = pYendthnkYoteiRiritu;
    }

    public String getYendthnkmaeSyouhncd() {
        return yendthnkmaeSyouhncd;
    }

    public void setYendthnkmaeSyouhncd(String pYendthnkmaeSyouhncd) {
        this.yendthnkmaeSyouhncd = pYendthnkmaeSyouhncd;
    }
