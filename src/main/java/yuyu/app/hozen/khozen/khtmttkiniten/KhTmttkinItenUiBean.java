...
/**
 * 積立金移転 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhTmttkinItenUiBean extends GenKhTmttkinItenUiBean implements CheckYuukouJyoutaiExecUiBeanParam,
SetToriatukaiTyuuiExecUiBeanParam,
SetKihonExecUiBeanParam, ViewKihonUiBeanParam,
...
SetHituyouSyoruiExecUiBeanParam, ViewHituyouSyoruiUiBeanParam,
...
KhozenCommonParamGetHituyouSyoruiUiBeanParam,ViewSonotaTkUiBeanParam, SetSonotaTkExecUiBeanParam,
ViewTrkKazokuUiBeanParam, SetTrkKazokuExecUiBeanParam, ViewKyksyadairiUiBeanParam, SetKyksyadairiExecUiBeanParam {

    private static final long serialVersionUID = 1L;

    private BizDate syoruiUktkKigenYmd;

    private C_UmuKbn tgitgiKykOutoubiKbn;
    ...
    public void setSyoruiUktkKigenYmd(BizDate pSyoruiUktkKigenYmd) {
        this.syoruiUktkKigenYmd = pSyoruiUktkKigenYmd;
    }

    public C_UmuKbn getTgitgiKykOutoubiKbn() {
        return tgitgiKykOutoubiKbn;
    }

    public void setTgitgiKykOutoubiKbn(C_UmuKbn pTgitgiKykOutoubiKbn) {
        this.tgitgiKykOutoubiKbn = pTgitgiKykOutoubiKbn;
    }
