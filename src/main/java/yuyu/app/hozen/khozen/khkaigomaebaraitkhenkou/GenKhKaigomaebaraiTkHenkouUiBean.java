...
/**
 * 重度介護前払特約変更 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhKaigomaebaraiTkHenkouUiBean extends AbstractUiBean {
    ...
    private C_KhTokusyuKbn khtokusyukbn;

    public C_KhTokusyuKbn getKhtokusyukbn() {
        return khtokusyukbn;
    }

    public void setKhtokusyukbn(C_KhTokusyuKbn pKhtokusyukbn) {
        khtokusyukbn = pKhtokusyukbn;
    }
