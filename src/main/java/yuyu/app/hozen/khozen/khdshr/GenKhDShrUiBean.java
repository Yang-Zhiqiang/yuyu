...
/**
 * 配当金支払 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhDShrUiBean extends AbstractUiBean {
    ...
    @MaxLength(max=4)
    @Digit
    private String inputhaitoukinskkngk;

    public String getInputhaitoukinskkngk() {
        return inputhaitoukinskkngk;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setInputhaitoukinskkngk(String pInputhaitoukinskkngk) {
        inputhaitoukinskkngk = pInputhaitoukinskkngk;
    }
    ...
    private BizCurrency tumitatehaitouganrikin2;

    public BizCurrency getTumitatehaitouganrikin2() {
        return tumitatehaitouganrikin2;
    }

    public void setTumitatehaitouganrikin2(BizCurrency pTumitatehaitouganrikin2) {
        tumitatehaitouganrikin2 = pTumitatehaitouganrikin2;
    }
    ...
    private BizCurrency shrtmtthtkinzndk;

    public BizCurrency getShrtmtthtkinzndk() {
        return shrtmtthtkinzndk;
    }

    public void setShrtmtthtkinzndk(BizCurrency pShrtmtthtkinzndk) {
        shrtmtthtkinzndk = pShrtmtthtkinzndk;
    }
