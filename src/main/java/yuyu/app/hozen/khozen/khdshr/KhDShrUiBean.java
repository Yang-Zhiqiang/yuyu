...
import yuyu.common.hozen.haitou.KhTumitateDKanriKeyinfoBean;
...
/**
 * 配当金支払 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhDShrUiBean extends GenKhDShrUiBean implements CheckYuukouJyoutaiExecUiBeanParam,
SetToriatukaiTyuuiExecUiBeanParam, SetKihonExecUiBeanParam, SetTetudukityuuiExecUiBeanParam,
SetKeiyakusyaExecUiBeanParam, SetTuusinsakiExecUiBeanParam, SetHosyouExecUiBeanParam,
SetSonotaTkExecUiBeanParam, SetHaraikomiInfoExecUiBeanParam, SetKouteiInfoExecUiBeanParam,
SetSyoruiInfoItiranExecUiBeanParam, SetProgressHistoryExecUiBeanParam, SetHituyouSyoruiExecUiBeanParam,
SetTrkKazokuExecUiBeanParam, SetKyksyadairiExecUiBeanParam,
KhozenCommonParamGetHituyouSyoruiUiBeanParam, ViewKihonUiBeanParam, ViewTetudukityuuiUiBeanParam,
ViewKeiyakusyaUiBeanParam, ViewTuusinsakiUiBeanParam, ViewHosyouUiBeanParam, ViewSonotaTkUiBeanParam,
ViewHaraikomiInfoUiBeanParam, ViewKouteiInfoUiBeanParam, ViewSyoruiInfoItiranUiBeanParam,
ViewProgressHistoryUiBeanParam, ViewHituyouSyoruiUiBeanParam, SetKhKbnPatternUtilUiBeanParam,
ViewTrkKazokuUiBeanParam, ViewKyksyadairiUiBeanParam, CheckKouzaChkSoukinsakiKouzaUiBeanParam {
    ...
    private KhTumitateDKanriKeyinfoBean khTumitateDKanriKeyinfoBean;
    ...
    public void setWrmdsAtoTumitated(BizCurrency pWrmdsAtoTumitated) {
        this.wrmdsAtoTumitated = pWrmdsAtoTumitated;
    }

    public KhTumitateDKanriKeyinfoBean getKhTumitateDKanriKeyinfoBean() {
        return khTumitateDKanriKeyinfoBean;
    }

    public void setKhTumitateDKanriKeyinfoBean(KhTumitateDKanriKeyinfoBean pKhTumitateDKanriKeyinfoBean) {
        this.khTumitateDKanriKeyinfoBean = pKhTumitateDKanriKeyinfoBean;
    }
