...
/**
 * 支払口座情報変更 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhSiharaiKouzaHenkouUiBean extends AbstractUiBean {
    ...
    private C_KouzasyuruiKbn vkskzkzsyuruikbn;

    public C_KouzasyuruiKbn getVkskzkzsyuruikbn() {
        return vkskzkzsyuruikbn;
    }

    public void setVkskzkzsyuruikbn(C_KouzasyuruiKbn pVkskzkzsyuruikbn) {
        vkskzkzsyuruikbn = pVkskzkzsyuruikbn;
    }

    @Length(length=4)
    @Digit
    private String vkskzbankcd;

    public String getVkskzbankcd() {
        return vkskzbankcd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setVkskzbankcd(String pVkskzbankcd) {
        vkskzbankcd = pVkskzbankcd;
    }

    @MaxLength(max=20)
    @MultiByteStrings
    @InvalidCharacter
    private String vkskzbanknmkj;

    public String getVkskzbanknmkj() {
        return vkskzbanknmkj;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setVkskzbanknmkj(String pVkskzbanknmkj) {
        vkskzbanknmkj = pVkskzbanknmkj;
    }

    @Length(length=3)
    @Digit
    private String vkskzsitencd;

    public String getVkskzsitencd() {
        return vkskzsitencd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setVkskzsitencd(String pVkskzsitencd) {
        vkskzsitencd = pVkskzsitencd;
    }

    @MaxLength(max=20)
    @MultiByteStrings
    @InvalidCharacter
    private String vkskzsitennmkj;

    public String getVkskzsitennmkj() {
        return vkskzsitennmkj;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setVkskzsitennmkj(String pVkskzsitennmkj) {
        vkskzsitennmkj = pVkskzsitennmkj;
    }

    private C_YokinKbn vkskzyokinkbn;

    public C_YokinKbn getVkskzyokinkbn() {
        return vkskzyokinkbn;
    }

    public void setVkskzyokinkbn(C_YokinKbn pVkskzyokinkbn) {
        vkskzyokinkbn = pVkskzyokinkbn;
    }

    @MaxLength(max=12)
    private String vkskzkouzano;

    public String getVkskzkouzano() {
        return vkskzkouzano;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setVkskzkouzano(String pVkskzkouzano) {
        vkskzkouzano = pVkskzkouzano;
    }
    ...
    private String vkskzkzmeiginmkn;

    public String getVkskzkzmeiginmkn() {
        return vkskzkzmeiginmkn;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setVkskzkzmeiginmkn(String pVkskzkzmeiginmkn) {
        vkskzkzmeiginmkn = pVkskzkzmeiginmkn;
    }
