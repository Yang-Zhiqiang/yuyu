...
/**
 * 解約 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhKaiyakuUiBean extends AbstractUiBean {
    ...
    private BizCurrency dispgstszeigk;

    public BizCurrency getDispgstszeigk() {
        return dispgstszeigk;
    }

    public void setDispgstszeigk(BizCurrency pDispgstszeigk) {
        dispgstszeigk = pDispgstszeigk;
    }

    private String dispgstszeigkcalckahimongon;

    public String getDispgstszeigkcalckahimongon() {
        return dispgstszeigkcalckahimongon;
    }

    public void setDispgstszeigkcalckahimongon(String pDispgstszeigkcalckahimongon) {
        dispgstszeigkcalckahimongon = pDispgstszeigkcalckahimongon;
    }
    ...
    private BizCurrency dispyengstszeigk;

    public BizCurrency getDispyengstszeigk() {
        return dispyengstszeigk;
    }

    public void setDispyengstszeigk(BizCurrency pDispyengstszeigk) {
        dispyengstszeigk = pDispyengstszeigk;
    }
    ...
    private BizCurrency dispyendthnkgstszeigk;

    public BizCurrency getDispyendthnkgstszeigk() {
        return dispyendthnkgstszeigk;
    }

    public void setDispyendthnkgstszeigk(BizCurrency pDispyendthnkgstszeigk) {
        dispyendthnkgstszeigk = pDispyendthnkgstszeigk;
    }
    ...
    private BizCurrency kiykhrsyousaikiykhrtogoukei;

    public BizCurrency getKiykhrsyousaikiykhrtogoukei() {
        return kiykhrsyousaikiykhrtogoukei;
    }

    public void setKiykhrsyousaikiykhrtogoukei(BizCurrency pKiykhrsyousaikiykhrtogoukei) {
        kiykhrsyousaikiykhrtogoukei = pKiykhrsyousaikiykhrtogoukei;
    }
    ...
    private BizCurrency kiykhrstousyenkiykhrgoukei;

    public BizCurrency getKiykhrstousyenkiykhrgoukei() {
        return kiykhrstousyenkiykhrgoukei;
    }

    public void setKiykhrstousyenkiykhrgoukei(BizCurrency pKiykhrstousyenkiykhrgoukei) {
        kiykhrstousyenkiykhrgoukei = pKiykhrstousyenkiykhrgoukei;
    }

    private BizDate kiykhrstousyenshrratetkymd;

    public BizDate getKiykhrstousyenshrratetkymd() {
        return kiykhrstousyenshrratetkymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setKiykhrstousyenshrratetkymd(BizDate pKiykhrstousyenshrratetkymd) {
        kiykhrstousyenshrratetkymd = pKiykhrstousyenshrratetkymd;
    }

    private BizNumber kiykhrstousyenshrratete;

    public BizNumber getKiykhrstousyenshrratete() {
        return kiykhrstousyenshrratete;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setKiykhrstousyenshrratete(BizNumber pKiykhrstousyenshrratete) {
        kiykhrstousyenshrratete = pKiykhrstousyenshrratete;
    }

    private C_Tuukasyu kiykhrstousshrkyktuukasyu;

    public C_Tuukasyu getKiykhrstousshrkyktuukasyu() {
        return kiykhrstousshrkyktuukasyu;
    }

    public void setKiykhrstousshrkyktuukasyu(C_Tuukasyu pKiykhrstousshrkyktuukasyu) {
        kiykhrstousshrkyktuukasyu = pKiykhrstousshrkyktuukasyu;
    }

    private BizCurrency kiykhrstouskaiyakuhrgoukei;

    public BizCurrency getKiykhrstouskaiyakuhrgoukei() {
        return kiykhrstouskaiyakuhrgoukei;
    }

    public void setKiykhrstouskaiyakuhrgoukei(BizCurrency pKiykhrstouskaiyakuhrgoukei) {
        kiykhrstouskaiyakuhrgoukei = pKiykhrstouskaiyakuhrgoukei;
    }

    private BizCurrency kiykhrstouskaiyakuhrkin;

    public BizCurrency getKiykhrstouskaiyakuhrkin() {
        return kiykhrstouskaiyakuhrkin;
    }

    public void setKiykhrstouskaiyakuhrkin(BizCurrency pKiykhrstouskaiyakuhrkin) {
        kiykhrstouskaiyakuhrkin = pKiykhrstouskaiyakuhrkin;
    }

    private BizCurrency kiykhrstousmikeikap;

    public BizCurrency getKiykhrstousmikeikap() {
        return kiykhrstousmikeikap;
    }

    public void setKiykhrstousmikeikap(BizCurrency pKiykhrstousmikeikap) {
        kiykhrstousmikeikap = pKiykhrstousmikeikap;
    }

    private BizCurrency kiykhrstouszennouseisankin;

    public BizCurrency getKiykhrstouszennouseisankin() {
        return kiykhrstouszennouseisankin;
    }

    public void setKiykhrstouszennouseisankin(BizCurrency pKiykhrstouszennouseisankin) {
        kiykhrstouszennouseisankin = pKiykhrstouszennouseisankin;
    }

    private BizCurrency kiykhrstouskykhnkkaiyakuhr;

    public BizCurrency getKiykhrstouskykhnkkaiyakuhr() {
        return kiykhrstouskykhnkkaiyakuhr;
    }

    public void setKiykhrstouskykhnkkaiyakuhr(BizCurrency pKiykhrstouskykhnkkaiyakuhr) {
        kiykhrstouskykhnkkaiyakuhr = pKiykhrstouskykhnkkaiyakuhr;
    }
    ...
    private C_KahiKbn telttdkkahikbn;

    public C_KahiKbn getTelttdkkahikbn() {
        return telttdkkahikbn;
    }

    public void setTelttdkkahikbn(C_KahiKbn pTelttdkkahikbn) {
        telttdkkahikbn = pTelttdkkahikbn;
    }

    private C_UmuKbn tokuteitrhkkztourokujk;

    public C_UmuKbn getTokuteitrhkkztourokujk() {
        return tokuteitrhkkztourokujk;
    }

    public void setTokuteitrhkkztourokujk(C_UmuKbn pTokuteitrhkkztourokujk) {
        tokuteitrhkkztourokujk = pTokuteitrhkkztourokujk;
    }

    private String telttdkhukariyuu;

    public String getTelttdkhukariyuu() {
        return telttdkhukariyuu;
    }

    public void setTelttdkhukariyuu(String pTelttdkhukariyuu) {
        telttdkhukariyuu = pTelttdkhukariyuu;
    }
