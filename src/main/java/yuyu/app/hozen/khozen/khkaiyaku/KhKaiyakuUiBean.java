...
import yuyu.common.hozen.khcommon.KhozenCommonParamKhKaiyakuUiBeanParam;
...
/**
 * 解約 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhKaiyakuUiBean extends GenKhKaiyakuUiBean implements ViewKouteiInfoUiBeanParam, ViewKihonUiBeanParam,
ViewBetukykUiBeanParam, ViewSyoruiInfoItiranUiBeanParam, ViewTetudukityuuiUiBeanParam, ViewKeiyakusyaUiBeanParam,
ViewTuusinsakiUiBeanParam, ViewHihokensyaUiBeanParam, ViewSonotaTkUiBeanParam, ViewHaraikomiInfoUiBeanParam,
ViewProgressHistoryUiBeanParam, ViewKouzaInfoUiBeanParam, ViewHituyouSyoruiUiBeanParam, ViewHosyouUiBeanParam,
SetKouteiInfoExecUiBeanParam, SetBetukykExecUiBeanParam, SetHosyouExecUiBeanParam, SetToriatukaiTyuuiExecUiBeanParam,
SetKihonExecUiBeanParam, SetTetudukityuuiExecUiBeanParam, SetKeiyakusyaExecUiBeanParam, SetTuusinsakiExecUiBeanParam,
SetHihokensyaExecUiBeanParam, SetSonotaTkExecUiBeanParam, SetSyoruiInfoItiranExecUiBeanParam,
SetHaraikomiInfoExecUiBeanParam, SetProgressHistoryExecUiBeanParam, SetHituyouSyoruiExecUiBeanParam,
SetKouzaInfoExecUiBeanParam, CheckYuukouJyoutaiExecUiBeanParam,
CheckKouzaChkSoukinsakiKouzaUiBeanParam, KhozenCommonParamGetHituyouSyoruiUiBeanParam,
KhozenCommonParamKhKaiyakuUiBeanParam, SetKhKbnPatternUtilUiBeanParam , SetKariukekinExecUiBeanParam,
ViewKariukekinUiBeanParam, SetDattaiExecUiBeanParam,ViewDattaiUiBeanParam, SetHaitoukinExecUiBeanParam,
ViewHaitoukinUiBeanParam, SetTokusinExecUiBeanParam,ViewTokusinUiBeanParam, ViewTrkKazokuUiBeanParam,
...
SetKhTkshrSiharaiKouzaExecUiBeanParam, ViewKhTkshrSiharaiKouzaUiBeanParam {
    ...
    private boolean hyoujiFlg;

    private C_UriagetyuusiKbn uriagetyuusikbn;
    ...
    private C_KaiyksyorikahiKbn kaiyksyorikahikbn;

    private C_UmuKbn daisennintdkumukbn;

    private BizCurrency bfrmikeikap;

    private BizCurrency bfrshrgkgoukei;
    ...
    private BizNumber sijyoukakakutyouseiyouriritu;

    private BizNumber kawaseRate;

    private BizDate enkatienrisokukisanbi;

    private Integer enkatienrisokuhisuu;
    ...
    private BizNumber keiyakutokisijyoukakakutyouseiyouriritu;

    private C_HtsiryosyuKbn siharaityousyosyuruikubun;
    ...
    private Integer yendthnktienrsknissuu;

    private BizCurrency gstszeigk;

    private BizCurrency jpygstszeigk;

    private BizCurrency gaikaShrjiYengstszeigk;

    private BizCurrency gaikaShrjiYengstszeigknationaltax;

    private BizCurrency jpyShrjiYengstszeigknationaltax;

    private BizCurrency gaikaShrjiYengstszeigklocaltax;

    private BizCurrency jpyShrjiYengstszeigklocaltax;

    private C_UmuKbn gaikaShrjiGsbunritaisyou;

    private C_UmuKbn jpyShrjiGsbunritaisyou;

    private BizCurrency gaikaShrjiYengststaisyousaeki;

    private BizCurrency jpyShrjiYengststaisyousaeki;

    private BizCurrency gaikaShrjiYenhtykeihi;

    private BizCurrency jpyShrjiYenhtykeihi;

    private BizCurrency keisanKhGensenYenW;
    ...
    private C_Kykjyoutai syukykjyoutai;
    ...
    private KeisanCommonKaiyakuOutBean keisanCommonKaiyakuOutBean;
    ...
    private BizCurrency zeimukaiyakuhryen;

    private BizDateYM lastPJyuutouYm;

    private C_UmuKbn mynoSinkokutaisyouFlg;

    private C_UmuKbn pminyuuSyoumetuShrtyousyoOutZumiFlg;

    private C_NaiteiKakuteiKbn haitouKanriNaiteiKakuteiKbn;
    ...
    public boolean isHyoujiFlg() {
        return hyoujiFlg;
    }

    public void setHyoujiFlg(boolean pHyoujiFlg) {
        hyoujiFlg = pHyoujiFlg;
    }
    ...
    public C_KaiyksyorikahiKbn getKaiyksyorikahikbn() {
        return kaiyksyorikahikbn;
    }

    public void setKaiyksyorikahikbn(C_KaiyksyorikahiKbn pKaiyksyorikahikbn) {
        kaiyksyorikahikbn = pKaiyksyorikahikbn;
    }
    ...
    public BizCurrency getBfrmikeikap() {
        return bfrmikeikap;
    }

    public void setBfrmikeikap(BizCurrency pBfrmikeikap) {
        bfrmikeikap = pBfrmikeikap;
    }

    public BizCurrency getBfrshrgkgoukei() {
        return bfrshrgkgoukei;
    }

    public void setBfrshrgkgoukei(BizCurrency pBfrshrgkgoukei) {
        bfrshrgkgoukei = pBfrshrgkgoukei;
    }
    ...
    public BizNumber getSijyoukakakutyouseiyouriritu() {
        return sijyoukakakutyouseiyouriritu;
    }

    public void setSijyoukakakutyouseiyouriritu(BizNumber pSijyoukakakutyouseiyouriritu) {
        sijyoukakakutyouseiyouriritu = pSijyoukakakutyouseiyouriritu;
    }
    ...
    public BizDate getEnkatienrisokukisanbi() {
        return enkatienrisokukisanbi;
    }

    public void setEnkatienrisokukisanbi(BizDate pEnkatienrisokukisanbi) {
        enkatienrisokukisanbi = pEnkatienrisokukisanbi;
    }

    public Integer getEnkatienrisokuhisuu() {
        return enkatienrisokuhisuu;
    }

    public void setEnkatienrisokuhisuu(Integer pEnkatienrisokuhisuu) {
        enkatienrisokuhisuu = pEnkatienrisokuhisuu;
    }
    ...
    public BizNumber getKeiyakutokisijyoukakakutyouseiyouriritu() {
        return keiyakutokisijyoukakakutyouseiyouriritu;
    }

    public void setKeiyakutokisijyoukakakutyouseiyouriritu(BizNumber pKeiyakutokisijyoukakakutyouseiyouriritu) {
        keiyakutokisijyoukakakutyouseiyouriritu = pKeiyakutokisijyoukakakutyouseiyouriritu;
    }

    public C_HtsiryosyuKbn getSiharaityousyosyuruikubun() {
        return siharaityousyosyuruikubun;
    }

    public void setSiharaityousyosyuruikubun(C_HtsiryosyuKbn pSiharaityousyosyuruikubun) {
        siharaityousyosyuruikubun = pSiharaityousyosyuruikubun;
    }
    ...
    public void setSyucurrencytype(CurrencyType pSyucurrencytype) {
        syucurrencytype = pSyucurrencytype;
    }
    ...
    public void setYendttienrskksnbi(BizDate pYendttienrskksnbi) {
        yendttienrskksnbi = pYendttienrskksnbi;
    }

    public Integer getYendthnktienrsknissuu() {
        return yendthnktienrsknissuu;
    }

    public void setYendthnktienrsknissuu(Integer pYendthnktienrsknissuu) {
        yendthnktienrsknissuu = pYendthnktienrsknissuu;
    }
    ...
    public BizCurrency getGaikaShrjiYengstszeigk() {
        return gaikaShrjiYengstszeigk;
    }

    public void setGaikaShrjiYengstszeigk(BizCurrency pGaikaShrjiYengstszeigk) {
        gaikaShrjiYengstszeigk = pGaikaShrjiYengstszeigk;
    }

    public BizCurrency getGaikaShrjiYengstszeigknationaltax() {
        return gaikaShrjiYengstszeigknationaltax;
    }

    public void setGaikaShrjiYengstszeigknationaltax(BizCurrency pGaikaShrjiYengstszeigknationaltax) {
        gaikaShrjiYengstszeigknationaltax = pGaikaShrjiYengstszeigknationaltax;
    }

    public BizCurrency getJpyShrjiYengstszeigknationaltax() {
        return jpyShrjiYengstszeigknationaltax;
    }

    public void setJpyShrjiYengstszeigknationaltax(BizCurrency pJpyShrjiYengstszeigknationaltax) {
        jpyShrjiYengstszeigknationaltax = pJpyShrjiYengstszeigknationaltax;
    }

    public BizCurrency getGaikaShrjiYengstszeigklocaltax() {
        return gaikaShrjiYengstszeigklocaltax;
    }

    public void setGaikaShrjiYengstszeigklocaltax(BizCurrency pGaikaShrjiYengstszeigklocaltax) {
        gaikaShrjiYengstszeigklocaltax = pGaikaShrjiYengstszeigklocaltax;
    }

    public BizCurrency getJpyShrjiYengstszeigklocaltax() {
        return jpyShrjiYengstszeigklocaltax;
    }

    public void setJpyShrjiYengstszeigklocaltax(BizCurrency pJpyShrjiYengstszeigklocaltax) {
        jpyShrjiYengstszeigklocaltax = pJpyShrjiYengstszeigklocaltax;
    }

    public C_UmuKbn getGaikaShrjiGsbunritaisyou() {
        return gaikaShrjiGsbunritaisyou;
    }

    public void setGaikaShrjiGsbunritaisyou(C_UmuKbn pGaikaShrjiGsbunritaisyou) {
        gaikaShrjiGsbunritaisyou = pGaikaShrjiGsbunritaisyou;
    }

    public C_UmuKbn getJpyShrjiGsbunritaisyou() {
        return jpyShrjiGsbunritaisyou;
    }

    public void setJpyShrjiGsbunritaisyou(C_UmuKbn pJpyShrjiGsbunritaisyou) {
        jpyShrjiGsbunritaisyou = pJpyShrjiGsbunritaisyou;
    }

    public BizCurrency getGaikaShrjiYengststaisyousaeki() {
        return gaikaShrjiYengststaisyousaeki;
    }

    public void setGaikaShrjiYengststaisyousaeki(BizCurrency pGaikaShrjiYengststaisyousaeki) {
        gaikaShrjiYengststaisyousaeki = pGaikaShrjiYengststaisyousaeki;
    }

    public BizCurrency getJpyShrjiYengststaisyousaeki() {
        return jpyShrjiYengststaisyousaeki;
    }

    public void setJpyShrjiYengststaisyousaeki(BizCurrency pJpyShrjiYengststaisyousaeki) {
        jpyShrjiYengststaisyousaeki = pJpyShrjiYengststaisyousaeki;
    }

    public BizCurrency getGaikaShrjiYenhtykeihi() {
        return gaikaShrjiYenhtykeihi;
    }

    public void setGaikaShrjiYenhtykeihi(BizCurrency pGaikaShrjiYenhtykeihi) {
        gaikaShrjiYenhtykeihi = pGaikaShrjiYenhtykeihi;
    }
    ...
    public void setJpyShrjiYenhtykeihi(BizCurrency pJpyShrjiYenhtykeihi) {
        jpyShrjiYenhtykeihi = pJpyShrjiYenhtykeihi;
    }

    public BizCurrency getKeisanKhGensenYenW() {
        return keisanKhGensenYenW;
    }

    public void setKeisanKhGensenYenW(BizCurrency pKeisanKhGensenYenW) {
        keisanKhGensenYenW = pKeisanKhGensenYenW;
    }
    ...
    public void setRatesyutokukekkakbn(C_RatesyutokukekkaKbn pRatesyutokukekkakbn) {
        ratesyutokukekkakbn = pRatesyutokukekkakbn;
    }
    ...
    public C_Kykjyoutai getSyukykjyoutai() {
        return syukykjyoutai;
    }

    public void setSyukykjyoutai(C_Kykjyoutai pSyukykjyoutai) {
        this.syukykjyoutai = pSyukykjyoutai;
    }
    ...
    public void setKeisanCommonKaiyakuOutBean(KeisanCommonKaiyakuOutBean pKeisanCommonKaiyakuOutBean) {
        this.keisanCommonKaiyakuOutBean = pKeisanCommonKaiyakuOutBean;
    }
    ...
    public void setKaiyakuhrgoukei(BizCurrency pKaiyakuhrgoukei) {
        this.kaiyakuhrgoukei = pKaiyakuhrgoukei;
    }
    ...
    public void setYenkiykhrgoukei(BizCurrency pYenkiykhrgoukei) {
        this.yenkiykhrgoukei = pYenkiykhrgoukei;
    }
    ...
    public BizCurrency getZeimukaiyakuhryen() {
        return zeimukaiyakuhryen;
    }

    public void setZeimukaiyakuhryen(BizCurrency pZeimukaiyakuhryen) {
        zeimukaiyakuhryen = pZeimukaiyakuhryen;
    }
    ...
    public void setPminyuuSyoumetuShrtyousyoOutZumiFlg(C_UmuKbn pPminyuuSyoumetuShrtyousyoOutZumiFlg) {
        this.pminyuuSyoumetuShrtyousyoOutZumiFlg = pPminyuuSyoumetuShrtyousyoOutZumiFlg;
    }

    public C_NaiteiKakuteiKbn getHaitouKanriNaiteiKakuteiKbn() {
        return haitouKanriNaiteiKakuteiKbn;
    }

    public void setHaitouKanriNaiteiKakuteiKbn(C_NaiteiKakuteiKbn pHaitouKanriNaiteiKakuteiKbn) {
        this.haitouKanriNaiteiKakuteiKbn = pHaitouKanriNaiteiKakuteiKbn;
    }
