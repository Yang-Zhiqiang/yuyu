...
/**
 * 契約取消 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhKeiyakuTorikesiUiBean extends AbstractUiBean {
    ...
    private BizCurrency nykntuukashrgkgoukeisyoukai;

    public BizCurrency getNykntuukashrgkgoukeisyoukai() {
        return nykntuukashrgkgoukeisyoukai;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNykntuukashrgkgoukeisyoukai(BizCurrency pNykntuukashrgkgoukeisyoukai) {
        nykntuukashrgkgoukeisyoukai = pNykntuukashrgkgoukeisyoukai;
    }
    ...
    private BizCurrency jpyshrgkgoukeisyoukai;

    public BizCurrency getJpyshrgkgoukeisyoukai() {
        return jpyshrgkgoukeisyoukai;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setJpyshrgkgoukeisyoukai(BizCurrency pJpyshrgkgoukeisyoukai) {
        jpyshrgkgoukeisyoukai = pJpyshrgkgoukeisyoukai;
    }
    ...
    private BizCurrency yendthnkshrgkgoukeisyoukai;

    public BizCurrency getYendthnkshrgkgoukeisyoukai() {
        return yendthnkshrgkgoukeisyoukai;
    }

    public void setYendthnkshrgkgoukeisyoukai(BizCurrency pYendthnkshrgkgoukeisyoukai) {
        yendthnkshrgkgoukeisyoukai = pYendthnkshrgkgoukeisyoukai;
    }

    private BizCurrency yendthnkshrgkgoukeikakunin;

    public BizCurrency getYendthnkshrgkgoukeikakunin() {
        return yendthnkshrgkgoukeikakunin;
    }

    public void setYendthnkshrgkgoukeikakunin(BizCurrency pYendthnkshrgkgoukeikakunin) {
        yendthnkshrgkgoukeikakunin = pYendthnkshrgkgoukeikakunin;
    }
    ...
    private BizCurrency yenazukarikinkykhnkmikeikap;

    public BizCurrency getYenazukarikinkykhnkmikeikap() {
        return yenazukarikinkykhnkmikeikap;
    }

    public void setYenazukarikinkykhnkmikeikap(BizCurrency pYenazukarikinkykhnkmikeikap) {
        yenazukarikinkykhnkmikeikap = pYenazukarikinkykhnkmikeikap;
    }
