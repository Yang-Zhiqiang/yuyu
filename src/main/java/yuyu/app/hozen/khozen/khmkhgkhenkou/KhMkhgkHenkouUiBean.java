...
/**
 * 目標額変更 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhMkhgkHenkouUiBean extends GenKhMkhgkHenkouUiBean implements ViewKihonUiBeanParam,
...
SetTrkKazokuExecUiBeanParam, ViewKyksyadairiUiBeanParam, SetKyksyadairiExecUiBeanParam {
    ...
    private Integer oldTargettkmkht;

    private Integer newTargettkmkht;
    ...
    public Integer getOldTargettkmkht() {
        return oldTargettkmkht;
    }

    public void setOldTargettkmkht(Integer pOldTargettkmkht) {
        oldTargettkmkht = pOldTargettkmkht;
    }

    public Integer getNewTargettkmkht() {
        return newTargettkmkht;
    }

    public void setNewTargettkmkht(Integer pNewTargettkmkht) {
        newTargettkmkht = pNewTargettkmkht;
    }
