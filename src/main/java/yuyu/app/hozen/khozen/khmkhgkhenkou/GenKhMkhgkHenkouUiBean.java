...
/**
 * 目標額変更 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhMkhgkHenkouUiBean extends AbstractUiBean {
    ...
    private String dispbfrtargettkmokuhyouti;

    public String getDispbfrtargettkmokuhyouti() {
        return dispbfrtargettkmokuhyouti;
    }

    public void setDispbfrtargettkmokuhyouti(String pDispbfrtargettkmokuhyouti) {
        dispbfrtargettkmokuhyouti = pDispbfrtargettkmokuhyouti;
    }
