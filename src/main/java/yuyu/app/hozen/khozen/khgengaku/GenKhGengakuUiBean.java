...
/**
 * 減額 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhGengakuUiBean extends AbstractUiBean {
    ...
    private BizCurrency hensyuikthrip;

    public BizCurrency getHensyuikthrip() {
        return hensyuikthrip;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setHensyuikthrip(BizCurrency pHensyuikthrip) {
        hensyuikthrip = pHensyuikthrip;
    }
    ...
    private BizCurrency newhkngk;

    public BizCurrency getNewhkngk() {
        return newhkngk;
    }

    public void setNewhkngk(BizCurrency pNewhkngk) {
        newhkngk = pNewhkngk;
    }

    @CurrencyLenght(length=13)
    private BizCurrency newsyukjnkngk;

    public BizCurrency getNewsyukjnkngk() {
        return newsyukjnkngk;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNewsyukjnkngk(BizCurrency pNewsyukjnkngk) {
        newsyukjnkngk = pNewsyukjnkngk;
    }
    ...
    private BizCurrency yenkiykhrgoukei;

    public BizCurrency getYenkiykhrgoukei() {
        return yenkiykhrgoukei;
    }

    public void setYenkiykhrgoukei(BizCurrency pYenkiykhrgoukei) {
        yenkiykhrgoukei = pYenkiykhrgoukei;
    }
    ...
    private String viewsiharaiyendummy;

    public String getViewsiharaiyendummy() {
        return viewsiharaiyendummy;
    }

    public void setViewsiharaiyendummy(String pViewsiharaiyendummy) {
        viewsiharaiyendummy = pViewsiharaiyendummy;
    }
