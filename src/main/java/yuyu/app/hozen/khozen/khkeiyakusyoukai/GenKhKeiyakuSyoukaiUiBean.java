...
/**
 * 契約内容照会 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhKeiyakuSyoukaiUiBean extends AbstractUiBean {
    ...
    private DataSource<KensakuResultInfoDataSourceBean> kensakuResultInfoDataSource = new DataSource<>();
    public DataSource<KensakuResultInfoDataSourceBean> getKensakuResultInfoDataSource() {
        return kensakuResultInfoDataSource;
    }

    @Deprecated
    public List<KensakuResultInfoDataSourceBean> getKensakuResultInfo() {
        return kensakuResultInfoDataSource.getDatas();
    }

    public void setKensakuResultInfo(List<KensakuResultInfoDataSourceBean> pKensakuResultInfo) {
        kensakuResultInfoDataSource.setDatas(pKensakuResultInfo, 10);
    }
    ...
    private DataSource<TetudukiRirekiListDataSourceBean> tetudukiRirekiListDataSource = new DataSource<>();
    public DataSource<TetudukiRirekiListDataSourceBean> getTetudukiRirekiListDataSource() {
        return tetudukiRirekiListDataSource;
    }

    @Deprecated
    public List<TetudukiRirekiListDataSourceBean> getTetudukiRirekiList() {
        return tetudukiRirekiListDataSource.getDatas();
    }

    public void setTetudukiRirekiList(List<TetudukiRirekiListDataSourceBean> pTetudukiRirekiList) {
        tetudukiRirekiListDataSource.setDatas(pTetudukiRirekiList, 10);
    }

    private DataSource<HenkounaiyouListDataSourceBean> henkounaiyouListDataSource = new DataSource<>();
    public DataSource<HenkounaiyouListDataSourceBean> getHenkounaiyouListDataSource() {
        return henkounaiyouListDataSource;
    }

    @Deprecated
    public List<HenkounaiyouListDataSourceBean> getHenkounaiyouList() {
        return henkounaiyouListDataSource.getDatas();
    }

    public void setHenkounaiyouList(List<HenkounaiyouListDataSourceBean> pHenkounaiyouList) {
        henkounaiyouListDataSource.setDatas(pHenkounaiyouList);
    }
    ...
    private DataSource<NyuukinRirekiInfoDataSourceBean> nyuukinRirekiInfoDataSource = new DataSource<>();
    public DataSource<NyuukinRirekiInfoDataSourceBean> getNyuukinRirekiInfoDataSource() {
        return nyuukinRirekiInfoDataSource;
    }

    @Deprecated
    public List<NyuukinRirekiInfoDataSourceBean> getNyuukinRirekiInfo() {
        return nyuukinRirekiInfoDataSource.getDatas();
    }

    public void setNyuukinRirekiInfo(List<NyuukinRirekiInfoDataSourceBean> pNyuukinRirekiInfo) {
        nyuukinRirekiInfoDataSource.setDatas(pNyuukinRirekiInfo, 10);
    }

    private DataSource<HokenryouTmttInfoDataSourceBean> hokenryouTmttInfoDataSource = new DataSource<>();
    public DataSource<HokenryouTmttInfoDataSourceBean> getHokenryouTmttInfoDataSource() {
        return hokenryouTmttInfoDataSource;
    }

    @Deprecated
    public List<HokenryouTmttInfoDataSourceBean> getHokenryouTmttInfo() {
        return hokenryouTmttInfoDataSource.getDatas();
    }

    public void setHokenryouTmttInfo(List<HokenryouTmttInfoDataSourceBean> pHokenryouTmttInfo) {
        hokenryouTmttInfoDataSource.setDatas(pHokenryouTmttInfo);
    }
    ...
    private String ttdktyuuijouhoubtn;

    public String getTtdktyuuijouhoubtn() {
        return ttdktyuuijouhoubtn;
    }

    public void setTtdktyuuijouhoubtn(String pTtdktyuuijouhoubtn) {
        ttdktyuuijouhoubtn = pTtdktyuuijouhoubtn;
    }
    ...
    private String hosyoujouhoubtn;

    public String getHosyoujouhoubtn() {
        return hosyoujouhoubtn;
    }

    public void setHosyoujouhoubtn(String pHosyoujouhoubtn) {
        hosyoujouhoubtn = pHosyoujouhoubtn;
    }

    private String sonotatokuyakubtn;

    public String getSonotatokuyakubtn() {
        return sonotatokuyakubtn;
    }

    public void setSonotatokuyakubtn(String pSonotatokuyakubtn) {
        sonotatokuyakubtn = pSonotatokuyakubtn;
    }

    private String haraikomijouhoubtn;

    public String getHaraikomijouhoubtn() {
        return haraikomijouhoubtn;
    }

    public void setHaraikomijouhoubtn(String pHaraikomijouhoubtn) {
        haraikomijouhoubtn = pHaraikomijouhoubtn;
    }

    private String tokusinjouhoubtn;

    public String getTokusinjouhoubtn() {
        return tokusinjouhoubtn;
    }

    public void setTokusinjouhoubtn(String pTokusinjouhoubtn) {
        tokusinjouhoubtn = pTokusinjouhoubtn;
    }

    private String kariukekinjouhoubtn;

    public String getKariukekinjouhoubtn() {
        return kariukekinjouhoubtn;
    }

    public void setKariukekinjouhoubtn(String pKariukekinjouhoubtn) {
        kariukekinjouhoubtn = pKariukekinjouhoubtn;
    }

    private String dattaiouhoubtn;

    public String getDattaiouhoubtn() {
        return dattaiouhoubtn;
    }

    public void setDattaiouhoubtn(String pDattaiouhoubtn) {
        dattaiouhoubtn = pDattaiouhoubtn;
    }

    private String haitoukinjouhoubtn;

    public String getHaitoukinjouhoubtn() {
        return haitoukinjouhoubtn;
    }

    public void setHaitoukinjouhoubtn(String pHaitoukinjouhoubtn) {
        haitoukinjouhoubtn = pHaitoukinjouhoubtn;
    }
    ...
    private String syhenkouyjouhoubtn;

    public String getSyhenkouyjouhoubtn() {
        return syhenkouyjouhoubtn;
    }

    public void setSyhenkouyjouhoubtn(String pSyhenkouyjouhoubtn) {
        syhenkouyjouhoubtn = pSyhenkouyjouhoubtn;
    }
    ...
    private BizDateYM dispjkipjytym;

    public BizDateYM getDispjkipjytym() {
        return dispjkipjytym;
    }

    public void setDispjkipjytym(BizDateYM pDispjkipjytym) {
        dispjkipjytym = pDispjkipjytym;
    }

    private BizDate nextannaiyoteiymd;

    public BizDate getNextannaiyoteiymd() {
        return nextannaiyoteiymd;
    }

    public void setNextannaiyoteiymd(BizDate pNextannaiyoteiymd) {
        nextannaiyoteiymd = pNextannaiyoteiymd;
    }

    private BizDate hrkkjt;

    public BizDate getHrkkjt() {
        return hrkkjt;
    }

    public void setHrkkjt(BizDate pHrkkjt) {
        hrkkjt = pHrkkjt;
    }
    ...
    private C_PyenTutHouKbn pyentuthoukbn;

    public C_PyenTutHouKbn getPyentuthoukbn() {
        return pyentuthoukbn;
    }

    public void setPyentuthoukbn(C_PyenTutHouKbn pPyentuthoukbn) {
        pyentuthoukbn = pPyentuthoukbn;
    }
    ...
    @MultiByteStrings
    @InvalidCharacter
    private String kzkatesouhusaki1;

    public String getKzkatesouhusaki1() {
        return kzkatesouhusaki1;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setKzkatesouhusaki1(String pKzkatesouhusaki1) {
        kzkatesouhusaki1 = pKzkatesouhusaki1;
    }

    @MaxLength(max=15)
    @MultiByteStrings
    @InvalidCharacter
    private String kzkatesouhusaki2;

    public String getKzkatesouhusaki2() {
        return kzkatesouhusaki2;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setKzkatesouhusaki2(String pKzkatesouhusaki2) {
        kzkatesouhusaki2 = pKzkatesouhusaki2;
    }

    @ValidDateYm
    private BizDateYM srchkykym;

    public BizDateYM getSrchkykym() {
        return srchkykym;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setSrchkykym(BizDateYM pSrchkykym) {
        srchkykym = pSrchkykym;
    }
    ...
    private C_YuukousyoumetuKbn srchyuukousyoumetukbn;

    public C_YuukousyoumetuKbn getSrchyuukousyoumetukbn() {
        return srchyuukousyoumetukbn;
    }

    public void setSrchyuukousyoumetukbn(C_YuukousyoumetuKbn pSrchyuukousyoumetukbn) {
        srchyuukousyoumetukbn = pSrchyuukousyoumetukbn;
    }
    ...
    @MultiByteStrings
    @InvalidCharacter
    private String srchkyknmkj;

    public String getSrchkyknmkj() {
        return srchkyknmkj;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setSrchkyknmkj(String pSrchkyknmkj) {
        srchkyknmkj = pSrchkyknmkj;
    }
    ...
    @Digit
    @Length(length=7)
    private String srchtsinyno;

    public String getSrchtsinyno() {
        return srchtsinyno;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setSrchtsinyno(String pSrchtsinyno) {
        srchtsinyno = pSrchtsinyno;
    }

    @MaxLength(max=14)
    @SingleByteStrings
    @Tel
    private String srchtelno;

    public String getSrchtelno() {
        return srchtelno;
    }

    public void setSrchtelno(String pSrchtelno) {
        srchtelno = pSrchtelno;
    }
    ...
    @MultiByteStrings
    @InvalidCharacter
    private String srchhhknnmkj;

    public String getSrchhhknnmkj() {
        return srchhhknnmkj;
    }

    @Trim("right")
    @DataConvert("toMultiByte")
    public void setSrchhhknnmkj(String pSrchhhknnmkj) {
        srchhhknnmkj = pSrchhhknnmkj;
    }

    @ValidDate
    private BizDate srchhhknseiymd;

    public BizDate getSrchhhknseiymd() {
        return srchhhknseiymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setSrchhhknseiymd(BizDate pSrchhhknseiymd) {
        srchhhknseiymd = pSrchhhknseiymd;
    }
    ...
    private C_HaitoukinsksKbn vhthaitoukinskskbn;

    public C_HaitoukinsksKbn getVhthaitoukinskskbn() {
        return vhthaitoukinskskbn;
    }

    public void setVhthaitoukinskskbn(C_HaitoukinsksKbn pVhthaitoukinskskbn) {
        vhthaitoukinskskbn = pVhthaitoukinskskbn;
    }
    ...
    private BizDate displastsyosaihkymd;

    public BizDate getDisplastsyosaihkymd() {
        return displastsyosaihkymd;
    }

    @Trim("both")
    public void setDisplastsyosaihkymd(BizDate pDisplastsyosaihkymd) {
        displastsyosaihkymd = pDisplastsyosaihkymd;
    }
    ...
    private String syorisosikinm;

    public String getSyorisosikinm() {
        return syorisosikinm;
    }

    public void setSyorisosikinm(String pSyorisosikinm) {
        syorisosikinm = pSyorisosikinm;
    }

    private String syorinaiyou;

    public String getSyorinaiyou() {
        return syorinaiyou;
    }

    public void setSyorinaiyou(String pSyorinaiyou) {
        syorinaiyou = pSyorinaiyou;
    }

    private String syoritntnmkj;

    public String getSyoritntnmkj() {
        return syoritntnmkj;
    }

    public void setSyoritntnmkj(String pSyoritntnmkj) {
        syoritntnmkj = pSyoritntnmkj;
    }
    ...
    private BizCurrency dispyentuikahrkkin;

    public BizCurrency getDispyentuikahrkkin() {
        return dispyentuikahrkkin;
    }

    public void setDispyentuikahrkkin(BizCurrency pDispyentuikahrkkin) {
        dispyentuikahrkkin = pDispyentuikahrkkin;
    }

    private BizCurrency disptuikahrkkin;

    public BizCurrency getDisptuikahrkkin() {
        return disptuikahrkkin;
    }

    public void setDisptuikahrkkin(BizCurrency pDisptuikahrkkin) {
        disptuikahrkkin = pDisptuikahrkkin;
    }

    private BizDate dispnyknjikwsratetkyymd;

    public BizDate getDispnyknjikwsratetkyymd() {
        return dispnyknjikwsratetkyymd;
    }

    public void setDispnyknjikwsratetkyymd(BizDate pDispnyknjikwsratetkyymd) {
        dispnyknjikwsratetkyymd = pDispnyknjikwsratetkyymd;
    }

    private BizNumber dispnyknjikwsrate;

    public BizNumber getDispnyknjikwsrate() {
        return dispnyknjikwsrate;
    }

    public void setDispnyknjikwsrate(BizNumber pDispnyknjikwsrate) {
        dispnyknjikwsrate = pDispnyknjikwsrate;
    }
    ...
    private BizCurrency nykntuukashrgkgoukeikakunin;

    public BizCurrency getNykntuukashrgkgoukeikakunin() {
        return nykntuukashrgkgoukeikakunin;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNykntuukashrgkgoukeikakunin(BizCurrency pNykntuukashrgkgoukeikakunin) {
        nykntuukashrgkgoukeikakunin = pNykntuukashrgkgoukeikakunin;
    }
    ...
    private BizCurrency keitorikrkgk;

    public BizCurrency getKeitorikrkgk() {
        return keitorikrkgk;
    }

    public void setKeitorikrkgk(BizCurrency pKeitorikrkgk) {
        keitorikrkgk = pKeitorikrkgk;
    }

    private BizCurrency yenhenkank;

    public BizCurrency getYenhenkank() {
        return yenhenkank;
    }

    public void setYenhenkank(BizCurrency pYenhenkank) {
        yenhenkank = pYenhenkank;
    }
    ...
    private BizCurrency tumitatehaitouganrikin;

    public BizCurrency getTumitatehaitouganrikin() {
        return tumitatehaitouganrikin;
    }

    public void setTumitatehaitouganrikin(BizCurrency pTumitatehaitouganrikin) {
        tumitatehaitouganrikin = pTumitatehaitouganrikin;
    }

    private String disphaitttienrskksnbinissuu;

    public String getDisphaitttienrskksnbinissuu() {
        return disphaitttienrskksnbinissuu;
    }

    public void setDisphaitttienrskksnbinissuu(String pDisphaitttienrskksnbinissuu) {
        disphaitttienrskksnbinissuu = pDisphaitttienrskksnbinissuu;
    }

    private BizCurrency haitshrtienrsk;

    public BizCurrency getHaitshrtienrsk() {
        return haitshrtienrsk;
    }

    public void setHaitshrtienrsk(BizCurrency pHaitshrtienrsk) {
        haitshrtienrsk = pHaitshrtienrsk;
    }
    ...
    private BizCurrency sonotashrgk;

    public BizCurrency getSonotashrgk() {
        return sonotashrgk;
    }

    public void setSonotashrgk(BizCurrency pSonotashrgk) {
        sonotashrgk = pSonotashrgk;
    }
    ...
    private String disptienrskkisanymdnissuu;

    public String getDisptienrskkisanymdnissuu() {
        return disptienrskkisanymdnissuu;
    }

    public void setDisptienrskkisanymdnissuu(String pDisptienrskkisanymdnissuu) {
        disptienrskkisanymdnissuu = pDisptienrskkisanymdnissuu;
    }
    ...
    private BizCurrency sntshrgksssonotashrgk;

    public BizCurrency getSntshrgksssonotashrgk() {
        return sntshrgksssonotashrgk;
    }

    public void setSntshrgksssonotashrgk(BizCurrency pSntshrgksssonotashrgk) {
        sntshrgksssonotashrgk = pSntshrgksssonotashrgk;
    }

    @ValidDate
    private BizDate sntshrgkssgikshrratetekiymd;

    public BizDate getSntshrgkssgikshrratetekiymd() {
        return sntshrgkssgikshrratetekiymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setSntshrgkssgikshrratetekiymd(BizDate pSntshrgkssgikshrratetekiymd) {
        sntshrgkssgikshrratetekiymd = pSntshrgkssgikshrratetekiymd;
    }

    private BizNumber sntshrgkssgikshrrate;

    public BizNumber getSntshrgkssgikshrrate() {
        return sntshrgkssgikshrrate;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setSntshrgkssgikshrrate(BizNumber pSntshrgkssgikshrrate) {
        sntshrgkssgikshrrate = pSntshrgkssgikshrrate;
    }

    private C_Tuukasyu sntshrgkssgikshrkyktuukasyu;

    public C_Tuukasyu getSntshrgkssgikshrkyktuukasyu() {
        return sntshrgkssgikshrkyktuukasyu;
    }

    public void setSntshrgkssgikshrkyktuukasyu(C_Tuukasyu pSntshrgkssgikshrkyktuukasyu) {
        sntshrgkssgikshrkyktuukasyu = pSntshrgkssgikshrkyktuukasyu;
    }

    private BizCurrency sntshrgkssyensonotashrgk;

    public BizCurrency getSntshrgkssyensonotashrgk() {
        return sntshrgkssyensonotashrgk;
    }

    public void setSntshrgkssyensonotashrgk(BizCurrency pSntshrgkssyensonotashrgk) {
        sntshrgkssyensonotashrgk = pSntshrgkssyensonotashrgk;
    }

    private BizCurrency sntshrgkssyenkamikeikap;

    public BizCurrency getSntshrgkssyenkamikeikap() {
        return sntshrgkssyenkamikeikap;
    }

    public void setSntshrgkssyenkamikeikap(BizCurrency pSntshrgkssyenkamikeikap) {
        sntshrgkssyenkamikeikap = pSntshrgkssyenkamikeikap;
    }

    private BizCurrency sntshrgkssyenzennousisnkgk;

    public BizCurrency getSntshrgkssyenzennousisnkgk() {
        return sntshrgkssyenzennousisnkgk;
    }

    public void setSntshrgkssyenzennousisnkgk(BizCurrency pSntshrgkssyenzennousisnkgk) {
        sntshrgkssyenzennousisnkgk = pSntshrgkssyenzennousisnkgk;
    }

    private BizCurrency sntshrgkssyenazukarikin;

    public BizCurrency getSntshrgkssyenazukarikin() {
        return sntshrgkssyenazukarikin;
    }

    public void setSntshrgkssyenazukarikin(BizCurrency pSntshrgkssyenazukarikin) {
        sntshrgkssyenazukarikin = pSntshrgkssyenazukarikin;
    }

    private BizCurrency sntshrgkssyenhaitoukin;

    public BizCurrency getSntshrgkssyenhaitoukin() {
        return sntshrgkssyenhaitoukin;
    }

    public void setSntshrgkssyenhaitoukin(BizCurrency pSntshrgkssyenhaitoukin) {
        sntshrgkssyenhaitoukin = pSntshrgkssyenhaitoukin;
    }

    private BizCurrency sntshrgkssyentkbthaitoukin;

    public BizCurrency getSntshrgkssyentkbthaitoukin() {
        return sntshrgkssyentkbthaitoukin;
    }

    public void setSntshrgkssyentkbthaitoukin(BizCurrency pSntshrgkssyentkbthaitoukin) {
        sntshrgkssyentkbthaitoukin = pSntshrgkssyentkbthaitoukin;
    }

    private BizCurrency sntshrgkssyenkakrkgk;

    public BizCurrency getSntshrgkssyenkakrkgk() {
        return sntshrgkssyenkakrkgk;
    }

    public void setSntshrgkssyenkakrkgk(BizCurrency pSntshrgkssyenkakrkgk) {
        sntshrgkssyenkakrkgk = pSntshrgkssyenkakrkgk;
    }

    private BizCurrency jpyshrgkgoukeikakunin;

    public BizCurrency getJpyshrgkgoukeikakunin() {
        return jpyshrgkgoukeikakunin;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setJpyshrgkgoukeikakunin(BizCurrency pJpyshrgkgoukeikakunin) {
        jpyshrgkgoukeikakunin = pJpyshrgkgoukeikakunin;
    }
    ...
    private String dispjptienrskkisanymdnissuu;

    public String getDispjptienrskkisanymdnissuu() {
        return dispjptienrskkisanymdnissuu;
    }

    public void setDispjptienrskkisanymdnissuu(String pDispjptienrskkisanymdnissuu) {
        dispjptienrskkisanymdnissuu = pDispjptienrskkisanymdnissuu;
    }
    ...
    private BizCurrency shrsyousaikaiyakuhr;

    public BizCurrency getShrsyousaikaiyakuhr() {
        return shrsyousaikaiyakuhr;
    }

    public void setShrsyousaikaiyakuhr(BizCurrency pShrsyousaikaiyakuhr) {
        shrsyousaikaiyakuhr = pShrsyousaikaiyakuhr;
    }

    private BizCurrency shrsyousaijpykaiyakuhr;

    public BizCurrency getShrsyousaijpykaiyakuhr() {
        return shrsyousaijpykaiyakuhr;
    }

    public void setShrsyousaijpykaiyakuhr(BizCurrency pShrsyousaijpykaiyakuhr) {
        shrsyousaijpykaiyakuhr = pShrsyousaijpykaiyakuhr;
    }

    private BizCurrency shrsyousaiptumitatekin;

    public BizCurrency getShrsyousaiptumitatekin() {
        return shrsyousaiptumitatekin;
    }

    public void setShrsyousaiptumitatekin(BizCurrency pShrsyousaiptumitatekin) {
        shrsyousaiptumitatekin = pShrsyousaiptumitatekin;
    }

    private BizCurrency shrsyousaijpyptumitatekin;

    public BizCurrency getShrsyousaijpyptumitatekin() {
        return shrsyousaijpyptumitatekin;
    }

    public void setShrsyousaijpyptumitatekin(BizCurrency pShrsyousaijpyptumitatekin) {
        shrsyousaijpyptumitatekin = pShrsyousaijpyptumitatekin;
    }
    ...
    private C_Tuukasyu shrkyktuukasyu;

    public C_Tuukasyu getShrkyktuukasyu() {
        return shrkyktuukasyu;
    }

    public void setShrkyktuukasyu(C_Tuukasyu pShrkyktuukasyu) {
        shrkyktuukasyu = pShrkyktuukasyu;
    }

    private BizCurrency yenkiykhrssyenkiykhrgoukei;

    public BizCurrency getYenkiykhrssyenkiykhrgoukei() {
        return yenkiykhrssyenkiykhrgoukei;
    }

    public void setYenkiykhrssyenkiykhrgoukei(BizCurrency pYenkiykhrssyenkiykhrgoukei) {
        yenkiykhrssyenkiykhrgoukei = pYenkiykhrssyenkiykhrgoukei;
    }

    @ValidDate
    private BizDate yenkiykhrssyenshrratetkymd;

    public BizDate getYenkiykhrssyenshrratetkymd() {
        return yenkiykhrssyenshrratetkymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setYenkiykhrssyenshrratetkymd(BizDate pYenkiykhrssyenshrratetkymd) {
        yenkiykhrssyenshrratetkymd = pYenkiykhrssyenshrratetkymd;
    }

    private BizNumber yenkiykhrssyenshrratete;

    public BizNumber getYenkiykhrssyenshrratete() {
        return yenkiykhrssyenshrratete;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setYenkiykhrssyenshrratete(BizNumber pYenkiykhrssyenshrratete) {
        yenkiykhrssyenshrratete = pYenkiykhrssyenshrratete;
    }

    private C_Tuukasyu yenkiykhrssshrkyktuukasyu;

    public C_Tuukasyu getYenkiykhrssshrkyktuukasyu() {
        return yenkiykhrssshrkyktuukasyu;
    }

    public void setYenkiykhrssshrkyktuukasyu(C_Tuukasyu pYenkiykhrssshrkyktuukasyu) {
        yenkiykhrssshrkyktuukasyu = pYenkiykhrssshrkyktuukasyu;
    }

    private BizCurrency yenkiykhrsskaiyakuhrgoukei;

    public BizCurrency getYenkiykhrsskaiyakuhrgoukei() {
        return yenkiykhrsskaiyakuhrgoukei;
    }

    public void setYenkiykhrsskaiyakuhrgoukei(BizCurrency pYenkiykhrsskaiyakuhrgoukei) {
        yenkiykhrsskaiyakuhrgoukei = pYenkiykhrsskaiyakuhrgoukei;
    }

    private BizCurrency yenkiykhrsskaiyakuhryen;

    public BizCurrency getYenkiykhrsskaiyakuhryen() {
        return yenkiykhrsskaiyakuhryen;
    }

    public void setYenkiykhrsskaiyakuhryen(BizCurrency pYenkiykhrsskaiyakuhryen) {
        yenkiykhrsskaiyakuhryen = pYenkiykhrsskaiyakuhryen;
    }

    private BizCurrency yenkiykhrssmikeikap;

    public BizCurrency getYenkiykhrssmikeikap() {
        return yenkiykhrssmikeikap;
    }

    public void setYenkiykhrssmikeikap(BizCurrency pYenkiykhrssmikeikap) {
        yenkiykhrssmikeikap = pYenkiykhrssmikeikap;
    }

    private BizCurrency yenkiykhrsszennouseisankin;

    public BizCurrency getYenkiykhrsszennouseisankin() {
        return yenkiykhrsszennouseisankin;
    }

    public void setYenkiykhrsszennouseisankin(BizCurrency pYenkiykhrsszennouseisankin) {
        yenkiykhrsszennouseisankin = pYenkiykhrsszennouseisankin;
    }

    private BizCurrency yenkiykhrsskykhnkkaiyakuhr;

    public BizCurrency getYenkiykhrsskykhnkkaiyakuhr() {
        return yenkiykhrsskykhnkkaiyakuhr;
    }

    public void setYenkiykhrsskykhnkkaiyakuhr(BizCurrency pYenkiykhrsskykhnkkaiyakuhr) {
        yenkiykhrsskykhnkkaiyakuhr = pYenkiykhrsskykhnkkaiyakuhr;
    }

    private BizCurrency yenptmttssyenptmttgoukei;

    public BizCurrency getYenptmttssyenptmttgoukei() {
        return yenptmttssyenptmttgoukei;
    }

    public void setYenptmttssyenptmttgoukei(BizCurrency pYenptmttssyenptmttgoukei) {
        yenptmttssyenptmttgoukei = pYenptmttssyenptmttgoukei;
    }

    @ValidDate
    private BizDate yenptmttssyenshrratetkymd;

    public BizDate getYenptmttssyenshrratetkymd() {
        return yenptmttssyenshrratetkymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setYenptmttssyenshrratetkymd(BizDate pYenptmttssyenshrratetkymd) {
        yenptmttssyenshrratetkymd = pYenptmttssyenshrratetkymd;
    }

    private BizNumber yenptmttssyenshrratete;

    public BizNumber getYenptmttssyenshrratete() {
        return yenptmttssyenshrratete;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setYenptmttssyenshrratete(BizNumber pYenptmttssyenshrratete) {
        yenptmttssyenshrratete = pYenptmttssyenshrratete;
    }

    private C_Tuukasyu yenptmttssshrkyktuukasyu;

    public C_Tuukasyu getYenptmttssshrkyktuukasyu() {
        return yenptmttssshrkyktuukasyu;
    }

    public void setYenptmttssshrkyktuukasyu(C_Tuukasyu pYenptmttssshrkyktuukasyu) {
        yenptmttssshrkyktuukasyu = pYenptmttssshrkyktuukasyu;
    }

    private BizCurrency yenptmttssptumitategoukei;

    public BizCurrency getYenptmttssptumitategoukei() {
        return yenptmttssptumitategoukei;
    }

    public void setYenptmttssptumitategoukei(BizCurrency pYenptmttssptumitategoukei) {
        yenptmttssptumitategoukei = pYenptmttssptumitategoukei;
    }

    private BizCurrency yenptmttssptumitate;

    public BizCurrency getYenptmttssptumitate() {
        return yenptmttssptumitate;
    }

    public void setYenptmttssptumitate(BizCurrency pYenptmttssptumitate) {
        yenptmttssptumitate = pYenptmttssptumitate;
    }

    private BizCurrency yenptmttssmikeikap;

    public BizCurrency getYenptmttssmikeikap() {
        return yenptmttssmikeikap;
    }

    public void setYenptmttssmikeikap(BizCurrency pYenptmttssmikeikap) {
        yenptmttssmikeikap = pYenptmttssmikeikap;
    }

    private BizCurrency yenptmttsszennouseisankin;

    public BizCurrency getYenptmttsszennouseisankin() {
        return yenptmttsszennouseisankin;
    }

    public void setYenptmttsszennouseisankin(BizCurrency pYenptmttsszennouseisankin) {
        yenptmttsszennouseisankin = pYenptmttsszennouseisankin;
    }

    private BizCurrency yenptmttsskykhnkkaiyakuhr;

    public BizCurrency getYenptmttsskykhnkkaiyakuhr() {
        return yenptmttsskykhnkkaiyakuhr;
    }

    public void setYenptmttsskykhnkkaiyakuhr(BizCurrency pYenptmttsskykhnkkaiyakuhr) {
        yenptmttsskykhnkkaiyakuhr = pYenptmttsskykhnkkaiyakuhr;
    }

    private BizCurrency yendthnkshrgkgoukei;

    public BizCurrency getYendthnkshrgkgoukei() {
        return yendthnkshrgkgoukei;
    }

    public void setYendthnkshrgkgoukei(BizCurrency pYendthnkshrgkgoukei) {
        yendthnkshrgkgoukei = pYendthnkshrgkgoukei;
    }
    ...
    public void setYendthnkkaiyakuhr(BizCurrency pYendthnkkaiyakuhr) {
        yendthnkkaiyakuhr = pYendthnkkaiyakuhr;
    }

    private BizCurrency yendthnkptumitatekin;

    public BizCurrency getYendthnkptumitatekin() {
        return yendthnkptumitatekin;
    }

    public void setYendthnkptumitatekin(BizCurrency pYendthnkptumitatekin) {
        yendthnkptumitatekin = pYendthnkptumitatekin;
    }

    private BizCurrency yendthnkmikeikap;

    public BizCurrency getYendthnkmikeikap() {
        return yendthnkmikeikap;
    }

    public void setYendthnkmikeikap(BizCurrency pYendthnkmikeikap) {
        yendthnkmikeikap = pYendthnkmikeikap;
    }

    private BizCurrency yendthnkzennouseisankin;

    public BizCurrency getYendthnkzennouseisankin() {
        return yendthnkzennouseisankin;
    }

    public void setYendthnkzennouseisankin(BizCurrency pYendthnkzennouseisankin) {
        yendthnkzennouseisankin = pYendthnkzennouseisankin;
    }
    ...
    private BizCurrency yendthnkhaitoukin;

    public BizCurrency getYendthnkhaitoukin() {
        return yendthnkhaitoukin;
    }

    public void setYendthnkhaitoukin(BizCurrency pYendthnkhaitoukin) {
        yendthnkhaitoukin = pYendthnkhaitoukin;
    }

    private BizCurrency yendthnktkbthaitoukin;

    public BizCurrency getYendthnktkbthaitoukin() {
        return yendthnktkbthaitoukin;
    }

    public void setYendthnktkbthaitoukin(BizCurrency pYendthnktkbthaitoukin) {
        yendthnktkbthaitoukin = pYendthnktkbthaitoukin;
    }

    private BizCurrency yendthnkkrkgk;

    public BizCurrency getYendthnkkrkgk() {
        return yendthnkkrkgk;
    }

    public void setYendthnkkrkgk(BizCurrency pYendthnkkrkgk) {
        yendthnkkrkgk = pYendthnkkrkgk;
    }
    ...
    public void setYendthnkgstszeigk(BizCurrency pYendthnkgstszeigk) {
        yendthnkgstszeigk = pYendthnkgstszeigk;
    }

    private String dispyendttienrskksnbinissuu;

    public String getDispyendttienrskksnbinissuu() {
        return dispyendttienrskksnbinissuu;
    }

    public void setDispyendttienrskksnbinissuu(String pDispyendttienrskksnbinissuu) {
        dispyendttienrskksnbinissuu = pDispyendttienrskksnbinissuu;
    }

    private BizCurrency yendthnkshrtienrsk;

    public BizCurrency getYendthnkshrtienrsk() {
        return yendthnkshrtienrsk;
    }

    public void setYendthnkshrtienrsk(BizCurrency pYendthnkshrtienrsk) {
        yendthnkshrtienrsk = pYendthnkshrtienrsk;
    }

    private BizCurrency kiykhrsyousaikaiyakuhr;

    public BizCurrency getKiykhrsyousaikaiyakuhr() {
        return kiykhrsyousaikaiyakuhr;
    }

    public void setKiykhrsyousaikaiyakuhr(BizCurrency pKiykhrsyousaikaiyakuhr) {
        kiykhrsyousaikaiyakuhr = pKiykhrsyousaikaiyakuhr;
    }
    ...
    private BizNumber kiykhrsyousaisjkkktyouseirt;

    public BizNumber getKiykhrsyousaisjkkktyouseirt() {
        return kiykhrsyousaisjkkktyouseirt;
    }

    public void setKiykhrsyousaisjkkktyouseirt(BizNumber pKiykhrsyousaisjkkktyouseirt) {
        kiykhrsyousaisjkkktyouseirt = pKiykhrsyousaisjkkktyouseirt;
    }

    private BizCurrency kiykhrsyousaikaiyakukjgk;

    public BizCurrency getKiykhrsyousaikaiyakukjgk() {
        return kiykhrsyousaikaiyakukjgk;
    }

    public void setKiykhrsyousaikaiyakukjgk(BizCurrency pKiykhrsyousaikaiyakukjgk) {
        kiykhrsyousaikaiyakukjgk = pKiykhrsyousaikaiyakukjgk;
    }

    private BizNumber kiykhrsyousaikaiyakukjritu;

    public BizNumber getKiykhrsyousaikaiyakukjritu() {
        return kiykhrsyousaikaiyakukjritu;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setKiykhrsyousaikaiyakukjritu(BizNumber pKiykhrsyousaikaiyakukjritu) {
        kiykhrsyousaikaiyakukjritu = pKiykhrsyousaikaiyakukjritu;
    }

    private BizCurrency ptumitatekinssptumitatekin;

    public BizCurrency getPtumitatekinssptumitatekin() {
        return ptumitatekinssptumitatekin;
    }

    public void setPtumitatekinssptumitatekin(BizCurrency pPtumitatekinssptumitatekin) {
        ptumitatekinssptumitatekin = pPtumitatekinssptumitatekin;
    }
    ...
    private BizCurrency gststaisyousaeki;

    public BizCurrency getGststaisyousaeki() {
        return gststaisyousaeki;
    }

    public void setGststaisyousaeki(BizCurrency pGststaisyousaeki) {
        gststaisyousaeki = pGststaisyousaeki;
    }

    private BizCurrency zeimugstszeigk;

    public BizCurrency getZeimugstszeigk() {
        return zeimugstszeigk;
    }

    public void setZeimugstszeigk(BizCurrency pZeimugstszeigk) {
        zeimugstszeigk = pZeimugstszeigk;
    }
    ...
    private BizCurrency azukarigoukeigk;

    public BizCurrency getAzukarigoukeigk() {
        return azukarigoukeigk;
    }

    public void setAzukarigoukeigk(BizCurrency pAzukarigoukeigk) {
        azukarigoukeigk = pAzukarigoukeigk;
    }

    private BizCurrency azukariaiyakuhr;

    public BizCurrency getAzukariaiyakuhr() {
        return azukariaiyakuhr;
    }

    public void setAzukariaiyakuhr(BizCurrency pAzukariaiyakuhr) {
        azukariaiyakuhr = pAzukariaiyakuhr;
    }

    private BizCurrency azukarijpygoukeigk;

    public BizCurrency getAzukarijpygoukeigk() {
        return azukarijpygoukeigk;
    }

    public void setAzukarijpygoukeigk(BizCurrency pAzukarijpygoukeigk) {
        azukarijpygoukeigk = pAzukarijpygoukeigk;
    }

    private BizCurrency azukarip;

    public BizCurrency getAzukarip() {
        return azukarip;
    }

    public void setAzukarip(BizCurrency pAzukarip) {
        azukarip = pAzukarip;
    }

    private BizCurrency azukarizennouseisankgk;

    public BizCurrency getAzukarizennouseisankgk() {
        return azukarizennouseisankgk;
    }

    public void setAzukarizennouseisankgk(BizCurrency pAzukarizennouseisankgk) {
        azukarizennouseisankgk = pAzukarizennouseisankgk;
    }

    private BizCurrency azukarihaitoukin;

    public BizCurrency getAzukarihaitoukin() {
        return azukarihaitoukin;
    }

    public void setAzukarihaitoukin(BizCurrency pAzukarihaitoukin) {
        azukarihaitoukin = pAzukarihaitoukin;
    }

    private BizCurrency azukartkbtihaitoukin;

    public BizCurrency getAzukartkbtihaitoukin() {
        return azukartkbtihaitoukin;
    }

    public void setAzukartkbtihaitoukin(BizCurrency pAzukartkbtihaitoukin) {
        azukartkbtihaitoukin = pAzukartkbtihaitoukin;
    }

    private BizDate yendtinfomkhgktttymd;

    public BizDate getYendtinfomkhgktttymd() {
        return yendtinfomkhgktttymd;
    }

    public void setYendtinfomkhgktttymd(BizDate pYendtinfomkhgktttymd) {
        yendtinfomkhgktttymd = pYendtinfomkhgktttymd;
    }

    private BizDate yendtinfosyoruiuktkymd;

    public BizDate getYendtinfosyoruiuktkymd() {
        return yendtinfosyoruiuktkymd;
    }

    public void setYendtinfosyoruiuktkymd(BizDate pYendtinfosyoruiuktkymd) {
        yendtinfosyoruiuktkymd = pYendtinfosyoruiuktkymd;
    }

    private BizDate yendtinfoyendthnkymd;

    public BizDate getYendtinfoyendthnkymd() {
        return yendtinfoyendthnkymd;
    }

    public void setYendtinfoyendthnkymd(BizDate pYendtinfoyendthnkymd) {
        yendtinfoyendthnkymd = pYendtinfoyendthnkymd;
    }

    private BizCurrency yendtinfomkhgk;

    public BizCurrency getYendtinfomkhgk() {
        return yendtinfomkhgk;
    }

    public void setYendtinfomkhgk(BizCurrency pYendtinfomkhgk) {
        yendtinfomkhgk = pYendtinfomkhgk;
    }

    private BizCurrency yendtinfokjnkngk;

    public BizCurrency getYendtinfokjnkngk() {
        return yendtinfokjnkngk;
    }

    public void setYendtinfokjnkngk(BizCurrency pYendtinfokjnkngk) {
        yendtinfokjnkngk = pYendtinfokjnkngk;
    }

    private Integer yendtinfomokuhyouti;

    public Integer getYendtinfomokuhyouti() {
        return yendtinfomokuhyouti;
    }

    public void setYendtinfomokuhyouti(Integer pYendtinfomokuhyouti) {
        yendtinfomokuhyouti = pYendtinfomokuhyouti;
    }

    private BizCurrency yendtinfotoutatukngk;

    public BizCurrency getYendtinfotoutatukngk() {
        return yendtinfotoutatukngk;
    }

    public void setYendtinfotoutatukngk(BizCurrency pYendtinfotoutatukngk) {
        yendtinfotoutatukngk = pYendtinfotoutatukngk;
    }

    private BizCurrency yendtinfoyendthnkkjnkngk;

    public BizCurrency getYendtinfoyendthnkkjnkngk() {
        return yendtinfoyendthnkkjnkngk;
    }

    public void setYendtinfoyendthnkkjnkngk(BizCurrency pYendtinfoyendthnkkjnkngk) {
        yendtinfoyendthnkkjnkngk = pYendtinfoyendthnkkjnkngk;
    }

    private BizCurrency yendtinfoyendthnkkiykhr;

    public BizCurrency getYendtinfoyendthnkkiykhr() {
        return yendtinfoyendthnkkiykhr;
    }

    public void setYendtinfoyendthnkkiykhr(BizCurrency pYendtinfoyendthnkkiykhr) {
        yendtinfoyendthnkkiykhr = pYendtinfoyendthnkkiykhr;
    }

    private BizDate yendtinfoyendtkwratetkyymd;

    public BizDate getYendtinfoyendtkwratetkyymd() {
        return yendtinfoyendtkwratetkyymd;
    }

    public void setYendtinfoyendtkwratetkyymd(BizDate pYendtinfoyendtkwratetkyymd) {
        yendtinfoyendtkwratetkyymd = pYendtinfoyendtkwratetkyymd;
    }

    private BizNumber yendtinfoyendthnkjikwsrate;

    public BizNumber getYendtinfoyendthnkjikwsrate() {
        return yendtinfoyendthnkjikwsrate;
    }

    public void setYendtinfoyendthnkjikwsrate(BizNumber pYendtinfoyendthnkjikwsrate) {
        yendtinfoyendthnkjikwsrate = pYendtinfoyendthnkjikwsrate;
    }

    private C_Tuukasyu yendtinfokyktuukasyu;

    public C_Tuukasyu getYendtinfokyktuukasyu() {
        return yendtinfokyktuukasyu;
    }

    public void setYendtinfokyktuukasyu(C_Tuukasyu pYendtinfokyktuukasyu) {
        yendtinfokyktuukasyu = pYendtinfokyktuukasyu;
    }

    private BizCurrency yendtinfoyendthnkhrgk;

    public BizCurrency getYendtinfoyendthnkhrgk() {
        return yendtinfoyendthnkhrgk;
    }

    public void setYendtinfoyendthnkhrgk(BizCurrency pYendtinfoyendthnkhrgk) {
        yendtinfoyendthnkhrgk = pYendtinfoyendthnkhrgk;
    }

    private BizCurrency yendtinfobfrsibousyen;

    public BizCurrency getYendtinfobfrsibousyen() {
        return yendtinfobfrsibousyen;
    }

    public void setYendtinfobfrsibousyen(BizCurrency pYendtinfobfrsibousyen) {
        yendtinfobfrsibousyen = pYendtinfobfrsibousyen;
    }

    private BizCurrency yendtinfonewkaiyakuhr;

    public BizCurrency getYendtinfonewkaiyakuhr() {
        return yendtinfonewkaiyakuhr;
    }

    public void setYendtinfonewkaiyakuhr(BizCurrency pYendtinfonewkaiyakuhr) {
        yendtinfonewkaiyakuhr = pYendtinfonewkaiyakuhr;
    }

    private BizCurrency kiykhrsyousaiyendthnkiykhr;

    public BizCurrency getKiykhrsyousaiyendthnkiykhr() {
        return kiykhrsyousaiyendthnkiykhr;
    }

    public void setKiykhrsyousaiyendthnkiykhr(BizCurrency pKiykhrsyousaiyendthnkiykhr) {
        kiykhrsyousaiyendthnkiykhr = pKiykhrsyousaiyendthnkiykhr;
    }

    private BizCurrency yendtinfoptumitatekin;

    public BizCurrency getYendtinfoptumitatekin() {
        return yendtinfoptumitatekin;
    }

    public void setYendtinfoptumitatekin(BizCurrency pYendtinfoptumitatekin) {
        yendtinfoptumitatekin = pYendtinfoptumitatekin;
    }

    private BizNumber yendtinfosjkkktyouseiritu;

    public BizNumber getYendtinfosjkkktyouseiritu() {
        return yendtinfosjkkktyouseiritu;
    }

    public void setYendtinfosjkkktyouseiritu(BizNumber pYendtinfosjkkktyouseiritu) {
        yendtinfosjkkktyouseiritu = pYendtinfosjkkktyouseiritu;
    }

    private BizCurrency yendtinfokaiyakukjgk;

    public BizCurrency getYendtinfokaiyakukjgk() {
        return yendtinfokaiyakukjgk;
    }

    public void setYendtinfokaiyakukjgk(BizCurrency pYendtinfokaiyakukjgk) {
        yendtinfokaiyakukjgk = pYendtinfokaiyakukjgk;
    }

    private BizNumber yendtinfokaiyakukoujyoritu;

    public BizNumber getYendtinfokaiyakukoujyoritu() {
        return yendtinfokaiyakukoujyoritu;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setYendtinfokaiyakukoujyoritu(BizNumber pYendtinfokaiyakukoujyoritu) {
        yendtinfokaiyakukoujyoritu = pYendtinfokaiyakukoujyoritu;
    }
    ...
    private String dispyenhokenryou;

    public String getDispyenhokenryou() {
        return dispyenhokenryou;
    }

    public void setDispyenhokenryou(String pDispyenhokenryou) {
        dispyenhokenryou = pDispyenhokenryou;
    }

    private String kwsrtinfokakuteikwsrate;

    public String getKwsrtinfokakuteikwsrate() {
        return kwsrtinfokakuteikwsrate;
    }

    public void setKwsrtinfokakuteikwsrate(String pKwsrtinfokakuteikwsrate) {
        kwsrtinfokakuteikwsrate = pKwsrtinfokakuteikwsrate;
    }

    private String kwsrtinforstuukasyu;

    public String getKwsrtinforstuukasyu() {
        return kwsrtinforstuukasyu;
    }

    public void setKwsrtinforstuukasyu(String pKwsrtinforstuukasyu) {
        kwsrtinforstuukasyu = pKwsrtinforstuukasyu;
    }

    private String kwsrtinfokyktuukasyu;

    public String getKwsrtinfokyktuukasyu() {
        return kwsrtinfokyktuukasyu;
    }

    public void setKwsrtinfokyktuukasyu(String pKwsrtinfokyktuukasyu) {
        kwsrtinfokyktuukasyu = pKwsrtinfokyktuukasyu;
    }

    private String kwsrtinfoknsnkijyunymd;

    public String getKwsrtinfoknsnkijyunymd() {
        return kwsrtinfoknsnkijyunymd;
    }

    public void setKwsrtinfoknsnkijyunymd(String pKwsrtinfoknsnkijyunymd) {
        kwsrtinfoknsnkijyunymd = pKwsrtinfoknsnkijyunymd;
    }

    private String kwsrtinfomessage1;

    public String getKwsrtinfomessage1() {
        return kwsrtinfomessage1;
    }

    public void setKwsrtinfomessage1(String pKwsrtinfomessage1) {
        kwsrtinfomessage1 = pKwsrtinfomessage1;
    }

    private String kwsrtinfomessage2;

    public String getKwsrtinfomessage2() {
        return kwsrtinfomessage2;
    }

    public void setKwsrtinfomessage2(String pKwsrtinfomessage2) {
        kwsrtinfomessage2 = pKwsrtinfomessage2;
    }

    private BizDateYM dispannaiym1;

    public BizDateYM getDispannaiym1() {
        return dispannaiym1;
    }

    public void setDispannaiym1(BizDateYM pDispannaiym1) {
        dispannaiym1 = pDispannaiym1;
    }

    private String dispannaijyutoukaisuu1;

    public String getDispannaijyutoukaisuu1() {
        return dispannaijyutoukaisuu1;
    }

    public void setDispannaijyutoukaisuu1(String pDispannaijyutoukaisuu1) {
        dispannaijyutoukaisuu1 = pDispannaijyutoukaisuu1;
    }

    private BizCurrency dispannaigk1;

    public BizCurrency getDispannaigk1() {
        return dispannaigk1;
    }

    public void setDispannaigk1(BizCurrency pDispannaigk1) {
        dispannaigk1 = pDispannaigk1;
    }

    private BizDateYM dispannaijyutouym1;

    public BizDateYM getDispannaijyutouym1() {
        return dispannaijyutouym1;
    }

    public void setDispannaijyutouym1(BizDateYM pDispannaijyutouym1) {
        dispannaijyutouym1 = pDispannaijyutouym1;
    }

    private C_Nykkeiro dispannaikeiro1;

    public C_Nykkeiro getDispannaikeiro1() {
        return dispannaikeiro1;
    }

    public void setDispannaikeiro1(C_Nykkeiro pDispannaikeiro1) {
        dispannaikeiro1 = pDispannaikeiro1;
    }

    private C_AnnaijkKbn dispannaijkkbn1;

    public C_AnnaijkKbn getDispannaijkkbn1() {
        return dispannaijkkbn1;
    }

    public void setDispannaijkkbn1(C_AnnaijkKbn pDispannaijkkbn1) {
        dispannaijkkbn1 = pDispannaijkkbn1;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn1;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn1() {
        return dispcredituragngjiyuukbn1;
    }

    public void setDispcredituragngjiyuukbn1(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn1) {
        dispcredituragngjiyuukbn1 = pDispcredituragngjiyuukbn1;
    }

    private C_HurihunoKbn disphurihunokbn1;

    public C_HurihunoKbn getDisphurihunokbn1() {
        return disphurihunokbn1;
    }

    public void setDisphurihunokbn1(C_HurihunoKbn pDisphurihunokbn1) {
        disphurihunokbn1 = pDisphurihunokbn1;
    }

    private BizDateYM dispannaiym2;

    public BizDateYM getDispannaiym2() {
        return dispannaiym2;
    }

    public void setDispannaiym2(BizDateYM pDispannaiym2) {
        dispannaiym2 = pDispannaiym2;
    }

    private String dispannaijyutoukaisuu2;

    public String getDispannaijyutoukaisuu2() {
        return dispannaijyutoukaisuu2;
    }

    public void setDispannaijyutoukaisuu2(String pDispannaijyutoukaisuu2) {
        dispannaijyutoukaisuu2 = pDispannaijyutoukaisuu2;
    }

    private BizCurrency dispannaigk2;

    public BizCurrency getDispannaigk2() {
        return dispannaigk2;
    }

    public void setDispannaigk2(BizCurrency pDispannaigk2) {
        dispannaigk2 = pDispannaigk2;
    }

    private BizDateYM dispannaijyutouym2;

    public BizDateYM getDispannaijyutouym2() {
        return dispannaijyutouym2;
    }

    public void setDispannaijyutouym2(BizDateYM pDispannaijyutouym2) {
        dispannaijyutouym2 = pDispannaijyutouym2;
    }

    private C_Nykkeiro dispannaikeiro2;

    public C_Nykkeiro getDispannaikeiro2() {
        return dispannaikeiro2;
    }

    public void setDispannaikeiro2(C_Nykkeiro pDispannaikeiro2) {
        dispannaikeiro2 = pDispannaikeiro2;
    }

    private C_AnnaijkKbn dispannaijkkbn2;

    public C_AnnaijkKbn getDispannaijkkbn2() {
        return dispannaijkkbn2;
    }

    public void setDispannaijkkbn2(C_AnnaijkKbn pDispannaijkkbn2) {
        dispannaijkkbn2 = pDispannaijkkbn2;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn2;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn2() {
        return dispcredituragngjiyuukbn2;
    }

    public void setDispcredituragngjiyuukbn2(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn2) {
        dispcredituragngjiyuukbn2 = pDispcredituragngjiyuukbn2;
    }

    private C_HurihunoKbn disphurihunokbn2;

    public C_HurihunoKbn getDisphurihunokbn2() {
        return disphurihunokbn2;
    }

    public void setDisphurihunokbn2(C_HurihunoKbn pDisphurihunokbn2) {
        disphurihunokbn2 = pDisphurihunokbn2;
    }

    private BizDateYM dispannaiym3;

    public BizDateYM getDispannaiym3() {
        return dispannaiym3;
    }

    public void setDispannaiym3(BizDateYM pDispannaiym3) {
        dispannaiym3 = pDispannaiym3;
    }

    private String dispannaijyutoukaisuu3;

    public String getDispannaijyutoukaisuu3() {
        return dispannaijyutoukaisuu3;
    }

    public void setDispannaijyutoukaisuu3(String pDispannaijyutoukaisuu3) {
        dispannaijyutoukaisuu3 = pDispannaijyutoukaisuu3;
    }

    private BizCurrency dispannaigk3;

    public BizCurrency getDispannaigk3() {
        return dispannaigk3;
    }

    public void setDispannaigk3(BizCurrency pDispannaigk3) {
        dispannaigk3 = pDispannaigk3;
    }

    private BizDateYM dispannaijyutouym3;

    public BizDateYM getDispannaijyutouym3() {
        return dispannaijyutouym3;
    }

    public void setDispannaijyutouym3(BizDateYM pDispannaijyutouym3) {
        dispannaijyutouym3 = pDispannaijyutouym3;
    }

    private C_Nykkeiro dispannaikeiro3;

    public C_Nykkeiro getDispannaikeiro3() {
        return dispannaikeiro3;
    }

    public void setDispannaikeiro3(C_Nykkeiro pDispannaikeiro3) {
        dispannaikeiro3 = pDispannaikeiro3;
    }

    private C_AnnaijkKbn dispannaijkkbn3;

    public C_AnnaijkKbn getDispannaijkkbn3() {
        return dispannaijkkbn3;
    }

    public void setDispannaijkkbn3(C_AnnaijkKbn pDispannaijkkbn3) {
        dispannaijkkbn3 = pDispannaijkkbn3;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn3;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn3() {
        return dispcredituragngjiyuukbn3;
    }

    public void setDispcredituragngjiyuukbn3(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn3) {
        dispcredituragngjiyuukbn3 = pDispcredituragngjiyuukbn3;
    }

    private C_HurihunoKbn disphurihunokbn3;

    public C_HurihunoKbn getDisphurihunokbn3() {
        return disphurihunokbn3;
    }

    public void setDisphurihunokbn3(C_HurihunoKbn pDisphurihunokbn3) {
        disphurihunokbn3 = pDisphurihunokbn3;
    }

    private BizDateYM dispannaiym4;

    public BizDateYM getDispannaiym4() {
        return dispannaiym4;
    }

    public void setDispannaiym4(BizDateYM pDispannaiym4) {
        dispannaiym4 = pDispannaiym4;
    }

    private String dispannaijyutoukaisuu4;

    public String getDispannaijyutoukaisuu4() {
        return dispannaijyutoukaisuu4;
    }

    public void setDispannaijyutoukaisuu4(String pDispannaijyutoukaisuu4) {
        dispannaijyutoukaisuu4 = pDispannaijyutoukaisuu4;
    }

    private BizCurrency dispannaigk4;

    public BizCurrency getDispannaigk4() {
        return dispannaigk4;
    }

    public void setDispannaigk4(BizCurrency pDispannaigk4) {
        dispannaigk4 = pDispannaigk4;
    }

    private BizDateYM dispannaijyutouym4;

    public BizDateYM getDispannaijyutouym4() {
        return dispannaijyutouym4;
    }

    public void setDispannaijyutouym4(BizDateYM pDispannaijyutouym4) {
        dispannaijyutouym4 = pDispannaijyutouym4;
    }

    private C_Nykkeiro dispannaikeiro4;

    public C_Nykkeiro getDispannaikeiro4() {
        return dispannaikeiro4;
    }

    public void setDispannaikeiro4(C_Nykkeiro pDispannaikeiro4) {
        dispannaikeiro4 = pDispannaikeiro4;
    }

    private C_AnnaijkKbn dispannaijkkbn4;

    public C_AnnaijkKbn getDispannaijkkbn4() {
        return dispannaijkkbn4;
    }

    public void setDispannaijkkbn4(C_AnnaijkKbn pDispannaijkkbn4) {
        dispannaijkkbn4 = pDispannaijkkbn4;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn4;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn4() {
        return dispcredituragngjiyuukbn4;
    }

    public void setDispcredituragngjiyuukbn4(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn4) {
        dispcredituragngjiyuukbn4 = pDispcredituragngjiyuukbn4;
    }

    private C_HurihunoKbn disphurihunokbn4;

    public C_HurihunoKbn getDisphurihunokbn4() {
        return disphurihunokbn4;
    }

    public void setDisphurihunokbn4(C_HurihunoKbn pDisphurihunokbn4) {
        disphurihunokbn4 = pDisphurihunokbn4;
    }

    private BizDateYM dispannaiym5;

    public BizDateYM getDispannaiym5() {
        return dispannaiym5;
    }

    public void setDispannaiym5(BizDateYM pDispannaiym5) {
        dispannaiym5 = pDispannaiym5;
    }

    private String dispannaijyutoukaisuu5;

    public String getDispannaijyutoukaisuu5() {
        return dispannaijyutoukaisuu5;
    }

    public void setDispannaijyutoukaisuu5(String pDispannaijyutoukaisuu5) {
        dispannaijyutoukaisuu5 = pDispannaijyutoukaisuu5;
    }

    private BizCurrency dispannaigk5;

    public BizCurrency getDispannaigk5() {
        return dispannaigk5;
    }

    public void setDispannaigk5(BizCurrency pDispannaigk5) {
        dispannaigk5 = pDispannaigk5;
    }

    private BizDateYM dispannaijyutouym5;

    public BizDateYM getDispannaijyutouym5() {
        return dispannaijyutouym5;
    }

    public void setDispannaijyutouym5(BizDateYM pDispannaijyutouym5) {
        dispannaijyutouym5 = pDispannaijyutouym5;
    }

    private C_Nykkeiro dispannaikeiro5;

    public C_Nykkeiro getDispannaikeiro5() {
        return dispannaikeiro5;
    }

    public void setDispannaikeiro5(C_Nykkeiro pDispannaikeiro5) {
        dispannaikeiro5 = pDispannaikeiro5;
    }

    private C_AnnaijkKbn dispannaijkkbn5;

    public C_AnnaijkKbn getDispannaijkkbn5() {
        return dispannaijkkbn5;
    }

    public void setDispannaijkkbn5(C_AnnaijkKbn pDispannaijkkbn5) {
        dispannaijkkbn5 = pDispannaijkkbn5;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn5;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn5() {
        return dispcredituragngjiyuukbn5;
    }

    public void setDispcredituragngjiyuukbn5(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn5) {
        dispcredituragngjiyuukbn5 = pDispcredituragngjiyuukbn5;
    }

    private C_HurihunoKbn disphurihunokbn5;

    public C_HurihunoKbn getDisphurihunokbn5() {
        return disphurihunokbn5;
    }

    public void setDisphurihunokbn5(C_HurihunoKbn pDisphurihunokbn5) {
        disphurihunokbn5 = pDisphurihunokbn5;
    }

    private BizDateYM dispannaiym6;

    public BizDateYM getDispannaiym6() {
        return dispannaiym6;
    }

    public void setDispannaiym6(BizDateYM pDispannaiym6) {
        dispannaiym6 = pDispannaiym6;
    }

    private String dispannaijyutoukaisuu6;

    public String getDispannaijyutoukaisuu6() {
        return dispannaijyutoukaisuu6;
    }

    public void setDispannaijyutoukaisuu6(String pDispannaijyutoukaisuu6) {
        dispannaijyutoukaisuu6 = pDispannaijyutoukaisuu6;
    }

    private BizCurrency dispannaigk6;

    public BizCurrency getDispannaigk6() {
        return dispannaigk6;
    }

    public void setDispannaigk6(BizCurrency pDispannaigk6) {
        dispannaigk6 = pDispannaigk6;
    }

    private BizDateYM dispannaijyutouym6;

    public BizDateYM getDispannaijyutouym6() {
        return dispannaijyutouym6;
    }

    public void setDispannaijyutouym6(BizDateYM pDispannaijyutouym6) {
        dispannaijyutouym6 = pDispannaijyutouym6;
    }

    private C_Nykkeiro dispannaikeiro6;

    public C_Nykkeiro getDispannaikeiro6() {
        return dispannaikeiro6;
    }

    public void setDispannaikeiro6(C_Nykkeiro pDispannaikeiro6) {
        dispannaikeiro6 = pDispannaikeiro6;
    }

    private C_AnnaijkKbn dispannaijkkbn6;

    public C_AnnaijkKbn getDispannaijkkbn6() {
        return dispannaijkkbn6;
    }

    public void setDispannaijkkbn6(C_AnnaijkKbn pDispannaijkkbn6) {
        dispannaijkkbn6 = pDispannaijkkbn6;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn6;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn6() {
        return dispcredituragngjiyuukbn6;
    }

    public void setDispcredituragngjiyuukbn6(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn6) {
        dispcredituragngjiyuukbn6 = pDispcredituragngjiyuukbn6;
    }

    private C_HurihunoKbn disphurihunokbn6;

    public C_HurihunoKbn getDisphurihunokbn6() {
        return disphurihunokbn6;
    }

    public void setDisphurihunokbn6(C_HurihunoKbn pDisphurihunokbn6) {
        disphurihunokbn6 = pDisphurihunokbn6;
    }

    private BizDateYM dispannaiym7;

    public BizDateYM getDispannaiym7() {
        return dispannaiym7;
    }

    public void setDispannaiym7(BizDateYM pDispannaiym7) {
        dispannaiym7 = pDispannaiym7;
    }

    private String dispannaijyutoukaisuu7;

    public String getDispannaijyutoukaisuu7() {
        return dispannaijyutoukaisuu7;
    }

    public void setDispannaijyutoukaisuu7(String pDispannaijyutoukaisuu7) {
        dispannaijyutoukaisuu7 = pDispannaijyutoukaisuu7;
    }

    private BizCurrency dispannaigk7;

    public BizCurrency getDispannaigk7() {
        return dispannaigk7;
    }

    public void setDispannaigk7(BizCurrency pDispannaigk7) {
        dispannaigk7 = pDispannaigk7;
    }

    private BizDateYM dispannaijyutouym7;

    public BizDateYM getDispannaijyutouym7() {
        return dispannaijyutouym7;
    }

    public void setDispannaijyutouym7(BizDateYM pDispannaijyutouym7) {
        dispannaijyutouym7 = pDispannaijyutouym7;
    }

    private C_Nykkeiro dispannaikeiro7;

    public C_Nykkeiro getDispannaikeiro7() {
        return dispannaikeiro7;
    }

    public void setDispannaikeiro7(C_Nykkeiro pDispannaikeiro7) {
        dispannaikeiro7 = pDispannaikeiro7;
    }

    private C_AnnaijkKbn dispannaijkkbn7;

    public C_AnnaijkKbn getDispannaijkkbn7() {
        return dispannaijkkbn7;
    }

    public void setDispannaijkkbn7(C_AnnaijkKbn pDispannaijkkbn7) {
        dispannaijkkbn7 = pDispannaijkkbn7;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn7;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn7() {
        return dispcredituragngjiyuukbn7;
    }

    public void setDispcredituragngjiyuukbn7(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn7) {
        dispcredituragngjiyuukbn7 = pDispcredituragngjiyuukbn7;
    }

    private C_HurihunoKbn disphurihunokbn7;

    public C_HurihunoKbn getDisphurihunokbn7() {
        return disphurihunokbn7;
    }

    public void setDisphurihunokbn7(C_HurihunoKbn pDisphurihunokbn7) {
        disphurihunokbn7 = pDisphurihunokbn7;
    }

    private BizDateYM dispannaiym8;

    public BizDateYM getDispannaiym8() {
        return dispannaiym8;
    }

    public void setDispannaiym8(BizDateYM pDispannaiym8) {
        dispannaiym8 = pDispannaiym8;
    }

    private String dispannaijyutoukaisuu8;

    public String getDispannaijyutoukaisuu8() {
        return dispannaijyutoukaisuu8;
    }

    public void setDispannaijyutoukaisuu8(String pDispannaijyutoukaisuu8) {
        dispannaijyutoukaisuu8 = pDispannaijyutoukaisuu8;
    }

    private BizCurrency dispannaigk8;

    public BizCurrency getDispannaigk8() {
        return dispannaigk8;
    }

    public void setDispannaigk8(BizCurrency pDispannaigk8) {
        dispannaigk8 = pDispannaigk8;
    }

    private BizDateYM dispannaijyutouym8;

    public BizDateYM getDispannaijyutouym8() {
        return dispannaijyutouym8;
    }

    public void setDispannaijyutouym8(BizDateYM pDispannaijyutouym8) {
        dispannaijyutouym8 = pDispannaijyutouym8;
    }

    private C_Nykkeiro dispannaikeiro8;

    public C_Nykkeiro getDispannaikeiro8() {
        return dispannaikeiro8;
    }

    public void setDispannaikeiro8(C_Nykkeiro pDispannaikeiro8) {
        dispannaikeiro8 = pDispannaikeiro8;
    }

    private C_AnnaijkKbn dispannaijkkbn8;

    public C_AnnaijkKbn getDispannaijkkbn8() {
        return dispannaijkkbn8;
    }

    public void setDispannaijkkbn8(C_AnnaijkKbn pDispannaijkkbn8) {
        dispannaijkkbn8 = pDispannaijkkbn8;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn8;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn8() {
        return dispcredituragngjiyuukbn8;
    }

    public void setDispcredituragngjiyuukbn8(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn8) {
        dispcredituragngjiyuukbn8 = pDispcredituragngjiyuukbn8;
    }

    private C_HurihunoKbn disphurihunokbn8;

    public C_HurihunoKbn getDisphurihunokbn8() {
        return disphurihunokbn8;
    }

    public void setDisphurihunokbn8(C_HurihunoKbn pDisphurihunokbn8) {
        disphurihunokbn8 = pDisphurihunokbn8;
    }

    private BizDateYM dispannaiym9;

    public BizDateYM getDispannaiym9() {
        return dispannaiym9;
    }

    public void setDispannaiym9(BizDateYM pDispannaiym9) {
        dispannaiym9 = pDispannaiym9;
    }

    private String dispannaijyutoukaisuu9;

    public String getDispannaijyutoukaisuu9() {
        return dispannaijyutoukaisuu9;
    }

    public void setDispannaijyutoukaisuu9(String pDispannaijyutoukaisuu9) {
        dispannaijyutoukaisuu9 = pDispannaijyutoukaisuu9;
    }

    private BizCurrency dispannaigk9;

    public BizCurrency getDispannaigk9() {
        return dispannaigk9;
    }

    public void setDispannaigk9(BizCurrency pDispannaigk9) {
        dispannaigk9 = pDispannaigk9;
    }

    private BizDateYM dispannaijyutouym9;

    public BizDateYM getDispannaijyutouym9() {
        return dispannaijyutouym9;
    }

    public void setDispannaijyutouym9(BizDateYM pDispannaijyutouym9) {
        dispannaijyutouym9 = pDispannaijyutouym9;
    }

    private C_Nykkeiro dispannaikeiro9;

    public C_Nykkeiro getDispannaikeiro9() {
        return dispannaikeiro9;
    }

    public void setDispannaikeiro9(C_Nykkeiro pDispannaikeiro9) {
        dispannaikeiro9 = pDispannaikeiro9;
    }

    private C_AnnaijkKbn dispannaijkkbn9;

    public C_AnnaijkKbn getDispannaijkkbn9() {
        return dispannaijkkbn9;
    }

    public void setDispannaijkkbn9(C_AnnaijkKbn pDispannaijkkbn9) {
        dispannaijkkbn9 = pDispannaijkkbn9;
    }

    private C_CreditUriageNgJiyuuKbn dispcredituragngjiyuukbn9;

    public C_CreditUriageNgJiyuuKbn getDispcredituragngjiyuukbn9() {
        return dispcredituragngjiyuukbn9;
    }

    public void setDispcredituragngjiyuukbn9(C_CreditUriageNgJiyuuKbn pDispcredituragngjiyuukbn9) {
        dispcredituragngjiyuukbn9 = pDispcredituragngjiyuukbn9;
    }

    private C_HurihunoKbn disphurihunokbn9;

    public C_HurihunoKbn getDisphurihunokbn9() {
        return disphurihunokbn9;
    }

    public void setDisphurihunokbn9(C_HurihunoKbn pDisphurihunokbn9) {
        disphurihunokbn9 = pDisphurihunokbn9;
    }

    private BizNumber disptmttknzoukaritujygn;

    public BizNumber getDisptmttknzoukaritujygn() {
        return disptmttknzoukaritujygn;
    }

    public void setDisptmttknzoukaritujygn(BizNumber pDisptmttknzoukaritujygn) {
        disptmttknzoukaritujygn = pDisptmttknzoukaritujygn;
    }

    private BizNumber dispkykjisisuurendourate;

    public BizNumber getDispkykjisisuurendourate() {
        return dispkykjisisuurendourate;
    }

    public void setDispkykjisisuurendourate(BizNumber pDispkykjisisuurendourate) {
        dispkykjisisuurendourate = pDispkykjisisuurendourate;
    }

    private BizNumber disprendouritu;

    public BizNumber getDisprendouritu() {
        return disprendouritu;
    }

    public void setDisprendouritu(BizNumber pDisprendouritu) {
        disprendouritu = pDisprendouritu;
    }

    private BizNumber dispkykjisisuurendourate2;

    public BizNumber getDispkykjisisuurendourate2() {
        return dispkykjisisuurendourate2;
    }

    public void setDispkykjisisuurendourate2(BizNumber pDispkykjisisuurendourate2) {
        dispkykjisisuurendourate2 = pDispkykjisisuurendourate2;
    }
