...
/**
 * 特伸処理 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhTokusinUiBean extends AbstractUiBean {
    ...
    private C_TokusinKbn bfrtokusinkbn;

    public C_TokusinKbn getBfrtokusinkbn() {
        return bfrtokusinkbn;
    }

    public void setBfrtokusinkbn(C_TokusinKbn pBfrtokusinkbn) {
        bfrtokusinkbn = pBfrtokusinkbn;
    }

    @ValidDate
    private BizDate bfrhsgymd;

    public BizDate getBfrhsgymd() {
        return bfrhsgymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setBfrhsgymd(BizDate pBfrhsgymd) {
        bfrhsgymd = pBfrhsgymd;
    }

    private BizDate bfrtokusinsyoriymd;

    public BizDate getBfrtokusinsyoriymd() {
        return bfrtokusinsyoriymd;
    }

    public void setBfrtokusinsyoriymd(BizDate pBfrtokusinsyoriymd) {
        bfrtokusinsyoriymd = pBfrtokusinsyoriymd;
    }

    @ValidDate
    private BizDate bfrtokusinendymd;

    public BizDate getBfrtokusinendymd() {
        return bfrtokusinendymd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setBfrtokusinendymd(BizDate pBfrtokusinendymd) {
        bfrtokusinendymd = pBfrtokusinendymd;
    }
    ...
    public BizDateYM getTokusinendym() {
        return tokusinendym;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setTokusinendym(BizDateYM pTokusinendym) {
        tokusinendym = pTokusinendym;
    }
