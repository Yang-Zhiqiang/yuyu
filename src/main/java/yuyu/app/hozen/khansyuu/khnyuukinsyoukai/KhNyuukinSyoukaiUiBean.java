...
/**
 * 入金照会 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhNyuukinSyoukaiUiBean extends GenKhNyuukinSyoukaiUiBean implements CheckYuukouJyoutaiExecUiBeanParam,
SetToriatukaiTyuuiExecUiBeanParam,SetKihonExecUiBeanParam,SetBetukykExecUiBeanParam,SetTetudukityuuiExecUiBeanParam,
SetKeiyakusyaExecUiBeanParam,SetHaraikomiInfoExecUiBeanParam,ViewKihonUiBeanParam,ViewBetukykUiBeanParam,
ViewTetudukityuuiUiBeanParam,ViewKeiyakusyaUiBeanParam,ViewHaraikomiInfoUiBeanParam,
SetTokusinExecUiBeanParam, SetKariukekinExecUiBeanParam, SetDattaiExecUiBeanParam,
ViewTokusinUiBeanParam, ViewKariukekinUiBeanParam, ViewDattaiUiBeanParam{
    ...
    private C_UmuKbn keisanprstuukaknsnumn;

    public KhNyuukinSyoukaiUiBean() {
    }
    ...
    public C_UmuKbn getKeisanprstuukaknsnumn() {
        return keisanprstuukaknsnumn;
    }

    public void setKeisanprstuukaknsnumn(C_UmuKbn pKeisanprstuukaknsnumn) {
        this.keisanprstuukaknsnumn = pKeisanprstuukaknsnumn;
    }
