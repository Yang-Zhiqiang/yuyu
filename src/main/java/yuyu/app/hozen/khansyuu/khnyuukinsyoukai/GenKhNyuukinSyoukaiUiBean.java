...
/**
 * 入金照会 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhNyuukinSyoukaiUiBean extends AbstractUiBean {
    ...
    private C_NyksyoukaiKbn nyksyoukaikbn;

    public C_NyksyoukaiKbn getNyksyoukaikbn() {
        return nyksyoukaikbn;
    }

    public void setNyksyoukaikbn(C_NyksyoukaiKbn pNyksyoukaikbn) {
        nyksyoukaikbn = pNyksyoukaikbn;
    }

    @ValidDate
    private BizDate rsyymd;

    public BizDate getRsyymd() {
        return rsyymd;
    }

    @Trim("both")
    public void setRsyymd(BizDate pRsyymd) {
        rsyymd = pRsyymd;
    }
    ...
    private BizDate ryosyujikwsratekjymd;

    public BizDate getRyosyujikwsratekjymd() {
        return ryosyujikwsratekjymd;
    }

    public void setRyosyujikwsratekjymd(BizDate pRyosyujikwsratekjymd) {
        ryosyujikwsratekjymd = pRyosyujikwsratekjymd;
    }

    private BizNumber ryosyujikwsrate;

    public BizNumber getRyosyujikwsrate() {
        return ryosyujikwsrate;
    }

    public void setRyosyujikwsrate(BizNumber pRyosyujikwsrate) {
        ryosyujikwsrate = pRyosyujikwsrate;
    }
