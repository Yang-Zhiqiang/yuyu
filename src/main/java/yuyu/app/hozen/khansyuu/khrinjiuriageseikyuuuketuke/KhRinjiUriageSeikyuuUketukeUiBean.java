...
/**
 * 臨時売上請求受付 の画面UiBeanクラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
@ConversationScoped
public class KhRinjiUriageSeikyuuUketukeUiBean extends GenKhRinjiUriageSeikyuuUketukeUiBean implements
CheckYuukouJyoutaiExecUiBeanParam, SetToriatukaiTyuuiExecUiBeanParam, SetKihonExecUiBeanParam,
SetBetukykExecUiBeanParam, SetTetudukityuuiExecUiBeanParam, SetKeiyakusyaExecUiBeanParam,
SetHaraikomiInfoExecUiBeanParam, SetKariukekinExecUiBeanParam, ViewKihonUiBeanParam, ViewBetukykUiBeanParam,
ViewTetudukityuuiUiBeanParam, ViewKeiyakusyaUiBeanParam, ViewHaraikomiInfoUiBeanParam, ViewKariukekinUiBeanParam {
    ...
    private BizDate uriageymdSyoriyou;

    private BizCurrency rinjiuriageskkngkSyoriyou;

    public KhRinjiUriageSeikyuuUketukeUiBean() {
    }
    ...
    public BizDate getUriageymdSyoriyou() {
        return uriageymdSyoriyou;
    }

    public void setUriageymdSyoriyou(BizDate pUriageymdSyoriyou) {
        uriageymdSyoriyou = pUriageymdSyoriyou;
    }

    public BizCurrency getRinjiuriageskkngkSyoriyou() {
        return rinjiuriageskkngkSyoriyou;
    }

    public void setRinjiuriageskkngkSyoriyou(BizCurrency pRinjiuriageskkngkSyoriyou) {
        this.rinjiuriageskkngkSyoriyou = pRinjiuriageskkngkSyoriyou;
    }
