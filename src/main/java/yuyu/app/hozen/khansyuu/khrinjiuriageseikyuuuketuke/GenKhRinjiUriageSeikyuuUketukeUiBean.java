...
/**
 * 臨時売上請求受付 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhRinjiUriageSeikyuuUketukeUiBean extends AbstractUiBean {
    ...
    private BizCurrency rinjiuriageskkngk;

    public BizCurrency getRinjiuriageskkngk() {
        return rinjiuriageskkngk;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setRinjiuriageskkngk(BizCurrency pRinjiuriageskkngk) {
        rinjiuriageskkngk = pRinjiuriageskkngk;
    }
}
