...
/**
 * 口座整備処理 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenKhKzSeibiUiBean extends AbstractUiBean {
    ...
    private String bfrbankcd;

    public String getBfrbankcd() {
        return bfrbankcd;
    }

    public void setBfrbankcd(String pBfrbankcd) {
        bfrbankcd = pBfrbankcd;
    }

    private String bfrbanknmkj;

    public String getBfrbanknmkj() {
        return bfrbanknmkj;
    }

    public void setBfrbanknmkj(String pBfrbanknmkj) {
        bfrbanknmkj = pBfrbanknmkj;
    }

    private String bfrsitencd;

    public String getBfrsitencd() {
        return bfrsitencd;
    }

    public void setBfrsitencd(String pBfrsitencd) {
        bfrsitencd = pBfrsitencd;
    }

    private String bfrsitennmkj;

    public String getBfrsitennmkj() {
        return bfrsitennmkj;
    }

    public void setBfrsitennmkj(String pBfrsitennmkj) {
        bfrsitennmkj = pBfrsitennmkj;
    }

    private C_YokinKbn bfryokinkbn;

    public C_YokinKbn getBfryokinkbn() {
        return bfryokinkbn;
    }

    public void setBfryokinkbn(C_YokinKbn pBfryokinkbn) {
        bfryokinkbn = pBfryokinkbn;
    }

    private String bfrkouzano12keta;

    public String getBfrkouzano12keta() {
        return bfrkouzano12keta;
    }

    public void setBfrkouzano12keta(String pBfrkouzano12keta) {
        bfrkouzano12keta = pBfrkouzano12keta;
    }

    private C_KzkykdouKbn bfrkzdoukbn;

    public C_KzkykdouKbn getBfrkzdoukbn() {
        return bfrkzdoukbn;
    }

    public void setBfrkzdoukbn(C_KzkykdouKbn pBfrkzdoukbn) {
        bfrkzdoukbn = pBfrkzdoukbn;
    }

    private String bfrkzmeiginmkn;

    public String getBfrkzmeiginmkn() {
        return bfrkzmeiginmkn;
    }

    public void setBfrkzmeiginmkn(String pBfrkzmeiginmkn) {
        bfrkzmeiginmkn = pBfrkzmeiginmkn;
    }

    @Length(length=4)
    @Digit
    private String newbankcd;

    public String getNewbankcd() {
        return newbankcd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNewbankcd(String pNewbankcd) {
        newbankcd = pNewbankcd;
    }
    ...
    @Length(length=3)
    @Digit
    private String newsitencd;

    public String getNewsitencd() {
        return newsitencd;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNewsitencd(String pNewsitencd) {
        newsitencd = pNewsitencd;
    }
    ...
    private C_YokinKbn newyokinkbn;

    public C_YokinKbn getNewyokinkbn() {
        return newyokinkbn;
    }

    public void setNewyokinkbn(C_YokinKbn pNewyokinkbn) {
        newyokinkbn = pNewyokinkbn;
    }

    @MaxLength(max=12)
    @HostInvalidCharacter
    private String newkouzano12;

    public String getNewkouzano12() {
        return newkouzano12;
    }

    @Trim("both")
    @DataConvert("toSingleByte")
    public void setNewkouzano12(String pNewkouzano12) {
        newkouzano12 = pNewkouzano12;
    }

    private C_KzkykdouKbn newkzdoukbn;

    public C_KzkykdouKbn getNewkzdoukbn() {
        return newkzdoukbn;
    }

    public void setNewkzdoukbn(C_KzkykdouKbn pNewkzdoukbn) {
        newkzdoukbn = pNewkzdoukbn;
    }
