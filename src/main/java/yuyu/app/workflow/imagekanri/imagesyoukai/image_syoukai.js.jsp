<%--
    image_syoukai.js.jsp - イメージ照会 JavaScript(JSP)
--%>
<%@page language="java" contentType="text/javascript; charset=UTF-8" pageEncoding="UTF-8" %>
<%@page import="static jp.co.slcs.swak.web.struts.ui.IdSelectorConstants.*" %>
<%@page import="static yuyu.app.workflow.imagekanri.imagesyoukai.ImageSyoukaiConstants.*" %>
<%@page import="static yuyu.app.workflow.imagekanri.imagesyoukai.ImageSyoukaiSelector.*"  %>
<%@page import="jp.co.slcs.swak.core.inject.SWAKInjector" %>
<%@page import="yuyu.app.workflow.imagekanri.imagesyoukai.ImageSyoukaiUiBean" %>
<% ImageSyoukaiUiBean uiBean = SWAKInjector.getInstance(ImageSyoukaiUiBean.class); %>
