...
/**
 * 稼働時間登録 - ●非営業日 の 行データBean クラスです。<br />
 * このクラスは手書きのコード変更が行われる可能性があります。
 * ツールの自動生成ファイルを無条件で上書きしないよう注意して下さい。
 */
public class HiEigyoubiKadouTimeInfoDataSourceBean extends GenHiEigyoubiKadouTimeInfoDataSourceBean implements KadouTimeInfoDataSourceBean {

    private static final long serialVersionUID = 1L;

    public HiEigyoubiKadouTimeInfoDataSourceBean() {
    }
