 ...
 * 契約者索引情報ソートクラス
 */
public class KykSakuinInfoSortComparator implements Comparator<KykSakuinInfoDataSourceBean> {

    @Override
    public int compare(KykSakuinInfoDataSourceBean obj1, KykSakuinInfoDataSourceBean obj2) {

        C_KeihiKbn taisyousya1 = obj1.getDispkyksakuintaisyou();
        C_KeihiKbn taisyousya2 = obj2.getDispkyksakuintaisyou();
        BizDate syoumetuYmd1 = obj1.getDispkyksakuinsyoumetuymd();
        BizDate syoumetuYmd2 = obj2.getDispkyksakuinsyoumetuymd();
        String seirituJyoukyo1 = obj1.getSeirituJyoukyo();
        String seirituJyoukyo2 = obj2.getSeirituJyoukyo();
        C_GaitouKbn gaitouKbn1 = obj1.getDispkyksakuinhuseiritu();
        C_GaitouKbn gaitouKbn2 = obj2.getDispkyksakuinhuseiritu();
        C_SysCdKbn systemKbn1 = obj1.getDispkyksakuin();
        C_SysCdKbn systemKbn2 = obj2.getDispkyksakuin();
