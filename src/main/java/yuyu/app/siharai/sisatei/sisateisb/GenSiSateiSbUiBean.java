...
/**
 * （死亡）査定 : 画面UiBeanの抽象親クラスです。<br />
 * このソースはツールによる自動生成で、画面項目定義の変更に連動して更新されます。
 * 手書きコードを加えないでください。
 */
public abstract class GenSiSateiSbUiBean extends AbstractUiBean {
    ...
    private DataSource<ViewKakuninkoumokuInfoDataSourceBean> viewKakuninkoumokuInfoDataSource = new DataSource<>();
    public DataSource<ViewKakuninkoumokuInfoDataSourceBean> getViewKakuninkoumokuInfoDataSource() {
        return viewKakuninkoumokuInfoDataSource;
    }

    @Deprecated
    public List<ViewKakuninkoumokuInfoDataSourceBean> getViewKakuninkoumokuInfo() {
        return viewKakuninkoumokuInfoDataSource.getDatas();
    }

    public void setViewKakuninkoumokuInfo(List<ViewKakuninkoumokuInfoDataSourceBean> pViewKakuninkoumokuInfo) {
        viewKakuninkoumokuInfoDataSource.setDatas(pViewKakuninkoumokuInfo);
    }
    ...
    private LoopChain<UserDefsList> sateitennousakisousasyacdOptionBeanList = new LoopChain<>();
    public UserDefsList getSateitennousakisousasyacdOptionBeanList() {
        return sateitennousakisousasyacdOptionBeanList.get();
    }

    public void setSateitennousakisousasyacdOptionBeanList(UserDefsList pSateitennousakisousasyacdOptionBeanList) {
        clearSateitennousakisousasyacdOptionBeanList();
        sateitennousakisousasyacdOptionBeanList.add(pSateitennousakisousasyacdOptionBeanList);
    }

    public void clearSateitennousakisousasyacdOptionBeanList() {
        sateitennousakisousasyacdOptionBeanList.clear();
    }
}
