 ...
 */
public class CheckKykSeiYmdKanren {
        ...
        if (kykSeiYmd == null) {
            if (!C_Kyksei.HJNKYK.eq(kykSei)) {
                if (C_KykKbn.KEIHI_BETU.eq(kykKbn)) {
                    setHubiMsg.exec(C_KetsrhkosKbn.KETHORYU_HUBI, C_SpKeisanKahiKbn.SPKEISANKA,
                        ...
                        makeMsg(MessageId.EBC0045, MessageId.EBC0045, ICommonKoumoku.DISP_S_KYKSEIYMD), pMP,
            ...
            if (C_Kyksei.HJNKYK.eq(kykSei)) {
                setHubiMsg.exec(C_KetsrhkosKbn.KETHORYU_HUBI,
                    ...
                    C_HubisyubetusyousaiKbn.NONE,
                    makeMsg(MessageId.EHC0062, MessageId.EHC0062,
                        kykSei.getContent(), ICommonKoumoku.DISP_S_KYKSEIYMD), pMP,
                        C_TknKbn.NONE, C_MsgKbn.ERROR);
            }
            else {
                if (C_KykKbn.KEIHI_DOUITU.eq(kykKbn)) {
                    setHubiMsg.exec(C_KetsrhkosKbn.KETHORYU_HUBI,
                        ...
                        C_HubisyubetusyousaiKbn.NONE,
                        makeMsg(MessageId.EHC0062, MessageId.EHC0062,
                            kykKbn.getContent(), ICommonKoumoku.DISP_S_KYKSEIYMD), pMP,
                            C_TknKbn.NONE, C_MsgKbn.ERROR);
                }
            }
        }
