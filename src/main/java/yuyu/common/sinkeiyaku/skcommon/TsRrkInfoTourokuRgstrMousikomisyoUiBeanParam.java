...
/**
 * 新契約 新契約共通 訂正履歴情報登録RgstrMousikomisyoインタフェース
 */
public interface TsRrkInfoTourokuRgstrMousikomisyoUiBeanParam {
    ...
    BizCurrency getSyukihons();

    Integer getSyuhknkkn();

    C_HknkknsmnKbn getSyuhknkknsmnkbn();

    Integer getSyuhrkkkn();

    C_HrkkknsmnKbn getSyuhrkkknsmnkbn();
    ...
    String getTrkkzknmkn2();

    String getTrkkzknmkj2();

    C_KjkhukaKbn getTrkkzknmkjkhukakbn2();

    BizDate getTrkkzkseiymd2();

    C_Seibetu getTrkkzksei2();

    C_Tdk getTrkkzktdk2();

    C_TsindousiteiKbn getTrkkzktsindousiteikbn2();

    String getTrkkzkyno2();

    String getTrkkzkadr1kj2();

    String getTrkkzkadr2kj2();

    String getTrkkzkadr3kj2();

    String getTrkkzktelno2();

    C_Tkhukaumu getKykdrtkykhukakbn();

    C_UktKbn getKykdrkbn();
    ...
    C_KzhuritourokuhouKbn getKzhuritourokuhoukbn();
    ...
    String getKhnchkcmnt();

    //  2016/03/08 S社導入：コメントアウト
    //    String getTksyouhncd1();
    //
