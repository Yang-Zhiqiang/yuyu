 ...
 * 新契約 工程 新契約工程遷移（環境査定）
 */
public class SkProcessForwardKankyouSatei {
    ...
    public SkProcessForwardKankyouSatei() {
        super();
    }

    public void exec(SkProcessForwardInBean pSkProcessForwardInBean) {

        logger.debug("▽ 新契約工程遷移（環境査定） 開始");
        ...
        else if (C_SyorikekkaKbn.TENSOU_KANKYOU_1.eq(pSkProcessForwardInBean.getSyorikekkaKbn()) ||
            C_SyorikekkaKbn.TENSOU_KANKYOU_2A.eq(pSkProcessForwardInBean.getSyorikekkaKbn()) ||
            C_SyorikekkaKbn.TENSOU_KANKYOU_2B.eq(pSkProcessForwardInBean.getSyorikekkaKbn())) {
