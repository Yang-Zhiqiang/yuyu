 ...
 * 新契約 工程 新契約工程遷移（医務査定）
 */
public class SkProcessForwardImuSatei {
    ...
    public void exec(SkProcessForwardInBean pSkProcessForwardInBean) {
        ...
        else if (C_SyorikekkaKbn.TENSOU_IMU_KANIUW.eq(pSkProcessForwardInBean.getSyorikekkaKbn()) ||
            C_SyorikekkaKbn.TENSOU_IMU_KANIMD.eq(pSkProcessForwardInBean.getSyorikekkaKbn())) {
