...
/**
 * 新契約 工程 新契約工程遷移（強制ハンド決定入力）
 */
public class SkProcessForwardKyouseiHand {
    ...
    public SkProcessForwardKyouseiHand() {
        super();
    }

    public void exec(SkProcessForwardInBean pSkProcessForwardInBean) {

        logger.debug("▽ 新契約工程遷移（強制ハンド決定入力） 開始");
        ...
        if (C_SyorikekkaKbn.IRAI_TENKEN_1.eq(pSkProcessForwardInBean.getMostenkenkekkaKbn()) ||
            C_SyorikekkaKbn.IRAI_TENKEN_2.eq(pSkProcessForwardInBean.getMostenkenkekkaKbn()) ||
            C_SyorikekkaKbn.IRAI_TENKEN_HUBI.eq(pSkProcessForwardInBean.getMostenkenkekkaKbn())) {
        ...
        if (C_SyorikekkaKbn.IRAI_KANKYOU_1.eq(pSkProcessForwardInBean.getKnksateikekkaKbn()) ||
            C_SyorikekkaKbn.IRAI_KANKYOU_2A.eq(pSkProcessForwardInBean.getKnksateikekkaKbn()) ||
            C_SyorikekkaKbn.IRAI_KANKYOU_2B.eq(pSkProcessForwardInBean.getKnksateikekkaKbn())) {
        ...
        if (C_SyorikekkaKbn.IRAI_IMU_KANIUW.eq(pSkProcessForwardInBean.getImusateikekkaKbn()) ||
            C_SyorikekkaKbn.IRAI_IMU_KANIMD.eq(pSkProcessForwardInBean.getImusateikekkaKbn())) {
        ...
        logger.debug("△ 新契約工程遷移（強制ハンド決定入力） 終了");
    }
