...
/**
 * 新契約 工程 新契約工程遷移（成立保留処理）
 */
public class SkProcessForwardSeirituHoryuu {
    ...
    public SkProcessForwardSeirituHoryuu() {
        super();
    }

    public void exec(SkProcessForwardInBean pSkProcessForwardInBean) {

        logger.debug("▽ 新契約工程遷移（成立保留処理） 開始");
        ...
        logger.debug("△ 新契約工程遷移（成立保留処理） 終了");
    }
