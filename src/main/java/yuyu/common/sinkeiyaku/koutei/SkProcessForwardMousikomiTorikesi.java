 ...
 * 新契約 工程 新契約工程遷移（申込取消）
 */
public class SkProcessForwardMousikomiTorikesi {
    ...
    public SkProcessForwardMousikomiTorikesi() {
        super();
    }

    public void exec(SkProcessForwardInBean pSkProcessForwardInBean) {

        logger.debug("▽ 新契約工程遷移（申込取消） 開始");
        ...
        else if (C_SyorikekkaKbn.TENSOU_MOSTORIKESI.eq(pSkProcessForwardInBean.getSyorikekkaKbn())) {
