...
/**
 * 新契約 工程 新契約工程遷移（新契約不備帳票作成）
 */
public class SkProcessForwardHubiTyouhyou {

    @Inject
    private static Logger logger;

    public SkProcessForwardHubiTyouhyou() {
        super();
    }

    public void exec(List<SkProcessForwardForBatchInBean> pSkProcessForwardForBatchInBeanList) {

        logger.debug("▽ 新契約工程遷移（新契約不備帳票作成） 開始");
        ...
        logger.debug("△ 新契約工程遷移（新契約不備帳票作成） 終了");
    }
