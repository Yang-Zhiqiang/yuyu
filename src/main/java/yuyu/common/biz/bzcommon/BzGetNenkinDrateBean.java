...
/**
 * 業務共通 業務共通 年金開始後Ｄレート取得結果Ｂｅａｎクラス
 */
public class BzGetNenkinDrateBean implements Serializable {
    ...
    private HashMap<Integer, BizNumber> nenkinKaisigodRate = null;
    ...
    public HashMap<Integer, BizNumber> getNenkinKaisigodRate() {
        return nenkinKaisigodRate;
    }

    public void setNenkinKaisigodRate(HashMap<Integer, BizNumber> pNenkinKaisigodRate) {
        this.nenkinKaisigodRate = pNenkinKaisigodRate;
    }
