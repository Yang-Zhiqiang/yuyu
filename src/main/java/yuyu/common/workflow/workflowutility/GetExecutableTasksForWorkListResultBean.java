...
/**
 * 工程ワークリストタスク選択用実行可能タスク情報取得（新契約以外） の処理結果クラスです。<br />
 */
public class GetExecutableTasksForWorkListResultBean extends WorkListResultBean{

    public GetExecutableTasksForWorkListResultBean() {
    }
