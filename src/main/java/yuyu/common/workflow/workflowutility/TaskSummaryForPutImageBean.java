...
/**
 * 工程サマリBean の処理結果共通クラスです。<br />
 */
public class TaskSummaryForPutImageBean implements Serializable {
    ...
    private BizDate kouteiKaisiYmd;

    public BizDate getKouteiKaisiYmd() {
        return kouteiKaisiYmd;
    }

    public void setKouteiKaisiYmd(BizDate pKouteiKaisiYmd) {
        kouteiKaisiYmd = pKouteiKaisiYmd;
    }

    private BizDate kouteiKanryouYmd;

    public BizDate getKouteiKanryouYmd() {
        return kouteiKanryouYmd;
    }

    public void setKouteiKanryouYmd(BizDate pKouteiKanryouYmd) {
