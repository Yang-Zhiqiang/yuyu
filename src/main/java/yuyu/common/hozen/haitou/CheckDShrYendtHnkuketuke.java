...
/**
 * 契約保全 配当 配当支払チェック（円建変更受付）
 */
public class CheckDShrYendtHnkuketuke extends CheckDShr{
    ...
    public CheckDShrYendtHnkuketuke() {
        super();
    }
    ...
    public C_ErrorKbn checkDShr(String pSyono, BizDate pCalcKijyunYmd, BizDate pSyoriYmd) {
        ...
        if (C_ErrorKbn.ERROR.eq(checkExistsDHaneiYmd(pSyono, pCalcKijyunYmd))) {
