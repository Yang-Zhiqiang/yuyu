...
public class EditMinyuuTuuti {
    ...
    private static final String KBNEXTHURIKAEMAIYOU1_2_4_NEN1BARAI = "年分の保険料）";

    private static final String KBNEXTHURIKAEMAIYOU1_3 = "";

    private static final String KBNEXTHURIKAEMAIYOU1_3_GAIKA = "＊為替レートによって保険料は変動します";

    private static final String KBNEXTHURIKAEMAIYOU2_1 = "次回振替内容";

    private static final String KBNEXTHURIKAEMAIYOU2_1_GAIKA = "次回振替内容　＊前月末営業日における当社所定の為替レートで換算";
    ...
    private static final String KBNEXTHURIKAEMAIYOU2_3_4_NEN1BARAI = "年分の保険料）";
    ...
    private static final String KBZENHURIKAENAIYOU2_3_3_NEN1BARAI = "年分の保険料";
    ...
    private static final String KBZENHURIKAENAIYOU3_3_3_NEN1BARAI = "年分の保険料";
    ...
    private static final String KBZENHURIKAENAIYOU4_3_3_NEN1BARAI = "年分の保険料";
    ...
    private static final String KBADDMSG_TOKUYAKUMONGON_1 = "＊保険料円貨払込特約（円貨払込額指定型）または保険料円貨払込特約（円貨";

    private static final String KBADDMSG_TOKUYAKUMONGON_2 = "　払込額変動型）の付加された契約は、円貨払込額（定期一括払いの場合は、";

    private static final String KBADDMSG_TOKUYAKUMONGON_3 = "　定期一括払円貨払込額）について「保険料」と表示しております。";
    ...
    private static final String KBCREDITADDMSG_TOKUYAKUMONGON_1 = "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、円貨払込額";

    private static final String KBCREDITADDMSG_TOKUYAKUMONGON_2 = "　（定期一括払いの場合は、定期一括払円貨払込額）について「保険料」と表示";

    private static final String KBCREDITADDMSG_TOKUYAKUMONGON_3 = "　しております。";
    ...
    public IT_KouzahuriMinyuTuuti editTBL(KhozenCommonParam pKhozenCommonParam,
        ...
        String dispJkiAnnaiJyuutouNensuu = Strings.padStart(
            ConvertUtil.toZenNumeric(String.valueOf(pEditMinyuuTuutiParam.getJkiAnnaiJyuutouNensuu())), 2, '　');
        ...
        String dispZenAnnaiJyuutouNensuu = Strings.padStart(
            ConvertUtil.toZenNumeric(String.valueOf(pEditMinyuuTuutiParam.getZenAnnaiJyuutouNensuu())), 2, '　');
        ...
        if (C_Hrkkaisuu.HALFY.eq(pKykKihon.getHrkkaisuu()) || C_Hrkkaisuu.NEN.eq(pKykKihon.getHrkkaisuu())) {
        ...
        if ((C_UmuKbn.NONE.eq(pEditMinyuuTuutiParam.getDattaiUktkUmu()) &&
            ...
            if (C_Hrkkaisuu.TUKI.eq(pKykKihon.getHrkkaisuu()) || C_Hrkkaisuu.HALFY.eq(pKykKihon.getHrkkaisuu())) {

                if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(kykSonotaTkyk.getYennyknsyuruikbn())) {

                    nextHurikaeNaiyou1 = KBNEXTHURIKAEMAIYOU2_1_GAIKA;
            ...
            if (C_Hrkkaisuu.NEN.eq(pKykKihon.getHrkkaisuu())) {
                ...
                if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(kykSonotaTkyk.getYennyknsyuruikbn())) {
                    ...
                    nextHurikaeNaiyou3 = KBNEXTHURIKAEMAIYOU2_3_1 + dispJkiAnnaiKg + KBNEXTHURIKAEMAIYOU2_3_2  +
                        dispJkiPJytYm + KBNEXTHURIKAEMAIYOU2_3_3  + dispJkiAnnaiJyuutouNensuu + KBNEXTHURIKAEMAIYOU2_3_4_NEN1BARAI;
                }
                else {
            ...
            if (C_Hrkkaisuu.TUKI.eq(pKykKihon.getHrkkaisuu()) || C_Hrkkaisuu.HALFY.eq(pKykKihon.getHrkkaisuu())) {
                ...
                if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(kykSonotaTkyk.getYennyknsyuruikbn())) {
                    ...
                    nextHurikaeNaiyou3 = KBNEXTHURIKAEMAIYOU1_3_GAIKA;
                }
                else {
            ...
            if (C_Hrkkaisuu.NEN.eq(pKykKihon.getHrkkaisuu())) {
                ...
                if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(kykSonotaTkyk.getYennyknsyuruikbn())) {
                    ...
                    nextHurikaeNaiyou2 = KBNEXTHURIKAEMAIYOU1_2_1 + dispZenAnnaiKg + KBNEXTHURIKAEMAIYOU1_2_2 +
                        dispZenAnnaiJyutouYm + KBNEXTHURIKAEMAIYOU1_2_3  + dispZenAnnaiJyuutouNensuu + KBNEXTHURIKAEMAIYOU1_2_4_NEN1BARAI;
        ...
        if (C_UmuKbn.NONE.eq(pEditMinyuuTuutiParam.getDattaiUktkUmu()) &&
            ...
            if (C_Hrkkaisuu.TUKI.eq(pEditMinyuuTuutiParam.getAnnaijiHrkkaisuu()) || C_Hrkkaisuu.HALFY.eq(pEditMinyuuTuutiParam.getAnnaijiHrkkaisuu())) {
            ...
            if (C_Hrkkaisuu.NEN.eq(pEditMinyuuTuutiParam.getAnnaijiHrkkaisuu())) {
                ...
                if (C_HurihunoKbn.SIKINHUSOKU.eq(pEditMinyuuTuutiParam.getHurihunoKbn())) {
                    ...
                    zenHurikaeNaiyou3 = KBZENHURIKAENAIYOU3_3_1 + dispZenAnnaiJyutouYm +
                        KBZENHURIKAENAIYOU3_3_2 + dispZenAnnaiJyuutouNensuu + KBZENHURIKAENAIYOU3_3_3_NEN1BARAI +
                        dispZenAnnaiKg + KBZENHURIKAENAIYOU3_3_4;
                    ...
                    zenHurikaeNaiyou3 = KBZENHURIKAENAIYOU4_3_1 + dispZenAnnaiJyutouYm +
                        KBZENHURIKAENAIYOU4_3_2 + dispZenAnnaiJyuutouNensuu + KBZENHURIKAENAIYOU4_3_3_NEN1BARAI +
                        dispZenAnnaiKg + KBZENHURIKAENAIYOU4_3_4;
                    ...
                    zenHurikaeNaiyou3 = KBZENHURIKAENAIYOU2_3_1 + dispZenAnnaiJyutouYm +
                        KBZENHURIKAENAIYOU2_3_2 + dispZenAnnaiJyuutouNensuu + KBZENHURIKAENAIYOU2_3_3_NEN1BARAI +
                        dispZenAnnaiKg + KBZENHURIKAENAIYOU2_3_4;
        ...
        if (BizDateUtil.compareYm(hurikaeYmYokugetu,
            ...
            if (C_UmuKbn.NONE.eq(pEditMinyuuTuutiParam.getDattaiUktkUmu()) ||
                ...
                if ((!pEditMinyuuTuutiParam.getHurihunoKbn().eq(zenHurihunoKbn) &&
                    ...
                    minyuttAddMsg15 = KBADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg16 = KBADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg17 = KBADDMSG_TOKUYAKUMONGON_3;
                    ...
                    minyuttAddMsg18 = KBADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg19 = KBADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg20 = KBADDMSG_TOKUYAKUMONGON_3;
                ...
                if (C_DattairiyuuKbn.HRHENKIBOU.eq(pEditMinyuuTuutiParam.getDattaiRiyuuKbn())) {
                    ...
                    minyuttAddMsg14 = KBADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg15 = KBADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg16 = KBADDMSG_TOKUYAKUMONGON_3;
            ...
            if (C_UmuKbn.NONE.eq(pEditMinyuuTuutiParam.getDattaiUktkUmu()) ||
                ...
                if ((!pEditMinyuuTuutiParam.getHurihunoKbn().eq(zenHurihunoKbn) &&
                    ...
                    minyuttAddMsg19 = KBADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg20 = KBADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg21 = KBADDMSG_TOKUYAKUMONGON_3;
                }
                else {
    ...
    public IT_KouzahuriMinyuTuuti editTBL(KhozenCommonParam pKhozenCommonParam,
        ...
        String dispJkiAnnaiJyuutouNensuu = Strings.padStart(
            ConvertUtil.toZenNumeric(String.valueOf(pSaikokuTuutiParam.getJkiAnnaiJyuutouNensuu())), 2, '　');
        ...
        if (C_UmuKbn.NONE.eq(pSaikokuTuutiParam.getDattaiUktkUmu())) {
            ...
            if (C_Hrkkaisuu.NEN.eq(pKykKihon.getHrkkaisuu()) ) {
                ...
                if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(kykSonotaTkyk.getYennyknsyuruikbn())) {
                    ...
                    nextHurikaeNaiyou1 = KBNEXTHURIKAEMAIYOU1_1;
                    nextHurikaeNaiyou2 = KBNEXTHURIKAEMAIYOU1_2_1 + dispJkiAnnaiKg + KBNEXTHURIKAEMAIYOU1_2_2 +
                        dispJkiPJytYm + KBNEXTHURIKAEMAIYOU1_2_3  + dispJkiAnnaiJyuutouNensuu + KBNEXTHURIKAEMAIYOU1_2_4_NEN1BARAI;
                    nextHurikaeNaiyou3 = KBNEXTHURIKAEMAIYOU1_3_GAIKA;
                }
                else {
        ...
        if (!syouMetuYokoFlg) {
            ...
            if (C_UmuKbn.NONE.eq(pEditCreditMinyuuTuutiParam.getDattaiUktkUmu())) {
                ...
                if (C_Yuukoukakkekka.YUUKOUKAK_OK.eq(pEditCreditMinyuuTuutiParam.getYuukoukakkekka()) &&
                    ...
                    minyuttAddMsg18 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg19 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg20 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                ...
                if (C_Yuukoukakkekka.YUUKOUKAK_OK.eq(pEditCreditMinyuuTuutiParam.getYuukoukakkekka())) {
                    ...
                    if (C_CreditUriageNgJiyuuKbn.YUUKOUKIGENERROR.eq(
                        ...
                        minyuttAddMsg22 = KB_BLANK;
                        minyuttAddMsg23 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                        minyuttAddMsg24 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                        minyuttAddMsg25 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                        minyuttAddMsg26 = KB_BLANK;
                        minyuttAddMsg27 = KB_BLANK;
                    }
                    else if (C_Dattaikeiro.ONLINE.eq(pEditCreditMinyuuTuutiParam.getDattaikeiro())) {
                        ...
                        if (C_DattairiyuuKbn.HRHENKIBOU.eq(pEditCreditMinyuuTuutiParam.getDattaiRiyuuKbn())) {
                            ...
                            minyuttAddMsg16 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg17 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg18 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            ...
                            minyuttAddMsg14 = KB_BLANK;
                            minyuttAddMsg15 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg16 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg17 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            ...
                            minyuttAddMsg14 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg15 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg16 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            minyuttAddMsg17 = KB_BLANK;
                            minyuttAddMsg18 = KB_BLANK;
                            minyuttAddMsg19 = KB_BLANK;
                            minyuttAddMsg20 = KB_BLANK;
                    ...
                    if (C_Dattaikeiro.CREDIT.eq(pEditCreditMinyuuTuutiParam.getDattaikeiro())) {
                        ...
                        if (C_DattairiyuuKbn.HRHENKIBOU.eq(pEditCreditMinyuuTuutiParam.getDattaiRiyuuKbn())) {
                            ...
                            minyuttAddMsg20 = KB_BLANK;
                            minyuttAddMsg21 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg22 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg23 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            minyuttAddMsg24 = KB_BLANK;
                            minyuttAddMsg25 = KB_BLANK;
                            minyuttAddMsg26 = KB_BLANK;
                            minyuttAddMsg27 = KB_BLANK;
                            ...
                            minyuttAddMsg19 = KB_BLANK;
                            minyuttAddMsg20 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg21 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg22 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            minyuttAddMsg23 = KB_BLANK;
                            minyuttAddMsg24 = KB_BLANK;
                            minyuttAddMsg25 = KB_BLANK;
                            minyuttAddMsg26 = KB_BLANK;
            ...
            if (C_UmuKbn.NONE.eq(pEditCreditMinyuuTuutiParam.getDattaiUktkUmu())) {
                ...
                if (C_Yuukoukakkekka.YUUKOUKAK_OK.eq(pEditCreditMinyuuTuutiParam.getYuukoukakkekka()) &&
                    ...
                    minyuttAddMsg17 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg18 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg19 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                    minyuttAddMsg20 = KB_BLANK;
                    minyuttAddMsg21 = KB_BLANK;
                    minyuttAddMsg22 = KB_BLANK;
                    minyuttAddMsg23 = KB_BLANK;
                ...
                if (C_Yuukoukakkekka.YUUKOUKAK_OK.eq(pEditCreditMinyuuTuutiParam.getYuukoukakkekka())) {
                    ...
                    if (C_Dattaikeiro.CREDIT.eq(pEditCreditMinyuuTuutiParam.getDattaikeiro())) {
                        ...
                        if (C_DattairiyuuKbn.HRHENKIBOU.eq(pEditCreditMinyuuTuutiParam.getDattaiRiyuuKbn())) {
                            ...
                            minyuttAddMsg17 = KBCREDITADDMSG5_DATTAITYU_2_KAIYK;
                            minyuttAddMsg18 = KBCREDITADDMSG5_DATTAITYU_3_KAIYK;
                            minyuttAddMsg19 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                            minyuttAddMsg20 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                            minyuttAddMsg21 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                            minyuttAddMsg22 = KB_BLANK;
                            minyuttAddMsg23 = KB_BLANK;
                            minyuttAddMsg24 = KB_BLANK;
                            minyuttAddMsg25 = KB_BLANK;
        ...
        if (C_UmuKbn.NONE.eq(pCreditSaikokuTuutiParam.getDattaiUktkUmu())) {
            ...
            if (C_Yuukoukakkekka.YUUKOUKAK_OK.eq(pCreditSaikokuTuutiParam.getYuukoukakkekka())) {
                ...
                if (C_CreditUriageNgJiyuuKbn.YUUKOUKIGENERROR.eq(
                    ...
                    minyuttAddMsg20 = KBCREDITADDMSG2_YKKIGENKIRE_10;
                    minyuttAddMsg21 = KBCREDITADDMSG2_YKKIGENKIRE_11;
                    minyuttAddMsg22 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                    minyuttAddMsg23 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                    minyuttAddMsg24 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
                    minyuttAddMsg25 = KB_BLANK;
                    minyuttAddMsg26 = KB_BLANK;
                    minyuttAddMsg27 = KB_BLANK;
                }
                    ...
                    if (C_DattairiyuuKbn.HRHENKIBOU.eq(pCreditSaikokuTuutiParam.getDattaiRiyuuKbn())) {
                        ...
                        minyuttAddMsg11 = KBCREDITADDMSG6_DATTAITYU_1_SONOTA;
                        minyuttAddMsg12 = KBCREDITADDMSG6_DATTAITYU_2_SONOTA;
                        minyuttAddMsg13 = KBCREDITADDMSG_TOKUYAKUMONGON_1;
                        minyuttAddMsg14 = KBCREDITADDMSG_TOKUYAKUMONGON_2;
                        minyuttAddMsg15 = KBCREDITADDMSG_TOKUYAKUMONGON_3;
