...
import yuyu.common.hozen.ascommon.dba4edithrhnkanryotuuti.EditHrhnKanryoTuutiDao;
...
public class EditHrhnKanryoTuuti {
    ...
    private static final String  YENHRKGK_COMMENT1 = "＊保険料円貨払込特約（円貨払込額指定型）の付加された契約は、";

    private static final String YENHRKGK_COMMENT2 = "　円貨払込額（定期一括払いの場合は、定期一括払円貨払込額）について";

    private static final String YENHRKGK_COMMENT3 = "　「保険料」と表示しております。";
    ...
    private static final String  PYEN_COMMENT1 = "＊保険料は当社所定の為替レートで円換算した金額をお払い込みいただき";

    private static final String  PYEN_COMMENT2 = "　ます。";
    ...
    private String[] editHrkykkmsg(IT_KykKihon pKykKihon, EditHrhnKanryoTuutiParam pEditHrhnKanryoTuutiParam,
        ...
        hrkykkMsgList.add(YENHRKGK_COMMENT1);

        hrkykkMsgList.add(YENHRKGK_COMMENT2);

        hrkykkMsgList.add(YENHRKGK_COMMENT3);
        ...
        if (C_YennykntksyuruiKbn.PYENHRKM_GKHENDOU.eq(yennykntksyuruiKbn)) {
            ...
            hrkykkMsgList.add(PYEN_COMMENT1);

            hrkykkMsgList.add(PYEN_COMMENT2);
