...
/**
 * 契約保全 契約保全共通 保険証券TBL編集（終身）
 */
public class EditSyoukenTblSyuusin {
    ...
    private static final BizNumber YOTEIRIRITU = BizNumber.valueOf(0.0055);
    ...
    public void editTBL(IT_HokenSyouken pHokenSyouken, IT_KykKihon pKykKihon,
        ...
        if (C_MousideIkouKbn.YENSYUUSIN.eq(pSyouhnZokusei.getMousideikoukbn())) {
        ...
        if (!C_Tuukasyu.JPY.eq(pSyuKykSyouhnLst.get(0).getKyktuukasyu())) {
            ...
            getKawaseRate.exec(pKykKihon.getFstpnyknymd(),
            ...
            if (C_HknKknKbn.DAI1HKNKKN.eq(hknkknkbn)) {
                for (int n = 0; n < keikanensuuMax; n++) {
                    ...
                    calcHkShrKngk.exec(pSyuKykSyouhnLst.get(0).getSyouhncd(),
                        ...
                        calcKijyunMaeYmd, pKykKihon.getSyono(),
            ...
            dai3syenyendaka = keisanGaikakanzan.exec(C_Tuukasyu.JPY, dai3s,
                skwsrateyendaka, C_HasuusyoriKbn.AGE);

            dai3syenyenkijyun = keisanGaikakanzan.exec(C_Tuukasyu.JPY, dai3s,
                skwsrateyenkijyun, C_HasuusyoriKbn.AGE);

            dai3syenyenyasu = keisanGaikakanzan.exec(C_Tuukasyu.JPY, dai3s,
                skwsrateyenyasu, C_HasuusyoriKbn.AGE);
        ...
        if (yendthnkymd == null) {
            ...
            if (pSksyoukenskskbn == SAIHAKKOUHOKENSYOUKEN) {
        ...
        if (pSksyoukenskskbn == SINKEIYAKUHOKENSYOUKEN) {
            ...
            if (C_UmuKbn.ARI.eq(pKykSonotaTkyk.getJyudkaigomeharaitkhukaumu())) {
                ...
                if (yendthnkymd == null) {
                    ...
                    IT_KykSyouhnHnkmae kykSyouhnHnkmae = hozenDomManager
                        .getKykSyouhnHnkmaeBySyono(pKykKihon.getSyono());

                    kgmaehrtkdai1hknkknmnryymd = BizDateUtil.getDateAfterPeriod(
                        pSyuKykSyouhnLst.get(0).getKykymd(),
                        kykSyouhnHnkmae.getDai1hknkkn(), 0).getPreviousDay();
        ...
        pHokenSyouken.setHyoujiranyoteiriritu(hyoujiranyoteiriritu);
        ...
        pHokenSyouken.setSiboumidasimsgcd("12010");
        ...
        pHokenSyouken.setSiboudai3hknkknmsgcd1(siboudai3hknkknmsgcd1);

        pHokenSyouken.setSiboudai3hknkknmsgcd2(siboudai3hknkknmsgcd2);
        ...
        pHokenSyouken.setSiboudai2hknkknymdto(dai2hknkknEndYmd);

        pHokenSyouken.setSiboudai2kjnkngktuuktype(siboudai2kjnkngktuuktype);

        pHokenSyouken.setSiboudai2kjnkngk(siboudai2kjnkngk);

        pHokenSyouken.setSiboudai3kjnkngktuuktype(siboudai3kjnkngktuuktype);

        pHokenSyouken.setSiboudai3kjnkngk(siboudai3kjnkngk);
        ...
        pHokenSyouken.setDai3stuuktype(dai3stuuktype);

        pHokenSyouken.setDai3s(dai3s);

        pHokenSyouken.setDai3syentuuktype(dai3syentuuktype);

        pHokenSyouken.setDai3syenyendaka(dai3syenyendaka);

        pHokenSyouken.setDai3syenyenkijyun(dai3syenyenkijyun);

        pHokenSyouken.setDai3syenyenyasu(dai3syenyenyasu);
