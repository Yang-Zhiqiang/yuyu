...
public class KeisanHrhnNewHrkp {
    ...
    public C_ErrorKbn exec(IT_KykSyouhn pSyuKykSyouhn,
        ...
        if (C_Sdpd.PD.eq(kykKihon.getSdpdkbn())) {
            syupWk = pSyuKykSyouhn.getHokenryou().multiply(
                Integer.valueOf(pNewHrkkaisuu.getValue())).divide(
                    Integer.valueOf(pOldHrkkaisuu.getValue()), 0, RoundingMode.DOWN);
        }
        else {
