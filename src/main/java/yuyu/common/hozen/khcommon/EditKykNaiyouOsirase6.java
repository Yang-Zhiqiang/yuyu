...
/**
 * 契約保全 契約保全共通 契約内容のお知らせ編集６（JG改定外貨）
 */
public class EditKykNaiyouOsirase6 {

    private static final String IKOU_SYSN = "以降（終身）";

    private static final String AISATUMSGCD_03004 = "03004";

    private static final String HOSYOUH_HSKMSGCD_05001 = "05001";

    private static final String HOSYOUH_HSKMSGCD_05005 = "05005";

    private static final String HOSYOUH_HSKMSGCD_05020 = "05020";

    private static final String HOSYOUH_HSKMSGCD_05021 = "05021";

    private static final String HOSYOUH_HSKMSGCD_05022 = "05022";
    ...
    public ZT_GaikaKokyakuTuutiTy editInfo(
        ...
        if (C_UmuKbn.ARI.eq(kykSonotaTkyk.getYennykntkhkumu()) ||
            ...
            upsideHosyouhskmsgcdLst.add(HOSYOUH_HSKMSGCD_05001);
        }

        if (C_UmuKbn.ARI.eq(kykSonotaTkyk.getInitsbjiyensitihsytkhukaumu()) ||
            C_UmuKbn.ARI.eq(kykSonotaTkyk.getTargettkhkumu())) {
            upsideHosyouhskmsgcdLst.add(HOSYOUH_HSKMSGCD_05021);
        }
        ...
        if (C_HknKknKbn.DAI1HKNKKN.eq(hknkknkbn)) {
            downsideHosyouhskmsgcdLst.add(HOSYOUH_HSKMSGCD_05005);
        }

        downsideHosyouhskmsgcdLst.add(HOSYOUH_HSKMSGCD_05022);
        ...
        pGaikaKokyakuTuutiTyn.setZtydai2hknkkntowa(IKOU_SYSN);
        ...
        if (C_HknKknKbn.DAI2HKNKKN.eq(hknkknkbn)) {
        ...
        pGaikaKokyakuTuutiTyn.setZtyhosyouhskmsgcd4(HOSYOUH_HSKMSGCD_05020);
