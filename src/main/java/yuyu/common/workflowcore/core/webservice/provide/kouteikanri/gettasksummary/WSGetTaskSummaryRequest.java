...
/**
 * 件数サマリ照会サービスのリクエストBeanです。<br/>
 */
@SuppressWarnings("serial")
public class WSGetTaskSummaryRequest extends WSCommonRequest {

    public static final String sSERVICE_NAME = "GetTaskSummary";


    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_ACCOUNTID)
    private String sAccountid_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_WARIATEUMU)
    private String sWariateumu_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKENDUMU)
    private String sTaskendumu_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_FLOWID)
    private String sFlowid_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKID)
    private String sTaskid_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKCREATETIME_FROM)
    private String sTaskcreatetimefrom_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKCREATETIME_TO)
    private String sTaskcreatetimeto_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKSTARTTIME_FROM)
    private String sTaskstarttimefrom_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKSTARTTIME_TO)
    private String sTaskstarttimeto_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKENDTIME_FROM)
    private String sTaskendtimefrom_;

    @FormParam(IWSGetTaskSummaryIOKey.IN.sS_TASKENDTIME_TO)
    private String sTaskendtimeto_;

    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_ACCOUNTID)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_WARIATEUMU)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKENDUMU)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_FLOWID)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKID)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKCREATETIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKCREATETIME_TO)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKSTARTTIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKSTARTTIME_TO)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKENDTIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskSummaryIOKey.IN.sS_TASKENDTIME_TO)
