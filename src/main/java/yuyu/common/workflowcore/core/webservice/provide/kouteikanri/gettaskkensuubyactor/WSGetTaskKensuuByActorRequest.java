...
/**
 * ユーザ別タスク件数照会サービスのリクエストBeanです。<br/>
 */
@SuppressWarnings("serial")
public class WSGetTaskKensuuByActorRequest extends WSCommonRequest {

    public static final String sSERVICE_NAME = "GetTaskKensuuByActor";


    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_ACCOUNTID)
    private String sAccountid_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_WARIATEUMU)
    private String sWariateumu_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDUMU)
    private String sTaskendumu_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_FLOWID)
    private String sFlowid_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKID)
    private String sTaskid_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKCREATETIME_FROM)
    private String sTaskcreatetimefrom_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKCREATETIME_TO)
    private String sTaskcreatetimeto_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKSTARTTIME_FROM)
    private String sTaskstarttimefrom_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKSTARTTIME_TO)
    private String sTaskstarttimeto_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDTIME_FROM)
    private String sTaskendtimefrom_;

    @FormParam(IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDTIME_TO)
    private String sTaskendtimeto_;

    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_ACCOUNTID)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_WARIATEUMU)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDUMU)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_FLOWID)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKID)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKCREATETIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKCREATETIME_TO)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKSTARTTIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKSTARTTIME_TO)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDTIME_FROM)
    ...
    @JSONHint(name = IWSGetTaskKensuuByActorIOKey.IN.sS_TASKENDTIME_TO)
