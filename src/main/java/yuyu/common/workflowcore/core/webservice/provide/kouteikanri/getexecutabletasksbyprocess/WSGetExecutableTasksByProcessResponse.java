...
public class WSGetExecutableTasksByProcessResponse extends WSCommonResponse {
    ...
    @JSONHint(name=IWSGetExecutableTasksByProcessIOKey.OUT.sS_FLOWIDSS)
    ...
    @JSONHint(name=IWSGetExecutableTasksByProcessIOKey.OUT.sS_NODENAMES)
    ...
    @JSONHint(name=IWSGetExecutableTasksByProcessIOKey.OUT.sS_TASKCOUNTKOJINS)
    ...
    @JSONHint(name=IWSGetExecutableTasksByProcessIOKey.OUT.sS_TASKCOUNTKYOUYUUS)
