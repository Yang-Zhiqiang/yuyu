 ...
 */
public class SiSonotaSateiSbParamImpl implements SiSonotaSateiSbParam {
    ...
    public boolean isAllBlnk() {
        ...
        if ((bengosikenkaiumukbn == null || C_NoinitUmuKbn.BLNK.eq(bengosikenkaiumukbn)) &&
                (kujyouumukbn == null || C_NoinitUmuKbn.BLNK.eq(kujyouumukbn)) &&
                (jimumissumukbn == null || C_NoinitUmuKbn.BLNK.eq(jimumissumukbn)) &&
                (kyhgksitukaisouyouhikbn == null || C_NoinitYouhiKbn.BLNK.eq(kyhgksitukaisouyouhikbn))) {
            return true;
        }
        return false;
    }
