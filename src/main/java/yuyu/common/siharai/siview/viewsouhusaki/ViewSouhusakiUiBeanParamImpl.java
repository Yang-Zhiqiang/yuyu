...
/**
 * 保険金給付金支払 支払画面部品 送付先情報表示クラス <br />
 */
public class ViewSouhusakiUiBeanParamImpl implements ViewSouhusakiUiBeanParam{
    ...
    private boolean viewSouhusakiSeigyo;

    private boolean viewSouhusakiDispFlg;
    ...
    public boolean isViewSouhusakiSeigyo() {
        return viewSouhusakiSeigyo;
    }

    @Override
    public boolean isViewSouhusakiDispFlg() {
        return viewSouhusakiDispFlg;
    }
}
