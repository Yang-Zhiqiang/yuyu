package yuyu.common.siharai.siview.viewippanhantei;
/**
 * 保険金給付金支払 支払画面部品 一般判定クラス <br />
 */
public class ViewIppanhanteiUiBeanParamImpl implements ViewIppanhanteiUiBeanParam{
    ...
    private boolean viewIppanhanteiFlg;

    private boolean viewIppanhanteiSeigyo;

    private boolean viewIppanhanteiDispFlg;
    ...
    public boolean isViewIppanhanteiFlg() {
        return viewIppanhanteiFlg;
    }

    @Override
    public boolean isViewIppanhanteiSeigyo() {
        return viewIppanhanteiSeigyo;
    }
