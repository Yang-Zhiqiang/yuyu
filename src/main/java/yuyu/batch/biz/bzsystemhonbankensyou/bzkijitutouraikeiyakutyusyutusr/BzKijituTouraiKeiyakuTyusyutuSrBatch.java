package yuyu.batch.biz.bzsystemhonbankensyou.bzkijitutouraikeiyakutyusyutusr;
...
/**
 * 業務共通 システム本番検証用 期日到来契約抽出（数理）
 */
public class BzKijituTouraiKeiyakuTyusyutuSrBatch implements Batch {

    public static final String SUBSYSTEMID_SUURI  = "suuri";
    ...
    //    @Inject
    //    private BzKijituTouraiKeiyakuTyusyutuSrDao bzkijituTouraiKeiyakuTyusyutuSrDao;
    ...
    public void execute() {
        ...
        //        try (
        //            ExDBResults<BzKijituTouraiKeiyakuTyusyutuSrBean> kijituTouraiKeiyakuTyusyutuList =
        //            bzkijituTouraiKeiyakuTyusyutuSrDao.getKijituTouraiKeiyakuTyusyutuInfos();
        //            MultipleEntityInserter multipleEntityInserter = new MultipleEntityInserter();) {
        //
        //            for (KijituTouraiKeiyakuTyusyutuSrBean kijituTouraiKeiyakuTyusyutuBean : kijituTouraiKeiyakuTyusyutuList) {
        //
        //                BT_KijituTouraiHonbanKensyou kijituTouraiHonbanKensyou = new BT_KijituTouraiHonbanKensyou();
        //                kijituTouraiHonbanKensyou.setSubSystemId(SUBSYSTEMID_SUURI);
        ...
        batchLogger.info(MessageUtil.getMessage(MessageId.IBF0002, String.valueOf(syoriCount), "数理統計"));
    }
