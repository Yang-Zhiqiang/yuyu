package yuyu.batch.biz.bzsystemhonbankensyou.bzkijitutouraikeiyakutyusyutuds;
...
/**
 * 業務共通 システム本番検証用 期日到来契約抽出（ダイレクトサービス）
 */
public class BzKijituTouraiKeiyakuTyusyutuDsBatch implements Batch {

    public static final String SUBSYSTEMID_DIRECT  = "direct";
    ...
    //    @Inject
    //    private BzKijituTouraiKeiyakuTyusyutuDsDao bzkijituTouraiKeiyakuTyusyutuDsDao;
    ...
    public void execute() {
        ...
        //        try (
        //            ExDBResults<BzKijituTouraiKeiyakuTyusyutuDsBean> kijituTouraiKeiyakuTyusyutuList =
        //            bzkijituTouraiKeiyakuTyusyutuDsDao.getKijituTouraiKeiyakuTyusyutuInfos();
        //            MultipleEntityInserter multipleEntityInserter = new MultipleEntityInserter();) {
        //
        //            for (BzKijituTouraiKeiyakuTyusyutuDsBean kijituTouraiKeiyakuTyusyutuBean : kijituTouraiKeiyakuTyusyutuList) {
        //
        //                BT_KijituTouraiHonbanKensyou kijituTouraiHonbanKensyou = new BT_KijituTouraiHonbanKensyou();
        //                kijituTouraiHonbanKensyou.setSubSystemId(SUBSYSTEMID_DIRECT);
        ...
        batchLogger.info(MessageUtil.getMessage(MessageId.IBF0002, String.valueOf(syoriCount), "ダイレクトサービス"));
    }
