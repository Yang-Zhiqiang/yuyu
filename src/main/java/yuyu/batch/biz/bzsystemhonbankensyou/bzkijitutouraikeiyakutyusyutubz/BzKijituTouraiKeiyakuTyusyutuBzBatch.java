package yuyu.batch.biz.bzsystemhonbankensyou.bzkijitutouraikeiyakutyusyutubz;
...
/**
 * 業務共通 システム本番検証用 期日到来契約抽出（業務共通）
 */
public class BzKijituTouraiKeiyakuTyusyutuBzBatch implements Batch {

    public static final String SUBSYSTEMID_BIZ  = "biz";
    ...
    //    @Inject
    //    private BzKijituTouraiKeiyakuTyusyutuBzDao bzkijituTouraiKeiyakuTyusyutuBzDao;
    ...
    public void execute() {
        ...
        //        try (
        //            ExDBResults<BzKijituTouraiKeiyakuTyusyutuBzBean> kijituTouraiKeiyakuTyusyutuList =
        //            bzkijituTouraiKeiyakuTyusyutuBzDao.getKijituTouraiKeiyakuTyusyutuInfos();
        //            MultipleEntityInserter multipleEntityInserter = new MultipleEntityInserter();) {
        //
        //            for (BzKijituTouraiKeiyakuTyusyutuBzBean kijituTouraiKeiyakuTyusyutuBean : kijituTouraiKeiyakuTyusyutuList) {
        //
        //                BT_KijituTouraiHonbanKensyou kijituTouraiHonbanKensyou = new BT_KijituTouraiHonbanKensyou();
        //                kijituTouraiHonbanKensyou.setSubSystemId(SUBSYSTEMID_BIZ);
        ...
        batchLogger.info(MessageUtil.getMessage(MessageId.IBF0002, String.valueOf(syoriCount), "業務共通"));
    }
