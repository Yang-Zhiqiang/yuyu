package yuyu.batch.biz.bzsystemhonbankensyou.bzkijitutouraikeiyakutyusyutukh;
...
/**
 * 業務共通 システム本番検証用 期日到来契約抽出（契約保全）
 */
public class BzKijituTouraiKeiyakuTyusyutuKhBatch implements Batch {

    public static final String SUBSYSTEMID_HOZEN  = "hozen";
    ...
    //    @Inject
    //    private BzKijituTouraiKeiyakuTyusyutuKhDao bzkijituTouraiKeiyakuTyusyutuKhDao;
    ...
    public void execute() {
        ...
        //        try (
        //            ExDBResults<BzKijituTouraiKeiyakuTyusyutuKhBean> kijituTouraiKeiyakuTyusyutuList =
        //            bzkijituTouraiKeiyakuTyusyutuKhDao.getKijituTouraiKeiyakuTyusyutuInfos();
        //            MultipleEntityInserter multipleEntityInserter = new MultipleEntityInserter();) {
        //
        //            for (BzKijituTouraiKeiyakuTyusyutuKhBean kijituTouraiKeiyakuTyusyutuBean : kijituTouraiKeiyakuTyusyutuList) {
        //
        //                BT_KijituTouraiHonbanKensyou kijituTouraiHonbanKensyou = new BT_KijituTouraiHonbanKensyou();
        //                kijituTouraiHonbanKensyou.setSubSystemId(SUBSYSTEMID_HOZEN);
        ...
        batchLogger.info(MessageUtil.getMessage(MessageId.IBF0002, String.valueOf(syoriCount), "契約保全"));
    }
}
