...
public class FilterAnsyuRireki1  implements Predicate<IT_AnsyuRireki> {
    ...
    public boolean apply(IT_AnsyuRireki pAnsyuRireki) {
        if (nyknaiyoukbn.eq(pAnsyuRireki.getNyknaiyoukbn())
            ...
            && ((C_Nykkeiro.KZHRK.eq(pAnsyuRireki.getNykkeiro()) && BizDateUtil.compareYmd(ryosyuymd,
                pAnsyuRireki.getHurikaeymd()) == BizDateUtil.COMPARE_EQUAL) || (C_Nykkeiro.CREDIT.eq(pAnsyuRireki
                    .getNykkeiro()) && BizDateUtil.compareYmd(ryosyuymd,
