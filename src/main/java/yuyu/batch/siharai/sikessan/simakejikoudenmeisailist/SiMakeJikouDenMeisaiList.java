...
/**
 * 保険金給付金支払 決算 時効伝票明細リスト作成
 */
public class SiMakeJikouDenMeisaiList implements Batch {
    ...
    public void execute() {
        ...
        try(ExDBResults<JT_SiBikinkanri> siBikinkanriList = siharaiDomManager.
            ...
            if (siBikinkanriIter.hasNext()) {
                ...
                while (siBikinkanriIter.hasNext()) {
                    ...
                    if (outputCount == 0) {
                        ...
                        if (!hokensyuruiKey.equals(siBikinkanri.getKbnkeirisegcd().getValue()) ||
                            ...
                            siJikouDenMeisaiListDataSourceBean_last.setIrGoukeikrkgk(convCurrency(
                                bubunSyukeiBean.getGoukeikrkgk()));
                            siJikouDenMeisaiListDataSourceBean_last.setIrGoukeizatusyunyukgk(convCurrency(
                    ...
                    siJikouDenMeisaiListDataSourceBean.setIrKrkgkstr(convCurrency(krkkgk));
                    siJikouDenMeisaiListDataSourceBean.setIrZatusyunyukgk(convCurrency(zatusyunyukgk));
                ...
                siJikouDenMeisaiListDataSourceBean.setIrGoukeikrkgk(convCurrency(
                    zenkenSyukeiBean.getGoukeikrkgk()));
                siJikouDenMeisaiListDataSourceBean.setIrGoukeizatusyunyukgk(convCurrency(
    ...
    private String convCurrency(BizCurrency pCurrency){
        if(pCurrency.compareTo(BizCurrency.valueOf(0, pCurrency.getType())) > 0){
            return String.valueOf(pCurrency);
        }
        return "";
    }
}
