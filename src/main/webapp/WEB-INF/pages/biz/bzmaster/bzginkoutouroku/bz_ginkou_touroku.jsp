...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/biz/bzmaster/bzginkoutouroku/BzGinkouTouroku.do">
        ...
        <swak:group id="searchConditions">
          <swak:item id="banktrktaisyoukbn" />
        </swak:group>
        ...
        <swak:group id="ginkouInfo">
          ...
          <swak:item id="banknmkn" />
        </swak:group>

        <%-- 支店情報 --%>
        <swak:group id="sitenInfo">
          <swak:item id="sitencd" />
          <swak:item id="sitennmkj" />
          <swak:item id="sitennmkn" />
        </swak:group>
