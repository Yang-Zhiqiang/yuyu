...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/biz/bzkensaku/bzsrchginkousiten/BzSrchGinkouSiten.do">
        ...
        <swak:group id="searchConditions">
          ...
          <swak:item id="srchsitencd" />
          <swak:item id="srchbanknmkn" />
          <swak:item id="srchsitennmkn" />
          <swak:item id="srchbanknmkj" />
          <swak:item id="srchsitennmkj" />
        </swak:group>
