...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khmkhgkhenkou/KhMkhgkHenkou.do">
        ...
        <%-- ●目標額変更内容 --%>
        <swak:group id="mkhgkhenkouInfo">
          <swak:item id="syoruiukeymd" />
        </swak:group>

        <%-- 目標額割合内容 --%>
        <swak:group id="mkhgkInfo">
          <swak:item id="dispbfrtargettkmokuhyouti" />
