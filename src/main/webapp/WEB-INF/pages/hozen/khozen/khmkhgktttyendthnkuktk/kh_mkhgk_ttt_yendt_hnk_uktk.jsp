...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khmkhgktttyendthnkuktk/KhMkhgkTttYendtHnkUktk.do">
        ...
        <swak:group id="searchConditions">
          <swak:item id="syoukaiymdfrom" />
          <swak:item id="syoukaiymdto" />
          <swak:item id="IIF1012" />
        </swak:group>
        ...
        <%-- ●目標額到達内容 --%>
        <swak:group id="mkhgktttNaiyou">
          <swak:item id="mkhgktttymd" />
          <swak:item id="mkhgktttkaiyakuhr" />
          <swak:item id="yendthnksbhokenkngk" />
          <swak:item id="yendthnkkaiyakuhrgk" />
          <swak:item id="yendthnkhrgk" />
