...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khseinengappiseiteisei/KhSeinengappiSeiTeisei.do">
        ...
        <%-- ●被保険者訂正入力 --%>
        <swak:group id="hhknTeiseiInfo">
          <swak:item id="newhhknnmkn" />
          <swak:item id="newhhknnmkj" />
          <swak:item id="newhhknnmkjkhukakbn" />
          <swak:item id="newhhknseiymd" />
          <swak:item id="newhhknsei" />
        </swak:group>

        <%-- ●契約変更後内容 --%>
        <swak:group id="kykHenkouNaiyouInfo">
          <swak:item id="newsyusyouhnnm" />
          <swak:item id="newsyukihons" />
          <swak:item id="newsyuhhknnen" />
          <swak:item id="newsyup" />
          <swak:item id="newsyukjnkngk" />
        </swak:group>

        <%-- 　＜特約＞ --%>
        <swak:group id="tokuyakuInfo1">
          <swak:item id="newtksyouhnnm1" />
          <swak:item id="dispnewtkp1" />
          <swak:item id="dispnewtkhhknnen1" />
          <swak:item id="dispnewtknextkosgop1" />
        </swak:group>

        <%-- tokuyakuInfo2 --%>
        <swak:group id="tokuyakuInfo2">
          <swak:item id="newtksyouhnnm2" />
          <swak:item id="dispnewtkp2" />
          <swak:item id="dispnewtkhhknnen2" />
          <swak:item id="dispnewtknextkosgop2" />
        </swak:group>

        <%-- tokuyakuInfo3 --%>
        <swak:group id="tokuyakuInfo3">
          <swak:item id="newtksyouhnnm3" />
          <swak:item id="dispnewtkp3" />
          <swak:item id="dispnewtkhhknnen3" />
          <swak:item id="dispnewtknextkosgop3" />
        </swak:group>

        <%-- tokuyakuInfo4 --%>
        <swak:group id="tokuyakuInfo4">
          <swak:item id="newtksyouhnnm4" />
          <swak:item id="dispnewtkp4" />
          <swak:item id="dispnewtkhhknnen4" />
          <swak:item id="dispnewtknextkosgop4" />
        </swak:group>

        <%-- tokuyakuInfo5 --%>
        <swak:group id="tokuyakuInfo5">
          <swak:item id="newtksyouhnnm5" />
          <swak:item id="dispnewtkp5" />
          <swak:item id="dispnewtkhhknnen5" />
          <swak:item id="dispnewtknextkosgop5" />
        </swak:group>

        <%-- tokuyakuInfo6 --%>
        <swak:group id="tokuyakuInfo6">
          <swak:item id="newtksyouhnnm6" />
          <swak:item id="dispnewtkp6" />
          <swak:item id="dispnewtkhhknnen6" />
          <swak:item id="dispnewtknextkosgop6" />
        </swak:group>

        <%-- tokuyakuInfo7 --%>
        <swak:group id="tokuyakuInfo7">
          <swak:item id="newtksyouhnnm7" />
          <swak:item id="dispnewtkp7" />
          <swak:item id="dispnewtkhhknnen7" />
          <swak:item id="dispnewtknextkosgop7" />
        </swak:group>

        <%-- tokuyakuInfo8 --%>
        <swak:group id="tokuyakuInfo8">
          <swak:item id="newtksyouhnnm8" />
          <swak:item id="dispnewtkp8" />
          <swak:item id="dispnewtkhhknnen8" />
          <swak:item id="dispnewtknextkosgop8" />
        </swak:group>

        <%-- tokuyakuInfo9 --%>
        <swak:group id="tokuyakuInfo9">
          <swak:item id="newtksyouhnnm9" />
          <swak:item id="dispnewtkp9" />
          <swak:item id="dispnewtkhhknnen9" />
          <swak:item id="dispnewtknextkosgop9" />
        </swak:group>

        <%-- tokuyakuInfo10 --%>
        <swak:group id="tokuyakuInfo10">
          <swak:item id="newtksyouhnnm10" />
          <swak:item id="dispnewtkp10" />
          <swak:item id="dispnewtkhhknnen10" />
          <swak:item id="dispnewtknextkosgop10" />
        </swak:group>

        <%-- ●追加払込金 --%>
        <swak:group id="tuikahrkkinInfo">
          <swak:item id="tuikahrkkinkyktuuka" />
        </swak:group>

        <%-- ●追加払込金 --%>
        <swak:group id="tuikahrkkinInfo2">
          <swak:item id="tuikahrkkinbfrkkt" />
        </swak:group>

        <%-- ●追加払込金 --%>
        <swak:group id="tuikahrkkinInfo3">
          <swak:item id="tuikahrkkinaftkkt" />
          <swak:item id="tuikahrkkingaika" />
        </swak:group>

        <%-- 入金時為替レート --%>
        <swak:group id="nyknjikwsrateInfo">
          <swak:item id="tkhrkkinnyknratetkyymd" />
          <swak:item id="tkhrkkinyennyknrate" />
          <swak:item id="tkhrkkinkyktuukasyu" />
        </swak:group>
        ...
        <swak:group id="shrgkkeiInfo">
          <swak:item id="henkankkyktuuka" />
        </swak:group>

        <%-- 返還金情報 --%>
        <swak:group id="henkankInfo">
          <swak:item id="henkankyen" />
          <swak:item id="henkankgaika" />
        </swak:group>

        <%-- 支払時為替レート --%>
        <swak:group id="shrkwsrateInfo">
          <swak:item id="henkankyenshrratetekiymd" />
          <swak:item id="henkankyenshrrate" />
          <swak:item id="henkankkyktuukasyu" />
        </swak:group>
        ...
        <%-- ●発送区分 --%>
        <swak:group id="hassoukbnInfo">
          <swak:item id="hassoukbn" />
        </swak:group>

        <%-- ●結果入力 --%>
        <swak:group id="kekkainputInfo">
        ...
        <swak:buttonGroup id="footerButtons2">
          ...
          <swak:item id="syoukaibtnbyinputcontents" />
        </swak:buttonGroup>
