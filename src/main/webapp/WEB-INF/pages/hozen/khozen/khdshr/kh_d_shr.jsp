...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khdshr/KhDShr.do">
        ...
        <swak:group id="skNaiyouInfo">
          <swak:item id="haitoukinskkbn" />
          <swak:item id="inputhaitoukinskkngk" />
          <swak:item id="IIF1016" />
          <swak:item id="haitoukinskkngk" />
        </swak:group>
        ...
        <swak:group id="siharaiNaiyouInfoGk">
          ...
          <swak:item id="tumitatehaitouganrikin2" />
          <swak:item id="disptienrskkisanymdnissuu" />
          <swak:item id="shrtienrsk" />
          <swak:item id="shrtmtthtkinzndk" />
        </swak:group>
