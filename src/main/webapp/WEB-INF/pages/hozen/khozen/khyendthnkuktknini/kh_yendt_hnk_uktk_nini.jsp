...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khyendthnkuktknini/KhYendtHnkUktkNini.do">
        ...
        <%-- ●その他特約・特則（変更後） --%>
        <swak:group id="newsonotaTkInfo">
          <swak:item id="yendthnktkhukainfo" />
        </swak:group>

        <%-- ●円建変更後内容 --%>
        <swak:group id="yendthnkInfo">
          <swak:item id="syoruiukeymd" />
        </swak:group>

        <%-- yendthnkInfo2 --%>
        <swak:group id="yendthnkInfo2">
          <swak:item id="yendthnkymd" />
          <swak:item id="yendthnkkjnkngk" />
        </swak:group>

        <%-- ●年金開始時点の年金原資 --%>
        <swak:group id="nenkinkaisijitennkgns">
          <swak:item id="nkgnsgk" />
        </swak:group>

        <%-- ●円建変更時点の保障内容 --%>
        <swak:group id="yendthnkjitenhosyouInfo">
          <swak:item id="yendthnkptumitatekin" />
          <swak:item id="yendthnksbhokenkngk" />
          <swak:item id="yendthnkkaiyakuhrgk" />
        </swak:group>
        ...
        <%-- ●本人確認 --%>
        <swak:group id="honninKakunin">
          <swak:item id="honninkakninkekkakbn" />
        </swak:group>

        <%-- ●発送区分 --%>
        <swak:group id="hassouKubun">
