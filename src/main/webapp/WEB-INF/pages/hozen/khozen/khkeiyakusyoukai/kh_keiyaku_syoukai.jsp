...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khkeiyakusyoukai/KhKeiyakuSyoukai.do">
        ...
        <swak:buttonGroup id="headerButtons1">
          ...
          <swak:item id="ttdkrrkbtnbykeiyakunaiyou" />
          <swak:item id="nkrrkbtnbykeiyakunaiyou" />
          <swak:item id="tmttknrrkbtnbykeiyakunaiyou" />
          <swak:item id="kyknysrssksbtnbykykny" />
        </swak:buttonGroup>

        <%-- headerButtons6 --%>
        <swak:buttonGroup id="headerButtons6">
          <swak:item id="syrkiykhkbtnbykeiyakunaiyou" />
          <swak:item id="kaiyakubtnbykeiyakunaiyou" />
        </swak:buttonGroup>

        <%-- headerButtons2 --%>
        <swak:buttonGroup id="headerButtons2">
          <swak:item id="kyknaiyoubtnbyttdkrireki" />
          <swak:item id="ttdkrirekibtnbyttdkrireki" />
          <swak:item id="nkrrkbtnbyttdkrireki" />
          <swak:item id="tmttknrrkbtnbyttdkrireki" />
          <swak:item id="kyknysrssksbtnbyttdkrrk" />
        </swak:buttonGroup>

        <%-- headerButtons7 --%>
        <swak:buttonGroup id="headerButtons7">
          <swak:item id="syrkiykhkbtnbyttdkrireki" />
          <swak:item id="kaiyakubtnbyttdkrireki" />
        </swak:buttonGroup>

        <%-- headerButtons3 --%>
        <swak:buttonGroup id="headerButtons3">
          <swak:item id="kyknaiyoubtnbynyuukinrireki" />
          <swak:item id="ttdkrrkbtnbynyuukinrireki" />
          <swak:item id="nkrrkbtnbynyuukinrireki" />
          <swak:item id="tmttknrrkbtnbynyuukinrireki" />
          <swak:item id="kyknysrssksbtnbynyknrrk" />
        </swak:buttonGroup>

        <%-- headerButtons8 --%>
        <swak:buttonGroup id="headerButtons8">
          <swak:item id="syrkiykhkbtnbynyuukinrireki" />
          <swak:item id="kaiyakubtnbynyuukinrireki" />
        </swak:buttonGroup>

        <%-- headerButtons5 --%>
        <swak:buttonGroup id="headerButtons5">
          <swak:item id="kyknaiyoubtnbytmttknrireki" />
          <swak:item id="ttdkrrkbtnbytmttknrireki" />
          <swak:item id="nkrrkbtnbytmttknrireki" />
          <swak:item id="tmttknrrkbtnbytmttknrireki" />
          <swak:item id="kyknysrssksbtntmttknrrk" />
        </swak:buttonGroup>

        <%-- headerButtons9 --%>
        <swak:buttonGroup id="headerButtons9">
          <swak:item id="syrkiykhkbtnbytmttknrireki" />
          <swak:item id="kaiyakubtnbytmttknrireki" />
        </swak:buttonGroup>

        <%-- linkButtons1 --%>
        <swak:buttonGroup id="linkButtons1">
          <swak:item id="kihonjouhoubtn" />
          <swak:item id="ttdktyuuijouhoubtn" />
          <swak:item id="keiyakusyajouhoubtn" />
          <swak:item id="tusinsakijouhoubtn" />
          <swak:item id="hihokensyajouhoubtn" />
          <swak:item id="hosyoujouhoubtn" />
          <swak:item id="sonotatokuyakubtn" />
        </swak:buttonGroup>

        <%-- linkButtons2 --%>
        <swak:buttonGroup id="linkButtons2">
          <swak:item id="haraikomijouhoubtn" />
          <swak:item id="tokusinjouhoubtn" />
          <swak:item id="kariukekinjouhoubtn" />
          <swak:item id="dattaiouhoubtn" />
          <swak:item id="haitoukinjouhoubtn" />
          <swak:item id="uketorininbtn" />
          <swak:item id="trkkzkbtn" />
        </swak:buttonGroup>

        <%-- linkButtons3 --%>
        <swak:buttonGroup id="linkButtons3">
          <swak:item id="kykdairininbtn" />
          <swak:item id="siteidairininbtn" />
          <swak:item id="siharaisakikouzajouhoubtn" />
          <swak:item id="dairitenjouhoubtn" />
          <swak:item id="syhenkouyjouhoubtn" />
        </swak:buttonGroup>
        ...
        <swak:group id="kihonInfo">
          ...
          <swak:item id="dispjkipjytym" />
          <swak:item id="nextannaiyoteiymd" />
          <swak:item id="hrkkjt" />
          <swak:item id="yykknmnryymd" />
        </swak:group>

        <%-- 約款情報 --%>
        <swak:group id="yakkanInfo">
          <swak:item id="yakkanjyuryouhoukbn" />
          <swak:item id="yakkanbunsyono" />
          <swak:item id="pyentuthoukbn" />
        </swak:group>

        <%-- 法定貯蓄性情報 --%>
        <swak:group id="houteityotkseiInfo">
          <swak:item id="houteityotkseiumu" />
        </swak:group>

        <%-- 登録家族通知情報 --%>
        <swak:group id="kzkatesouhusakiInfo">
          <swak:item id="kzkatesouhusaki1" />
          <swak:item id="kzkatesouhusaki2" />
        </swak:group>
        ...
        <swak:buttonGroup id="headerButtons4">
          <swak:item id="kyknaiyoubtnbyinputkey" />
          <swak:item id="ttdkrirekibtnbyinputkey" />
          <swak:item id="nyuukinrirekibtnbyinputkey" />
          <swak:item id="tmttknrrkbtnbyinputkey" />
        </swak:buttonGroup>

        <%-- ●検索条件指定 --%>
        <swak:group id="searchConditions">
          <swak:item id="srchkykym" />
          <swak:item id="srchdrtencd" />
          <swak:item id="srchyuukousyoumetukbn" />
          <swak:item id="srchkyknmkn" />
          <swak:item id="srchkyknmkj" />
          <swak:item id="srchkykseiymd" />
          <swak:item id="srchtsinyno" />
          <swak:item id="srchtelno" />
          <swak:item id="srchhhknnmkn" />
          <swak:item id="srchhhknnmkj" />
          <swak:item id="srchhhknseiymd" />
        </swak:group>

        <%-- kensakuResultInfo --%>
        <swak:dataTable id="kensakuResultInfo">
          <swak:column id="dispsyono" />
          <swak:column id="dispkyknmkn" />
          <swak:column id="disptsintelno" />
          <swak:column id="dispkykseiymd" />
          <swak:column id="dispsyouhnnm" />
          <swak:column id="dispkyknmkj" />
          <swak:column id="disphhknnmkn" />
          <swak:column id="dispdai2tsintelno" />
          <swak:column id="disphhknseiymd" />
          <swak:column id="dispyuukousyoumetukbn" />
          <swak:column id="disphhknnmkj" />
        </swak:dataTable>
        <swak:pager id="kensakuResultInfoDataSource" />
        ...
        <%-- ●配当金情報 --%>
        <swak:group id="haitoukinInfo">
          <swak:item id="vhthaitoukinuketorihoukbn" />
          <swak:item id="vhthaitounendo" />
          <swak:item id="vhttounendod" />
          <swak:item id="vhtnaiteikakuteikbn" />
          <swak:item id="vhttumitatenendo" />
          <swak:item id="vhttumitated" />
          <swak:item id="vhttumitatedtumitateymd" />
          <swak:item id="vhttumitatedshrkrkymd" />
        </swak:group>
        ...
        <%-- ●継続年金受取人 --%>
        <swak:group id="keizokuNkuktInfo">
        ...
        <%-- ●定期支払金支払先口座 --%>
        <swak:group id="viewKhTkshrSiharaiKouzaInfo">
          <swak:item id="vktikskzkzsyuruikbn" />
          <swak:item id="vktikskzbankcd" />
          <swak:item id="vktikskzbanknmkj" />
          <swak:item id="vktikskzsitencd" />
          <swak:item id="vktikskzsitennmkj" />
          <swak:item id="vktikskzyokinkbn" />
          <swak:item id="vktikskzkouzano" />
          <swak:item id="vktikskzkzmeiginmkn" />
        </swak:group>
        ...
        <%-- ●最終変更 --%>
        <swak:group id="saisyuhenkoInfo">
          <swak:item id="lastmeihenymd" />
          <swak:item id="lastjyuuhenymd" />
          <swak:item id="displastsyosaihkymd" />
        </swak:group>

        <%-- saisyuhenkoInfo2 --%>
        <swak:group id="saisyuhenkoInfo2">
          <swak:item id="syhenkouymd" />
          <swak:item id="kinouNm" />
          <swak:item id="kosid" />
          <swak:item id="kostime" />
        </swak:group>

        <%-- tetudukiRirekiList --%>
        <swak:dataTable id="tetudukiRirekiList">
          <swak:column id="dispsyoriymd" />
          <swak:column id="dispsyorinaiyou" />
          <swak:column id="dispsyorisosikinm" />
          <swak:column id="dispsyoritntnmkj" />
          <swak:column id="hyoujilink1" />
        </swak:dataTable>
        <swak:pager id="tetudukiRirekiListDataSource" />

        <%-- tetudukiRirekiInfo --%>
        <swak:group id="tetudukiRirekiInfo">
          <swak:item id="syoriYmd" />
          <swak:item id="syorisosikinm" />
          <swak:item id="syorinaiyou" />
          <swak:item id="syoritntnmkj" />
        </swak:group>

        <%-- ●変更内容 --%>
        <swak:dataTable id="henkounaiyouList">
          <swak:column id="disphnkkbn" />
          <swak:column id="disphanbetukoumokunm" />
          <swak:column id="disphenkoukoumokunm" />
          <swak:column id="dispbfrnaiyou" />
          <swak:column id="dispnewnaiyou" />
        </swak:dataTable>

        <%-- ●新契約者通信先 --%>
        <swak:group id="sinkykTsintelInfo">
        ...
        <%-- ●追加払込金 --%>
        <swak:group id="tuikahrkkinInfo">
          <swak:item id="dispyentuikahrkkin" />
          <swak:item id="disptuikahrkkin" />
        </swak:group>

        <%-- 追加払込金為替レート --%>
        <swak:group id="tuikahrkkinwsrateInfo">
          <swak:item id="dispnyknjikwsratetkyymd" />
          <swak:item id="dispnyknjikwsrate" />
          <swak:item id="kyktuukasyu" />
        </swak:group>

        <%-- ●支払内容 --%>
        <swak:group id="shrNaiyouSyoruiUkeInfo">
        ...
        <%-- ●支払額合計1 --%>
        <swak:group id="shrgkkeiInfo1">
          <swak:item id="nykntuukashrgkgoukeikakunin" />
          <swak:item id="kihrkmp" />
          <swak:item id="keitorikrkgk" />
        </swak:group>

        <%-- 返還金 --%>
        <swak:group id="henkankInfo">
          <swak:item id="yenhenkank" />
          <swak:item id="henkank" />
        </swak:group>

        <%-- ●支払額合計3 --%>
        <swak:group id="shrgkkeiInfo3">
          <swak:item id="shrgkkei" />
          <swak:item id="tumitatehaitouganrikin" />
          <swak:item id="disphaitttienrskksnbinissuu" />
          <swak:item id="haitshrtienrsk" />
        </swak:group>

        <%-- ●支払額合計（外貨） --%>
        <swak:group id="shrgkkeigaikaInfo">
          <swak:item id="shrgkgoukeikakunin" />
          <swak:item id="ptumitatekin" />
          <swak:item id="kaiyakuhr" />
          <swak:item id="mikeikap" />
          <swak:item id="zennouseisankin" />
          <swak:item id="azukarikinkykhnkkaiyakuhr" />
          <swak:item id="sonotashrgk" />
          <swak:item id="gstszeigk" />
          <swak:item id="disptienrskkisanymdnissuu" />
          <swak:item id="shrtienrsk" />
        </swak:group>

        <%-- ＜その他支払金額（外貨支払）の詳細＞ --%>
        <swak:group id="sntshrgksssonotashrgkInfo">
          <swak:item id="sntshrgksssonotashrgk" />
        </swak:group>

        <%-- その他支払金額詳細の支払時為替レート --%>
        <swak:group id="sntshrgksssiharaiWaseRate">
          <swak:item id="sntshrgkssgikshrratetekiymd" />
          <swak:item id="sntshrgkssgikshrrate" />
          <swak:item id="sntshrgkssgikshrkyktuukasyu" />
        </swak:group>

        <%-- その他支払金額詳細の情報 --%>
        <swak:group id="sntshrgkssyensonotashrgkInfo">
          <swak:item id="sntshrgkssyensonotashrgk" />
          <swak:item id="sntshrgkssyenkamikeikap" />
          <swak:item id="sntshrgkssyenzennousisnkgk" />
          <swak:item id="sntshrgkssyenazukarikin" />
          <swak:item id="sntshrgkssyenhaitoukin" />
          <swak:item id="sntshrgkssyentkbthaitoukin" />
          <swak:item id="sntshrgkssyenkakrkgk" />
        </swak:group>

        <%-- ●支払額合計（円貨） --%>
        <swak:group id="shrgkkeienkaInfo">
          <swak:item id="jpyshrgkgoukeikakunin" />
          <swak:item id="jpyptumitatekin" />
          <swak:item id="jpykaiyakuhr" />
          <swak:item id="yenkamikeikap" />
          <swak:item id="yenkazennouseisankgk" />
          <swak:item id="yenkaazukarikingk" />
          <swak:item id="yenkahaitoukin" />
          <swak:item id="yentkbthaitoukin" />
          <swak:item id="yenkakrkgk" />
          <swak:item id="jpygstszeigk" />
          <swak:item id="dispjptienrskkisanymdnissuu" />
          <swak:item id="jpyshrtienrsk" />
        </swak:group>

        <%-- ＜円支払額の詳細＞ --%>
        <swak:group id="siharaisyousaiInfo">
          <swak:item id="shrsyousaikaiyakuhr" />
          <swak:item id="shrsyousaijpykaiyakuhr" />
          <swak:item id="shrsyousaiptumitatekin" />
          <swak:item id="shrsyousaijpyptumitatekin" />
        </swak:group>

        <%-- 支払時為替レート --%>
        <swak:group id="rateiInfo">
          <swak:item id="yenshrratetekiymd" />
          <swak:item id="yenshrrate" />
          <swak:item id="shrkyktuukasyu" />
        </swak:group>

        <%-- ＜解約返戻金等合計の詳細＞ --%>
        <swak:group id="yenkiykhrssInfo">
          <swak:item id="yenkiykhrssyenkiykhrgoukei" />
        </swak:group>

        <%-- 解約返戻金（円貨支払）の支払時為替レート --%>
        <swak:group id="yenkiykhrssshrkwsrateInfo">
          <swak:item id="yenkiykhrssyenshrratetkymd" />
          <swak:item id="yenkiykhrssyenshrratete" />
          <swak:item id="yenkiykhrssshrkyktuukasyu" />
        </swak:group>

        <%-- 解約返戻金（円貨支払）の解約返戻金合計 --%>
        <swak:group id="yenkiykhrssgoukeiInfo">
          <swak:item id="yenkiykhrsskaiyakuhrgoukei" />
          <swak:item id="yenkiykhrsskaiyakuhryen" />
          <swak:item id="yenkiykhrssmikeikap" />
          <swak:item id="yenkiykhrsszennouseisankin" />
          <swak:item id="yenkiykhrsskykhnkkaiyakuhr" />
        </swak:group>

        <%-- ＜保険料積立金等合計の詳細＞ --%>
        <swak:group id="yenptmttssInfo">
          <swak:item id="yenptmttssyenptmttgoukei" />
        </swak:group>

        <%-- 円貨保険料積立金詳細の支払時為替レート --%>
        <swak:group id="yenptmttsssiharaiWaseRate">
          <swak:item id="yenptmttssyenshrratetkymd" />
          <swak:item id="yenptmttssyenshrratete" />
          <swak:item id="yenptmttssshrkyktuukasyu" />
        </swak:group>

        <%-- 円貨保険料積立金詳細の保険料積立金合計 --%>
        <swak:group id="yenptmttssGoukeiInfo">
          <swak:item id="yenptmttssptumitategoukei" />
          <swak:item id="yenptmttssptumitate" />
          <swak:item id="yenptmttssmikeikap" />
          <swak:item id="yenptmttsszennouseisankin" />
          <swak:item id="yenptmttsskykhnkkaiyakuhr" />
        </swak:group>

        <%-- 支払額合計 --%>
        <swak:group id="shrgkkeiInfo">
          <swak:item id="yendthnkshrgkgoukei" />
          <swak:item id="yendthnkkaiyakuhr" />
          <swak:item id="yendthnkptumitatekin" />
          <swak:item id="yendthnkmikeikap" />
          <swak:item id="yendthnkzennouseisankin" />
          <swak:item id="yendthnkhr" />
          <swak:item id="yendthnkhaitoukin" />
          <swak:item id="yendthnktkbthaitoukin" />
          <swak:item id="yendthnkkrkgk" />
          <swak:item id="sonotaseisan" />
          <swak:item id="yendthnkgstszeigk" />
          <swak:item id="dispyendttienrskksnbinissuu" />
          <swak:item id="yendthnkshrtienrsk" />
        </swak:group>

        <%-- ＜解約返戻金の詳細＞ --%>
        <swak:group id="kaiyakuhrsyousaiInfo">
          <swak:item id="kiykhrsyousaikaiyakuhr" />
          <swak:item id="kiykhrsyousaiptumitatekin" />
          <swak:item id="kiykhrsyousaisjkkktyouseirt" />
          <swak:item id="kiykhrsyousaikaiyakukjgk" />
          <swak:item id="kiykhrsyousaikaiyakukjritu" />
        </swak:group>

        <%-- ＜保険料積立金の詳細＞ --%>
        <swak:group id="hokenryouTmttksyousaiInfo">
          <swak:item id="ptumitatekinssptumitatekin" />
          <swak:item id="teiritutmttkngk" />
          <swak:item id="sisuurendoutmttkngk" />
        </swak:group>

        <%-- ●税務情報 --%>
        <swak:group id="zeimuInfo">
          <swak:item id="synykngk" />
          <swak:item id="yenkaiyakuhrstgk" />
          <swak:item id="zeimukwsratekjnymd" />
          <swak:item id="zeimukwsrate" />
          <swak:item id="zeimukyktuukasyu" />
          <swak:item id="htykeihi" />
          <swak:item id="gststaisyousaeki" />
          <swak:item id="zeimugstszeigk" />
          <swak:item id="kihrkmpsgk" />
          <swak:item id="oldkykkihrkmp" />
          <swak:item id="yenshrkykhtykeihi" />
          <swak:item id="kykhnkkaisuu" />
        </swak:group>

        <%-- ●預り金内容 --%>
        <swak:group id="azukarikinInfo">
          <swak:item id="azukarigoukeigk" />
          <swak:item id="azukariaiyakuhr" />
        </swak:group>

        <%-- 預り金合計（円貨） --%>
        <swak:group id="azukarikinYenInfo">
          <swak:item id="azukarijpygoukeigk" />
          <swak:item id="azukarip" />
          <swak:item id="azukarizennouseisankgk" />
          <swak:item id="azukarihaitoukin" />
          <swak:item id="azukartkbtihaitoukin" />
        </swak:group>

        <%-- ●円建変更情報 --%>
        <swak:group id="yendtinfo">
          <swak:item id="yendtinfomkhgktttymd" />
          <swak:item id="yendtinfosyoruiuktkymd" />
          <swak:item id="yendtinfoyendthnkymd" />
          <swak:item id="yendtinfomkhgk" />
          <swak:item id="yendtinfokjnkngk" />
          <swak:item id="yendtinfomokuhyouti" />
          <swak:item id="yendtinfotoutatukngk" />
          <swak:item id="yendtinfoyendthnkkjnkngk" />
          <swak:item id="yendtinfoyendthnkkiykhr" />
          <swak:item id="yendtinfoyendtkwratetkyymd" />
          <swak:item id="yendtinfoyendthnkjikwsrate" />
          <swak:item id="yendtinfokyktuukasyu" />
          <swak:item id="yendtinfoyendthnkhrgk" />
          <swak:item id="yendtinfobfrsibousyen" />
          <swak:item id="yendtinfonewkaiyakuhr" />
        </swak:group>

        <%-- ＜円建変更時の解約返戻金の詳細＞ --%>
        <swak:group id="yendtkiykhrsyousai">
          <swak:item id="kiykhrsyousaiyendthnkiykhr" />
          <swak:item id="yendtinfoptumitatekin" />
          <swak:item id="yendtinfosjkkktyouseiritu" />
          <swak:item id="yendtinfokaiyakukjgk" />
          <swak:item id="yendtinfokaiyakukoujyoritu" />
        </swak:group>

        <%-- ●その他送金先 --%>
        <swak:group id="soukinsakiInfo">
          <swak:item id="soukinsakinmkn" />
          <swak:item id="soukinsakinmkj" />
        </swak:group>

        <%-- soukinsakiInfo2 --%>
        <swak:group id="soukinsakiInfo2">
          <swak:item id="soukinsakiyno" />
          <swak:item id="soukinsakiadr1kj" />
          <swak:item id="soukinsakiadr2kj" />
          <swak:item id="soukinsakiadr3kj" />
        </swak:group>

        <%-- ●契約者相続人 --%>
        <swak:group id="kyksyaszInfo">
          <swak:item id="kyksyaszknmkn" />
          <swak:item id="kyksyaszknmkj" />
        </swak:group>

        <%-- kyksyaszInfo2 --%>
        <swak:group id="kyksyaszInfo2">
          <swak:item id="kyksyaszkyno" />
          <swak:item id="kyksyaszkadr1kj" />
          <swak:item id="kyksyaszkadr2kj" />
          <swak:item id="kyksyaszkadr3kj" />
        </swak:group>

        <%-- ●債権者 --%>
        <swak:group id="saikeInfo">
          <swak:item id="saikennmkj" />
        </swak:group>

        <%-- saikeInfo2 --%>
        <swak:group id="saikeInfo2">
        ...
        <%-- ●円貨支払申出入力 --%>
        <swak:group id="yenshrtkumuInfo">
          <swak:item id="yenshrtkumu" />
        </swak:group>

        <%-- ●支払方法 --%>
        <swak:group id="siharaihouhou">
        ...
        <%-- 為替レート通知内容情報 --%>
        <swak:group id="kawaserateNaiyouInfo">
          <swak:item id="dispyenhokenryou" />
          <swak:item id="kwsrtinfokakuteikwsrate" />
          <swak:item id="kwsrtinforstuukasyu" />
          <swak:item id="kwsrtinfokyktuukasyu" />
          <swak:item id="kwsrtinfoknsnkijyunymd" />
        </swak:group>

        <%-- 為替レート通知メッセージ情報 --%>
        <swak:group id="kawaserateMessageInfo1">
          <swak:item id="kwsrtinfomessage1" />
        </swak:group>

        <%-- 為替レート通知メッセージ情報 --%>
        <swak:group id="kawaserateMessageInfo2">
          <swak:item id="kwsrtinfomessage2" />
        </swak:group>

        <%-- annaiInfo1 --%>
        <swak:group id="annaiInfo1">
          <swak:item id="dispannaiym1" />
          <swak:item id="dispannaijyutoukaisuu1" />
          <swak:item id="dispannaigk1" />
          <swak:item id="dispannaijyutouym1" />
          <swak:item id="dispannaikeiro1" />
          <swak:item id="dispannaijkkbn1" />
          <swak:item id="dispcredituragngjiyuukbn1" />
          <swak:item id="disphurihunokbn1" />
        </swak:group>

        <%-- annaiInfo2 --%>
        <swak:group id="annaiInfo2">
          <swak:item id="dispannaiym2" />
          <swak:item id="dispannaijyutoukaisuu2" />
          <swak:item id="dispannaigk2" />
          <swak:item id="dispannaijyutouym2" />
          <swak:item id="dispannaikeiro2" />
          <swak:item id="dispannaijkkbn2" />
          <swak:item id="dispcredituragngjiyuukbn2" />
          <swak:item id="disphurihunokbn2" />
        </swak:group>

        <%-- annaiInfo3 --%>
        <swak:group id="annaiInfo3">
          <swak:item id="dispannaiym3" />
          <swak:item id="dispannaijyutoukaisuu3" />
          <swak:item id="dispannaigk3" />
          <swak:item id="dispannaijyutouym3" />
          <swak:item id="dispannaikeiro3" />
          <swak:item id="dispannaijkkbn3" />
          <swak:item id="dispcredituragngjiyuukbn3" />
          <swak:item id="disphurihunokbn3" />
        </swak:group>

        <%-- annaiInfo4 --%>
        <swak:group id="annaiInfo4">
          <swak:item id="dispannaiym4" />
          <swak:item id="dispannaijyutoukaisuu4" />
          <swak:item id="dispannaigk4" />
          <swak:item id="dispannaijyutouym4" />
          <swak:item id="dispannaikeiro4" />
          <swak:item id="dispannaijkkbn4" />
          <swak:item id="dispcredituragngjiyuukbn4" />
          <swak:item id="disphurihunokbn4" />
        </swak:group>

        <%-- annaiInfo5 --%>
        <swak:group id="annaiInfo5">
          <swak:item id="dispannaiym5" />
          <swak:item id="dispannaijyutoukaisuu5" />
          <swak:item id="dispannaigk5" />
          <swak:item id="dispannaijyutouym5" />
          <swak:item id="dispannaikeiro5" />
          <swak:item id="dispannaijkkbn5" />
          <swak:item id="dispcredituragngjiyuukbn5" />
          <swak:item id="disphurihunokbn5" />
        </swak:group>

        <%-- annaiInfo6 --%>
        <swak:group id="annaiInfo6">
          <swak:item id="dispannaiym6" />
          <swak:item id="dispannaijyutoukaisuu6" />
          <swak:item id="dispannaigk6" />
          <swak:item id="dispannaijyutouym6" />
          <swak:item id="dispannaikeiro6" />
          <swak:item id="dispannaijkkbn6" />
          <swak:item id="dispcredituragngjiyuukbn6" />
          <swak:item id="disphurihunokbn6" />
        </swak:group>

        <%-- annaiInfo7 --%>
        <swak:group id="annaiInfo7">
          <swak:item id="dispannaiym7" />
          <swak:item id="dispannaijyutoukaisuu7" />
          <swak:item id="dispannaigk7" />
          <swak:item id="dispannaijyutouym7" />
          <swak:item id="dispannaikeiro7" />
          <swak:item id="dispannaijkkbn7" />
          <swak:item id="dispcredituragngjiyuukbn7" />
          <swak:item id="disphurihunokbn7" />
        </swak:group>

        <%-- annaiInfo8 --%>
        <swak:group id="annaiInfo8">
          <swak:item id="dispannaiym8" />
          <swak:item id="dispannaijyutoukaisuu8" />
          <swak:item id="dispannaigk8" />
          <swak:item id="dispannaijyutouym8" />
          <swak:item id="dispannaikeiro8" />
          <swak:item id="dispannaijkkbn8" />
          <swak:item id="dispcredituragngjiyuukbn8" />
          <swak:item id="disphurihunokbn8" />
        </swak:group>

        <%-- annaiInfo9 --%>
        <swak:group id="annaiInfo9">
          <swak:item id="dispannaiym9" />
          <swak:item id="dispannaijyutoukaisuu9" />
          <swak:item id="dispannaigk9" />
          <swak:item id="dispannaijyutouym9" />
          <swak:item id="dispannaikeiro9" />
          <swak:item id="dispannaijkkbn9" />
          <swak:item id="dispcredituragngjiyuukbn9" />
          <swak:item id="disphurihunokbn9" />
        </swak:group>

        <%-- nyuukinRirekiInfo --%>
        <swak:dataTable id="nyuukinRirekiInfo">
          <swak:column id="dispryosyuymd" />
          <swak:column id="dispnykkeiro" />
          <swak:column id="dispjyuutouym" />
          <swak:column id="dispjyutoukaisuu" />
          <swak:column id="disphrkp" />
          <swak:column id="disprskingaku" />
          <swak:column id="dispkawaserate" />
          <swak:column id="disprstuukasyu" />
          <swak:column id="dispkyktuukasyu" />
          <swak:column id="dispnyktrks" />
        </swak:dataTable>
        <swak:pager id="nyuukinRirekiInfoDataSource" />

        <%-- ●指数連動積立情報 --%>
        <swak:group id="sisuuRendouTmttInfo">
          <swak:item id="disptmttknzoukaritujygn" />
          <swak:item id="dispkykjisisuurendourate" />
          <swak:item id="disprendouritu" />
          <swak:item id="dispkykjisisuurendourate2" />
        </swak:group>

        <%-- ●保険料積立金内容 --%>
        <swak:dataTable id="hokenryouTmttInfo">
          <swak:column id="disptaisyound" />
          <swak:column id="dispkouryokukaisiymd" />
          <swak:column id="dispteiritutmttkngk" />
          <swak:column id="disptmttknhaneisisuu" />
          <swak:column id="dispsisuuupritu" />
          <swak:column id="dispsisuurendoutmttkngk" />
        </swak:dataTable>
        ...
        <swak:buttonGroup id="footerButtons3">
          ...
          <swak:item id="searchresulthemodorubtnbykeiyakunaiyou" />
        </swak:buttonGroup>

        <%-- footerButtons4 --%>
        <swak:buttonGroup id="footerButtons4">
          <swak:item id="modorubtnbyttdkrrklist" />
          <swak:item id="searchresulthemodorubtnbyttdkrireki" />
        </swak:buttonGroup>

        <%-- footerButtons5 --%>
        <swak:buttonGroup id="footerButtons5">
          <swak:item id="modorubtnbyttdksyousai" />
        </swak:buttonGroup>

        <%-- footerButtons6 --%>
        <swak:buttonGroup id="footerButtons6">
          <swak:item id="modorubtnbynyuukinrireki" />
          <swak:item id="searchresulthemodorubtnbynyuukinrireki" />
        </swak:buttonGroup>

        <%-- footerButtons7 --%>
        <swak:buttonGroup id="footerButtons7">
          <swak:item id="modorubtnbytmttknrireki" />
          <swak:item id="srcrsltmdrbtnbytmttknrireki" />
        </swak:buttonGroup>
