...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khgengaku/KhGengaku.do">
        ...
        <%-- ●減額処理入力 --%>
        <swak:group id="gengakuNyuuryokuInfo">
          <swak:item id="syoruiukeymd" />
        </swak:group>

        <%-- gengakuNyuuryokuSyuInfo --%>
        <swak:group id="gengakuNyuuryokuSyuInfo">
          <swak:item id="dispsyusyouhnnm" />
          <swak:item id="syuhnkkbn" />
          <swak:item id="gengkhoukbn" />
          ...
          <swak:item id="hensyuikthrip" />
        </swak:group>

        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo1">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo2">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo3">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo4">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo5">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo6">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo7">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo8">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo9">
        ...
        <%-- 　＜特約＞ --%>
        <swak:group id="gengakuNyuuryokuTkInfo10">
        ...
        <%-- ●新基本保険金額 --%>
        <swak:group id="sinKihonHknkngaku">
          <swak:item id="newhkngk" />
        </swak:group>

        <%-- ●新基準金額 --%>
        <swak:group id="sinkjnkngkInfo">
          <swak:item id="newsyukjnkngk" />
        </swak:group>

        <%-- ●新基本Ｓ --%>
        <swak:group id="sinkihonsInfo">
          <swak:item id="newsyukihons" />
        </swak:group>

        <%-- ●支払内容 --%>
        <swak:group id="siharaiNaiyouInfoYmd">
          <swak:item id="shrymd" />
        </swak:group>
        ...
        <swak:group id="siharaiNaiyouInfoGk">
          ...
          <swak:item id="gaikamikeikap" />
          <swak:item id="gaikazennouseisankgk" />
        ...
        <swak:group id="siharaiNaiyouInfoYen">
          ...
          <swak:item id="viewsiharaiyendummy" />
        ...
        <%-- ＜解約返戻金等合計の詳細＞ --%>
        <swak:group id="yenkiykhrssYenInfo">
          <swak:item id="yenkiykhrssyenkiykhrgoukei" />
        </swak:group>

        <%-- 解約返戻金等合計の詳細の支払時為替レート --%>
        <swak:group id="yenkiykhrssWaseRate">
        ...
        <%-- 解約返戻金等合計の詳細の解約返戻金合計 --%>
        <swak:group id="yenkiykhrssGkInfo">
        ...
        <%-- ●円貨支払申出入力 --%>
        <swak:group id="yenShrTkNyuuryoku">
          <swak:item id="yenshrtkumu" />
        </swak:group>

        <%-- ●支払方法 --%>
        <swak:group id="shrHouInfo">
