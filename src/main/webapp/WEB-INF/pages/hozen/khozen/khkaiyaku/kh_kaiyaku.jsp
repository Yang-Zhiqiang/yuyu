...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khkaiyaku/KhKaiyaku.do">
        ...
        <%-- ●解約事由 --%>
        <swak:group id="kaiyakuJiyuuInfo">
          <swak:item id="kaiyakujiyuu" />
        </swak:group>
        ...
        <%-- ●解約処理入力 --%>
        <swak:group id="kaiyakuSyoriNyuuryokuInfo">
        ...
        <swak:group id="siharaiNaiyouInfoGk">
          ...
          <swak:item id="dispgstszeigk" />
          <swak:item id="dispgstszeigkcalckahimongon" />
        ...
        <%-- その他支払金額詳細の支払時為替レート --%>
        <swak:group id="sntshrgksssiharaiKawaseRate">
        ...
        <%-- その他支払金額詳細の合計情報 --%>
        <swak:group id="sntshrgkssGoukeiInfo">
        ...
        <%-- ●支払内容 --%>
        <swak:group id="siharaiNaiyouInfoYendthnk">
          ...
          <swak:item id="dispyendthnkgstszeigk" />
        ...
        <swak:group id="kiykhrsyousaiInfo">
          <swak:item id="kiykhrsyousaikiykhrtogoukei" />
        ...
        <%-- ＜解約返戻金等合計の詳細＞ --%>
        <swak:group id="kiykhrstousGoukeiInfoYen">
          <swak:item id="kiykhrstousyenkiykhrgoukei" />
        </swak:group>

        <%-- 解約返戻金等合計詳細の支払時為替レート --%>
        <swak:group id="kiykhrstousKawaseRate">
          <swak:item id="kiykhrstousyenshrratetkymd" />
          <swak:item id="kiykhrstousyenshrratete" />
          <swak:item id="kiykhrstousshrkyktuukasyu" />
        </swak:group>

        <%-- 解約返戻金等合計詳細の合計情報 --%>
        <swak:group id="kiykhrstousGoukeiInfo">
          <swak:item id="kiykhrstouskaiyakuhrgoukei" />
          <swak:item id="kiykhrstouskaiyakuhrkin" />
          <swak:item id="kiykhrstousmikeikap" />
          <swak:item id="kiykhrstouszennouseisankin" />
          <swak:item id="kiykhrstouskykhnkkaiyakuhr" />
        </swak:group>

        <%-- ＜保険料積立金の詳細＞ --%>
        <swak:group id="ptumitatekinInfo">
        ...
        <swak:group id="drctserviceInfo">
          <swak:item id="telttdkkahikbn" />
          <swak:item id="tokuteitrhkkztourokujk" />
          <swak:item id="telttdkhukariyuu" />
        </swak:group>
        ...
        <%-- ●債権者情報 --%>
        <swak:group id="saikenInfo">
          <swak:item id="saikennmkj" />
        </swak:group>

        <%-- saikenInfo2 --%>
        <swak:group id="saikenInfo2">
        ...
        <%-- ●完了通知出力区分 --%>
        <swak:group id="kanryouInfo">
          <swak:item id="kanryotuutioutkbn" />
          <swak:item id="IIC0001" />
        </swak:group>
