...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khkaigomaebaraitkhenkou/KhKaigomaebaraiTkHenkou.do">
        ...
        <%-- ●重度介護前払特約変更内容 --%>
        <swak:group id="jydkgmbrtkykhnkInfo">
          <swak:item id="jyudkaigomaebaraitkykhnkkbn" />
        </swak:group>
        ...
        <%-- ●特殊区分内容 --%>
        <swak:group id="khtokusyukbnInfo">
          <swak:item id="khtokusyukbn" />
        </swak:group>
