...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khjyuusyohenkou/KhJyuusyoHenkou.do">
        ...
        <%-- ●請求書送付先 --%>
        <swak:group id="skSouhusakiinfo">
          <swak:item id="shsnmkj" />
        </swak:group>

        <%-- skSouhusaki --%>
        <swak:group id="skSouhusaki">
        ...
        <%-- ●変更後通信先 --%>
        <swak:group id="henkoutuusinsakiInfo">
