...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khkeiyakutorikesi/KhKeiyakuTorikesi.do">
        ...
        <%-- ●契約取消処理入力 --%>
        <swak:group id="kyktrksSyoriInputInfo">
          <swak:item id="kyktrkskbn" />
          <swak:item id="sibouymd" />
          <swak:item id="kaijyokessaiymd" />
          <swak:item id="kaijyotuutiymd" />
          <swak:item id="syoruiukeymd" />
          <swak:item id="hubikanryouymd" />
          <swak:item id="IIC1005" />
        </swak:group>
        ...
        <swak:group id="siharaiInfo">
          <swak:item id="nykntuukashrgkgoukeisyoukai" />
        ...
        <%-- ●支払内容 --%>
        <swak:group id="siharaiNaiyouInfoGk">
        ...
        <%-- ●支払内容 --%>
        <swak:group id="siharaiNaiyouInfoYen">
          <swak:item id="jpyshrgkgoukeisyoukai" />
          <swak:item id="jpyshrgkgoukeikakunin" />
          <swak:item id="yendthnkshrgkgoukeisyoukai" />
          <swak:item id="yendthnkshrgkgoukeikakunin" />
          <swak:item id="jpyptumitatekin" />
          <swak:item id="kaiyakuhryen" />
          ...
          <swak:item id="yenazukarikinkykhnkmikeikap" />
        ...
        <%-- ＜解約返戻金の詳細＞ --%>
        <swak:group id="kiykhrsyousaiInfo">
        ...
        <%-- ＜保険料積立金の詳細＞ --%>
        <swak:group id="ptumitatekinsyousaiInfo">
        ...
        <%-- ●延伸区分 --%>
        <swak:group id="ensinkbnInfo">
          <swak:item id="sinsagendokknkbn" />
          <swak:item id="rikoukityuutuudannissuu" />
        </swak:group>

        <%-- ●送金先指定 --%>
        <swak:group id="soukinsakisiteiInfo">
          <swak:item id="soukinsakisiteikbn" />
        </swak:group>

        <%-- ●その他送金先 --%>
        <swak:group id="souhusakiInfo1">
          <swak:item id="soukinsakinmkn" />
          <swak:item id="soukinsakinmkj" />
        </swak:group>

        <%-- souhusakiInfo2 --%>
        <swak:group id="souhusakiInfo2">
        ...
        <%-- ●契約者相続人 --%>
        <swak:group id="kyksyaszkInfo1">
          <swak:item id="kyksyaszknmkn" />
          <swak:item id="kyksyaszknmkj" />
        </swak:group>

        <%-- kyksyaszkInfo2 --%>
        <swak:group id="kyksyaszkInfo2">
        ...
        <%-- ●支払方法 --%>
        <swak:group id="inputshrhousiteikbnInfo">
        ...
        <%-- ●ＭＮ名義番号 --%>
        <swak:group id="mnMeigiBangouInfo">
