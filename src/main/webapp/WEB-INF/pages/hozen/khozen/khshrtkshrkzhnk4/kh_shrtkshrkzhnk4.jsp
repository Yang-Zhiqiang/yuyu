...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khshrtkshrkzhnk4/KhShrtkshrkzhnk4.do">
        ...
        <%-- ●処理区分 --%>
        <swak:group id="syorikbnInfo">
          <swak:item id="syorikbn" />
        </swak:group>
        ...
        <swak:group id="viewSiharaiInfo">
          <swak:item id="teikishrkinshrtuukasyu" />
        </swak:group>

        <%-- ●支払先口座情報 --%>
        <swak:group id="siharaisakikouzaInfo">
          <swak:item id="vkskzkzsyuruikbn" />
          <swak:item id="vkskzbankcd" />
          <swak:item id="vkskzbanknmkj" />
          <swak:item id="vkskzsitencd" />
          <swak:item id="vkskzsitennmkj" />
          <swak:item id="vkskzyokinkbn" />
          <swak:item id="vkskzkouzano" />
          <swak:item id="vkskzkzmeiginmkn" />
        </swak:group>
        ...
        <%-- ●変更後支払通貨 --%>
        <swak:group id="shrtuukasyuChangeAfterInfo">
          <swak:item id="shrtuukasyu" />
        </swak:group>

        <%-- ●口座変更内容 --%>
        <swak:group id="kouzaChangeInfo">
          <swak:item id="kzsyuruikbn" />
        </swak:group>

        <%-- ●変更後口座情報 --%>
        <swak:group id="kouzaChangeAfterInfo">
          <swak:item id="bankcd" />
