...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khyendthnkhrshr/KhYendtHnkHrShr.do">
        ...
        <%-- ●支払事由 --%>
        <swak:group id="khhrshrjiyuuInfo">
          <swak:item id="khhrshrjiyuu" />
        </swak:group>
        ...
        <%-- ●支払処理入力 --%>
        <swak:group id="shiharaiSyoriNyuuryokuInfo">
        ...
        <%-- ●請求書作成事由 --%>
        <swak:group id="khskssakuseijiyuuInfo">
          <swak:item id="khskssakuseijiyuu" />
        </swak:group>
