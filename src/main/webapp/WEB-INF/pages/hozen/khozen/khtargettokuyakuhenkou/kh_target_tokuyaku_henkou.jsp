...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khtargettokuyakuhenkou/KhTargetTokuyakuHenkou.do">
        ...
        <%-- ●ターゲット特約変更内容 --%>
        <swak:group id="targettkhnknaiyou">
          <swak:item id="targettkykkykhenkoymd" />
          <swak:item id="targettkykhnkkbn" />
          <swak:item id="targettkmokuhyouti" />
        </swak:group>
        ...
        <swak:group id="kekkainputGroup">
          <swak:item id="dispsyorikekkakbn" />
