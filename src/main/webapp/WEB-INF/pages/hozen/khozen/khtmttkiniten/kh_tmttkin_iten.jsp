...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khtmttkiniten/KhTmttkinIten.do">
        ...
        <%-- ●積立金移転内容 --%>
        <swak:group id="khTmttkinItenNaiyouInfo">
          <swak:item id="tmttknitenkbn" />
          <swak:item id="tmttknitenymd" />
        </swak:group>

        <%-- ●積立金移転処理入力 --%>
        <swak:group id="khTmttkinItenNyuuryokuInfo">
