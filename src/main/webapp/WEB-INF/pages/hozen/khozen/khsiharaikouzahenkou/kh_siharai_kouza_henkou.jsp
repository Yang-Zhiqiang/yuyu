...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khsiharaikouzahenkou/KhSiharaiKouzaHenkou.do">
        ...
        <swak:dataTable id="syoruiInfoList">
          <swak:column id="dispsyoruittykymd" />
          <swak:column id="dispsyoruinm" />
          <swak:column id="disphituyousyorui" />
        ...
        <%-- ●円支払特約変更内容 --%>
        <swak:group id="yenshrkykhenkoInfo">
        </swak:group>
