...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khozen/khnenkinsiharaitokuyakuhenkou/KhNenkinSiharaiTokuyakuHenkou.do">
        ...
        <%-- ●年金支払特約変更内容 --%>
        <swak:group id="nkshrtkykhnknaiyouInfo">
          <swak:item id="nkshrtkykhnkkbn" />
          <swak:item id="nkshrtkyknksyukbn" />
          <swak:item id="nkshrtkyknksyukkn" />
        </swak:group>
