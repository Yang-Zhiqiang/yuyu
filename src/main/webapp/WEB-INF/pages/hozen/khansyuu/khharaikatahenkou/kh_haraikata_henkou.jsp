...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khharaikatahenkou/KhHaraikataHenkou.do">
        ...
        <%-- ●払込方法変更入力情報 --%>
        <swak:group id="hrkhouhouhenkouInfo1">
          <swak:item id="newhrkkeiro" />
          <swak:item id="IIA3004" />
          <swak:item id="newtikiktbrisyuruikbn" />
          <swak:item id="IIA3003" />
          <swak:item id="newhrkkaisuu" />
          <swak:item id="IIA3003" />
          <swak:item id="henkouyoteiym" />
          <swak:item id="IIF3001" />
          <swak:item id="newtikiktbrihrkp" />
          <swak:item id="newhrkp" />
          <swak:item id="disphrhnkyoup" />
          <swak:item id="IIA3005" />
          <swak:item id="yenkahrhnkyoup" />
          <swak:item id="hrhnkyoupkwsratekjymd" />
          <swak:item id="hrhnkyoupkwsrate" />
          <swak:item id="rstuukasyu" />
          <swak:item id="ptuukasyu" />
          <swak:item id="hrhnkyoupzytym" />
          <swak:item id="hrhnkyoupzytm" />
        </swak:group>

        <%-- hrkhouhouhenkouInfo2 --%>
        <swak:group id="hrkhouhouhenkouInfo2">
          <swak:item id="newnextkosgohrkp" />
        </swak:group>

        <%-- ●クレジットカード情報 --%>
        <swak:group id="creditcardInfo">
          <swak:item id="dispsaibancreditkessaiyouno" />
        </swak:group>
        ...
        <%-- authorikakyhInfo --%>
        <swak:group id="authorikakyhInfo">
          <swak:item id="authorikakyhkbn" />
        </swak:group>

        <%-- ●予約異動受付 --%>
        <swak:group id="yykidouuktkInfo">
          <swak:item id="yykidouuktkkbn" />
        </swak:group>

        <%-- ●旧口座案内 --%>
        <swak:group id="kyuukouzaannaiInfo">
          <swak:item id="kyuukouzaannaikbn" />
        </swak:group>

        <%-- ●完了通知出力区分 --%>
        <swak:group id="kanryotuutioutInfo">
