...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khrinjiuriageseikyuuuketuke/KhRinjiUriageSeikyuuUketuke.do">
        ...
        <%-- ●請求内容 --%>
        <swak:group id="seikyuuNaiyouInfo">
          <swak:item id="nyknaiyoukbn" />
          <swak:item id="uriageymd" />
          <swak:item id="rinjiuriageskkngk" />
        </swak:group>
