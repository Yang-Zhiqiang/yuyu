...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khnyuukinsyoukai/KhNyuukinSyoukai.do">
        ...
        <%-- ●入金照会入力 --%>
        <swak:group id="nyuukinSyoukaiInfo">
          <swak:item id="nyksyoukaikbn" />
          <swak:item id="rsyymd" />
          <swak:item id="hrkkigenymd" />
        ...
        <%-- ●試算結果 --%>
        <swak:group id="resultInfo">
          <swak:item id="rsgaku" />
          <swak:item id="annaisaikaiym" />
        </swak:group>

        <%-- resultInfonoRyosyujikwsrate --%>
        <swak:group id="resultInfonoRyosyujikwsrate">
          <swak:item id="ryosyujikwsratekjymd" />
          <swak:item id="ryosyujikwsrate" />
