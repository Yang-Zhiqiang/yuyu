...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khkariuketeisei/KhKariukeTeisei.do">
        ...
        <%-- ●仮受訂正入力情報 --%>
        <swak:group id="krkteiseiinputInfo">
          <swak:item id="krkteiseikbn" />
          <swak:item id="denkarikanjyono" />
        </swak:group>
        ...
        <%-- ●返金先クレジットカード情報 --%>
        <swak:group id="hnknsakicreditInfo">
          <swak:item id="disphnknsakicreditkessaiyouno" />
        </swak:group>
        ...
        <%-- ●返金理由区分 --%>
        <swak:group id="hnknriyuukbnInfo">
          <swak:item id="shrriyuukbn" />
        </swak:group>
