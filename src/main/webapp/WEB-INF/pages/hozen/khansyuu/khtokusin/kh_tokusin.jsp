...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khtokusin/KhTokusin.do">
        ...
        <%-- ●変更前特伸情報 --%>
        <swak:group id="oldTokusinInfo">
          <swak:item id="bfrtokusinkbn" />
          <swak:item id="bfrhsgymd" />
          <swak:item id="bfrtokusinsyoriymd" />
          <swak:item id="bfrtokusinendymd" />
        </swak:group>

        <%-- ●特伸処理入力情報 --%>
        <swak:group id="tokusinSyoriNyuuryokuInfo">
          <swak:item id="tokusinkbn" />
          <swak:item id="hsgymd" />
          <swak:item id="tokusinendym" />
