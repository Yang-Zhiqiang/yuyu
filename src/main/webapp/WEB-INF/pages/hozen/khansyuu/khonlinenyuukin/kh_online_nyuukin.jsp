...
<swak:html>
  ...
  <body>
    ...
    <swak:form action="/hozen/khansyuu/khonlinenyuukin/KhOnlineNyuukin.do">
        ...
        <%-- ●入金方法入力情報 --%>
        <swak:group id="nykhouhouInfo">
          <swak:item id="nykhouhou" />
        </swak:group>

        <%-- ●振替依頼情報 --%>
        <swak:dataTable id="hrkeiraiInfo">
          <swak:column id="nykntaisyouchkbox" />
          <swak:column id="nyknaiyoukbn" />
          <swak:column id="jyuutouym" />
          <swak:column id="hrkkigen" />
          <swak:column id="hrkiraikngk" />
          <swak:column id="comment124keta" />
          <swak:column id="jyutoukaisuuy" />
          <swak:column id="jyutoukaisuum" />
          <swak:column id="kzkpannaijiyuukbn" />
        </swak:dataTable>

        <%-- ●入金処理入力 --%>
        <swak:group id="nyuukinsyoriInfo">
          <swak:item id="hrkkaisuu" />
          <swak:item id="tikiktbrisyuruikbn" />
          <swak:item id="nykkeiro" />
          <swak:item id="nyknaiyoukbn" />
          <swak:item id="jyuutouym" />
          <swak:item id="jyutoukaisuuy" />
          <swak:item id="jyutoukaisuum" />
          <swak:item id="ryosyuymd" />
          <swak:item id="rsgaku" />
          <swak:item id="nykinputdenymd" />
          <swak:item id="tyakkinymd" />
          <swak:item id="tabakarikanjyono" />
          <swak:item id="suitososhikicd" />
        </swak:group>

        <%-- ●仮受金情報入力 --%>
        <swak:group id="kariukekinInfo">
          <swak:item id="dummykmk1" />
          <swak:item id="IIW3016" />
          <swak:item id="dummykmk2" />
          <swak:item id="IIW3017" />
          <swak:item id="krkno" />
          <swak:item id="krkkeijyoymd" />
          <swak:item id="krkriyuukbn" />
          <swak:item id="hasseidenymd" />
          <swak:item id="disphrkkaisuu" />
          <swak:item id="nykinputhrkkaisuu" />
          <swak:item id="disptikiktbrisyuruikbn" />
          <swak:item id="nykinputtikiktbrisyuruikbn" />
          <swak:item id="dispnykkeiro" />
          <swak:item id="nykinputnykkeiro" />
          <swak:item id="dispnyknaiyoukbn" />
          <swak:item id="nykinputnyknaiyoukbn" />
          <swak:item id="dispjyuutouym" />
          <swak:item id="nykinputjyuutouym" />
          <swak:item id="dispjyutoukaisuuy" />
          <swak:item id="dispjyutoukaisuum" />
          <swak:item id="nykinputjyutoukaisuuy" />
          <swak:item id="nykinputjyutoukaisuum" />
          <swak:item id="dispryosyuymd" />
          <swak:item id="nykinputryosyuymd" />
          <swak:item id="krkgk" />
        </swak:group>
