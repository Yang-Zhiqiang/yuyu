...
# [～sinkeiyaku]cp: cannot stat `/sli/data/zm/transfer/shuhai/haisin/RAZP7AA1A20170417*': そのようなファイルやディレクトリはありません
# [～sinkeiyaku]$ echo $?
# 1
#
