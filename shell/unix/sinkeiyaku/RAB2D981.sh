...
# [～sinkeiyaku]cp: cannot stat `/sli/data/zm/transfer/shuhai/haisin/RAZP7AC1A20170417*': そのようなファイルやディレクトリはありません
# [～sinkeiyaku]$ echo $?
# 1
#
