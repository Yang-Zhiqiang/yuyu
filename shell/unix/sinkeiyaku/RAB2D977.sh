...
# [～sinkeiyaku]cp: cannot stat `/sli/data/zm/transfer/shuhai/haisin/RAZP7AC2A20170417*': そのようなファイルやディレクトリはありません
# [～sinkeiyaku]$ echo $?
# 1
#
