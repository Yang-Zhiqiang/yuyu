...
###############################################################################
# ＳＰＩＲＡＬメール配信２Ｆ連動
# ＳＰＩＲＡＬメール配信２Ｆをパイプドビッツ（ＳＰＩＲＡＬ環境）へ連動します。
###############################################################################
# ログ出力用のメッセージ定義
# 正常メッセージ
MSG0001N="--NOR-- ＳＰＩＲＡＬメール配信２Ｆ連動処理を開始します。"
...
MSG0006N="--NOR-- パイプドビッツ（ＳＰＩＲＡＬ環境）へ、ＳＰＩＲＡＬメール配信２Ｆを連動します。"
MSG0007N="--NOR-- パイプドビッツ（ＳＰＩＲＡＬ環境）へ、ＳＰＩＲＡＬメール配信２Ｆを連動しました。"
MSG0008N="--NOR-- ＳＰＩＲＡＬメール配信２Ｆ連動処理を終了します。"
...
# メッセージ出力「--NOR-- ＳＰＩＲＡＬメール配信２Ｆ連動処理を開始します。」
...
# ファイル名（固定部分）
PRE_FILENAME="SpiralMailHaisin2_"
...
# メッセージ出力「--NOR-- パイプドビッツ（ＳＰＩＲＡＬ環境）へ、ＳＰＩＲＡＬメール配信２Ｆを連動します。」
...
# メッセージ出力「--NOR-- パイプドビッツ（ＳＰＩＲＡＬ環境）へ、ＳＰＩＲＡＬメール配信２Ｆを連動しました。」
FUNC_MSG "${MSG_NOR}" ${MSG0007N}

# メッセージ出力「--NOR-- ＳＰＩＲＡＬメール配信２Ｆ連動処理を終了します。」
